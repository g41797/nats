...
pub export fn natsStatus_GetText(arg_s: natsStatus) [*c]const u8 {
    var s = arg_s;
    _ = &s;
    return statusText[@as(c_uint, @intCast(@as(c_int, @bitCast(s))))];
}
...
pub var statusText: [38][*c]const u8 = [38][*c]const u8{
    "OK",
    "Error",
    "Protocol Error",
    "IO Error",
