...
pub const struct_in6_addr = extern struct {
    __in6_u: union_unnamed_16 = @import("std").mem.zeroes(union_unnamed_16),
};
...
const union_unnamed_17 = extern union {
    _pad: [12]c_int,
    _tid: __pid_t,
    _sigev_thread: struct_unnamed_18,
};
pub const struct_sigevent = extern struct {
    ...
    _sigev_un: union_unnamed_17 = @import("std").mem.zeroes(union_unnamed_17),
};
...
const struct_unnamed_37 = extern struct {
    ...
    _bounds: union_unnamed_38 = @import("std").mem.zeroes(union_unnamed_38),
};
...
const union_unnamed_32 = extern union {
    _pad: [28]c_int,
    _kill: struct_unnamed_33,
    _timer: struct_unnamed_34,
    _rt: struct_unnamed_35,
    _sigchld: struct_unnamed_36,
    _sigfault: struct_unnamed_37,
    _sigpoll: struct_unnamed_40,
    _sigsys: struct_unnamed_41,
};
pub const siginfo_t = extern struct {
    ...
    __pad0: c_int = @import("std").mem.zeroes(c_int),
    _sifields: union_unnamed_32 = @import("std").mem.zeroes(union_unnamed_32),
};
...
pub const struct_sigaction = extern struct {
    __sigaction_handler: union_unnamed_50 = @import("std").mem.zeroes(union_unnamed_50),
...
pub const struct_sigcontext = extern struct {
    ...
    unnamed_0: union_unnamed_51 = @import("std").mem.zeroes(union_unnamed_51),
...
pub const struct___natsSubscriptionControlMessages = extern struct {
    sub: struct_unnamed_53 = @import("std").mem.zeroes(struct_unnamed_53),
    fetch: struct_unnamed_54 = @import("std").mem.zeroes(struct_unnamed_54),
};
...
pub const struct_jsOptionsPublishAsync_55 = extern struct {
...
pub const struct_jsOptionsPullSubscribeAsync_56 = extern struct {
...
pub const struct_jsOptionsStreamPurge_58 = extern struct {
    Subject: [*c]const u8 = @import("std").mem.zeroes([*c]const u8),
    Sequence: u64 = @import("std").mem.zeroes(u64),
    Keep: u64 = @import("std").mem.zeroes(u64),
};
pub const struct_jsOptionsStreamInfo_59 = extern struct {
    DeletedDetails: bool = @import("std").mem.zeroes(bool),
    SubjectsFilter: [*c]const u8 = @import("std").mem.zeroes([*c]const u8),
};
pub const struct_jsOptionsStream_57 = extern struct {
    Purge: struct_jsOptionsStreamPurge_58 = @import("std").mem.zeroes(struct_jsOptionsStreamPurge_58),
    Info: struct_jsOptionsStreamInfo_59 = @import("std").mem.zeroes(struct_jsOptionsStreamInfo_59),
};
pub const struct_jsOptions = extern struct {
    ...
    PublishAsync: struct_jsOptionsPublishAsync_55 = @import("std").mem.zeroes(struct_jsOptionsPublishAsync_55),
    PullSubscribeAsync: struct_jsOptionsPullSubscribeAsync_56 = @import("std").mem.zeroes(struct_jsOptionsPullSubscribeAsync_56),
    Stream: struct_jsOptionsStream_57 = @import("std").mem.zeroes(struct_jsOptionsStream_57),
};
...
pub const struct___jsFetch = extern struct {
    opts: struct_jsOptionsPullSubscribeAsync_56 = @import("std").mem.zeroes(struct_jsOptionsPullSubscribeAsync_56),
...
pub const struct_mismatch_60 = extern struct {
...
pub const struct___jsSub = extern struct {
    ...
    mismatch: struct_mismatch_60 = @import("std").mem.zeroes(struct_mismatch_60),
...
pub const struct___natsConnection = extern struct {
    ...
    el: struct_unnamed_61 = @import("std").mem.zeroes(struct_unnamed_61),
    filter: natsMsgFilter = @import("std").mem.zeroes(natsMsgFilter),
    filterClosure: ?*anyopaque = @import("std").mem.zeroes(?*anyopaque),
    srvVersion: struct_unnamed_62 = @import("std").mem.zeroes(struct_unnamed_62),
};
...
pub export fn natsParser_Create(arg_newParser: [*c][*c]natsParser) natsStatus {
    var newParser = arg_newParser;
    _ = &newParser;
    var parser: [*c]natsParser = @as([*c]natsParser, @ptrCast(@alignCast(calloc(@as(c_ulong, @bitCast(@as(c_long, @as(c_int, 1)))), @sizeOf(natsParser)))));
    _ = &parser;
    if (parser == @as([*c]natsParser, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) return @as(c_uint, @bitCast(NATS_NO_MEMORY));
    newParser.* = parser;
    return @as(c_uint, @bitCast(NATS_OK));
}
// ./src/submodules/nats.c/src/parser.c:269:25: warning: TODO implement translation of stmt class GotoStmtClass

// ./src/submodules/nats.c/src/parser.c:226:1: warning: unable to translate function, demoted to extern
pub extern fn natsParser_Parse(arg_nc: [*c]struct___natsConnection, arg_buf: [*c]u8, arg_bufLen: c_int) natsStatus;
pub export fn natsParser_Destroy(arg_parser: [*c]natsParser) void {
    var parser = arg_parser;
    _ = &parser;
    if (parser == @as([*c]natsParser, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) return;
    ...
    free(@as(?*anyopaque, @ptrCast(parser)));
}
...
pub const nats_JSONField = extern struct {
    name: [*c]u8 = @import("std").mem.zeroes([*c]u8),
    typ: c_int = @import("std").mem.zeroes(c_int),
    value: union_unnamed_63 = @import("std").mem.zeroes(union_unnamed_63),
...
pub fn _cloneMsgArg(arg_nc: [*c]natsConnection) callconv(.c) natsStatus {
    var nc = arg_nc;
    _ = &nc;
    var s: natsStatus = undefined;
    _ = &s;
    var subjLen: c_int = nc.*.ps.*.ma.subject.*.len;
    _ = &subjLen;
    s = natsBuf_InitWithBackend(&nc.*.ps.*.argBufRec, @as([*c]u8, @ptrCast(@alignCast(&nc.*.ps.*.scratch))), @as(c_int, 0), @as(c_int, @bitCast(@as(c_uint, @truncate(@sizeOf([4096]u8))))));
    if (s == @as(c_uint, @bitCast(NATS_OK))) {
        nc.*.ps.*.argBuf = &nc.*.ps.*.argBufRec;
        s = natsBuf_Append(nc.*.ps.*.argBuf, nc.*.ps.*.ma.subject.*.data, nc.*.ps.*.ma.subject.*.len);
        if (s == @as(c_uint, @bitCast(NATS_OK))) {
            natsBuf_Destroy(nc.*.ps.*.ma.subject);
            nc.*.ps.*.ma.subject = null;
            s = natsBuf_InitWithBackend(&nc.*.ps.*.ma.subjectRec, @as([*c]u8, @ptrCast(@alignCast(&nc.*.ps.*.scratch))), subjLen, subjLen);
            if (s == @as(c_uint, @bitCast(NATS_OK))) {
                nc.*.ps.*.ma.subject = &nc.*.ps.*.ma.subjectRec;
            }
        }
    }
    if ((s == @as(c_uint, @bitCast(NATS_OK))) and (nc.*.ps.*.ma.reply != @as([*c]natsBuffer, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0)))))))) {
        s = natsBuf_Append(nc.*.ps.*.argBuf, nc.*.ps.*.ma.reply.*.data, nc.*.ps.*.ma.reply.*.len);
        if (s == @as(c_uint, @bitCast(NATS_OK))) {
            var replyLen: c_int = nc.*.ps.*.ma.reply.*.len;
            _ = &replyLen;
            natsBuf_Destroy(nc.*.ps.*.ma.reply);
            nc.*.ps.*.ma.reply = null;
            s = natsBuf_InitWithBackend(&nc.*.ps.*.ma.replyRec, @as([*c]u8, @ptrCast(@alignCast(&nc.*.ps.*.scratch))) + @as(usize, @bitCast(@as(isize, @intCast(subjLen)))), replyLen, replyLen);
            if (s == @as(c_uint, @bitCast(NATS_OK))) {
...
pub const struct_slice = extern struct {
    start: [*c]u8 = @import("std").mem.zeroes([*c]u8),
    len: c_int = @import("std").mem.zeroes(c_int),
};
pub fn _processMsgArgs(arg_nc: [*c]natsConnection, arg_buf: [*c]u8, arg_bufLen: c_int) callconv(.c) natsStatus {
    var nc = arg_nc;
    _ = &nc;
    var buf = arg_buf;
    _ = &buf;
    ...
    var b: u8 = undefined;
    _ = &b;
    var slices: [5]struct_slice = undefined;
    _ = &slices;
    var errTxt: [256]u8 = undefined;
    _ = &errTxt;
    var indexLimit: c_int = 3;
    _ = &indexLimit;
    var minArgs: c_int = 3;
    _ = &minArgs;
    var maxArgs: c_int = 4;
    _ = &maxArgs;
    var hasHeaders: bool = (if (nc.*.ps.*.hdr >= @as(c_int, 0)) @as(c_int, 1) else @as(c_int, 0)) != 0;
    _ = &hasHeaders;
    if (hasHeaders) {
        indexLimit = 4;
        minArgs = 4;
    ...
    }
    {
        ...
        while (i < bufLen) : (i += 1) {
            ...
            if ((((@as(c_int, @bitCast(@as(c_uint, b))) == @as(c_int, ' ')) or (@as(c_int, @bitCast(@as(c_uint, b))) == @as(c_int, '\t'))) or (@as(c_int, @bitCast(@as(c_uint, b))) == @as(c_int, '\r'))) or (@as(c_int, @bitCast(@as(c_uint, b))) == @as(c_int, '\n'))) {
                if (start >= @as(c_int, 0)) {
                    if (index_1 > indexLimit) {
                        s = @as(c_uint, @bitCast(NATS_PROTOCOL_ERROR));
                        break;
                    }
                    slices[@as(c_uint, @intCast(index_1))].start = buf + @as(usize, @bitCast(@as(isize, @intCast(start))));
                    slices[@as(c_uint, @intCast(index_1))].len = i - start;
                    index_1 += 1;
                    start = -@as(c_int, 1);
                }
            } else if (start < @as(c_int, 0)) {
                start = i;
            }
        }
    }
    if ((s == @as(c_uint, @bitCast(NATS_OK))) and (start >= @as(c_int, 0))) {
        if (index_1 > indexLimit) {
            s = @as(c_uint, @bitCast(NATS_PROTOCOL_ERROR));
        } else {
            slices[@as(c_uint, @intCast(index_1))].start = buf + @as(usize, @bitCast(@as(isize, @intCast(start))));
    ...
    if ((s == @as(c_uint, @bitCast(NATS_OK))) and ((index_1 == minArgs) or (index_1 == maxArgs))) {
        var maSizeIndex: c_int = index_1 - @as(c_int, 1);
        _ = &maSizeIndex;
        var hdrSizeIndex: c_int = index_1 - @as(c_int, 2);
        _ = &hdrSizeIndex;
        s = natsBuf_InitWithBackend(&nc.*.ps.*.ma.subjectRec, slices[@as(c_uint, @intCast(@as(c_int, 0)))].start, slices[@as(c_uint, @intCast(@as(c_int, 0)))].len, slices[@as(c_uint, @intCast(@as(c_int, 0)))].len);
        if (s == @as(c_uint, @bitCast(NATS_OK))) {
            nc.*.ps.*.ma.subject = &nc.*.ps.*.ma.subjectRec;
            nc.*.ps.*.ma.sid = nats_ParseInt64(slices[@as(c_uint, @intCast(@as(c_int, 1)))].start, slices[@as(c_uint, @intCast(@as(c_int, 1)))].len);
            if (index_1 == minArgs) {
                nc.*.ps.*.ma.reply = null;
            } else {
                s = natsBuf_InitWithBackend(&nc.*.ps.*.ma.replyRec, slices[@as(c_uint, @intCast(@as(c_int, 2)))].start, slices[@as(c_uint, @intCast(@as(c_int, 2)))].len, slices[@as(c_uint, @intCast(@as(c_int, 2)))].len);
                if (s == @as(c_uint, @bitCast(NATS_OK))) {
                    nc.*.ps.*.ma.reply = &nc.*.ps.*.ma.replyRec;
                }
            }
        ...
        if (s == @as(c_uint, @bitCast(NATS_OK))) {
            if (hasHeaders) {
                nc.*.ps.*.ma.hdr = @as(c_int, @bitCast(@as(c_int, @truncate(nats_ParseInt64(slices[@as(c_uint, @intCast(hdrSizeIndex))].start, slices[@as(c_uint, @intCast(hdrSizeIndex))].len)))));
            }
            nc.*.ps.*.ma.size = @as(c_int, @bitCast(@as(c_int, @truncate(nats_ParseInt64(slices[@as(c_uint, @intCast(maSizeIndex))].start, slices[@as(c_uint, @intCast(maSizeIndex))].len)))));
        }
    } else {
        _ = snprintf(@as([*c]u8, @ptrCast(@alignCast(&errTxt))), @sizeOf([256]u8), "%s", "processMsgArgs Parse Error: wrong number of arguments");
        s = @as(c_uint, @bitCast(NATS_PROTOCOL_ERROR));
    }
    if (nc.*.ps.*.ma.sid < @as(i64, @bitCast(@as(c_long, @as(c_int, 0))))) {
        _ = snprintf(@as([*c]u8, @ptrCast(@alignCast(&errTxt))), @sizeOf([256]u8), "processMsgArgs Bad or Missing Sid: '%.*s'", bufLen, buf);
        s = @as(c_uint, @bitCast(NATS_PROTOCOL_ERROR));
    }
    if (nc.*.ps.*.ma.size < @as(c_int, 0)) {
        _ = snprintf(@as([*c]u8, @ptrCast(@alignCast(&errTxt))), @sizeOf([256]u8), "processMsgArgs Bad or Missing Size: '%.*s'", bufLen, buf);
        s = @as(c_uint, @bitCast(NATS_PROTOCOL_ERROR));
    }
    if ((@as(c_int, @intFromBool(hasHeaders)) != 0) and ((nc.*.ps.*.ma.hdr < @as(c_int, 0)) or (nc.*.ps.*.ma.hdr > nc.*.ps.*.ma.size))) {
        _ = snprintf(@as([*c]u8, @ptrCast(@alignCast(&errTxt))), @sizeOf([256]u8), "processMsgArgs Bad or Missing Header Size: '%.*s'", bufLen, buf);
        s = @as(c_uint, @bitCast(NATS_PROTOCOL_ERROR));
    }
    if (s != @as(c_uint, @bitCast(NATS_OK))) {
        _ = natsMutex_Lock(nc.*.mu);
        _ = snprintf(@as([*c]u8, @ptrCast(@alignCast(&nc.*.errStr))), @sizeOf([256]u8), "%s", @as([*c]u8, @ptrCast(@alignCast(&errTxt))));
        nc.*.err = s;
