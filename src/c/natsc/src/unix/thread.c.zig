...
pub const struct_threadCtx = extern struct {
    entry: natsThreadCb = @import("std").mem.zeroes(natsThreadCb),
    arg: ?*anyopaque = @import("std").mem.zeroes(?*anyopaque),
};
pub export fn natsThread_Create(arg_thread: [*c][*c]natsThread, arg_cb: natsThreadCb, arg_arg: ?*anyopaque) natsStatus {
    ...
    var arg = arg_arg;
    _ = &arg;
    var ctx: [*c]struct_threadCtx = null;
    _ = &ctx;
    ...
    _ = &err;
    natsLib_Retain();
    ctx = @as([*c]struct_threadCtx, @ptrCast(@alignCast(calloc(@as(c_ulong, @bitCast(@as(c_long, @as(c_int, 1)))), @sizeOf(struct_threadCtx)))));
    t = @as([*c]natsThread, @ptrCast(@alignCast(calloc(@as(c_ulong, @bitCast(@as(c_long, @as(c_int, 1)))), @sizeOf(natsThread)))));
    if ((ctx == @as([*c]struct_threadCtx, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) or (t == @as([*c]natsThread, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0)))))))) {
        s = nats_setErrorReal("./src/submodules/nats.c/src/unix/thread.c", "natsThread_Create", @as(c_int, 63), @as(c_uint, @bitCast(NATS_NO_MEMORY)), "%s", natsStatus_GetText(@as(c_uint, @bitCast(NATS_NO_MEMORY))));
    }
    if (s == @as(c_uint, @bitCast(NATS_OK))) {
        ctx.*.entry = cb;
        ctx.*.arg = arg;
        err = pthread_create(t, null, &_threadStart, @as(?*anyopaque, @ptrCast(ctx)));
        if (err != 0) {
            s = nats_setErrorReal("./src/submodules/nats.c/src/unix/thread.c", "natsThread_Create", @as(c_int, 73), @as(c_uint, @bitCast(NATS_SYS_ERROR)), "pthread_create error: %d", __errno_location().*);
        }
    }
    if (s == @as(c_uint, @bitCast(NATS_OK))) {
        thread.* = t;
...
pub export fn natsThread_IsCurrent(arg_t: [*c]natsThread) bool {
    var t = arg_t;
    _ = &t;
    if (pthread_equal(pthread_self(), t.*) == @as(c_int, 0)) return @as(c_int, 0) != 0;
    return @as(c_int, 1) != 0;
}
pub export fn natsThread_Join(arg_t: [*c]natsThread) void {
    var t = arg_t;
    _ = &t;
    if (!natsThread_IsCurrent(t)) {
        if (pthread_join(t.*, null) != @as(c_int, 0)) {
            abort();
        }
    } else {
        _ = pthread_detach(t.*);
...
pub export fn natsThread_Detach(arg_t: [*c]natsThread) void {
    var t = arg_t;
    _ = &t;
    if (pthread_detach(t.*) != @as(c_int, 0)) {
        abort();
    }
}
pub export fn natsThread_Yield() void {
    _ = sched_yield();
}
pub export fn natsThread_Destroy(arg_t: [*c]natsThread) void {
    var t = arg_t;
    _ = &t;
    if (t == @as([*c]natsThread, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) return;
    free(@as(?*anyopaque, @ptrCast(t)));
}
pub export fn natsThreadLocal_CreateKey(arg_tl: [*c]natsThreadLocal, arg_destructor: ?*const fn (?*anyopaque) callconv(.c) void) natsStatus {
    var tl = arg_tl;
    _ = &tl;
    ...
    _ = &ret;
    if ((blk: {
        const tmp = pthread_key_create(tl, destructor);
        ret = tmp;
        break :blk tmp;
    }) != @as(c_int, 0)) {
        return nats_setErrorReal("./src/submodules/nats.c/src/unix/thread.c", "natsThreadLocal_CreateKey", @as(c_int, 149), @as(c_uint, @bitCast(NATS_SYS_ERROR)), "pthread_key_create error: %d", ret);
    }
    return @as(c_uint, @bitCast(NATS_OK));
}
pub export fn natsThreadLocal_Get(arg_tl: natsThreadLocal) ?*anyopaque {
    var tl = arg_tl;
    _ = &tl;
    return pthread_getspecific(tl);
}
pub export fn natsThreadLocal_SetEx(arg_tl: natsThreadLocal, arg_value: ?*const anyopaque, arg_setErr: bool) natsStatus {
    var tl = arg_tl;
    _ = &tl;
    var value = arg_value;
    _ = &value;
    var setErr = arg_setErr;
    _ = &setErr;
    var ret: c_int = undefined;
    _ = &ret;
    if ((blk: {
        const tmp = pthread_setspecific(tl, value);
        ret = tmp;
        break :blk tmp;
    }) != @as(c_int, 0)) {
        if (setErr) return nats_setErrorReal("./src/submodules/nats.c/src/unix/thread.c", "natsThreadLocal_SetEx", @as(c_int, 171), @as(c_uint, @bitCast(NATS_SYS_ERROR)), "pthread_setspecific: %d", ret) else return @as(c_uint, @bitCast(NATS_SYS_ERROR));
    }
    return @as(c_uint, @bitCast(NATS_OK));
}
pub export fn natsThreadLocal_DestroyKey(arg_tl: natsThreadLocal) void {
    var tl = arg_tl;
    _ = &tl;
    _ = pthread_key_delete(tl);
}
pub export fn nats_InitOnce(arg_control: [*c]natsInitOnceType, arg_cb: natsInitOnceCb) bool {
    var control = arg_control;
    _ = &control;
    var cb = arg_cb;
    _ = &cb;
    if (pthread_once(control, cb) != @as(c_int, 0)) return @as(c_int, 0) != 0;
    return @as(c_int, 1) != 0;
}
...
pub fn _threadStart(arg_arg: ?*anyopaque) callconv(.c) ?*anyopaque {
    var arg = arg_arg;
    _ = &arg;
    var c: [*c]struct_threadCtx = @as([*c]struct_threadCtx, @ptrCast(@alignCast(arg)));
    _ = &c;
    nats_setNATSThreadKey();
    c.*.entry.?(c.*.arg);
    free(@as(?*anyopaque, @ptrCast(c)));
...
// ./src/submodules/nats.c/src/unix/../include/n-unix.h:60:9
...
// ./src/submodules/nats.c/src/unix/../err.h:22:9
...
// ./src/submodules/nats.c/src/unix/../err.h:26:9
...
// ./src/submodules/nats.c/src/unix/../msg.h:33:9
...
// ./src/submodules/nats.c/src/unix/../msg.h:43:9
...
// ./src/submodules/nats.c/src/unix/../msg.h:46:9
...
// ./src/submodules/nats.c/src/unix/../msg.h:48:9
...
// ./src/submodules/nats.c/src/unix/../natsp.h:119:9
pub const IF_OK_DUP_STRING = @compileError("unable to translate C expr: unexpected token 'if'");
// ./src/submodules/nats.c/src/unix/../natsp.h:126:9
...
// ./src/submodules/nats.c/src/unix/../natsp.h:146:9
...
pub const threadCtx = struct_threadCtx;
