...
pub export fn natsUrl_Create(arg_newUrl: [*c][*c]natsUrl, arg_urlStr: [*c]const u8) natsStatus {
    var newUrl = arg_newUrl;
    _ = &newUrl;
    var urlStr = arg_urlStr;
    _ = &urlStr;
    ...
    _ = &host;
    var port: [*c]const u8 = null;
    _ = &port;
    var path: [*c]const u8 = null;
    _ = &path;
    var url: [*c]natsUrl = null;
    _ = &url;
    if ((if ((urlStr == @as([*c]const u8, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) or (@as(c_int, @bitCast(@as(c_uint, urlStr[@as(c_uint, @intCast(@as(c_int, 0)))]))) == @as(c_int, '\x00'))) @as(c_int, 1) else @as(c_int, 0)) != 0) return nats_setErrorReal("./src/submodules/nats.c/src/url.c", "natsUrl_Create", @as(c_int, 101), @as(c_uint, @bitCast(NATS_INVALID_ARG)), "%s", natsStatus_GetText(@as(c_uint, @bitCast(NATS_INVALID_ARG))));
    url = @as([*c]natsUrl, @ptrCast(@alignCast(calloc(@as(c_ulong, @bitCast(@as(c_long, @as(c_int, 1)))), @sizeOf(natsUrl)))));
    if (url == @as([*c]natsUrl, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) return nats_setErrorReal("./src/submodules/nats.c/src/url.c", "natsUrl_Create", @as(c_int, 105), @as(c_uint, @bitCast(NATS_NO_MEMORY)), "%s", natsStatus_GetText(@as(c_uint, @bitCast(NATS_NO_MEMORY))));
    s = nats_Trim(&copy, urlStr);
    if (s == @as(c_uint, @bitCast(NATS_OK))) {
        ptr = strstr(copy, "://");
        if (ptr == @as([*c]u8, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) {
            scheme = "nats";
            ptr = copy;
        } else {
            ptr.* = '\x00';
            scheme = @as([*c]const u8, @ptrCast(@alignCast(copy)));
            ptr += @as(usize, @bitCast(@as(isize, @intCast(@as(c_int, 3)))));
        }
    }
    if (s == @as(c_uint, @bitCast(NATS_OK))) {
        var sep: [*c]u8 = strrchr(ptr, @as(c_int, '@'));
        _ = &sep;
        if (sep != @as([*c]u8, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) {
            host = @as([*c]const u8, @ptrCast(@alignCast(sep + @as(usize, @bitCast(@as(isize, @intCast(@as(c_int, 1))))))));
            sep.* = '\x00';
            if (ptr != sep) {
                sep = strchr(ptr, @as(c_int, ':'));
                if (sep != @as([*c]u8, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) {
                    sep.* = '\x00';
                    if (sep != ptr) {
                        user = @as([*c]const u8, @ptrCast(@alignCast(ptr)));
                    }
                    if ((sep + @as(usize, @bitCast(@as(isize, @intCast(@as(c_int, 1)))))) != @as([*c]u8, @ptrCast(@volatileCast(@constCast(host))))) {
                        pwd = @as([*c]const u8, @ptrCast(@alignCast(sep + @as(usize, @bitCast(@as(isize, @intCast(@as(c_int, 1))))))));
                    }
                } else {
                    user = @as([*c]const u8, @ptrCast(@alignCast(ptr)));
                }
            ...
            host = @as([*c]const u8, @ptrCast(@alignCast(ptr)));
        }
    }
    if (s == @as(c_uint, @bitCast(NATS_OK))) {
        ptr = strrchr(host, @as(c_int, ']'));
        if (ptr == @as([*c]u8, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) {
            ptr = @as([*c]u8, @ptrCast(@volatileCast(@constCast(host))));
        }
        ptr = strrchr(ptr, @as(c_int, ':'));
        if (ptr != @as([*c]u8, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) {
            ptr.* = '\x00';
            port = @as([*c]const u8, @ptrCast(@alignCast(ptr + @as(usize, @bitCast(@as(isize, @intCast(@as(c_int, 1))))))));
        }
        if ((if ((host == @as([*c]const u8, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) or (@as(c_int, @bitCast(@as(c_uint, host[@as(c_uint, @intCast(@as(c_int, 0)))]))) == @as(c_int, '\x00'))) @as(c_int, 1) else @as(c_int, 0)) != 0) {
            host = "localhost";
        }
    }
    if (s == @as(c_uint, @bitCast(NATS_OK))) {
        if (port != @as([*c]const u8, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) {
            var sep: [*c]u8 = strchr(port, @as(c_int, '/'));
            _ = &sep;
            if (sep != @as([*c]u8, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) {
                sep.* = '\x00';
                path = @as([*c]const u8, @ptrCast(@alignCast(sep + @as(usize, @bitCast(@as(isize, @intCast(@as(c_int, 1))))))));
            }
        }
        if ((if ((port == @as([*c]const u8, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) or (@as(c_int, @bitCast(@as(c_uint, port[@as(c_uint, @intCast(@as(c_int, 0)))]))) == @as(c_int, '\x00'))) @as(c_int, 1) else @as(c_int, 0)) != 0) {
            url.*.port = 4222;
        } else {
    ...
    if (s == @as(c_uint, @bitCast(NATS_OK))) {
        var userval: [*c]const u8 = if ((if ((user == @as([*c]const u8, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) or (@as(c_int, @bitCast(@as(c_uint, user[@as(c_uint, @intCast(@as(c_int, 0)))]))) == @as(c_int, '\x00'))) @as(c_int, 1) else @as(c_int, 0)) != 0) "" else user;
        _ = &userval;
        var usep: [*c]const u8 = if ((if ((pwd == @as([*c]const u8, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) or (@as(c_int, @bitCast(@as(c_uint, pwd[@as(c_uint, @intCast(@as(c_int, 0)))]))) == @as(c_int, '\x00'))) @as(c_int, 1) else @as(c_int, 0)) != 0) "" else ":";
        _ = &usep;
        var pwdval: [*c]const u8 = if ((if ((pwd == @as([*c]const u8, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) or (@as(c_int, @bitCast(@as(c_uint, pwd[@as(c_uint, @intCast(@as(c_int, 0)))]))) == @as(c_int, '\x00'))) @as(c_int, 1) else @as(c_int, 0)) != 0) "" else pwd;
        _ = &pwdval;
        var hsep: [*c]const u8 = if ((if ((user == @as([*c]const u8, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) or (@as(c_int, @bitCast(@as(c_uint, user[@as(c_uint, @intCast(@as(c_int, 0)))]))) == @as(c_int, '\x00'))) @as(c_int, 1) else @as(c_int, 0)) != 0) "" else "@";
        _ = &hsep;
        var pathsep: [*c]const u8 = if ((if ((path == @as([*c]const u8, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) or (@as(c_int, @bitCast(@as(c_uint, path[@as(c_uint, @intCast(@as(c_int, 0)))]))) == @as(c_int, '\x00'))) @as(c_int, 1) else @as(c_int, 0)) != 0) "" else "/";
        _ = &pathsep;
        var pathval: [*c]const u8 = if ((if ((path == @as([*c]const u8, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) or (@as(c_int, @bitCast(@as(c_uint, path[@as(c_uint, @intCast(@as(c_int, 0)))]))) == @as(c_int, '\x00'))) @as(c_int, 1) else @as(c_int, 0)) != 0) "" else path;
        _ = &pathval;
        {
            url.*.host = strdup(host);
            if (url.*.host == @as([*c]u8, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) {
                s = nats_setErrorReal("./src/submodules/nats.c/src/url.c", "natsUrl_Create", @as(c_int, 203), @as(c_uint, @bitCast(NATS_NO_MEMORY)), "%s", natsStatus_GetText(@as(c_uint, @bitCast(NATS_NO_MEMORY))));
            }
        }
        if (user != @as([*c]const u8, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) if (s == @as(c_uint, @bitCast(NATS_OK))) {
            s = _decodeAndDup(&url.*.username, user);
        };
        if (pwd != @as([*c]const u8, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) if (s == @as(c_uint, @bitCast(NATS_OK))) {
            s = _decodeAndDup(&url.*.password, pwd);
        };
        if ((s == @as(c_uint, @bitCast(NATS_OK))) and (asprintf(&url.*.fullUrl, "%s://%s%s%s%s%s:%d%s%s", scheme, userval, usep, pwdval, hsep, host, url.*.port, pathsep, pathval) < @as(c_int, 0))) {
            s = nats_setErrorReal("./src/submodules/nats.c/src/url.c", "natsUrl_Create", @as(c_int, 213), @as(c_uint, @bitCast(NATS_NO_MEMORY)), "%s", natsStatus_GetText(@as(c_uint, @bitCast(NATS_NO_MEMORY))));
        }
    }
    free(@as(?*anyopaque, @ptrCast(copy)));
    if (s == @as(c_uint, @bitCast(NATS_OK))) {
        newUrl.* = url;
    } else {
        natsUrl_Destroy(url);
    }
    return if (s == @as(c_uint, @bitCast(NATS_OK))) s else nats_updateErrStack(s, "natsUrl_Create");
}
pub export fn natsUrl_Destroy(arg_url: [*c]natsUrl) void {
    var url = arg_url;
    _ = &url;
    if (url == @as([*c]natsUrl, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) return;
    free(@as(?*anyopaque, @ptrCast(url.*.fullUrl)));
    free(@as(?*anyopaque, @ptrCast(url.*.host)));
    free(@as(?*anyopaque, @ptrCast(url.*.username)));
    free(@as(?*anyopaque, @ptrCast(url.*.password)));
    free(@as(?*anyopaque, @ptrCast(url)));
}
...
pub fn _parsePort(arg_port: [*c]c_int, arg_sport: [*c]const u8) callconv(.c) natsStatus {
    var port = arg_port;
    _ = &port;
    var sport = arg_sport;
    _ = &sport;
    ...
    var n: i64 = 0;
    _ = &n;
    n = nats_ParseInt64(sport, @as(c_int, @bitCast(@as(c_uint, @truncate(strlen(sport))))));
    if ((n < @as(i64, @bitCast(@as(c_long, @as(c_int, 0))))) or (n > @as(i64, @bitCast(@as(c_long, @as(c_int, 2147483647)))))) {
        s = nats_setErrorReal("./src/submodules/nats.c/src/url.c", "_parsePort", @as(c_int, 43), @as(c_uint, @bitCast(NATS_INVALID_ARG)), "invalid port '%s'", sport);
    } else {
        port.* = @as(c_int, @bitCast(@as(c_int, @truncate(n))));
    }
    return s;
}
pub fn _decodeAndDup(arg_decoded: [*c][*c]u8, arg_encoded: [*c]const u8) callconv(.c) natsStatus {
    var decoded = arg_decoded;
    _ = &decoded;
    var encoded = arg_encoded;
    _ = &encoded;
    var len: usize = strlen(encoded);
    _ = &len;
    var p: [*c]const u8 = encoded;
    _ = &p;
    var e: [*c]const u8 = encoded + len;
    _ = &e;
    var d: [*c]u8 = undefined;
    _ = &d;
    decoded.* = @as([*c]u8, @ptrCast(@alignCast(malloc(len +% @as(usize, @bitCast(@as(c_long, @as(c_int, 1))))))));
    if (decoded.* == @as([*c]u8, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) {
        return nats_setErrorReal("./src/submodules/nats.c/src/url.c", "_decodeAndDup", @as(c_int, 60), @as(c_uint, @bitCast(NATS_NO_MEMORY)), "%s", natsStatus_GetText(@as(c_uint, @bitCast(NATS_NO_MEMORY))));
    }
    d = decoded.*;
    while (p < e) : (p += 1) {
        ...
        if ((@divExact(@as(c_long, @bitCast(@intFromPtr(e) -% @intFromPtr(p))), @sizeOf(u8)) < @as(c_long, @bitCast(@as(c_long, @as(c_int, 3))))) or (!((@as(c_int, @bitCast(@as(c_uint, (blk: {
            const tmp = @as(c_int, @bitCast(@as(c_uint, (p + @as(usize, @bitCast(@as(isize, @intCast(@as(c_int, 1)))))).*)));
        ...
        }).*))) & @as(c_int, @bitCast(@as(c_uint, @as(c_ushort, @bitCast(@as(c_short, @truncate(_ISxdigit)))))))) != 0) or !((@as(c_int, @bitCast(@as(c_uint, (blk: {
            const tmp = @as(c_int, @bitCast(@as(c_uint, (p + @as(usize, @bitCast(@as(isize, @intCast(@as(c_int, 2)))))).*)));
            if (tmp >= 0) break :blk __ctype_b_loc().* + @as(usize, @intCast(tmp)) else break :blk __ctype_b_loc().* - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
        }).*))) & @as(c_int, @bitCast(@as(c_uint, @as(c_ushort, @bitCast(@as(c_short, @truncate(_ISxdigit)))))))) != 0))) {
            free(@as(?*anyopaque, @ptrCast(decoded.*)));
            decoded.* = null;
            return nats_setErrorReal("./src/submodules/nats.c/src/url.c", "_decodeAndDup", @as(c_int, 75), @as(c_uint, @bitCast(NATS_ERR)), "invalid percent encoding in URL: %s", encoded);
        }
        var buf: [3]u8 = [3]u8{
            p[@as(c_uint, @intCast(@as(c_int, 1)))],
            p[@as(c_uint, @intCast(@as(c_int, 2)))],
            '\x00',
        };
        _ = &buf;
        (blk: {
            ...
            ref.* += 1;
            break :blk tmp;
        }).* = @as(u8, @bitCast(@as(i8, @truncate(strtol(@as([*c]u8, @ptrCast(@alignCast(&buf))), null, @as(c_int, 16))))));
