...
pub const struct___natsSubscriptionControlMessages = extern struct {
    sub: struct_unnamed_5 = @import("std").mem.zeroes(struct_unnamed_5),
    fetch: struct_unnamed_6 = @import("std").mem.zeroes(struct_unnamed_6),
};
...
pub const struct_jsOptionsPublishAsync_7 = extern struct {
...
pub const struct_jsOptionsPullSubscribeAsync_8 = extern struct {
...
pub const struct_jsOptionsStreamPurge_10 = extern struct {
    Subject: [*c]const u8 = @import("std").mem.zeroes([*c]const u8),
    Sequence: u64 = @import("std").mem.zeroes(u64),
    Keep: u64 = @import("std").mem.zeroes(u64),
};
pub const struct_jsOptionsStreamInfo_11 = extern struct {
    DeletedDetails: bool = @import("std").mem.zeroes(bool),
    SubjectsFilter: [*c]const u8 = @import("std").mem.zeroes([*c]const u8),
};
pub const struct_jsOptionsStream_9 = extern struct {
    Purge: struct_jsOptionsStreamPurge_10 = @import("std").mem.zeroes(struct_jsOptionsStreamPurge_10),
    Info: struct_jsOptionsStreamInfo_11 = @import("std").mem.zeroes(struct_jsOptionsStreamInfo_11),
};
pub const struct_jsOptions = extern struct {
    ...
    PublishAsync: struct_jsOptionsPublishAsync_7 = @import("std").mem.zeroes(struct_jsOptionsPublishAsync_7),
    PullSubscribeAsync: struct_jsOptionsPullSubscribeAsync_8 = @import("std").mem.zeroes(struct_jsOptionsPullSubscribeAsync_8),
    Stream: struct_jsOptionsStream_9 = @import("std").mem.zeroes(struct_jsOptionsStream_9),
};
...
pub const struct___jsFetch = extern struct {
    opts: struct_jsOptionsPullSubscribeAsync_8 = @import("std").mem.zeroes(struct_jsOptionsPullSubscribeAsync_8),
...
pub const struct_mismatch_12 = extern struct {
...
pub const struct___jsSub = extern struct {
    ...
    mismatch: struct_mismatch_12 = @import("std").mem.zeroes(struct_mismatch_12),
...
pub const struct___natsConnection = extern struct {
    ...
    el: struct_unnamed_13 = @import("std").mem.zeroes(struct_unnamed_13),
    filter: natsMsgFilter = @import("std").mem.zeroes(natsMsgFilter),
    filterClosure: ?*anyopaque = @import("std").mem.zeroes(?*anyopaque),
    srvVersion: struct_unnamed_14 = @import("std").mem.zeroes(struct_unnamed_14),
};
...
pub const struct_in6_addr = extern struct {
    __in6_u: union_unnamed_26 = @import("std").mem.zeroes(union_unnamed_26),
};
...
const struct_unnamed_47 = extern struct {
    ...
    _bounds: union_unnamed_48 = @import("std").mem.zeroes(union_unnamed_48),
};
...
const union_unnamed_42 = extern union {
    _pad: [28]c_int,
    _kill: struct_unnamed_43,
    _timer: struct_unnamed_44,
    _rt: struct_unnamed_45,
    _sigchld: struct_unnamed_46,
    _sigfault: struct_unnamed_47,
    _sigpoll: struct_unnamed_50,
    _sigsys: struct_unnamed_51,
};
pub const siginfo_t = extern struct {
    ...
    __pad0: c_int = @import("std").mem.zeroes(c_int),
    _sifields: union_unnamed_42 = @import("std").mem.zeroes(union_unnamed_42),
};
...
pub const struct_sigaction = extern struct {
    __sigaction_handler: union_unnamed_60 = @import("std").mem.zeroes(union_unnamed_60),
...
pub export fn natsBuf_InitWithBackend(arg_newBuf: [*c]natsBuffer, arg_data: [*c]u8, arg_len: c_int, arg_capacity: c_int) natsStatus {
    var newBuf = arg_newBuf;
    _ = &newBuf;
    var data = arg_data;
    _ = &data;
    var len = arg_len;
    ...
    _ = &capacity;
    if (data == @as([*c]u8, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) return @as(c_uint, @bitCast(NATS_INVALID_ARG));
    return _init(newBuf, data, len, capacity);
}
pub export fn natsBuf_Init(arg_buf: [*c]natsBuffer, arg_capacity: c_int) natsStatus {
    var buf = arg_buf;
    _ = &buf;
    var capacity = arg_capacity;
    _ = &capacity;
    return _init(buf, null, @as(c_int, 0), capacity);
}
pub export fn natsBuf_CreateWithBackend(arg_newBuf: [*c][*c]natsBuffer, arg_data: [*c]u8, arg_len: c_int, arg_capacity: c_int) natsStatus {
    var newBuf = arg_newBuf;
    _ = &newBuf;
    var data = arg_data;
    _ = &data;
    ...
    _ = &s;
    if (data == @as([*c]u8, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) return nats_setErrorReal("./src/submodules/nats.c/src/buf.c", "natsBuf_CreateWithBackend", @as(c_int, 94), @as(c_uint, @bitCast(NATS_INVALID_ARG)), "%s", natsStatus_GetText(@as(c_uint, @bitCast(NATS_INVALID_ARG))));
    s = _newBuf(newBuf, data, len, capacity);
    return if (s == @as(c_uint, @bitCast(NATS_OK))) s else nats_updateErrStack(s, "natsBuf_CreateWithBackend");
}
pub export fn natsBuf_Create(arg_newBuf: [*c][*c]natsBuffer, arg_capacity: c_int) natsStatus {
    var newBuf = arg_newBuf;
    _ = &newBuf;
    var capacity = arg_capacity;
    _ = &capacity;
    var s: natsStatus = _newBuf(newBuf, null, @as(c_int, 0), capacity);
    _ = &s;
    return if (s == @as(c_uint, @bitCast(NATS_OK))) s else nats_updateErrStack(s, "natsBuf_Create");
}
pub export fn natsBuf_Reset(arg_buf: [*c]natsBuffer) void {
    var buf = arg_buf;
    _ = &buf;
    buf.*.len = 0;
    buf.*.pos = buf.*.data;
}
pub export fn natsBuf_MoveTo(arg_buf: [*c]natsBuffer, arg_newPosition: c_int) void {
    var buf = arg_buf;
    _ = &buf;
    var newPosition = arg_newPosition;
    _ = &newPosition;
    _ = blk: {
        _ = @sizeOf(c_int);
        break :blk blk_1: {
            break :blk_1 if (newPosition <= buf.*.capacity) {} else {
                __assert_fail("newPosition <= buf->capacity", "./src/submodules/nats.c/src/buf.c", @as(c_uint, @bitCast(@as(c_int, 118))), "void natsBuf_MoveTo(natsBuffer *, int)");
            };
        };
    };
    buf.*.len = newPosition;
    buf.*.pos = buf.*.data + @as(usize, @bitCast(@as(isize, @intCast(newPosition))));
}
pub export fn natsBuf_Expand(arg_buf: [*c]natsBuffer, arg_newSize: c_int) natsStatus {
    var buf = arg_buf;
    _ = &buf;
    var newSize = arg_newSize;
    _ = &newSize;
    var offset: c_int = @as(c_int, @bitCast(@as(c_int, @truncate(@divExact(@as(c_long, @bitCast(@intFromPtr(buf.*.pos) -% @intFromPtr(buf.*.data))), @sizeOf(u8))))));
    _ = &offset;
    var newData: [*c]u8 = null;
    _ = &newData;
    if (newSize <= buf.*.capacity) return nats_setErrorReal("./src/submodules/nats.c/src/buf.c", "natsBuf_Expand", @as(c_int, 131), @as(c_uint, @bitCast(NATS_INVALID_ARG)), "%s", natsStatus_GetText(@as(c_uint, @bitCast(NATS_INVALID_ARG))));
    if (buf.*.ownData) {
        newData = @as([*c]u8, @ptrCast(@alignCast(realloc(@as(?*anyopaque, @ptrCast(buf.*.data)), @as(c_ulong, @bitCast(@as(c_long, newSize)))))));
        if (newData == @as([*c]u8, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) return nats_setErrorReal("./src/submodules/nats.c/src/buf.c", "natsBuf_Expand", @as(c_int, 137), @as(c_uint, @bitCast(NATS_NO_MEMORY)), "%s", natsStatus_GetText(@as(c_uint, @bitCast(NATS_NO_MEMORY))));
    } else {
        newData = @as([*c]u8, @ptrCast(@alignCast(malloc(@as(c_ulong, @bitCast(@as(c_long, newSize)))))));
        if (newData == @as([*c]u8, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) return nats_setErrorReal("./src/submodules/nats.c/src/buf.c", "natsBuf_Expand", @as(c_int, 143), @as(c_uint, @bitCast(NATS_NO_MEMORY)), "%s", natsStatus_GetText(@as(c_uint, @bitCast(NATS_NO_MEMORY))));
        _ = memcpy(@as(?*anyopaque, @ptrCast(newData)), @as(?*const anyopaque, @ptrCast(buf.*.data)), @as(c_ulong, @bitCast(@as(c_long, buf.*.len))));
        buf.*.ownData = @as(c_int, 1) != 0;
    }
    if (buf.*.data != newData) {
        buf.*.data = newData;
        buf.*.pos = buf.*.data + @as(usize, @bitCast(@as(isize, @intCast(offset))));
    }
    buf.*.capacity = newSize;
    return @as(c_uint, @bitCast(NATS_OK));
}
pub export fn natsBuf_Append(arg_buf: [*c]natsBuffer, arg_data: [*c]const u8, arg_dataLen: c_int) natsStatus {
    var buf = arg_buf;
    _ = &buf;
    var data = arg_data;
    _ = &data;
    ...
    var n: i64 = undefined;
    _ = &n;
    if (dataLen == -@as(c_int, 1)) {
        dataLen = @as(c_int, @bitCast(@as(c_uint, @truncate(strlen(data)))));
    }
    n = @as(i64, @bitCast(@as(c_long, buf.*.len))) + @as(i64, @bitCast(@as(c_long, dataLen)));
    if ((n < @as(i64, @bitCast(@as(c_long, @as(c_int, 0))))) or (n >= @as(i64, @bitCast(@as(c_long, @as(c_int, 2147483647)))))) return nats_setErrorReal("./src/submodules/nats.c/src/buf.c", "natsBuf_Append", @as(c_int, 172), @as(c_uint, @bitCast(NATS_NO_MEMORY)), "%s", natsStatus_GetText(@as(c_uint, @bitCast(NATS_NO_MEMORY))));
    if (n > @as(i64, @bitCast(@as(c_long, buf.*.capacity)))) {
        var extra: i64 = @as(i64, @intFromFloat(@as(f64, @floatFromInt(n)) * 0.1));
        _ = &extra;
        var newSize: i64 = undefined;
        _ = &newSize;
        newSize = n + (if (extra < @as(i64, @bitCast(@as(c_long, @as(c_int, 64))))) @as(i64, @bitCast(@as(c_long, @as(c_int, 64)))) else extra);
        if (newSize >= @as(i64, @bitCast(@as(c_long, @as(c_int, 2147483647))))) return nats_setErrorReal("./src/submodules/nats.c/src/buf.c", "natsBuf_Append", @as(c_int, 185), @as(c_uint, @bitCast(NATS_NO_MEMORY)), "%s", natsStatus_GetText(@as(c_uint, @bitCast(NATS_NO_MEMORY))));
        s = natsBuf_Expand(buf, @as(c_int, @bitCast(@as(c_int, @truncate(newSize)))));
    }
    if (s == @as(c_uint, @bitCast(NATS_OK))) {
        _ = memcpy(@as(?*anyopaque, @ptrCast(buf.*.pos)), @as(?*const anyopaque, @ptrCast(data)), @as(c_ulong, @bitCast(@as(c_long, dataLen))));
        buf.*.pos += @as(usize, @bitCast(@as(isize, @intCast(dataLen))));
        buf.*.len += dataLen;
    }
    return if (s == @as(c_uint, @bitCast(NATS_OK))) s else nats_updateErrStack(s, "natsBuf_Append");
}
pub export fn natsBuf_AppendByte(arg_buf: [*c]natsBuffer, arg_b: u8) natsStatus {
    var buf = arg_buf;
    _ = &buf;
    var b = arg_b;
    _ = &b;
    var s: natsStatus = @as(c_uint, @bitCast(NATS_OK));
    _ = &s;
    var c: c_int = buf.*.capacity;
    _ = &c;
    if (buf.*.len == c) {
        var extra: c_int = @as(c_int, @intFromFloat(@as(f64, @floatFromInt(c)) * 0.1));
        _ = &extra;
        var newSize: c_int = undefined;
        _ = &newSize;
        newSize = c + (if (extra < @as(c_int, 64)) @as(c_int, 64) else extra);
        if (newSize < @as(c_int, 0)) return nats_setErrorReal("./src/submodules/nats.c/src/buf.c", "natsBuf_AppendByte", @as(c_int, 217), @as(c_uint, @bitCast(NATS_NO_MEMORY)), "%s", natsStatus_GetText(@as(c_uint, @bitCast(NATS_NO_MEMORY))));
    ...
    return if (s == @as(c_uint, @bitCast(NATS_OK))) s else nats_updateErrStack(s, "natsBuf_AppendByte");
}
pub export fn natsBuf_Consume(arg_buf: [*c]natsBuffer, arg_n: c_int) void {
    var buf = arg_buf;
    _ = &buf;
    var n = arg_n;
    _ = &n;
    ...
    _ = blk: {
        _ = @sizeOf(c_int);
        break :blk blk_1: {
            break :blk_1 if (n <= buf.*.len) {} else {
                __assert_fail("n <= buf->len", "./src/submodules/nats.c/src/buf.c", @as(c_uint, @bitCast(@as(c_int, 236))), "void natsBuf_Consume(natsBuffer *, int)");
            };
        };
    };
    remaining = buf.*.len - n;
    if (remaining > @as(c_int, 0)) {
        _ = memmove(@as(?*anyopaque, @ptrCast(buf.*.data)), @as(?*const anyopaque, @ptrCast(buf.*.data + @as(usize, @bitCast(@as(isize, @intCast(n)))))), @as(c_ulong, @bitCast(@as(c_long, remaining))));
    }
    buf.*.len = remaining;
    buf.*.pos = buf.*.data + @as(usize, @bitCast(@as(isize, @intCast(remaining))));
}
pub export fn natsBuf_Destroy(arg_buf: [*c]natsBuffer) void {
    var buf = arg_buf;
    _ = &buf;
    if (buf == @as([*c]natsBuffer, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) return;
    if (buf.*.ownData) {
        free(@as(?*anyopaque, @ptrCast(buf.*.data)));
    }
    if (buf.*.doFree) {
        free(@as(?*anyopaque, @ptrCast(buf)));
    } else {
        _ = memset(@as(?*anyopaque, @ptrCast(buf)), @as(c_int, 0), @sizeOf(natsBuffer));
    }
}
...
pub fn _init(arg_newBuf: [*c]natsBuffer, arg_data: [*c]u8, arg_len: c_int, arg_capacity: c_int) callconv(.c) natsStatus {
    var newBuf = arg_newBuf;
    _ = &newBuf;
    var data = arg_data;
    _ = &data;
    ...
    var capacity = arg_capacity;
    _ = &capacity;
    var buf: [*c]natsBuffer = newBuf;
    _ = &buf;
    buf.*.doFree = @as(c_int, 0) != 0;
    if (data != @as([*c]u8, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) {
        buf.*.data = data;
        buf.*.ownData = @as(c_int, 0) != 0;
    } else {
        buf.*.data = @as([*c]u8, @ptrCast(@alignCast(malloc(@as(c_ulong, @bitCast(@as(c_long, capacity)))))));
        if (buf.*.data == @as([*c]u8, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) return nats_setErrorReal("./src/submodules/nats.c/src/buf.c", "_init", @as(c_int, 39), @as(c_uint, @bitCast(NATS_NO_MEMORY)), "%s", natsStatus_GetText(@as(c_uint, @bitCast(NATS_NO_MEMORY))));
        buf.*.ownData = @as(c_int, 1) != 0;
    }
    buf.*.pos = buf.*.data + @as(usize, @bitCast(@as(isize, @intCast(len))));
    buf.*.len = len;
    buf.*.capacity = capacity;
    return @as(c_uint, @bitCast(NATS_OK));
}
pub fn _newBuf(arg_newBuf: [*c][*c]natsBuffer, arg_data: [*c]u8, arg_len: c_int, arg_capacity: c_int) callconv(.c) natsStatus {
    var newBuf = arg_newBuf;
    _ = &newBuf;
    var data = arg_data;
    _ = &data;
    ...
    var capacity = arg_capacity;
    _ = &capacity;
    var buf: [*c]natsBuffer = undefined;
    _ = &buf;
    buf = @as([*c]natsBuffer, @ptrCast(@alignCast(malloc(@sizeOf(natsBuffer)))));
    if (buf == @as([*c]natsBuffer, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) return nats_setErrorReal("./src/submodules/nats.c/src/buf.c", "_newBuf", @as(c_int, 73), @as(c_uint, @bitCast(NATS_NO_MEMORY)), "%s", natsStatus_GetText(@as(c_uint, @bitCast(NATS_NO_MEMORY))));
    if (_init(buf, data, len, capacity) != @as(c_uint, @bitCast(NATS_OK))) {
        free(@as(?*anyopaque, @ptrCast(buf)));
        return if (NATS_NO_MEMORY == NATS_OK) @as(c_uint, @bitCast(NATS_NO_MEMORY)) else nats_updateErrStack(@as(c_uint, @bitCast(NATS_NO_MEMORY)), "_newBuf");
    }
    buf.*.doFree = @as(c_int, 1) != 0;
    newBuf.* = buf;
    return @as(c_uint, @bitCast(NATS_OK));
}
