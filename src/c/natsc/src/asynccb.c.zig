...
pub export fn natsAsyncCb_PostConnHandler(arg_nc: [*c]struct___natsConnection, arg_type: natsAsyncCbType) void {
    var nc = arg_nc;
    _ = &nc;
    var @"type" = arg_type;
    _ = &@"type";
    _createAndPostCb(@"type", nc, null, @as(c_uint, @bitCast(NATS_OK)), null, @as(?*anyopaque, @ptrFromInt(@as(c_int, 0))));
}
pub export fn natsAsyncCb_PostErrHandler(arg_nc: [*c]struct___natsConnection, arg_sub: [*c]struct___natsSubscription, arg_err: natsStatus, arg_errTxt: [*c]u8) void {
    var nc = arg_nc;
    _ = &nc;
    var sub = arg_sub;
    _ = &sub;
    ...
    _ = &errTxt;
    _createAndPostCb(@as(c_uint, @bitCast(ASYNC_ERROR)), nc, sub, err, errTxt, @as(?*anyopaque, @ptrFromInt(@as(c_int, 0))));
}
pub export fn natsAsyncCb_Destroy(arg_info: [*c]natsAsyncCbInfo) void {
    var info = arg_info;
    _ = &info;
    ...
    _ = &sub;
    if (info == @as([*c]natsAsyncCbInfo, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) return;
    nc = info.*.nc;
    sub = info.*.sub;
...
pub fn _freeAsyncCbInfo(arg_info: [*c]natsAsyncCbInfo) callconv(.c) void {
    var info = arg_info;
    _ = &info;
    free(@as(?*anyopaque, @ptrCast(info.*.errTxt)));
    free(@as(?*anyopaque, @ptrCast(info)));
}
pub fn _createAndPostCb(arg_type: natsAsyncCbType, arg_nc: [*c]natsConnection, arg_sub: [*c]natsSubscription, arg_err: natsStatus, arg_errTxt: [*c]u8, arg_scPtr: ?*anyopaque) callconv(.c) void {
    var @"type" = arg_type;
    _ = &@"type";
    var nc = arg_nc;
    _ = &nc;
    ...
    _ = &s;
    var cb: [*c]natsAsyncCbInfo = undefined;
    _ = &cb;
    cb = @as([*c]natsAsyncCbInfo, @ptrCast(@alignCast(calloc(@as(c_ulong, @bitCast(@as(c_long, @as(c_int, 1)))), @sizeOf(natsAsyncCbInfo)))));
    if (cb == @as([*c]natsAsyncCbInfo, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) {
        return;
    }
    cb.*.type = @"type";
    cb.*.nc = nc;
