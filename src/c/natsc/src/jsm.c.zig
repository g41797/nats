...
pub export fn jsStreamConfig_Init(arg_cfg: [*c]jsStreamConfig) natsStatus {
    var cfg = arg_cfg;
    _ = &cfg;
    if (cfg == @as([*c]jsStreamConfig, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) return nats_setErrorReal("./src/submodules/nats.c/src/jsm.c", "jsStreamConfig_Init", @as(c_int, 1270), @as(c_uint, @bitCast(NATS_INVALID_ARG)), "%s", natsStatus_GetText(@as(c_uint, @bitCast(NATS_INVALID_ARG))));
    _ = memset(@as(?*anyopaque, @ptrCast(cfg)), @as(c_int, 0), @sizeOf(jsStreamConfig));
    cfg.*.Retention = @as(c_uint, @bitCast(js_LimitsPolicy));
    cfg.*.MaxConsumers = @as(i64, @bitCast(@as(c_long, -@as(c_int, 1))));
    cfg.*.MaxMsgs = @as(i64, @bitCast(@as(c_long, -@as(c_int, 1))));
    cfg.*.MaxBytes = @as(i64, @bitCast(@as(c_long, -@as(c_int, 1))));
    cfg.*.MaxMsgSize = -@as(c_int, 1);
    cfg.*.Storage = @as(c_uint, @bitCast(js_FileStorage));
    cfg.*.Discard = @as(c_uint, @bitCast(js_DiscardOld));
    cfg.*.Replicas = 1;
    cfg.*.Compression = @as(c_uint, @bitCast(js_StorageCompressionNone));
    return @as(c_uint, @bitCast(NATS_OK));
}
pub export fn jsPlacement_Init(arg_placement: [*c]jsPlacement) natsStatus {
    var placement = arg_placement;
    _ = &placement;
    if (placement == @as([*c]jsPlacement, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) return nats_setErrorReal("./src/submodules/nats.c/src/jsm.c", "jsPlacement_Init", @as(c_int, 2763), @as(c_uint, @bitCast(NATS_INVALID_ARG)), "%s", natsStatus_GetText(@as(c_uint, @bitCast(NATS_INVALID_ARG))));
    _ = memset(@as(?*anyopaque, @ptrCast(placement)), @as(c_int, 0), @sizeOf(jsPlacement));
    return @as(c_uint, @bitCast(NATS_OK));
}
pub export fn jsStreamSource_Init(arg_source: [*c]jsStreamSource) natsStatus {
    var source = arg_source;
    _ = &source;
    if (source == @as([*c]jsStreamSource, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) return nats_setErrorReal("./src/submodules/nats.c/src/jsm.c", "jsStreamSource_Init", @as(c_int, 2773), @as(c_uint, @bitCast(NATS_INVALID_ARG)), "%s", natsStatus_GetText(@as(c_uint, @bitCast(NATS_INVALID_ARG))));
    _ = memset(@as(?*anyopaque, @ptrCast(source)), @as(c_int, 0), @sizeOf(jsStreamSource));
    return @as(c_uint, @bitCast(NATS_OK));
}
pub export fn jsExternalStream_Init(arg_external: [*c]jsExternalStream) natsStatus {
    var external = arg_external;
    _ = &external;
    if (external == @as([*c]jsExternalStream, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) return nats_setErrorReal("./src/submodules/nats.c/src/jsm.c", "jsExternalStream_Init", @as(c_int, 2784), @as(c_uint, @bitCast(NATS_INVALID_ARG)), "%s", natsStatus_GetText(@as(c_uint, @bitCast(NATS_INVALID_ARG))));
    _ = memset(@as(?*anyopaque, @ptrCast(external)), @as(c_int, 0), @sizeOf(jsExternalStream));
    return @as(c_uint, @bitCast(NATS_OK));
}
pub export fn jsRePublish_Init(arg_rp: [*c]jsRePublish) natsStatus {
    var rp = arg_rp;
    _ = &rp;
    if (rp == @as([*c]jsRePublish, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) return nats_setErrorReal("./src/submodules/nats.c/src/jsm.c", "jsRePublish_Init", @as(c_int, 2794), @as(c_uint, @bitCast(NATS_INVALID_ARG)), "%s", natsStatus_GetText(@as(c_uint, @bitCast(NATS_INVALID_ARG))));
    _ = memset(@as(?*anyopaque, @ptrCast(rp)), @as(c_int, 0), @sizeOf(jsRePublish));
    return @as(c_uint, @bitCast(NATS_OK));
}
pub export fn js_AddStream(arg_new_si: [*c][*c]jsStreamInfo, arg_js: [*c]jsCtx, arg_cfg: [*c]jsStreamConfig, arg_opts: [*c]jsOptions, arg_errCode: [*c]jsErrCode) natsStatus {
    var new_si = arg_new_si;
    _ = &new_si;
    var js = arg_js;
    _ = &js;
    var cfg = arg_cfg;
    ...
    _ = &errCode;
    var s: natsStatus = _addOrUpdate(new_si, @as(c_uint, @bitCast(jsStreamActionCreate)), js, cfg, opts, errCode);
    _ = &s;
    return if (s == @as(c_uint, @bitCast(NATS_OK))) s else nats_updateErrStack(s, "js_AddStream");
}
pub export fn js_UpdateStream(arg_new_si: [*c][*c]jsStreamInfo, arg_js: [*c]jsCtx, arg_cfg: [*c]jsStreamConfig, arg_opts: [*c]jsOptions, arg_errCode: [*c]jsErrCode) natsStatus {
    var new_si = arg_new_si;
    _ = &new_si;
    var js = arg_js;
    _ = &js;
    ...
    var errCode = arg_errCode;
    _ = &errCode;
    var s: natsStatus = _addOrUpdate(new_si, @as(c_uint, @bitCast(jsStreamActionUpdate)), js, cfg, opts, errCode);
    _ = &s;
    return if (s == @as(c_uint, @bitCast(NATS_OK))) s else nats_updateErrStack(s, "js_UpdateStream");
}
pub export fn js_PurgeStream(arg_js: [*c]jsCtx, arg_stream: [*c]const u8, arg_opts: [*c]jsOptions, arg_errCode: [*c]jsErrCode) natsStatus {
    var js = arg_js;
    _ = &js;
    ...
    var errCode = arg_errCode;
    _ = &errCode;
    var s: natsStatus = _purgeOrDelete(@as(c_int, 1) != 0, js, stream, opts, errCode);
    _ = &s;
    return if (s == @as(c_uint, @bitCast(NATS_OK))) s else nats_updateErrStack(s, "js_PurgeStream");
}
pub export fn js_DeleteStream(arg_js: [*c]jsCtx, arg_stream: [*c]const u8, arg_opts: [*c]jsOptions, arg_errCode: [*c]jsErrCode) natsStatus {
    var js = arg_js;
    _ = &js;
    var stream = arg_stream;
    _ = &stream;
    ...
    var errCode = arg_errCode;
    _ = &errCode;
    var s: natsStatus = _purgeOrDelete(@as(c_int, 0) != 0, js, stream, opts, errCode);
    _ = &s;
    return if (s == @as(c_uint, @bitCast(NATS_OK))) s else nats_updateErrStack(s, "js_DeleteStream");
}
pub export fn js_GetMsg(arg_msg: [*c][*c]natsMsg, arg_js: [*c]jsCtx, arg_stream: [*c]const u8, arg_seq: u64, arg_opts: [*c]jsOptions, arg_errCode: [*c]jsErrCode) natsStatus {
    var msg = arg_msg;
    _ = &msg;
    var js = arg_js;
    _ = &js;
    ...
    var errCode = arg_errCode;
    _ = &errCode;
    var s: natsStatus = undefined;
    _ = &s;
    if (errCode != @as([*c]jsErrCode, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) {
        errCode.* = 0;
    }
    if (seq < @as(u64, @bitCast(@as(c_long, @as(c_int, 1))))) return nats_setErrorReal("./src/submodules/nats.c/src/jsm.c", "js_GetMsg", @as(c_int, 1934), @as(c_uint, @bitCast(NATS_INVALID_ARG)), "%s", natsStatus_GetText(@as(c_uint, @bitCast(NATS_INVALID_ARG))));
    s = _getMsg(msg, js, stream, seq, null, opts, errCode);
    return if (s == @as(c_uint, @bitCast(NATS_OK))) s else nats_updateErrStack(s, "js_GetMsg");
}
pub export fn js_GetLastMsg(arg_msg: [*c][*c]natsMsg, arg_js: [*c]jsCtx, arg_stream: [*c]const u8, arg_subject: [*c]const u8, arg_opts: [*c]jsOptions, arg_errCode: [*c]jsErrCode) natsStatus {
    var msg = arg_msg;
    _ = &msg;
    var js = arg_js;
    _ = &js;
    ...
    if ((if ((subject == @as([*c]const u8, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) or (@as(c_int, @bitCast(@as(c_uint, subject[@as(c_uint, @intCast(@as(c_int, 0)))]))) == @as(c_int, '\x00'))) @as(c_int, 1) else @as(c_int, 0)) != 0) return nats_setErrorReal("./src/submodules/nats.c/src/jsm.c", "js_GetLastMsg", @as(c_int, 1949), @as(c_uint, @bitCast(NATS_INVALID_ARG)), "%s", natsStatus_GetText(@as(c_uint, @bitCast(NATS_INVALID_ARG))));
    s = _getMsg(msg, js, stream, @as(u64, @bitCast(@as(c_long, @as(c_int, 0)))), subject, opts, errCode);
    return if (s == @as(c_uint, @bitCast(NATS_OK))) s else nats_updateErrStack(s, "js_GetLastMsg");
}
pub export fn jsDirectGetMsgOptions_Init(arg_opts: [*c]jsDirectGetMsgOptions) natsStatus {
    var opts = arg_opts;
    _ = &opts;
    if (opts == @as([*c]jsDirectGetMsgOptions, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) return nats_setErrorReal("./src/submodules/nats.c/src/jsm.c", "jsDirectGetMsgOptions_Init", @as(c_int, 1959), @as(c_uint, @bitCast(NATS_INVALID_ARG)), "%s", natsStatus_GetText(@as(c_uint, @bitCast(NATS_INVALID_ARG))));
    _ = memset(@as(?*anyopaque, @ptrCast(opts)), @as(c_int, 0), @sizeOf(jsDirectGetMsgOptions));
    return @as(c_uint, @bitCast(NATS_OK));
}
pub export fn js_DirectGetMsg(arg_msg: [*c][*c]natsMsg, arg_js: [*c]jsCtx, arg_stream: [*c]const u8, arg_opts: [*c]jsOptions, arg_dgOpts: [*c]jsDirectGetMsgOptions) natsStatus {
    var msg = arg_msg;
    _ = &msg;
    var js = arg_js;
    _ = &js;
    ...
    var opts = arg_opts;
    _ = &opts;
    var dgOpts = arg_dgOpts;
    _ = &dgOpts;
    var s: natsStatus = @as(c_uint, @bitCast(NATS_OK));
    _ = &s;
    var subj: [*c]u8 = null;
    _ = &subj;
    var resp: [*c]natsMsg = null;
    _ = &resp;
    var nc: [*c]natsConnection = null;
    _ = &nc;
    var freePfx: bool = @as(c_int, 0) != 0;
    _ = &freePfx;
    var comma: bool = @as(c_int, 0) != 0;
    _ = &comma;
    var doLBS: bool = @as(c_int, 0) != 0;
    _ = &doLBS;
    var o: jsOptions = undefined;
    _ = &o;
    var buffer: [64]u8 = undefined;
    _ = &buffer;
    var buf: natsBuffer = natsBuffer{
        .data = null,
        .pos = null,
        .len = @as(c_int, 0),
        .capacity = @as(c_int, 0),
        .ownData = @as(c_int, 0) != 0,
        .doFree = @as(c_int, 0) != 0,
    };
    _ = &buf;
    if (((msg == @as([*c][*c]natsMsg, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) or (js == @as([*c]jsCtx, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0)))))))) or (dgOpts == @as([*c]jsDirectGetMsgOptions, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0)))))))) return nats_setErrorReal("./src/submodules/nats.c/src/jsm.c", "js_DirectGetMsg", @as(c_int, 2035), @as(c_uint, @bitCast(NATS_INVALID_ARG)), "%s", natsStatus_GetText(@as(c_uint, @bitCast(NATS_INVALID_ARG))));
    if ((if ((stream == @as([*c]const u8, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) or (@as(c_int, @bitCast(@as(c_uint, stream[@as(c_uint, @intCast(@as(c_int, 0)))]))) == @as(c_int, '\x00'))) @as(c_int, 1) else @as(c_int, 0)) != 0) return nats_setErrorReal("./src/submodules/nats.c/src/jsm.c", "js_DirectGetMsg", @as(c_int, 2038), @as(c_uint, @bitCast(NATS_INVALID_ARG)), "%s", "stream name is required");
    doLBS = !((if ((dgOpts.*.LastBySubject == @as([*c]const u8, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) or (@as(c_int, @bitCast(@as(c_uint, dgOpts.*.LastBySubject[@as(c_uint, @intCast(@as(c_int, 0)))]))) == @as(c_int, '\x00'))) @as(c_int, 1) else @as(c_int, 0)) != 0);
    s = js_setOpts(&nc, &freePfx, js, opts, &o);
    if (s == @as(c_uint, @bitCast(NATS_OK))) {
        if (doLBS) {
            if (asprintf(&subj, "%.*s.DIRECT.GET.%s.%s", js_lenWithoutTrailingDot(o.Prefix), o.Prefix, stream, dgOpts.*.LastBySubject) < @as(c_int, 0)) {
                s = nats_setErrorReal("./src/submodules/nats.c/src/jsm.c", "js_DirectGetMsg", @as(c_int, 2048), @as(c_uint, @bitCast(NATS_NO_MEMORY)), "%s", natsStatus_GetText(@as(c_uint, @bitCast(NATS_NO_MEMORY))));
            }
        } else {
            if (asprintf(&subj, "%.*s.DIRECT.GET.%s", js_lenWithoutTrailingDot(o.Prefix), o.Prefix, stream) < @as(c_int, 0)) {
                s = nats_setErrorReal("./src/submodules/nats.c/src/jsm.c", "js_DirectGetMsg", @as(c_int, 2053), @as(c_uint, @bitCast(NATS_NO_MEMORY)), "%s", natsStatus_GetText(@as(c_uint, @bitCast(NATS_NO_MEMORY))));
            }
        }
        if (freePfx) {
            free(@as(?*anyopaque, @ptrCast(@as([*c]u8, @ptrCast(@volatileCast(@constCast(o.Prefix)))))));
        }
    }
    if ((s == @as(c_uint, @bitCast(NATS_OK))) and (@as(c_int, @intFromBool(doLBS)) != 0)) {
        if (s == @as(c_uint, @bitCast(NATS_OK))) {
            s = natsConnection_Request(&resp, js.*.nc, subj, null, @as(c_int, 0), o.Wait);
        }
    } else if (s == @as(c_uint, @bitCast(NATS_OK))) {
        if (s == @as(c_uint, @bitCast(NATS_OK))) {
            s = natsBuf_InitWithBackend(&buf, @as([*c]u8, @ptrCast(@alignCast(&buffer))), @as(c_int, 0), @as(c_int, @bitCast(@as(c_uint, @truncate(@sizeOf([64]u8))))));
        }
        if (s == @as(c_uint, @bitCast(NATS_OK))) {
            s = natsBuf_AppendByte(&buf, @as(u8, @bitCast(@as(i8, @truncate(@as(c_int, '{'))))));
        }
        if ((s == @as(c_uint, @bitCast(NATS_OK))) and (dgOpts.*.Sequence > @as(u64, @bitCast(@as(c_long, @as(c_int, 0)))))) {
            comma = @as(c_int, 1) != 0;
            s = nats_marshalULong(&buf, @as(c_int, 0) != 0, "seq", dgOpts.*.Sequence);
        }
        if ((s == @as(c_uint, @bitCast(NATS_OK))) and !((if ((dgOpts.*.NextBySubject == @as([*c]const u8, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) or (@as(c_int, @bitCast(@as(c_uint, dgOpts.*.NextBySubject[@as(c_uint, @intCast(@as(c_int, 0)))]))) == @as(c_int, '\x00'))) @as(c_int, 1) else @as(c_int, 0)) != 0)) {
            if (comma) {
                s = natsBuf_AppendByte(&buf, @as(u8, @bitCast(@as(i8, @truncate(@as(c_int, ','))))));
            }
            comma = @as(c_int, 1) != 0;
            if (s == @as(c_uint, @bitCast(NATS_OK))) {
                s = natsBuf_Append(&buf, "\"next_by_subj\":\"", -@as(c_int, 1));
            }
            if (s == @as(c_uint, @bitCast(NATS_OK))) {
                s = natsBuf_Append(&buf, dgOpts.*.NextBySubject, -@as(c_int, 1));
            }
            if (s == @as(c_uint, @bitCast(NATS_OK))) {
                s = natsBuf_AppendByte(&buf, @as(u8, @bitCast(@as(i8, @truncate(@as(c_int, '"'))))));
            }
        ...
        if (s == @as(c_uint, @bitCast(NATS_OK))) {
            s = natsConnection_Request(&resp, js.*.nc, subj, @as(?*const anyopaque, @ptrCast((&buf).*.data)), (&buf).*.len, o.Wait);
        }
        natsBuf_Destroy(&buf);
    }
    if (s == @as(c_uint, @bitCast(NATS_OK))) {
        s = js_directGetMsgToJSMsg(stream, resp);
    }
    free(@as(?*anyopaque, @ptrCast(subj)));
    if (s == @as(c_uint, @bitCast(NATS_OK))) {
        msg.* = resp;
    } else {
        natsMsg_Destroy(resp);
    }
    return if (s == @as(c_uint, @bitCast(NATS_OK))) s else nats_updateErrStack(s, "js_DirectGetMsg");
}
pub export fn js_DeleteMsg(arg_js: [*c]jsCtx, arg_stream: [*c]const u8, arg_seq: u64, arg_opts: [*c]jsOptions, arg_errCode: [*c]jsErrCode) natsStatus {
    var js = arg_js;
    _ = &js;
    var stream = arg_stream;
    _ = &stream;
    ...
    var s: natsStatus = undefined;
    _ = &s;
    s = _deleteMsg(js, @as(c_int, 1) != 0, stream, seq, opts, errCode);
    return if (s == @as(c_uint, @bitCast(NATS_OK))) s else nats_updateErrStack(s, "js_DeleteMsg");
}
pub export fn js_EraseMsg(arg_js: [*c]jsCtx, arg_stream: [*c]const u8, arg_seq: u64, arg_opts: [*c]jsOptions, arg_errCode: [*c]jsErrCode) natsStatus {
    var js = arg_js;
    _ = &js;
    var stream = arg_stream;
    _ = &stream;
    ...
    var s: natsStatus = undefined;
    _ = &s;
    s = _deleteMsg(js, @as(c_int, 0) != 0, stream, seq, opts, errCode);
    return if (s == @as(c_uint, @bitCast(NATS_OK))) s else nats_updateErrStack(s, "js_EraseMsg");
}
pub const struct_apiPaged = extern struct {
    total: i64 = @import("std").mem.zeroes(i64),
    offset: i64 = @import("std").mem.zeroes(i64),
    limit: i64 = @import("std").mem.zeroes(i64),
};
pub const apiPaged = struct_apiPaged;
pub export fn js_GetStreamInfo(arg_new_si: [*c][*c]jsStreamInfo, arg_js: [*c]jsCtx, arg_stream: [*c]const u8, arg_opts: [*c]jsOptions, arg_errCode: [*c]jsErrCode) natsStatus {
    var new_si = arg_new_si;
    _ = &new_si;
    var js = arg_js;
    _ = &js;
    ...
    var offset: i64 = 0;
    _ = &offset;
    var doPage: bool = @as(c_int, 0) != 0;
    _ = &doPage;
    var done: bool = @as(c_int, 0) != 0;
    _ = &done;
    var si: [*c]jsStreamInfo = null;
    _ = &si;
    var subjects: [*c]jsStreamStateSubjects = null;
    _ = &subjects;
    var page: apiPaged = apiPaged{
        .total = @as(i64, @bitCast(@as(c_long, @as(c_int, 0)))),
        .offset = @import("std").mem.zeroes(i64),
        .limit = @import("std").mem.zeroes(i64),
    };
    _ = &page;
    if (errCode != @as([*c]jsErrCode, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) {
        errCode.* = 0;
    }
    if ((js == @as([*c]jsCtx, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) or (new_si == @as([*c][*c]jsStreamInfo, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0)))))))) return nats_setErrorReal("./src/submodules/nats.c/src/jsm.c", "js_GetStreamInfo", @as(c_int, 1526), @as(c_uint, @bitCast(NATS_INVALID_ARG)), "%s", natsStatus_GetText(@as(c_uint, @bitCast(NATS_INVALID_ARG))));
    s = _checkStreamName(stream);
    if (s != @as(c_uint, @bitCast(NATS_OK))) return if (s == @as(c_uint, @bitCast(NATS_OK))) s else nats_updateErrStack(s, "js_GetStreamInfo");
    s = js_setOpts(&nc, &freePfx, js, opts, &o);
    if (s == @as(c_uint, @bitCast(NATS_OK))) {
        if (asprintf(&subj, "%.*s.STREAM.INFO.%s", js_lenWithoutTrailingDot(o.Prefix), o.Prefix, stream) < @as(c_int, 0)) {
            s = nats_setErrorReal("./src/submodules/nats.c/src/jsm.c", "js_GetStreamInfo", @as(c_int, 1536), @as(c_uint, @bitCast(NATS_NO_MEMORY)), "%s", natsStatus_GetText(@as(c_uint, @bitCast(NATS_NO_MEMORY))));
        }
        if (freePfx) {
            free(@as(?*anyopaque, @ptrCast(@as([*c]u8, @ptrCast(@volatileCast(@constCast(o.Prefix)))))));
        }
    }
    if (!((if ((o.Stream.Info.SubjectsFilter == @as([*c]const u8, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) or (@as(c_int, @bitCast(@as(c_uint, o.Stream.Info.SubjectsFilter[@as(c_uint, @intCast(@as(c_int, 0)))]))) == @as(c_int, '\x00'))) @as(c_int, 1) else @as(c_int, 0)) != 0)) {
        doPage = @as(c_int, 1) != 0;
        _ = memset(@as(?*anyopaque, @ptrCast(&page)), @as(c_int, 0), @sizeOf(apiPaged));
    }
    while (true) {
        if (s == @as(c_uint, @bitCast(NATS_OK))) {
            s = _marshalStreamInfoReq(&buf, &o.Stream.Info, offset);
        }
        if (((s == @as(c_uint, @bitCast(NATS_OK))) and (buf != @as([*c]natsBuffer, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0)))))))) and (buf.*.len > @as(c_int, 0))) {
            req = buf.*.data;
            reqLen = buf.*.len;
        }
        if (s == @as(c_uint, @bitCast(NATS_OK))) {
            s = natsConnection_Request(&resp, nc, subj, @as(?*const anyopaque, @ptrCast(req)), reqLen, o.Wait);
            if ((s == @as(c_uint, @bitCast(NATS_NO_RESPONDERS))) and (errCode != @as([*c]jsErrCode, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0)))))))) {
                errCode.* = @as(c_uint, @bitCast(JSNotEnabledErr));
            }
        }
        if (s == @as(c_uint, @bitCast(NATS_OK))) {
            s = _unmarshalStreamCreateResp(&si, &page, resp, errCode);
        }
        if ((s == @as(c_uint, @bitCast(NATS_OK))) and (@as(c_int, @intFromBool(doPage)) != 0)) {
            if (si.*.State.Subjects != @as([*c]jsStreamStateSubjects, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) {
                var sc: c_int = si.*.State.Subjects.*.Count;
                _ = &sc;
                offset += @as(i64, @bitCast(@as(c_long, sc)));
                if (subjects == @as([*c]jsStreamStateSubjects, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) {
                    subjects = si.*.State.Subjects;
                } else {
                    var list: [*c]jsStreamStateSubject = subjects.*.List;
                    _ = &list;
                    var prev: c_int = subjects.*.Count;
                    _ = &prev;
                    list = @as([*c]jsStreamStateSubject, @ptrCast(@alignCast(realloc(@as(?*anyopaque, @ptrCast(list)), @as(c_ulong, @bitCast(@as(c_long, prev + sc))) *% @sizeOf(jsStreamStateSubject)))));
                    if (list == @as([*c]jsStreamStateSubject, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) {
                        s = nats_setErrorReal("./src/submodules/nats.c/src/jsm.c", "js_GetStreamInfo", @as(c_int, 1581), @as(c_uint, @bitCast(NATS_NO_MEMORY)), "%s", natsStatus_GetText(@as(c_uint, @bitCast(NATS_NO_MEMORY))));
                    } else {
                        ...
                        _ = &i;
                        {
                            ...
                            while (i < sc) : (i += 1) {
                                (blk: {
                                    const tmp = prev + i;
                                    if (tmp >= 0) break :blk list + @as(usize, @intCast(tmp)) else break :blk list - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
                                }).*.Subject = (blk: {
                                    const tmp = i;
                                    if (tmp >= 0) break :blk si.*.State.Subjects.*.List + @as(usize, @intCast(tmp)) else break :blk si.*.State.Subjects.*.List - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
                                }).*.Subject;
                                (blk: {
                                    const tmp = prev + i;
                                    if (tmp >= 0) break :blk list + @as(usize, @intCast(tmp)) else break :blk list - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
                        ...
                        free(@as(?*anyopaque, @ptrCast(si.*.State.Subjects.*.List)));
                        free(@as(?*anyopaque, @ptrCast(si.*.State.Subjects)));
                        subjects.*.List = list;
                        subjects.*.Count += sc;
                    }
                }
        ...
        natsMsg_Destroy(resp);
        resp = null;
        if (!(((s == @as(c_uint, @bitCast(NATS_OK))) and (@as(c_int, @intFromBool(doPage)) != 0)) and !done)) break;
    }
    natsBuf_Destroy(buf);
    free(@as(?*anyopaque, @ptrCast(subj)));
    if (s == @as(c_uint, @bitCast(NATS_OK))) {
        if ((@as(c_int, @intFromBool(doPage)) != 0) and (subjects != @as([*c]jsStreamStateSubjects, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0)))))))) {
        ...
        if (s == @as(c_uint, @bitCast(NATS_NOT_FOUND))) {
            nats_clearLastError();
            return s;
        }
    }
    return if (s == @as(c_uint, @bitCast(NATS_OK))) s else nats_updateErrStack(s, "js_GetStreamInfo");
}
pub export fn jsStreamInfo_Destroy(arg_si: [*c]jsStreamInfo) void {
    var si = arg_si;
    _ = &si;
    var i: c_int = undefined;
    _ = &i;
    if (si == @as([*c]jsStreamInfo, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) return;
    ...
    {
        i = 0;
        while (i < si.*.SourcesLen) : (i += 1) {
            _destroyStreamSourceInfo((blk: {
                const tmp = i;
                if (tmp >= 0) break :blk si.*.Sources + @as(usize, @intCast(tmp)) else break :blk si.*.Sources - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
            }).*);
        }
    }
    free(@as(?*anyopaque, @ptrCast(si.*.Sources)));
    {
        i = 0;
        while (i < si.*.AlternatesLen) : (i += 1) {
            _destroyStreamAlternate((blk: {
                const tmp = i;
                if (tmp >= 0) break :blk si.*.Alternates + @as(usize, @intCast(tmp)) else break :blk si.*.Alternates - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
            }).*);
        }
    }
    free(@as(?*anyopaque, @ptrCast(si.*.Alternates)));
    free(@as(?*anyopaque, @ptrCast(si)));
}
...
pub export fn js_Streams(arg_new_list: [*c][*c]jsStreamInfoList, arg_js: [*c]jsCtx, arg_opts: [*c]jsOptions, arg_errCode: [*c]jsErrCode) natsStatus {
    ...
    var timeout: i64 = 0;
    _ = &timeout;
    var streams: [*c]natsStrHash = null;
    _ = &streams;
    var list: [*c]jsStreamInfoList = null;
    _ = &list;
    var o: jsOptions = undefined;
    _ = &o;
    var page: apiPaged = apiPaged{
    ...
    if ((new_list == @as([*c][*c]jsStreamInfoList, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) or (js == @as([*c]jsCtx, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0)))))))) return nats_setErrorReal("./src/submodules/nats.c/src/jsm.c", "js_Streams", @as(c_int, 2248), @as(c_uint, @bitCast(NATS_INVALID_ARG)), "%s", natsStatus_GetText(@as(c_uint, @bitCast(NATS_INVALID_ARG))));
    s = js_setOpts(&nc, &freePfx, js, opts, &o);
    if (s == @as(c_uint, @bitCast(NATS_OK))) {
        if (asprintf(&subj, "%.*s.STREAM.LIST", js_lenWithoutTrailingDot(o.Prefix), o.Prefix) < @as(c_int, 0)) {
            s = nats_setErrorReal("./src/submodules/nats.c/src/jsm.c", "js_Streams", @as(c_int, 2254), @as(c_uint, @bitCast(NATS_NO_MEMORY)), "%s", natsStatus_GetText(@as(c_uint, @bitCast(NATS_NO_MEMORY))));
        }
        if (freePfx) {
            free(@as(?*anyopaque, @ptrCast(@as([*c]u8, @ptrCast(@volatileCast(@constCast(o.Prefix)))))));
        }
    ...
    if (s == @as(c_uint, @bitCast(NATS_OK))) {
        s = natsBuf_Create(&buf, @as(c_int, 64));
    }
    if (s == @as(c_uint, @bitCast(NATS_OK))) {
        s = natsStrHash_Create(&streams, @as(c_int, 16));
    }
    if (s == @as(c_uint, @bitCast(NATS_OK))) {
        _ = memset(@as(?*anyopaque, @ptrCast(&page)), @as(c_int, 0), @sizeOf(apiPaged));
        start = nats_Now();
    ...
    while (true) {
        ...
        if (s == @as(c_uint, @bitCast(NATS_OK))) {
            s = nats_marshalLong(buf, @as(c_int, 0) != 0, "offset", offset);
        }
        if (!((if ((o.Stream.Info.SubjectsFilter == @as([*c]const u8, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) or (@as(c_int, @bitCast(@as(c_uint, o.Stream.Info.SubjectsFilter[@as(c_uint, @intCast(@as(c_int, 0)))]))) == @as(c_int, '\x00'))) @as(c_int, 1) else @as(c_int, 0)) != 0)) {
            if (s == @as(c_uint, @bitCast(NATS_OK))) {
                s = natsBuf_Append(buf, ",\"subject\":\"", -@as(c_int, 1));
            }
            if (s == @as(c_uint, @bitCast(NATS_OK))) {
                s = natsBuf_Append(buf, o.Stream.Info.SubjectsFilter, -@as(c_int, 1));
            }
            if (s == @as(c_uint, @bitCast(NATS_OK))) {
                s = natsBuf_AppendByte(buf, @as(u8, @bitCast(@as(i8, @truncate(@as(c_int, '"'))))));
            }
        ...
        if (timeout <= @as(i64, @bitCast(@as(c_long, @as(c_int, 0))))) {
            s = @as(c_uint, @bitCast(NATS_TIMEOUT));
        }
        if (s == @as(c_uint, @bitCast(NATS_OK))) {
            s = natsConnection_Request(&resp, nc, subj, @as(?*const anyopaque, @ptrCast(buf.*.data)), buf.*.len, timeout);
            if ((s == @as(c_uint, @bitCast(NATS_NO_RESPONDERS))) and (errCode != @as([*c]jsErrCode, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0)))))))) {
                errCode.* = @as(c_uint, @bitCast(JSNotEnabledErr));
            }
        }
        if (s == @as(c_uint, @bitCast(NATS_OK))) {
            s = _unmarshalStreamInfoListResp(streams, &page, resp, errCode);
        }
        if (s == @as(c_uint, @bitCast(NATS_OK))) {
            offset += page.limit;
            done = offset >= page.total;
        ...
        natsMsg_Destroy(resp);
        resp = null;
        if (!((s == @as(c_uint, @bitCast(NATS_OK))) and !done)) break;
    }
    natsBuf_Destroy(buf);
    free(@as(?*anyopaque, @ptrCast(subj)));
    if (s == @as(c_uint, @bitCast(NATS_OK))) {
        if (streams.*.used == @as(c_int, 0)) {
            natsStrHash_Destroy(streams);
            return @as(c_uint, @bitCast(NATS_NOT_FOUND));
        }
        list = @as([*c]jsStreamInfoList, @ptrCast(@alignCast(calloc(@as(c_ulong, @bitCast(@as(c_long, @as(c_int, 1)))), @sizeOf(jsStreamInfoList)))));
        if (list == @as([*c]jsStreamInfoList, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) {
            s = nats_setErrorReal("./src/submodules/nats.c/src/jsm.c", "js_Streams", @as(c_int, 2315), @as(c_uint, @bitCast(NATS_NO_MEMORY)), "%s", natsStatus_GetText(@as(c_uint, @bitCast(NATS_NO_MEMORY))));
        } else {
            list.*.List = @as([*c][*c]jsStreamInfo, @ptrCast(@alignCast(calloc(@as(c_ulong, @bitCast(@as(c_long, streams.*.used))), @sizeOf([*c]jsStreamInfo)))));
            if (list.*.List == @as([*c][*c]jsStreamInfo, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) {
                free(@as(?*anyopaque, @ptrCast(list)));
                list = null;
                s = nats_setErrorReal("./src/submodules/nats.c/src/jsm.c", "js_Streams", @as(c_int, 2323), @as(c_uint, @bitCast(NATS_NO_MEMORY)), "%s", natsStatus_GetText(@as(c_uint, @bitCast(NATS_NO_MEMORY))));
            } else {
                var iter: natsStrHashIter = undefined;
                _ = &iter;
                var val: ?*anyopaque = @as(?*anyopaque, @ptrFromInt(@as(c_int, 0)));
                _ = &val;
                natsStrHashIter_Init(&iter, streams);
                while (natsStrHashIter_Next(&iter, null, &val)) {
                    var si: [*c]jsStreamInfo = @as([*c]jsStreamInfo, @ptrCast(@alignCast(val)));
                    _ = &si;
                    (blk: {
                        const tmp = blk_1: {
                            const ref = &list.*.Count;
                            const tmp_2 = ref.*;
                            ref.* += 1;
                            break :blk_1 tmp_2;
                        };
                        if (tmp >= 0) break :blk list.*.List + @as(usize, @intCast(tmp)) else break :blk list.*.List - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
                    }).* = si;
                    _ = natsStrHashIter_RemoveCurrent(&iter);
                }
    ...
    natsStrHash_Destroy(streams);
    return if (s == @as(c_uint, @bitCast(NATS_OK))) s else nats_updateErrStack(s, "js_Streams");
}
pub export fn jsStreamInfoList_Destroy(arg_list: [*c]jsStreamInfoList) void {
    var list = arg_list;
    _ = &list;
    var i: c_int = undefined;
    _ = &i;
    if (list == @as([*c]jsStreamInfoList, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) return;
    {
        i = 0;
        while (i < list.*.Count) : (i += 1) {
            jsStreamInfo_Destroy((blk: {
                const tmp = i;
                if (tmp >= 0) break :blk list.*.List + @as(usize, @intCast(tmp)) else break :blk list.*.List - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
            }).*);
        }
    }
    free(@as(?*anyopaque, @ptrCast(list.*.List)));
    free(@as(?*anyopaque, @ptrCast(list)));
}
pub export fn js_StreamNames(arg_new_list: [*c][*c]jsStreamNamesList, arg_js: [*c]jsCtx, arg_opts: [*c]jsOptions, arg_errCode: [*c]jsErrCode) natsStatus {
    var new_list = arg_new_list;
    _ = &new_list;
    var js = arg_js;
    _ = &js;
    ...
    var timeout: i64 = 0;
    _ = &timeout;
    var names: [*c]natsStrHash = null;
    _ = &names;
    var list: [*c]jsStreamNamesList = null;
    _ = &list;
    var o: jsOptions = undefined;
    _ = &o;
    var page: apiPaged = apiPaged{
    ...
    if ((new_list == @as([*c][*c]jsStreamNamesList, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) or (js == @as([*c]jsCtx, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0)))))))) return nats_setErrorReal("./src/submodules/nats.c/src/jsm.c", "js_StreamNames", @as(c_int, 2450), @as(c_uint, @bitCast(NATS_INVALID_ARG)), "%s", natsStatus_GetText(@as(c_uint, @bitCast(NATS_INVALID_ARG))));
    s = js_setOpts(&nc, &freePfx, js, opts, &o);
    if (s == @as(c_uint, @bitCast(NATS_OK))) {
        if (asprintf(&subj, "%.*s.STREAM.NAMES", js_lenWithoutTrailingDot(o.Prefix), o.Prefix) < @as(c_int, 0)) {
            s = nats_setErrorReal("./src/submodules/nats.c/src/jsm.c", "js_StreamNames", @as(c_int, 2456), @as(c_uint, @bitCast(NATS_NO_MEMORY)), "%s", natsStatus_GetText(@as(c_uint, @bitCast(NATS_NO_MEMORY))));
        }
        if (freePfx) {
            free(@as(?*anyopaque, @ptrCast(@as([*c]u8, @ptrCast(@volatileCast(@constCast(o.Prefix)))))));
        }
    ...
    if (s == @as(c_uint, @bitCast(NATS_OK))) {
        s = natsStrHash_Create(&names, @as(c_int, 16));
    }
    if (s == @as(c_uint, @bitCast(NATS_OK))) {
        _ = memset(@as(?*anyopaque, @ptrCast(&page)), @as(c_int, 0), @sizeOf(apiPaged));
        start = nats_Now();
    ...
    while (true) {
        ...
        if (s == @as(c_uint, @bitCast(NATS_OK))) {
            s = _unmarshalNamesListResp("streams", names, &page, resp, errCode);
        }
        if (s == @as(c_uint, @bitCast(NATS_OK))) {
            offset += page.limit;
            done = offset >= page.total;
    ...
    free(@as(?*anyopaque, @ptrCast(subj)));
    if (s == @as(c_uint, @bitCast(NATS_OK))) {
        if (names.*.used == @as(c_int, 0)) {
            natsStrHash_Destroy(names);
            return @as(c_uint, @bitCast(NATS_NOT_FOUND));
        }
        list = @as([*c]jsStreamNamesList, @ptrCast(@alignCast(calloc(@as(c_ulong, @bitCast(@as(c_long, @as(c_int, 1)))), @sizeOf(jsStreamNamesList)))));
        if (list == @as([*c]jsStreamNamesList, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) {
            s = nats_setErrorReal("./src/submodules/nats.c/src/jsm.c", "js_StreamNames", @as(c_int, 2517), @as(c_uint, @bitCast(NATS_NO_MEMORY)), "%s", natsStatus_GetText(@as(c_uint, @bitCast(NATS_NO_MEMORY))));
        } else {
            list.*.List = @as([*c][*c]u8, @ptrCast(@alignCast(calloc(@as(c_ulong, @bitCast(@as(c_long, names.*.used))), @sizeOf([*c]u8)))));
            if (list.*.List == @as([*c][*c]u8, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) {
                s = nats_setErrorReal("./src/submodules/nats.c/src/jsm.c", "js_StreamNames", @as(c_int, 2522), @as(c_uint, @bitCast(NATS_NO_MEMORY)), "%s", natsStatus_GetText(@as(c_uint, @bitCast(NATS_NO_MEMORY))));
            } else {
                var iter: natsStrHashIter = undefined;
                _ = &iter;
                var sname: [*c]u8 = null;
                ...
                while ((s == @as(c_uint, @bitCast(NATS_OK))) and (@as(c_int, @intFromBool(natsStrHashIter_Next(&iter, &sname, null))) != 0)) {
                    var copyName: [*c]u8 = null;
                    _ = &copyName;
                    {
                        copyName = strdup(sname);
                        if (copyName == @as([*c]u8, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) {
                            s = nats_setErrorReal("./src/submodules/nats.c/src/jsm.c", "js_StreamNames", @as(c_int, 2533), @as(c_uint, @bitCast(NATS_NO_MEMORY)), "%s", natsStatus_GetText(@as(c_uint, @bitCast(NATS_NO_MEMORY))));
                        }
                    }
                    if (s == @as(c_uint, @bitCast(NATS_OK))) {
                        (blk: {
    ...
    natsStrHash_Destroy(names);
    return if (s == @as(c_uint, @bitCast(NATS_OK))) s else nats_updateErrStack(s, "js_StreamNames");
}
pub export fn jsStreamNamesList_Destroy(arg_list: [*c]jsStreamNamesList) void {
    var list = arg_list;
    _ = &list;
    var i: c_int = undefined;
    _ = &i;
    if (list == @as([*c]jsStreamNamesList, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) return;
    {
        i = 0;
        while (i < list.*.Count) : (i += 1) {
...
pub export fn jsConsumerConfig_Init(arg_cc: [*c]jsConsumerConfig) natsStatus {
    var cc = arg_cc;
    _ = &cc;
    if (cc == @as([*c]jsConsumerConfig, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) return nats_setErrorReal("./src/submodules/nats.c/src/jsm.c", "jsConsumerConfig_Init", @as(c_int, 3602), @as(c_uint, @bitCast(NATS_INVALID_ARG)), "%s", natsStatus_GetText(@as(c_uint, @bitCast(NATS_INVALID_ARG))));
    _ = memset(@as(?*anyopaque, @ptrCast(cc)), @as(c_int, 0), @sizeOf(jsConsumerConfig));
    cc.*.AckPolicy = @as(c_uint, @bitCast(-@as(c_int, 1)));
    cc.*.DeliverPolicy = @as(c_uint, @bitCast(-@as(c_int, 1)));
    cc.*.ReplayPolicy = @as(c_uint, @bitCast(-@as(c_int, 1)));
    return @as(c_uint, @bitCast(NATS_OK));
}
pub export fn js_AddConsumer(arg_new_ci: [*c][*c]jsConsumerInfo, arg_js: [*c]jsCtx, arg_stream: [*c]const u8, arg_cfg: [*c]jsConsumerConfig, arg_opts: [*c]jsOptions, arg_errCode: [*c]jsErrCode) natsStatus {
    var new_ci = arg_new_ci;
    _ = &new_ci;
    var js = arg_js;
    _ = &js;
    var stream = arg_stream;
    ...
    if (js == @as([*c]jsCtx, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) return nats_setErrorReal("./src/submodules/nats.c/src/jsm.c", "js_AddConsumer", @as(c_int, 3260), @as(c_uint, @bitCast(NATS_INVALID_ARG)), "%s", natsStatus_GetText(@as(c_uint, @bitCast(NATS_INVALID_ARG))));
    if (cfg == @as([*c]jsConsumerConfig, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) return nats_setErrorReal("./src/submodules/nats.c/src/jsm.c", "js_AddConsumer", @as(c_int, 3263), @as(c_uint, @bitCast(NATS_INVALID_ARG)), "%s", "consumer configuration required");
    s = _checkStreamName(stream);
    if (s != @as(c_uint, @bitCast(NATS_OK))) return if (s == @as(c_uint, @bitCast(NATS_OK))) s else nats_updateErrStack(s, "js_AddConsumer");
    if (!((if ((cfg.*.Name == @as([*c]const u8, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) or (@as(c_int, @bitCast(@as(c_uint, cfg.*.Name[@as(c_uint, @intCast(@as(c_int, 0)))]))) == @as(c_int, '\x00'))) @as(c_int, 1) else @as(c_int, 0)) != 0)) {
        if ((blk: {
            const tmp = js_checkConsName(cfg.*.Name, @as(c_int, 0) != 0);
            s = tmp;
            break :blk tmp;
        }) != @as(c_uint, @bitCast(NATS_OK))) return if (s == @as(c_uint, @bitCast(NATS_OK))) s else nats_updateErrStack(s, "js_AddConsumer");
    }
    if (!((if ((cfg.*.Durable == @as([*c]const u8, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) or (@as(c_int, @bitCast(@as(c_uint, cfg.*.Durable[@as(c_uint, @intCast(@as(c_int, 0)))]))) == @as(c_int, '\x00'))) @as(c_int, 1) else @as(c_int, 0)) != 0)) {
        if ((blk: {
            const tmp = js_checkConsName(cfg.*.Durable, @as(c_int, 1) != 0);
            s = tmp;
            break :blk tmp;
        }) != @as(c_uint, @bitCast(NATS_OK))) return if (s == @as(c_uint, @bitCast(NATS_OK))) s else nats_updateErrStack(s, "js_AddConsumer");
    }
    ...
    if (s == @as(c_uint, @bitCast(NATS_OK))) {
        ...
        _ = &res;
        if (!((if ((cfg.*.Name == @as([*c]const u8, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) or (@as(c_int, @bitCast(@as(c_uint, cfg.*.Name[@as(c_uint, @intCast(@as(c_int, 0)))]))) == @as(c_int, '\x00'))) @as(c_int, 1) else @as(c_int, 0)) != 0)) {
            if (!((if ((cfg.*.FilterSubject == @as([*c]const u8, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) or (@as(c_int, @bitCast(@as(c_uint, cfg.*.FilterSubject[@as(c_uint, @intCast(@as(c_int, 0)))]))) == @as(c_int, '\x00'))) @as(c_int, 1) else @as(c_int, 0)) != 0) and (cfg.*.FilterSubjectsLen == @as(c_int, 0))) {
                res = asprintf(&subj, "%.*s.CONSUMER.CREATE.%s.%s.%s", js_lenWithoutTrailingDot(o.Prefix), o.Prefix, stream, cfg.*.Name, cfg.*.FilterSubject);
            } else {
                res = asprintf(&subj, "%.*s.CONSUMER.CREATE.%s.%s", js_lenWithoutTrailingDot(o.Prefix), o.Prefix, stream, cfg.*.Name);
            }
        } else if ((if ((cfg.*.Durable == @as([*c]const u8, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) or (@as(c_int, @bitCast(@as(c_uint, cfg.*.Durable[@as(c_uint, @intCast(@as(c_int, 0)))]))) == @as(c_int, '\x00'))) @as(c_int, 1) else @as(c_int, 0)) != 0) {
            res = asprintf(&subj, "%.*s.CONSUMER.CREATE.%s", js_lenWithoutTrailingDot(o.Prefix), o.Prefix, stream);
        } else {
            res = asprintf(&subj, "%.*s.CONSUMER.DURABLE.CREATE.%s.%s", js_lenWithoutTrailingDot(o.Prefix), o.Prefix, stream, cfg.*.Durable);
        }
        if (res < @as(c_int, 0)) {
            s = nats_setErrorReal("./src/submodules/nats.c/src/jsm.c", "js_AddConsumer", @as(c_int, 3308), @as(c_uint, @bitCast(NATS_NO_MEMORY)), "%s", natsStatus_GetText(@as(c_uint, @bitCast(NATS_NO_MEMORY))));
        }
        if (freePfx) {
            free(@as(?*anyopaque, @ptrCast(@as([*c]u8, @ptrCast(@volatileCast(@constCast(o.Prefix)))))));
        }
    ...
    if (s == @as(c_uint, @bitCast(NATS_OK))) {
        s = _marshalConsumerCreateReq(&buf, stream, cfg);
    }
    if (s == @as(c_uint, @bitCast(NATS_OK))) {
        s = natsConnection_Request(&resp, nc, subj, @as(?*const anyopaque, @ptrCast(buf.*.data)), buf.*.len, o.Wait);
        if ((s == @as(c_uint, @bitCast(NATS_NO_RESPONDERS))) and (errCode != @as([*c]jsErrCode, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0)))))))) {
            errCode.* = @as(c_uint, @bitCast(JSNotEnabledErr));
        }
    }
    if (s == @as(c_uint, @bitCast(NATS_OK))) {
        s = _unmarshalConsumerCreateOrGetResp(new_ci, resp, errCode);
    }
    if ((((s == @as(c_uint, @bitCast(NATS_OK))) and (new_ci != @as([*c][*c]jsConsumerInfo, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0)))))))) and (cfg.*.FilterSubjectsLen > @as(c_int, 0))) and (new_ci.*.*.Config.*.FilterSubjectsLen == @as(c_int, 0))) {
        s = nats_setErrorReal("./src/submodules/nats.c/src/jsm.c", "js_AddConsumer", @as(c_int, 3326), @as(c_uint, @bitCast(NATS_INVALID_ARG)), "%s", "multiple consumer filter subjects not supported by the server");
    }
    free(@as(?*anyopaque, @ptrCast(subj)));
    natsMsg_Destroy(resp);
    natsBuf_Destroy(buf);
    return if (s == @as(c_uint, @bitCast(NATS_OK))) s else nats_updateErrStack(s, "js_AddConsumer");
}
pub export fn js_UpdateConsumer(arg_ci: [*c][*c]jsConsumerInfo, arg_js: [*c]jsCtx, arg_stream: [*c]const u8, arg_cfg: [*c]jsConsumerConfig, arg_opts: [*c]jsOptions, arg_errCode: [*c]jsErrCode) natsStatus {
    var ci = arg_ci;
    _ = &ci;
    var js = arg_js;
    _ = &js;
    ...
    var s: natsStatus = undefined;
    _ = &s;
    if ((cfg != @as([*c]jsConsumerConfig, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) and ((if ((cfg.*.Durable == @as([*c]const u8, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) or (@as(c_int, @bitCast(@as(c_uint, cfg.*.Durable[@as(c_uint, @intCast(@as(c_int, 0)))]))) == @as(c_int, '\x00'))) @as(c_int, 1) else @as(c_int, 0)) != 0)) return nats_setErrorReal("./src/submodules/nats.c/src/jsm.c", "js_UpdateConsumer", @as(c_int, 3344), @as(c_uint, @bitCast(NATS_INVALID_ARG)), "%s", "durable name is required");
    s = js_AddConsumer(ci, js, stream, cfg, opts, errCode);
    return if (s == @as(c_uint, @bitCast(NATS_OK))) s else nats_updateErrStack(s, "js_UpdateConsumer");
}
pub export fn js_GetConsumerInfo(arg_new_ci: [*c][*c]jsConsumerInfo, arg_js: [*c]jsCtx, arg_stream: [*c]const u8, arg_consumer: [*c]const u8, arg_opts: [*c]jsOptions, arg_errCode: [*c]jsErrCode) natsStatus {
    var new_ci = arg_new_ci;
    _ = &new_ci;
    var js = arg_js;
    _ = &js;
    ...
    if ((js == @as([*c]jsCtx, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) or (new_ci == @as([*c][*c]jsConsumerInfo, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0)))))))) return nats_setErrorReal("./src/submodules/nats.c/src/jsm.c", "js_GetConsumerInfo", @as(c_int, 3366), @as(c_uint, @bitCast(NATS_INVALID_ARG)), "%s", natsStatus_GetText(@as(c_uint, @bitCast(NATS_INVALID_ARG))));
    s = _checkStreamName(stream);
    if (s == @as(c_uint, @bitCast(NATS_OK))) {
        s = js_checkConsName(consumer, @as(c_int, 0) != 0);
    }
    if (s != @as(c_uint, @bitCast(NATS_OK))) return if (s == @as(c_uint, @bitCast(NATS_OK))) s else nats_updateErrStack(s, "js_GetConsumerInfo");
    s = js_setOpts(&nc, &freePfx, js, opts, &o);
    if (s == @as(c_uint, @bitCast(NATS_OK))) {
        if (asprintf(&subj, "%.*s.CONSUMER.INFO.%s.%s", js_lenWithoutTrailingDot(o.Prefix), o.Prefix, stream, consumer) < @as(c_int, 0)) {
            s = nats_setErrorReal("./src/submodules/nats.c/src/jsm.c", "js_GetConsumerInfo", @as(c_int, 3380), @as(c_uint, @bitCast(NATS_NO_MEMORY)), "%s", natsStatus_GetText(@as(c_uint, @bitCast(NATS_NO_MEMORY))));
        }
        if (freePfx) {
            free(@as(?*anyopaque, @ptrCast(@as([*c]u8, @ptrCast(@volatileCast(@constCast(o.Prefix)))))));
        }
    ...
    if (s == @as(c_uint, @bitCast(NATS_OK))) {
        s = natsConnection_Request(&resp, nc, subj, null, @as(c_int, 0), o.Wait);
        if ((s == @as(c_uint, @bitCast(NATS_NO_RESPONDERS))) and (errCode != @as([*c]jsErrCode, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0)))))))) {
            errCode.* = @as(c_uint, @bitCast(JSNotEnabledErr));
        }
    }
    ...
    return if (s == @as(c_uint, @bitCast(NATS_OK))) s else nats_updateErrStack(s, "js_GetConsumerInfo");
}
pub export fn js_DeleteConsumer(arg_js: [*c]jsCtx, arg_stream: [*c]const u8, arg_consumer: [*c]const u8, arg_opts: [*c]jsOptions, arg_errCode: [*c]jsErrCode) natsStatus {
    var js = arg_js;
    _ = &js;
    var stream = arg_stream;
    _ = &stream;
    ...
    if (js == @as([*c]jsCtx, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) return nats_setErrorReal("./src/submodules/nats.c/src/jsm.c", "js_DeleteConsumer", @as(c_int, 3420), @as(c_uint, @bitCast(NATS_INVALID_ARG)), "%s", natsStatus_GetText(@as(c_uint, @bitCast(NATS_INVALID_ARG))));
    s = _checkStreamName(stream);
    if (s == @as(c_uint, @bitCast(NATS_OK))) {
        s = js_checkConsName(consumer, @as(c_int, 0) != 0);
    }
    if (s != @as(c_uint, @bitCast(NATS_OK))) return if (s == @as(c_uint, @bitCast(NATS_OK))) s else nats_updateErrStack(s, "js_DeleteConsumer");
    s = js_setOpts(&nc, &freePfx, js, opts, &o);
    if (s == @as(c_uint, @bitCast(NATS_OK))) {
        if (asprintf(&subj, "%.*s.CONSUMER.DELETE.%s.%s", js_lenWithoutTrailingDot(o.Prefix), o.Prefix, stream, consumer) < @as(c_int, 0)) {
            s = nats_setErrorReal("./src/submodules/nats.c/src/jsm.c", "js_DeleteConsumer", @as(c_int, 3434), @as(c_uint, @bitCast(NATS_NO_MEMORY)), "%s", natsStatus_GetText(@as(c_uint, @bitCast(NATS_NO_MEMORY))));
        }
        if (freePfx) {
            free(@as(?*anyopaque, @ptrCast(@as([*c]u8, @ptrCast(@volatileCast(@constCast(o.Prefix)))))));
        }
    ...
    if (s == @as(c_uint, @bitCast(NATS_OK))) {
        s = _unmarshalSuccessResp(&success, resp, errCode);
    }
    if ((s == @as(c_uint, @bitCast(NATS_OK))) and !success) {
        s = nats_setErrorReal("./src/submodules/nats.c/src/jsm.c", "js_DeleteConsumer", @as(c_int, 3446), s, "failed to delete consumer '%s'", consumer);
    }
    free(@as(?*anyopaque, @ptrCast(subj)));
    natsMsg_Destroy(resp);
    return if (s == @as(c_uint, @bitCast(NATS_OK))) s else nats_updateErrStack(s, "js_DeleteConsumer");
}
pub export fn js_PauseConsumer(arg_new_cpr: [*c][*c]jsConsumerPauseResponse, arg_js: [*c]jsCtx, arg_stream: [*c]const u8, arg_consumer: [*c]const u8, arg_pauseUntil: u64, arg_opts: [*c]jsOptions, arg_errCode: [*c]jsErrCode) natsStatus {
    var new_cpr = arg_new_cpr;
    _ = &new_cpr;
    var js = arg_js;
    _ = &js;
    var stream = arg_stream;
    ...
    if ((js == @as([*c]jsCtx, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) or (new_cpr == @as([*c][*c]jsConsumerPauseResponse, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0)))))))) return nats_setErrorReal("./src/submodules/nats.c/src/jsm.c", "js_PauseConsumer", @as(c_int, 3557), @as(c_uint, @bitCast(NATS_INVALID_ARG)), "%s", natsStatus_GetText(@as(c_uint, @bitCast(NATS_INVALID_ARG))));
    s = _checkStreamName(stream);
    if (s == @as(c_uint, @bitCast(NATS_OK))) {
        s = js_checkConsName(consumer, @as(c_int, 0) != 0);
    }
    if (s != @as(c_uint, @bitCast(NATS_OK))) return if (s == @as(c_uint, @bitCast(NATS_OK))) s else nats_updateErrStack(s, "js_PauseConsumer");
    s = js_setOpts(&nc, &freePfx, js, opts, &o);
    if (s == @as(c_uint, @bitCast(NATS_OK))) {
        if (asprintf(&subj, "%.*s.CONSUMER.PAUSE.%s.%s", js_lenWithoutTrailingDot(o.Prefix), o.Prefix, stream, consumer) < @as(c_int, 0)) {
            s = nats_setErrorReal("./src/submodules/nats.c/src/jsm.c", "js_PauseConsumer", @as(c_int, 3571), @as(c_uint, @bitCast(NATS_NO_MEMORY)), "%s", natsStatus_GetText(@as(c_uint, @bitCast(NATS_NO_MEMORY))));
        }
        if (freePfx) {
            free(@as(?*anyopaque, @ptrCast(@as([*c]u8, @ptrCast(@volatileCast(@constCast(o.Prefix)))))));
        }
    ...
    if (s == @as(c_uint, @bitCast(NATS_OK))) {
        s = _marshalConsumerPauseReq(&buf, pauseUntil);
    }
    if (s == @as(c_uint, @bitCast(NATS_OK))) {
        s = natsConnection_Request(&resp, nc, subj, @as(?*const anyopaque, @ptrCast(buf.*.data)), buf.*.len, o.Wait);
        if ((s == @as(c_uint, @bitCast(NATS_NO_RESPONDERS))) and (errCode != @as([*c]jsErrCode, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0)))))))) {
    ...
    if (s == @as(c_uint, @bitCast(NATS_OK))) {
        s = _unmarshalConsumerPauseResp(new_cpr, resp, errCode);
    }
    free(@as(?*anyopaque, @ptrCast(subj)));
    natsMsg_Destroy(resp);
    natsBuf_Destroy(buf);
    ...
    return if (s == @as(c_uint, @bitCast(NATS_OK))) s else nats_updateErrStack(s, "js_PauseConsumer");
}
pub export fn jsConsumerPauseResponse_Destroy(arg_cpr: [*c]jsConsumerPauseResponse) void {
    var cpr = arg_cpr;
    _ = &cpr;
    if (cpr == @as([*c]jsConsumerPauseResponse, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) return;
    free(@as(?*anyopaque, @ptrCast(cpr)));
}
pub export fn jsConsumerInfo_Destroy(arg_ci: [*c]jsConsumerInfo) void {
    var ci = arg_ci;
    _ = &ci;
    if (ci == @as([*c]jsConsumerInfo, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) return;
    free(@as(?*anyopaque, @ptrCast(ci.*.Stream)));
    free(@as(?*anyopaque, @ptrCast(ci.*.Name)));
    js_destroyConsumerConfig(ci.*.Config);
    _destroyClusterInfo(ci.*.Cluster);
    free(@as(?*anyopaque, @ptrCast(ci)));
}
pub export fn js_Consumers(arg_new_list: [*c][*c]jsConsumerInfoList, arg_js: [*c]jsCtx, arg_stream: [*c]const u8, arg_opts: [*c]jsOptions, arg_errCode: [*c]jsErrCode) natsStatus {
    var new_list = arg_new_list;
    _ = &new_list;
    var js = arg_js;
    _ = &js;
    ...
    var timeout: i64 = 0;
    _ = &timeout;
    var cons: [*c]natsStrHash = null;
    _ = &cons;
    var list: [*c]jsConsumerInfoList = null;
    _ = &list;
    var o: jsOptions = undefined;
    _ = &o;
    var page: apiPaged = apiPaged{
    ...
    if ((new_list == @as([*c][*c]jsConsumerInfoList, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) or (js == @as([*c]jsCtx, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0)))))))) return nats_setErrorReal("./src/submodules/nats.c/src/jsm.c", "js_Consumers", @as(c_int, 3702), @as(c_uint, @bitCast(NATS_INVALID_ARG)), "%s", natsStatus_GetText(@as(c_uint, @bitCast(NATS_INVALID_ARG))));
    s = _checkStreamName(stream);
    if (s != @as(c_uint, @bitCast(NATS_OK))) return if (s == @as(c_uint, @bitCast(NATS_OK))) s else nats_updateErrStack(s, "js_Consumers");
    s = js_setOpts(&nc, &freePfx, js, opts, &o);
    if (s == @as(c_uint, @bitCast(NATS_OK))) {
        if (asprintf(&subj, "%.*s.CONSUMER.LIST.%s", js_lenWithoutTrailingDot(o.Prefix), o.Prefix, stream) < @as(c_int, 0)) {
            s = nats_setErrorReal("./src/submodules/nats.c/src/jsm.c", "js_Consumers", @as(c_int, 3712), @as(c_uint, @bitCast(NATS_NO_MEMORY)), "%s", natsStatus_GetText(@as(c_uint, @bitCast(NATS_NO_MEMORY))));
        }
        if (freePfx) {
            free(@as(?*anyopaque, @ptrCast(@as([*c]u8, @ptrCast(@volatileCast(@constCast(o.Prefix)))))));
        }
    ...
    if (s == @as(c_uint, @bitCast(NATS_OK))) {
        s = natsBuf_Create(&buf, @as(c_int, 16));
    }
    if (s == @as(c_uint, @bitCast(NATS_OK))) {
        s = natsStrHash_Create(&cons, @as(c_int, 16));
    }
    if (s == @as(c_uint, @bitCast(NATS_OK))) {
        _ = memset(@as(?*anyopaque, @ptrCast(&page)), @as(c_int, 0), @sizeOf(apiPaged));
        start = nats_Now();
    ...
    while (true) {
        ...
        if (s == @as(c_uint, @bitCast(NATS_OK))) {
            s = _unmarshalConsumerInfoListResp(cons, &page, resp, errCode);
        }
        if (s == @as(c_uint, @bitCast(NATS_OK))) {
            offset += page.limit;
            done = offset >= page.total;
    ...
    free(@as(?*anyopaque, @ptrCast(subj)));
    if (s == @as(c_uint, @bitCast(NATS_OK))) {
        if (cons.*.used == @as(c_int, 0)) {
            natsStrHash_Destroy(cons);
            return @as(c_uint, @bitCast(NATS_NOT_FOUND));
        }
        list = @as([*c]jsConsumerInfoList, @ptrCast(@alignCast(calloc(@as(c_ulong, @bitCast(@as(c_long, @as(c_int, 1)))), @sizeOf(jsConsumerInfoList)))));
        if (list == @as([*c]jsConsumerInfoList, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) {
            s = nats_setErrorReal("./src/submodules/nats.c/src/jsm.c", "js_Consumers", @as(c_int, 3767), @as(c_uint, @bitCast(NATS_NO_MEMORY)), "%s", natsStatus_GetText(@as(c_uint, @bitCast(NATS_NO_MEMORY))));
        } else {
            list.*.List = @as([*c][*c]jsConsumerInfo, @ptrCast(@alignCast(calloc(@as(c_ulong, @bitCast(@as(c_long, cons.*.used))), @sizeOf([*c]jsConsumerInfo)))));
            if (list.*.List == @as([*c][*c]jsConsumerInfo, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) {
                free(@as(?*anyopaque, @ptrCast(list)));
                list = null;
                s = nats_setErrorReal("./src/submodules/nats.c/src/jsm.c", "js_Consumers", @as(c_int, 3775), @as(c_uint, @bitCast(NATS_NO_MEMORY)), "%s", natsStatus_GetText(@as(c_uint, @bitCast(NATS_NO_MEMORY))));
            } else {
                var iter: natsStrHashIter = undefined;
                _ = &iter;
                var val: ?*anyopaque = @as(?*anyopaque, @ptrFromInt(@as(c_int, 0)));
                ...
                while (natsStrHashIter_Next(&iter, null, &val)) {
                    var ci: [*c]jsConsumerInfo = @as([*c]jsConsumerInfo, @ptrCast(@alignCast(val)));
                    _ = &ci;
                    (blk: {
                        const tmp = blk_1: {
                            const ref = &list.*.Count;
    ...
    natsStrHash_Destroy(cons);
    return if (s == @as(c_uint, @bitCast(NATS_OK))) s else nats_updateErrStack(s, "js_Consumers");
}
pub export fn jsConsumerInfoList_Destroy(arg_list: [*c]jsConsumerInfoList) void {
    var list = arg_list;
    _ = &list;
    var i: c_int = undefined;
    _ = &i;
    if (list == @as([*c]jsConsumerInfoList, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) return;
    {
        i = 0;
        while (i < list.*.Count) : (i += 1) {
            jsConsumerInfo_Destroy((blk: {
                const tmp = i;
                if (tmp >= 0) break :blk list.*.List + @as(usize, @intCast(tmp)) else break :blk list.*.List - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
            }).*);
        }
...
pub export fn js_ConsumerNames(arg_new_list: [*c][*c]jsConsumerNamesList, arg_js: [*c]jsCtx, arg_stream: [*c]const u8, arg_opts: [*c]jsOptions, arg_errCode: [*c]jsErrCode) natsStatus {
    var new_list = arg_new_list;
    _ = &new_list;
    var js = arg_js;
    _ = &js;
    ...
    var names: [*c]natsStrHash = null;
    _ = &names;
    var list: [*c]jsConsumerNamesList = null;
    _ = &list;
    var o: jsOptions = undefined;
    _ = &o;
    var page: apiPaged = apiPaged{
    ...
    if ((new_list == @as([*c][*c]jsConsumerNamesList, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) or (js == @as([*c]jsCtx, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0)))))))) return nats_setErrorReal("./src/submodules/nats.c/src/jsm.c", "js_ConsumerNames", @as(c_int, 3853), @as(c_uint, @bitCast(NATS_INVALID_ARG)), "%s", natsStatus_GetText(@as(c_uint, @bitCast(NATS_INVALID_ARG))));
    s = _checkStreamName(stream);
    if (s != @as(c_uint, @bitCast(NATS_OK))) return if (s == @as(c_uint, @bitCast(NATS_OK))) s else nats_updateErrStack(s, "js_ConsumerNames");
    s = js_setOpts(&nc, &freePfx, js, opts, &o);
    if (s == @as(c_uint, @bitCast(NATS_OK))) {
        if (asprintf(&subj, "%.*s.CONSUMER.NAMES.%s", js_lenWithoutTrailingDot(o.Prefix), o.Prefix, stream) < @as(c_int, 0)) {
            s = nats_setErrorReal("./src/submodules/nats.c/src/jsm.c", "js_ConsumerNames", @as(c_int, 3863), @as(c_uint, @bitCast(NATS_NO_MEMORY)), "%s", natsStatus_GetText(@as(c_uint, @bitCast(NATS_NO_MEMORY))));
        }
        if (freePfx) {
            free(@as(?*anyopaque, @ptrCast(@as([*c]u8, @ptrCast(@volatileCast(@constCast(o.Prefix)))))));
        }
    ...
    while (true) {
        ...
        if (s == @as(c_uint, @bitCast(NATS_OK))) {
            s = _unmarshalNamesListResp("consumers", names, &page, resp, errCode);
        }
        if (s == @as(c_uint, @bitCast(NATS_OK))) {
            offset += page.limit;
            done = offset >= page.total;
    ...
    if (s == @as(c_uint, @bitCast(NATS_OK))) {
        ...
        list = @as([*c]jsConsumerNamesList, @ptrCast(@alignCast(calloc(@as(c_ulong, @bitCast(@as(c_long, @as(c_int, 1)))), @sizeOf(jsConsumerNamesList)))));
        if (list == @as([*c]jsConsumerNamesList, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) {
            s = nats_setErrorReal("./src/submodules/nats.c/src/jsm.c", "js_ConsumerNames", @as(c_int, 3918), @as(c_uint, @bitCast(NATS_NO_MEMORY)), "%s", natsStatus_GetText(@as(c_uint, @bitCast(NATS_NO_MEMORY))));
        } else {
            list.*.List = @as([*c][*c]u8, @ptrCast(@alignCast(calloc(@as(c_ulong, @bitCast(@as(c_long, names.*.used))), @sizeOf([*c]u8)))));
            if (list.*.List == @as([*c][*c]u8, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) {
                s = nats_setErrorReal("./src/submodules/nats.c/src/jsm.c", "js_ConsumerNames", @as(c_int, 3923), @as(c_uint, @bitCast(NATS_NO_MEMORY)), "%s", natsStatus_GetText(@as(c_uint, @bitCast(NATS_NO_MEMORY))));
            } else {
                var iter: natsStrHashIter = undefined;
                _ = &iter;
                var sname: [*c]u8 = null;
                ...
                while ((s == @as(c_uint, @bitCast(NATS_OK))) and (@as(c_int, @intFromBool(natsStrHashIter_Next(&iter, &sname, null))) != 0)) {
                    ...
                    _ = &copyName;
                    {
                        copyName = strdup(sname);
                        if (copyName == @as([*c]u8, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) {
                            s = nats_setErrorReal("./src/submodules/nats.c/src/jsm.c", "js_ConsumerNames", @as(c_int, 3934), @as(c_uint, @bitCast(NATS_NO_MEMORY)), "%s", natsStatus_GetText(@as(c_uint, @bitCast(NATS_NO_MEMORY))));
                        }
                    }
                    if (s == @as(c_uint, @bitCast(NATS_OK))) {
                        (blk: {
    ...
    natsStrHash_Destroy(names);
    return if (s == @as(c_uint, @bitCast(NATS_OK))) s else nats_updateErrStack(s, "js_ConsumerNames");
}
pub export fn jsConsumerNamesList_Destroy(arg_list: [*c]jsConsumerNamesList) void {
    var list = arg_list;
    _ = &list;
    var i: c_int = undefined;
    _ = &i;
    if (list == @as([*c]jsConsumerNamesList, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) return;
    {
        i = 0;
        while (i < list.*.Count) : (i += 1) {
            free(@as(?*anyopaque, @ptrCast((blk: {
...
pub export fn js_GetAccountInfo(arg_new_ai: [*c][*c]jsAccountInfo, arg_js: [*c]jsCtx, arg_opts: [*c]jsOptions, arg_errCode: [*c]jsErrCode) natsStatus {
    var new_ai = arg_new_ai;
    _ = &new_ai;
    var js = arg_js;
    _ = &js;
    var opts = arg_opts;
    ...
    if ((new_ai == @as([*c][*c]jsAccountInfo, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) or (js == @as([*c]jsCtx, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0)))))))) return nats_setErrorReal("./src/submodules/nats.c/src/jsm.c", "js_GetAccountInfo", @as(c_int, 2714), @as(c_uint, @bitCast(NATS_INVALID_ARG)), "%s", natsStatus_GetText(@as(c_uint, @bitCast(NATS_INVALID_ARG))));
    s = js_setOpts(&nc, &freePfx, js, opts, &o);
    if (s == @as(c_uint, @bitCast(NATS_OK))) {
        if (asprintf(&subj, "%.*s.INFO", js_lenWithoutTrailingDot(o.Prefix), o.Prefix) < @as(c_int, 0)) {
            s = nats_setErrorReal("./src/submodules/nats.c/src/jsm.c", "js_GetAccountInfo", @as(c_int, 2720), @as(c_uint, @bitCast(NATS_NO_MEMORY)), "%s", natsStatus_GetText(@as(c_uint, @bitCast(NATS_NO_MEMORY))));
        }
        if (freePfx) {
            free(@as(?*anyopaque, @ptrCast(@as([*c]u8, @ptrCast(@volatileCast(@constCast(o.Prefix)))))));
        }
    ...
    if (s == @as(c_uint, @bitCast(NATS_OK))) {
        s = _unmarshalAccountInfoResp(new_ai, resp, errCode);
    }
    free(@as(?*anyopaque, @ptrCast(subj)));
    natsMsg_Destroy(resp);
    return if (s == @as(c_uint, @bitCast(NATS_OK))) s else nats_updateErrStack(s, "js_GetAccountInfo");
}
pub export fn jsAccountInfo_Destroy(arg_ai: [*c]jsAccountInfo) void {
    var ai = arg_ai;
    _ = &ai;
    if (ai == @as([*c]jsAccountInfo, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) return;
    if (ai.*.Tiers != @as([*c][*c]jsTier, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) {
        var i: c_int = undefined;
        _ = &i;
        {
            i = 0;
            while (i < ai.*.TiersLen) : (i += 1) {
                var t: [*c]jsTier = (blk: {
                    const tmp = i;
                    if (tmp >= 0) break :blk ai.*.Tiers + @as(usize, @intCast(tmp)) else break :blk ai.*.Tiers - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
                }).*;
                _ = &t;
                free(@as(?*anyopaque, @ptrCast(@as([*c]u8, @ptrCast(@volatileCast(@constCast(t.*.Name)))))));
                free(@as(?*anyopaque, @ptrCast(t)));
            }
        }
        free(@as(?*anyopaque, @ptrCast(ai.*.Tiers)));
    }
    free(@as(?*anyopaque, @ptrCast(ai.*.Domain)));
    free(@as(?*anyopaque, @ptrCast(ai)));
}
...
pub extern fn natsSub_enqueueMessage(sub: [*c]natsSubscription, msg: [*c]natsMsg) void;
pub extern fn natsSub_enqueueUserMessage(sub: [*c]natsSubscription, msg: [*c]natsMsg) natsStatus;
...
pub extern fn nats_dispatchThreadPool(arg: ?*anyopaque) void;
pub extern fn nats_dispatchThreadOwn(arg: ?*anyopaque) void;
...
pub export fn js_unmarshalAccountInfo(arg_json: [*c]nats_JSON, arg_new_ai: [*c][*c]jsAccountInfo) natsStatus {
    var json = arg_json;
    _ = &json;
    var new_ai = arg_new_ai;
    _ = &new_ai;
    var s: natsStatus = undefined;
    _ = &s;
    var obj: [*c]nats_JSON = null;
    _ = &obj;
    var ai: [*c]jsAccountInfo = null;
    _ = &ai;
    ai = @as([*c]jsAccountInfo, @ptrCast(@alignCast(calloc(@as(c_ulong, @bitCast(@as(c_long, @as(c_int, 1)))), @sizeOf(jsAccountInfo)))));
    if (ai == @as([*c]jsAccountInfo, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) return nats_setErrorReal("./src/submodules/nats.c/src/jsm.c", "js_unmarshalAccountInfo", @as(c_int, 2650), @as(c_uint, @bitCast(NATS_NO_MEMORY)), "%s", natsStatus_GetText(@as(c_uint, @bitCast(NATS_NO_MEMORY))));
    s = nats_JSONGetULong(json, "memory", &ai.*.Memory);
    if (s == @as(c_uint, @bitCast(NATS_OK))) {
        s = nats_JSONGetULong(json, "storage", &ai.*.Store);
    }
    if (s == @as(c_uint, @bitCast(NATS_OK))) {
        s = nats_JSONGetLong(json, "streams", &ai.*.Streams);
    }
    if (s == @as(c_uint, @bitCast(NATS_OK))) {
        s = nats_JSONGetLong(json, "consumers", &ai.*.Consumers);
    }
    if (s == @as(c_uint, @bitCast(NATS_OK))) {
        s = nats_JSONGetStr(json, "domain", &ai.*.Domain);
    }
    if (s == @as(c_uint, @bitCast(NATS_OK))) {
        s = nats_JSONGetObject(json, "api", &obj);
    }
    if ((s == @as(c_uint, @bitCast(NATS_OK))) and (obj != @as([*c]nats_JSON, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0)))))))) {
        if (s == @as(c_uint, @bitCast(NATS_OK))) {
            s = nats_JSONGetULong(obj, "total", &ai.*.API.Total);
        }
        if (s == @as(c_uint, @bitCast(NATS_OK))) {
            s = nats_JSONGetULong(obj, "errors", &ai.*.API.Errors);
        }
        obj = null;
    }
    if (s == @as(c_uint, @bitCast(NATS_OK))) {
        s = _unmarshalAccLimits(json, &ai.*.Limits);
    }
    if (s == @as(c_uint, @bitCast(NATS_OK))) {
        s = _unmarshalAccTiers(json, ai);
    }
    if (s == @as(c_uint, @bitCast(NATS_OK))) {
        new_ai.* = ai;
    } else {
    ...
    return if (s == @as(c_uint, @bitCast(NATS_OK))) s else nats_updateErrStack(s, "js_unmarshalAccountInfo");
}
pub export fn js_marshalStreamConfig(arg_new_buf: [*c][*c]natsBuffer, arg_cfg: [*c]jsStreamConfig) natsStatus {
    var new_buf = arg_new_buf;
    _ = &new_buf;
    var cfg = arg_cfg;
    _ = &cfg;
    var buf: [*c]natsBuffer = null;
    ...
    var s: natsStatus = undefined;
    _ = &s;
    s = natsBuf_Create(&buf, @as(c_int, 256));
    if (s != @as(c_uint, @bitCast(NATS_OK))) return if (s == @as(c_uint, @bitCast(NATS_OK))) s else nats_updateErrStack(s, "js_marshalStreamConfig");
    s = natsBuf_Append(buf, "{\"name\":\"", -@as(c_int, 1));
    if (s == @as(c_uint, @bitCast(NATS_OK))) {
        s = natsBuf_Append(buf, cfg.*.Name, -@as(c_int, 1));
    }
    if (s == @as(c_uint, @bitCast(NATS_OK))) {
        s = natsBuf_AppendByte(buf, @as(u8, @bitCast(@as(i8, @truncate(@as(c_int, '"'))))));
    }
    if ((s == @as(c_uint, @bitCast(NATS_OK))) and !((if ((cfg.*.Description == @as([*c]const u8, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) or (@as(c_int, @bitCast(@as(c_uint, cfg.*.Description[@as(c_uint, @intCast(@as(c_int, 0)))]))) == @as(c_int, '\x00'))) @as(c_int, 1) else @as(c_int, 0)) != 0)) {
        if (s == @as(c_uint, @bitCast(NATS_OK))) {
            s = natsBuf_Append(buf, ",\"description\":\"", -@as(c_int, 1));
        }
        if (s == @as(c_uint, @bitCast(NATS_OK))) {
            s = natsBuf_Append(buf, cfg.*.Description, -@as(c_int, 1));
        }
        if (s == @as(c_uint, @bitCast(NATS_OK))) {
            s = natsBuf_AppendByte(buf, @as(u8, @bitCast(@as(i8, @truncate(@as(c_int, '"'))))));
        }
    }
    if ((s == @as(c_uint, @bitCast(NATS_OK))) and (cfg.*.SubjectsLen > @as(c_int, 0))) {
        var i: c_int = undefined;
        _ = &i;
        if (s == @as(c_uint, @bitCast(NATS_OK))) {
            s = natsBuf_Append(buf, ",\"subjects\":[\"", -@as(c_int, 1));
        }
        {
            i = 0;
            while ((s == @as(c_uint, @bitCast(NATS_OK))) and (i < cfg.*.SubjectsLen)) : (i += 1) {
                if (s == @as(c_uint, @bitCast(NATS_OK))) {
                    s = natsBuf_Append(buf, (blk: {
                        const tmp = i;
                        if (tmp >= 0) break :blk cfg.*.Subjects + @as(usize, @intCast(tmp)) else break :blk cfg.*.Subjects - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
                    }).*, -@as(c_int, 1));
                }
                if (s == @as(c_uint, @bitCast(NATS_OK))) {
                    s = natsBuf_AppendByte(buf, @as(u8, @bitCast(@as(i8, @truncate(@as(c_int, '"'))))));
                }
                if (i < (cfg.*.SubjectsLen - @as(c_int, 1))) if (s == @as(c_uint, @bitCast(NATS_OK))) {
                    s = natsBuf_Append(buf, ",\"", -@as(c_int, 1));
                };
            }
        }
        if (s == @as(c_uint, @bitCast(NATS_OK))) {
    ...
    if (s == @as(c_uint, @bitCast(NATS_OK))) {
        s = _marshalRetentionPolicy(cfg.*.Retention, buf);
    }
    if (s == @as(c_uint, @bitCast(NATS_OK))) {
        s = nats_marshalLong(buf, @as(c_int, 1) != 0, "max_consumers", cfg.*.MaxConsumers);
    }
    if (s == @as(c_uint, @bitCast(NATS_OK))) {
        s = nats_marshalLong(buf, @as(c_int, 1) != 0, "max_msgs", cfg.*.MaxMsgs);
    }
    if (s == @as(c_uint, @bitCast(NATS_OK))) {
        s = nats_marshalLong(buf, @as(c_int, 1) != 0, "max_bytes", cfg.*.MaxBytes);
    }
    if (s == @as(c_uint, @bitCast(NATS_OK))) {
        s = nats_marshalLong(buf, @as(c_int, 1) != 0, "max_age", cfg.*.MaxAge);
    }
    if (s == @as(c_uint, @bitCast(NATS_OK))) {
        s = nats_marshalLong(buf, @as(c_int, 1) != 0, "max_msg_size", @as(i64, @bitCast(@as(c_long, cfg.*.MaxMsgSize))));
    }
    if (s == @as(c_uint, @bitCast(NATS_OK))) {
        s = nats_marshalLong(buf, @as(c_int, 1) != 0, "max_msgs_per_subject", cfg.*.MaxMsgsPerSubject);
    }
    if (s == @as(c_uint, @bitCast(NATS_OK))) {
        s = _marshalDiscardPolicy(cfg.*.Discard, buf);
    }
    if (s == @as(c_uint, @bitCast(NATS_OK))) {
        s = _marshalStorageType(cfg.*.Storage, buf);
    }
    if (s == @as(c_uint, @bitCast(NATS_OK))) {
        s = nats_marshalLong(buf, @as(c_int, 1) != 0, "num_replicas", cfg.*.Replicas);
    }
    if ((s == @as(c_uint, @bitCast(NATS_OK))) and (@as(c_int, @intFromBool(cfg.*.NoAck)) != 0)) if (s == @as(c_uint, @bitCast(NATS_OK))) {
        s = natsBuf_Append(buf, ",\"no_ack\":true", -@as(c_int, 1));
    };
    if ((s == @as(c_uint, @bitCast(NATS_OK))) and (cfg.*.Template != @as([*c]const u8, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0)))))))) {
        if (s == @as(c_uint, @bitCast(NATS_OK))) {
            s = natsBuf_Append(buf, ",\"template_owner\":\"", -@as(c_int, 1));
        }
        if (s == @as(c_uint, @bitCast(NATS_OK))) {
            s = natsBuf_Append(buf, cfg.*.Template, -@as(c_int, 1));
        }
        if (s == @as(c_uint, @bitCast(NATS_OK))) {
            s = natsBuf_AppendByte(buf, @as(u8, @bitCast(@as(i8, @truncate(@as(c_int, '"'))))));
        }
    }
    if ((s == @as(c_uint, @bitCast(NATS_OK))) and (cfg.*.Duplicates != @as(i64, @bitCast(@as(c_long, @as(c_int, 0)))))) if (s == @as(c_uint, @bitCast(NATS_OK))) {
        s = nats_marshalLong(buf, @as(c_int, 1) != 0, "duplicate_window", cfg.*.Duplicates);
    };
    if ((s == @as(c_uint, @bitCast(NATS_OK))) and (cfg.*.Placement != @as([*c]jsPlacement, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0)))))))) if (s == @as(c_uint, @bitCast(NATS_OK))) {
        s = _marshalPlacement(cfg.*.Placement, buf);
    };
    if ((s == @as(c_uint, @bitCast(NATS_OK))) and (cfg.*.Mirror != @as([*c]jsStreamSource, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0)))))))) if (s == @as(c_uint, @bitCast(NATS_OK))) {
        s = _marshalStreamSource(cfg.*.Mirror, "mirror", buf);
    };
    if ((s == @as(c_uint, @bitCast(NATS_OK))) and (cfg.*.SourcesLen > @as(c_int, 0))) {
        var i: c_int = undefined;
        _ = &i;
        if (s == @as(c_uint, @bitCast(NATS_OK))) {
            s = natsBuf_Append(buf, ",\"sources\":[", -@as(c_int, 1));
        }
        {
            i = 0;
            while ((s == @as(c_uint, @bitCast(NATS_OK))) and (i < cfg.*.SourcesLen)) : (i += 1) {
                if (s == @as(c_uint, @bitCast(NATS_OK))) {
                    s = _marshalStreamSource((blk: {
                        const tmp = i;
                        if (tmp >= 0) break :blk cfg.*.Sources + @as(usize, @intCast(tmp)) else break :blk cfg.*.Sources - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
                    }).*, null, buf);
                }
                if ((s == @as(c_uint, @bitCast(NATS_OK))) and (i < (cfg.*.SourcesLen - @as(c_int, 1)))) if (s == @as(c_uint, @bitCast(NATS_OK))) {
                    s = natsBuf_AppendByte(buf, @as(u8, @bitCast(@as(i8, @truncate(@as(c_int, ','))))));
                };
            }
        }
    ...
    if ((s == @as(c_uint, @bitCast(NATS_OK))) and (@as(c_int, @intFromBool(cfg.*.Sealed)) != 0)) if (s == @as(c_uint, @bitCast(NATS_OK))) {
        s = natsBuf_Append(buf, ",\"sealed\":true", -@as(c_int, 1));
    };
    if ((s == @as(c_uint, @bitCast(NATS_OK))) and (@as(c_int, @intFromBool(cfg.*.DenyDelete)) != 0)) if (s == @as(c_uint, @bitCast(NATS_OK))) {
        s = natsBuf_Append(buf, ",\"deny_delete\":true", -@as(c_int, 1));
    };
    if ((s == @as(c_uint, @bitCast(NATS_OK))) and (@as(c_int, @intFromBool(cfg.*.DenyPurge)) != 0)) if (s == @as(c_uint, @bitCast(NATS_OK))) {
        s = natsBuf_Append(buf, ",\"deny_purge\":true", -@as(c_int, 1));
    };
    if ((s == @as(c_uint, @bitCast(NATS_OK))) and (@as(c_int, @intFromBool(cfg.*.AllowRollup)) != 0)) if (s == @as(c_uint, @bitCast(NATS_OK))) {
        s = natsBuf_Append(buf, ",\"allow_rollup_hdrs\":true", -@as(c_int, 1));
    };
    if (((s == @as(c_uint, @bitCast(NATS_OK))) and (cfg.*.RePublish != @as([*c]jsRePublish, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0)))))))) and !((if ((cfg.*.RePublish.*.Destination == @as([*c]const u8, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) or (@as(c_int, @bitCast(@as(c_uint, cfg.*.RePublish.*.Destination[@as(c_uint, @intCast(@as(c_int, 0)))]))) == @as(c_int, '\x00'))) @as(c_int, 1) else @as(c_int, 0)) != 0)) {
        if (s == @as(c_uint, @bitCast(NATS_OK))) {
            s = natsBuf_Append(buf, ",\"republish\":{\"dest\":\"", -@as(c_int, 1));
        }
        if (s == @as(c_uint, @bitCast(NATS_OK))) {
            s = natsBuf_Append(buf, cfg.*.RePublish.*.Destination, -@as(c_int, 1));
        }
        if (s == @as(c_uint, @bitCast(NATS_OK))) {
            s = natsBuf_AppendByte(buf, @as(u8, @bitCast(@as(i8, @truncate(@as(c_int, '"'))))));
        }
        if (!((if ((cfg.*.RePublish.*.Source == @as([*c]const u8, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) or (@as(c_int, @bitCast(@as(c_uint, cfg.*.RePublish.*.Source[@as(c_uint, @intCast(@as(c_int, 0)))]))) == @as(c_int, '\x00'))) @as(c_int, 1) else @as(c_int, 0)) != 0)) {
            if (s == @as(c_uint, @bitCast(NATS_OK))) {
                s = natsBuf_Append(buf, ",\"src\":\"", -@as(c_int, 1));
            }
            if (s == @as(c_uint, @bitCast(NATS_OK))) {
                s = natsBuf_Append(buf, cfg.*.RePublish.*.Source, -@as(c_int, 1));
            }
            if (s == @as(c_uint, @bitCast(NATS_OK))) {
                s = natsBuf_AppendByte(buf, @as(u8, @bitCast(@as(i8, @truncate(@as(c_int, '"'))))));
            }
        }
        if (cfg.*.RePublish.*.HeadersOnly) if (s == @as(c_uint, @bitCast(NATS_OK))) {
            s = natsBuf_Append(buf, ",\"headers_only\":true", -@as(c_int, 1));
        };
        if (s == @as(c_uint, @bitCast(NATS_OK))) {
            s = natsBuf_AppendByte(buf, @as(u8, @bitCast(@as(i8, @truncate(@as(c_int, '}'))))));
        }
    }
    if ((s == @as(c_uint, @bitCast(NATS_OK))) and (@as(c_int, @intFromBool(cfg.*.AllowDirect)) != 0)) if (s == @as(c_uint, @bitCast(NATS_OK))) {
        s = natsBuf_Append(buf, ",\"allow_direct\":true", -@as(c_int, 1));
    };
    if ((s == @as(c_uint, @bitCast(NATS_OK))) and (@as(c_int, @intFromBool(cfg.*.MirrorDirect)) != 0)) if (s == @as(c_uint, @bitCast(NATS_OK))) {
        s = natsBuf_Append(buf, ",\"mirror_direct\":true", -@as(c_int, 1));
    };
    if ((s == @as(c_uint, @bitCast(NATS_OK))) and (@as(c_int, @intFromBool(cfg.*.DiscardNewPerSubject)) != 0)) if (s == @as(c_uint, @bitCast(NATS_OK))) {
        s = natsBuf_Append(buf, ",\"discard_new_per_subject\":true", -@as(c_int, 1));
    };
    if (s == @as(c_uint, @bitCast(NATS_OK))) {
        s = nats_marshalMetadata(buf, @as(c_int, 1) != 0, "metadata", cfg.*.Metadata);
    }
    if (s == @as(c_uint, @bitCast(NATS_OK))) {
        s = _marshalStorageCompression(cfg.*.Compression, buf);
    }
    if (s == @as(c_uint, @bitCast(NATS_OK))) {
        s = nats_marshalULong(buf, @as(c_int, 1) != 0, "first_seq", cfg.*.FirstSeq);
    }
    if (s == @as(c_uint, @bitCast(NATS_OK))) {
        s = _marshalSubjectTransformConfig(&cfg.*.SubjectTransform, buf);
    }
    if (s == @as(c_uint, @bitCast(NATS_OK))) {
        s = _marshalStreamConsumerLimits(&cfg.*.ConsumerLimits, buf);
    }
    if (s == @as(c_uint, @bitCast(NATS_OK))) {
        s = natsBuf_AppendByte(buf, @as(u8, @bitCast(@as(i8, @truncate(@as(c_int, '}'))))));
    }
    ...
    return if (s == @as(c_uint, @bitCast(NATS_OK))) s else nats_updateErrStack(s, "js_marshalStreamConfig");
}
pub export fn js_unmarshalStreamConfig(arg_json: [*c]nats_JSON, arg_fieldName: [*c]const u8, arg_new_cfg: [*c][*c]jsStreamConfig) natsStatus {
    var json = arg_json;
    _ = &json;
    var fieldName = arg_fieldName;
    _ = &fieldName;
    var new_cfg = arg_new_cfg;
    _ = &new_cfg;
    var jcfg: [*c]nats_JSON = null;
    _ = &jcfg;
    var cfg: [*c]jsStreamConfig = null;
    _ = &cfg;
    var sources: [*c][*c]nats_JSON = null;
    _ = &sources;
    var sourcesLen: c_int = 0;
    _ = &sourcesLen;
    var obj: [*c]nats_JSON = null;
    _ = &obj;
    var s: natsStatus = undefined;
    _ = &s;
    if (fieldName != @as([*c]const u8, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) {
        s = nats_JSONGetObject(json, fieldName, &jcfg);
        if (jcfg == @as([*c]nats_JSON, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) return if (s == @as(c_uint, @bitCast(NATS_OK))) s else nats_updateErrStack(s, "js_unmarshalStreamConfig");
    } else {
        jcfg = json;
    }
    cfg = @as([*c]jsStreamConfig, @ptrCast(@alignCast(calloc(@as(c_ulong, @bitCast(@as(c_long, @as(c_int, 1)))), @sizeOf(jsStreamConfig)))));
    if (cfg == @as([*c]jsStreamConfig, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) return nats_setErrorReal("./src/submodules/nats.c/src/jsm.c", "js_unmarshalStreamConfig", @as(c_int, 710), @as(c_uint, @bitCast(NATS_NO_MEMORY)), "%s", natsStatus_GetText(@as(c_uint, @bitCast(NATS_NO_MEMORY))));
    s = nats_JSONGetStr(jcfg, "name", @as([*c][*c]u8, @ptrCast(@alignCast(&cfg.*.Name))));
    if (s == @as(c_uint, @bitCast(NATS_OK))) {
        s = nats_JSONGetStr(jcfg, "description", @as([*c][*c]u8, @ptrCast(@alignCast(&cfg.*.Description))));
    }
    if (s == @as(c_uint, @bitCast(NATS_OK))) {
        s = nats_JSONGetArrayStr(jcfg, "subjects", @as([*c][*c][*c]u8, @ptrCast(@alignCast(&cfg.*.Subjects))), &cfg.*.SubjectsLen);
    }
    if (s == @as(c_uint, @bitCast(NATS_OK))) {
        s = _unmarshalRetentionPolicy(jcfg, "retention", &cfg.*.Retention);
    }
    if (s == @as(c_uint, @bitCast(NATS_OK))) {
        s = nats_JSONGetLong(jcfg, "max_consumers", &cfg.*.MaxConsumers);
    }
    if (s == @as(c_uint, @bitCast(NATS_OK))) {
        s = nats_JSONGetLong(jcfg, "max_msgs", &cfg.*.MaxMsgs);
    }
    if (s == @as(c_uint, @bitCast(NATS_OK))) {
        s = nats_JSONGetLong(jcfg, "max_bytes", &cfg.*.MaxBytes);
    }
    if (s == @as(c_uint, @bitCast(NATS_OK))) {
        s = nats_JSONGetLong(jcfg, "max_age", &cfg.*.MaxAge);
    }
    if (s == @as(c_uint, @bitCast(NATS_OK))) {
        s = nats_JSONGetLong(jcfg, "max_msgs_per_subject", &cfg.*.MaxMsgsPerSubject);
    }
    if (s == @as(c_uint, @bitCast(NATS_OK))) {
        s = nats_JSONGetInt32(jcfg, "max_msg_size", &cfg.*.MaxMsgSize);
    }
    if (s == @as(c_uint, @bitCast(NATS_OK))) {
        s = _unmarshalDiscardPolicy(jcfg, "discard", &cfg.*.Discard);
    }
    if (s == @as(c_uint, @bitCast(NATS_OK))) {
        s = _unmarshalStorageType(jcfg, "storage", &cfg.*.Storage);
    }
    if (s == @as(c_uint, @bitCast(NATS_OK))) {
        s = nats_JSONGetLong(jcfg, "num_replicas", &cfg.*.Replicas);
    }
    if (s == @as(c_uint, @bitCast(NATS_OK))) {
        s = nats_JSONGetBool(jcfg, "no_ack", &cfg.*.NoAck);
    }
    if (s == @as(c_uint, @bitCast(NATS_OK))) {
        s = nats_JSONGetStr(jcfg, "template_owner", @as([*c][*c]u8, @ptrCast(@alignCast(&cfg.*.Template))));
    }
    if (s == @as(c_uint, @bitCast(NATS_OK))) {
        s = nats_JSONGetLong(jcfg, "duplicate_window", &cfg.*.Duplicates);
    }
    if (s == @as(c_uint, @bitCast(NATS_OK))) {
        s = _unmarshalPlacement(jcfg, "placement", &cfg.*.Placement);
    }
    if (s == @as(c_uint, @bitCast(NATS_OK))) {
        s = _unmarshalStreamSource(jcfg, "mirror", &cfg.*.Mirror);
    }
    if (s == @as(c_uint, @bitCast(NATS_OK))) {
        s = nats_JSONGetArrayObject(jcfg, "sources", &sources, &sourcesLen);
    }
    if ((s == @as(c_uint, @bitCast(NATS_OK))) and (sources != @as([*c][*c]nats_JSON, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0)))))))) {
        var i: c_int = undefined;
        _ = &i;
        cfg.*.Sources = @as([*c][*c]jsStreamSource, @ptrCast(@alignCast(calloc(@as(c_ulong, @bitCast(@as(c_long, sourcesLen))), @sizeOf([*c]jsStreamSource)))));
        if (cfg.*.Sources == @as([*c][*c]jsStreamSource, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) {
            s = nats_setErrorReal("./src/submodules/nats.c/src/jsm.c", "js_unmarshalStreamConfig", @as(c_int, 738), @as(c_uint, @bitCast(NATS_NO_MEMORY)), "%s", natsStatus_GetText(@as(c_uint, @bitCast(NATS_NO_MEMORY))));
        }
        {
            i = 0;
            while ((s == @as(c_uint, @bitCast(NATS_OK))) and (i < sourcesLen)) : (i += 1) {
                s = _unmarshalStreamSource((blk: {
                    const tmp = i;
                    if (tmp >= 0) break :blk sources + @as(usize, @intCast(tmp)) else break :blk sources - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
                }).*, null, &(blk: {
                    const tmp = i;
                    if (tmp >= 0) break :blk cfg.*.Sources + @as(usize, @intCast(tmp)) else break :blk cfg.*.Sources - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
                }).*);
        ...
        free(@as(?*anyopaque, @ptrCast(sources)));
    }
    if (s == @as(c_uint, @bitCast(NATS_OK))) {
        s = nats_JSONGetBool(jcfg, "sealed", &cfg.*.Sealed);
    }
    if (s == @as(c_uint, @bitCast(NATS_OK))) {
        s = nats_JSONGetBool(jcfg, "deny_delete", &cfg.*.DenyDelete);
    }
    if (s == @as(c_uint, @bitCast(NATS_OK))) {
        s = nats_JSONGetBool(jcfg, "deny_purge", &cfg.*.DenyPurge);
    }
    if (s == @as(c_uint, @bitCast(NATS_OK))) {
        s = nats_JSONGetBool(jcfg, "allow_rollup_hdrs", &cfg.*.AllowRollup);
    }
    if (s == @as(c_uint, @bitCast(NATS_OK))) {
        s = _unmarshalRePublish(jcfg, "republish", &cfg.*.RePublish);
    }
    if (s == @as(c_uint, @bitCast(NATS_OK))) {
        s = nats_JSONGetBool(jcfg, "allow_direct", &cfg.*.AllowDirect);
    }
    if (s == @as(c_uint, @bitCast(NATS_OK))) {
        s = nats_JSONGetBool(jcfg, "mirror_direct", &cfg.*.MirrorDirect);
    }
    if (s == @as(c_uint, @bitCast(NATS_OK))) {
        s = nats_JSONGetBool(jcfg, "discard_new_per_subject", &cfg.*.DiscardNewPerSubject);
    }
    if (s == @as(c_uint, @bitCast(NATS_OK))) {
        s = nats_unmarshalMetadata(jcfg, "metadata", &cfg.*.Metadata);
    }
    if (s == @as(c_uint, @bitCast(NATS_OK))) {
        s = _unmarshalStorageCompression(jcfg, "storage", &cfg.*.Compression);
    }
    if (s == @as(c_uint, @bitCast(NATS_OK))) {
        s = nats_JSONGetULong(jcfg, "first_seq", &cfg.*.FirstSeq);
    }
    if (s == @as(c_uint, @bitCast(NATS_OK))) {
        s = nats_JSONGetObject(jcfg, "subject_transform", &obj);
    }
    if (s == @as(c_uint, @bitCast(NATS_OK))) {
        s = _unmarshalSubjectTransformConfig(obj, &cfg.*.SubjectTransform);
    }
    obj = null;
    if (s == @as(c_uint, @bitCast(NATS_OK))) {
        s = nats_JSONGetObject(jcfg, "consumer_limits", &obj);
    }
    if (s == @as(c_uint, @bitCast(NATS_OK))) {
        s = _unmarshalStreamConsumerLimits(obj, &cfg.*.ConsumerLimits);
    }
    if (s == @as(c_uint, @bitCast(NATS_OK))) {
        new_cfg.* = cfg;
    } else {
    ...
    return if (s == @as(c_uint, @bitCast(NATS_OK))) s else nats_updateErrStack(s, "js_unmarshalStreamConfig");
}
pub export fn js_destroyStreamConfig(arg_cfg: [*c]jsStreamConfig) void {
    var cfg = arg_cfg;
    _ = &cfg;
    var i: c_int = undefined;
    _ = &i;
    if (cfg == @as([*c]jsStreamConfig, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) return;
    free(@as(?*anyopaque, @ptrCast(@as([*c]u8, @ptrCast(@volatileCast(@constCast(cfg.*.Name)))))));
    free(@as(?*anyopaque, @ptrCast(@as([*c]u8, @ptrCast(@volatileCast(@constCast(cfg.*.Description)))))));
    {
        i = 0;
        while (i < cfg.*.SubjectsLen) : (i += 1) {
            free(@as(?*anyopaque, @ptrCast(@as([*c]u8, @ptrCast(@volatileCast(@constCast((blk: {
                const tmp = i;
                if (tmp >= 0) break :blk cfg.*.Subjects + @as(usize, @intCast(tmp)) else break :blk cfg.*.Subjects - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
            }).*)))))));
        }
    }
    free(@as(?*anyopaque, @ptrCast(@as([*c][*c]u8, @ptrCast(@alignCast(cfg.*.Subjects))))));
    free(@as(?*anyopaque, @ptrCast(@as([*c]u8, @ptrCast(@volatileCast(@constCast(cfg.*.Template)))))));
    _destroyPlacement(cfg.*.Placement);
    _destroyStreamSource(cfg.*.Mirror);
    {
        i = 0;
        while (i < cfg.*.SourcesLen) : (i += 1) {
            _destroyStreamSource((blk: {
                const tmp = i;
                if (tmp >= 0) break :blk cfg.*.Sources + @as(usize, @intCast(tmp)) else break :blk cfg.*.Sources - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
            }).*);
        }
    }
    free(@as(?*anyopaque, @ptrCast(cfg.*.Sources)));
    _destroyRePublish(cfg.*.RePublish);
    nats_freeMetadata(&cfg.*.Metadata);
    free(@as(?*anyopaque, @ptrCast(@as([*c]u8, @ptrCast(@volatileCast(@constCast(cfg.*.SubjectTransform.Source)))))));
    free(@as(?*anyopaque, @ptrCast(@as([*c]u8, @ptrCast(@volatileCast(@constCast(cfg.*.SubjectTransform.Destination)))))));
    free(@as(?*anyopaque, @ptrCast(cfg)));
}
pub export fn js_unmarshalStreamState(arg_pjson: [*c]nats_JSON, arg_fieldName: [*c]const u8, arg_state: [*c]jsStreamState) natsStatus {
    var pjson = arg_pjson;
    _ = &pjson;
    var fieldName = arg_fieldName;
    _ = &fieldName;
    var state = arg_state;
    _ = &state;
    var json: [*c]nats_JSON = null;
    _ = &json;
    var s: natsStatus = undefined;
    _ = &s;
    s = nats_JSONGetObject(pjson, fieldName, &json);
    if (json == @as([*c]nats_JSON, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) return if (s == @as(c_uint, @bitCast(NATS_OK))) s else nats_updateErrStack(s, "js_unmarshalStreamState");
    s = nats_JSONGetULong(json, "messages", &state.*.Msgs);
    if (s == @as(c_uint, @bitCast(NATS_OK))) {
        s = nats_JSONGetULong(json, "bytes", &state.*.Bytes);
    }
    if (s == @as(c_uint, @bitCast(NATS_OK))) {
        s = nats_JSONGetULong(json, "first_seq", &state.*.FirstSeq);
    }
    if (s == @as(c_uint, @bitCast(NATS_OK))) {
        s = nats_JSONGetTime(json, "first_ts", &state.*.FirstTime);
    }
    if (s == @as(c_uint, @bitCast(NATS_OK))) {
        s = nats_JSONGetULong(json, "last_seq", &state.*.LastSeq);
    }
    if (s == @as(c_uint, @bitCast(NATS_OK))) {
        s = nats_JSONGetTime(json, "last_ts", &state.*.LastTime);
    }
    if (s == @as(c_uint, @bitCast(NATS_OK))) {
        s = nats_JSONGetULong(json, "num_deleted", &state.*.NumDeleted);
    }
    if (s == @as(c_uint, @bitCast(NATS_OK))) {
        s = nats_JSONGetArrayULong(json, "deleted", &state.*.Deleted, &state.*.DeletedLen);
    }
    if (s == @as(c_uint, @bitCast(NATS_OK))) {
        s = _unmarshalLostStreamData(json, "lost", &state.*.Lost);
    }
    if (s == @as(c_uint, @bitCast(NATS_OK))) {
        s = nats_JSONGetLong(json, "consumer_count", &state.*.Consumers);
    }
    if (s == @as(c_uint, @bitCast(NATS_OK))) {
        s = nats_JSONGetLong(json, "num_subjects", &state.*.NumSubjects);
    }
    if (s == @as(c_uint, @bitCast(NATS_OK))) {
        s = _unmarshalStreamStateSubjects(json, "subjects", &state.*.Subjects);
    }
    return if (s == @as(c_uint, @bitCast(NATS_OK))) s else nats_updateErrStack(s, "js_unmarshalStreamState");
}
pub export fn js_unmarshalStreamInfo(arg_json: [*c]nats_JSON, arg_new_si: [*c][*c]jsStreamInfo) natsStatus {
    var json = arg_json;
    _ = &json;
    var new_si = arg_new_si;
    _ = &new_si;
    var s: natsStatus = _unmarshalStreamInfoPaged(json, new_si, null);
    _ = &s;
    return if (s == @as(c_uint, @bitCast(NATS_OK))) s else nats_updateErrStack(s, "js_unmarshalStreamInfo");
}
pub export fn js_unmarshalConsumerInfo(arg_json: [*c]nats_JSON, arg_new_ci: [*c][*c]jsConsumerInfo) natsStatus {
    var json = arg_json;
    _ = &json;
    var new_ci = arg_new_ci;
    _ = &new_ci;
    var s: natsStatus = @as(c_uint, @bitCast(NATS_OK));
    _ = &s;
    var ci: [*c]jsConsumerInfo = null;
    _ = &ci;
    ci = @as([*c]jsConsumerInfo, @ptrCast(@alignCast(calloc(@as(c_ulong, @bitCast(@as(c_long, @as(c_int, 1)))), @sizeOf(jsConsumerInfo)))));
    if (ci == @as([*c]jsConsumerInfo, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) return nats_setErrorReal("./src/submodules/nats.c/src/jsm.c", "js_unmarshalConsumerInfo", @as(c_int, 3186), @as(c_uint, @bitCast(NATS_NO_MEMORY)), "%s", natsStatus_GetText(@as(c_uint, @bitCast(NATS_NO_MEMORY))));
    s = nats_JSONGetStr(json, "stream_name", &ci.*.Stream);
    if (s == @as(c_uint, @bitCast(NATS_OK))) {
        s = nats_JSONGetStr(json, "name", &ci.*.Name);
    }
    if (s == @as(c_uint, @bitCast(NATS_OK))) {
        s = nats_JSONGetTime(json, "created", &ci.*.Created);
    }
    if (s == @as(c_uint, @bitCast(NATS_OK))) {
        s = _unmarshalConsumerConfig(json, "config", &ci.*.Config);
    }
    if (s == @as(c_uint, @bitCast(NATS_OK))) {
        s = _unmarshalSeqInfo(json, "delivered", &ci.*.Delivered);
    }
    if (s == @as(c_uint, @bitCast(NATS_OK))) {
        s = _unmarshalSeqInfo(json, "ack_floor", &ci.*.AckFloor);
    }
    if (s == @as(c_uint, @bitCast(NATS_OK))) {
        s = nats_JSONGetLong(json, "num_ack_pending", &ci.*.NumAckPending);
    }
    if (s == @as(c_uint, @bitCast(NATS_OK))) {
        s = nats_JSONGetLong(json, "num_redelivered", &ci.*.NumRedelivered);
    }
    if (s == @as(c_uint, @bitCast(NATS_OK))) {
        s = nats_JSONGetLong(json, "num_waiting", &ci.*.NumWaiting);
    }
    if (s == @as(c_uint, @bitCast(NATS_OK))) {
        s = nats_JSONGetULong(json, "num_pending", &ci.*.NumPending);
    }
    if (s == @as(c_uint, @bitCast(NATS_OK))) {
        s = _unmarshalClusterInfo(json, "cluster", &ci.*.Cluster);
    }
    if (s == @as(c_uint, @bitCast(NATS_OK))) {
        s = nats_JSONGetBool(json, "push_bound", &ci.*.PushBound);
    }
    if (s == @as(c_uint, @bitCast(NATS_OK))) {
        s = nats_JSONGetBool(json, "paused", &ci.*.Paused);
    }
    if (s == @as(c_uint, @bitCast(NATS_OK))) {
        s = nats_JSONGetLong(json, "pause_remaining", &ci.*.PauseRemaining);
    }
    if (s == @as(c_uint, @bitCast(NATS_OK))) {
        new_ci.* = ci;
    } else {
    ...
    return if (s == @as(c_uint, @bitCast(NATS_OK))) s else nats_updateErrStack(s, "js_unmarshalConsumerInfo");
}
pub export fn js_cleanStreamState(arg_state: [*c]jsStreamState) void {
    var state = arg_state;
    _ = &state;
    if (state == @as([*c]jsStreamState, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) return;
    free(@as(?*anyopaque, @ptrCast(state.*.Deleted)));
...
pub export fn js_directGetMsgToJSMsg(arg_stream: [*c]const u8, arg_msg: [*c]natsMsg) natsStatus {
    var stream = arg_stream;
    _ = &stream;
    var msg = arg_msg;
    _ = &msg;
    ...
    var tm_1: i64 = 0;
    _ = &tm_1;
    if ((msg.*.hdrLen == @as(c_int, 0)) and (msg.*.headers == @as([*c]natsStrHash, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0)))))))) return nats_setErrorReal("./src/submodules/nats.c/src/jsm.c", "js_directGetMsgToJSMsg", @as(c_int, 1974), @as(c_uint, @bitCast(NATS_ERR)), "%s", "direct get message response should have headers");
    if ((natsMsg_GetDataLength(msg) == @as(c_int, 0)) and (natsMsgHeader_Get(msg, "Status", &val) == @as(c_uint, @bitCast(NATS_OK)))) {
        if (strcmp(val, "404") == @as(c_int, 0)) return nats_setErrorReal("./src/submodules/nats.c/src/jsm.c", "js_directGetMsgToJSMsg", @as(c_int, 1982), @as(c_uint, @bitCast(NATS_NOT_FOUND)), "%s", natsStatus_GetText(@as(c_uint, @bitCast(NATS_NOT_FOUND)))) else {
            _ = natsMsgHeader_Get(msg, "Description", &val);
            return nats_setErrorReal("./src/submodules/nats.c/src/jsm.c", "js_directGetMsgToJSMsg", @as(c_int, 1986), @as(c_uint, @bitCast(NATS_ERR)), "error getting message: %s", val);
        }
    }
    s = natsMsgHeader_Get(msg, "Nats-Stream", &val);
    if ((s != @as(c_uint, @bitCast(NATS_OK))) or ((if ((val == @as([*c]const u8, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) or (@as(c_int, @bitCast(@as(c_uint, val[@as(c_uint, @intCast(@as(c_int, 0)))]))) == @as(c_int, '\x00'))) @as(c_int, 1) else @as(c_int, 0)) != 0)) return nats_setErrorReal("./src/submodules/nats.c/src/jsm.c", "js_directGetMsgToJSMsg", @as(c_int, 1992), @as(c_uint, @bitCast(NATS_ERR)), "missing stream name '%s'", val);
    val = null;
    s = natsMsgHeader_Get(msg, "Nats-Sequence", &val);
    if ((s != @as(c_uint, @bitCast(NATS_OK))) or ((blk: {
        const tmp = nats_ParseInt64(val, @as(c_int, @bitCast(@as(c_uint, @truncate(strlen(val))))));
        seq = tmp;
        break :blk tmp;
    }) == @as(i64, @bitCast(@as(c_long, -@as(c_int, 1)))))) return nats_setErrorReal("./src/submodules/nats.c/src/jsm.c", "js_directGetMsgToJSMsg", @as(c_int, 1997), @as(c_uint, @bitCast(NATS_ERR)), "missing or invalid sequence '%s'", val);
    val = null;
    s = natsMsgHeader_Get(msg, "Nats-Time-Stamp", &val);
    if ((s == @as(c_uint, @bitCast(NATS_OK))) and !((if ((val == @as([*c]const u8, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) or (@as(c_int, @bitCast(@as(c_uint, val[@as(c_uint, @intCast(@as(c_int, 0)))]))) == @as(c_int, '\x00'))) @as(c_int, 1) else @as(c_int, 0)) != 0)) {
        s = nats_parseTime(@as([*c]u8, @ptrCast(@volatileCast(@constCast(val)))), &tm_1);
    }
    if ((s != @as(c_uint, @bitCast(NATS_OK))) or (tm_1 == @as(i64, @bitCast(@as(c_long, @as(c_int, 0)))))) return nats_setErrorReal("./src/submodules/nats.c/src/jsm.c", "js_directGetMsgToJSMsg", @as(c_int, 2004), @as(c_uint, @bitCast(NATS_ERR)), "missing or invalid timestamp '%s'", val);
    val = null;
    s = natsMsgHeader_Get(msg, "Nats-Subject", &val);
    if ((s != @as(c_uint, @bitCast(NATS_OK))) or ((if ((val == @as([*c]const u8, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) or (@as(c_int, @bitCast(@as(c_uint, val[@as(c_uint, @intCast(@as(c_int, 0)))]))) == @as(c_int, '\x00'))) @as(c_int, 1) else @as(c_int, 0)) != 0)) return nats_setErrorReal("./src/submodules/nats.c/src/jsm.c", "js_directGetMsgToJSMsg", @as(c_int, 2009), @as(c_uint, @bitCast(NATS_ERR)), "missing or invalid subject '%s'", val);
    msg.*.subject = val;
    msg.*.seq = @as(u64, @bitCast(seq));
    msg.*.time = tm_1;
    return @as(c_uint, @bitCast(NATS_OK));
}
pub export fn js_cloneConsumerConfig(arg_org: [*c]jsConsumerConfig, arg_clone_1: [*c][*c]jsConsumerConfig) natsStatus {
    var org = arg_org;
    _ = &org;
    var clone_1 = arg_clone_1;
    _ = &clone_1;
    var s: natsStatus = @as(c_uint, @bitCast(NATS_OK));
    _ = &s;
    var c: [*c]jsConsumerConfig = null;
    _ = &c;
    clone_1.* = null;
    if (org == @as([*c]jsConsumerConfig, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) return @as(c_uint, @bitCast(NATS_OK));
    c = @as([*c]jsConsumerConfig, @ptrCast(@alignCast(calloc(@as(c_ulong, @bitCast(@as(c_long, @as(c_int, 1)))), @sizeOf(jsConsumerConfig)))));
    if (c == @as([*c]jsConsumerConfig, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) return nats_setErrorReal("./src/submodules/nats.c/src/jsm.c", "js_cloneConsumerConfig", @as(c_int, 3981), @as(c_uint, @bitCast(NATS_NO_MEMORY)), "%s", natsStatus_GetText(@as(c_uint, @bitCast(NATS_NO_MEMORY))));
    _ = memcpy(@as(?*anyopaque, @ptrCast(c)), @as(?*const anyopaque, @ptrCast(org)), @sizeOf(jsConsumerConfig));
    c.*.Name = null;
    c.*.Durable = null;
    c.*.Description = null;
    c.*.BackOff = null;
    ...
    c.*.DeliverGroup = null;
    if ((s == @as(c_uint, @bitCast(NATS_OK))) and !((if ((org.*.Name == @as([*c]const u8, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) or (@as(c_int, @bitCast(@as(c_uint, org.*.Name[@as(c_uint, @intCast(@as(c_int, 0)))]))) == @as(c_int, '\x00'))) @as(c_int, 1) else @as(c_int, 0)) != 0)) {
        c.*.Name = strdup(org.*.Name);
        if (c.*.Name == @as([*c]const u8, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) {
            s = nats_setErrorReal("./src/submodules/nats.c/src/jsm.c", "js_cloneConsumerConfig", @as(c_int, 3998), @as(c_uint, @bitCast(NATS_NO_MEMORY)), "%s", natsStatus_GetText(@as(c_uint, @bitCast(NATS_NO_MEMORY))));
        }
    }
    if ((s == @as(c_uint, @bitCast(NATS_OK))) and !((if ((org.*.Durable == @as([*c]const u8, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) or (@as(c_int, @bitCast(@as(c_uint, org.*.Durable[@as(c_uint, @intCast(@as(c_int, 0)))]))) == @as(c_int, '\x00'))) @as(c_int, 1) else @as(c_int, 0)) != 0)) {
        c.*.Durable = strdup(org.*.Durable);
        if (c.*.Durable == @as([*c]const u8, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) {
            s = nats_setErrorReal("./src/submodules/nats.c/src/jsm.c", "js_cloneConsumerConfig", @as(c_int, 3999), @as(c_uint, @bitCast(NATS_NO_MEMORY)), "%s", natsStatus_GetText(@as(c_uint, @bitCast(NATS_NO_MEMORY))));
        }
    }
    if ((s == @as(c_uint, @bitCast(NATS_OK))) and !((if ((org.*.Description == @as([*c]const u8, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) or (@as(c_int, @bitCast(@as(c_uint, org.*.Description[@as(c_uint, @intCast(@as(c_int, 0)))]))) == @as(c_int, '\x00'))) @as(c_int, 1) else @as(c_int, 0)) != 0)) {
        c.*.Description = strdup(org.*.Description);
        if (c.*.Description == @as([*c]const u8, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) {
            s = nats_setErrorReal("./src/submodules/nats.c/src/jsm.c", "js_cloneConsumerConfig", @as(c_int, 4000), @as(c_uint, @bitCast(NATS_NO_MEMORY)), "%s", natsStatus_GetText(@as(c_uint, @bitCast(NATS_NO_MEMORY))));
        }
    }
    if ((s == @as(c_uint, @bitCast(NATS_OK))) and !((if ((org.*.FilterSubject == @as([*c]const u8, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) or (@as(c_int, @bitCast(@as(c_uint, org.*.FilterSubject[@as(c_uint, @intCast(@as(c_int, 0)))]))) == @as(c_int, '\x00'))) @as(c_int, 1) else @as(c_int, 0)) != 0)) {
        c.*.FilterSubject = strdup(org.*.FilterSubject);
        if (c.*.FilterSubject == @as([*c]const u8, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) {
            s = nats_setErrorReal("./src/submodules/nats.c/src/jsm.c", "js_cloneConsumerConfig", @as(c_int, 4001), @as(c_uint, @bitCast(NATS_NO_MEMORY)), "%s", natsStatus_GetText(@as(c_uint, @bitCast(NATS_NO_MEMORY))));
        }
    }
    if ((s == @as(c_uint, @bitCast(NATS_OK))) and !((if ((org.*.SampleFrequency == @as([*c]const u8, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) or (@as(c_int, @bitCast(@as(c_uint, org.*.SampleFrequency[@as(c_uint, @intCast(@as(c_int, 0)))]))) == @as(c_int, '\x00'))) @as(c_int, 1) else @as(c_int, 0)) != 0)) {
        c.*.SampleFrequency = strdup(org.*.SampleFrequency);
        if (c.*.SampleFrequency == @as([*c]const u8, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) {
            s = nats_setErrorReal("./src/submodules/nats.c/src/jsm.c", "js_cloneConsumerConfig", @as(c_int, 4002), @as(c_uint, @bitCast(NATS_NO_MEMORY)), "%s", natsStatus_GetText(@as(c_uint, @bitCast(NATS_NO_MEMORY))));
        }
    }
    if ((s == @as(c_uint, @bitCast(NATS_OK))) and !((if ((org.*.DeliverSubject == @as([*c]const u8, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) or (@as(c_int, @bitCast(@as(c_uint, org.*.DeliverSubject[@as(c_uint, @intCast(@as(c_int, 0)))]))) == @as(c_int, '\x00'))) @as(c_int, 1) else @as(c_int, 0)) != 0)) {
        c.*.DeliverSubject = strdup(org.*.DeliverSubject);
        if (c.*.DeliverSubject == @as([*c]const u8, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) {
            s = nats_setErrorReal("./src/submodules/nats.c/src/jsm.c", "js_cloneConsumerConfig", @as(c_int, 4003), @as(c_uint, @bitCast(NATS_NO_MEMORY)), "%s", natsStatus_GetText(@as(c_uint, @bitCast(NATS_NO_MEMORY))));
        }
    }
    if ((s == @as(c_uint, @bitCast(NATS_OK))) and !((if ((org.*.DeliverGroup == @as([*c]const u8, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) or (@as(c_int, @bitCast(@as(c_uint, org.*.DeliverGroup[@as(c_uint, @intCast(@as(c_int, 0)))]))) == @as(c_int, '\x00'))) @as(c_int, 1) else @as(c_int, 0)) != 0)) {
        c.*.DeliverGroup = strdup(org.*.DeliverGroup);
        if (c.*.DeliverGroup == @as([*c]const u8, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) {
            s = nats_setErrorReal("./src/submodules/nats.c/src/jsm.c", "js_cloneConsumerConfig", @as(c_int, 4004), @as(c_uint, @bitCast(NATS_NO_MEMORY)), "%s", natsStatus_GetText(@as(c_uint, @bitCast(NATS_NO_MEMORY))));
        }
    }
    if (((s == @as(c_uint, @bitCast(NATS_OK))) and (org.*.BackOff != @as([*c]i64, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0)))))))) and (org.*.BackOffLen > @as(c_int, 0))) {
        c.*.BackOff = @as([*c]i64, @ptrCast(@alignCast(calloc(@as(c_ulong, @bitCast(@as(c_long, org.*.BackOffLen))), @sizeOf(i64)))));
        if (c.*.BackOff == @as([*c]i64, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) {
            s = nats_setErrorReal("./src/submodules/nats.c/src/jsm.c", "js_cloneConsumerConfig", @as(c_int, 4009), @as(c_uint, @bitCast(NATS_NO_MEMORY)), "%s", natsStatus_GetText(@as(c_uint, @bitCast(NATS_NO_MEMORY))));
        } else {
            _ = memcpy(@as(?*anyopaque, @ptrCast(c.*.BackOff)), @as(?*const anyopaque, @ptrCast(org.*.BackOff)), @as(c_ulong, @bitCast(@as(c_long, org.*.BackOffLen))) *% @sizeOf(i64));
        }
    }
    if (((s == @as(c_uint, @bitCast(NATS_OK))) and (org.*.FilterSubjects != @as([*c][*c]const u8, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0)))))))) and (org.*.FilterSubjectsLen > @as(c_int, 0))) {
        c.*.FilterSubjects = @as([*c][*c]const u8, @ptrCast(@alignCast(calloc(@as(c_ulong, @bitCast(@as(c_long, org.*.FilterSubjectsLen))), @sizeOf([*c]const u8)))));
        if (c.*.FilterSubjects == @as([*c][*c]const u8, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) {
            s = nats_setErrorReal("./src/submodules/nats.c/src/jsm.c", "js_cloneConsumerConfig", @as(c_int, 4017), @as(c_uint, @bitCast(NATS_NO_MEMORY)), "%s", natsStatus_GetText(@as(c_uint, @bitCast(NATS_NO_MEMORY))));
        }
        {
            var i: c_int = 0;
            _ = &i;
            while ((s == @as(c_uint, @bitCast(NATS_OK))) and (i < org.*.FilterSubjectsLen)) : (i += 1) {
                if ((s == @as(c_uint, @bitCast(NATS_OK))) and !((if (((blk: {
                    const tmp = i;
                    if (tmp >= 0) break :blk org.*.FilterSubjects + @as(usize, @intCast(tmp)) else break :blk org.*.FilterSubjects - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
                }).* == @as([*c]const u8, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) or (@as(c_int, @bitCast(@as(c_uint, (blk: {
                    const tmp = i;
                    if (tmp >= 0) break :blk org.*.FilterSubjects + @as(usize, @intCast(tmp)) else break :blk org.*.FilterSubjects - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
                }).*[@as(c_uint, @intCast(@as(c_int, 0)))]))) == @as(c_int, '\x00'))) @as(c_int, 1) else @as(c_int, 0)) != 0)) {
                    (blk: {
                        const tmp = i;
                        if (tmp >= 0) break :blk c.*.FilterSubjects + @as(usize, @intCast(tmp)) else break :blk c.*.FilterSubjects - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
                    }).* = strdup((blk: {
                        const tmp = i;
                        if (tmp >= 0) break :blk org.*.FilterSubjects + @as(usize, @intCast(tmp)) else break :blk org.*.FilterSubjects - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
                    }).*);
                    if ((blk: {
                        ...
                        s = nats_setErrorReal("./src/submodules/nats.c/src/jsm.c", "js_cloneConsumerConfig", @as(c_int, 4021), @as(c_uint, @bitCast(NATS_NO_MEMORY)), "%s", natsStatus_GetText(@as(c_uint, @bitCast(NATS_NO_MEMORY))));
                    }
                }
            }
        }
    ...
    if (s == @as(c_uint, @bitCast(NATS_OK))) {
        s = nats_cloneMetadata(&c.*.Metadata, org.*.Metadata);
    }
    if (s == @as(c_uint, @bitCast(NATS_OK))) {
        clone_1.* = c;
    } else {
    ...
    return if (s == @as(c_uint, @bitCast(NATS_OK))) s else nats_updateErrStack(s, "js_cloneConsumerConfig");
}
pub export fn js_destroyConsumerConfig(arg_cc: [*c]jsConsumerConfig) void {
    var cc = arg_cc;
    _ = &cc;
    var i: c_int = undefined;
    _ = &i;
    if (cc == @as([*c]jsConsumerConfig, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) return;
    free(@as(?*anyopaque, @ptrCast(@as([*c]u8, @ptrCast(@volatileCast(@constCast(cc.*.Name)))))));
    free(@as(?*anyopaque, @ptrCast(@as([*c]u8, @ptrCast(@volatileCast(@constCast(cc.*.Durable)))))));
    free(@as(?*anyopaque, @ptrCast(@as([*c]u8, @ptrCast(@volatileCast(@constCast(cc.*.Description)))))));
    free(@as(?*anyopaque, @ptrCast(@as([*c]u8, @ptrCast(@volatileCast(@constCast(cc.*.DeliverSubject)))))));
    free(@as(?*anyopaque, @ptrCast(@as([*c]u8, @ptrCast(@volatileCast(@constCast(cc.*.DeliverGroup)))))));
    free(@as(?*anyopaque, @ptrCast(@as([*c]u8, @ptrCast(@volatileCast(@constCast(cc.*.FilterSubject)))))));
    {
        i = 0;
        while (i < cc.*.FilterSubjectsLen) : (i += 1) {
            free(@as(?*anyopaque, @ptrCast(@as([*c]u8, @ptrCast(@volatileCast(@constCast((blk: {
                const tmp = i;
                if (tmp >= 0) break :blk cc.*.FilterSubjects + @as(usize, @intCast(tmp)) else break :blk cc.*.FilterSubjects - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
            }).*)))))));
        }
    }
    nats_freeMetadata(&cc.*.Metadata);
    free(@as(?*anyopaque, @ptrCast(@as([*c]u8, @ptrCast(@alignCast(cc.*.FilterSubjects))))));
    free(@as(?*anyopaque, @ptrCast(@as([*c]u8, @ptrCast(@volatileCast(@constCast(cc.*.SampleFrequency)))))));
    free(@as(?*anyopaque, @ptrCast(cc.*.BackOff)));
    free(@as(?*anyopaque, @ptrCast(cc)));
}
...
pub const jsStreamActionCreate: c_int = 1;
pub const jsStreamActionUpdate: c_int = 2;
pub const jsStreamActionGet: c_int = 3;
pub const jsStreamAction = c_uint;
pub fn _marshalTimeUTC(arg_buf: [*c]natsBuffer, arg_sep: bool, arg_fieldName: [*c]const u8, arg_timeUTC: i64) callconv(.c) natsStatus {
    var buf = arg_buf;
    _ = &buf;
    var sep = arg_sep;
    _ = &sep;
    ...
    _ = &dbuf;
    s = nats_EncodeTimeUTC(@as([*c]u8, @ptrCast(@alignCast(&dbuf))), @sizeOf([36]u8), timeUTC);
    if (s != @as(c_uint, @bitCast(NATS_OK))) return nats_setErrorReal("./src/submodules/nats.c/src/jsm.c", "_marshalTimeUTC", @as(c_int, 43), @as(c_uint, @bitCast(NATS_ERR)), "unable to encode data for field '%s' value %ld", fieldName, timeUTC);
    if (sep) {
        s = natsBuf_AppendByte(buf, @as(u8, @bitCast(@as(i8, @truncate(@as(c_int, ','))))));
    }
    if (s == @as(c_uint, @bitCast(NATS_OK))) {
    ...
    if (s == @as(c_uint, @bitCast(NATS_OK))) {
        s = natsBuf_Append(buf, fieldName, -@as(c_int, 1));
    }
    if (s == @as(c_uint, @bitCast(NATS_OK))) {
        s = natsBuf_Append(buf, "\":\"", -@as(c_int, 1));
    }
    if (s == @as(c_uint, @bitCast(NATS_OK))) {
        s = natsBuf_Append(buf, @as([*c]u8, @ptrCast(@alignCast(&dbuf))), -@as(c_int, 1));
    }
    if (s == @as(c_uint, @bitCast(NATS_OK))) {
        s = natsBuf_AppendByte(buf, @as(u8, @bitCast(@as(i8, @truncate(@as(c_int, '"'))))));
    }
    return if (s == @as(c_uint, @bitCast(NATS_OK))) s else nats_updateErrStack(s, "_marshalTimeUTC");
}
pub fn _checkStreamName(arg_stream: [*c]const u8) callconv(.c) natsStatus {
    var stream = arg_stream;
    _ = &stream;
    if ((if ((stream == @as([*c]const u8, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) or (@as(c_int, @bitCast(@as(c_uint, stream[@as(c_uint, @intCast(@as(c_int, 0)))]))) == @as(c_int, '\x00'))) @as(c_int, 1) else @as(c_int, 0)) != 0) return nats_setErrorReal("./src/submodules/nats.c/src/jsm.c", "_checkStreamName", @as(c_int, 65), @as(c_uint, @bitCast(NATS_INVALID_ARG)), "%s", "stream name is required");
    if (strchr(stream, @as(c_int, '.')) != @as([*c]u8, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) return nats_setErrorReal("./src/submodules/nats.c/src/jsm.c", "_checkStreamName", @as(c_int, 68), @as(c_uint, @bitCast(NATS_INVALID_ARG)), "%s '%s' (cannot contain '.')", "invalid stream name", stream);
    return @as(c_uint, @bitCast(NATS_OK));
}
pub fn _destroyPlacement(arg_placement: [*c]jsPlacement) callconv(.c) void {
    var placement = arg_placement;
    _ = &placement;
    var i: c_int = undefined;
    _ = &i;
    if (placement == @as([*c]jsPlacement, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) return;
    free(@as(?*anyopaque, @ptrCast(@as([*c]u8, @ptrCast(@volatileCast(@constCast(placement.*.Cluster)))))));
    {
        i = 0;
        while (i < placement.*.TagsLen) : (i += 1) {
            free(@as(?*anyopaque, @ptrCast(@as([*c]u8, @ptrCast(@volatileCast(@constCast((blk: {
                const tmp = i;
                if (tmp >= 0) break :blk placement.*.Tags + @as(usize, @intCast(tmp)) else break :blk placement.*.Tags - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
            }).*)))))));
        }
    }
    free(@as(?*anyopaque, @ptrCast(@as([*c][*c]u8, @ptrCast(@alignCast(placement.*.Tags))))));
    free(@as(?*anyopaque, @ptrCast(placement)));
}
pub fn _destroyExternalStream(arg_external: [*c]jsExternalStream) callconv(.c) void {
    var external = arg_external;
    _ = &external;
    if (external == @as([*c]jsExternalStream, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) return;
    free(@as(?*anyopaque, @ptrCast(@as([*c]u8, @ptrCast(@volatileCast(@constCast(external.*.APIPrefix)))))));
    free(@as(?*anyopaque, @ptrCast(@as([*c]u8, @ptrCast(@volatileCast(@constCast(external.*.DeliverPrefix)))))));
    free(@as(?*anyopaque, @ptrCast(external)));
}
pub fn _destroyStreamSource(arg_source: [*c]jsStreamSource) callconv(.c) void {
    var source = arg_source;
    _ = &source;
    if (source == @as([*c]jsStreamSource, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) return;
    free(@as(?*anyopaque, @ptrCast(@as([*c]u8, @ptrCast(@volatileCast(@constCast(source.*.Name)))))));
    free(@as(?*anyopaque, @ptrCast(@as([*c]u8, @ptrCast(@volatileCast(@constCast(source.*.FilterSubject)))))));
    _destroyExternalStream(source.*.External);
    free(@as(?*anyopaque, @ptrCast(source)));
}
pub fn _destroyRePublish(arg_rp: [*c]jsRePublish) callconv(.c) void {
    var rp = arg_rp;
    _ = &rp;
    if (rp == @as([*c]jsRePublish, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) return;
    free(@as(?*anyopaque, @ptrCast(@as([*c]u8, @ptrCast(@volatileCast(@constCast(rp.*.Source)))))));
    free(@as(?*anyopaque, @ptrCast(@as([*c]u8, @ptrCast(@volatileCast(@constCast(rp.*.Destination)))))));
    free(@as(?*anyopaque, @ptrCast(rp)));
}
pub fn _destroyPeerInfo(arg_peer: [*c]jsPeerInfo) callconv(.c) void {
    var peer = arg_peer;
    _ = &peer;
    if (peer == @as([*c]jsPeerInfo, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) return;
    free(@as(?*anyopaque, @ptrCast(peer.*.Name)));
    free(@as(?*anyopaque, @ptrCast(peer)));
}
pub fn _destroyClusterInfo(arg_cluster: [*c]jsClusterInfo) callconv(.c) void {
    var cluster = arg_cluster;
    _ = &cluster;
    var i: c_int = undefined;
    _ = &i;
    if (cluster == @as([*c]jsClusterInfo, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) return;
    free(@as(?*anyopaque, @ptrCast(cluster.*.Name)));
    free(@as(?*anyopaque, @ptrCast(cluster.*.Leader)));
    {
        i = 0;
        while (i < cluster.*.ReplicasLen) : (i += 1) {
            _destroyPeerInfo((blk: {
                const tmp = i;
                if (tmp >= 0) break :blk cluster.*.Replicas + @as(usize, @intCast(tmp)) else break :blk cluster.*.Replicas - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
            }).*);
        }
    }
    free(@as(?*anyopaque, @ptrCast(cluster.*.Replicas)));
    free(@as(?*anyopaque, @ptrCast(cluster)));
}
pub fn _destroyStreamSourceInfo(arg_info: [*c]jsStreamSourceInfo) callconv(.c) void {
    var info = arg_info;
    _ = &info;
    var i: c_int = undefined;
    _ = &i;
    if (info == @as([*c]jsStreamSourceInfo, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) return;
    free(@as(?*anyopaque, @ptrCast(info.*.Name)));
    free(@as(?*anyopaque, @ptrCast(@as([*c]u8, @ptrCast(@volatileCast(@constCast(info.*.FilterSubject)))))));
    {
        i = 0;
        while (i < info.*.SubjectTransformsLen) : (i += 1) {
            free(@as(?*anyopaque, @ptrCast(@as([*c]u8, @ptrCast(@volatileCast(@constCast((blk: {
                const tmp = i;
                if (tmp >= 0) break :blk info.*.SubjectTransforms + @as(usize, @intCast(tmp)) else break :blk info.*.SubjectTransforms - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
            }).*.Source)))))));
            free(@as(?*anyopaque, @ptrCast(@as([*c]u8, @ptrCast(@volatileCast(@constCast((blk: {
                const tmp = i;
                if (tmp >= 0) break :blk info.*.SubjectTransforms + @as(usize, @intCast(tmp)) else break :blk info.*.SubjectTransforms - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
    ...
    free(@as(?*anyopaque, @ptrCast(info.*.SubjectTransforms)));
    _destroyExternalStream(info.*.External);
    free(@as(?*anyopaque, @ptrCast(info)));
}
pub fn _destroyLostStreamData(arg_lost: [*c]jsLostStreamData) callconv(.c) void {
    var lost = arg_lost;
    _ = &lost;
    if (lost == @as([*c]jsLostStreamData, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) return;
    free(@as(?*anyopaque, @ptrCast(lost.*.Msgs)));
    free(@as(?*anyopaque, @ptrCast(lost)));
}
pub fn _destroyStreamStateSubjects(arg_subjects: [*c]jsStreamStateSubjects) callconv(.c) void {
    var subjects = arg_subjects;
    _ = &subjects;
    var i: c_int = undefined;
    _ = &i;
    if (subjects == @as([*c]jsStreamStateSubjects, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) return;
    {
        i = 0;
        while (i < subjects.*.Count) : (i += 1) {
            free(@as(?*anyopaque, @ptrCast(@as([*c]u8, @ptrCast(@volatileCast(@constCast((blk: {
                const tmp = i;
                if (tmp >= 0) break :blk subjects.*.List + @as(usize, @intCast(tmp)) else break :blk subjects.*.List - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
            }).*.Subject)))))));
        }
    }
    free(@as(?*anyopaque, @ptrCast(subjects.*.List)));
    free(@as(?*anyopaque, @ptrCast(subjects)));
}
pub fn _destroyStreamAlternate(arg_sa: [*c]jsStreamAlternate) callconv(.c) void {
    var sa = arg_sa;
    _ = &sa;
    if (sa == @as([*c]jsStreamAlternate, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) return;
    free(@as(?*anyopaque, @ptrCast(@as([*c]u8, @ptrCast(@volatileCast(@constCast(sa.*.Name)))))));
    free(@as(?*anyopaque, @ptrCast(@as([*c]u8, @ptrCast(@volatileCast(@constCast(sa.*.Domain)))))));
    free(@as(?*anyopaque, @ptrCast(@as([*c]u8, @ptrCast(@volatileCast(@constCast(sa.*.Cluster)))))));
    free(@as(?*anyopaque, @ptrCast(sa)));
}
pub fn _unmarshalExternalStream(arg_json: [*c]nats_JSON, arg_fieldName: [*c]const u8, arg_new_external: [*c][*c]jsExternalStream) callconv(.c) natsStatus {
    var json = arg_json;
    _ = &json;
    var fieldName = arg_fieldName;
    _ = &fieldName;
    var new_external = arg_new_external;
    _ = &new_external;
    var external: [*c]jsExternalStream = null;
    _ = &external;
    var obj: [*c]nats_JSON = null;
    _ = &obj;
    var s: natsStatus = undefined;
    ...
    if (obj == @as([*c]nats_JSON, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) return if (s == @as(c_uint, @bitCast(NATS_OK))) s else nats_updateErrStack(s, "_unmarshalExternalStream");
    external = @as([*c]jsExternalStream, @ptrCast(@alignCast(calloc(@as(c_ulong, @bitCast(@as(c_long, @as(c_int, 1)))), @sizeOf(jsExternalStream)))));
    if (external == @as([*c]jsExternalStream, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) return nats_setErrorReal("./src/submodules/nats.c/src/jsm.c", "_unmarshalExternalStream", @as(c_int, 274), @as(c_uint, @bitCast(NATS_NO_MEMORY)), "%s", natsStatus_GetText(@as(c_uint, @bitCast(NATS_NO_MEMORY))));
    s = nats_JSONGetStr(obj, "api", @as([*c][*c]u8, @ptrCast(@alignCast(&external.*.APIPrefix))));
    if (s == @as(c_uint, @bitCast(NATS_OK))) {
        s = nats_JSONGetStr(obj, "deliver", @as([*c][*c]u8, @ptrCast(@alignCast(&external.*.DeliverPrefix))));
    }
    if (s == @as(c_uint, @bitCast(NATS_OK))) {
    ...
    return if (s == @as(c_uint, @bitCast(NATS_OK))) s else nats_updateErrStack(s, "_unmarshalExternalStream");
}
pub fn _marshalExternalStream(arg_external: [*c]jsExternalStream, arg_fieldName: [*c]const u8, arg_buf: [*c]natsBuffer) callconv(.c) natsStatus {
    var external = arg_external;
    _ = &external;
    var fieldName = arg_fieldName;
    _ = &fieldName;
    ...
    if (s == @as(c_uint, @bitCast(NATS_OK))) {
        s = natsBuf_Append(buf, "\":{\"api\":\"", -@as(c_int, 1));
    }
    if (s == @as(c_uint, @bitCast(NATS_OK))) {
        s = natsBuf_Append(buf, external.*.APIPrefix, -@as(c_int, 1));
    }
    if ((s == @as(c_uint, @bitCast(NATS_OK))) and !((if ((external.*.DeliverPrefix == @as([*c]const u8, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) or (@as(c_int, @bitCast(@as(c_uint, external.*.DeliverPrefix[@as(c_uint, @intCast(@as(c_int, 0)))]))) == @as(c_int, '\x00'))) @as(c_int, 1) else @as(c_int, 0)) != 0)) {
        if (s == @as(c_uint, @bitCast(NATS_OK))) {
            s = natsBuf_Append(buf, "\",\"deliver\":\"", -@as(c_int, 1));
        }
        if (s == @as(c_uint, @bitCast(NATS_OK))) {
            s = natsBuf_Append(buf, external.*.DeliverPrefix, -@as(c_int, 1));
        }
    }
    if (s == @as(c_uint, @bitCast(NATS_OK))) {
        s = natsBuf_Append(buf, "\"}", -@as(c_int, 1));
    }
    return if (s == @as(c_uint, @bitCast(NATS_OK))) s else nats_updateErrStack(s, "_marshalExternalStream");
}
pub fn _unmarshalStreamSource(arg_json: [*c]nats_JSON, arg_fieldName: [*c]const u8, arg_new_source: [*c][*c]jsStreamSource) callconv(.c) natsStatus {
    var json = arg_json;
    _ = &json;
    var fieldName = arg_fieldName;
    _ = &fieldName;
    var new_source = arg_new_source;
    _ = &new_source;
    var source: [*c]jsStreamSource = null;
    _ = &source;
    var obj: [*c]nats_JSON = null;
    _ = &obj;
    var s: natsStatus = undefined;
    ...
    if (fieldName != @as([*c]const u8, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) {
        s = nats_JSONGetObject(json, fieldName, &obj);
        if (obj == @as([*c]nats_JSON, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) return if (s == @as(c_uint, @bitCast(NATS_OK))) s else nats_updateErrStack(s, "_unmarshalStreamSource");
    } else {
        obj = json;
    }
    source = @as([*c]jsStreamSource, @ptrCast(@alignCast(calloc(@as(c_ulong, @bitCast(@as(c_long, @as(c_int, 1)))), @sizeOf(jsStreamSource)))));
    if (source == @as([*c]jsStreamSource, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) return nats_setErrorReal("./src/submodules/nats.c/src/jsm.c", "_unmarshalStreamSource", @as(c_int, 326), @as(c_uint, @bitCast(NATS_NO_MEMORY)), "%s", natsStatus_GetText(@as(c_uint, @bitCast(NATS_NO_MEMORY))));
    s = nats_JSONGetStr(obj, "name", @as([*c][*c]u8, @ptrCast(@alignCast(&source.*.Name))));
    if (s == @as(c_uint, @bitCast(NATS_OK))) {
        s = nats_JSONGetULong(obj, "opt_start_seq", &source.*.OptStartSeq);
    }
    if (s == @as(c_uint, @bitCast(NATS_OK))) {
        s = nats_JSONGetTime(obj, "opt_start_time", &source.*.OptStartTime);
    }
    if (s == @as(c_uint, @bitCast(NATS_OK))) {
        s = nats_JSONGetStr(obj, "filter_subject", @as([*c][*c]u8, @ptrCast(@alignCast(&source.*.FilterSubject))));
    }
    if (s == @as(c_uint, @bitCast(NATS_OK))) {
        s = _unmarshalExternalStream(obj, "external", &source.*.External);
    }
    if (s == @as(c_uint, @bitCast(NATS_OK))) {
        new_source.* = source;
    } else {
    ...
    return if (s == @as(c_uint, @bitCast(NATS_OK))) s else nats_updateErrStack(s, "_unmarshalStreamSource");
}
pub fn _marshalStreamSource(arg_source: [*c]jsStreamSource, arg_fieldName: [*c]const u8, arg_buf: [*c]natsBuffer) callconv(.c) natsStatus {
    var source = arg_source;
    _ = &source;
    var fieldName = arg_fieldName;
    _ = &fieldName;
    ...
    if (s == @as(c_uint, @bitCast(NATS_OK))) {
        s = natsBuf_Append(buf, source.*.Name, -@as(c_int, 1));
    }
    if (s == @as(c_uint, @bitCast(NATS_OK))) {
        s = natsBuf_AppendByte(buf, @as(u8, @bitCast(@as(i8, @truncate(@as(c_int, '"'))))));
    }
    if ((s == @as(c_uint, @bitCast(NATS_OK))) and (source.*.OptStartSeq > @as(u64, @bitCast(@as(c_long, @as(c_int, 0)))))) {
        s = nats_marshalLong(buf, @as(c_int, 1) != 0, "opt_start_seq", @as(i64, @bitCast(source.*.OptStartSeq)));
    }
    if ((s == @as(c_uint, @bitCast(NATS_OK))) and (source.*.OptStartTime > @as(i64, @bitCast(@as(c_long, @as(c_int, 0)))))) if (s == @as(c_uint, @bitCast(NATS_OK))) {
        s = _marshalTimeUTC(buf, @as(c_int, 1) != 0, "opt_start_time", source.*.OptStartTime);
    };
    if (source.*.FilterSubject != @as([*c]const u8, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) {
        if (s == @as(c_uint, @bitCast(NATS_OK))) {
            s = natsBuf_Append(buf, ",\"filter_subject\":\"", -@as(c_int, 1));
        }
        if (s == @as(c_uint, @bitCast(NATS_OK))) {
            s = natsBuf_Append(buf, source.*.FilterSubject, -@as(c_int, 1));
        }
        if (s == @as(c_uint, @bitCast(NATS_OK))) {
            s = natsBuf_AppendByte(buf, @as(u8, @bitCast(@as(i8, @truncate(@as(c_int, '"'))))));
        }
    }
    if (source.*.External != @as([*c]jsExternalStream, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) if (s == @as(c_uint, @bitCast(NATS_OK))) {
        s = _marshalExternalStream(source.*.External, "external", buf);
    };
    if (s == @as(c_uint, @bitCast(NATS_OK))) {
        s = natsBuf_AppendByte(buf, @as(u8, @bitCast(@as(i8, @truncate(@as(c_int, '}'))))));
    }
    return if (s == @as(c_uint, @bitCast(NATS_OK))) s else nats_updateErrStack(s, "_marshalStreamSource");
}
pub fn _unmarshalPlacement(arg_json: [*c]nats_JSON, arg_fieldName: [*c]const u8, arg_new_placement: [*c][*c]jsPlacement) callconv(.c) natsStatus {
    var json = arg_json;
    _ = &json;
    var fieldName = arg_fieldName;
    _ = &fieldName;
    var new_placement = arg_new_placement;
    _ = &new_placement;
    var placement: [*c]jsPlacement = null;
    _ = &placement;
    var jpl: [*c]nats_JSON = null;
    _ = &jpl;
    var s: natsStatus = undefined;
    _ = &s;
    s = nats_JSONGetObject(json, fieldName, &jpl);
    if (jpl == @as([*c]nats_JSON, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) return if (s == @as(c_uint, @bitCast(NATS_OK))) s else nats_updateErrStack(s, "_unmarshalPlacement");
    placement = @as([*c]jsPlacement, @ptrCast(@alignCast(calloc(@as(c_ulong, @bitCast(@as(c_long, @as(c_int, 1)))), @sizeOf(jsPlacement)))));
    if (placement == @as([*c]jsPlacement, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) return nats_setErrorReal("./src/submodules/nats.c/src/jsm.c", "_unmarshalPlacement", @as(c_int, 387), @as(c_uint, @bitCast(NATS_NO_MEMORY)), "%s", natsStatus_GetText(@as(c_uint, @bitCast(NATS_NO_MEMORY))));
    s = nats_JSONGetStr(jpl, "cluster", @as([*c][*c]u8, @ptrCast(@alignCast(&placement.*.Cluster))));
    if (s == @as(c_uint, @bitCast(NATS_OK))) {
        s = nats_JSONGetArrayStr(jpl, "tags", @as([*c][*c][*c]u8, @ptrCast(@alignCast(&placement.*.Tags))), &placement.*.TagsLen);
    }
    if (s == @as(c_uint, @bitCast(NATS_OK))) {
    ...
    return if (s == @as(c_uint, @bitCast(NATS_OK))) s else nats_updateErrStack(s, "_unmarshalPlacement");
}
pub fn _marshalPlacement(arg_placement: [*c]jsPlacement, arg_buf: [*c]natsBuffer) callconv(.c) natsStatus {
    var placement = arg_placement;
    _ = &placement;
    var buf = arg_buf;
    _ = &buf;
    var s: natsStatus = undefined;
    _ = &s;
    s = natsBuf_Append(buf, ",\"placement\":{\"cluster\":\"", -@as(c_int, 1));
    if (s == @as(c_uint, @bitCast(NATS_OK))) {
        s = natsBuf_Append(buf, placement.*.Cluster, -@as(c_int, 1));
    }
    if (s == @as(c_uint, @bitCast(NATS_OK))) {
    ...
    if (placement.*.TagsLen > @as(c_int, 0)) {
        var i: c_int = undefined;
        _ = &i;
        if (s == @as(c_uint, @bitCast(NATS_OK))) {
            s = natsBuf_Append(buf, ",\"tags\":[\"", -@as(c_int, 1));
        }
        {
            i = 0;
            while ((s == @as(c_uint, @bitCast(NATS_OK))) and (i < placement.*.TagsLen)) : (i += 1) {
                if (s == @as(c_uint, @bitCast(NATS_OK))) {
                    s = natsBuf_Append(buf, (blk: {
                        const tmp = i;
                        if (tmp >= 0) break :blk placement.*.Tags + @as(usize, @intCast(tmp)) else break :blk placement.*.Tags - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
                ...
                if (i < (placement.*.TagsLen - @as(c_int, 1))) if (s == @as(c_uint, @bitCast(NATS_OK))) {
                    s = natsBuf_Append(buf, ",\"", -@as(c_int, 1));
                };
            }
        }
    ...
    return if (s == @as(c_uint, @bitCast(NATS_OK))) s else nats_updateErrStack(s, "_marshalPlacement");
}
pub fn _unmarshalRetentionPolicy(arg_json: [*c]nats_JSON, arg_fieldName: [*c]const u8, arg_policy: [*c]jsRetentionPolicy) callconv(.c) natsStatus {
    var json = arg_json;
    _ = &json;
    var fieldName = arg_fieldName;
    _ = &fieldName;
    ...
    if (str == @as([*c]u8, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) return if (s == @as(c_uint, @bitCast(NATS_OK))) s else nats_updateErrStack(s, "_unmarshalRetentionPolicy");
    if (strcmp(str, "limits") == @as(c_int, 0)) {
        policy.* = @as(c_uint, @bitCast(js_LimitsPolicy));
    } else if (strcmp(str, "interest") == @as(c_int, 0)) {
        policy.* = @as(c_uint, @bitCast(js_InterestPolicy));
    } else if (strcmp(str, "workqueue") == @as(c_int, 0)) {
        policy.* = @as(c_uint, @bitCast(js_WorkQueuePolicy));
    } else {
        s = nats_setErrorReal("./src/submodules/nats.c/src/jsm.c", "_unmarshalRetentionPolicy", @as(c_int, 443), @as(c_uint, @bitCast(NATS_ERR)), "unable to unmarshal retention policy '%s'", str);
    }
    free(@as(?*anyopaque, @ptrCast(str)));
    return if (s == @as(c_uint, @bitCast(NATS_OK))) s else nats_updateErrStack(s, "_unmarshalRetentionPolicy");
}
pub fn _marshalRetentionPolicy(arg_policy: jsRetentionPolicy, arg_buf: [*c]natsBuffer) callconv(.c) natsStatus {
    var policy = arg_policy;
    _ = &policy;
    var buf = arg_buf;
    _ = &buf;
    var s: natsStatus = undefined;
    _ = &s;
    var rp: [*c]const u8 = null;
    _ = &rp;
    s = natsBuf_Append(buf, ",\"retention\":\"", -@as(c_int, 1));
    while (true) {
        switch (policy) {
            ...
            else => return nats_setErrorReal("./src/submodules/nats.c/src/jsm.c", "_marshalRetentionPolicy", @as(c_int, 463), @as(c_uint, @bitCast(NATS_INVALID_ARG)), "invalid retention policy %d", @as(c_int, @bitCast(policy))),
        }
        break;
    }
    if (s == @as(c_uint, @bitCast(NATS_OK))) {
        s = natsBuf_Append(buf, rp, -@as(c_int, 1));
    }
    if (s == @as(c_uint, @bitCast(NATS_OK))) {
        s = natsBuf_AppendByte(buf, @as(u8, @bitCast(@as(i8, @truncate(@as(c_int, '"'))))));
    }
    return if (s == @as(c_uint, @bitCast(NATS_OK))) s else nats_updateErrStack(s, "_marshalRetentionPolicy");
}
pub fn _unmarshalDiscardPolicy(arg_json: [*c]nats_JSON, arg_fieldName: [*c]const u8, arg_policy: [*c]jsDiscardPolicy) callconv(.c) natsStatus {
    var json = arg_json;
    _ = &json;
    var fieldName = arg_fieldName;
    _ = &fieldName;
    ...
    _ = &str;
    s = nats_JSONGetStr(json, fieldName, &str);
    if (str == @as([*c]u8, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) return if (s == @as(c_uint, @bitCast(NATS_OK))) s else nats_updateErrStack(s, "_unmarshalDiscardPolicy");
    if (strcmp(str, "old") == @as(c_int, 0)) {
        policy.* = @as(c_uint, @bitCast(js_DiscardOld));
    } else if (strcmp(str, "new") == @as(c_int, 0)) {
        policy.* = @as(c_uint, @bitCast(js_DiscardNew));
    } else {
        s = nats_setErrorReal("./src/submodules/nats.c/src/jsm.c", "_unmarshalDiscardPolicy", @as(c_int, 485), @as(c_uint, @bitCast(NATS_ERR)), "unable to unmarshal discard policy '%s'", str);
    }
    free(@as(?*anyopaque, @ptrCast(str)));
    return if (s == @as(c_uint, @bitCast(NATS_OK))) s else nats_updateErrStack(s, "_unmarshalDiscardPolicy");
}
pub fn _marshalDiscardPolicy(arg_policy: jsDiscardPolicy, arg_buf: [*c]natsBuffer) callconv(.c) natsStatus {
    var policy = arg_policy;
    _ = &policy;
    var buf = arg_buf;
    _ = &buf;
    var s: natsStatus = undefined;
    _ = &s;
    var dp: [*c]const u8 = null;
    _ = &dp;
    s = natsBuf_Append(buf, ",\"discard\":\"", -@as(c_int, 1));
    while (true) {
        switch (policy) {
            @as(c_uint, @bitCast(@as(c_int, 0))) => {
                dp = "old";
            ...
            else => return nats_setErrorReal("./src/submodules/nats.c/src/jsm.c", "_marshalDiscardPolicy", @as(c_int, 504), @as(c_uint, @bitCast(NATS_INVALID_ARG)), "invalid discard policy %d", @as(c_int, @bitCast(policy))),
        }
        break;
    }
    if (s == @as(c_uint, @bitCast(NATS_OK))) {
        s = natsBuf_Append(buf, dp, -@as(c_int, 1));
    }
    if (s == @as(c_uint, @bitCast(NATS_OK))) {
        s = natsBuf_AppendByte(buf, @as(u8, @bitCast(@as(i8, @truncate(@as(c_int, '"'))))));
    }
    return if (s == @as(c_uint, @bitCast(NATS_OK))) s else nats_updateErrStack(s, "_marshalDiscardPolicy");
}
pub fn _unmarshalStorageType(arg_json: [*c]nats_JSON, arg_fieldName: [*c]const u8, arg_storage: [*c]jsStorageType) callconv(.c) natsStatus {
    var json = arg_json;
    _ = &json;
    var fieldName = arg_fieldName;
    _ = &fieldName;
    var storage = arg_storage;
    _ = &storage;
    var s: natsStatus = @as(c_uint, @bitCast(NATS_OK));
    _ = &s;
    var str: [*c]u8 = null;
    ...
    if (str == @as([*c]u8, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) return if (s == @as(c_uint, @bitCast(NATS_OK))) s else nats_updateErrStack(s, "_unmarshalStorageType");
    if (strcmp(str, "file") == @as(c_int, 0)) {
        storage.* = @as(c_uint, @bitCast(js_FileStorage));
    } else if (strcmp(str, "memory") == @as(c_int, 0)) {
        storage.* = @as(c_uint, @bitCast(js_MemoryStorage));
    } else {
        s = nats_setErrorReal("./src/submodules/nats.c/src/jsm.c", "_unmarshalStorageType", @as(c_int, 526), @as(c_uint, @bitCast(NATS_ERR)), "unable to unmarshal storage type '%s'", str);
    }
    free(@as(?*anyopaque, @ptrCast(str)));
    return if (s == @as(c_uint, @bitCast(NATS_OK))) s else nats_updateErrStack(s, "_unmarshalStorageType");
}
pub fn _marshalStorageType(arg_storage: jsStorageType, arg_buf: [*c]natsBuffer) callconv(.c) natsStatus {
    var storage = arg_storage;
    _ = &storage;
    var buf = arg_buf;
    _ = &buf;
    var s: natsStatus = undefined;
    _ = &s;
    var st: [*c]const u8 = null;
    _ = &st;
    s = natsBuf_Append(buf, ",\"storage\":\"", -@as(c_int, 1));
    while (true) {
        switch (storage) {
            @as(c_uint, @bitCast(@as(c_int, 0))) => {
                st = "file";
            ...
            else => return nats_setErrorReal("./src/submodules/nats.c/src/jsm.c", "_marshalStorageType", @as(c_int, 545), @as(c_uint, @bitCast(NATS_INVALID_ARG)), "invalid storage type %d", @as(c_int, @bitCast(storage))),
        }
        break;
    }
    if (s == @as(c_uint, @bitCast(NATS_OK))) {
        s = natsBuf_Append(buf, st, -@as(c_int, 1));
    }
    if (s == @as(c_uint, @bitCast(NATS_OK))) {
        s = natsBuf_AppendByte(buf, @as(u8, @bitCast(@as(i8, @truncate(@as(c_int, '"'))))));
    }
    return if (s == @as(c_uint, @bitCast(NATS_OK))) s else nats_updateErrStack(s, "_marshalStorageType");
}
pub fn _unmarshalStorageCompression(arg_json: [*c]nats_JSON, arg_fieldName: [*c]const u8, arg_compression: [*c]jsStorageCompression) callconv(.c) natsStatus {
    var json = arg_json;
    _ = &json;
    var fieldName = arg_fieldName;
    _ = &fieldName;
    var compression = arg_compression;
    _ = &compression;
    var s: natsStatus = @as(c_uint, @bitCast(NATS_OK));
    _ = &s;
    ...
    if (str == @as([*c]const u8, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) return if (s == @as(c_uint, @bitCast(NATS_OK))) s else nats_updateErrStack(s, "_unmarshalStorageCompression");
    if (strcmp(str, "none") == @as(c_int, 0)) {
        compression.* = @as(c_uint, @bitCast(js_StorageCompressionNone));
    } else if (strcmp(str, "s2") == @as(c_int, 0)) {
        compression.* = @as(c_uint, @bitCast(js_StorageCompressionS2));
    } else {
        s = nats_setErrorReal("./src/submodules/nats.c/src/jsm.c", "_unmarshalStorageCompression", @as(c_int, 567), @as(c_uint, @bitCast(NATS_ERR)), "unable to unmarshal storage compression '%s'", str);
    }
    return if (s == @as(c_uint, @bitCast(NATS_OK))) s else nats_updateErrStack(s, "_unmarshalStorageCompression");
}
pub fn _marshalStorageCompression(arg_compression: jsStorageCompression, arg_buf: [*c]natsBuffer) callconv(.c) natsStatus {
    var compression = arg_compression;
    _ = &compression;
    var buf = arg_buf;
    _ = &buf;
    ...
    var st: [*c]const u8 = null;
    _ = &st;
    s = natsBuf_Append(buf, ",\"compression\":\"", -@as(c_int, 1));
    while (true) {
        switch (compression) {
            @as(c_uint, @bitCast(@as(c_int, 0))) => {
                st = "none";
            ...
            else => return nats_setErrorReal("./src/submodules/nats.c/src/jsm.c", "_marshalStorageCompression", @as(c_int, 588), @as(c_uint, @bitCast(NATS_INVALID_ARG)), "invalid storage type %d", @as(c_int, @bitCast(compression))),
        }
        break;
    }
    if (s == @as(c_uint, @bitCast(NATS_OK))) {
    ...
    return if (s == @as(c_uint, @bitCast(NATS_OK))) s else nats_updateErrStack(s, "_marshalStorageCompression");
}
pub fn _unmarshalSubjectTransformConfig(arg_obj: [*c]nats_JSON, arg_cfg: [*c]jsSubjectTransformConfig) callconv(.c) natsStatus {
    var obj = arg_obj;
    _ = &obj;
    var cfg = arg_cfg;
    _ = &cfg;
    var s: natsStatus = @as(c_uint, @bitCast(NATS_OK));
    _ = &s;
    _ = memset(@as(?*anyopaque, @ptrCast(cfg)), @as(c_int, 0), @sizeOf(jsSubjectTransformConfig));
    if (obj == @as([*c]nats_JSON, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) {
        return @as(c_uint, @bitCast(NATS_OK));
    }
    if (s == @as(c_uint, @bitCast(NATS_OK))) {
        s = nats_JSONGetStr(obj, "src", @as([*c][*c]u8, @ptrCast(@alignCast(&cfg.*.Source))));
    }
    if (s == @as(c_uint, @bitCast(NATS_OK))) {
        s = nats_JSONGetStr(obj, "dest", @as([*c][*c]u8, @ptrCast(@alignCast(&cfg.*.Destination))));
    }
    return if (s == @as(c_uint, @bitCast(NATS_OK))) s else nats_updateErrStack(s, "_unmarshalSubjectTransformConfig");
}
pub fn _marshalSubjectTransformConfig(arg_cfg: [*c]jsSubjectTransformConfig, arg_buf: [*c]natsBuffer) callconv(.c) natsStatus {
    var cfg = arg_cfg;
    _ = &cfg;
    var buf = arg_buf;
    _ = &buf;
    var s: natsStatus = undefined;
    _ = &s;
    if ((cfg == @as([*c]jsSubjectTransformConfig, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) or (((if ((cfg.*.Source == @as([*c]const u8, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) or (@as(c_int, @bitCast(@as(c_uint, cfg.*.Source[@as(c_uint, @intCast(@as(c_int, 0)))]))) == @as(c_int, '\x00'))) @as(c_int, 1) else @as(c_int, 0)) != 0) and ((if ((cfg.*.Destination == @as([*c]const u8, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) or (@as(c_int, @bitCast(@as(c_uint, cfg.*.Destination[@as(c_uint, @intCast(@as(c_int, 0)))]))) == @as(c_int, '\x00'))) @as(c_int, 1) else @as(c_int, 0)) != 0))) return @as(c_uint, @bitCast(NATS_OK));
    s = natsBuf_Append(buf, ",\"subject_transform\":{", -@as(c_int, 1));
    if (s == @as(c_uint, @bitCast(NATS_OK))) {
        s = natsBuf_Append(buf, "\"src\":\"", -@as(c_int, 1));
    }
    if (cfg.*.Source != @as([*c]const u8, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) if (s == @as(c_uint, @bitCast(NATS_OK))) {
        s = natsBuf_Append(buf, cfg.*.Source, -@as(c_int, 1));
    };
    if (s == @as(c_uint, @bitCast(NATS_OK))) {
        s = natsBuf_Append(buf, "\",\"dest\":\"", -@as(c_int, 1));
    }
    if (cfg.*.Destination != @as([*c]const u8, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) if (s == @as(c_uint, @bitCast(NATS_OK))) {
        s = natsBuf_Append(buf, cfg.*.Destination, -@as(c_int, 1));
    };
    if (s == @as(c_uint, @bitCast(NATS_OK))) {
        s = natsBuf_Append(buf, "\"}", -@as(c_int, 1));
    }
    return if (s == @as(c_uint, @bitCast(NATS_OK))) s else nats_updateErrStack(s, "_marshalSubjectTransformConfig");
}
pub fn _marshalStreamConsumerLimits(arg_limits: [*c]jsStreamConsumerLimits, arg_buf: [*c]natsBuffer) callconv(.c) natsStatus {
    var limits = arg_limits;
    _ = &limits;
    var buf = arg_buf;
    _ = &buf;
    var s: natsStatus = undefined;
    _ = &s;
    if ((limits == @as([*c]jsStreamConsumerLimits, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) or ((limits.*.InactiveThreshold == @as(i64, @bitCast(@as(c_long, @as(c_int, 0))))) and (limits.*.MaxAckPending == @as(c_int, 0)))) return @as(c_uint, @bitCast(NATS_OK));
    s = natsBuf_Append(buf, ",\"consumer_limits\":{", -@as(c_int, 1));
    if (s == @as(c_uint, @bitCast(NATS_OK))) {
        s = nats_marshalLong(buf, @as(c_int, 0) != 0, "inactive_threshold", limits.*.InactiveThreshold);
    }
    if (s == @as(c_uint, @bitCast(NATS_OK))) {
        s = nats_marshalLong(buf, @as(c_int, 1) != 0, "max_ack_pending", @as(i64, @bitCast(@as(c_long, limits.*.MaxAckPending))));
    }
    if (s == @as(c_uint, @bitCast(NATS_OK))) {
        s = natsBuf_AppendByte(buf, @as(u8, @bitCast(@as(i8, @truncate(@as(c_int, '}'))))));
    }
    return if (s == @as(c_uint, @bitCast(NATS_OK))) s else nats_updateErrStack(s, "_marshalStreamConsumerLimits");
}
pub fn _unmarshalStreamConsumerLimits(arg_obj: [*c]nats_JSON, arg_limits: [*c]jsStreamConsumerLimits) callconv(.c) natsStatus {
    var obj = arg_obj;
    _ = &obj;
    var limits = arg_limits;
    _ = &limits;
    var s: natsStatus = @as(c_uint, @bitCast(NATS_OK));
    _ = &s;
    _ = memset(@as(?*anyopaque, @ptrCast(limits)), @as(c_int, 0), @sizeOf(jsStreamConsumerLimits));
    if (obj == @as([*c]nats_JSON, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) {
        return @as(c_uint, @bitCast(NATS_OK));
    }
    if (s == @as(c_uint, @bitCast(NATS_OK))) {
        s = nats_JSONGetLong(obj, "inactive_threshold", &limits.*.InactiveThreshold);
    }
    if (s == @as(c_uint, @bitCast(NATS_OK))) {
        s = nats_JSONGetInt(obj, "max_ack_pending", &limits.*.MaxAckPending);
    }
    return if (s == @as(c_uint, @bitCast(NATS_OK))) s else nats_updateErrStack(s, "_unmarshalStreamConsumerLimits");
}
pub fn _unmarshalRePublish(arg_json: [*c]nats_JSON, arg_fieldName: [*c]const u8, arg_new_republish: [*c][*c]jsRePublish) callconv(.c) natsStatus {
    var json = arg_json;
    _ = &json;
    var fieldName = arg_fieldName;
    _ = &fieldName;
    var new_republish = arg_new_republish;
    _ = &new_republish;
    var rp: [*c]jsRePublish = null;
    _ = &rp;
    var jsm: [*c]nats_JSON = null;
    _ = &jsm;
    var s: natsStatus = undefined;
    _ = &s;
    s = nats_JSONGetObject(json, fieldName, &jsm);
    if (jsm == @as([*c]nats_JSON, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) return if (s == @as(c_uint, @bitCast(NATS_OK))) s else nats_updateErrStack(s, "_unmarshalRePublish");
    rp = @as([*c]jsRePublish, @ptrCast(@alignCast(calloc(@as(c_ulong, @bitCast(@as(c_long, @as(c_int, 1)))), @sizeOf(jsRePublish)))));
    if (rp == @as([*c]jsRePublish, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) return nats_setErrorReal("./src/submodules/nats.c/src/jsm.c", "_unmarshalRePublish", @as(c_int, 672), @as(c_uint, @bitCast(NATS_NO_MEMORY)), "%s", natsStatus_GetText(@as(c_uint, @bitCast(NATS_NO_MEMORY))));
    s = nats_JSONGetStr(jsm, "src", @as([*c][*c]u8, @ptrCast(@alignCast(&rp.*.Source))));
    if (s == @as(c_uint, @bitCast(NATS_OK))) {
        s = nats_JSONGetStr(jsm, "dest", @as([*c][*c]u8, @ptrCast(@alignCast(&rp.*.Destination))));
    }
    if (s == @as(c_uint, @bitCast(NATS_OK))) {
        s = nats_JSONGetBool(jsm, "headers_only", &rp.*.HeadersOnly);
    }
    if (s == @as(c_uint, @bitCast(NATS_OK))) {
        new_republish.* = rp;
    } else {
    ...
    return if (s == @as(c_uint, @bitCast(NATS_OK))) s else nats_updateErrStack(s, "_unmarshalRePublish");
}
pub fn _unmarshalLostStreamData(arg_pjson: [*c]nats_JSON, arg_fieldName: [*c]const u8, arg_new_lost: [*c][*c]jsLostStreamData) callconv(.c) natsStatus {
    var pjson = arg_pjson;
    _ = &pjson;
    var fieldName = arg_fieldName;
    _ = &fieldName;
    var new_lost = arg_new_lost;
    _ = &new_lost;
    var s: natsStatus = @as(c_uint, @bitCast(NATS_OK));
    _ = &s;
    var lost: [*c]jsLostStreamData = null;
    _ = &lost;
    var json: [*c]nats_JSON = null;
    _ = &json;
    s = nats_JSONGetObject(pjson, fieldName, &json);
    if (json == @as([*c]nats_JSON, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) return if (s == @as(c_uint, @bitCast(NATS_OK))) s else nats_updateErrStack(s, "_unmarshalLostStreamData");
    lost = @as([*c]jsLostStreamData, @ptrCast(@alignCast(calloc(@as(c_ulong, @bitCast(@as(c_long, @as(c_int, 1)))), @sizeOf(jsLostStreamData)))));
    if (lost == @as([*c]jsLostStreamData, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) return nats_setErrorReal("./src/submodules/nats.c/src/jsm.c", "_unmarshalLostStreamData", @as(c_int, 917), @as(c_uint, @bitCast(NATS_NO_MEMORY)), "%s", natsStatus_GetText(@as(c_uint, @bitCast(NATS_NO_MEMORY))));
    if (s == @as(c_uint, @bitCast(NATS_OK))) {
        s = nats_JSONGetArrayULong(json, "msgs", &lost.*.Msgs, &lost.*.MsgsLen);
    }
    if (s == @as(c_uint, @bitCast(NATS_OK))) {
        s = nats_JSONGetULong(json, "bytes", &lost.*.Bytes);
    }
    if (s == @as(c_uint, @bitCast(NATS_OK))) {
        new_lost.* = lost;
    } else {
    ...
    return if (s == @as(c_uint, @bitCast(NATS_OK))) s else nats_updateErrStack(s, "_unmarshalLostStreamData");
}
pub fn _fillSubjectsList(arg_userInfo: ?*anyopaque, arg_subject: [*c]const u8, arg_f: [*c]nats_JSONField) callconv(.c) natsStatus {
    var userInfo = arg_userInfo;
    _ = &userInfo;
    var subject = arg_subject;
    _ = &subject;
    var f = arg_f;
    _ = &f;
    var subjs: [*c]jsStreamStateSubjects = @as([*c]jsStreamStateSubjects, @ptrCast(@alignCast(userInfo)));
    _ = &subjs;
    var s: natsStatus = @as(c_uint, @bitCast(NATS_OK));
    _ = &s;
    var i: c_int = subjs.*.Count;
    _ = &i;
    {
        (blk: {
            const tmp = i;
            if (tmp >= 0) break :blk subjs.*.List + @as(usize, @intCast(tmp)) else break :blk subjs.*.List - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
        }).*.Subject = strdup(subject);
        if ((blk: {
            const tmp = i;
            if (tmp >= 0) break :blk subjs.*.List + @as(usize, @intCast(tmp)) else break :blk subjs.*.List - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
        }).*.Subject == @as([*c]const u8, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) {
            s = nats_setErrorReal("./src/submodules/nats.c/src/jsm.c", "_fillSubjectsList", @as(c_int, 937), @as(c_uint, @bitCast(NATS_NO_MEMORY)), "%s", natsStatus_GetText(@as(c_uint, @bitCast(NATS_NO_MEMORY))));
        }
    }
    if (s == @as(c_uint, @bitCast(NATS_OK))) {
        (blk: {
        ...
        subjs.*.Count = i + @as(c_int, 1);
    }
    return if (s == @as(c_uint, @bitCast(NATS_OK))) s else nats_updateErrStack(s, "_fillSubjectsList");
}
pub fn _unmarshalStreamStateSubjects(arg_pjson: [*c]nats_JSON, arg_fieldName: [*c]const u8, arg_subjects: [*c][*c]jsStreamStateSubjects) callconv(.c) natsStatus {
    var pjson = arg_pjson;
    _ = &pjson;
    var fieldName = arg_fieldName;
    _ = &fieldName;
    ...
    var s: natsStatus = @as(c_uint, @bitCast(NATS_OK));
    _ = &s;
    var subjs: [*c]jsStreamStateSubjects = null;
    _ = &subjs;
    var n: c_int = undefined;
    _ = &n;
    s = nats_JSONGetObject(pjson, fieldName, &json);
    if (json == @as([*c]nats_JSON, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) return if (s == @as(c_uint, @bitCast(NATS_OK))) s else nats_updateErrStack(s, "_unmarshalStreamStateSubjects");
    if ((blk: {
        const tmp = json.*.fields.*.used;
        n = tmp;
        break :blk tmp;
    }) > @as(c_int, 0)) {
        subjs = @as([*c]jsStreamStateSubjects, @ptrCast(@alignCast(calloc(@as(c_ulong, @bitCast(@as(c_long, @as(c_int, 1)))), @sizeOf(jsStreamStateSubjects)))));
        if (subjs == @as([*c]jsStreamStateSubjects, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) {
            s = nats_setErrorReal("./src/submodules/nats.c/src/jsm.c", "_unmarshalStreamStateSubjects", @as(c_int, 962), @as(c_uint, @bitCast(NATS_NO_MEMORY)), "%s", natsStatus_GetText(@as(c_uint, @bitCast(NATS_NO_MEMORY))));
        }
        if (s == @as(c_uint, @bitCast(NATS_OK))) {
            subjs.*.List = @as([*c]jsStreamStateSubject, @ptrCast(@alignCast(calloc(@as(c_ulong, @bitCast(@as(c_long, n))), @sizeOf(jsStreamStateSubject)))));
            if (subjs.*.List == @as([*c]jsStreamStateSubject, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) {
                s = nats_setErrorReal("./src/submodules/nats.c/src/jsm.c", "_unmarshalStreamStateSubjects", @as(c_int, 968), @as(c_uint, @bitCast(NATS_NO_MEMORY)), "%s", natsStatus_GetText(@as(c_uint, @bitCast(NATS_NO_MEMORY))));
            }
        }
        if (s == @as(c_uint, @bitCast(NATS_OK))) {
            s = nats_JSONRange(json, @as(c_int, 3), @as(c_int, 5), &_fillSubjectsList, @as(?*anyopaque, @ptrCast(subjs)));
        }
        if (s == @as(c_uint, @bitCast(NATS_OK))) {
            subjects.* = subjs;
        } else {
    ...
    return if (s == @as(c_uint, @bitCast(NATS_OK))) s else nats_updateErrStack(s, "_unmarshalStreamStateSubjects");
}
pub fn _unmarshalPeerInfo(arg_json: [*c]nats_JSON, arg_new_pi: [*c][*c]jsPeerInfo) callconv(.c) natsStatus {
    var json = arg_json;
    _ = &json;
    var new_pi = arg_new_pi;
    _ = &new_pi;
    var pi: [*c]jsPeerInfo = null;
    _ = &pi;
    var s: natsStatus = undefined;
    _ = &s;
    pi = @as([*c]jsPeerInfo, @ptrCast(@alignCast(calloc(@as(c_ulong, @bitCast(@as(c_long, @as(c_int, 1)))), @sizeOf(jsPeerInfo)))));
    if (pi == @as([*c]jsPeerInfo, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) return nats_setErrorReal("./src/submodules/nats.c/src/jsm.c", "_unmarshalPeerInfo", @as(c_int, 1014), @as(c_uint, @bitCast(NATS_NO_MEMORY)), "%s", natsStatus_GetText(@as(c_uint, @bitCast(NATS_NO_MEMORY))));
    s = nats_JSONGetStr(json, "name", &pi.*.Name);
    if (s == @as(c_uint, @bitCast(NATS_OK))) {
        s = nats_JSONGetBool(json, "current", &pi.*.Current);
    }
    if (s == @as(c_uint, @bitCast(NATS_OK))) {
        s = nats_JSONGetBool(json, "offline", &pi.*.Offline);
    }
    if (s == @as(c_uint, @bitCast(NATS_OK))) {
        s = nats_JSONGetLong(json, "active", &pi.*.Active);
    }
    if (s == @as(c_uint, @bitCast(NATS_OK))) {
        s = nats_JSONGetULong(json, "lag", &pi.*.Lag);
    }
    if (s == @as(c_uint, @bitCast(NATS_OK))) {
        new_pi.* = pi;
    } else {
    ...
    return if (s == @as(c_uint, @bitCast(NATS_OK))) s else nats_updateErrStack(s, "_unmarshalPeerInfo");
}
pub fn _unmarshalClusterInfo(arg_pjson: [*c]nats_JSON, arg_fieldName: [*c]const u8, arg_new_ci: [*c][*c]jsClusterInfo) callconv(.c) natsStatus {
    var pjson = arg_pjson;
    _ = &pjson;
    var fieldName = arg_fieldName;
    _ = &fieldName;
    var new_ci = arg_new_ci;
    _ = &new_ci;
    var ci: [*c]jsClusterInfo = null;
    _ = &ci;
    var json: [*c]nats_JSON = null;
    _ = &json;
    var replicas: [*c][*c]nats_JSON = null;
    _ = &replicas;
    var replicasLen: c_int = 0;
    _ = &replicasLen;
    var s: natsStatus = undefined;
    _ = &s;
    s = nats_JSONGetObject(pjson, fieldName, &json);
    if (json == @as([*c]nats_JSON, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) return if (s == @as(c_uint, @bitCast(NATS_OK))) s else nats_updateErrStack(s, "_unmarshalClusterInfo");
    ci = @as([*c]jsClusterInfo, @ptrCast(@alignCast(calloc(@as(c_ulong, @bitCast(@as(c_long, @as(c_int, 1)))), @sizeOf(jsClusterInfo)))));
    if (ci == @as([*c]jsClusterInfo, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) return nats_setErrorReal("./src/submodules/nats.c/src/jsm.c", "_unmarshalClusterInfo", @as(c_int, 1045), @as(c_uint, @bitCast(NATS_NO_MEMORY)), "%s", natsStatus_GetText(@as(c_uint, @bitCast(NATS_NO_MEMORY))));
    s = nats_JSONGetStr(json, "name", &ci.*.Name);
    if (s == @as(c_uint, @bitCast(NATS_OK))) {
        s = nats_JSONGetStr(json, "leader", &ci.*.Leader);
    }
    if (s == @as(c_uint, @bitCast(NATS_OK))) {
        s = nats_JSONGetArrayObject(json, "replicas", &replicas, &replicasLen);
    }
    if ((s == @as(c_uint, @bitCast(NATS_OK))) and (replicas != @as([*c][*c]nats_JSON, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0)))))))) {
        var i: c_int = undefined;
        _ = &i;
        ci.*.Replicas = @as([*c][*c]jsPeerInfo, @ptrCast(@alignCast(calloc(@as(c_ulong, @bitCast(@as(c_long, replicasLen))), @sizeOf([*c]jsPeerInfo)))));
        if (ci.*.Replicas == @as([*c][*c]jsPeerInfo, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) {
            s = nats_setErrorReal("./src/submodules/nats.c/src/jsm.c", "_unmarshalClusterInfo", @as(c_int, 1056), @as(c_uint, @bitCast(NATS_NO_MEMORY)), "%s", natsStatus_GetText(@as(c_uint, @bitCast(NATS_NO_MEMORY))));
        }
        {
            i = 0;
            while ((s == @as(c_uint, @bitCast(NATS_OK))) and (i < replicasLen)) : (i += 1) {
                s = _unmarshalPeerInfo((blk: {
                    const tmp = i;
                    if (tmp >= 0) break :blk replicas + @as(usize, @intCast(tmp)) else break :blk replicas - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
                }).*, &(blk: {
                    const tmp = i;
                    if (tmp >= 0) break :blk ci.*.Replicas + @as(usize, @intCast(tmp)) else break :blk ci.*.Replicas - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
                }).*);
                if (s == @as(c_uint, @bitCast(NATS_OK))) {
                    ci.*.ReplicasLen += 1;
                }
        ...
        free(@as(?*anyopaque, @ptrCast(replicas)));
    }
    if (s == @as(c_uint, @bitCast(NATS_OK))) {
        new_ci.* = ci;
    } else {
    ...
    return if (s == @as(c_uint, @bitCast(NATS_OK))) s else nats_updateErrStack(s, "_unmarshalClusterInfo");
}
pub fn _unmarshalStreamSourceInfo(arg_pjson: [*c]nats_JSON, arg_fieldName: [*c]const u8, arg_new_src: [*c][*c]jsStreamSourceInfo) callconv(.c) natsStatus {
    var pjson = arg_pjson;
    _ = &pjson;
    var fieldName = arg_fieldName;
    _ = &fieldName;
    var new_src = arg_new_src;
    _ = &new_src;
    var json: [*c]nats_JSON = null;
    _ = &json;
    var ssi: [*c]jsStreamSourceInfo = null;
    _ = &ssi;
    var s: natsStatus = undefined;
    _ = &s;
    var subjectTransforms: [*c][*c]nats_JSON = null;
    _ = &subjectTransforms;
    var subjectTransformsLen: c_int = 0;
    _ = &subjectTransformsLen;
    if (fieldName != @as([*c]const u8, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) {
        s = nats_JSONGetObject(pjson, fieldName, &json);
        if (json == @as([*c]nats_JSON, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) return if (s == @as(c_uint, @bitCast(NATS_OK))) s else nats_updateErrStack(s, "_unmarshalStreamSourceInfo");
    } else {
        json = pjson;
    }
    ssi = @as([*c]jsStreamSourceInfo, @ptrCast(@alignCast(calloc(@as(c_ulong, @bitCast(@as(c_long, @as(c_int, 1)))), @sizeOf(jsStreamSourceInfo)))));
    if (ssi == @as([*c]jsStreamSourceInfo, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) return nats_setErrorReal("./src/submodules/nats.c/src/jsm.c", "_unmarshalStreamSourceInfo", @as(c_int, 1097), @as(c_uint, @bitCast(NATS_NO_MEMORY)), "%s", natsStatus_GetText(@as(c_uint, @bitCast(NATS_NO_MEMORY))));
    s = nats_JSONGetStr(json, "name", &ssi.*.Name);
    if (s == @as(c_uint, @bitCast(NATS_OK))) {
        s = _unmarshalExternalStream(json, "external", &ssi.*.External);
    }
    if (s == @as(c_uint, @bitCast(NATS_OK))) {
        s = nats_JSONGetULong(json, "lag", &ssi.*.Lag);
    }
    if (s == @as(c_uint, @bitCast(NATS_OK))) {
        s = nats_JSONGetLong(json, "active", &ssi.*.Active);
    }
    if (s == @as(c_uint, @bitCast(NATS_OK))) {
        s = nats_JSONGetStr(json, "filter_subject", @as([*c][*c]u8, @ptrCast(@alignCast(&ssi.*.FilterSubject))));
    }
    if (s == @as(c_uint, @bitCast(NATS_OK))) {
        s = nats_JSONGetArrayObject(json, "subject_transforms", &subjectTransforms, &subjectTransformsLen);
    }
    if ((s == @as(c_uint, @bitCast(NATS_OK))) and (subjectTransforms != @as([*c][*c]nats_JSON, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0)))))))) {
        var i: c_int = undefined;
        _ = &i;
        ssi.*.SubjectTransforms = @as([*c]jsSubjectTransformConfig, @ptrCast(@alignCast(calloc(@as(c_ulong, @bitCast(@as(c_long, subjectTransformsLen))), @sizeOf(jsSubjectTransformConfig)))));
        if (ssi.*.SubjectTransforms == @as([*c]jsSubjectTransformConfig, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) {
            s = nats_setErrorReal("./src/submodules/nats.c/src/jsm.c", "_unmarshalStreamSourceInfo", @as(c_int, 1113), @as(c_uint, @bitCast(NATS_NO_MEMORY)), "%s", natsStatus_GetText(@as(c_uint, @bitCast(NATS_NO_MEMORY))));
        }
        {
            i = 0;
            while ((s == @as(c_uint, @bitCast(NATS_OK))) and (i < subjectTransformsLen)) : (i += 1) {
                s = _unmarshalSubjectTransformConfig((blk: {
                    const tmp = i;
                    if (tmp >= 0) break :blk subjectTransforms + @as(usize, @intCast(tmp)) else break :blk subjectTransforms - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
                }).*, &(blk: {
                    const tmp = i;
                    if (tmp >= 0) break :blk ssi.*.SubjectTransforms + @as(usize, @intCast(tmp)) else break :blk ssi.*.SubjectTransforms - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
                }).*);
                if (s == @as(c_uint, @bitCast(NATS_OK))) {
                    ssi.*.SubjectTransformsLen += 1;
                }
            }
        }
        free(@as(?*anyopaque, @ptrCast(subjectTransforms)));
    }
    if (s == @as(c_uint, @bitCast(NATS_OK))) {
        new_src.* = ssi;
    } else {
    ...
    return if (s == @as(c_uint, @bitCast(NATS_OK))) s else nats_updateErrStack(s, "_unmarshalStreamSourceInfo");
}
pub fn _unmarshalStreamAlternate(arg_json: [*c]nats_JSON, arg_new_alt: [*c][*c]jsStreamAlternate) callconv(.c) natsStatus {
    var json = arg_json;
    _ = &json;
    var new_alt = arg_new_alt;
    _ = &new_alt;
    var sa: [*c]jsStreamAlternate = null;
    _ = &sa;
    var s: natsStatus = @as(c_uint, @bitCast(NATS_OK));
    _ = &s;
    sa = @as([*c]jsStreamAlternate, @ptrCast(@alignCast(calloc(@as(c_ulong, @bitCast(@as(c_long, @as(c_int, 1)))), @sizeOf(jsStreamAlternate)))));
    if (sa == @as([*c]jsStreamAlternate, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) return nats_setErrorReal("./src/submodules/nats.c/src/jsm.c", "_unmarshalStreamAlternate", @as(c_int, 1141), @as(c_uint, @bitCast(NATS_NO_MEMORY)), "%s", natsStatus_GetText(@as(c_uint, @bitCast(NATS_NO_MEMORY))));
    s = nats_JSONGetStr(json, "name", @as([*c][*c]u8, @ptrCast(@alignCast(&sa.*.Name))));
    if (s == @as(c_uint, @bitCast(NATS_OK))) {
        s = nats_JSONGetStr(json, "domain", @as([*c][*c]u8, @ptrCast(@alignCast(&sa.*.Domain))));
    }
    if (s == @as(c_uint, @bitCast(NATS_OK))) {
        s = nats_JSONGetStr(json, "cluster", @as([*c][*c]u8, @ptrCast(@alignCast(&sa.*.Cluster))));
    }
    if (s == @as(c_uint, @bitCast(NATS_OK))) {
        new_alt.* = sa;
    } else {
    ...
    return if (s == @as(c_uint, @bitCast(NATS_OK))) s else nats_updateErrStack(s, "_unmarshalStreamAlternate");
}
pub fn _unmarshalStreamInfoPaged(arg_json: [*c]nats_JSON, arg_new_si: [*c][*c]jsStreamInfo, arg_page: [*c]apiPaged) callconv(.c) natsStatus {
    var json = arg_json;
    _ = &json;
    var new_si = arg_new_si;
    _ = &new_si;
    ...
    var sourcesLen: c_int = 0;
    _ = &sourcesLen;
    var alts: [*c][*c]nats_JSON = null;
    _ = &alts;
    var altsLen: c_int = 0;
    _ = &altsLen;
    var s: natsStatus = undefined;
    _ = &s;
    si = @as([*c]jsStreamInfo, @ptrCast(@alignCast(calloc(@as(c_ulong, @bitCast(@as(c_long, @as(c_int, 1)))), @sizeOf(jsStreamInfo)))));
    if (si == @as([*c]jsStreamInfo, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) return nats_setErrorReal("./src/submodules/nats.c/src/jsm.c", "_unmarshalStreamInfoPaged", @as(c_int, 1167), @as(c_uint, @bitCast(NATS_NO_MEMORY)), "%s", natsStatus_GetText(@as(c_uint, @bitCast(NATS_NO_MEMORY))));
    s = js_unmarshalStreamConfig(json, "config", &si.*.Config);
    if (s == @as(c_uint, @bitCast(NATS_OK))) {
        s = nats_JSONGetTime(json, "created", &si.*.Created);
    }
    if (s == @as(c_uint, @bitCast(NATS_OK))) {
        s = js_unmarshalStreamState(json, "state", &si.*.State);
    }
    if (s == @as(c_uint, @bitCast(NATS_OK))) {
        s = _unmarshalClusterInfo(json, "cluster", &si.*.Cluster);
    }
    if (s == @as(c_uint, @bitCast(NATS_OK))) {
        s = _unmarshalStreamSourceInfo(json, "mirror", &si.*.Mirror);
    }
    if (s == @as(c_uint, @bitCast(NATS_OK))) {
        s = nats_JSONGetArrayObject(json, "sources", &sources, &sourcesLen);
    }
    if ((s == @as(c_uint, @bitCast(NATS_OK))) and (sources != @as([*c][*c]nats_JSON, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0)))))))) {
        var i: c_int = undefined;
        _ = &i;
        si.*.Sources = @as([*c][*c]jsStreamSourceInfo, @ptrCast(@alignCast(calloc(@as(c_ulong, @bitCast(@as(c_long, sourcesLen))), @sizeOf([*c]jsStreamSourceInfo)))));
        if (si.*.Sources == @as([*c][*c]jsStreamSourceInfo, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) {
            s = nats_setErrorReal("./src/submodules/nats.c/src/jsm.c", "_unmarshalStreamInfoPaged", @as(c_int, 1182), @as(c_uint, @bitCast(NATS_NO_MEMORY)), "%s", natsStatus_GetText(@as(c_uint, @bitCast(NATS_NO_MEMORY))));
        }
        {
            i = 0;
            while ((s == @as(c_uint, @bitCast(NATS_OK))) and (i < sourcesLen)) : (i += 1) {
                s = _unmarshalStreamSourceInfo((blk: {
                    const tmp = i;
                    if (tmp >= 0) break :blk sources + @as(usize, @intCast(tmp)) else break :blk sources - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
                }).*, null, &(blk: {
                    const tmp = i;
    ...
    if (s == @as(c_uint, @bitCast(NATS_OK))) {
        s = nats_JSONGetArrayObject(json, "alternates", &alts, &altsLen);
    }
    if ((s == @as(c_uint, @bitCast(NATS_OK))) and (alts != @as([*c][*c]nats_JSON, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0)))))))) {
        var i: c_int = undefined;
        _ = &i;
        si.*.Alternates = @as([*c][*c]jsStreamAlternate, @ptrCast(@alignCast(calloc(@as(c_ulong, @bitCast(@as(c_long, altsLen))), @sizeOf([*c]jsStreamAlternate)))));
        if (si.*.Alternates == @as([*c][*c]jsStreamAlternate, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) {
            s = nats_setErrorReal("./src/submodules/nats.c/src/jsm.c", "_unmarshalStreamInfoPaged", @as(c_int, 1200), @as(c_uint, @bitCast(NATS_NO_MEMORY)), "%s", natsStatus_GetText(@as(c_uint, @bitCast(NATS_NO_MEMORY))));
        }
        {
            i = 0;
            while ((s == @as(c_uint, @bitCast(NATS_OK))) and (i < altsLen)) : (i += 1) {
                s = _unmarshalStreamAlternate((blk: {
                    const tmp = i;
                    if (tmp >= 0) break :blk alts + @as(usize, @intCast(tmp)) else break :blk alts - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
                }).*, &(blk: {
                    const tmp = i;
                    if (tmp >= 0) break :blk si.*.Alternates + @as(usize, @intCast(tmp)) else break :blk si.*.Alternates - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
                }).*);
        ...
        free(@as(?*anyopaque, @ptrCast(alts)));
    }
    if ((s == @as(c_uint, @bitCast(NATS_OK))) and (page != @as([*c]apiPaged, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0)))))))) {
        if (s == @as(c_uint, @bitCast(NATS_OK))) {
            s = nats_JSONGetLong(json, "total", &page.*.total);
        }
        if (s == @as(c_uint, @bitCast(NATS_OK))) {
            s = nats_JSONGetLong(json, "offset", &page.*.offset);
        }
        if (s == @as(c_uint, @bitCast(NATS_OK))) {
            s = nats_JSONGetLong(json, "limit", &page.*.limit);
        }
    }
    if (s == @as(c_uint, @bitCast(NATS_OK))) {
        new_si.* = si;
    ...
    return if (s == @as(c_uint, @bitCast(NATS_OK))) s else nats_updateErrStack(s, "_unmarshalStreamInfoPaged");
}
pub fn _unmarshalStreamCreateResp(arg_new_si: [*c][*c]jsStreamInfo, arg_page: [*c]apiPaged, arg_resp: [*c]natsMsg, arg_errCode: [*c]jsErrCode) callconv(.c) natsStatus {
    var new_si = arg_new_si;
    _ = &new_si;
    var page = arg_page;
    _ = &page;
    ...
    var json: [*c]nats_JSON = null;
    _ = &json;
    var ar: jsApiResponse = undefined;
    _ = &ar;
    var s: natsStatus = undefined;
    _ = &s;
    s = js_unmarshalResponse(&ar, &json, resp);
    if (s != @as(c_uint, @bitCast(NATS_OK))) return if (s == @as(c_uint, @bitCast(NATS_OK))) s else nats_updateErrStack(s, "_unmarshalStreamCreateResp");
    if (((&ar).*.Error.Code != @as(c_int, 0)) or (@as(c_int, @bitCast(@as(c_uint, (&ar).*.Error.ErrCode))) != @as(c_int, 0))) {
        if (errCode != @as([*c]jsErrCode, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) {
            errCode.* = @as(c_uint, @bitCast(@as(c_int, @bitCast(@as(c_uint, ar.Error.ErrCode)))));
        }
        if (@as(c_int, @bitCast(@as(c_uint, ar.Error.ErrCode))) == JSStreamNotFoundErr) {
            s = @as(c_uint, @bitCast(NATS_NOT_FOUND));
        } else {
            s = nats_setErrorReal("./src/submodules/nats.c/src/jsm.c", "_unmarshalStreamCreateResp", @as(c_int, 1253), @as(c_uint, @bitCast(NATS_ERR)), "%s", ar.Error.Description);
        }
    } else if (new_si != @as([*c][*c]jsStreamInfo, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) {
        s = _unmarshalStreamInfoPaged(json, new_si, page);
    }
    js_freeApiRespContent(&ar);
    nats_JSONDestroy(json);
    return if (s == @as(c_uint, @bitCast(NATS_OK))) s else nats_updateErrStack(s, "_unmarshalStreamCreateResp");
}
pub fn _restoreMirrorAndSourcesExternal(arg_cfg: [*c]jsStreamConfig) callconv(.c) void {
    var cfg = arg_cfg;
    _ = &cfg;
    var i: c_int = undefined;
    _ = &i;
    if ((cfg.*.Mirror != @as([*c]jsStreamSource, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) and !((if ((cfg.*.Mirror.*.Domain == @as([*c]const u8, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) or (@as(c_int, @bitCast(@as(c_uint, cfg.*.Mirror.*.Domain[@as(c_uint, @intCast(@as(c_int, 0)))]))) == @as(c_int, '\x00'))) @as(c_int, 1) else @as(c_int, 0)) != 0)) {
    ...
    }
    {
        i = 0;
        while (i < cfg.*.SourcesLen) : (i += 1) {
            var src: [*c]jsStreamSource = (blk: {
                const tmp = i;
                if (tmp >= 0) break :blk cfg.*.Sources + @as(usize, @intCast(tmp)) else break :blk cfg.*.Sources - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
            }).*;
            _ = &src;
            if ((src != @as([*c]jsStreamSource, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) and !((if ((src.*.Domain == @as([*c]const u8, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) or (@as(c_int, @bitCast(@as(c_uint, src.*.Domain[@as(c_uint, @intCast(@as(c_int, 0)))]))) == @as(c_int, '\x00'))) @as(c_int, 1) else @as(c_int, 0)) != 0)) {
...
pub fn _convertDomain(arg_src: [*c]jsStreamSource) callconv(.c) natsStatus {
    var src = arg_src;
    _ = &src;
    var e: [*c]jsExternalStream = null;
    _ = &e;
    e = @as([*c]jsExternalStream, @ptrCast(@alignCast(calloc(@as(c_ulong, @bitCast(@as(c_long, @as(c_int, 1)))), @sizeOf(jsExternalStream)))));
    if (e == @as([*c]jsExternalStream, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) return nats_setErrorReal("./src/submodules/nats.c/src/jsm.c", "_convertDomain", @as(c_int, 1316), @as(c_uint, @bitCast(NATS_NO_MEMORY)), "%s", natsStatus_GetText(@as(c_uint, @bitCast(NATS_NO_MEMORY))));
    if (asprintf(@as([*c][*c]u8, @ptrCast(@alignCast(&e.*.APIPrefix))), "$JS.%s.API", src.*.Domain) < @as(c_int, 0)) {
        free(@as(?*anyopaque, @ptrCast(e)));
        return nats_setErrorReal("./src/submodules/nats.c/src/jsm.c", "_convertDomain", @as(c_int, 1321), @as(c_uint, @bitCast(NATS_NO_MEMORY)), "%s", natsStatus_GetText(@as(c_uint, @bitCast(NATS_NO_MEMORY))));
    }
    src.*.External = e;
    return @as(c_uint, @bitCast(NATS_OK));
}
pub fn _convertMirrorAndSourcesDomain(arg_converted: [*c]bool, arg_cfg: [*c]jsStreamConfig) callconv(.c) natsStatus {
    var converted = arg_converted;
    _ = &converted;
    var cfg = arg_cfg;
    _ = &cfg;
    var s: natsStatus = @as(c_uint, @bitCast(NATS_OK));
    _ = &s;
    var cm: bool = @as(c_int, 0) != 0;
    _ = &cm;
    var cs: bool = @as(c_int, 0) != 0;
    _ = &cs;
    var i: c_int = undefined;
    _ = &i;
    converted.* = @as(c_int, 0) != 0;
    if ((cfg.*.Mirror != @as([*c]jsStreamSource, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) and !((if ((cfg.*.Mirror.*.Domain == @as([*c]const u8, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) or (@as(c_int, @bitCast(@as(c_uint, cfg.*.Mirror.*.Domain[@as(c_uint, @intCast(@as(c_int, 0)))]))) == @as(c_int, '\x00'))) @as(c_int, 1) else @as(c_int, 0)) != 0)) {
        if (cfg.*.Mirror.*.External != @as([*c]jsExternalStream, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) return nats_setErrorReal("./src/submodules/nats.c/src/jsm.c", "_convertMirrorAndSourcesDomain", @as(c_int, 1340), @as(c_uint, @bitCast(NATS_INVALID_ARG)), "%s", "mirror's domain and external are both set");
        cm = @as(c_int, 1) != 0;
    }
    {
        i = 0;
        while (i < cfg.*.SourcesLen) : (i += 1) {
            ...
            _ = &src;
            if ((src != @as([*c]jsStreamSource, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) and !((if ((src.*.Domain == @as([*c]const u8, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) or (@as(c_int, @bitCast(@as(c_uint, src.*.Domain[@as(c_uint, @intCast(@as(c_int, 0)))]))) == @as(c_int, '\x00'))) @as(c_int, 1) else @as(c_int, 0)) != 0)) {
                if (src.*.External != @as([*c]jsExternalStream, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) return nats_setErrorReal("./src/submodules/nats.c/src/jsm.c", "_convertMirrorAndSourcesDomain", @as(c_int, 1349), @as(c_uint, @bitCast(NATS_INVALID_ARG)), "%s", "source's domain and external are both set");
                cs = @as(c_int, 1) != 0;
            }
        }
    }
    if (!cm and !cs) return @as(c_uint, @bitCast(NATS_OK));
    if (cm) {
        s = _convertDomain(cfg.*.Mirror);
    }
    if ((s == @as(c_uint, @bitCast(NATS_OK))) and (@as(c_int, @intFromBool(cs)) != 0)) {
        {
            i = 0;
            while ((s == @as(c_uint, @bitCast(NATS_OK))) and (i < cfg.*.SourcesLen)) : (i += 1) {
                var src: [*c]jsStreamSource = (blk: {
    ...
    if (s == @as(c_uint, @bitCast(NATS_OK))) {
        converted.* = @as(c_int, 1) != 0;
    } else {
        _restoreMirrorAndSourcesExternal(cfg);
    }
    return if (s == @as(c_uint, @bitCast(NATS_OK))) s else nats_updateErrStack(s, "_convertMirrorAndSourcesDomain");
}
pub fn _addOrUpdate(arg_new_si: [*c][*c]jsStreamInfo, arg_action: jsStreamAction, arg_js: [*c]jsCtx, arg_cfg: [*c]jsStreamConfig, arg_opts: [*c]jsOptions, arg_errCode: [*c]jsErrCode) callconv(.c) natsStatus {
    var new_si = arg_new_si;
    _ = &new_si;
    ...
    var nc: [*c]natsConnection = null;
    _ = &nc;
    var apiT: [*c]const u8 = null;
    _ = &apiT;
    var freePfx: bool = @as(c_int, 0) != 0;
    _ = &freePfx;
    var msc: bool = @as(c_int, 0) != 0;
    _ = &msc;
    var o: jsOptions = undefined;
    _ = &o;
    if (errCode != @as([*c]jsErrCode, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) {
    ...
    if (js == @as([*c]jsCtx, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) return nats_setErrorReal("./src/submodules/nats.c/src/jsm.c", "_addOrUpdate", @as(c_int, 1391), @as(c_uint, @bitCast(NATS_INVALID_ARG)), "%s", natsStatus_GetText(@as(c_uint, @bitCast(NATS_INVALID_ARG))));
    if (cfg == @as([*c]jsStreamConfig, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) return nats_setErrorReal("./src/submodules/nats.c/src/jsm.c", "_addOrUpdate", @as(c_int, 1394), @as(c_uint, @bitCast(NATS_INVALID_ARG)), "%s", "stream configuration required");
    s = _checkStreamName(cfg.*.Name);
    if (s != @as(c_uint, @bitCast(NATS_OK))) return if (s == @as(c_uint, @bitCast(NATS_OK))) s else nats_updateErrStack(s, "_addOrUpdate");
    while (true) {
        switch (action) {
            @as(c_uint, @bitCast(@as(c_int, 1))) => {
                apiT = "%.*s.STREAM.CREATE.%s";
                break;
            },
            @as(c_uint, @bitCast(@as(c_int, 2))) => {
                apiT = "%.*s.STREAM.UPDATE.%s";
                break;
            },
            else => {
                abort();
    ...
    s = js_setOpts(&nc, &freePfx, js, opts, &o);
    if (s == @as(c_uint, @bitCast(NATS_OK))) {
        if (asprintf(&subj, apiT, js_lenWithoutTrailingDot(o.Prefix), o.Prefix, cfg.*.Name) < @as(c_int, 0)) {
            s = nats_setErrorReal("./src/submodules/nats.c/src/jsm.c", "_addOrUpdate", @as(c_int, 1410), @as(c_uint, @bitCast(NATS_NO_MEMORY)), "%s", natsStatus_GetText(@as(c_uint, @bitCast(NATS_NO_MEMORY))));
        }
        if (freePfx) {
            free(@as(?*anyopaque, @ptrCast(@as([*c]u8, @ptrCast(@volatileCast(@constCast(o.Prefix)))))));
        }
    }
    if ((s == @as(c_uint, @bitCast(NATS_OK))) and (action == @as(c_uint, @bitCast(jsStreamActionCreate)))) {
        s = _convertMirrorAndSourcesDomain(&msc, cfg);
    }
    if (s == @as(c_uint, @bitCast(NATS_OK))) {
        s = js_marshalStreamConfig(&buf, cfg);
    }
    if (s == @as(c_uint, @bitCast(NATS_OK))) {
        s = natsConnection_Request(&resp, nc, subj, @as(?*const anyopaque, @ptrCast(buf.*.data)), buf.*.len, o.Wait);
        if ((s == @as(c_uint, @bitCast(NATS_NO_RESPONDERS))) and (errCode != @as([*c]jsErrCode, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0)))))))) {
    ...
    if (s == @as(c_uint, @bitCast(NATS_OK))) {
        s = _unmarshalStreamCreateResp(new_si, null, resp, errCode);
    }
    if (msc) {
        _restoreMirrorAndSourcesExternal(cfg);
    }
    if ((((((((((s == @as(c_uint, @bitCast(NATS_OK))) and (new_si != @as([*c][*c]jsStreamInfo, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0)))))))) and (new_si.* != @as([*c]jsStreamInfo, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0)))))))) and (cfg.*.Compression != new_si.*.*.Config.*.Compression)) and (cfg.*.FirstSeq != new_si.*.*.Config.*.FirstSeq)) and (cfg.*.Metadata.Count != new_si.*.*.Config.*.Metadata.Count)) and (@as(c_int, @intFromBool(nats_StringEquals(cfg.*.SubjectTransform.Source, new_si.*.*.Config.*.SubjectTransform.Source))) != 0)) and (@as(c_int, @intFromBool(nats_StringEquals(cfg.*.SubjectTransform.Destination, new_si.*.*.Config.*.SubjectTransform.Destination))) != 0)) and (cfg.*.ConsumerLimits.InactiveThreshold != new_si.*.*.Config.*.ConsumerLimits.InactiveThreshold)) and (cfg.*.ConsumerLimits.MaxAckPending != new_si.*.*.Config.*.ConsumerLimits.MaxAckPending)) {
        return nats_setErrorReal("./src/submodules/nats.c/src/jsm.c", "_addOrUpdate", @as(c_int, 1445), @as(c_uint, @bitCast(NATS_INVALID_ARG)), "%s", "stream configuration required");
    }
    natsBuf_Destroy(buf);
    natsMsg_Destroy(resp);
    free(@as(?*anyopaque, @ptrCast(subj)));
    return if (s == @as(c_uint, @bitCast(NATS_OK))) s else nats_updateErrStack(s, "_addOrUpdate");
}
pub fn _marshalStreamInfoReq(arg_new_buf: [*c][*c]natsBuffer, arg_o: [*c]struct_jsOptionsStreamInfo_71, arg_offset: i64) callconv(.c) natsStatus {
    var new_buf = arg_new_buf;
    _ = &new_buf;
    var o = arg_o;
    _ = &o;
    ...
    _ = &offset;
    var buf: [*c]natsBuffer = new_buf.*;
    _ = &buf;
    var s: natsStatus = @as(c_uint, @bitCast(NATS_OK));
    _ = &s;
    if (!o.*.DeletedDetails and ((if ((o.*.SubjectsFilter == @as([*c]const u8, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) or (@as(c_int, @bitCast(@as(c_uint, o.*.SubjectsFilter[@as(c_uint, @intCast(@as(c_int, 0)))]))) == @as(c_int, '\x00'))) @as(c_int, 1) else @as(c_int, 0)) != 0)) return @as(c_uint, @bitCast(NATS_OK));
    if (buf == @as([*c]natsBuffer, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) {
        s = natsBuf_Create(&buf, @as(c_int, 30));
    }
    if (s == @as(c_uint, @bitCast(NATS_OK))) {
        s = natsBuf_AppendByte(buf, @as(u8, @bitCast(@as(i8, @truncate(@as(c_int, '{'))))));
    }
    if ((s == @as(c_uint, @bitCast(NATS_OK))) and (@as(c_int, @intFromBool(o.*.DeletedDetails)) != 0)) {
        s = natsBuf_Append(buf, "\"deleted_details\":true", -@as(c_int, 1));
    }
    if ((s == @as(c_uint, @bitCast(NATS_OK))) and !((if ((o.*.SubjectsFilter == @as([*c]const u8, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) or (@as(c_int, @bitCast(@as(c_uint, o.*.SubjectsFilter[@as(c_uint, @intCast(@as(c_int, 0)))]))) == @as(c_int, '\x00'))) @as(c_int, 1) else @as(c_int, 0)) != 0)) {
        if (o.*.DeletedDetails) {
            s = natsBuf_AppendByte(buf, @as(u8, @bitCast(@as(i8, @truncate(@as(c_int, ','))))));
        }
        if (s == @as(c_uint, @bitCast(NATS_OK))) {
            s = natsBuf_Append(buf, "\"subjects_filter\":\"", -@as(c_int, 1));
        }
        if (s == @as(c_uint, @bitCast(NATS_OK))) {
            s = natsBuf_Append(buf, o.*.SubjectsFilter, -@as(c_int, 1));
        }
        if (s == @as(c_uint, @bitCast(NATS_OK))) {
            s = natsBuf_AppendByte(buf, @as(u8, @bitCast(@as(i8, @truncate(@as(c_int, '"'))))));
        }
        if ((s == @as(c_uint, @bitCast(NATS_OK))) and (offset > @as(i64, @bitCast(@as(c_long, @as(c_int, 0)))))) if (s == @as(c_uint, @bitCast(NATS_OK))) {
            s = nats_marshalLong(buf, @as(c_int, 1) != 0, "offset", offset);
        };
    }
    if (s == @as(c_uint, @bitCast(NATS_OK))) {
        s = natsBuf_AppendByte(buf, @as(u8, @bitCast(@as(i8, @truncate(@as(c_int, '}'))))));
    }
    if (new_buf.* == @as([*c]natsBuffer, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) {
        new_buf.* = buf;
    }
    return if (s == @as(c_uint, @bitCast(NATS_OK))) s else nats_updateErrStack(s, "_marshalStreamInfoReq");
}
pub fn _unmarshalSuccessResp(arg_success: [*c]bool, arg_resp: [*c]natsMsg, arg_errCode: [*c]jsErrCode) callconv(.c) natsStatus {
    var success = arg_success;
    _ = &success;
    var resp = arg_resp;
    _ = &resp;
    var errCode = arg_errCode;
    ...
    var s: natsStatus = undefined;
    _ = &s;
    success.* = @as(c_int, 0) != 0;
    s = js_unmarshalResponse(&ar, &json, resp);
    if (s != @as(c_uint, @bitCast(NATS_OK))) return if (s == @as(c_uint, @bitCast(NATS_OK))) s else nats_updateErrStack(s, "_unmarshalSuccessResp");
    if (((&ar).*.Error.Code != @as(c_int, 0)) or (@as(c_int, @bitCast(@as(c_uint, (&ar).*.Error.ErrCode))) != @as(c_int, 0))) {
        if (errCode != @as([*c]jsErrCode, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) {
            errCode.* = @as(c_uint, @bitCast(@as(c_int, @bitCast(@as(c_uint, ar.Error.ErrCode)))));
        }
        if ((@as(c_int, @bitCast(@as(c_uint, ar.Error.ErrCode))) == JSStreamNotFoundErr) or (@as(c_int, @bitCast(@as(c_uint, ar.Error.ErrCode))) == JSConsumerNotFoundErr)) {
            s = @as(c_uint, @bitCast(NATS_NOT_FOUND));
        } else {
            s = nats_setErrorReal("./src/submodules/nats.c/src/jsm.c", "_unmarshalSuccessResp", @as(c_int, 1662), @as(c_uint, @bitCast(NATS_ERR)), "%s", ar.Error.Description);
        }
    } else {
    ...
    js_freeApiRespContent(&ar);
    nats_JSONDestroy(json);
    return if (s == @as(c_uint, @bitCast(NATS_OK))) s else nats_updateErrStack(s, "_unmarshalSuccessResp");
}
pub fn _marshalPurgeRequest(arg_new_buf: [*c][*c]natsBuffer, arg_opts: [*c]struct_jsOptionsStreamPurge_70) callconv(.c) natsStatus {
    var new_buf = arg_new_buf;
    _ = &new_buf;
    var opts = arg_opts;
    _ = &opts;
    ...
    var comma: bool = @as(c_int, 0) != 0;
    _ = &comma;
    if ((((if ((opts.*.Subject == @as([*c]const u8, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) or (@as(c_int, @bitCast(@as(c_uint, opts.*.Subject[@as(c_uint, @intCast(@as(c_int, 0)))]))) == @as(c_int, '\x00'))) @as(c_int, 1) else @as(c_int, 0)) != 0) and (opts.*.Sequence == @as(u64, @bitCast(@as(c_long, @as(c_int, 0)))))) and (opts.*.Keep == @as(u64, @bitCast(@as(c_long, @as(c_int, 0)))))) return @as(c_uint, @bitCast(NATS_OK));
    if ((opts.*.Sequence > @as(u64, @bitCast(@as(c_long, @as(c_int, 0))))) and (opts.*.Keep > @as(u64, @bitCast(@as(c_long, @as(c_int, 0)))))) return nats_setErrorReal("./src/submodules/nats.c/src/jsm.c", "_marshalPurgeRequest", @as(c_int, 1687), @as(c_uint, @bitCast(NATS_INVALID_ARG)), "Sequence (%lu) and Keep (%lu are mutually exclusive", opts.*.Sequence, opts.*.Keep);
    s = natsBuf_Create(&buf, @as(c_int, 128));
    if (s == @as(c_uint, @bitCast(NATS_OK))) {
        s = natsBuf_AppendByte(buf, @as(u8, @bitCast(@as(i8, @truncate(@as(c_int, '{'))))));
    }
    if ((s == @as(c_uint, @bitCast(NATS_OK))) and !((if ((opts.*.Subject == @as([*c]const u8, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) or (@as(c_int, @bitCast(@as(c_uint, opts.*.Subject[@as(c_uint, @intCast(@as(c_int, 0)))]))) == @as(c_int, '\x00'))) @as(c_int, 1) else @as(c_int, 0)) != 0)) {
        s = natsBuf_Append(buf, "\"filter\":\"", -@as(c_int, 1));
        if (s == @as(c_uint, @bitCast(NATS_OK))) {
            s = natsBuf_Append(buf, opts.*.Subject, -@as(c_int, 1));
        }
        if (s == @as(c_uint, @bitCast(NATS_OK))) {
            s = natsBuf_AppendByte(buf, @as(u8, @bitCast(@as(i8, @truncate(@as(c_int, '"'))))));
        }
    ...
    if ((s == @as(c_uint, @bitCast(NATS_OK))) and (opts.*.Sequence > @as(u64, @bitCast(@as(c_long, @as(c_int, 0)))))) {
        s = nats_marshalULong(buf, comma, "seq", opts.*.Sequence);
    }
    if ((s == @as(c_uint, @bitCast(NATS_OK))) and (opts.*.Keep > @as(u64, @bitCast(@as(c_long, @as(c_int, 0)))))) {
    ...
    return if (s == @as(c_uint, @bitCast(NATS_OK))) s else nats_updateErrStack(s, "_marshalPurgeRequest");
}
pub fn _purgeOrDelete(arg_purge: bool, arg_js: [*c]jsCtx, arg_stream: [*c]const u8, arg_opts: [*c]jsOptions, arg_errCode: [*c]jsErrCode) callconv(.c) natsStatus {
    var purge = arg_purge;
    _ = &purge;
    var js = arg_js;
    _ = &js;
    ...
    var nc: [*c]natsConnection = null;
    _ = &nc;
    var apiT: [*c]const u8 = if (@as(c_int, @intFromBool(purge)) != 0) "%.*s.STREAM.PURGE.%s" else "%.*s.STREAM.DELETE.%s";
    _ = &apiT;
    var freePfx: bool = @as(c_int, 0) != 0;
    _ = &freePfx;
    var buf: [*c]natsBuffer = null;
    ...
    if (js == @as([*c]jsCtx, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) return nats_setErrorReal("./src/submodules/nats.c/src/jsm.c", "_purgeOrDelete", @as(c_int, 1733), @as(c_uint, @bitCast(NATS_INVALID_ARG)), "%s", natsStatus_GetText(@as(c_uint, @bitCast(NATS_INVALID_ARG))));
    s = _checkStreamName(stream);
    if (s != @as(c_uint, @bitCast(NATS_OK))) return if (s == @as(c_uint, @bitCast(NATS_OK))) s else nats_updateErrStack(s, "_purgeOrDelete");
    s = js_setOpts(&nc, &freePfx, js, opts, &o);
    if (s == @as(c_uint, @bitCast(NATS_OK))) {
        if (asprintf(&subj, apiT, js_lenWithoutTrailingDot(o.Prefix), o.Prefix, stream) < @as(c_int, 0)) {
            s = nats_setErrorReal("./src/submodules/nats.c/src/jsm.c", "_purgeOrDelete", @as(c_int, 1743), @as(c_uint, @bitCast(NATS_NO_MEMORY)), "%s", natsStatus_GetText(@as(c_uint, @bitCast(NATS_NO_MEMORY))));
        }
        if (freePfx) {
            free(@as(?*anyopaque, @ptrCast(@as([*c]u8, @ptrCast(@volatileCast(@constCast(o.Prefix)))))));
        }
    }
    if ((s == @as(c_uint, @bitCast(NATS_OK))) and (@as(c_int, @intFromBool(purge)) != 0)) {
        s = _marshalPurgeRequest(&buf, &o.Stream.Purge);
        if ((s == @as(c_uint, @bitCast(NATS_OK))) and (buf != @as([*c]natsBuffer, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0)))))))) {
            data = @as(?*const anyopaque, @ptrCast(buf.*.data));
            dlen = buf.*.len;
        }
    }
    if (s == @as(c_uint, @bitCast(NATS_OK))) {
        s = natsConnection_Request(&resp, js.*.nc, subj, data, dlen, o.Wait);
        if ((s == @as(c_uint, @bitCast(NATS_NO_RESPONDERS))) and (errCode != @as([*c]jsErrCode, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0)))))))) {
            errCode.* = @as(c_uint, @bitCast(JSNotEnabledErr));
        }
    }
    ...
    if ((s == @as(c_uint, @bitCast(NATS_OK))) and !success) {
        s = nats_setErrorReal("./src/submodules/nats.c/src/jsm.c", "_purgeOrDelete", @as(c_int, 1763), @as(c_uint, @bitCast(NATS_ERR)), "failed to %s stream '%s'", if (@as(c_int, @intFromBool(purge)) != 0) "purge" else "delete", stream);
    }
    natsBuf_Destroy(buf);
    natsMsg_Destroy(resp);
    free(@as(?*anyopaque, @ptrCast(subj)));
    return if (s == @as(c_uint, @bitCast(NATS_OK))) s else nats_updateErrStack(s, "_purgeOrDelete");
}
pub fn _decodeBytesLen(arg_json: [*c]nats_JSON, arg_field: [*c]const u8, arg_str: [*c][*c]const u8, arg_strLen: [*c]c_int, arg_decodedLen: [*c]c_int) callconv(.c) natsStatus {
    var json = arg_json;
    _ = &json;
    var field = arg_field;
    _ = &field;
    var str = arg_str;
    _ = &str;
    var strLen = arg_strLen;
    _ = &strLen;
    var decodedLen = arg_decodedLen;
    _ = &decodedLen;
    var s: natsStatus = @as(c_uint, @bitCast(NATS_OK));
    _ = &s;
    s = nats_JSONGetStrPtr(json, field, str);
    if ((s == @as(c_uint, @bitCast(NATS_OK))) and (str.* != @as([*c]const u8, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0)))))))) {
        s = nats_Base64_DecodeLen(str.*, strLen, decodedLen);
    }
    return if (s == @as(c_uint, @bitCast(NATS_OK))) s else nats_updateErrStack(s, "_decodeBytesLen");
}
pub fn _unmarshalStoredMsg(arg_json: [*c]nats_JSON, arg_new_msg: [*c][*c]natsMsg) callconv(.c) natsStatus {
    var json = arg_json;
    _ = &json;
    var new_msg = arg_new_msg;
    _ = &new_msg;
    var s: natsStatus = undefined;
    _ = &s;
    var msg: [*c]natsMsg = null;
    _ = &msg;
    var subject: [*c]const u8 = null;
    _ = &subject;
    var hdrs: [*c]const u8 = null;
    _ = &hdrs;
    ...
    if (s == @as(c_uint, @bitCast(NATS_OK))) {
        s = _decodeBytesLen(json, "hdrs", &hdrs, &hdrsl, &dhdrsl);
    }
    if (s == @as(c_uint, @bitCast(NATS_OK))) {
        s = _decodeBytesLen(json, "data", &data, &datal, &ddatal);
    }
    if ((s == @as(c_uint, @bitCast(NATS_OK))) and (subject != @as([*c]const u8, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0)))))))) {
        s = natsMsg_create(&msg, subject, @as(c_int, @bitCast(@as(c_uint, @truncate(strlen(subject))))), null, @as(c_int, 0), null, dhdrsl + ddatal, dhdrsl);
        if (s == @as(c_uint, @bitCast(NATS_OK))) {
            if ((hdrs != @as([*c]const u8, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) and (dhdrsl > @as(c_int, 0))) {
                nats_Base64_DecodeInPlace(hdrs, hdrsl, @as([*c]u8, @ptrCast(@alignCast(msg.*.hdr))));
            }
            if ((data != @as([*c]const u8, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) and (ddatal > @as(c_int, 0))) {
                nats_Base64_DecodeInPlace(data, datal, @as([*c]u8, @ptrCast(@volatileCast(@constCast(msg.*.data)))));
            }
        }
        if (s == @as(c_uint, @bitCast(NATS_OK))) {
            s = nats_JSONGetULong(json, "seq", &msg.*.seq);
        }
        if (s == @as(c_uint, @bitCast(NATS_OK))) {
            s = nats_JSONGetTime(json, "time", &msg.*.time);
        }
    }
    if (s == @as(c_uint, @bitCast(NATS_OK))) {
        new_msg.* = msg;
    }
    return if (s == @as(c_uint, @bitCast(NATS_OK))) s else nats_updateErrStack(s, "_unmarshalStoredMsg");
}
pub fn _unmarshalGetMsgResp(arg_msg: [*c][*c]natsMsg, arg_resp: [*c]natsMsg, arg_errCode: [*c]jsErrCode) callconv(.c) natsStatus {
    var msg = arg_msg;
    _ = &msg;
    var resp = arg_resp;
    _ = &resp;
    ...
    _ = &s;
    s = js_unmarshalResponse(&ar, &json, resp);
    if (s != @as(c_uint, @bitCast(NATS_OK))) return if (s == @as(c_uint, @bitCast(NATS_OK))) s else nats_updateErrStack(s, "_unmarshalGetMsgResp");
    if (((&ar).*.Error.Code != @as(c_int, 0)) or (@as(c_int, @bitCast(@as(c_uint, (&ar).*.Error.ErrCode))) != @as(c_int, 0))) {
        if (errCode != @as([*c]jsErrCode, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) {
            errCode.* = @as(c_uint, @bitCast(@as(c_int, @bitCast(@as(c_uint, ar.Error.ErrCode)))));
        }
        if (@as(c_int, @bitCast(@as(c_uint, ar.Error.ErrCode))) == JSNoMessageFoundErr) {
            s = @as(c_uint, @bitCast(NATS_NOT_FOUND));
        } else {
            s = nats_setErrorReal("./src/submodules/nats.c/src/jsm.c", "_unmarshalGetMsgResp", @as(c_int, 1854), @as(c_uint, @bitCast(NATS_ERR)), "%s", ar.Error.Description);
        }
    } else {
        var mjson: [*c]nats_JSON = null;
        _ = &mjson;
        s = nats_JSONGetObject(json, "message", &mjson);
        if ((s == @as(c_uint, @bitCast(NATS_OK))) and (mjson == @as([*c]nats_JSON, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0)))))))) {
            s = nats_setErrorReal("./src/submodules/nats.c/src/jsm.c", "_unmarshalGetMsgResp", @as(c_int, 1862), @as(c_uint, @bitCast(NATS_NOT_FOUND)), "%s", "message content not found");
        } else {
    ...
    js_freeApiRespContent(&ar);
    nats_JSONDestroy(json);
    return if (s == @as(c_uint, @bitCast(NATS_OK))) s else nats_updateErrStack(s, "_unmarshalGetMsgResp");
}
pub fn _getMsg(arg_msg: [*c][*c]natsMsg, arg_js: [*c]jsCtx, arg_stream: [*c]const u8, arg_seq: u64, arg_subject: [*c]const u8, arg_opts: [*c]jsOptions, arg_errCode: [*c]jsErrCode) callconv(.c) natsStatus {
    var msg = arg_msg;
    _ = &msg;
    var js = arg_js;
    _ = &js;
    ...
    _ = &buf;
    if ((msg == @as([*c][*c]natsMsg, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) or (js == @as([*c]jsCtx, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0)))))))) return nats_setErrorReal("./src/submodules/nats.c/src/jsm.c", "_getMsg", @as(c_int, 1885), @as(c_uint, @bitCast(NATS_INVALID_ARG)), "%s", natsStatus_GetText(@as(c_uint, @bitCast(NATS_INVALID_ARG))));
    if ((if ((stream == @as([*c]const u8, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) or (@as(c_int, @bitCast(@as(c_uint, stream[@as(c_uint, @intCast(@as(c_int, 0)))]))) == @as(c_int, '\x00'))) @as(c_int, 1) else @as(c_int, 0)) != 0) return nats_setErrorReal("./src/submodules/nats.c/src/jsm.c", "_getMsg", @as(c_int, 1888), @as(c_uint, @bitCast(NATS_INVALID_ARG)), "%s", "stream name is required");
    s = js_setOpts(&nc, &freePfx, js, opts, &o);
    if (s == @as(c_uint, @bitCast(NATS_OK))) {
        if (asprintf(&subj, "%.*s.STREAM.MSG.GET.%s", js_lenWithoutTrailingDot(o.Prefix), o.Prefix, stream) < @as(c_int, 0)) {
            s = nats_setErrorReal("./src/submodules/nats.c/src/jsm.c", "_getMsg", @as(c_int, 1894), @as(c_uint, @bitCast(NATS_NO_MEMORY)), "%s", natsStatus_GetText(@as(c_uint, @bitCast(NATS_NO_MEMORY))));
        }
        if (freePfx) {
            free(@as(?*anyopaque, @ptrCast(@as([*c]u8, @ptrCast(@volatileCast(@constCast(o.Prefix)))))));
        }
    ...
    if ((s == @as(c_uint, @bitCast(NATS_OK))) and (seq > @as(u64, @bitCast(@as(c_long, @as(c_int, 0)))))) {
        s = nats_marshalULong(&buf, @as(c_int, 0) != 0, "seq", seq);
    } else {
        if (s == @as(c_uint, @bitCast(NATS_OK))) {
            s = natsBuf_Append(&buf, "\"last_by_subj\":\"", -@as(c_int, 1));
        }
        if (s == @as(c_uint, @bitCast(NATS_OK))) {
            s = natsBuf_Append(&buf, subject, -@as(c_int, 1));
        }
    ...
    natsMsg_Destroy(resp);
    free(@as(?*anyopaque, @ptrCast(subj)));
    return if (s == @as(c_uint, @bitCast(NATS_OK))) s else nats_updateErrStack(s, "_getMsg");
}
pub fn _deleteMsg(arg_js: [*c]jsCtx, arg_noErase: bool, arg_stream: [*c]const u8, arg_seq: u64, arg_opts: [*c]jsOptions, arg_errCode: [*c]jsErrCode) callconv(.c) natsStatus {
    var js = arg_js;
    _ = &js;
    var noErase = arg_noErase;
    _ = &noErase;
    var stream = arg_stream;
    _ = &stream;
    var seq = arg_seq;
    ...
    if (js == @as([*c]jsCtx, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) return nats_setErrorReal("./src/submodules/nats.c/src/jsm.c", "_deleteMsg", @as(c_int, 2117), @as(c_uint, @bitCast(NATS_INVALID_ARG)), "%s", natsStatus_GetText(@as(c_uint, @bitCast(NATS_INVALID_ARG))));
    if ((if ((stream == @as([*c]const u8, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) or (@as(c_int, @bitCast(@as(c_uint, stream[@as(c_uint, @intCast(@as(c_int, 0)))]))) == @as(c_int, '\x00'))) @as(c_int, 1) else @as(c_int, 0)) != 0) return nats_setErrorReal("./src/submodules/nats.c/src/jsm.c", "_deleteMsg", @as(c_int, 2120), @as(c_uint, @bitCast(NATS_INVALID_ARG)), "%s", "stream name is required");
    s = js_setOpts(&nc, &freePfx, js, opts, &o);
    if (s == @as(c_uint, @bitCast(NATS_OK))) {
        if (asprintf(&subj, "%.*s.STREAM.MSG.DELETE.%s", js_lenWithoutTrailingDot(o.Prefix), o.Prefix, stream) < @as(c_int, 0)) {
            s = nats_setErrorReal("./src/submodules/nats.c/src/jsm.c", "_deleteMsg", @as(c_int, 2126), @as(c_uint, @bitCast(NATS_NO_MEMORY)), "%s", natsStatus_GetText(@as(c_uint, @bitCast(NATS_NO_MEMORY))));
        }
        if (freePfx) {
            free(@as(?*anyopaque, @ptrCast(@as([*c]u8, @ptrCast(@volatileCast(@constCast(o.Prefix)))))));
        }
    ...
    if ((s == @as(c_uint, @bitCast(NATS_OK))) and (@as(c_int, @intFromBool(noErase)) != 0)) {
        s = natsBuf_Append(&buf, ",\"no_erase\":true", -@as(c_int, 1));
    }
    if (s == @as(c_uint, @bitCast(NATS_OK))) {
        s = natsBuf_AppendByte(&buf, @as(u8, @bitCast(@as(i8, @truncate(@as(c_int, '}'))))));
    }
    ...
    if ((s == @as(c_uint, @bitCast(NATS_OK))) and !success) {
        s = nats_setErrorReal("./src/submodules/nats.c/src/jsm.c", "_deleteMsg", @as(c_int, 2143), @as(c_uint, @bitCast(NATS_ERR)), "failed to delete message %lu", seq);
    }
    natsBuf_Destroy(&buf);
    natsMsg_Destroy(resp);
    free(@as(?*anyopaque, @ptrCast(subj)));
    return if (s == @as(c_uint, @bitCast(NATS_OK))) s else nats_updateErrStack(s, "_deleteMsg");
}
pub fn _unmarshalStreamInfoListResp(arg_m: [*c]natsStrHash, arg_page: [*c]apiPaged, arg_resp: [*c]natsMsg, arg_errCode: [*c]jsErrCode) callconv(.c) natsStatus {
    var m = arg_m;
    _ = &m;
    var page = arg_page;
    _ = &page;
    ...
    _ = &s;
    s = js_unmarshalResponse(&ar, &json, resp);
    if (s != @as(c_uint, @bitCast(NATS_OK))) return if (s == @as(c_uint, @bitCast(NATS_OK))) s else nats_updateErrStack(s, "_unmarshalStreamInfoListResp");
    if (((&ar).*.Error.Code != @as(c_int, 0)) or (@as(c_int, @bitCast(@as(c_uint, (&ar).*.Error.ErrCode))) != @as(c_int, 0))) {
        if (errCode != @as([*c]jsErrCode, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) {
            errCode.* = @as(c_uint, @bitCast(@as(c_int, @bitCast(@as(c_uint, ar.Error.ErrCode)))));
        }
        if (@as(c_int, @bitCast(@as(c_uint, ar.Error.ErrCode))) == JSStreamNotFoundErr) {
            ...
            s = nats_setErrorReal("./src/submodules/nats.c/src/jsm.c", "_unmarshalStreamInfoListResp", @as(c_int, 2190), @as(c_uint, @bitCast(NATS_ERR)), "%s", ar.Error.Description);
        }
    } else {
        var streams: [*c][*c]nats_JSON = null;
        _ = &streams;
        var streamsLen: c_int = 0;
        _ = &streamsLen;
        if (s == @as(c_uint, @bitCast(NATS_OK))) {
            s = nats_JSONGetLong(json, "total", &page.*.total);
        }
        ...
        if (s == @as(c_uint, @bitCast(NATS_OK))) {
            s = nats_JSONGetArrayObject(json, "streams", &streams, &streamsLen);
        }
        if ((s == @as(c_uint, @bitCast(NATS_OK))) and (streams != @as([*c][*c]nats_JSON, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0)))))))) {
            var i: c_int = undefined;
            _ = &i;
            {
                i = 0;
                while ((s == @as(c_uint, @bitCast(NATS_OK))) and (i < streamsLen)) : (i += 1) {
                    var si: [*c]jsStreamInfo = null;
                    _ = &si;
                    var osi: [*c]jsStreamInfo = null;
                    _ = &osi;
                    s = js_unmarshalStreamInfo((blk: {
                        const tmp = i;
                        if (tmp >= 0) break :blk streams + @as(usize, @intCast(tmp)) else break :blk streams - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
                    }).*, &si);
                    if ((s == @as(c_uint, @bitCast(NATS_OK))) and ((si.*.Config == @as([*c]jsStreamConfig, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) or ((if ((si.*.Config.*.Name == @as([*c]const u8, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) or (@as(c_int, @bitCast(@as(c_uint, si.*.Config.*.Name[@as(c_uint, @intCast(@as(c_int, 0)))]))) == @as(c_int, '\x00'))) @as(c_int, 1) else @as(c_int, 0)) != 0))) {
                        s = nats_setErrorReal("./src/submodules/nats.c/src/jsm.c", "_unmarshalStreamInfoListResp", @as(c_int, 2212), @as(c_uint, @bitCast(NATS_ERR)), "%s", "stream name missing from configuration");
                    }
                    if (s == @as(c_uint, @bitCast(NATS_OK))) {
                        s = natsStrHash_SetEx(m, @as([*c]u8, @ptrCast(@volatileCast(@constCast(si.*.Config.*.Name)))), @as(c_int, 1) != 0, @as(c_int, 1) != 0, @as(?*anyopaque, @ptrCast(si)), @as([*c]?*anyopaque, @ptrCast(@alignCast(&osi))));
                    }
                    if (osi != @as([*c]jsStreamInfo, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) {
                        jsStreamInfo_Destroy(osi);
                    }
                }
            }
            free(@as(?*anyopaque, @ptrCast(streams)));
        }
    }
    js_freeApiRespContent(&ar);
    nats_JSONDestroy(json);
    return if (s == @as(c_uint, @bitCast(NATS_OK))) s else nats_updateErrStack(s, "_unmarshalStreamInfoListResp");
}
pub fn _unmarshalNamesListResp(arg_fieldName: [*c]const u8, arg_m: [*c]natsStrHash, arg_page: [*c]apiPaged, arg_resp: [*c]natsMsg, arg_errCode: [*c]jsErrCode) callconv(.c) natsStatus {
    var fieldName = arg_fieldName;
    _ = &fieldName;
    var m = arg_m;
    _ = &m;
    ...
    _ = &s;
    s = js_unmarshalResponse(&ar, &json, resp);
    if (s != @as(c_uint, @bitCast(NATS_OK))) return if (s == @as(c_uint, @bitCast(NATS_OK))) s else nats_updateErrStack(s, "_unmarshalNamesListResp");
    if (((&ar).*.Error.Code != @as(c_int, 0)) or (@as(c_int, @bitCast(@as(c_uint, (&ar).*.Error.ErrCode))) != @as(c_int, 0))) {
        if (errCode != @as([*c]jsErrCode, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) {
            errCode.* = @as(c_uint, @bitCast(@as(c_int, @bitCast(@as(c_uint, ar.Error.ErrCode)))));
        }
        if (@as(c_int, @bitCast(@as(c_uint, ar.Error.ErrCode))) == JSStreamNotFoundErr) {
            ...
            s = nats_setErrorReal("./src/submodules/nats.c/src/jsm.c", "_unmarshalNamesListResp", @as(c_int, 2399), @as(c_uint, @bitCast(NATS_ERR)), "%s", ar.Error.Description);
        }
    } else {
        var names: [*c][*c]u8 = null;
        _ = &names;
        var namesLen: c_int = 0;
        _ = &namesLen;
        if (s == @as(c_uint, @bitCast(NATS_OK))) {
            s = nats_JSONGetLong(json, "total", &page.*.total);
        }
        ...
        if (s == @as(c_uint, @bitCast(NATS_OK))) {
            s = nats_JSONGetArrayStr(json, fieldName, &names, &namesLen);
        }
        if ((s == @as(c_uint, @bitCast(NATS_OK))) and (names != @as([*c][*c]u8, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0)))))))) {
            var i: c_int = undefined;
            _ = &i;
            {
                i = 0;
                while ((s == @as(c_uint, @bitCast(NATS_OK))) and (i < namesLen)) : (i += 1) {
                    s = natsStrHash_SetEx(m, (blk: {
                        const tmp = i;
                        if (tmp >= 0) break :blk names + @as(usize, @intCast(tmp)) else break :blk names - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
                    }).*, @as(c_int, 1) != 0, (if (@as(c_int, 1) != 0) @as(c_int, 1) else @as(c_int, 0)) != 0, @as(?*anyopaque, @ptrFromInt(@as(c_int, 0))), null);
                }
            }
            {
                i = 0;
                while (i < namesLen) : (i += 1) {
                    free(@as(?*anyopaque, @ptrCast((blk: {
                        const tmp = i;
                        if (tmp >= 0) break :blk names + @as(usize, @intCast(tmp)) else break :blk names - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
                    }).*)));
            ...
            free(@as(?*anyopaque, @ptrCast(names)));
        }
    }
    js_freeApiRespContent(&ar);
    nats_JSONDestroy(json);
    return if (s == @as(c_uint, @bitCast(NATS_OK))) s else nats_updateErrStack(s, "_unmarshalNamesListResp");
}
pub fn _unmarshalAccLimits(arg_json: [*c]nats_JSON, arg_limits: [*c]jsAccountLimits) callconv(.c) natsStatus {
    var json = arg_json;
    _ = &json;
    var limits = arg_limits;
    _ = &limits;
    ...
    if (obj == @as([*c]nats_JSON, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) return if (s == @as(c_uint, @bitCast(NATS_OK))) s else nats_updateErrStack(s, "_unmarshalAccLimits");
    if (s == @as(c_uint, @bitCast(NATS_OK))) {
        s = nats_JSONGetLong(obj, "max_memory", &limits.*.MaxMemory);
    }
    if (s == @as(c_uint, @bitCast(NATS_OK))) {
        s = nats_JSONGetLong(obj, "max_storage", &limits.*.MaxStore);
    }
    if (s == @as(c_uint, @bitCast(NATS_OK))) {
        s = nats_JSONGetLong(obj, "max_streams", &limits.*.MaxStreams);
    }
    if (s == @as(c_uint, @bitCast(NATS_OK))) {
        s = nats_JSONGetLong(obj, "max_consumers", &limits.*.MaxConsumers);
    }
    if (s == @as(c_uint, @bitCast(NATS_OK))) {
        s = nats_JSONGetLong(obj, "max_ack_pending", &limits.*.MaxAckPending);
    }
    if (s == @as(c_uint, @bitCast(NATS_OK))) {
        s = nats_JSONGetLong(obj, "memory_max_stream_bytes", &limits.*.MemoryMaxStreamBytes);
    }
    if (s == @as(c_uint, @bitCast(NATS_OK))) {
        s = nats_JSONGetLong(obj, "storage_max_stream_bytes", &limits.*.StoreMaxStreamBytes);
    }
    if (s == @as(c_uint, @bitCast(NATS_OK))) {
        s = nats_JSONGetBool(obj, "max_bytes_required", &limits.*.MaxBytesRequired);
    }
    return if (s == @as(c_uint, @bitCast(NATS_OK))) s else nats_updateErrStack(s, "_unmarshalAccLimits");
}
pub fn _fillTier(arg_userInfo: ?*anyopaque, arg_subject: [*c]const u8, arg_f: [*c]nats_JSONField) callconv(.c) natsStatus {
    var userInfo = arg_userInfo;
    _ = &userInfo;
    var subject = arg_subject;
    _ = &subject;
    var f = arg_f;
    _ = &f;
    var ai: [*c]jsAccountInfo = @as([*c]jsAccountInfo, @ptrCast(@alignCast(userInfo)));
    _ = &ai;
    var s: natsStatus = @as(c_uint, @bitCast(NATS_OK));
    _ = &s;
    var t: [*c]jsTier = null;
    _ = &t;
    var json: [*c]nats_JSON = f.*.value.vobj;
    _ = &json;
    t = @as([*c]jsTier, @ptrCast(@alignCast(calloc(@as(c_ulong, @bitCast(@as(c_long, @as(c_int, 1)))), @sizeOf(jsTier)))));
    if (t == @as([*c]jsTier, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) return nats_setErrorReal("./src/submodules/nats.c/src/jsm.c", "_fillTier", @as(c_int, 2604), @as(c_uint, @bitCast(NATS_NO_MEMORY)), "%s", natsStatus_GetText(@as(c_uint, @bitCast(NATS_NO_MEMORY))));
    (blk: {
        const tmp = blk_1: {
            const ref = &ai.*.TiersLen;
            const tmp_2 = ref.*;
            ref.* += 1;
            break :blk_1 tmp_2;
        };
    ...
    {
        t.*.Name = strdup(subject);
        if (t.*.Name == @as([*c]const u8, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) {
            s = nats_setErrorReal("./src/submodules/nats.c/src/jsm.c", "_fillTier", @as(c_int, 2608), @as(c_uint, @bitCast(NATS_NO_MEMORY)), "%s", natsStatus_GetText(@as(c_uint, @bitCast(NATS_NO_MEMORY))));
        }
    }
    if (s == @as(c_uint, @bitCast(NATS_OK))) {
        s = nats_JSONGetULong(json, "memory", &t.*.Memory);
    }
    if (s == @as(c_uint, @bitCast(NATS_OK))) {
        s = nats_JSONGetULong(json, "storage", &t.*.Store);
    }
    if (s == @as(c_uint, @bitCast(NATS_OK))) {
        s = nats_JSONGetLong(json, "streams", &t.*.Streams);
    }
    if (s == @as(c_uint, @bitCast(NATS_OK))) {
        s = nats_JSONGetLong(json, "consumers", &t.*.Consumers);
    }
    if (s == @as(c_uint, @bitCast(NATS_OK))) {
        s = _unmarshalAccLimits(json, &t.*.Limits);
    }
    return if (s == @as(c_uint, @bitCast(NATS_OK))) s else nats_updateErrStack(s, "_fillTier");
}
pub fn _unmarshalAccTiers(arg_json: [*c]nats_JSON, arg_ai: [*c]jsAccountInfo) callconv(.c) natsStatus {
    var json = arg_json;
    _ = &json;
    var ai = arg_ai;
    _ = &ai;
    ...
    if (obj == @as([*c]nats_JSON, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) return if (s == @as(c_uint, @bitCast(NATS_OK))) s else nats_updateErrStack(s, "_unmarshalAccTiers");
    n = obj.*.fields.*.used;
    if (n == @as(c_int, 0)) return @as(c_uint, @bitCast(NATS_OK));
    ai.*.Tiers = @as([*c][*c]jsTier, @ptrCast(@alignCast(calloc(@as(c_ulong, @bitCast(@as(c_long, n))), @sizeOf([*c]jsTier)))));
    if (ai.*.Tiers == @as([*c][*c]jsTier, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) return nats_setErrorReal("./src/submodules/nats.c/src/jsm.c", "_unmarshalAccTiers", @as(c_int, 2635), @as(c_uint, @bitCast(NATS_NO_MEMORY)), "%s", natsStatus_GetText(@as(c_uint, @bitCast(NATS_NO_MEMORY))));
    s = nats_JSONRange(obj, @as(c_int, 8), @as(c_int, 0), &_fillTier, @as(?*anyopaque, @ptrCast(ai)));
    return if (s == @as(c_uint, @bitCast(NATS_OK))) s else nats_updateErrStack(s, "_unmarshalAccTiers");
}
pub fn _unmarshalAccountInfoResp(arg_new_ai: [*c][*c]jsAccountInfo, arg_resp: [*c]natsMsg, arg_errCode: [*c]jsErrCode) callconv(.c) natsStatus {
    var new_ai = arg_new_ai;
    _ = &new_ai;
    var resp = arg_resp;
    _ = &resp;
    ...
    _ = &s;
    s = js_unmarshalResponse(&ar, &json, resp);
    if (s != @as(c_uint, @bitCast(NATS_OK))) return if (s == @as(c_uint, @bitCast(NATS_OK))) s else nats_updateErrStack(s, "_unmarshalAccountInfoResp");
    if (((&ar).*.Error.Code != @as(c_int, 0)) or (@as(c_int, @bitCast(@as(c_uint, (&ar).*.Error.ErrCode))) != @as(c_int, 0))) {
        if (errCode != @as([*c]jsErrCode, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) {
            errCode.* = @as(c_uint, @bitCast(@as(c_int, @bitCast(@as(c_uint, ar.Error.ErrCode)))));
        }
        s = nats_setErrorReal("./src/submodules/nats.c/src/jsm.c", "_unmarshalAccountInfoResp", @as(c_int, 2690), @as(c_uint, @bitCast(NATS_ERR)), "%s", ar.Error.Description);
    } else {
        s = js_unmarshalAccountInfo(json, new_ai);
    }
    js_freeApiRespContent(&ar);
    nats_JSONDestroy(json);
    return if (s == @as(c_uint, @bitCast(NATS_OK))) s else nats_updateErrStack(s, "_unmarshalAccountInfoResp");
}
pub fn _marshalDeliverPolicy(arg_buf: [*c]natsBuffer, arg_p: jsDeliverPolicy) callconv(.c) natsStatus {
    var buf = arg_buf;
    _ = &buf;
    var p = arg_p;
    _ = &p;
    ...
    var dp: [*c]const u8 = null;
    _ = &dp;
    s = natsBuf_Append(buf, "\"deliver_policy\":\"", -@as(c_int, 1));
    while (true) {
        switch (p) {
            @as(c_uint, @bitCast(@as(c_int, 0))) => {
                dp = "all";
            ...
            else => return nats_setErrorReal("./src/submodules/nats.c/src/jsm.c", "_marshalDeliverPolicy", @as(c_int, 2820), @as(c_uint, @bitCast(NATS_INVALID_ARG)), "invalid deliver policy %d", @as(c_int, @bitCast(p))),
        }
        break;
    }
    if (s == @as(c_uint, @bitCast(NATS_OK))) {
    ...
    return if (s == @as(c_uint, @bitCast(NATS_OK))) s else nats_updateErrStack(s, "_marshalDeliverPolicy");
}
pub fn _marshalAckPolicy(arg_buf: [*c]natsBuffer, arg_p: jsAckPolicy) callconv(.c) natsStatus {
    var buf = arg_buf;
    _ = &buf;
    var p = arg_p;
    _ = &p;
    var s: natsStatus = undefined;
    _ = &s;
    var ap: [*c]const u8 = undefined;
    _ = &ap;
    s = natsBuf_Append(buf, ",\"ack_policy\":\"", -@as(c_int, 1));
    while (true) {
        switch (p) {
            @as(c_uint, @bitCast(@as(c_int, 1))) => {
                ap = "none";
            ...
            else => return nats_setErrorReal("./src/submodules/nats.c/src/jsm.c", "_marshalAckPolicy", @as(c_int, 2841), @as(c_uint, @bitCast(NATS_INVALID_ARG)), "invalid ack policy %d", @as(c_int, @bitCast(p))),
        }
        break;
    }
    if (s == @as(c_uint, @bitCast(NATS_OK))) {
        s = natsBuf_Append(buf, ap, -@as(c_int, 1));
    }
    if (s == @as(c_uint, @bitCast(NATS_OK))) {
        s = natsBuf_AppendByte(buf, @as(u8, @bitCast(@as(i8, @truncate(@as(c_int, '"'))))));
    }
    return if (s == @as(c_uint, @bitCast(NATS_OK))) s else nats_updateErrStack(s, "_marshalAckPolicy");
}
pub fn _marshalReplayPolicy(arg_buf: [*c]natsBuffer, arg_p: jsReplayPolicy) callconv(.c) natsStatus {
    var buf = arg_buf;
    _ = &buf;
    var p = arg_p;
    _ = &p;
    ...
    var rp: [*c]const u8 = null;
    _ = &rp;
    s = natsBuf_Append(buf, ",\"replay_policy\":\"", -@as(c_int, 1));
    while (true) {
        switch (p) {
            @as(c_uint, @bitCast(@as(c_int, 1))) => {
                rp = "original";
            ...
            else => return nats_setErrorReal("./src/submodules/nats.c/src/jsm.c", "_marshalReplayPolicy", @as(c_int, 2861), @as(c_uint, @bitCast(NATS_INVALID_ARG)), "invalid replay policy %d", @as(c_int, @bitCast(p))),
        }
        break;
    }
    if (s == @as(c_uint, @bitCast(NATS_OK))) {
    ...
    return if (s == @as(c_uint, @bitCast(NATS_OK))) s else nats_updateErrStack(s, "_marshalReplayPolicy");
}
pub fn _marshalConsumerCreateReq(arg_new_buf: [*c][*c]natsBuffer, arg_stream: [*c]const u8, arg_cfg: [*c]jsConsumerConfig) callconv(.c) natsStatus {
    var new_buf = arg_new_buf;
    _ = &new_buf;
    var stream = arg_stream;
    _ = &stream;
    ...
    var buf: [*c]natsBuffer = null;
    _ = &buf;
    if (@as(c_int, @bitCast(cfg.*.DeliverPolicy)) < @as(c_int, 0)) {
        cfg.*.DeliverPolicy = @as(c_uint, @bitCast(js_DeliverAll));
    }
    if (@as(c_int, @bitCast(cfg.*.AckPolicy)) < @as(c_int, 0)) {
        cfg.*.AckPolicy = @as(c_uint, @bitCast(js_AckExplicit));
    }
    if (@as(c_int, @bitCast(cfg.*.ReplayPolicy)) < @as(c_int, 0)) {
        cfg.*.ReplayPolicy = @as(c_uint, @bitCast(js_ReplayInstant));
    }
    s = natsBuf_Create(&buf, @as(c_int, 256));
    if (s == @as(c_uint, @bitCast(NATS_OK))) {
        s = natsBuf_Append(buf, "{\"stream_name\":\"", -@as(c_int, 1));
    }
    if (s == @as(c_uint, @bitCast(NATS_OK))) {
        s = natsBuf_Append(buf, stream, -@as(c_int, 1));
    }
    if (s == @as(c_uint, @bitCast(NATS_OK))) {
        s = natsBuf_Append(buf, "\",\"config\":{", -@as(c_int, 1));
    }
    if (s == @as(c_uint, @bitCast(NATS_OK))) {
        s = _marshalDeliverPolicy(buf, cfg.*.DeliverPolicy);
    }
    if ((s == @as(c_uint, @bitCast(NATS_OK))) and !((if ((cfg.*.Name == @as([*c]const u8, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) or (@as(c_int, @bitCast(@as(c_uint, cfg.*.Name[@as(c_uint, @intCast(@as(c_int, 0)))]))) == @as(c_int, '\x00'))) @as(c_int, 1) else @as(c_int, 0)) != 0)) {
        s = natsBuf_Append(buf, ",\"name\":\"", -@as(c_int, 1));
        if (s == @as(c_uint, @bitCast(NATS_OK))) {
            s = natsBuf_Append(buf, cfg.*.Name, -@as(c_int, 1));
        }
    ...
    if ((s == @as(c_uint, @bitCast(NATS_OK))) and !((if ((cfg.*.Durable == @as([*c]const u8, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) or (@as(c_int, @bitCast(@as(c_uint, cfg.*.Durable[@as(c_uint, @intCast(@as(c_int, 0)))]))) == @as(c_int, '\x00'))) @as(c_int, 1) else @as(c_int, 0)) != 0)) {
        s = natsBuf_Append(buf, ",\"durable_name\":\"", -@as(c_int, 1));
        if (s == @as(c_uint, @bitCast(NATS_OK))) {
            s = natsBuf_Append(buf, cfg.*.Durable, -@as(c_int, 1));
        }
        if (s == @as(c_uint, @bitCast(NATS_OK))) {
            s = natsBuf_AppendByte(buf, @as(u8, @bitCast(@as(i8, @truncate(@as(c_int, '"'))))));
        }
    }
    if ((s == @as(c_uint, @bitCast(NATS_OK))) and !((if ((cfg.*.DeliverSubject == @as([*c]const u8, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) or (@as(c_int, @bitCast(@as(c_uint, cfg.*.DeliverSubject[@as(c_uint, @intCast(@as(c_int, 0)))]))) == @as(c_int, '\x00'))) @as(c_int, 1) else @as(c_int, 0)) != 0)) {
        s = natsBuf_Append(buf, ",\"deliver_subject\":\"", -@as(c_int, 1));
        if (s == @as(c_uint, @bitCast(NATS_OK))) {
            s = natsBuf_Append(buf, cfg.*.DeliverSubject, -@as(c_int, 1));
        }
        if (s == @as(c_uint, @bitCast(NATS_OK))) {
            s = natsBuf_AppendByte(buf, @as(u8, @bitCast(@as(i8, @truncate(@as(c_int, '"'))))));
        }
    }
    if ((s == @as(c_uint, @bitCast(NATS_OK))) and !((if ((cfg.*.DeliverGroup == @as([*c]const u8, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) or (@as(c_int, @bitCast(@as(c_uint, cfg.*.DeliverGroup[@as(c_uint, @intCast(@as(c_int, 0)))]))) == @as(c_int, '\x00'))) @as(c_int, 1) else @as(c_int, 0)) != 0)) {
        s = natsBuf_Append(buf, ",\"deliver_group\":\"", -@as(c_int, 1));
        if (s == @as(c_uint, @bitCast(NATS_OK))) {
            s = natsBuf_Append(buf, cfg.*.DeliverGroup, -@as(c_int, 1));
        }
        if (s == @as(c_uint, @bitCast(NATS_OK))) {
            s = natsBuf_AppendByte(buf, @as(u8, @bitCast(@as(i8, @truncate(@as(c_int, '"'))))));
        }
    }
    if ((s == @as(c_uint, @bitCast(NATS_OK))) and (cfg.*.OptStartSeq > @as(u64, @bitCast(@as(c_long, @as(c_int, 0)))))) {
        s = nats_marshalLong(buf, @as(c_int, 1) != 0, "opt_start_seq", @as(i64, @bitCast(cfg.*.OptStartSeq)));
    }
    if ((s == @as(c_uint, @bitCast(NATS_OK))) and (cfg.*.OptStartTime > @as(i64, @bitCast(@as(c_long, @as(c_int, 0)))))) {
        s = _marshalTimeUTC(buf, @as(c_int, 1) != 0, "opt_start_time", cfg.*.OptStartTime);
    }
    if (s == @as(c_uint, @bitCast(NATS_OK))) {
        s = _marshalAckPolicy(buf, cfg.*.AckPolicy);
    }
    if ((s == @as(c_uint, @bitCast(NATS_OK))) and (cfg.*.AckWait > @as(i64, @bitCast(@as(c_long, @as(c_int, 0)))))) {
        s = nats_marshalLong(buf, @as(c_int, 1) != 0, "ack_wait", cfg.*.AckWait);
    }
    if ((s == @as(c_uint, @bitCast(NATS_OK))) and (cfg.*.MaxDeliver > @as(i64, @bitCast(@as(c_long, @as(c_int, 0)))))) {
        s = nats_marshalLong(buf, @as(c_int, 1) != 0, "max_deliver", cfg.*.MaxDeliver);
    }
    if ((s == @as(c_uint, @bitCast(NATS_OK))) and !((if ((cfg.*.FilterSubject == @as([*c]const u8, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) or (@as(c_int, @bitCast(@as(c_uint, cfg.*.FilterSubject[@as(c_uint, @intCast(@as(c_int, 0)))]))) == @as(c_int, '\x00'))) @as(c_int, 1) else @as(c_int, 0)) != 0)) {
        s = natsBuf_Append(buf, ",\"filter_subject\":\"", -@as(c_int, 1));
        if (s == @as(c_uint, @bitCast(NATS_OK))) {
            s = natsBuf_Append(buf, cfg.*.FilterSubject, -@as(c_int, 1));
        }
        if (s == @as(c_uint, @bitCast(NATS_OK))) {
            s = natsBuf_AppendByte(buf, @as(u8, @bitCast(@as(i8, @truncate(@as(c_int, '"'))))));
        }
    }
    if ((s == @as(c_uint, @bitCast(NATS_OK))) and (cfg.*.FilterSubjectsLen > @as(c_int, 0))) {
        var i: c_int = undefined;
        _ = &i;
        s = natsBuf_Append(buf, ",\"filter_subjects\":[", -@as(c_int, 1));
        {
            i = 0;
            while ((s == @as(c_uint, @bitCast(NATS_OK))) and (i < cfg.*.FilterSubjectsLen)) : (i += 1) {
                if (i > @as(c_int, 0)) {
                    s = natsBuf_AppendByte(buf, @as(u8, @bitCast(@as(i8, @truncate(@as(c_int, ','))))));
                }
                if (s == @as(c_uint, @bitCast(NATS_OK))) {
                ...
                if (s == @as(c_uint, @bitCast(NATS_OK))) {
                    s = natsBuf_Append(buf, (blk: {
                        const tmp = i;
                        if (tmp >= 0) break :blk cfg.*.FilterSubjects + @as(usize, @intCast(tmp)) else break :blk cfg.*.FilterSubjects - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
                    }).*, -@as(c_int, 1));
                }
                if (s == @as(c_uint, @bitCast(NATS_OK))) {
                    s = natsBuf_AppendByte(buf, @as(u8, @bitCast(@as(i8, @truncate(@as(c_int, '"'))))));
    ...
    if ((s == @as(c_uint, @bitCast(NATS_OK))) and (cfg.*.PauseUntil > @as(i64, @bitCast(@as(c_long, @as(c_int, 0)))))) {
        s = _marshalTimeUTC(buf, @as(c_int, 1) != 0, "pause_until", cfg.*.PauseUntil);
    }
    if (s == @as(c_uint, @bitCast(NATS_OK))) {
        s = _marshalReplayPolicy(buf, cfg.*.ReplayPolicy);
    }
    if ((s == @as(c_uint, @bitCast(NATS_OK))) and (cfg.*.RateLimit > @as(u64, @bitCast(@as(c_long, @as(c_int, 0)))))) {
        s = nats_marshalULong(buf, @as(c_int, 1) != 0, "rate_limit_bps", cfg.*.RateLimit);
    }
    if ((s == @as(c_uint, @bitCast(NATS_OK))) and !((if ((cfg.*.SampleFrequency == @as([*c]const u8, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) or (@as(c_int, @bitCast(@as(c_uint, cfg.*.SampleFrequency[@as(c_uint, @intCast(@as(c_int, 0)))]))) == @as(c_int, '\x00'))) @as(c_int, 1) else @as(c_int, 0)) != 0)) {
        s = natsBuf_Append(buf, ",\"sample_freq\":\"", -@as(c_int, 1));
        if (s == @as(c_uint, @bitCast(NATS_OK))) {
            s = natsBuf_Append(buf, cfg.*.SampleFrequency, -@as(c_int, 1));
        }
        if (s == @as(c_uint, @bitCast(NATS_OK))) {
            s = natsBuf_AppendByte(buf, @as(u8, @bitCast(@as(i8, @truncate(@as(c_int, '"'))))));
        }
    }
    if ((s == @as(c_uint, @bitCast(NATS_OK))) and (cfg.*.MaxWaiting > @as(i64, @bitCast(@as(c_long, @as(c_int, 0)))))) {
        s = nats_marshalLong(buf, @as(c_int, 1) != 0, "max_waiting", cfg.*.MaxWaiting);
    }
    if ((s == @as(c_uint, @bitCast(NATS_OK))) and (cfg.*.MaxAckPending > @as(i64, @bitCast(@as(c_long, @as(c_int, 0)))))) {
        s = nats_marshalLong(buf, @as(c_int, 1) != 0, "max_ack_pending", cfg.*.MaxAckPending);
    }
    if ((s == @as(c_uint, @bitCast(NATS_OK))) and (@as(c_int, @intFromBool(cfg.*.FlowControl)) != 0)) {
        s = natsBuf_Append(buf, ",\"flow_control\":true", -@as(c_int, 1));
    }
    if ((s == @as(c_uint, @bitCast(NATS_OK))) and (cfg.*.Heartbeat > @as(i64, @bitCast(@as(c_long, @as(c_int, 0)))))) {
        s = nats_marshalLong(buf, @as(c_int, 1) != 0, "idle_heartbeat", cfg.*.Heartbeat);
    }
    if ((s == @as(c_uint, @bitCast(NATS_OK))) and (@as(c_int, @intFromBool(cfg.*.HeadersOnly)) != 0)) {
        s = natsBuf_Append(buf, ",\"headers_only\":true", -@as(c_int, 1));
    }
    if ((s == @as(c_uint, @bitCast(NATS_OK))) and (cfg.*.MaxRequestBatch > @as(i64, @bitCast(@as(c_long, @as(c_int, 0)))))) {
        s = nats_marshalLong(buf, @as(c_int, 1) != 0, "max_batch", cfg.*.MaxRequestBatch);
    }
    if ((s == @as(c_uint, @bitCast(NATS_OK))) and (cfg.*.MaxRequestExpires > @as(i64, @bitCast(@as(c_long, @as(c_int, 0)))))) {
        s = nats_marshalLong(buf, @as(c_int, 1) != 0, "max_expires", cfg.*.MaxRequestExpires);
    }
    if ((s == @as(c_uint, @bitCast(NATS_OK))) and (cfg.*.MaxRequestMaxBytes > @as(i64, @bitCast(@as(c_long, @as(c_int, 0)))))) {
        s = nats_marshalLong(buf, @as(c_int, 1) != 0, "max_bytes", cfg.*.MaxRequestMaxBytes);
    }
    if ((s == @as(c_uint, @bitCast(NATS_OK))) and (cfg.*.InactiveThreshold > @as(i64, @bitCast(@as(c_long, @as(c_int, 0)))))) {
        s = nats_marshalLong(buf, @as(c_int, 1) != 0, "inactive_threshold", cfg.*.InactiveThreshold);
    }
    if (((s == @as(c_uint, @bitCast(NATS_OK))) and (cfg.*.BackOff != @as([*c]i64, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0)))))))) and (cfg.*.BackOffLen > @as(c_int, 0))) {
        var tmp: [32]u8 = undefined;
        _ = &tmp;
        var i: c_int = undefined;
        _ = &i;
        s = natsBuf_Append(buf, ",\"backoff\":[", -@as(c_int, 1));
        {
            i = 0;
            while ((s == @as(c_uint, @bitCast(NATS_OK))) and (i < cfg.*.BackOffLen)) : (i += 1) {
                _ = snprintf(@as([*c]u8, @ptrCast(@alignCast(&tmp))), @sizeOf([32]u8), "%ld", (blk: {
                    const tmp_1 = i;
                    if (tmp_1 >= 0) break :blk cfg.*.BackOff + @as(usize, @intCast(tmp_1)) else break :blk cfg.*.BackOff - ~@as(usize, @bitCast(@as(isize, @intCast(tmp_1)) +% -1));
                }).*);
                if (i > @as(c_int, 0)) {
                    s = natsBuf_AppendByte(buf, @as(u8, @bitCast(@as(i8, @truncate(@as(c_int, ','))))));
                }
                if (s == @as(c_uint, @bitCast(NATS_OK))) {
                    s = natsBuf_Append(buf, @as([*c]u8, @ptrCast(@alignCast(&tmp))), -@as(c_int, 1));
                }
            }
        }
        if (s == @as(c_uint, @bitCast(NATS_OK))) {
    ...
    if ((s == @as(c_uint, @bitCast(NATS_OK))) and (cfg.*.Replicas > @as(i64, @bitCast(@as(c_long, @as(c_int, 0)))))) {
        s = nats_marshalLong(buf, @as(c_int, 1) != 0, "num_replicas", cfg.*.Replicas);
    }
    if ((s == @as(c_uint, @bitCast(NATS_OK))) and (@as(c_int, @intFromBool(cfg.*.MemoryStorage)) != 0)) {
        s = natsBuf_Append(buf, ",\"mem_storage\":true", -@as(c_int, 1));
    }
    if (s == @as(c_uint, @bitCast(NATS_OK))) {
        s = natsBuf_Append(buf, "}}", -@as(c_int, 1));
    }
    ...
    return if (s == @as(c_uint, @bitCast(NATS_OK))) s else nats_updateErrStack(s, "_marshalConsumerCreateReq");
}
pub fn _unmarshalDeliverPolicy(arg_json: [*c]nats_JSON, arg_fieldName: [*c]const u8, arg_dp: [*c]jsDeliverPolicy) callconv(.c) natsStatus {
    var json = arg_json;
    _ = &json;
    var fieldName = arg_fieldName;
    _ = &fieldName;
    ...
    _ = &str;
    s = nats_JSONGetStr(json, fieldName, &str);
    if (str == @as([*c]u8, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) return if (s == @as(c_uint, @bitCast(NATS_OK))) s else nats_updateErrStack(s, "_unmarshalDeliverPolicy");
    if (strcmp(str, "all") == @as(c_int, 0)) {
        dp.* = @as(c_uint, @bitCast(js_DeliverAll));
    } else if (strcmp(str, "last") == @as(c_int, 0)) {
        dp.* = @as(c_uint, @bitCast(js_DeliverLast));
    } else if (strcmp(str, "new") == @as(c_int, 0)) {
        dp.* = @as(c_uint, @bitCast(js_DeliverNew));
    } else if (strcmp(str, "by_start_sequence") == @as(c_int, 0)) {
        dp.* = @as(c_uint, @bitCast(js_DeliverByStartSequence));
    } else if (strcmp(str, "by_start_time") == @as(c_int, 0)) {
        dp.* = @as(c_uint, @bitCast(js_DeliverByStartTime));
    } else if (strcmp(str, "last_per_subject") == @as(c_int, 0)) {
        dp.* = @as(c_uint, @bitCast(js_DeliverLastPerSubject));
    } else {
        s = nats_setErrorReal("./src/submodules/nats.c/src/jsm.c", "_unmarshalDeliverPolicy", @as(c_int, 3056), @as(c_uint, @bitCast(NATS_ERR)), "unable to unmarshal delivery policy '%s'", str);
    }
    free(@as(?*anyopaque, @ptrCast(str)));
    return if (s == @as(c_uint, @bitCast(NATS_OK))) s else nats_updateErrStack(s, "_unmarshalDeliverPolicy");
}
pub fn _unmarshalAckPolicy(arg_json: [*c]nats_JSON, arg_fieldName: [*c]const u8, arg_ap: [*c]jsAckPolicy) callconv(.c) natsStatus {
    var json = arg_json;
    _ = &json;
    var fieldName = arg_fieldName;
    _ = &fieldName;
    ...
    _ = &str;
    s = nats_JSONGetStr(json, fieldName, &str);
    if (str == @as([*c]u8, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) return if (s == @as(c_uint, @bitCast(NATS_OK))) s else nats_updateErrStack(s, "_unmarshalAckPolicy");
    if (strcmp(str, "none") == @as(c_int, 0)) {
        ap.* = @as(c_uint, @bitCast(js_AckNone));
    } else if (strcmp(str, "all") == @as(c_int, 0)) {
        ap.* = @as(c_uint, @bitCast(js_AckAll));
    } else if (strcmp(str, "explicit") == @as(c_int, 0)) {
        ap.* = @as(c_uint, @bitCast(js_AckExplicit));
    } else {
        s = nats_setErrorReal("./src/submodules/nats.c/src/jsm.c", "_unmarshalAckPolicy", @as(c_int, 3080), @as(c_uint, @bitCast(NATS_ERR)), "unable to unmarshal ack policy '%s'", str);
    }
    free(@as(?*anyopaque, @ptrCast(str)));
    return if (s == @as(c_uint, @bitCast(NATS_OK))) s else nats_updateErrStack(s, "_unmarshalAckPolicy");
}
pub fn _unmarshalReplayPolicy(arg_json: [*c]nats_JSON, arg_fieldName: [*c]const u8, arg_rp: [*c]jsReplayPolicy) callconv(.c) natsStatus {
    var json = arg_json;
    _ = &json;
    var fieldName = arg_fieldName;
    _ = &fieldName;
    ...
    _ = &str;
    s = nats_JSONGetStr(json, fieldName, &str);
    if (str == @as([*c]u8, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) return if (s == @as(c_uint, @bitCast(NATS_OK))) s else nats_updateErrStack(s, "_unmarshalReplayPolicy");
    if (strcmp(str, "original") == @as(c_int, 0)) {
        rp.* = @as(c_uint, @bitCast(js_ReplayOriginal));
    } else if (strcmp(str, "instant") == @as(c_int, 0)) {
        rp.* = @as(c_uint, @bitCast(js_ReplayInstant));
    } else {
        s = nats_setErrorReal("./src/submodules/nats.c/src/jsm.c", "_unmarshalReplayPolicy", @as(c_int, 3102), @as(c_uint, @bitCast(NATS_ERR)), "unable to unmarshal replay policy '%s'", str);
    }
    free(@as(?*anyopaque, @ptrCast(str)));
    return if (s == @as(c_uint, @bitCast(NATS_OK))) s else nats_updateErrStack(s, "_unmarshalReplayPolicy");
}
pub fn _unmarshalConsumerConfig(arg_json: [*c]nats_JSON, arg_fieldName: [*c]const u8, arg_new_cc: [*c][*c]jsConsumerConfig) callconv(.c) natsStatus {
    var json = arg_json;
    _ = &json;
    var fieldName = arg_fieldName;
    _ = &fieldName;
    var new_cc = arg_new_cc;
    _ = &new_cc;
    var s: natsStatus = @as(c_uint, @bitCast(NATS_OK));
    _ = &s;
    var cc: [*c]jsConsumerConfig = null;
    _ = &cc;
    var cjson: [*c]nats_JSON = null;
    _ = &cjson;
    cc = @as([*c]jsConsumerConfig, @ptrCast(@alignCast(calloc(@as(c_ulong, @bitCast(@as(c_long, @as(c_int, 1)))), @sizeOf(jsConsumerConfig)))));
    if (cc == @as([*c]jsConsumerConfig, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) return nats_setErrorReal("./src/submodules/nats.c/src/jsm.c", "_unmarshalConsumerConfig", @as(c_int, 3118), @as(c_uint, @bitCast(NATS_NO_MEMORY)), "%s", natsStatus_GetText(@as(c_uint, @bitCast(NATS_NO_MEMORY))));
    s = nats_JSONGetObject(json, fieldName, &cjson);
    if ((s == @as(c_uint, @bitCast(NATS_OK))) and (cjson != @as([*c]nats_JSON, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0)))))))) {
        s = nats_JSONGetStr(cjson, "durable_name", @as([*c][*c]u8, @ptrCast(@alignCast(&cc.*.Durable))));
        if (s == @as(c_uint, @bitCast(NATS_OK))) {
            s = nats_JSONGetStr(cjson, "name", @as([*c][*c]u8, @ptrCast(@alignCast(&cc.*.Name))));
        }
        if (s == @as(c_uint, @bitCast(NATS_OK))) {
            s = nats_JSONGetStr(cjson, "description", @as([*c][*c]u8, @ptrCast(@alignCast(&cc.*.Description))));
        }
        if (s == @as(c_uint, @bitCast(NATS_OK))) {
            s = nats_JSONGetStr(cjson, "deliver_subject", @as([*c][*c]u8, @ptrCast(@alignCast(&cc.*.DeliverSubject))));
        }
        if (s == @as(c_uint, @bitCast(NATS_OK))) {
            s = nats_JSONGetStr(cjson, "deliver_group", @as([*c][*c]u8, @ptrCast(@alignCast(&cc.*.DeliverGroup))));
        }
        if (s == @as(c_uint, @bitCast(NATS_OK))) {
            s = _unmarshalDeliverPolicy(cjson, "deliver_policy", &cc.*.DeliverPolicy);
        }
        if (s == @as(c_uint, @bitCast(NATS_OK))) {
            s = nats_JSONGetULong(cjson, "opt_start_seq", &cc.*.OptStartSeq);
        }
        if (s == @as(c_uint, @bitCast(NATS_OK))) {
            s = nats_JSONGetTime(cjson, "opt_start_time", &cc.*.OptStartTime);
        }
        if (s == @as(c_uint, @bitCast(NATS_OK))) {
            s = _unmarshalAckPolicy(cjson, "ack_policy", &cc.*.AckPolicy);
        }
        if (s == @as(c_uint, @bitCast(NATS_OK))) {
            s = nats_JSONGetLong(cjson, "ack_wait", &cc.*.AckWait);
        }
        if (s == @as(c_uint, @bitCast(NATS_OK))) {
            s = nats_JSONGetLong(cjson, "max_deliver", &cc.*.MaxDeliver);
        }
        if (s == @as(c_uint, @bitCast(NATS_OK))) {
            s = nats_JSONGetStr(cjson, "filter_subject", @as([*c][*c]u8, @ptrCast(@alignCast(&cc.*.FilterSubject))));
        }
        if (s == @as(c_uint, @bitCast(NATS_OK))) {
            s = nats_JSONGetArrayStr(cjson, "filter_subjects", @as([*c][*c][*c]u8, @ptrCast(@alignCast(&cc.*.FilterSubjects))), &cc.*.FilterSubjectsLen);
        }
        if (s == @as(c_uint, @bitCast(NATS_OK))) {
            s = _unmarshalReplayPolicy(cjson, "replay_policy", &cc.*.ReplayPolicy);
        }
        if (s == @as(c_uint, @bitCast(NATS_OK))) {
            s = nats_JSONGetULong(cjson, "rate_limit_bps", &cc.*.RateLimit);
        }
        if (s == @as(c_uint, @bitCast(NATS_OK))) {
            s = nats_JSONGetStr(cjson, "sample_freq", @as([*c][*c]u8, @ptrCast(@alignCast(&cc.*.SampleFrequency))));
        }
        if (s == @as(c_uint, @bitCast(NATS_OK))) {
            s = nats_JSONGetLong(cjson, "max_waiting", &cc.*.MaxWaiting);
        }
        if (s == @as(c_uint, @bitCast(NATS_OK))) {
            s = nats_JSONGetLong(cjson, "max_ack_pending", &cc.*.MaxAckPending);
        }
        if (s == @as(c_uint, @bitCast(NATS_OK))) {
            s = nats_JSONGetBool(cjson, "flow_control", &cc.*.FlowControl);
        }
        if (s == @as(c_uint, @bitCast(NATS_OK))) {
            s = nats_JSONGetLong(cjson, "idle_heartbeat", &cc.*.Heartbeat);
        }
        if (s == @as(c_uint, @bitCast(NATS_OK))) {
            s = nats_JSONGetBool(cjson, "headers_only", &cc.*.HeadersOnly);
        }
        if (s == @as(c_uint, @bitCast(NATS_OK))) {
            s = nats_JSONGetLong(cjson, "max_batch", &cc.*.MaxRequestBatch);
        }
        if (s == @as(c_uint, @bitCast(NATS_OK))) {
            s = nats_JSONGetLong(cjson, "max_expires", &cc.*.MaxRequestExpires);
        }
        if (s == @as(c_uint, @bitCast(NATS_OK))) {
            s = nats_JSONGetLong(cjson, "max_bytes", &cc.*.MaxRequestMaxBytes);
        }
        if (s == @as(c_uint, @bitCast(NATS_OK))) {
            s = nats_JSONGetLong(cjson, "inactive_threshold", &cc.*.InactiveThreshold);
        }
        if (s == @as(c_uint, @bitCast(NATS_OK))) {
            s = nats_JSONGetArrayLong(cjson, "backoff", &cc.*.BackOff, &cc.*.BackOffLen);
        }
        if (s == @as(c_uint, @bitCast(NATS_OK))) {
            s = nats_JSONGetLong(cjson, "num_replicas", &cc.*.Replicas);
        }
        if (s == @as(c_uint, @bitCast(NATS_OK))) {
            s = nats_JSONGetBool(cjson, "mem_storage", &cc.*.MemoryStorage);
        }
        if (s == @as(c_uint, @bitCast(NATS_OK))) {
            s = nats_unmarshalMetadata(cjson, "metadata", &cc.*.Metadata);
        }
    }
    if (s == @as(c_uint, @bitCast(NATS_OK))) {
        new_cc.* = cc;
    ...
    return if (s == @as(c_uint, @bitCast(NATS_OK))) s else nats_updateErrStack(s, "_unmarshalConsumerConfig");
}
pub fn _unmarshalSeqInfo(arg_json: [*c]nats_JSON, arg_fieldName: [*c]const u8, arg_si: [*c]jsSequenceInfo) callconv(.c) natsStatus {
    var json = arg_json;
    _ = &json;
    var fieldName = arg_fieldName;
    _ = &fieldName;
    ...
    var s: natsStatus = @as(c_uint, @bitCast(NATS_OK));
    _ = &s;
    var sij: [*c]nats_JSON = null;
    _ = &sij;
    s = nats_JSONGetObject(json, fieldName, &sij);
    if ((s == @as(c_uint, @bitCast(NATS_OK))) and (sij != @as([*c]nats_JSON, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0)))))))) {
        if (s == @as(c_uint, @bitCast(NATS_OK))) {
            s = nats_JSONGetULong(sij, "consumer_seq", &si.*.Consumer);
        }
        if (s == @as(c_uint, @bitCast(NATS_OK))) {
            s = nats_JSONGetULong(sij, "stream_seq", &si.*.Stream);
        }
        if (s == @as(c_uint, @bitCast(NATS_OK))) {
            s = nats_JSONGetTime(sij, "last_active", &si.*.Last);
        }
    }
    return if (s == @as(c_uint, @bitCast(NATS_OK))) s else nats_updateErrStack(s, "_unmarshalSeqInfo");
}
pub fn _unmarshalConsumerCreateOrGetResp(arg_new_ci: [*c][*c]jsConsumerInfo, arg_resp: [*c]natsMsg, arg_errCode: [*c]jsErrCode) callconv(.c) natsStatus {
    var new_ci = arg_new_ci;
    _ = &new_ci;
    var resp = arg_resp;
    _ = &resp;
    ...
    _ = &s;
    s = js_unmarshalResponse(&ar, &json, resp);
    if (s != @as(c_uint, @bitCast(NATS_OK))) return if (s == @as(c_uint, @bitCast(NATS_OK))) s else nats_updateErrStack(s, "_unmarshalConsumerCreateOrGetResp");
    if (((&ar).*.Error.Code != @as(c_int, 0)) or (@as(c_int, @bitCast(@as(c_uint, (&ar).*.Error.ErrCode))) != @as(c_int, 0))) {
        if (errCode != @as([*c]jsErrCode, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) {
            errCode.* = @as(c_uint, @bitCast(@as(c_int, @bitCast(@as(c_uint, ar.Error.ErrCode)))));
        }
        if (@as(c_int, @bitCast(@as(c_uint, ar.Error.ErrCode))) == JSConsumerNotFoundErr) {
            s = @as(c_uint, @bitCast(NATS_NOT_FOUND));
        } else {
            s = nats_setErrorReal("./src/submodules/nats.c/src/jsm.c", "_unmarshalConsumerCreateOrGetResp", @as(c_int, 3229), @as(c_uint, @bitCast(NATS_ERR)), "%s", ar.Error.Description);
        }
    } else if (new_ci != @as([*c][*c]jsConsumerInfo, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) {
        s = js_unmarshalConsumerInfo(json, new_ci);
    }
    js_freeApiRespContent(&ar);
    nats_JSONDestroy(json);
    return if (s == @as(c_uint, @bitCast(NATS_OK))) s else nats_updateErrStack(s, "_unmarshalConsumerCreateOrGetResp");
}
pub export fn js_unmarshalConsumerPauseResp(arg_json: [*c]nats_JSON, arg_new_cpr: [*c][*c]jsConsumerPauseResponse) natsStatus {
    var json = arg_json;
    _ = &json;
    var new_cpr = arg_new_cpr;
    _ = &new_cpr;
    var s: natsStatus = @as(c_uint, @bitCast(NATS_OK));
    _ = &s;
    var cpr: [*c]jsConsumerPauseResponse = null;
    _ = &cpr;
    cpr = @as([*c]jsConsumerPauseResponse, @ptrCast(@alignCast(calloc(@as(c_ulong, @bitCast(@as(c_long, @as(c_int, 1)))), @sizeOf(jsConsumerPauseResponse)))));
    if (cpr == @as([*c]jsConsumerPauseResponse, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) return nats_setErrorReal("./src/submodules/nats.c/src/jsm.c", "js_unmarshalConsumerPauseResp", @as(c_int, 3462), @as(c_uint, @bitCast(NATS_NO_MEMORY)), "%s", natsStatus_GetText(@as(c_uint, @bitCast(NATS_NO_MEMORY))));
    s = nats_JSONGetBool(json, "paused", &cpr.*.Paused);
    if (s == @as(c_uint, @bitCast(NATS_OK))) {
        s = nats_JSONGetTime(json, "pause_until", &cpr.*.PauseUntil);
    }
    if (s == @as(c_uint, @bitCast(NATS_OK))) {
        s = nats_JSONGetLong(json, "pause_remaining", &cpr.*.PauseRemaining);
    }
    if (s == @as(c_uint, @bitCast(NATS_OK))) {
        new_cpr.* = cpr;
    } else {
    ...
    return if (s == @as(c_uint, @bitCast(NATS_OK))) s else nats_updateErrStack(s, "js_unmarshalConsumerPauseResp");
}
pub fn _unmarshalConsumerPauseResp(arg_new_cpr: [*c][*c]jsConsumerPauseResponse, arg_resp: [*c]natsMsg, arg_errCode: [*c]jsErrCode) callconv(.c) natsStatus {
    var new_cpr = arg_new_cpr;
    _ = &new_cpr;
    var resp = arg_resp;
    _ = &resp;
    ...
    _ = &s;
    s = js_unmarshalResponse(&ar, &json, resp);
    if (s != @as(c_uint, @bitCast(NATS_OK))) return if (s == @as(c_uint, @bitCast(NATS_OK))) s else nats_updateErrStack(s, "_unmarshalConsumerPauseResp");
    if (((&ar).*.Error.Code != @as(c_int, 0)) or (@as(c_int, @bitCast(@as(c_uint, (&ar).*.Error.ErrCode))) != @as(c_int, 0))) {
        if (errCode != @as([*c]jsErrCode, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) {
            errCode.* = @as(c_uint, @bitCast(@as(c_int, @bitCast(@as(c_uint, ar.Error.ErrCode)))));
        }
        if (@as(c_int, @bitCast(@as(c_uint, ar.Error.ErrCode))) == JSConsumerNotFoundErr) {
            ...
            s = nats_setErrorReal("./src/submodules/nats.c/src/jsm.c", "_unmarshalConsumerPauseResp", @as(c_int, 3495), @as(c_uint, @bitCast(NATS_ERR)), "%s", ar.Error.Description);
        }
    } else if (new_cpr != @as([*c][*c]jsConsumerPauseResponse, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) {
        s = js_unmarshalConsumerPauseResp(json, new_cpr);
    }
    js_freeApiRespContent(&ar);
    nats_JSONDestroy(json);
    return if (s == @as(c_uint, @bitCast(NATS_OK))) s else nats_updateErrStack(s, "_unmarshalConsumerPauseResp");
}
pub fn _marshalConsumerPauseReq(arg_new_buf: [*c][*c]natsBuffer, arg_pauseUntil: u64) callconv(.c) natsStatus {
    var new_buf = arg_new_buf;
    _ = &new_buf;
    var pauseUntil = arg_pauseUntil;
    _ = &pauseUntil;
    ...
    if ((s == @as(c_uint, @bitCast(NATS_OK))) and (pauseUntil > @as(u64, @bitCast(@as(c_long, @as(c_int, 0)))))) {
        s = _marshalTimeUTC(buf, @as(c_int, 0) != 0, "pause_until", @as(i64, @bitCast(pauseUntil)));
    }
    if (s == @as(c_uint, @bitCast(NATS_OK))) {
        s = natsBuf_AppendByte(buf, @as(u8, @bitCast(@as(i8, @truncate(@as(c_int, '}'))))));
    }
    ...
    return if (s == @as(c_uint, @bitCast(NATS_OK))) s else nats_updateErrStack(s, "_marshalConsumerPauseReq");
}
pub fn _unmarshalConsumerInfoListResp(arg_m: [*c]natsStrHash, arg_page: [*c]apiPaged, arg_resp: [*c]natsMsg, arg_errCode: [*c]jsErrCode) callconv(.c) natsStatus {
    var m = arg_m;
    _ = &m;
    var page = arg_page;
    _ = &page;
    ...
    _ = &s;
    s = js_unmarshalResponse(&ar, &json, resp);
    if (s != @as(c_uint, @bitCast(NATS_OK))) return if (s == @as(c_uint, @bitCast(NATS_OK))) s else nats_updateErrStack(s, "_unmarshalConsumerInfoListResp");
    if (((&ar).*.Error.Code != @as(c_int, 0)) or (@as(c_int, @bitCast(@as(c_uint, (&ar).*.Error.ErrCode))) != @as(c_int, 0))) {
        if (errCode != @as([*c]jsErrCode, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) {
            errCode.* = @as(c_uint, @bitCast(@as(c_int, @bitCast(@as(c_uint, ar.Error.ErrCode)))));
        }
        if (@as(c_int, @bitCast(@as(c_uint, ar.Error.ErrCode))) == JSStreamNotFoundErr) {
            ...
            s = nats_setErrorReal("./src/submodules/nats.c/src/jsm.c", "_unmarshalConsumerInfoListResp", @as(c_int, 3644), @as(c_uint, @bitCast(NATS_ERR)), "%s", ar.Error.Description);
        }
    } else {
        var consumers: [*c][*c]nats_JSON = null;
        _ = &consumers;
        var consumersLen: c_int = 0;
        _ = &consumersLen;
        if (s == @as(c_uint, @bitCast(NATS_OK))) {
            s = nats_JSONGetLong(json, "total", &page.*.total);
        }
        ...
        if (s == @as(c_uint, @bitCast(NATS_OK))) {
            s = nats_JSONGetArrayObject(json, "consumers", &consumers, &consumersLen);
        }
        if ((s == @as(c_uint, @bitCast(NATS_OK))) and (consumers != @as([*c][*c]nats_JSON, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0)))))))) {
            var i: c_int = undefined;
            _ = &i;
            {
                i = 0;
                while ((s == @as(c_uint, @bitCast(NATS_OK))) and (i < consumersLen)) : (i += 1) {
                    var ci: [*c]jsConsumerInfo = null;
                    _ = &ci;
                    var oci: [*c]jsConsumerInfo = null;
                    _ = &oci;
                    s = js_unmarshalConsumerInfo((blk: {
                        const tmp = i;
                        if (tmp >= 0) break :blk consumers + @as(usize, @intCast(tmp)) else break :blk consumers - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
                    }).*, &ci);
                    if ((s == @as(c_uint, @bitCast(NATS_OK))) and ((ci.*.Config == @as([*c]jsConsumerConfig, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) or ((if ((ci.*.Name == @as([*c]u8, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) or (@as(c_int, @bitCast(@as(c_uint, ci.*.Name[@as(c_uint, @intCast(@as(c_int, 0)))]))) == @as(c_int, '\x00'))) @as(c_int, 1) else @as(c_int, 0)) != 0))) {
                        s = nats_setErrorReal("./src/submodules/nats.c/src/jsm.c", "_unmarshalConsumerInfoListResp", @as(c_int, 3666), @as(c_uint, @bitCast(NATS_ERR)), "%s", "consumer name missing");
                    }
                    if (s == @as(c_uint, @bitCast(NATS_OK))) {
                        s = natsStrHash_SetEx(m, ci.*.Name, @as(c_int, 1) != 0, @as(c_int, 1) != 0, @as(?*anyopaque, @ptrCast(ci)), @as([*c]?*anyopaque, @ptrCast(@alignCast(&oci))));
                    }
                    if (oci != @as([*c]jsConsumerInfo, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) {
                        jsConsumerInfo_Destroy(oci);
                    }
                }
            }
            free(@as(?*anyopaque, @ptrCast(consumers)));
        }
    }
    js_freeApiRespContent(&ar);
    nats_JSONDestroy(json);
    return if (s == @as(c_uint, @bitCast(NATS_OK))) s else nats_updateErrStack(s, "_unmarshalConsumerInfoListResp");
}
