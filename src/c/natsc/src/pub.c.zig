...
pub export fn natsConnection_Publish(arg_nc: [*c]natsConnection, arg_subj: [*c]const u8, arg_data: ?*const anyopaque, arg_dataLen: c_int) natsStatus {
    var nc = arg_nc;
    _ = &nc;
    var subj = arg_subj;
    _ = &subj;
    ...
    s = natsConn_publish(nc, &msg, null, @as(c_int, 0) != 0);
    return if (s == @as(c_uint, @bitCast(NATS_OK))) s else nats_updateErrStack(s, "natsConnection_Publish");
}
pub export fn natsConnection_PublishString(arg_nc: [*c]natsConnection, arg_subj: [*c]const u8, arg_str: [*c]const u8) natsStatus {
    var nc = arg_nc;
    _ = &nc;
    var subj = arg_subj;
    _ = &subj;
    ...
    if (str != @as([*c]const u8, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) {
        dataLen = @as(c_int, @bitCast(@as(c_uint, @truncate(strlen(str)))));
    }
    natsMsg_init(&msg, subj, str, dataLen);
    s = natsConn_publish(nc, &msg, null, @as(c_int, 0) != 0);
    return if (s == @as(c_uint, @bitCast(NATS_OK))) s else nats_updateErrStack(s, "natsConnection_PublishString");
}
pub export fn natsConnection_PublishMsg(arg_nc: [*c]natsConnection, arg_msg: [*c]natsMsg) natsStatus {
    var nc = arg_nc;
    _ = &nc;
    var msg = arg_msg;
    _ = &msg;
    var reply: [*c]const u8 = if (msg != @as([*c]natsMsg, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) msg.*.reply else null;
    _ = &reply;
    var s: natsStatus = undefined;
    _ = &s;
    s = natsConn_publish(nc, msg, reply, @as(c_int, 0) != 0);
    return if (s == @as(c_uint, @bitCast(NATS_OK))) s else nats_updateErrStack(s, "natsConnection_PublishMsg");
}
pub export fn natsConnection_PublishRequest(arg_nc: [*c]natsConnection, arg_subj: [*c]const u8, arg_reply: [*c]const u8, arg_data: ?*const anyopaque, arg_dataLen: c_int) natsStatus {
    var nc = arg_nc;
    _ = &nc;
    var subj = arg_subj;
    _ = &subj;
    ...
    var msg: natsMsg = undefined;
    _ = &msg;
    if ((reply == @as([*c]const u8, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) or (strlen(reply) == @as(c_ulong, @bitCast(@as(c_long, @as(c_int, 0)))))) return nats_setErrorReal("./src/submodules/nats.c/src/pub.c", "natsConnection_PublishRequest", @as(c_int, 302), @as(c_uint, @bitCast(NATS_INVALID_ARG)), "%s", natsStatus_GetText(@as(c_uint, @bitCast(NATS_INVALID_ARG))));
    natsMsg_init(&msg, subj, @as([*c]const u8, @ptrCast(@alignCast(data))), dataLen);
    s = natsConn_publish(nc, &msg, reply, @as(c_int, 0) != 0);
    return if (s == @as(c_uint, @bitCast(NATS_OK))) s else nats_updateErrStack(s, "natsConnection_PublishRequest");
}
pub export fn natsConnection_PublishRequestString(arg_nc: [*c]natsConnection, arg_subj: [*c]const u8, arg_reply: [*c]const u8, arg_str: [*c]const u8) natsStatus {
    var nc = arg_nc;
    _ = &nc;
    var subj = arg_subj;
    _ = &subj;
    ...
    var dataLen: c_int = 0;
    _ = &dataLen;
    if ((reply == @as([*c]const u8, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) or (strlen(reply) == @as(c_ulong, @bitCast(@as(c_long, @as(c_int, 0)))))) return nats_setErrorReal("./src/submodules/nats.c/src/pub.c", "natsConnection_PublishRequestString", @as(c_int, 328), @as(c_uint, @bitCast(NATS_INVALID_ARG)), "%s", natsStatus_GetText(@as(c_uint, @bitCast(NATS_INVALID_ARG))));
    if (str != @as([*c]const u8, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) {
        dataLen = @as(c_int, @bitCast(@as(c_uint, @truncate(strlen(str)))));
    }
    natsMsg_init(&msg, subj, str, dataLen);
    s = natsConn_publish(nc, &msg, reply, @as(c_int, 0) != 0);
    return if (s == @as(c_uint, @bitCast(NATS_OK))) s else nats_updateErrStack(s, "natsConnection_PublishRequestString");
}
pub export fn natsConnection_Request(arg_replyMsg: [*c][*c]natsMsg, arg_nc: [*c]natsConnection, arg_subj: [*c]const u8, arg_data: ?*const anyopaque, arg_dataLen: c_int, arg_timeout: i64) natsStatus {
    var replyMsg = arg_replyMsg;
    _ = &replyMsg;
    var nc = arg_nc;
    _ = &nc;
    var subj = arg_subj;
    ...
    return if (s == @as(c_uint, @bitCast(NATS_OK))) s else nats_updateErrStack(s, "natsConnection_Request");
}
pub export fn natsConnection_RequestString(arg_replyMsg: [*c][*c]natsMsg, arg_nc: [*c]natsConnection, arg_subj: [*c]const u8, arg_str: [*c]const u8, arg_timeout: i64) natsStatus {
    var replyMsg = arg_replyMsg;
    _ = &replyMsg;
    var nc = arg_nc;
    _ = &nc;
    ...
    var msg: natsMsg = undefined;
    _ = &msg;
    natsMsg_init(&msg, subj, str, if (str == @as([*c]const u8, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) @as(c_int, 0) else @as(c_int, @bitCast(@as(c_uint, @truncate(strlen(str))))));
    s = natsConnection_RequestMsg(replyMsg, nc, &msg, timeout);
    return if (s == @as(c_uint, @bitCast(NATS_OK))) s else nats_updateErrStack(s, "natsConnection_RequestString");
}
pub export fn natsConnection_RequestMsg(arg_replyMsg: [*c][*c]natsMsg, arg_nc: [*c]natsConnection, arg_m: [*c]natsMsg, arg_timeout: i64) natsStatus {
    var replyMsg = arg_replyMsg;
    _ = &replyMsg;
    var nc = arg_nc;
    _ = &nc;
    ...
    _ = &resp;
    var needsRemoval: bool = @as(c_int, 1) != 0;
    _ = &needsRemoval;
    var respInboxBuf: [74]u8 = undefined;
    _ = &respInboxBuf;
    var respInbox: [*c]u8 = @as([*c]u8, @ptrCast(@alignCast(&respInboxBuf)));
    _ = &respInbox;
    if (((replyMsg == @as([*c][*c]natsMsg, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) or (nc == @as([*c]natsConnection, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0)))))))) or (m == @as([*c]natsMsg, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0)))))))) return nats_setErrorReal("./src/submodules/nats.c/src/pub.c", "natsConnection_RequestMsg", @as(c_int, 438), @as(c_uint, @bitCast(NATS_INVALID_ARG)), "%s", natsStatus_GetText(@as(c_uint, @bitCast(NATS_INVALID_ARG))));
    replyMsg.* = null;
    _ = natsMutex_Lock(nc.*.mu);
    if (natsConn_isClosed(nc)) {
        _ = natsMutex_Unlock(nc.*.mu);
        return nats_setErrorReal("./src/submodules/nats.c/src/pub.c", "natsConnection_RequestMsg", @as(c_int, 446), @as(c_uint, @bitCast(NATS_CONNECTION_CLOSED)), "%s", natsStatus_GetText(@as(c_uint, @bitCast(NATS_CONNECTION_CLOSED))));
    }
    if (nc.*.opts.*.useOldRequestStyle) {
        _ = natsMutex_Unlock(nc.*.mu);
        return _oldRequestMsg(replyMsg, nc, m, timeout);
    }
    if (nc.*.inboxPfxLen > @as(c_int, 32)) {
        respInbox = @as([*c]u8, @ptrCast(@alignCast(malloc(@as(c_ulong, @bitCast(@as(c_long, ((nc.*.inboxPfxLen + (@as(c_int, 12) + @as(c_int, 10))) + @as(c_int, 19)) + @as(c_int, 1))))))));
        if (respInbox == @as([*c]u8, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) {
            _ = natsMutex_Unlock(nc.*.mu);
            return nats_setErrorReal("./src/submodules/nats.c/src/pub.c", "natsConnection_RequestMsg", @as(c_int, 462), @as(c_uint, @bitCast(NATS_NO_MEMORY)), "%s", natsStatus_GetText(@as(c_uint, @bitCast(NATS_NO_MEMORY))));
        }
    }
    natsConn_retain(nc);
    if (nc.*.respMux == @as([*c]natsSubscription, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) {
        s = natsConn_initResp(nc, &_respHandler);
    }
    if (s == @as(c_uint, @bitCast(NATS_OK))) {
        s = natsConn_addRespInfo(&resp, nc, respInbox, @as(c_int, @bitCast(@as(c_uint, @truncate(@sizeOf([*c]u8))))));
    }
    _ = natsMutex_Unlock(nc.*.mu);
    if (s == @as(c_uint, @bitCast(NATS_OK))) {
        s = natsConn_publish(nc, m, @as([*c]const u8, @ptrCast(@alignCast(respInbox))), @as(c_int, 1) != 0);
        if (s == @as(c_uint, @bitCast(NATS_OK))) {
            natsMutex_Lock(resp.*.mu);
            while (((s != @as(c_uint, @bitCast(NATS_TIMEOUT))) and (resp.*.msg == @as([*c]natsMsg, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0)))))))) and !resp.*.closed) {
            ...
            resp.*.removed = @as(c_int, 1) != 0;
            natsMutex_Unlock(resp.*.mu);
        }
    }
    if (needsRemoval) {
        _ = natsMutex_Lock(nc.*.mu);
        if (nc.*.respMap != @as([*c]natsStrHash, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) {
            _ = natsStrHash_Remove(nc.*.respMap, respInbox + @as(usize, @bitCast(@as(isize, @intCast(nc.*.reqIdOffset)))));
        }
        _ = natsMutex_Unlock(nc.*.mu);
    }
    natsConn_disposeRespInfo(nc, resp, @as(c_int, 1) != 0);
    natsConn_release(nc);
    if (respInbox != @as([*c]u8, @ptrCast(@alignCast(&respInboxBuf)))) {
        free(@as(?*anyopaque, @ptrCast(respInbox)));
    }
    return if (s == @as(c_uint, @bitCast(NATS_OK))) s else nats_updateErrStack(s, "natsConnection_RequestMsg");
}
...
pub export fn natsConn_publish(arg_nc: [*c]natsConnection, arg_msg: [*c]natsMsg, arg_reply: [*c]const u8, arg_directFlush: bool) natsStatus {
    var nc = arg_nc;
    _ = &nc;
    var msg = arg_msg;
    _ = &msg;
    var reply = arg_reply;
    _ = &reply;
    var directFlush = arg_directFlush;
    _ = &directFlush;
    var s: natsStatus = @as(c_uint, @bitCast(NATS_OK));
    _ = &s;
    var msgHdSize: c_int = 0;
    _ = &msgHdSize;
    var dlb: [12]u8 = undefined;
    _ = &dlb;
    var dli: c_int = @as(c_int, 12);
    _ = &dli;
    var dlSize: c_int = 0;
    _ = &dlSize;
    var hlb: [12]u8 = undefined;
    _ = &hlb;
    var hli: c_int = @as(c_int, 12);
    _ = &hli;
    var hlSize: c_int = 0;
    _ = &hlSize;
    var subjLen: c_int = 0;
    ...
    _ = &replyLen;
    var reconnecting: bool = @as(c_int, 0) != 0;
    _ = &reconnecting;
    var ppo: c_int = 1;
    _ = &ppo;
    var hdrl: c_int = 0;
    _ = &hdrl;
    var totalLen: c_int = 0;
    _ = &totalLen;
    if (nc == @as([*c]natsConnection, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) return nats_setErrorReal("./src/submodules/nats.c/src/pub.c", "natsConn_publish", @as(c_int, 71), @as(c_uint, @bitCast(NATS_INVALID_ARG)), "%s", natsStatus_GetText(@as(c_uint, @bitCast(NATS_INVALID_ARG))));
    if ((msg.*.subject == @as([*c]const u8, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) or ((blk: {
        const tmp = @as(c_int, @bitCast(@as(c_uint, @truncate(strlen(msg.*.subject)))));
        subjLen = tmp;
        break :blk tmp;
    }) == @as(c_int, 0))) {
        return nats_setErrorReal("./src/submodules/nats.c/src/pub.c", "natsConn_publish", @as(c_int, 76), @as(c_uint, @bitCast(NATS_INVALID_SUBJECT)), "%s", natsStatus_GetText(@as(c_uint, @bitCast(NATS_INVALID_SUBJECT))));
    }
    if (reply == @as([*c]const u8, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) {
        reply = msg.*.reply;
    }
    replyLen = if (reply != @as([*c]const u8, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) @as(c_int, @bitCast(@as(c_uint, @truncate(strlen(reply))))) else @as(c_int, 0);
    _ = natsMutex_Lock(nc.*.mu);
    if (natsConn_isClosed(nc)) {
        _ = natsMutex_Unlock(nc.*.mu);
        return nats_setErrorReal("./src/submodules/nats.c/src/pub.c", "natsConn_publish", @as(c_int, 92), @as(c_uint, @bitCast(NATS_CONNECTION_CLOSED)), "%s", natsStatus_GetText(@as(c_uint, @bitCast(NATS_CONNECTION_CLOSED))));
    }
    if (natsConn_isDrainingPubs(nc)) {
        _ = natsMutex_Unlock(nc.*.mu);
        return nats_setErrorReal("./src/submodules/nats.c/src/pub.c", "natsConn_publish", @as(c_int, 99), @as(c_uint, @bitCast(NATS_DRAINING)), "%s", natsStatus_GetText(@as(c_uint, @bitCast(NATS_DRAINING))));
    }
    if ((msg.*.headers != @as([*c]natsStrHash, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) or ((msg.*.flags & (@as(c_int, 1) << @intCast(0))) != @as(c_int, 0))) {
        if (!nc.*.initc and !nc.*.info.headers) {
            _ = natsMutex_Unlock(nc.*.mu);
            return nats_setErrorReal("./src/submodules/nats.c/src/pub.c", "natsConn_publish", @as(c_int, 115), @as(c_uint, @bitCast(NATS_NO_SERVER_SUPPORT)), "%s", natsStatus_GetText(@as(c_uint, @bitCast(NATS_NO_SERVER_SUPPORT))));
        }
        ...
        if (hdrl > @as(c_int, 0)) {
            {
                if (hdrl > @as(c_int, 0)) {
                    ...
                    {
                        l = hdrl;
                        while (l > @as(c_int, 0)) : (l = @divTrunc(l, @as(c_int, 10))) {
                            hli -= @as(c_int, 1);
                            hlb[@as(c_uint, @intCast(hli))] = (blk: {
                                const tmp = @import("std").zig.c_translation.signedRemainder(l, @as(c_int, 10));
                                if (tmp >= 0) break :blk digits + @as(usize, @intCast(tmp)) else break :blk digits - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
                            }).*;
                        }
                    }
                } else {
                    hli -= @as(c_int, 1);
                    hlb[@as(c_uint, @intCast(hli))] = digits[@as(c_uint, @intCast(@as(c_int, 0)))];
                }
            }
            hlSize = @as(c_int, 12) - hli;
            ppo = 0;
            totalLen = hdrl;
        }
    }
    totalLen += msg.*.dataLen;
    if (!nc.*.initc and (@as(i64, @bitCast(@as(c_long, totalLen))) > nc.*.info.maxPayload)) {
        _ = natsMutex_Unlock(nc.*.mu);
        return nats_setErrorReal("./src/submodules/nats.c/src/pub.c", "natsConn_publish", @as(c_int, 136), @as(c_uint, @bitCast(NATS_MAX_PAYLOAD)), "Payload %d greater than maximum allowed: %ld", totalLen, nc.*.info.maxPayload);
    }
    if (blk: {
        const tmp = natsConn_isReconnecting(nc);
        reconnecting = tmp;
        break :blk tmp;
    }) {
        if (nc.*.pending.*.len >= nc.*.opts.*.reconnectBufSize) {
            _ = natsMutex_Unlock(nc.*.mu);
            return nats_setErrorReal("./src/submodules/nats.c/src/pub.c", "natsConn_publish", @as(c_int, 147), @as(c_uint, @bitCast(NATS_INSUFFICIENT_BUFFER)), "%s", natsStatus_GetText(@as(c_uint, @bitCast(NATS_INSUFFICIENT_BUFFER))));
        }
    }
    {
        if (totalLen > @as(c_int, 0)) {
            var l: c_int = undefined;
            _ = &l;
            {
                l = totalLen;
            ...
            dli -= @as(c_int, 1);
            dlb[@as(c_uint, @intCast(dli))] = digits[@as(c_uint, @intCast(@as(c_int, 0)))];
        }
    }
    dlSize = @as(c_int, 12) - dli;
    msgHdSize = ((((((@as(c_int, 5) - ppo) + subjLen) + @as(c_int, 1)) + (if (replyLen > @as(c_int, 0)) replyLen + @as(c_int, 1) else @as(c_int, 0))) + (if (hdrl > @as(c_int, 0)) (hlSize + @as(c_int, 1)) + hdrl else @as(c_int, 0))) + dlSize) + @as(c_int, 2);
    natsBuf_MoveTo(nc.*.scratch, @as(c_int, 5));
    if (nc.*.scratch.*.capacity < msgHdSize) {
        s = natsBuf_Expand(nc.*.scratch, @as(c_int, @intFromFloat(@as(f64, @floatCast(@as(f32, @floatFromInt(msgHdSize)))) * 1.1)));
    }
    if (s == @as(c_uint, @bitCast(NATS_OK))) {
        s = natsBuf_Append(nc.*.scratch, msg.*.subject, subjLen);
    }
    if (s == @as(c_uint, @bitCast(NATS_OK))) {
        s = natsBuf_Append(nc.*.scratch, " ", @as(c_int, 1));
    }
    if ((s == @as(c_uint, @bitCast(NATS_OK))) and (reply != @as([*c]const u8, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0)))))))) {
        s = natsBuf_Append(nc.*.scratch, reply, replyLen);
        if (s == @as(c_uint, @bitCast(NATS_OK))) {
            s = natsBuf_Append(nc.*.scratch, " ", @as(c_int, 1));
        }
    }
    if ((s == @as(c_uint, @bitCast(NATS_OK))) and (hdrl > @as(c_int, 0))) {
        s = natsBuf_Append(nc.*.scratch, @as([*c]u8, @ptrCast(@alignCast(&hlb))) + @as(usize, @bitCast(@as(isize, @intCast(hli)))), hlSize);
        if (s == @as(c_uint, @bitCast(NATS_OK))) {
            s = natsBuf_Append(nc.*.scratch, " ", @as(c_int, 1));
        }
    }
    if (s == @as(c_uint, @bitCast(NATS_OK))) {
        s = natsBuf_Append(nc.*.scratch, @as([*c]u8, @ptrCast(@alignCast(&dlb))) + @as(usize, @bitCast(@as(isize, @intCast(dli)))), dlSize);
    }
    if (s == @as(c_uint, @bitCast(NATS_OK))) {
        s = natsBuf_Append(nc.*.scratch, "\r\n", @as(c_int, 2));
    }
    if ((s == @as(c_uint, @bitCast(NATS_OK))) and (hdrl > @as(c_int, 0))) {
    ...
    if (s == @as(c_uint, @bitCast(NATS_OK))) {
        ...
        if (reconnecting) {
            pos = nc.*.pending.*.len;
        } else if (nc.*.opts.*.writeDeadline > @as(i64, @bitCast(@as(c_long, @as(c_int, 0))))) {
            natsDeadline_Init(&nc.*.sockCtx.writeDeadline, nc.*.opts.*.writeDeadline);
        }
        s = natsConn_bufferWrite(nc, nc.*.scratch.*.data + @as(usize, @bitCast(@as(isize, @intCast(ppo)))), msgHdSize);
        if (s == @as(c_uint, @bitCast(NATS_OK))) {
        ...
        if ((s != @as(c_uint, @bitCast(NATS_OK))) and (@as(c_int, @intFromBool(reconnecting)) != 0)) {
            natsBuf_MoveTo(nc.*.pending, pos);
        }
    }
    if ((s == @as(c_uint, @bitCast(NATS_OK))) and !reconnecting) {
        if (directFlush) {
    ...
    if (s == @as(c_uint, @bitCast(NATS_OK))) {
        nc.*.stats.outMsgs +%= @as(u64, @bitCast(@as(c_long, @as(c_int, 1))));
        nc.*.stats.outBytes +%= @as(u64, @bitCast(@as(c_long, totalLen)));
    }
    _ = natsMutex_Unlock(nc.*.mu);
    return if (s == @as(c_uint, @bitCast(NATS_OK))) s else nats_updateErrStack(s, "natsConn_publish");
}
...
pub var digits: [*c]const u8 = "0123456789";
pub fn _oldRequestMsg(arg_replyMsg: [*c][*c]natsMsg, arg_nc: [*c]natsConnection, arg_requestMsg: [*c]natsMsg, arg_timeout: i64) callconv(.c) natsStatus {
    var replyMsg = arg_replyMsg;
    _ = &replyMsg;
    var nc = arg_nc;
    _ = &nc;
    var requestMsg = arg_requestMsg;
    _ = &requestMsg;
    var timeout = arg_timeout;
    _ = &timeout;
    var s: natsStatus = @as(c_uint, @bitCast(NATS_OK));
    ...
    _ = &sub;
    var inboxBuf: [55]u8 = undefined;
    _ = &inboxBuf;
    var inbox: [*c]u8 = null;
    _ = &inbox;
    var freeIbx: bool = @as(c_int, 0) != 0;
    _ = &freeIbx;
    s = natsConn_initInbox(nc, @as([*c]u8, @ptrCast(@alignCast(&inboxBuf))), @as(c_int, @bitCast(@as(c_uint, @truncate(@sizeOf([55]u8))))), &inbox, &freeIbx);
    if (s == @as(c_uint, @bitCast(NATS_OK))) {
        s = natsConn_subscribeImpl(&sub, nc, @as(c_int, 1) != 0, inbox, null, @as(i64, @bitCast(@as(c_long, @as(c_int, 0)))), null, @as(?*anyopaque, @ptrFromInt(@as(c_int, 0))), @as(c_int, 1) != 0, null);
    }
    if (s == @as(c_uint, @bitCast(NATS_OK))) {
        s = natsSubscription_AutoUnsubscribe(sub, @as(c_int, 1));
    }
    if (s == @as(c_uint, @bitCast(NATS_OK))) {
        s = natsConn_publish(nc, requestMsg, @as([*c]const u8, @ptrCast(@alignCast(inbox))), @as(c_int, 1) != 0);
    }
    if (s == @as(c_uint, @bitCast(NATS_OK))) {
    ...
    return if (s == @as(c_uint, @bitCast(NATS_OK))) s else nats_updateErrStack(s, "_oldRequestMsg");
}
pub fn _respHandler(arg_nc: [*c]natsConnection, arg_sub: [*c]natsSubscription, arg_msg: [*c]natsMsg, arg_closure: ?*anyopaque) callconv(.c) void {
    var nc = arg_nc;
    _ = &nc;
    var sub = arg_sub;
    _ = &sub;
    ...
    if ((@as(c_int, @bitCast(@as(c_uint, @truncate(strlen(subj))))) > nc.*.reqIdOffset) and (memcmp(@as(?*const anyopaque, @ptrCast(sub.*.subject)), @as(?*const anyopaque, @ptrCast(subj)), strlen(sub.*.subject) -% @as(c_ulong, @bitCast(@as(c_long, @as(c_int, 1))))) == @as(c_int, 0))) {
        rt = @as([*c]u8, @ptrCast(@volatileCast(@constCast(natsMsg_GetSubject(msg) + @as(usize, @bitCast(@as(isize, @intCast(nc.*.reqIdOffset))))))));
        resp = @as([*c]respInfo, @ptrCast(@alignCast(natsStrHash_Remove(nc.*.respMap, rt))));
    } else if (nc.*.respMap.*.used == @as(c_int, 1)) {
        var value: ?*anyopaque = @as(?*anyopaque, @ptrFromInt(@as(c_int, 0)));
        _ = &value;
        _ = natsStrHash_RemoveSingle(nc.*.respMap, null, &value);
        resp = @as([*c]respInfo, @ptrCast(@alignCast(value)));
    }
...
pub inline fn _publishMsg(n: anytype, m: anytype, r: anytype) @TypeOf(natsConn_publish(n, m, r, @"false")) {
    _ = &n;
    _ = &m;
    _ = &r;
    return natsConn_publish(n, m, r, @"false");
}
pub const GETBYTES_SIZE = @compileError("unable to translate macro: undefined identifier `l`");
// ./src/submodules/nats.c/src/pub.c:28:9
pub const BYTES_SIZE_MAX = @as(c_int, 12);
