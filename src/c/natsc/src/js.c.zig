...
pub const struct_in6_addr = extern struct {
    __in6_u: union_unnamed_15 = @import("std").mem.zeroes(union_unnamed_15),
};
...
const union_unnamed_16 = extern union {
    _pad: [12]c_int,
    _tid: __pid_t,
    _sigev_thread: struct_unnamed_17,
};
pub const struct_sigevent = extern struct {
    ...
    _sigev_un: union_unnamed_16 = @import("std").mem.zeroes(union_unnamed_16),
};
...
const struct_unnamed_36 = extern struct {
    ...
    _bounds: union_unnamed_37 = @import("std").mem.zeroes(union_unnamed_37),
};
...
const union_unnamed_31 = extern union {
    _pad: [28]c_int,
    _kill: struct_unnamed_32,
    _timer: struct_unnamed_33,
    _rt: struct_unnamed_34,
    _sigchld: struct_unnamed_35,
    _sigfault: struct_unnamed_36,
    _sigpoll: struct_unnamed_39,
    _sigsys: struct_unnamed_40,
};
pub const siginfo_t = extern struct {
    ...
    __pad0: c_int = @import("std").mem.zeroes(c_int),
    _sifields: union_unnamed_31 = @import("std").mem.zeroes(union_unnamed_31),
};
...
pub const struct_sigaction = extern struct {
    __sigaction_handler: union_unnamed_49 = @import("std").mem.zeroes(union_unnamed_49),
...
pub const struct___va_list_tag_52 = extern struct {
    gp_offset: c_uint = @import("std").mem.zeroes(c_uint),
    fp_offset: c_uint = @import("std").mem.zeroes(c_uint),
    overflow_arg_area: ?*anyopaque = @import("std").mem.zeroes(?*anyopaque),
    reg_save_area: ?*anyopaque = @import("std").mem.zeroes(?*anyopaque),
};
pub const __builtin_va_list = [1]struct___va_list_tag_52;
...
pub const __mbstate_t = extern struct {
    ...
    __value: union_unnamed_53 = @import("std").mem.zeroes(union_unnamed_53),
};
...
pub extern fn vfprintf(noalias __s: [*c]FILE, noalias __format: [*c]const u8, __arg: [*c]struct___va_list_tag_52) c_int;
pub extern fn vprintf(noalias __format: [*c]const u8, __arg: [*c]struct___va_list_tag_52) c_int;
pub extern fn vsprintf(noalias __s: [*c]u8, noalias __format: [*c]const u8, __arg: [*c]struct___va_list_tag_52) c_int;
pub extern fn snprintf(noalias __s: [*c]u8, __maxlen: c_ulong, noalias __format: [*c]const u8, ...) c_int;
pub extern fn vsnprintf(noalias __s: [*c]u8, __maxlen: c_ulong, noalias __format: [*c]const u8, __arg: [*c]struct___va_list_tag_52) c_int;
pub extern fn vasprintf(noalias __ptr: [*c][*c]u8, noalias __f: [*c]const u8, __arg: [*c]struct___va_list_tag_52) c_int;
pub extern fn __asprintf(noalias __ptr: [*c][*c]u8, noalias __fmt: [*c]const u8, ...) c_int;
pub extern fn asprintf(noalias __ptr: [*c][*c]u8, noalias __fmt: [*c]const u8, ...) c_int;
pub extern fn vdprintf(__fd: c_int, noalias __fmt: [*c]const u8, __arg: [*c]struct___va_list_tag_52) c_int;
pub extern fn dprintf(__fd: c_int, noalias __fmt: [*c]const u8, ...) c_int;
pub extern fn fscanf(noalias __stream: [*c]FILE, noalias __format: [*c]const u8, ...) c_int;
pub extern fn scanf(noalias __format: [*c]const u8, ...) c_int;
pub extern fn sscanf(noalias __s: [*c]const u8, noalias __format: [*c]const u8, ...) c_int;
pub extern fn vfscanf(noalias __s: [*c]FILE, noalias __format: [*c]const u8, __arg: [*c]struct___va_list_tag_52) c_int;
pub extern fn vscanf(noalias __format: [*c]const u8, __arg: [*c]struct___va_list_tag_52) c_int;
pub extern fn vsscanf(noalias __s: [*c]const u8, noalias __format: [*c]const u8, __arg: [*c]struct___va_list_tag_52) c_int;
...
pub const struct___natsSubscriptionControlMessages = extern struct {
    sub: struct_unnamed_54 = @import("std").mem.zeroes(struct_unnamed_54),
    fetch: struct_unnamed_55 = @import("std").mem.zeroes(struct_unnamed_55),
};
...
pub const struct_jsOptionsPublishAsync_56 = extern struct {
...
pub const struct_jsOptionsPullSubscribeAsync_57 = extern struct {
...
pub const struct_jsOptionsStreamPurge_59 = extern struct {
    Subject: [*c]const u8 = @import("std").mem.zeroes([*c]const u8),
    Sequence: u64 = @import("std").mem.zeroes(u64),
    Keep: u64 = @import("std").mem.zeroes(u64),
};
pub const struct_jsOptionsStreamInfo_60 = extern struct {
    DeletedDetails: bool = @import("std").mem.zeroes(bool),
    SubjectsFilter: [*c]const u8 = @import("std").mem.zeroes([*c]const u8),
};
pub const struct_jsOptionsStream_58 = extern struct {
    Purge: struct_jsOptionsStreamPurge_59 = @import("std").mem.zeroes(struct_jsOptionsStreamPurge_59),
    Info: struct_jsOptionsStreamInfo_60 = @import("std").mem.zeroes(struct_jsOptionsStreamInfo_60),
};
pub const struct_jsOptions = extern struct {
    ...
    PublishAsync: struct_jsOptionsPublishAsync_56 = @import("std").mem.zeroes(struct_jsOptionsPublishAsync_56),
    PullSubscribeAsync: struct_jsOptionsPullSubscribeAsync_57 = @import("std").mem.zeroes(struct_jsOptionsPullSubscribeAsync_57),
    Stream: struct_jsOptionsStream_58 = @import("std").mem.zeroes(struct_jsOptionsStream_58),
};
...
pub const struct___jsFetch = extern struct {
    opts: struct_jsOptionsPullSubscribeAsync_57 = @import("std").mem.zeroes(struct_jsOptionsPullSubscribeAsync_57),
...
pub const struct_mismatch_61 = extern struct {
...
pub const struct___jsSub = extern struct {
    ...
    mismatch: struct_mismatch_61 = @import("std").mem.zeroes(struct_mismatch_61),
...
pub const struct___natsConnection = extern struct {
    ...
    el: struct_unnamed_62 = @import("std").mem.zeroes(struct_unnamed_62),
    filter: natsMsgFilter = @import("std").mem.zeroes(natsMsgFilter),
    filterClosure: ?*anyopaque = @import("std").mem.zeroes(?*anyopaque),
    srvVersion: struct_unnamed_63 = @import("std").mem.zeroes(struct_unnamed_63),
};
...
pub export fn jsOptions_Init(arg_opts: [*c]jsOptions) natsStatus {
    var opts = arg_opts;
    _ = &opts;
    if (opts == @as([*c]jsOptions, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) return nats_setErrorReal("./src/submodules/nats.c/src/js.c", "jsOptions_Init", @as(c_int, 191), @as(c_uint, @bitCast(NATS_INVALID_ARG)), "%s", natsStatus_GetText(@as(c_uint, @bitCast(NATS_INVALID_ARG))));
    _ = memset(@as(?*anyopaque, @ptrCast(opts)), @as(c_int, 0), @sizeOf(jsOptions));
    return @as(c_uint, @bitCast(NATS_OK));
}
pub export fn natsConnection_JetStream(arg_new_js: [*c][*c]jsCtx, arg_nc: [*c]natsConnection, arg_opts: [*c]jsOptions) natsStatus {
    var new_js = arg_new_js;
    _ = &new_js;
    var nc = arg_nc;
    _ = &nc;
    var opts = arg_opts;
    ...
    _ = &s;
    if ((new_js == @as([*c][*c]jsCtx, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) or (nc == @as([*c]natsConnection, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0)))))))) return nats_setErrorReal("./src/submodules/nats.c/src/js.c", "natsConnection_JetStream", @as(c_int, 272), @as(c_uint, @bitCast(NATS_INVALID_ARG)), "%s", natsStatus_GetText(@as(c_uint, @bitCast(NATS_INVALID_ARG))));
    if (opts != @as([*c]jsOptions, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) {
        if (opts.*.Wait < @as(i64, @bitCast(@as(c_long, @as(c_int, 0))))) return nats_setErrorReal("./src/submodules/nats.c/src/js.c", "natsConnection_JetStream", @as(c_int, 277), @as(c_uint, @bitCast(NATS_INVALID_ARG)), "option 'Wait' (%ld) cannot be negative", opts.*.Wait);
        if (opts.*.PublishAsync.StallWait < @as(i64, @bitCast(@as(c_long, @as(c_int, 0))))) return nats_setErrorReal("./src/submodules/nats.c/src/js.c", "natsConnection_JetStream", @as(c_int, 279), @as(c_uint, @bitCast(NATS_INVALID_ARG)), "option 'PublishAsyncStallWait' (%ld) cannot be negative", opts.*.PublishAsync.StallWait);
    }
    js = @as([*c]jsCtx, @ptrCast(@alignCast(calloc(@as(c_ulong, @bitCast(@as(c_long, @as(c_int, 1)))), @sizeOf(jsCtx)))));
    if (js == @as([*c]jsCtx, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) return nats_setErrorReal("./src/submodules/nats.c/src/js.c", "natsConnection_JetStream", @as(c_int, 284), @as(c_uint, @bitCast(NATS_NO_MEMORY)), "%s", natsStatus_GetText(@as(c_uint, @bitCast(NATS_NO_MEMORY))));
    js.*.refs = 1;
    natsConn_retain(nc);
    js.*.nc = nc;
    js.*.rpreLen = (nc.*.inboxPfxLen + @as(c_int, 8)) + @as(c_int, 1);
    s = natsMutex_Create(&js.*.mu);
    if (s == @as(c_uint, @bitCast(NATS_OK))) {
        if ((opts != @as([*c]jsOptions, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) and !((if ((opts.*.Domain == @as([*c]const u8, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) or (@as(c_int, @bitCast(@as(c_uint, opts.*.Domain[@as(c_uint, @intCast(@as(c_int, 0)))]))) == @as(c_int, '\x00'))) @as(c_int, 1) else @as(c_int, 0)) != 0)) {
            if (asprintf(@as([*c][*c]u8, @ptrCast(@alignCast(&js.*.opts.Prefix))), "$JS.%.*s.API", js_lenWithoutTrailingDot(opts.*.Domain), opts.*.Domain) < @as(c_int, 0)) {
                s = nats_setErrorReal("./src/submodules/nats.c/src/js.c", "natsConnection_JetStream", @as(c_int, 305), @as(c_uint, @bitCast(NATS_NO_MEMORY)), "%s", natsStatus_GetText(@as(c_uint, @bitCast(NATS_NO_MEMORY))));
            }
        } else if ((opts == @as([*c]jsOptions, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) or ((if ((opts.*.Prefix == @as([*c]const u8, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) or (@as(c_int, @bitCast(@as(c_uint, opts.*.Prefix[@as(c_uint, @intCast(@as(c_int, 0)))]))) == @as(c_int, '\x00'))) @as(c_int, 1) else @as(c_int, 0)) != 0)) {
            js.*.opts.Prefix = strdup(jsDefaultAPIPrefix);
            if (js.*.opts.Prefix == @as([*c]const u8, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) {
                s = nats_setErrorReal("./src/submodules/nats.c/src/js.c", "natsConnection_JetStream", @as(c_int, 312), @as(c_uint, @bitCast(NATS_NO_MEMORY)), "%s", natsStatus_GetText(@as(c_uint, @bitCast(NATS_NO_MEMORY))));
            }
        } else if (asprintf(@as([*c][*c]u8, @ptrCast(@alignCast(&js.*.opts.Prefix))), "%.*s", js_lenWithoutTrailingDot(opts.*.Prefix), opts.*.Prefix) < @as(c_int, 0)) {
            s = nats_setErrorReal("./src/submodules/nats.c/src/js.c", "natsConnection_JetStream", @as(c_int, 317), @as(c_uint, @bitCast(NATS_NO_MEMORY)), "%s", natsStatus_GetText(@as(c_uint, @bitCast(NATS_NO_MEMORY))));
        }
    }
    if ((s == @as(c_uint, @bitCast(NATS_OK))) and (opts != @as([*c]jsOptions, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0)))))))) {
        var pa: [*c]struct_jsOptionsPublishAsync_56 = &js.*.opts.PublishAsync;
        _ = &pa;
        pa.*.MaxPending = opts.*.PublishAsync.MaxPending;
        if (opts.*.PublishAsync.AckHandler != @as(jsPubAckHandler, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) {
    ...
    if (js.*.opts.Wait == @as(i64, @bitCast(@as(c_long, @as(c_int, 0))))) {
        js.*.opts.Wait = jsDefaultRequestWait;
    }
    if (js.*.opts.PublishAsync.StallWait == @as(i64, @bitCast(@as(c_long, @as(c_int, 0))))) {
        js.*.opts.PublishAsync.StallWait = jsDefaultStallWait;
    }
    if ((s == @as(c_uint, @bitCast(NATS_OK))) and (opts != @as([*c]jsOptions, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0)))))))) {
        s = _copyPurgeOptions(js, &opts.*.Stream.Purge);
        if (s == @as(c_uint, @bitCast(NATS_OK))) {
            s = _copyStreamInfoOptions(js, &opts.*.Stream.Info);
        }
    }
    if (s == @as(c_uint, @bitCast(NATS_OK))) {
        new_js.* = js;
    ...
    return if (s == @as(c_uint, @bitCast(NATS_OK))) s else nats_updateErrStack(s, "natsConnection_JetStream");
}
...
pub export fn jsCtx_Destroy(arg_js: [*c]jsCtx) void {
    var js = arg_js;
    _ = &js;
    var pm: [*c]pmInfo = undefined;
    _ = &pm;
    if (js == @as([*c]jsCtx, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) return;
    _ = natsMutex_Lock(js.*.mu);
    if (js.*.closed) {
        _ = natsMutex_Unlock(js.*.mu);
        return;
    }
    js.*.closed = @as(c_int, 1) != 0;
    if (js.*.rsub != @as([*c]natsSubscription, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) {
        natsSubscription_Destroy(js.*.rsub);
        js.*.rsub = null;
    }
    if ((js.*.pm != @as([*c]natsStrHash, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) and (js.*.pm.*.used > @as(c_int, 0))) {
        var iter: natsStrHashIter = undefined;
        _ = &iter;
        var v: ?*anyopaque = @as(?*anyopaque, @ptrFromInt(@as(c_int, 0)));
        _ = &v;
        natsStrHashIter_Init(&iter, js.*.pm);
        while (natsStrHashIter_Next(&iter, null, &v)) {
            var msg: [*c]natsMsg = @as([*c]natsMsg, @ptrCast(@alignCast(v)));
            _ = &msg;
    ...
    while ((blk: {
        ...
        pm = tmp;
        break :blk tmp;
    }) != @as([*c]pmInfo, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) {
        js.*.pmHead = pm.*.next;
        _destroyPMInfo(pm);
    }
    if (js.*.pmtmr != @as([*c]natsTimer, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) {
...
pub export fn jsPubOptions_Init(arg_opts: [*c]jsPubOptions) natsStatus {
    var opts = arg_opts;
    _ = &opts;
    if (opts == @as([*c]jsPubOptions, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) return nats_setErrorReal("./src/submodules/nats.c/src/js.c", "jsPubOptions_Init", @as(c_int, 427), @as(c_uint, @bitCast(NATS_INVALID_ARG)), "%s", natsStatus_GetText(@as(c_uint, @bitCast(NATS_INVALID_ARG))));
    _ = memset(@as(?*anyopaque, @ptrCast(opts)), @as(c_int, 0), @sizeOf(jsPubOptions));
    return @as(c_uint, @bitCast(NATS_OK));
}
pub export fn js_Publish(arg_new_puback: [*c][*c]jsPubAck, arg_js: [*c]jsCtx, arg_subj: [*c]const u8, arg_data: ?*const anyopaque, arg_dataLen: c_int, arg_opts: [*c]jsPubOptions, arg_errCode: [*c]jsErrCode) natsStatus {
    var new_puback = arg_new_puback;
    _ = &new_puback;
    var js = arg_js;
    _ = &js;
    var subj = arg_subj;
    ...
    var s: natsStatus = undefined;
    _ = &s;
    var msg: natsMsg = undefined;
    _ = &msg;
    natsMsg_init(&msg, subj, @as([*c]const u8, @ptrCast(@alignCast(data))), dataLen);
    s = js_PublishMsg(new_puback, js, &msg, opts, errCode);
    natsMsg_freeHeaders(&msg);
    return if (s == @as(c_uint, @bitCast(NATS_OK))) s else nats_updateErrStack(s, "js_Publish");
}
...
pub export fn js_PublishMsg(arg_new_puback: [*c][*c]jsPubAck, arg_js: [*c]jsCtx, arg_msg: [*c]natsMsg, arg_opts: [*c]jsPubOptions, arg_errCode: [*c]jsErrCode) natsStatus {
    var new_puback = arg_new_puback;
    _ = &new_puback;
    var js = arg_js;
    _ = &js;
    ...
    _ = &resp;
    var ar: jsApiResponse = jsApiResponse{
        .Type = null,
        .Error = jsApiError{
            .Code = @as(c_int, 0),
            .ErrCode = @as(u16, @bitCast(@as(c_short, @truncate(@as(c_int, 0))))),
            .Description = null,
        },
    };
    _ = &ar;
    ...
    if (((js == @as([*c]jsCtx, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) or (msg == @as([*c]natsMsg, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0)))))))) or ((if ((msg.*.subject == @as([*c]const u8, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) or (@as(c_int, @bitCast(@as(c_uint, msg.*.subject[@as(c_uint, @intCast(@as(c_int, 0)))]))) == @as(c_int, '\x00'))) @as(c_int, 1) else @as(c_int, 0)) != 0)) return nats_setErrorReal("./src/submodules/nats.c/src/js.c", "js_PublishMsg", @as(c_int, 509), @as(c_uint, @bitCast(NATS_INVALID_ARG)), "%s", natsStatus_GetText(@as(c_uint, @bitCast(NATS_INVALID_ARG))));
    if (opts != @as([*c]jsPubOptions, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) {
        s = _checkMaxWaitOpt(&ttl, opts);
        if (s == @as(c_uint, @bitCast(NATS_OK))) {
            s = _setHeadersFromOptions(msg, opts);
        }
        if (s != @as(c_uint, @bitCast(NATS_OK))) return if (s == @as(c_uint, @bitCast(NATS_OK))) s else nats_updateErrStack(s, "js_PublishMsg");
    }
    if (ttl == @as(i64, @bitCast(@as(c_long, @as(c_int, 0))))) {
        ttl = js.*.opts.Wait;
    }
    if (s == @as(c_uint, @bitCast(NATS_OK))) {
        s = natsConnection_RequestMsg(&resp, js.*.nc, msg, ttl);
    ...
    if (s == @as(c_uint, @bitCast(NATS_OK))) {
        if (((&ar).*.Error.Code != @as(c_int, 0)) or (@as(c_int, @bitCast(@as(c_uint, (&ar).*.Error.ErrCode))) != @as(c_int, 0))) {
            ...
            s = nats_setErrorReal("./src/submodules/nats.c/src/js.c", "js_PublishMsg", @as(c_int, 538), @as(c_uint, @bitCast(NATS_ERR)), "%s", ar.Error.Description);
        } else if (new_puback != @as([*c][*c]jsPubAck, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) {
            var pa: [*c]jsPubAck = null;
            _ = &pa;
            pa = @as([*c]jsPubAck, @ptrCast(@alignCast(calloc(@as(c_ulong, @bitCast(@as(c_long, @as(c_int, 1)))), @sizeOf(jsPubAck)))));
            if (pa == @as([*c]jsPubAck, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) {
                s = nats_setErrorReal("./src/submodules/nats.c/src/js.c", "js_PublishMsg", @as(c_int, 547), @as(c_uint, @bitCast(NATS_NO_MEMORY)), "%s", natsStatus_GetText(@as(c_uint, @bitCast(NATS_NO_MEMORY))));
            } else {
                s = nats_JSONGetStr(json, "stream", &pa.*.Stream);
                if (s == @as(c_uint, @bitCast(NATS_OK))) {
                    s = nats_JSONGetULong(json, "seq", &pa.*.Sequence);
                }
                if (s == @as(c_uint, @bitCast(NATS_OK))) {
                    s = nats_JSONGetBool(json, "duplicate", &pa.*.Duplicate);
                }
                if (s == @as(c_uint, @bitCast(NATS_OK))) {
                    s = nats_JSONGetStr(json, "domain", &pa.*.Domain);
                }
                if (s == @as(c_uint, @bitCast(NATS_OK))) {
                    new_puback.* = pa;
                } else {
    ...
    return if (s == @as(c_uint, @bitCast(NATS_OK))) s else nats_updateErrStack(s, "js_PublishMsg");
}
pub export fn jsPubAck_Destroy(arg_pa: [*c]jsPubAck) void {
    var pa = arg_pa;
    _ = &pa;
    if (pa == @as([*c]jsPubAck, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) return;
    free(@as(?*anyopaque, @ptrCast(pa.*.Stream)));
    free(@as(?*anyopaque, @ptrCast(pa.*.Domain)));
    free(@as(?*anyopaque, @ptrCast(pa)));
}
pub export fn js_PublishAsync(arg_js: [*c]jsCtx, arg_subj: [*c]const u8, arg_data: ?*const anyopaque, arg_dataLen: c_int, arg_opts: [*c]jsPubOptions) natsStatus {
    var js = arg_js;
    _ = &js;
    var subj = arg_subj;
    _ = &subj;
    ...
    _ = &msg;
    s = natsMsg_Create(&msg, subj, null, @as([*c]const u8, @ptrCast(@alignCast(data))), dataLen);
    if (s == @as(c_uint, @bitCast(NATS_OK))) {
        s = js_PublishMsgAsync(js, &msg, opts);
    }
    natsMsg_Destroy(msg);
    return if (s == @as(c_uint, @bitCast(NATS_OK))) s else nats_updateErrStack(s, "js_PublishAsync");
}
pub export fn js_PublishMsgAsync(arg_js: [*c]jsCtx, arg_msg: [*c][*c]natsMsg, arg_opts: [*c]jsPubOptions) natsStatus {
    var js = arg_js;
    _ = &js;
    var msg = arg_msg;
    _ = &msg;
    ...
    _ = &nc;
    var replyBuf: [41]u8 = undefined;
    _ = &replyBuf;
    var reply: [*c]u8 = @as([*c]u8, @ptrCast(@alignCast(&replyBuf)));
    _ = &reply;
    var mw: i64 = 0;
    _ = &mw;
    if (((js == @as([*c]jsCtx, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) or (msg == @as([*c][*c]natsMsg, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0)))))))) or (msg.* == @as([*c]natsMsg, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0)))))))) return nats_setErrorReal("./src/submodules/nats.c/src/js.c", "js_PublishMsgAsync", @as(c_int, 1017), @as(c_uint, @bitCast(NATS_INVALID_ARG)), "%s", natsStatus_GetText(@as(c_uint, @bitCast(NATS_INVALID_ARG))));
    if (js.*.rpreLen > @as(c_int, 32)) {
        reply = @as([*c]u8, @ptrCast(@alignCast(malloc(@as(c_ulong, @bitCast(@as(c_long, (js.*.rpreLen + @as(c_int, 8)) + @as(c_int, 1))))))));
        if (reply == @as([*c]u8, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) return nats_setErrorReal("./src/submodules/nats.c/src/js.c", "js_PublishMsgAsync", @as(c_int, 1023), @as(c_uint, @bitCast(NATS_NO_MEMORY)), "%s", natsStatus_GetText(@as(c_uint, @bitCast(NATS_NO_MEMORY))));
    }
    if (opts != @as([*c]jsPubOptions, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) {
        mw = opts.*.MaxWait;
        s = _setHeadersFromOptions(msg.*, opts);
    ...
    if (s == @as(c_uint, @bitCast(NATS_OK))) {
        s = _registerPubMsg(&nc, reply, js, msg.*, mw);
    }
    if (s == @as(c_uint, @bitCast(NATS_OK))) {
        s = natsConn_publish(nc, msg.*, @as([*c]const u8, @ptrCast(@alignCast(reply))), @as(c_int, 0) != 0);
        if (s != @as(c_uint, @bitCast(NATS_OK))) {
            var id: [*c]u8 = reply + @as(usize, @bitCast(@as(isize, @intCast(js.*.rpreLen))));
            _ = &id;
            _ = natsMutex_Lock(js.*.mu);
            if (natsStrHash_Remove(js.*.pm, id) == @as(?*anyopaque, @ptrFromInt(@as(c_int, 0)))) {
                s = @as(c_uint, @bitCast(NATS_OK));
            } else {
                js.*.pmcount -= 1;
            }
            _ = natsMutex_Unlock(js.*.mu);
    ...
    if (reply != @as([*c]u8, @ptrCast(@alignCast(&replyBuf)))) {
        free(@as(?*anyopaque, @ptrCast(reply)));
    }
    return if (s == @as(c_uint, @bitCast(NATS_OK))) s else nats_updateErrStack(s, "js_PublishMsgAsync");
}
pub export fn js_PublishAsyncComplete(arg_js: [*c]jsCtx, arg_opts: [*c]jsPubOptions) natsStatus {
    var js = arg_js;
    _ = &js;
    var opts = arg_opts;
    _ = &opts;
    ...
    var target: i64 = 0;
    _ = &target;
    if (js == @as([*c]jsCtx, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) return nats_setErrorReal("./src/submodules/nats.c/src/js.c", "js_PublishAsyncComplete", @as(c_int, 1077), @as(c_uint, @bitCast(NATS_INVALID_ARG)), "%s", natsStatus_GetText(@as(c_uint, @bitCast(NATS_INVALID_ARG))));
    if (opts != @as([*c]jsPubOptions, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) {
        s = _checkMaxWaitOpt(&ttl, opts);
        if (s != @as(c_uint, @bitCast(NATS_OK))) return if (s == @as(c_uint, @bitCast(NATS_OK))) s else nats_updateErrStack(s, "js_PublishAsyncComplete");
    }
    _ = natsMutex_Lock(js.*.mu);
    if ((js.*.pm == @as([*c]natsStrHash, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) or (js.*.pmcount == @as(i64, @bitCast(@as(c_long, @as(c_int, 0)))))) {
        _ = natsMutex_Unlock(js.*.mu);
        return @as(c_uint, @bitCast(NATS_OK));
    }
    if (ttl > @as(i64, @bitCast(@as(c_long, @as(c_int, 0))))) {
    ...
    js.*.pacw += 1;
    while ((s != @as(c_uint, @bitCast(NATS_TIMEOUT))) and (js.*.pmcount > @as(i64, @bitCast(@as(c_long, @as(c_int, 0)))))) {
        if (target > @as(i64, @bitCast(@as(c_long, @as(c_int, 0))))) {
    ...
    js.*.pacw -= 1;
    if ((s == @as(c_uint, @bitCast(NATS_TIMEOUT))) and (js.*.pmcount == @as(i64, @bitCast(@as(c_long, @as(c_int, 0)))))) {
        s = @as(c_uint, @bitCast(NATS_OK));
    }
    js_unlockAndRelease(js);
    return if (s == @as(c_uint, @bitCast(NATS_OK))) s else nats_updateErrStack(s, "js_PublishAsyncComplete");
}
pub export fn js_PublishAsyncGetPendingList(arg_pending: [*c]natsMsgList, arg_js: [*c]jsCtx) natsStatus {
    var pending = arg_pending;
    _ = &pending;
    var js = arg_js;
    _ = &js;
    var s: natsStatus = @as(c_uint, @bitCast(NATS_OK));
    ...
    var count: c_int = 0;
    _ = &count;
    if ((pending == @as([*c]natsMsgList, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) or (js == @as([*c]jsCtx, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0)))))))) return nats_setErrorReal("./src/submodules/nats.c/src/js.c", "js_PublishAsyncGetPendingList", @as(c_int, 1122), @as(c_uint, @bitCast(NATS_INVALID_ARG)), "%s", natsStatus_GetText(@as(c_uint, @bitCast(NATS_INVALID_ARG))));
    _ = natsMutex_Lock(js.*.mu);
    if ((blk: {
        const tmp = js.*.pm.*.used;
        count = tmp;
        break :blk tmp;
    }) == @as(c_int, 0)) {
        _ = natsMutex_Unlock(js.*.mu);
    ...
    pending.*.Msgs = @as([*c][*c]natsMsg, @ptrCast(@alignCast(calloc(@as(c_ulong, @bitCast(@as(c_long, count))), @sizeOf([*c]natsMsg)))));
    if (pending.*.Msgs == @as([*c][*c]natsMsg, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) {
        s = nats_setErrorReal("./src/submodules/nats.c/src/js.c", "js_PublishAsyncGetPendingList", @as(c_int, 1132), @as(c_uint, @bitCast(NATS_NO_MEMORY)), "%s", natsStatus_GetText(@as(c_uint, @bitCast(NATS_NO_MEMORY))));
    } else {
        var iter: natsStrHashIter = undefined;
        _ = &iter;
        ...
        while (natsStrHashIter_Next(&iter, null, &val)) {
            (blk: {
                ...
                if (tmp >= 0) break :blk pending.*.Msgs + @as(usize, @intCast(tmp)) else break :blk pending.*.Msgs - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
            }).* = @as([*c]natsMsg, @ptrCast(@alignCast(val)));
            _ = natsStrHashIter_RemoveCurrent(&iter);
            if (js.*.pmcount > @as(i64, @bitCast(@as(c_long, @as(c_int, 0))))) {
                js.*.pmcount -= 1;
            }
        }
        pending.*.Count = count;
    ...
    return if (s == @as(c_uint, @bitCast(NATS_OK))) s else nats_updateErrStack(s, "js_PublishAsyncGetPendingList");
}
pub export fn jsSubOptions_Init(arg_opts: [*c]jsSubOptions) natsStatus {
    var opts = arg_opts;
    _ = &opts;
    if (opts == @as([*c]jsSubOptions, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) return nats_setErrorReal("./src/submodules/nats.c/src/js.c", "jsSubOptions_Init", @as(c_int, 1161), @as(c_uint, @bitCast(NATS_INVALID_ARG)), "%s", natsStatus_GetText(@as(c_uint, @bitCast(NATS_INVALID_ARG))));
    _ = memset(@as(?*anyopaque, @ptrCast(opts)), @as(c_int, 0), @sizeOf(jsSubOptions));
    opts.*.Config.AckPolicy = @as(c_uint, @bitCast(-@as(c_int, 1)));
    opts.*.Config.DeliverPolicy = @as(c_uint, @bitCast(-@as(c_int, 1)));
    opts.*.Config.ReplayPolicy = @as(c_uint, @bitCast(-@as(c_int, 1)));
    return @as(c_uint, @bitCast(NATS_OK));
}
pub export fn js_Subscribe(arg_sub: [*c][*c]natsSubscription, arg_js: [*c]jsCtx, arg_subject: [*c]const u8, arg_cb: natsMsgHandler, arg_cbClosure: ?*anyopaque, arg_jsOpts: [*c]jsOptions, arg_opts: [*c]jsSubOptions, arg_errCode: [*c]jsErrCode) natsStatus {
    var sub = arg_sub;
    _ = &sub;
    var js = arg_js;
    _ = &js;
    ...
    var cb = arg_cb;
    _ = &cb;
    var cbClosure = arg_cbClosure;
    _ = &cbClosure;
    var jsOpts = arg_jsOpts;
    _ = &jsOpts;
    var opts = arg_opts;
    _ = &opts;
    var errCode = arg_errCode;
    ...
    if (cb == @as(natsMsgHandler, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) return nats_setErrorReal("./src/submodules/nats.c/src/js.c", "js_Subscribe", @as(c_int, 2844), @as(c_uint, @bitCast(NATS_INVALID_ARG)), "%s", natsStatus_GetText(@as(c_uint, @bitCast(NATS_INVALID_ARG))));
    s = _subscribe(sub, js, subject, null, cb, cbClosure, @as(c_int, 0) != 0, jsOpts, opts, errCode);
    return if (s == @as(c_uint, @bitCast(NATS_OK))) s else nats_updateErrStack(s, "js_Subscribe");
}
pub export fn js_SubscribeMulti(arg_sub: [*c][*c]natsSubscription, arg_js: [*c]jsCtx, arg_subjects: [*c][*c]const u8, arg_numSubjects: c_int, arg_cb: natsMsgHandler, arg_cbClosure: ?*anyopaque, arg_jsOpts: [*c]jsOptions, arg_opts: [*c]jsSubOptions, arg_errCode: [*c]jsErrCode) natsStatus {
    var sub = arg_sub;
    _ = &sub;
    var js = arg_js;
    _ = &js;
    ...
    _ = &subjects;
    var numSubjects = arg_numSubjects;
    _ = &numSubjects;
    var cb = arg_cb;
    _ = &cb;
    var cbClosure = arg_cbClosure;
    ...
    if (cb == @as(natsMsgHandler, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) return nats_setErrorReal("./src/submodules/nats.c/src/js.c", "js_SubscribeMulti", @as(c_int, 2861), @as(c_uint, @bitCast(NATS_INVALID_ARG)), "%s", natsStatus_GetText(@as(c_uint, @bitCast(NATS_INVALID_ARG))));
    s = _subscribeMulti(sub, js, subjects, numSubjects, null, cb, cbClosure, @as(c_int, 0) != 0, jsOpts, opts, errCode);
    return if (s == @as(c_uint, @bitCast(NATS_OK))) s else nats_updateErrStack(s, "js_SubscribeMulti");
}
pub export fn js_SubscribeSync(arg_sub: [*c][*c]natsSubscription, arg_js: [*c]jsCtx, arg_subject: [*c]const u8, arg_jsOpts: [*c]jsOptions, arg_opts: [*c]jsSubOptions, arg_errCode: [*c]jsErrCode) natsStatus {
    var sub = arg_sub;
    _ = &sub;
    var js = arg_js;
    _ = &js;
    ...
    s = _subscribe(sub, js, subject, null, null, @as(?*anyopaque, @ptrFromInt(@as(c_int, 0))), @as(c_int, 0) != 0, jsOpts, opts, errCode);
    return if (s == @as(c_uint, @bitCast(NATS_OK))) s else nats_updateErrStack(s, "js_SubscribeSync");
}
pub export fn js_SubscribeSyncMulti(arg_sub: [*c][*c]natsSubscription, arg_js: [*c]jsCtx, arg_subjects: [*c][*c]const u8, arg_numSubjects: c_int, arg_jsOpts: [*c]jsOptions, arg_opts: [*c]jsSubOptions, arg_errCode: [*c]jsErrCode) natsStatus {
    var sub = arg_sub;
    _ = &sub;
    var js = arg_js;
    _ = &js;
    ...
    s = _subscribeMulti(sub, js, subjects, numSubjects, null, null, @as(?*anyopaque, @ptrFromInt(@as(c_int, 0))), @as(c_int, 0) != 0, jsOpts, opts, errCode);
    return if (s == @as(c_uint, @bitCast(NATS_OK))) s else nats_updateErrStack(s, "js_SubscribeSyncMulti");
}
pub export fn js_PullSubscribe(arg_sub: [*c][*c]natsSubscription, arg_js: [*c]jsCtx, arg_subject: [*c]const u8, arg_durable: [*c]const u8, arg_jsOpts: [*c]jsOptions, arg_opts: [*c]jsSubOptions, arg_errCode: [*c]jsErrCode) natsStatus {
    var sub = arg_sub;
    _ = &sub;
    var js = arg_js;
    _ = &js;
    ...
    s = _subscribe(sub, js, subject, durable, null, @as(?*anyopaque, @ptrFromInt(@as(c_int, 0))), @as(c_int, 1) != 0, jsOpts, opts, errCode);
    return if (s == @as(c_uint, @bitCast(NATS_OK))) s else nats_updateErrStack(s, "js_PullSubscribe");
}
pub export fn natsSubscription_Fetch(arg_list: [*c]natsMsgList, arg_sub: [*c]natsSubscription, arg_batch: c_int, arg_timeout: i64, arg_errCode: [*c]jsErrCode) natsStatus {
    var list = arg_list;
    _ = &list;
    var sub = arg_sub;
    _ = &sub;
    ...
    var s: natsStatus = undefined;
    _ = &s;
    var req: jsFetchRequest = undefined;
    _ = &req;
    if (errCode != @as([*c]jsErrCode, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) {
        errCode.* = 0;
    }
    _ = jsFetchRequest_Init(&req);
    req.Batch = batch;
    req.Expires = timeout * @as(i64, @intFromFloat(1000000.0));
    s = _fetch(list, sub, &req, @as(c_int, 1) != 0);
    return if (s == @as(c_uint, @bitCast(NATS_OK))) s else nats_updateErrStack(s, "natsSubscription_Fetch");
}
pub export fn jsFetchRequest_Init(arg_request: [*c]jsFetchRequest) natsStatus {
    var request = arg_request;
    _ = &request;
    if (request == @as([*c]jsFetchRequest, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) return nats_setErrorReal("./src/submodules/nats.c/src/js.c", "jsFetchRequest_Init", @as(c_int, 2055), @as(c_uint, @bitCast(NATS_INVALID_ARG)), "%s", natsStatus_GetText(@as(c_uint, @bitCast(NATS_INVALID_ARG))));
    _ = memset(@as(?*anyopaque, @ptrCast(request)), @as(c_int, 0), @sizeOf(jsFetchRequest));
    return @as(c_uint, @bitCast(NATS_OK));
}
pub export fn js_PullSubscribeAsync(arg_newsub: [*c][*c]natsSubscription, arg_js: [*c]jsCtx, arg_subject: [*c]const u8, arg_durable: [*c]const u8, arg_msgCB: natsMsgHandler, arg_msgCBClosure: ?*anyopaque, arg_jsOpts: [*c]jsOptions, arg_opts: [*c]jsSubOptions, arg_errCode: [*c]jsErrCode) natsStatus {
    var newsub = arg_newsub;
    _ = &newsub;
    var js = arg_js;
    _ = &js;
    var subject = arg_subject;
    ...
    var msgCB = arg_msgCB;
    _ = &msgCB;
    var msgCBClosure = arg_msgCBClosure;
    _ = &msgCBClosure;
    var jsOpts = arg_jsOpts;
    _ = &jsOpts;
    var opts = arg_opts;
    ...
    _ = &sub;
    var jsi: [*c]jsSub = null;
    _ = &jsi;
    var fetch: [*c]jsFetch = null;
    _ = &fetch;
    if ((newsub == @as([*c][*c]natsSubscription, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) or (msgCB == @as(natsMsgHandler, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0)))))))) return nats_setErrorReal("./src/submodules/nats.c/src/js.c", "js_PullSubscribeAsync", @as(c_int, 3012), @as(c_uint, @bitCast(NATS_INVALID_ARG)), "%s", natsStatus_GetText(@as(c_uint, @bitCast(NATS_INVALID_ARG))));
    if ((jsOpts != @as([*c]jsOptions, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) and (jsOpts.*.PullSubscribeAsync.KeepAhead > @as(c_int, 0))) {
        if (jsOpts.*.PullSubscribeAsync.MaxBytes > @as(i64, @bitCast(@as(c_long, @as(c_int, 0))))) return nats_setErrorReal("./src/submodules/nats.c/src/js.c", "js_PullSubscribeAsync", @as(c_int, 3017), @as(c_uint, @bitCast(NATS_INVALID_ARG)), "%s", "Can not use MaxBytes and KeepAhead together");
        if (jsOpts.*.PullSubscribeAsync.NoWait) return nats_setErrorReal("./src/submodules/nats.c/src/js.c", "js_PullSubscribeAsync", @as(c_int, 3019), @as(c_uint, @bitCast(NATS_INVALID_ARG)), "%s", "Can not use NoWait with KeepAhead together");
    }
    if (errCode != @as([*c]jsErrCode, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) {
        errCode.* = 0;
    }
    s = _subscribe(&sub, js, subject, durable, msgCB, msgCBClosure, @as(c_int, 1) != 0, jsOpts, opts, errCode);
    if (s == @as(c_uint, @bitCast(NATS_OK))) {
        fetch = @as([*c]jsFetch, @ptrCast(@alignCast(calloc(@as(c_ulong, @bitCast(@as(c_long, @as(c_int, 1)))), @sizeOf(jsFetch)))));
        if (fetch == @as([*c]jsFetch, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) {
            s = nats_setErrorReal("./src/submodules/nats.c/src/js.c", "js_PullSubscribeAsync", @as(c_int, 3033), @as(c_uint, @bitCast(NATS_NO_MEMORY)), "%s", natsStatus_GetText(@as(c_uint, @bitCast(NATS_NO_MEMORY))));
        }
    }
    if (s != @as(c_uint, @bitCast(NATS_OK))) {
        free(@as(?*anyopaque, @ptrCast(fetch)));
        natsSubscription_Destroy(sub);
        return if (s == @as(c_uint, @bitCast(NATS_OK))) s else nats_updateErrStack(s, "js_PullSubscribeAsync");
    }
    fetch.*.status = @as(c_uint, @bitCast(NATS_OK));
    fetch.*.startTimeMillis = nats_Now();
    if (jsOpts != @as([*c]jsOptions, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) {
        fetch.*.opts = jsOpts.*.PullSubscribeAsync;
    }
    if (fetch.*.opts.FetchSize == @as(c_int, 0)) {
        fetch.*.opts.FetchSize = 128;
    }
    if (fetch.*.opts.NextHandler == @as(jsFetchNextHandler, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) {
        fetch.*.opts.NextHandler = &_autoNextFetchRequest;
        fetch.*.opts.NextHandlerClosure = @as(?*anyopaque, @ptrCast(fetch));
    }
    nats_lockSubAndDispatcher(sub);
    jsi = sub.*.jsi;
    jsi.*.fetch = fetch;
    jsi.*.inFetch = @as(c_int, 1) != 0;
    if (fetch.*.opts.Timeout > @as(i64, @bitCast(@as(c_long, @as(c_int, 0))))) {
        sub.*.refs += 1;
        s = natsTimer_Create(&fetch.*.expiresTimer, &_fetchExpiredFired, &_releaseSubWhenStopped, fetch.*.opts.Timeout, @as(?*anyopaque, @ptrCast(sub)));
        if (s != @as(c_uint, @bitCast(NATS_OK))) {
            sub.*.refs -= 1;
        }
    }
    if ((s == @as(c_uint, @bitCast(NATS_OK))) and (fetch.*.opts.Heartbeat > @as(i64, @bitCast(@as(c_long, @as(c_int, 0)))))) {
        var dur: i64 = fetch.*.opts.Heartbeat * @as(i64, @bitCast(@as(c_long, @as(c_int, 2))));
        _ = &dur;
        sub.*.refs += 1;
        if (jsi.*.hbTimer == @as([*c]natsTimer, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) {
            s = natsTimer_Create(&jsi.*.hbTimer, &_hbTimerFired, &_releaseSubWhenStopped, dur, @as(?*anyopaque, @ptrCast(sub)));
            if (s != @as(c_uint, @bitCast(NATS_OK))) {
                sub.*.refs -= 1;
            }
        } else {
...
pub export fn natsSubscription_FetchRequest(arg_list: [*c]natsMsgList, arg_sub: [*c]natsSubscription, arg_req: [*c]jsFetchRequest) natsStatus {
    var list = arg_list;
    _ = &list;
    var sub = arg_sub;
    _ = &sub;
    ...
    var s: natsStatus = undefined;
    _ = &s;
    s = _fetch(list, sub, req, @as(c_int, 0) != 0);
    return if (s == @as(c_uint, @bitCast(NATS_OK))) s else nats_updateErrStack(s, "natsSubscription_FetchRequest");
}
pub export fn natsSubscription_GetConsumerInfo(arg_ci: [*c][*c]jsConsumerInfo, arg_sub: [*c]natsSubscription, arg_opts: [*c]jsOptions, arg_errCode: [*c]jsErrCode) natsStatus {
    var ci = arg_ci;
    _ = &ci;
    var sub = arg_sub;
    _ = &sub;
    ...
    var errCode = arg_errCode;
    _ = &errCode;
    var consumer: [*c]u8 = null;
    _ = &consumer;
    var stream: [*c]const u8 = null;
    _ = &stream;
    var js: [*c]jsCtx = null;
    _ = &js;
    var s: natsStatus = @as(c_uint, @bitCast(NATS_OK));
    _ = &s;
    if ((ci == @as([*c][*c]jsConsumerInfo, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) or (sub == @as([*c]natsSubscription, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0)))))))) return nats_setErrorReal("./src/submodules/nats.c/src/js.c", "natsSubscription_GetConsumerInfo", @as(c_int, 1617), @as(c_uint, @bitCast(NATS_INVALID_ARG)), "%s", natsStatus_GetText(@as(c_uint, @bitCast(NATS_INVALID_ARG))));
    natsSub_Lock(sub);
    if ((sub.*.jsi == @as([*c]jsSub, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) or (sub.*.jsi.*.consumer == @as([*c]u8, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0)))))))) {
        natsSub_Unlock(sub);
        return nats_setErrorReal("./src/submodules/nats.c/src/js.c", "natsSubscription_GetConsumerInfo", @as(c_int, 1623), @as(c_uint, @bitCast(NATS_INVALID_SUBSCRIPTION)), "%s", natsStatus_GetText(@as(c_uint, @bitCast(NATS_INVALID_SUBSCRIPTION))));
    }
    js = sub.*.jsi.*.js;
    stream = @as([*c]const u8, @ptrCast(@alignCast(sub.*.jsi.*.stream)));
    {
        consumer = strdup(sub.*.jsi.*.consumer);
        if (consumer == @as([*c]u8, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) {
            s = nats_setErrorReal("./src/submodules/nats.c/src/js.c", "natsSubscription_GetConsumerInfo", @as(c_int, 1627), @as(c_uint, @bitCast(NATS_NO_MEMORY)), "%s", natsStatus_GetText(@as(c_uint, @bitCast(NATS_NO_MEMORY))));
        }
    }
    if (s == @as(c_uint, @bitCast(NATS_OK))) {
        sub.*.refs += 1;
    ...
    if (s == @as(c_uint, @bitCast(NATS_OK))) {
        ...
        free(@as(?*anyopaque, @ptrCast(consumer)));
        natsSub_release(sub);
    }
    return if (s == @as(c_uint, @bitCast(NATS_OK))) s else nats_updateErrStack(s, "natsSubscription_GetConsumerInfo");
}
pub export fn natsSubscription_GetSequenceMismatch(arg_csm: [*c]jsConsumerSequenceMismatch, arg_sub: [*c]natsSubscription) natsStatus {
    var csm = arg_csm;
    _ = &csm;
    var sub = arg_sub;
    _ = &sub;
    var jsi: [*c]jsSub = undefined;
    _ = &jsi;
    var m: [*c]struct_mismatch_61 = null;
    _ = &m;
    if ((csm == @as([*c]jsConsumerSequenceMismatch, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) or (sub == @as([*c]natsSubscription, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0)))))))) return nats_setErrorReal("./src/submodules/nats.c/src/js.c", "natsSubscription_GetSequenceMismatch", @as(c_int, 1648), @as(c_uint, @bitCast(NATS_INVALID_ARG)), "%s", natsStatus_GetText(@as(c_uint, @bitCast(NATS_INVALID_ARG))));
    nats_lockSubAndDispatcher(sub);
    if (sub.*.jsi == @as([*c]jsSub, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) {
        nats_unlockSubAndDispatcher(sub);
        return nats_setErrorReal("./src/submodules/nats.c/src/js.c", "natsSubscription_GetSequenceMismatch", @as(c_int, 1654), @as(c_uint, @bitCast(NATS_INVALID_SUBSCRIPTION)), "%s", "not a JetStream subscription");
    }
    jsi = sub.*.jsi;
    m = &jsi.*.mismatch;
    if (m.*.dseq == m.*.ldseq) {
    ...
    _ = memset(@as(?*anyopaque, @ptrCast(csm)), @as(c_int, 0), @sizeOf(jsConsumerSequenceMismatch));
    csm.*.Stream = m.*.sseq;
...
pub export fn natsMsg_GetMetaData(arg_new_meta: [*c][*c]jsMsgMetaData, arg_msg: [*c]natsMsg) natsStatus {
    var new_meta = arg_new_meta;
    _ = &new_meta;
    var msg = arg_msg;
    _ = &msg;
    var meta: [*c]jsMsgMetaData = null;
    _ = &meta;
    var s: natsStatus = undefined;
    _ = &s;
    if ((new_meta == @as([*c][*c]jsMsgMetaData, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) or (msg == @as([*c]natsMsg, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0)))))))) return nats_setErrorReal("./src/submodules/nats.c/src/js.c", "natsMsg_GetMetaData", @as(c_int, 3251), @as(c_uint, @bitCast(NATS_INVALID_ARG)), "%s", natsStatus_GetText(@as(c_uint, @bitCast(NATS_INVALID_ARG))));
    if (msg.*.sub == @as([*c]struct___natsSubscription, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) return nats_setErrorReal("./src/submodules/nats.c/src/js.c", "natsMsg_GetMetaData", @as(c_int, 3254), @as(c_uint, @bitCast(NATS_ILLEGAL_STATE)), "%s", "message not bound to a subscription");
    if ((if ((msg.*.reply == @as([*c]const u8, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) or (@as(c_int, @bitCast(@as(c_uint, msg.*.reply[@as(c_uint, @intCast(@as(c_int, 0)))]))) == @as(c_int, '\x00'))) @as(c_int, 1) else @as(c_int, 0)) != 0) return nats_setErrorReal("./src/submodules/nats.c/src/js.c", "natsMsg_GetMetaData", @as(c_int, 3257), @as(c_uint, @bitCast(NATS_ILLEGAL_STATE)), "%s", "not a JetStream message");
    if (strstr(msg.*.reply, "$JS.ACK.") != @as([*c]u8, @ptrCast(@volatileCast(@constCast(msg.*.reply))))) return nats_setErrorReal("./src/submodules/nats.c/src/js.c", "natsMsg_GetMetaData", @as(c_int, 3260), @as(c_uint, @bitCast(NATS_ERR)), "invalid meta data '%s'", msg.*.reply);
    meta = @as([*c]jsMsgMetaData, @ptrCast(@alignCast(calloc(@as(c_ulong, @bitCast(@as(c_long, @as(c_int, 1)))), @sizeOf(jsMsgMetaData)))));
    if (meta == @as([*c]jsMsgMetaData, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) return nats_setErrorReal("./src/submodules/nats.c/src/js.c", "natsMsg_GetMetaData", @as(c_int, 3264), @as(c_uint, @bitCast(NATS_NO_MEMORY)), "%s", natsStatus_GetText(@as(c_uint, @bitCast(NATS_NO_MEMORY))));
    s = js_getMetaData(msg.*.reply + @as(usize, @bitCast(@as(isize, @intCast(@as(c_int, 8))))), &meta.*.Domain, &meta.*.Stream, &meta.*.Consumer, &meta.*.NumDelivered, &meta.*.Sequence.Stream, &meta.*.Sequence.Consumer, &meta.*.Timestamp, &meta.*.NumPending, @as(c_int, 8));
    if (s == @as(c_uint, @bitCast(NATS_ERR))) {
        s = nats_setErrorReal("./src/submodules/nats.c/src/js.c", "natsMsg_GetMetaData", @as(c_int, 3277), @as(c_uint, @bitCast(NATS_ERR)), "invalid meta data '%s'", msg.*.reply);
    }
    if (s == @as(c_uint, @bitCast(NATS_OK))) {
        new_meta.* = meta;
    } else {
    ...
    return if (s == @as(c_uint, @bitCast(NATS_OK))) s else nats_updateErrStack(s, "natsMsg_GetMetaData");
}
pub export fn jsMsgMetaData_Destroy(arg_meta: [*c]jsMsgMetaData) void {
    var meta = arg_meta;
    _ = &meta;
    if (meta == @as([*c]jsMsgMetaData, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) return;
    free(@as(?*anyopaque, @ptrCast(meta.*.Stream)));
    free(@as(?*anyopaque, @ptrCast(meta.*.Consumer)));
    free(@as(?*anyopaque, @ptrCast(meta.*.Domain)));
    free(@as(?*anyopaque, @ptrCast(meta)));
}
pub const struct___ackOpts = extern struct {
    ackType: [*c]const u8 = @import("std").mem.zeroes([*c]const u8),
    inProgress: bool = @import("std").mem.zeroes(bool),
    sync: bool = @import("std").mem.zeroes(bool),
    nakDelay: i64 = @import("std").mem.zeroes(i64),
};
pub const _ackOpts = struct___ackOpts;
pub export fn natsMsg_Ack(arg_msg: [*c]natsMsg, arg_opts: [*c]jsOptions) natsStatus {
    var msg = arg_msg;
    _ = &msg;
    var opts = arg_opts;
    _ = &opts;
    var s: natsStatus = undefined;
    _ = &s;
    var o: _ackOpts = _ackOpts{
        .ackType = "+ACK",
        .inProgress = @as(c_int, 0) != 0,
        .sync = @as(c_int, 0) != 0,
        .nakDelay = @as(i64, @bitCast(@as(c_long, @as(c_int, 0)))),
    };
    _ = &o;
    s = _ackMsg(msg, opts, &o, null);
    return if (s == @as(c_uint, @bitCast(NATS_OK))) s else nats_updateErrStack(s, "natsMsg_Ack");
}
pub export fn natsMsg_AckSync(arg_msg: [*c]natsMsg, arg_opts: [*c]jsOptions, arg_errCode: [*c]jsErrCode) natsStatus {
    var msg = arg_msg;
    _ = &msg;
    var opts = arg_opts;
    _ = &opts;
    ...
    return if (s == @as(c_uint, @bitCast(NATS_OK))) s else nats_updateErrStack(s, "natsMsg_AckSync");
}
pub export fn natsMsg_Nak(arg_msg: [*c]natsMsg, arg_opts: [*c]jsOptions) natsStatus {
    var msg = arg_msg;
    _ = &msg;
    var opts = arg_opts;
    _ = &opts;
    ...
    _ = &o;
    s = _ackMsg(msg, opts, &o, null);
    return if (s == @as(c_uint, @bitCast(NATS_OK))) s else nats_updateErrStack(s, "natsMsg_Nak");
}
pub export fn natsMsg_NakWithDelay(arg_msg: [*c]natsMsg, arg_delay: i64, arg_opts: [*c]jsOptions) natsStatus {
    var msg = arg_msg;
    _ = &msg;
    var delay = arg_delay;
    _ = &delay;
    ...
    _ = &o;
    s = _ackMsg(msg, opts, &o, null);
    return if (s == @as(c_uint, @bitCast(NATS_OK))) s else nats_updateErrStack(s, "natsMsg_NakWithDelay");
}
pub export fn natsMsg_InProgress(arg_msg: [*c]natsMsg, arg_opts: [*c]jsOptions) natsStatus {
    var msg = arg_msg;
    _ = &msg;
    var opts = arg_opts;
    _ = &opts;
    ...
    var o: _ackOpts = _ackOpts{
        .ackType = "+WPI",
        .inProgress = @as(c_int, 1) != 0,
        .sync = @as(c_int, 0) != 0,
        .nakDelay = @as(i64, @bitCast(@as(c_long, @as(c_int, 0)))),
    };
    _ = &o;
    s = _ackMsg(msg, opts, &o, null);
    return if (s == @as(c_uint, @bitCast(NATS_OK))) s else nats_updateErrStack(s, "natsMsg_InProgress");
}
pub export fn natsMsg_Term(arg_msg: [*c]natsMsg, arg_opts: [*c]jsOptions) natsStatus {
    var msg = arg_msg;
    _ = &msg;
    var opts = arg_opts;
    _ = &opts;
    ...
    _ = &o;
    s = _ackMsg(msg, opts, &o, null);
    return if (s == @as(c_uint, @bitCast(NATS_OK))) s else nats_updateErrStack(s, "natsMsg_Term");
}
...
pub export fn jsSub_free(arg_jsi: [*c]jsSub) void {
    var jsi = arg_jsi;
    _ = &jsi;
    var js: [*c]jsCtx = null;
    _ = &js;
    if (jsi == @as([*c]jsSub, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) return;
    _destroyFetch(jsi.*.fetch);
    js = jsi.*.js;
    natsTimer_Destroy(jsi.*.hbTimer);
    free(@as(?*anyopaque, @ptrCast(jsi.*.stream)));
    free(@as(?*anyopaque, @ptrCast(jsi.*.consumer)));
    free(@as(?*anyopaque, @ptrCast(jsi.*.nxtMsgSubj)));
    free(@as(?*anyopaque, @ptrCast(jsi.*.cmeta)));
    free(@as(?*anyopaque, @ptrCast(jsi.*.fcReply)));
    free(@as(?*anyopaque, @ptrCast(jsi.*.psubj)));
    js_destroyConsumerConfig(jsi.*.ocCfg);
    free(@as(?*anyopaque, @ptrCast(jsi)));
    js_release(js);
}
pub export fn jsSub_deleteConsumer(arg_sub: [*c]natsSubscription) natsStatus {
    var sub = arg_sub;
    _ = &sub;
    var js: [*c]jsCtx = null;
    _ = &js;
    var stream: [*c]const u8 = null;
    _ = &stream;
    var consumer: [*c]const u8 = null;
    _ = &consumer;
    var s: natsStatus = undefined;
    _ = &s;
    natsSub_Lock(sub);
    if ((sub.*.jsi != @as([*c]jsSub, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) and (@as(c_int, @intFromBool(sub.*.jsi.*.dc)) != 0)) {
        js = sub.*.jsi.*.js;
        stream = sub.*.jsi.*.stream;
        consumer = sub.*.jsi.*.consumer;
        sub.*.jsi.*.dc = @as(c_int, 0) != 0;
    }
    natsSub_Unlock(sub);
    if (((js == @as([*c]jsCtx, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) or (stream == @as([*c]const u8, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0)))))))) or (consumer == @as([*c]const u8, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0)))))))) return @as(c_uint, @bitCast(NATS_OK));
    s = js_DeleteConsumer(js, stream, consumer, null, null);
    if (s == @as(c_uint, @bitCast(NATS_NOT_FOUND))) {
        s = nats_setErrorReal("./src/submodules/nats.c/src/js.c", "jsSub_deleteConsumer", @as(c_int, 1301), s, "failed to delete consumer '%s': not found", consumer);
    }
    return if (s == @as(c_uint, @bitCast(NATS_OK))) s else nats_updateErrStack(s, "jsSub_deleteConsumer");
}
pub export fn jsSub_deleteConsumerAfterDrain(arg_sub: [*c]natsSubscription) void {
    var sub = arg_sub;
    _ = &sub;
    var nc: [*c]natsConnection = null;
    _ = &nc;
    ...
    var s: natsStatus = undefined;
    _ = &s;
    if ((sub.*.jsi == @as([*c]jsSub, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) or !sub.*.jsi.*.dc) return;
    nc = sub.*.conn;
    consumer = sub.*.jsi.*.consumer;
    natsSub_Unlock(sub);
    ...
    if (s != @as(c_uint, @bitCast(NATS_OK))) {
        ...
        _ = snprintf(@as([*c]u8, @ptrCast(@alignCast(&tmp))), @sizeOf([256]u8), "failed to delete consumer '%s': %u (%s)", consumer, s, natsStatus_GetText(s));
        natsAsyncCb_PostErrHandler(nc, sub, s, strdup(@as([*c]u8, @ptrCast(@alignCast(&tmp)))));
        _ = natsMutex_Unlock(nc.*.mu);
    }
    natsSub_Lock(sub);
}
pub export fn jsSub_trackSequences(arg_jsi: [*c]jsSub, arg_reply: [*c]const u8) natsStatus {
    var jsi = arg_jsi;
    _ = &jsi;
    var reply = arg_reply;
    _ = &reply;
    ...
    if ((reply == @as([*c]const u8, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) or (strstr(reply, "$JS.ACK.") != @as([*c]u8, @ptrCast(@volatileCast(@constCast(reply)))))) return @as(c_uint, @bitCast(NATS_OK));
    jsi.*.fciseq +%= 1;
    free(@as(?*anyopaque, @ptrCast(jsi.*.cmeta)));
    {
        jsi.*.cmeta = strdup(reply + @as(usize, @bitCast(@as(isize, @intCast(@as(c_int, 8))))));
        if (jsi.*.cmeta == @as([*c]u8, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) {
            s = nats_setErrorReal("./src/submodules/nats.c/src/js.c", "jsSub_trackSequences", @as(c_int, 1532), @as(c_uint, @bitCast(NATS_NO_MEMORY)), "%s", natsStatus_GetText(@as(c_uint, @bitCast(NATS_NO_MEMORY))));
        }
    }
    return if (s == @as(c_uint, @bitCast(NATS_OK))) s else nats_updateErrStack(s, "jsSub_trackSequences");
}
pub export fn jsSub_processSequenceMismatch(arg_sub: [*c]natsSubscription, arg_msg: [*c]natsMsg, arg_sm: [*c]bool) natsStatus {
    var sub = arg_sub;
    _ = &sub;
    var msg = arg_msg;
    _ = &msg;
    ...
    var val: i64 = 0;
    _ = &val;
    var m: [*c]struct_mismatch_61 = &jsi.*.mismatch;
    _ = &m;
    var s: natsStatus = undefined;
    _ = &s;
    sm.* = @as(c_int, 0) != 0;
    jsi.*.active = @as(c_int, 1) != 0;
    if (jsi.*.cmeta == @as([*c]u8, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) return @as(c_uint, @bitCast(NATS_OK));
    s = js_getMetaData(jsi.*.cmeta, null, null, null, null, &m.*.sseq, &m.*.dseq, null, null, @as(c_int, 2));
    if (s != @as(c_uint, @bitCast(NATS_OK))) {
        if (s == @as(c_uint, @bitCast(NATS_ERR))) return nats_setErrorReal("./src/submodules/nats.c/src/js.c", "jsSub_processSequenceMismatch", @as(c_int, 1557), @as(c_uint, @bitCast(NATS_ERR)), "invalid JS ACK: '%s'", jsi.*.cmeta);
        return if (s == @as(c_uint, @bitCast(NATS_OK))) s else nats_updateErrStack(s, "jsSub_processSequenceMismatch");
    }
    s = natsMsgHeader_Get(msg, "Nats-Last-Consumer", &str);
    if (s != @as(c_uint, @bitCast(NATS_OK))) return if (s == @as(c_uint, @bitCast(NATS_OK))) s else nats_updateErrStack(s, "jsSub_processSequenceMismatch");
    if (str != @as([*c]const u8, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) {
        val = nats_ParseInt64(str, @as(c_int, @bitCast(@as(c_uint, @truncate(strlen(str))))));
        if (val == @as(i64, @bitCast(@as(c_long, -@as(c_int, 1))))) return nats_setErrorReal("./src/submodules/nats.c/src/js.c", "jsSub_processSequenceMismatch", @as(c_int, 1571), @as(c_uint, @bitCast(NATS_ERR)), "invalid last consumer sequence: '%s'", str);
        m.*.ldseq = @as(u64, @bitCast(val));
    }
    if (m.*.ldseq == m.*.dseq) {
        jsi.*.sm = @as(c_int, 0) != 0;
        jsi.*.ssmn = @as(c_int, 0) != 0;
    } else {
        if (jsi.*.ordered) {
            s = jsSub_resetOrderedConsumer(sub, jsi.*.sseq +% @as(u64, @bitCast(@as(c_long, @as(c_int, 1)))));
        } else if (!jsi.*.ssmn) {
            jsi.*.sm = @as(c_int, 1) != 0;
            jsi.*.ssmn = @as(c_int, 1) != 0;
            if (sub.*.msgCb != @as(natsMsgHandler, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) {
                sm.* = @as(c_int, 1) != 0;
            }
        }
    }
...
pub export fn jsSub_checkForFlowControlResponse(arg_sub: [*c]natsSubscription) [*c]u8 {
    var sub = arg_sub;
    _ = &sub;
    var jsi: [*c]jsSub = sub.*.jsi;
    _ = &jsi;
...
pub export fn jsSub_scheduleFlowControlResponse(arg_jsi: [*c]jsSub, arg_reply: [*c]const u8) natsStatus {
    var jsi = arg_jsi;
    _ = &jsi;
    var reply = arg_reply;
    _ = &reply;
    free(@as(?*anyopaque, @ptrCast(jsi.*.fcReply)));
    jsi.*.fcReply = strdup(reply);
    if (jsi.*.fcReply == @as([*c]u8, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) return nats_setErrorReal("./src/submodules/nats.c/src/js.c", "jsSub_scheduleFlowControlResponse", @as(c_int, 1694), @as(c_uint, @bitCast(NATS_NO_MEMORY)), "%s", natsStatus_GetText(@as(c_uint, @bitCast(NATS_NO_MEMORY))));
    jsi.*.fcDelivered = jsi.*.fciseq;
    return @as(c_uint, @bitCast(NATS_OK));
}
pub export fn jsSub_checkOrderedMsg(arg_sub: [*c]natsSubscription, arg_msg: [*c]natsMsg, arg_reset: [*c]bool) natsStatus {
    var sub = arg_sub;
    _ = &sub;
    var msg = arg_msg;
    _ = &msg;
    ...
    _ = &dseq;
    reset.* = @as(c_int, 0) != 0;
    if (natsMsg_GetReply(msg) == @as([*c]const u8, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) return @as(c_uint, @bitCast(NATS_OK));
    s = js_getMetaData(natsMsg_GetReply(msg), null, null, null, null, &sseq, &dseq, null, null, @as(c_int, 2));
    if (s == @as(c_uint, @bitCast(NATS_OK))) {
        jsi = sub.*.jsi;
        if (dseq != jsi.*.dseq) {
            reset.* = @as(c_int, 1) != 0;
            ...
            jsi.*.dseq = dseq +% @as(u64, @bitCast(@as(c_long, @as(c_int, 1))));
            jsi.*.sseq = sseq;
        }
    }
    return if (s == @as(c_uint, @bitCast(NATS_OK))) s else nats_updateErrStack(s, "jsSub_checkOrderedMsg");
}
pub const struct___jsOrderedConsInfo = extern struct {
    osid: i64 = @import("std").mem.zeroes(i64),
    nsid: i64 = @import("std").mem.zeroes(i64),
    sseq: u64 = @import("std").mem.zeroes(u64),
    nc: [*c]natsConnection = @import("std").mem.zeroes([*c]natsConnection),
    sub: [*c]natsSubscription = @import("std").mem.zeroes([*c]natsSubscription),
    ndlv: [*c]u8 = @import("std").mem.zeroes([*c]u8),
    thread: [*c]natsThread = @import("std").mem.zeroes([*c]natsThread),
    max: c_int = @import("std").mem.zeroes(c_int),
    done: bool = @import("std").mem.zeroes(bool),
};
pub const jsOrderedConsInfo = struct___jsOrderedConsInfo;
pub export fn jsSub_resetOrderedConsumer(arg_sub: [*c]natsSubscription, arg_sseq: u64) natsStatus {
    var sub = arg_sub;
    _ = &sub;
    var sseq = arg_sseq;
    _ = &sseq;
    ...
    var osid: i64 = 0;
    _ = &osid;
    var newDeliver: [*c]natsInbox = null;
    _ = &newDeliver;
    var oci: [*c]jsOrderedConsInfo = null;
    _ = &oci;
    var max: c_int = 0;
    _ = &max;
    ...
    var jsi: [*c]jsSub = sub.*.jsi;
    _ = &jsi;
    if (((jsi == @as([*c]jsSub, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) or (nc == @as([*c]natsConnection, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0)))))))) or (@as(c_int, @intFromBool(sub.*.closed)) != 0)) return @as(c_uint, @bitCast(NATS_OK));
    if (sub.*.max > @as(u64, @bitCast(@as(c_long, @as(c_int, 0))))) {
        if (sub.*.jsi.*.fciseq < sub.*.max) {
            max = @as(c_int, @bitCast(@as(c_uint, @truncate(sub.*.max -% jsi.*.fciseq))));
        } else {
            done = @as(c_int, 1) != 0;
        }
    }
    s = natsConn_newInbox(nc, &newDeliver);
    if (s != @as(c_uint, @bitCast(NATS_OK))) return if (s == @as(c_uint, @bitCast(NATS_OK))) s else nats_updateErrStack(s, "jsSub_resetOrderedConsumer");
    osid = applyNewSID(sub);
    free(@as(?*anyopaque, @ptrCast(sub.*.subject)));
    sub.*.subject = @as([*c]u8, @ptrCast(@alignCast(newDeliver)));
    oci = @as([*c]jsOrderedConsInfo, @ptrCast(@alignCast(calloc(@as(c_ulong, @bitCast(@as(c_long, @as(c_int, 1)))), @sizeOf(jsOrderedConsInfo)))));
    if (oci == @as([*c]jsOrderedConsInfo, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) {
        s = nats_setErrorReal("./src/submodules/nats.c/src/js.c", "jsSub_resetOrderedConsumer", @as(c_int, 3503), @as(c_uint, @bitCast(NATS_NO_MEMORY)), "%s", natsStatus_GetText(@as(c_uint, @bitCast(NATS_NO_MEMORY))));
    } else {
        oci.*.ndlv = strdup(@as([*c]u8, @ptrCast(@alignCast(newDeliver))));
        if (oci.*.ndlv == @as([*c]u8, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) {
            s = nats_setErrorReal("./src/submodules/nats.c/src/js.c", "jsSub_resetOrderedConsumer", @as(c_int, 3505), @as(c_uint, @bitCast(NATS_NO_MEMORY)), "%s", natsStatus_GetText(@as(c_uint, @bitCast(NATS_NO_MEMORY))));
        }
    }
    if (s == @as(c_uint, @bitCast(NATS_OK))) {
        jsi.*.dseq = 1;
        ...
        oci.*.done = done;
        natsSub_retain(sub);
        s = natsThread_Create(&oci.*.thread, &_recreateOrderedCons, @as(?*anyopaque, @ptrCast(oci)));
        if (s != @as(c_uint, @bitCast(NATS_OK))) {
            free(@as(?*anyopaque, @ptrCast(oci)));
            natsSub_release(sub);
        }
    }
    if ((s != @as(c_uint, @bitCast(NATS_OK))) and (oci != @as([*c]jsOrderedConsInfo, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0)))))))) {
        free(@as(?*anyopaque, @ptrCast(oci.*.ndlv)));
        free(@as(?*anyopaque, @ptrCast(oci)));
    }
    return s;
}
pub export fn natsMsg_isJSCtrl(arg_msg: [*c]natsMsg, arg_ctrlType: [*c]c_int) bool {
    var msg = arg_msg;
    _ = &msg;
    var ctrlType = arg_ctrlType;
    _ = &ctrlType;
    var p: [*c]u8 = null;
    _ = &p;
    ctrlType.* = 0;
    if ((msg.*.dataLen > @as(c_int, 0)) or (msg.*.hdrLen <= @as(c_int, 0))) return @as(c_int, 0) != 0;
    if (strstr(msg.*.hdr, "NATS/1.0") != msg.*.hdr) return @as(c_int, 0) != 0;
    p = msg.*.hdr + @as(usize, @bitCast(@as(isize, @intCast(@as(c_int, 8)))));
    if (@as(c_int, @bitCast(@as(c_uint, p.*))) != @as(c_int, ' ')) return @as(c_int, 0) != 0;
    while ((@as(c_int, @bitCast(@as(c_uint, p.*))) != @as(c_int, '\x00')) and ((@as(c_int, @bitCast(@as(c_uint, (blk: {
        const tmp = @as(c_int, @bitCast(@as(c_uint, @as(u8, @bitCast(p.*)))));
    ...
    if (((@as(c_int, @bitCast(@as(c_uint, p.*))) == @as(c_int, '\r')) or (@as(c_int, @bitCast(@as(c_uint, p.*))) == @as(c_int, '\n'))) or (@as(c_int, @bitCast(@as(c_uint, p.*))) == @as(c_int, '\x00'))) return @as(c_int, 0) != 0;
    if (strstr(p, "100") != p) return @as(c_int, 0) != 0;
    p += @as(usize, @bitCast(@as(isize, @intCast(@as(c_int, 3)))));
    if (!((@as(c_int, @bitCast(@as(c_uint, (blk: {
        const tmp = @as(c_int, @bitCast(@as(c_uint, @as(u8, @bitCast(p.*)))));
        if (tmp >= 0) break :blk __ctype_b_loc().* + @as(usize, @intCast(tmp)) else break :blk __ctype_b_loc().* - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
    }).*))) & @as(c_int, @bitCast(@as(c_uint, @as(c_ushort, @bitCast(@as(c_short, @truncate(_ISspace)))))))) != 0)) return @as(c_int, 0) != 0;
...
pub const nats_JSONField = extern struct {
    name: [*c]u8 = @import("std").mem.zeroes([*c]u8),
    typ: c_int = @import("std").mem.zeroes(c_int),
    value: union_unnamed_64 = @import("std").mem.zeroes(union_unnamed_64),
...
pub export fn js_setOpts(arg_nc: [*c][*c]natsConnection, arg_freePfx: [*c]bool, arg_js: [*c]jsCtx, arg_opts: [*c]jsOptions, arg_resOpts: [*c]jsOptions) natsStatus {
    var nc = arg_nc;
    _ = &nc;
    var freePfx = arg_freePfx;
    _ = &freePfx;
    var js = arg_js;
    _ = &js;
    var opts = arg_opts;
    _ = &opts;
    var resOpts = arg_resOpts;
    _ = &resOpts;
    var s: natsStatus = @as(c_uint, @bitCast(NATS_OK));
    _ = &s;
    freePfx.* = @as(c_int, 0) != 0;
    _ = jsOptions_Init(resOpts);
    if ((opts != @as([*c]jsOptions, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) and !((if ((opts.*.Domain == @as([*c]const u8, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) or (@as(c_int, @bitCast(@as(c_uint, opts.*.Domain[@as(c_uint, @intCast(@as(c_int, 0)))]))) == @as(c_int, '\x00'))) @as(c_int, 1) else @as(c_int, 0)) != 0)) {
        var pfx: [*c]u8 = null;
        _ = &pfx;
        if (asprintf(&pfx, "$JS.%.*s.API", js_lenWithoutTrailingDot(opts.*.Domain), opts.*.Domain) < @as(c_int, 0)) {
            s = nats_setErrorReal("./src/submodules/nats.c/src/js.c", "js_setOpts", @as(c_int, 381), @as(c_uint, @bitCast(NATS_NO_MEMORY)), "%s", natsStatus_GetText(@as(c_uint, @bitCast(NATS_NO_MEMORY))));
        } else {
            resOpts.*.Prefix = pfx;
            freePfx.* = @as(c_int, 1) != 0;
        }
    }
    if (s == @as(c_uint, @bitCast(NATS_OK))) {
        var po: [*c]struct_jsOptionsStreamPurge_59 = &js.*.opts.Stream.Purge;
        _ = &po;
        _ = natsMutex_Lock(js.*.mu);
        if (resOpts.*.Prefix == @as([*c]const u8, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) {
            resOpts.*.Prefix = if ((opts == @as([*c]jsOptions, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) or ((if ((opts.*.Prefix == @as([*c]const u8, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) or (@as(c_int, @bitCast(@as(c_uint, opts.*.Prefix[@as(c_uint, @intCast(@as(c_int, 0)))]))) == @as(c_int, '\x00'))) @as(c_int, 1) else @as(c_int, 0)) != 0)) js.*.opts.Prefix else opts.*.Prefix;
        }
        resOpts.*.Wait = if ((opts == @as([*c]jsOptions, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) or (opts.*.Wait <= @as(i64, @bitCast(@as(c_long, @as(c_int, 0)))))) js.*.opts.Wait else opts.*.Wait;
        if (opts != @as([*c]jsOptions, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) {
            var opo: [*c]struct_jsOptionsStreamPurge_59 = &opts.*.Stream.Purge;
            _ = &opo;
            if (((opo.*.Subject != @as([*c]const u8, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) or (opo.*.Sequence > @as(u64, @bitCast(@as(c_long, @as(c_int, 0)))))) or (opo.*.Keep > @as(u64, @bitCast(@as(c_long, @as(c_int, 0)))))) {
                po = opo;
            }
        }
        _ = memcpy(@as(?*anyopaque, @ptrCast(&resOpts.*.Stream.Purge)), @as(?*const anyopaque, @ptrCast(po)), @sizeOf(struct_jsOptionsStreamPurge_59));
        resOpts.*.Stream.Info.DeletedDetails = (if (opts == @as([*c]jsOptions, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) @as(c_int, @intFromBool(js.*.opts.Stream.Info.DeletedDetails)) else @as(c_int, @intFromBool(opts.*.Stream.Info.DeletedDetails))) != 0;
        resOpts.*.Stream.Info.SubjectsFilter = if (opts == @as([*c]jsOptions, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) js.*.opts.Stream.Info.SubjectsFilter else opts.*.Stream.Info.SubjectsFilter;
        nc.* = js.*.nc;
        _ = natsMutex_Unlock(js.*.mu);
    }
    return if (s == @as(c_uint, @bitCast(NATS_OK))) s else nats_updateErrStack(s, "js_setOpts");
}
pub export fn js_lenWithoutTrailingDot(arg_str: [*c]const u8) c_int {
    var str = arg_str;
    _ = &str;
    var l: c_int = @as(c_int, @bitCast(@as(c_uint, @truncate(strlen(str)))));
    _ = &l;
    if (@as(c_int, @bitCast(@as(c_uint, (blk: {
        const tmp = l - @as(c_int, 1);
...
pub export fn js_unmarshalResponse(arg_ar: [*c]jsApiResponse, arg_new_json: [*c][*c]nats_JSON, arg_resp: [*c]natsMsg) natsStatus {
    var ar = arg_ar;
    _ = &ar;
    var new_json = arg_new_json;
    _ = &new_json;
    var resp = arg_resp;
    _ = &resp;
    var json: [*c]nats_JSON = null;
    _ = &json;
    var err: [*c]nats_JSON = null;
    _ = &err;
    var s: natsStatus = undefined;
    _ = &s;
    _ = memset(@as(?*anyopaque, @ptrCast(ar)), @as(c_int, 0), @sizeOf(jsApiResponse));
    s = nats_JSONParse(&json, natsMsg_GetData(resp), natsMsg_GetDataLength(resp));
    if (s != @as(c_uint, @bitCast(NATS_OK))) return if (s == @as(c_uint, @bitCast(NATS_OK))) s else nats_updateErrStack(s, "js_unmarshalResponse");
    s = nats_JSONGetObject(json, "error", &err);
    if ((s == @as(c_uint, @bitCast(NATS_OK))) and (err != @as([*c]nats_JSON, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0)))))))) {
        s = nats_JSONGetInt(err, "code", &ar.*.Error.Code);
        if (s == @as(c_uint, @bitCast(NATS_OK))) {
            s = nats_JSONGetUInt16(err, "err_code", &ar.*.Error.ErrCode);
        }
        if (s == @as(c_uint, @bitCast(NATS_OK))) {
            s = nats_JSONGetStr(err, "description", &ar.*.Error.Description);
        }
    }
    if (s == @as(c_uint, @bitCast(NATS_OK))) {
        new_json.* = json;
    ...
    return if (s == @as(c_uint, @bitCast(NATS_OK))) s else nats_updateErrStack(s, "js_unmarshalResponse");
}
pub export fn js_freeApiRespContent(arg_ar: [*c]jsApiResponse) void {
    var ar = arg_ar;
    _ = &ar;
    if (ar == @as([*c]jsApiResponse, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) return;
    free(@as(?*anyopaque, @ptrCast(ar.*.Type)));
    free(@as(?*anyopaque, @ptrCast(ar.*.Error.Description)));
}
...
pub export fn js_checkConsName(arg_cons: [*c]const u8, arg_isDurable: bool) natsStatus {
    var cons = arg_cons;
    _ = &cons;
    var isDurable = arg_isDurable;
    _ = &isDurable;
    var i: c_int = undefined;
    _ = &i;
    if ((if ((cons == @as([*c]const u8, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) or (@as(c_int, @bitCast(@as(c_uint, cons[@as(c_uint, @intCast(@as(c_int, 0)))]))) == @as(c_int, '\x00'))) @as(c_int, 1) else @as(c_int, 0)) != 0) return nats_setErrorReal("./src/submodules/nats.c/src/js.c", "js_checkConsName", @as(c_int, 2407), @as(c_uint, @bitCast(NATS_INVALID_ARG)), "%s", "consumer name is required");
    {
        i = 0;
        while (i < @as(c_int, @bitCast(@as(c_uint, @truncate(strlen(cons)))))) : (i += 1) {
            var c: u8 = (blk: {
                const tmp = i;
                if (tmp >= 0) break :blk cons + @as(usize, @intCast(tmp)) else break :blk cons - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
            }).*;
            _ = &c;
            if ((((@as(c_int, @bitCast(@as(c_uint, c))) == @as(c_int, '.')) or (@as(c_int, @bitCast(@as(c_uint, c))) == @as(c_int, ' '))) or (@as(c_int, @bitCast(@as(c_uint, c))) == @as(c_int, '*'))) or (@as(c_int, @bitCast(@as(c_uint, c))) == @as(c_int, '>'))) {
                return nats_setErrorReal("./src/submodules/nats.c/src/js.c", "js_checkConsName", @as(c_int, 2415), @as(c_uint, @bitCast(NATS_INVALID_ARG)), "%s '%s' (cannot contain '%c')", if (@as(c_int, @intFromBool(isDurable)) != 0) "invalid durable name" else "invalid consumer name", cons, @as(c_int, @bitCast(@as(c_uint, c))));
            }
        }
    }
    return @as(c_uint, @bitCast(NATS_OK));
}
pub export fn js_getMetaData(arg_reply: [*c]const u8, arg_domain: [*c][*c]u8, arg_stream: [*c][*c]u8, arg_consumer: [*c][*c]u8, arg_numDelivered: [*c]u64, arg_sseq: [*c]u64, arg_dseq: [*c]u64, arg_tm_1: [*c]i64, arg_numPending: [*c]u64, arg_asked: c_int) natsStatus {
    var reply = arg_reply;
    _ = &reply;
    ...
    _ = &consumer;
    var numDelivered = arg_numDelivered;
    _ = &numDelivered;
    var sseq = arg_sseq;
    _ = &sseq;
    var dseq = arg_dseq;
    ...
    var tm_1 = arg_tm_1;
    _ = &tm_1;
    var numPending = arg_numPending;
    _ = &numPending;
    var asked = arg_asked;
    _ = &asked;
    var s: natsStatus = @as(c_uint, @bitCast(NATS_OK));
    _ = &s;
    var p: [*c]const u8 = reply;
    _ = &p;
    var np: [*c]const u8 = null;
    _ = &np;
    var str: [*c]const u8 = null;
    _ = &str;
    var done: c_int = 0;
    ...
    _ = &l;
    const struct_token = extern struct {
        start: [*c]const u8 = @import("std").mem.zeroes([*c]const u8),
        len: c_int = @import("std").mem.zeroes(c_int),
    };
    _ = &struct_token;
    var tokens: [9]struct_token = undefined;
    _ = &tokens;
    _ = memset(@as(?*anyopaque, @ptrCast(@as([*c]struct_token, @ptrCast(@alignCast(&tokens))))), @as(c_int, 0), @sizeOf([9]struct_token));
    while ((nt < @as(c_int, 9)) and ((blk: {
        const tmp = strchr(p, @as(c_int, '.'));
        np = tmp;
        break :blk tmp;
    }) != @as([*c]const u8, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0)))))))) {
        tokens[@as(c_uint, @intCast(nt))].start = p;
        tokens[@as(c_uint, @intCast(nt))].len = @as(c_int, @bitCast(@as(c_int, @truncate(@divExact(@as(c_long, @bitCast(@intFromPtr(np) -% @intFromPtr(p))), @sizeOf(u8))))));
        nt += 1;
        p = np + @as(usize, @bitCast(@as(isize, @intCast(@as(c_int, 1)))));
    }
    if (np == @as([*c]const u8, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) {
        tokens[@as(c_uint, @intCast(nt))].start = p;
        tokens[@as(c_uint, @intCast(nt))].len = @as(c_int, @bitCast(@as(c_uint, @truncate(strlen(p)))));
        nt += 1;
    }
    if ((nt < @as(c_int, 7)) or ((nt > @as(c_int, 7)) and (nt < @as(c_int, 9)))) return @as(c_uint, @bitCast(NATS_ERR));
    if (nt == @as(c_int, 7)) {
        _ = memmove(@as(?*anyopaque, @ptrCast(&tokens[@as(c_uint, @intCast(@as(c_int, 2)))])), @as(?*const anyopaque, @ptrCast(&tokens[@as(c_uint, @intCast(@as(c_int, 0)))])), @as(c_ulong, @bitCast(@as(c_long, nt))) *% @sizeOf(struct_token));
        tokens[@as(c_uint, @intCast(@as(c_int, 0)))].start = null;
        tokens[@as(c_uint, @intCast(@as(c_int, 0)))].len = 0;
        tokens[@as(c_uint, @intCast(@as(c_int, 1)))].start = null;
        tokens[@as(c_uint, @intCast(@as(c_int, 1)))].len = 0;
        nt = 9;
    }
    {
        i = 0;
        while (i < nt) : (i += 1) {
            str = tokens[@as(c_uint, @intCast(i))].start;
            l = tokens[@as(c_uint, @intCast(i))].len;
            if (i > @as(c_int, 3)) {
                val = nats_ParseInt64(str, l);
                if (val == @as(i64, @bitCast(@as(c_long, -@as(c_int, 1))))) return @as(c_uint, @bitCast(NATS_ERR));
            }
            while (true) {
                switch (i) {
                    @as(c_int, 0) => {
                        if (domain != @as([*c][*c]u8, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) {
                            if ((str == @as([*c]const u8, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) or ((l == @as(c_int, 1)) and (@as(c_int, @bitCast(@as(c_uint, str[@as(c_uint, @intCast(@as(c_int, 0)))]))) == @as(c_int, '_')))) {
                                domain.* = null;
                            } else if ((blk: {
                                const tmp = _copyString(domain, str, l);
                                s = tmp;
                                break :blk tmp;
                            }) != @as(c_uint, @bitCast(NATS_OK))) return if (s == @as(c_uint, @bitCast(NATS_OK))) s else nats_updateErrStack(s, "js_getMetaData");
                            done += 1;
                        }
                        break;
                    },
                    @as(c_int, 1) => break,
                    @as(c_int, 2) => {
                        if (stream != @as([*c][*c]u8, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) {
                            if ((blk: {
                                const tmp = _copyString(stream, str, l);
                                s = tmp;
                                break :blk tmp;
                            }) != @as(c_uint, @bitCast(NATS_OK))) return if (s == @as(c_uint, @bitCast(NATS_OK))) s else nats_updateErrStack(s, "js_getMetaData");
                            done += 1;
                    ...
                    @as(c_int, 3) => {
                        if (consumer != @as([*c][*c]u8, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) {
                            if ((blk: {
                                const tmp = _copyString(consumer, str, l);
                                s = tmp;
                                break :blk tmp;
                            }) != @as(c_uint, @bitCast(NATS_OK))) return if (s == @as(c_uint, @bitCast(NATS_OK))) s else nats_updateErrStack(s, "js_getMetaData");
                            done += 1;
                    ...
                    @as(c_int, 4) => {
                        if (numDelivered != @as([*c]u64, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) {
                            numDelivered.* = @as(u64, @bitCast(val));
                            done += 1;
                        }
                        break;
                    },
                    @as(c_int, 5) => {
                        if (sseq != @as([*c]u64, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) {
                            sseq.* = @as(u64, @bitCast(val));
                            done += 1;
                        }
                        break;
                    },
                    @as(c_int, 6) => {
                        if (dseq != @as([*c]u64, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) {
                            dseq.* = @as(u64, @bitCast(val));
                            done += 1;
                        }
                        break;
                    },
                    @as(c_int, 7) => {
                        if (tm_1 != @as([*c]i64, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) {
                            tm_1.* = val;
                            done += 1;
                        }
                        break;
                    ...
                    @as(c_int, 8) => {
                        if (numPending != @as([*c]u64, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) {
                            numPending.* = @as(u64, @bitCast(val));
                            done += 1;
                        }
                        break;
                    },
            ...
            if (done == asked) return @as(c_uint, @bitCast(NATS_OK));
        }
    }
    return @as(c_uint, @bitCast(NATS_OK));
}
pub export fn js_retain(arg_js: [*c]jsCtx) void {
    var js = arg_js;
    _ = &js;
    _ = natsMutex_Lock(js.*.mu);
    js.*.refs += 1;
...
pub export fn js_release(arg_js: [*c]jsCtx) void {
    var js = arg_js;
    _ = &js;
    var doFree: bool = undefined;
    _ = &doFree;
    if (js == @as([*c]jsCtx, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) return;
    _ = natsMutex_Lock(js.*.mu);
    doFree = (blk: {
...
pub export fn js_checkFetchedMsg(arg_sub: [*c]natsSubscription, arg_msg: [*c]natsMsg, arg_fetchID: u64, arg_checkSts: bool, arg_usrMsg: [*c]bool) natsStatus {
    var sub = arg_sub;
    _ = &sub;
    var msg = arg_msg;
    _ = &msg;
    var fetchID = arg_fetchID;
    _ = &fetchID;
    var checkSts = arg_checkSts;
    _ = &checkSts;
    var usrMsg = arg_usrMsg;
    _ = &usrMsg;
    var s: natsStatus = @as(c_uint, @bitCast(NATS_OK));
    _ = &s;
    ...
    _ = &desc;
    if (sub.*.control != @as([*c]natsSubscriptionControlMessages, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) {
        if (msg == sub.*.control.*.fetch.missedHeartbeat) {
            usrMsg.* = @as(c_int, 0) != 0;
            return @as(c_uint, @bitCast(NATS_MISSED_HEARTBEAT));
        } else if (msg == sub.*.control.*.fetch.expired) {
            usrMsg.* = @as(c_int, 0) != 0;
            return @as(c_uint, @bitCast(NATS_TIMEOUT));
        }
    }
    if ((msg.*.dataLen > @as(c_int, 0)) or (msg.*.hdrLen <= @as(c_int, 0))) {
        usrMsg.* = @as(c_int, 1) != 0;
        return @as(c_uint, @bitCast(NATS_OK));
    }
    s = natsMsgHeader_Get(msg, "Status", &val);
    if (s == @as(c_uint, @bitCast(NATS_NOT_FOUND))) {
        usrMsg.* = @as(c_int, 1) != 0;
        return @as(c_uint, @bitCast(NATS_OK));
    } else if (s != @as(c_uint, @bitCast(NATS_OK))) {
        usrMsg.* = @as(c_int, 0) != 0;
        return if (s == @as(c_uint, @bitCast(NATS_OK))) s else nats_updateErrStack(s, "js_checkFetchedMsg");
    }
    usrMsg.* = @as(c_int, 0) != 0;
    if (!checkSts) return @as(c_uint, @bitCast(NATS_OK));
    if (strncmp(val, "100", @as(c_ulong, @bitCast(@as(c_long, @as(c_int, 3))))) == @as(c_int, 0)) return @as(c_uint, @bitCast(NATS_OK));
    var id: i64 = _fetchIDFromSubject(sub, natsMsg_GetSubject(msg));
    _ = &id;
    if (id != @as(i64, @bitCast(fetchID))) return @as(c_uint, @bitCast(NATS_OK));
    if (strncmp(val, "404", @as(c_ulong, @bitCast(@as(c_long, @as(c_int, 3))))) == @as(c_int, 0)) return @as(c_uint, @bitCast(NATS_NOT_FOUND));
    if (strncmp(val, "408", @as(c_ulong, @bitCast(@as(c_long, @as(c_int, 3))))) == @as(c_int, 0)) return @as(c_uint, @bitCast(NATS_TIMEOUT));
    if (strncmp(val, "409", @as(c_ulong, @bitCast(@as(c_long, @as(c_int, 3))))) == @as(c_int, 0)) {
        _ = natsMsgHeader_Get(msg, "Description", &desc);
        return nats_setErrorReal("./src/submodules/nats.c/src/js.c", "js_checkFetchedMsg", @as(c_int, 1803), @as(c_uint, @bitCast(NATS_LIMIT_REACHED)), "%s", if (desc == @as([*c]const u8, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) "error checking pull subscribe message" else desc);
    }
    if (strncmp(val, "503", @as(c_ulong, @bitCast(@as(c_long, @as(c_int, 3))))) == @as(c_int, 0)) return @as(c_uint, @bitCast(NATS_NO_RESPONDERS));
    _ = natsMsgHeader_Get(msg, "Description", &desc);
    return nats_setErrorReal("./src/submodules/nats.c/src/js.c", "js_checkFetchedMsg", @as(c_int, 1813), @as(c_uint, @bitCast(NATS_ERR)), "%s", if (desc == @as([*c]const u8, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) "error checking pull subscribe message" else desc);
}
pub export fn js_maybeFetchMore(arg_sub: [*c]natsSubscription, arg_fetch: [*c]jsFetch) natsStatus {
    var sub = arg_sub;
    _ = &sub;
    var fetch = arg_fetch;
    _ = &fetch;
    var req: jsFetchRequest = jsFetchRequest{
        .Expires = @as(i64, @bitCast(@as(c_long, @as(c_int, 0)))),
        .Batch = 0,
        .MaxBytes = @import("std").mem.zeroes(i64),
        .NoWait = false,
        .Heartbeat = @import("std").mem.zeroes(i64),
    };
    _ = &req;
    if (fetch.*.opts.NextHandler == @as(jsFetchNextHandler, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) return @as(c_uint, @bitCast(NATS_OK));
    if (!fetch.*.opts.NextHandler.?(&req.Batch, &req.MaxBytes, sub, fetch.*.opts.NextHandlerClosure)) return @as(c_uint, @bitCast(NATS_OK));
    var now: i64 = nats_Now();
    _ = &now;
    if (fetch.*.opts.Timeout != @as(i64, @bitCast(@as(c_long, @as(c_int, 0))))) {
        req.Expires = ((fetch.*.opts.Timeout - (now - fetch.*.startTimeMillis)) * @as(i64, @bitCast(@as(c_long, @as(c_int, 1000))))) * @as(i64, @bitCast(@as(c_long, @as(c_int, 1000))));
    }
    req.NoWait = fetch.*.opts.NoWait;
    req.Heartbeat = (fetch.*.opts.Heartbeat * @as(i64, @bitCast(@as(c_long, @as(c_int, 1000))))) * @as(i64, @bitCast(@as(c_long, @as(c_int, 1000))));
    var buffer: [128]u8 = undefined;
    _ = &buffer;
    var buf: natsBuffer = undefined;
    _ = &buf;
    _ = natsBuf_InitWithBackend(&buf, @as([*c]u8, @ptrCast(@alignCast(&buffer))), @as(c_int, 0), @as(c_int, @bitCast(@as(c_uint, @truncate(@sizeOf([128]u8))))));
    nats_lockSubAndDispatcher(sub);
    var jsi: [*c]jsSub = sub.*.jsi;
    _ = &jsi;
    jsi.*.inFetch = @as(c_int, 1) != 0;
    jsi.*.fetchID +%= 1;
    _ = snprintf(@as([*c]u8, @ptrCast(@alignCast(&fetch.*.replySubject))), @sizeOf([61]u8), "%.*s%lu", @as(c_int, @bitCast(@as(c_uint, @truncate(strlen(sub.*.subject))))) - @as(c_int, 1), sub.*.subject, jsi.*.fetchID);
    var s: natsStatus = _sendPullRequest(sub.*.conn, jsi.*.nxtMsgSubj, @as([*c]u8, @ptrCast(@alignCast(&fetch.*.replySubject))), &buf, &req);
    _ = &s;
    if (s == @as(c_uint, @bitCast(NATS_OK))) {
    ...
    nats_unlockSubAndDispatcher(sub);
    natsBuf_Destroy(&buf);
    return if (s == @as(c_uint, @bitCast(NATS_OK))) s else nats_updateErrStack(s, "js_maybeFetchMore");
}
...
pub fn natsOptions_lock(arg_opts: [*c]natsOptions) callconv(.c) void {
    var opts = arg_opts;
    _ = &opts;
    natsMutex_Lock(opts.*.mu);
}
pub fn natsOptions_unlock(arg_opts: [*c]natsOptions) callconv(.c) void {
    var opts = arg_opts;
    _ = &opts;
    natsMutex_Unlock(opts.*.mu);
}
pub extern fn natsOptions_clone(opts: [*c]natsOptions) [*c]natsOptions;
pub extern fn natsOptions_setMicroCallbacks(opts: [*c]natsOptions, closedCb: natsConnectionHandler, errCb: natsErrHandler) natsStatus;
...
pub export const jsDefaultStallWait: i64 = @as(i64, @bitCast(@as(c_long, @as(c_int, 200))));
pub export var jsDigits: [*c]const u8 = "0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz";
pub export const jsBase: c_int = 62;
pub export const jsOrderedHBInterval: i64 = @as(i64, @bitCast(@as(c_long, @as(c_int, 5)))) * @as(i64, @intFromFloat(1000000000.0));
pub fn _hbTimerFired(arg_timer: [*c]natsTimer, arg_closure: ?*anyopaque) callconv(.c) void {
    var timer = arg_timer;
    _ = &timer;
    var closure = arg_closure;
    _ = &closure;
    var sub: [*c]natsSubscription = @as([*c]natsSubscription, @ptrCast(@alignCast(closure)));
    _ = &sub;
    var jsi: [*c]jsSub = sub.*.jsi;
    _ = &jsi;
    var alert: bool = @as(c_int, 0) != 0;
    _ = &alert;
    var nc: [*c]natsConnection = null;
    _ = &nc;
    var oc: bool = @as(c_int, 0) != 0;
    _ = &oc;
    var s: natsStatus = @as(c_uint, @bitCast(NATS_OK));
    _ = &s;
    nats_lockSubAndDispatcher(sub);
    alert = !jsi.*.active;
    oc = jsi.*.ordered;
    jsi.*.active = @as(c_int, 0) != 0;
    if ((@as(c_int, @intFromBool(alert)) != 0) and (@as(c_int, @intFromBool(jsi.*.pull)) != 0)) {
    ...
    if (oc) {
        nats_lockSubAndDispatcher(sub);
        if (!sub.*.closed) {
            s = jsSub_resetOrderedConsumer(sub, sub.*.jsi.*.sseq +% @as(u64, @bitCast(@as(c_long, @as(c_int, 1)))));
        }
        nats_unlockSubAndDispatcher(sub);
    }
    _ = natsMutex_Lock(nc.*.mu);
    if (s == @as(c_uint, @bitCast(NATS_OK))) {
        s = @as(c_uint, @bitCast(NATS_MISSED_HEARTBEAT));
    }
    natsAsyncCb_PostErrHandler(nc, sub, s, null);
    _ = natsMutex_Unlock(nc.*.mu);
}
pub fn _releaseSubWhenStopped(arg_timer: [*c]natsTimer, arg_closure: ?*anyopaque) callconv(.c) void {
    var timer = arg_timer;
    _ = &timer;
    var closure = arg_closure;
    _ = &closure;
...
pub fn _destroyOptions(arg_o: [*c]jsOptions) callconv(.c) void {
    var o = arg_o;
    _ = &o;
    free(@as(?*anyopaque, @ptrCast(@as([*c]u8, @ptrCast(@volatileCast(@constCast(o.*.Prefix)))))));
    free(@as(?*anyopaque, @ptrCast(@as([*c]u8, @ptrCast(@volatileCast(@constCast(o.*.Stream.Purge.Subject)))))));
}
pub fn _freeContext(arg_js: [*c]jsCtx) callconv(.c) void {
    var js = arg_js;
    _ = &js;
    var nc: [*c]natsConnection = null;
    _ = &nc;
    ...
    free(@as(?*anyopaque, @ptrCast(js.*.rpre)));
    natsCondition_Destroy(js.*.cond);
    natsMutex_Destroy(js.*.mu);
    natsTimer_Destroy(js.*.pmtmr);
    nc = js.*.nc;
    free(@as(?*anyopaque, @ptrCast(js)));
    natsConn_release(nc);
}
pub fn js_unlockAndRelease(arg_js: [*c]jsCtx) callconv(.c) void {
    var js = arg_js;
    _ = &js;
    var doFree: bool = undefined;
    _ = &doFree;
...
pub fn _destroyPMInfo(arg_pmi: [*c]pmInfo) callconv(.c) void {
    var pmi = arg_pmi;
    _ = &pmi;
    if (pmi == @as([*c]pmInfo, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) return;
    free(@as(?*anyopaque, @ptrCast(pmi.*.subject)));
    free(@as(?*anyopaque, @ptrCast(pmi)));
}
pub fn _copyPurgeOptions(arg_js: [*c]jsCtx, arg_o: [*c]struct_jsOptionsStreamPurge_59) callconv(.c) natsStatus {
    var js = arg_js;
    _ = &js;
    var o = arg_o;
    _ = &o;
    ...
    po.*.Keep = o.*.Keep;
    if (!((if ((o.*.Subject == @as([*c]const u8, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) or (@as(c_int, @bitCast(@as(c_uint, o.*.Subject[@as(c_uint, @intCast(@as(c_int, 0)))]))) == @as(c_int, '\x00'))) @as(c_int, 1) else @as(c_int, 0)) != 0)) {
        po.*.Subject = strdup(o.*.Subject);
        if (po.*.Subject == @as([*c]const u8, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) {
            s = nats_setErrorReal("./src/submodules/nats.c/src/js.c", "_copyPurgeOptions", @as(c_int, 252), @as(c_uint, @bitCast(NATS_NO_MEMORY)), "%s", natsStatus_GetText(@as(c_uint, @bitCast(NATS_NO_MEMORY))));
        }
    }
    return if (s == @as(c_uint, @bitCast(NATS_OK))) s else nats_updateErrStack(s, "_copyPurgeOptions");
}
pub fn _copyStreamInfoOptions(arg_js: [*c]jsCtx, arg_o: [*c]struct_jsOptionsStreamInfo_60) callconv(.c) natsStatus {
    var js = arg_js;
    _ = &js;
    var o = arg_o;
    _ = &o;
...
pub fn _setHeadersFromOptions(arg_msg: [*c]natsMsg, arg_opts: [*c]jsPubOptions) callconv(.c) natsStatus {
    var msg = arg_msg;
    _ = &msg;
    var opts = arg_opts;
    _ = &opts;
    ...
    _ = &temp;
    if (!((if ((opts.*.MsgId == @as([*c]const u8, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) or (@as(c_int, @bitCast(@as(c_uint, opts.*.MsgId[@as(c_uint, @intCast(@as(c_int, 0)))]))) == @as(c_int, '\x00'))) @as(c_int, 1) else @as(c_int, 0)) != 0)) {
        s = natsMsgHeader_Set(msg, "Nats-Msg-Id", opts.*.MsgId);
    }
    if ((s == @as(c_uint, @bitCast(NATS_OK))) and !((if ((opts.*.ExpectLastMsgId == @as([*c]const u8, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) or (@as(c_int, @bitCast(@as(c_uint, opts.*.ExpectLastMsgId[@as(c_uint, @intCast(@as(c_int, 0)))]))) == @as(c_int, '\x00'))) @as(c_int, 1) else @as(c_int, 0)) != 0)) {
        s = natsMsgHeader_Set(msg, "Nats-Expected-Last-Msg-Id", opts.*.ExpectLastMsgId);
    }
    if ((s == @as(c_uint, @bitCast(NATS_OK))) and !((if ((opts.*.ExpectStream == @as([*c]const u8, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) or (@as(c_int, @bitCast(@as(c_uint, opts.*.ExpectStream[@as(c_uint, @intCast(@as(c_int, 0)))]))) == @as(c_int, '\x00'))) @as(c_int, 1) else @as(c_int, 0)) != 0)) {
        s = natsMsgHeader_Set(msg, "Nats-Expected-Stream", opts.*.ExpectStream);
    }
    if ((s == @as(c_uint, @bitCast(NATS_OK))) and (opts.*.ExpectLastSeq > @as(u64, @bitCast(@as(c_long, @as(c_int, 0)))))) {
        _ = snprintf(@as([*c]u8, @ptrCast(@alignCast(&temp))), @sizeOf([64]u8), "%lu", opts.*.ExpectLastSeq);
        s = natsMsgHeader_Set(msg, "Nats-Expected-Last-Sequence", @as([*c]u8, @ptrCast(@alignCast(&temp))));
    }
    if (s == @as(c_uint, @bitCast(NATS_OK))) {
        if (opts.*.ExpectNoMessage) {
            s = natsMsgHeader_Set(msg, "Nats-Expected-Last-Subject-Sequence", "0");
        } else if (opts.*.ExpectLastSubjectSeq > @as(u64, @bitCast(@as(c_long, @as(c_int, 0))))) {
            _ = snprintf(@as([*c]u8, @ptrCast(@alignCast(&temp))), @sizeOf([64]u8), "%lu", opts.*.ExpectLastSubjectSeq);
            s = natsMsgHeader_Set(msg, "Nats-Expected-Last-Subject-Sequence", @as([*c]u8, @ptrCast(@alignCast(&temp))));
        }
    }
    return if (s == @as(c_uint, @bitCast(NATS_OK))) s else nats_updateErrStack(s, "_setHeadersFromOptions");
}
pub fn _checkMaxWaitOpt(arg_new_ttl: [*c]i64, arg_opts: [*c]jsPubOptions) callconv(.c) natsStatus {
    var new_ttl = arg_new_ttl;
    _ = &new_ttl;
    var opts = arg_opts;
    _ = &opts;
    var ttl: i64 = undefined;
    _ = &ttl;
    if ((blk: {
        const tmp = opts.*.MaxWait;
        ttl = tmp;
        break :blk tmp;
    }) < @as(i64, @bitCast(@as(c_long, @as(c_int, 0))))) return nats_setErrorReal("./src/submodules/nats.c/src/js.c", "_checkMaxWaitOpt", @as(c_int, 489), @as(c_uint, @bitCast(NATS_INVALID_ARG)), "option 'MaxWait' (%ld) cannot be negative", ttl);
    new_ttl.* = ttl;
    return @as(c_uint, @bitCast(NATS_OK));
}
pub fn _freePubAck(arg_pa: [*c]jsPubAck) callconv(.c) void {
    var pa = arg_pa;
    _ = &pa;
    if (pa == @as([*c]jsPubAck, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) return;
    free(@as(?*anyopaque, @ptrCast(pa.*.Stream)));
...
pub fn _parsePubAck(arg_msg: [*c]natsMsg, arg_pa: [*c]jsPubAck, arg_pae: [*c]jsPubAckErr, arg_errTxt: [*c]u8, arg_errTxtSize: usize) callconv(.c) natsStatus {
    var msg = arg_msg;
    _ = &msg;
    var pa = arg_pa;
    _ = &pa;
    var pae = arg_pae;
    _ = &pae;
    var errTxt = arg_errTxt;
    _ = &errTxt;
    var errTxtSize = arg_errTxtSize;
    _ = &errTxtSize;
    var s: natsStatus = @as(c_uint, @bitCast(NATS_OK));
    _ = &s;
    var jerr: jsErrCode = 0;
    _ = &jerr;
    if ((msg.*.flags & (@as(c_int, 1) << @intCast(3))) != @as(c_int, 0)) {
        s = @as(c_uint, @bitCast(NATS_TIMEOUT));
    } else if (natsMsg_IsNoResponders(msg)) {
        s = @as(c_uint, @bitCast(NATS_NO_RESPONDERS));
    } else {
        var json: [*c]nats_JSON = null;
        _ = &json;
        ...
        if (s == @as(c_uint, @bitCast(NATS_OK))) {
            if (((&ar).*.Error.Code != @as(c_int, 0)) or (@as(c_int, @bitCast(@as(c_uint, (&ar).*.Error.ErrCode))) != @as(c_int, 0))) {
                s = @as(c_uint, @bitCast(NATS_ERR));
                jerr = @as(c_uint, @bitCast(@as(c_uint, ar.Error.ErrCode)));
                _ = snprintf(errTxt, errTxtSize, "%s", ar.Error.Description);
            } else if (pa != @as([*c]jsPubAck, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) {
                _ = memset(@as(?*anyopaque, @ptrCast(pa)), @as(c_int, 0), @sizeOf(jsPubAck));
                s = nats_JSONGetStr(json, "stream", &pa.*.Stream);
                if (s == @as(c_uint, @bitCast(NATS_OK))) {
                    s = nats_JSONGetULong(json, "seq", &pa.*.Sequence);
                }
    ...
    if (s != @as(c_uint, @bitCast(NATS_OK))) {
        if (@as(c_int, @bitCast(@as(c_uint, errTxt[@as(c_uint, @intCast(@as(c_int, 0)))]))) == @as(c_int, '\x00')) {
            _ = snprintf(errTxt, errTxtSize, "%s", natsStatus_GetText(s));
        }
        _ = memset(@as(?*anyopaque, @ptrCast(pae)), @as(c_int, 0), @sizeOf(jsPubAckErr));
        pae.*.Err = s;
        pae.*.ErrCode = jerr;
        pae.*.ErrText = errTxt;
    }
...
pub fn _handleAsyncReply(arg_nc: [*c]natsConnection, arg_sub: [*c]natsSubscription, arg_msg: [*c]natsMsg, arg_closure: ?*anyopaque) callconv(.c) void {
    var nc = arg_nc;
    _ = &nc;
    var sub = arg_sub;
    _ = &sub;
    ...
    var closure = arg_closure;
    _ = &closure;
    var subject: [*c]const u8 = natsMsg_GetSubject(msg);
    _ = &subject;
    var id: [*c]u8 = null;
    _ = &id;
    var js: [*c]jsCtx = @as([*c]jsCtx, @ptrCast(@alignCast(closure)));
    _ = &js;
    var pmsg: [*c]natsMsg = null;
    _ = &pmsg;
    var errTxt: [256]u8 = [1]u8{
        '\x00',
    } ++ [1]u8{0} ** 255;
    _ = &errTxt;
    var pae: jsPubAckErr = undefined;
    _ = &pae;
    var pa: jsPubAck = undefined;
    _ = &pa;
    var opa: [*c]struct_jsOptionsPublishAsync_56 = null;
    _ = &opa;
    if ((subject == @as([*c]const u8, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) or (@as(c_int, @bitCast(@as(c_uint, @truncate(strlen(subject))))) <= js.*.rpreLen)) {
        natsMsg_Destroy(msg);
        return;
    }
    id = @as([*c]u8, @ptrCast(@volatileCast(@constCast(subject + @as(usize, @bitCast(@as(isize, @intCast(js.*.rpreLen))))))));
    _ = natsMutex_Lock(js.*.mu);
    pmsg = @as([*c]natsMsg, @ptrCast(@alignCast(natsStrHash_Remove(js.*.pm, id))));
    if (pmsg == @as([*c]natsMsg, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) {
        _ = natsMutex_Unlock(js.*.mu);
        natsMsg_Destroy(msg);
        return;
    }
    opa = &js.*.opts.PublishAsync;
    if (opa.*.AckHandler != null) {
        var ppae: [*c]jsPubAckErr = null;
        _ = &ppae;
        var ppa: [*c]jsPubAck = null;
        _ = &ppa;
        if (_parsePubAck(msg, &pa, &pae, @as([*c]u8, @ptrCast(@alignCast(&errTxt))), @sizeOf([256]u8)) != @as(c_uint, @bitCast(NATS_OK))) {
            ppae = &pae;
        } else {
            ppa = &pa;
        }
        ...
        _freePubAck(ppa);
        pmsg = null;
    } else if ((opa.*.ErrHandler != @as(jsPubAckErrHandler, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) and (_parsePubAck(msg, null, &pae, @as([*c]u8, @ptrCast(@alignCast(&errTxt))), @sizeOf([256]u8)) != @as(c_uint, @bitCast(NATS_OK)))) {
        pae.Msg = pmsg;
        _ = natsMutex_Unlock(js.*.mu);
    ...
    js.*.pmcount -= 1;
    if (((js.*.pacw > @as(c_int, 0)) and (js.*.pmcount == @as(i64, @bitCast(@as(c_long, @as(c_int, 0)))))) or ((js.*.stalled > @as(c_int, 0)) and (js.*.pmcount <= opa.*.MaxPending))) {
...
pub fn _subComplete(arg_closure: ?*anyopaque) callconv(.c) void {
    var closure = arg_closure;
    _ = &closure;
    js_release(@as([*c]jsCtx, @ptrCast(@alignCast(closure))));
}
pub fn _newAsyncReply(arg_reply: [*c]u8, arg_js: [*c]jsCtx) callconv(.c) natsStatus {
    var reply = arg_reply;
    _ = &reply;
    var js = arg_js;
    _ = &js;
    ...
    if (js.*.rsub == @as([*c]natsSubscription, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) {
        ...
        if (s == @as(c_uint, @bitCast(NATS_OK))) {
            s = natsStrHash_Create(&js.*.pm, @as(c_int, 64));
        }
        if (s == @as(c_uint, @bitCast(NATS_OK))) {
            js.*.rpre = @as([*c]u8, @ptrCast(@alignCast(malloc(@as(c_ulong, @bitCast(@as(c_long, js.*.rpreLen + @as(c_int, 1))))))));
            if (js.*.rpre == @as([*c]u8, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) {
                s = nats_setErrorReal("./src/submodules/nats.c/src/js.c", "_newAsyncReply", @as(c_int, 759), @as(c_uint, @bitCast(NATS_NO_MEMORY)), "%s", natsStatus_GetText(@as(c_uint, @bitCast(NATS_NO_MEMORY))));
            } else {
                var nuid: [23]u8 = undefined;
                _ = &nuid;
                s = natsNUID_Next(@as([*c]u8, @ptrCast(@alignCast(&nuid))), @as(c_int, @bitCast(@as(c_uint, @truncate(@sizeOf([23]u8))))));
                if (s == @as(c_uint, @bitCast(NATS_OK))) {
                    _ = memcpy(@as(?*anyopaque, @ptrCast(js.*.rpre)), @as(?*const anyopaque, @ptrCast(js.*.nc.*.inboxPfx)), @as(c_ulong, @bitCast(@as(c_long, js.*.nc.*.inboxPfxLen))));
                    _ = memcpy(@as(?*anyopaque, @ptrCast(js.*.rpre + @as(usize, @bitCast(@as(isize, @intCast(js.*.nc.*.inboxPfxLen)))))), @as(?*const anyopaque, @ptrCast(@as([*c]u8, @ptrCast(@alignCast(&nuid))) + @as(usize, @bitCast(@as(isize, @intCast(@as(c_int, @bitCast(@as(c_uint, @truncate(strlen(@as([*c]u8, @ptrCast(@alignCast(&nuid)))))))) - @as(c_int, 8))))))), @as(c_ulong, @bitCast(@as(c_long, @as(c_int, 8)))));
                    (blk: {
                        const tmp = js.*.rpreLen - @as(c_int, 1);
                        if (tmp >= 0) break :blk js.*.rpre + @as(usize, @intCast(tmp)) else break :blk js.*.rpre - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
                    }).* = '.';
                    (blk: {
                        const tmp = js.*.rpreLen;
                        if (tmp >= 0) break :blk js.*.rpre + @as(usize, @intCast(tmp)) else break :blk js.*.rpre - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
                    }).* = '\x00';
                }
            }
        ...
        if (s == @as(c_uint, @bitCast(NATS_OK))) {
            var subj: [*c]u8 = null;
            _ = &subj;
            if (asprintf(&subj, "%s*", js.*.rpre) < @as(c_int, 0)) {
                s = nats_setErrorReal("./src/submodules/nats.c/src/js.c", "_newAsyncReply", @as(c_int, 779), @as(c_uint, @bitCast(NATS_NO_MEMORY)), "%s", natsStatus_GetText(@as(c_uint, @bitCast(NATS_NO_MEMORY))));
            } else {
                s = natsConn_subscribeImpl(&js.*.rsub, js.*.nc, @as(c_int, 1) != 0, subj, null, @as(i64, @bitCast(@as(c_long, @as(c_int, 0)))), &_handleAsyncReply, @as(?*anyopaque, @ptrCast(js)), @as(c_int, 1) != 0, null);
            }
            if (s == @as(c_uint, @bitCast(NATS_OK))) {
                _ = blk: {
                    const ref = &js.*.refs;
                ...
                _ = natsSubscription_SetPendingLimits(js.*.rsub, -@as(c_int, 1), -@as(c_int, 1));
                _ = natsSubscription_SetOnCompleteCB(js.*.rsub, &_subComplete, @as(?*anyopaque, @ptrCast(js)));
            }
    ...
    if (s == @as(c_uint, @bitCast(NATS_OK))) {
        ...
        var i: c_int = undefined;
        _ = &i;
        _ = memcpy(@as(?*anyopaque, @ptrCast(reply)), @as(?*const anyopaque, @ptrCast(js.*.rpre)), @as(c_ulong, @bitCast(@as(c_long, js.*.rpreLen))));
        l = nats_Rand64();
        {
            i = 0;
            while (i < @as(c_int, 8)) : (i += 1) {
                (blk: {
                    const tmp = js.*.rpreLen + i;
                    if (tmp >= 0) break :blk reply + @as(usize, @intCast(tmp)) else break :blk reply - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
                }).* = (blk: {
                    const tmp = @import("std").zig.c_translation.signedRemainder(l, @as(i64, @bitCast(@as(c_long, jsBase))));
                    if (tmp >= 0) break :blk jsDigits + @as(usize, @intCast(tmp)) else break :blk jsDigits - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
                }).*;
                l = @divTrunc(l, @as(i64, @bitCast(@as(c_long, jsBase))));
            }
        }
        (blk: {
            const tmp = js.*.rpreLen + @as(c_int, 8);
            if (tmp >= 0) break :blk reply + @as(usize, @intCast(tmp)) else break :blk reply - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
        }).* = '\x00';
    }
    return if (s == @as(c_uint, @bitCast(NATS_OK))) s else nats_updateErrStack(s, "_newAsyncReply");
}
pub fn _timeoutPubAsync(arg_t: [*c]natsTimer, arg_closure: ?*anyopaque) callconv(.c) void {
    var t = arg_t;
    _ = &t;
    var closure = arg_closure;
    _ = &closure;
    ...
    while (((blk: {
        ...
        pm = tmp;
        break :blk tmp;
    }) != @as([*c]pmInfo, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) and (pm.*.deadline <= now)) {
        var m: [*c]natsMsg = null;
        _ = &m;
        if (natsMsg_Create(&m, pm.*.subject, null, null, @as(c_int, 0)) != @as(c_uint, @bitCast(NATS_OK))) break;
        _ = blk: {
            const ref = &m.*.flags;
            ref.* |= @as(c_int, 1) << @intCast(3);
            break :blk ref.*;
        };
        nats_lockSubAndDispatcher(js.*.rsub);
        _ = natsSub_enqueueUserMessage(js.*.rsub, m);
        nats_unlockSubAndDispatcher(js.*.rsub);
        js.*.pmHead = pm.*.next;
        _destroyPMInfo(pm);
    }
    if (js.*.pmHead == @as([*c]pmInfo, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) {
        if (js.*.pmTail != @as([*c]pmInfo, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) {
            js.*.pmTail = null;
        }
        next = @as(i64, @bitCast(@as(c_long, (@as(c_int, 60) * @as(c_int, 60)) * @as(c_int, 1000))));
    } else {
        next = js.*.pmHead.*.deadline - now;
        if (next <= @as(i64, @bitCast(@as(c_long, @as(c_int, 0))))) {
            next = 1;
        }
    }
...
pub fn _timeoutPubAsyncComplete(arg_t: [*c]natsTimer, arg_closure: ?*anyopaque) callconv(.c) void {
    var t = arg_t;
    _ = &t;
    var closure = arg_closure;
    _ = &closure;
...
pub fn _trackPublishAsyncTimeout(arg_js: [*c]jsCtx, arg_subject: [*c]u8, arg_mw: i64) callconv(.c) natsStatus {
    var js = arg_js;
    _ = &js;
    var subject = arg_subject;
    _ = &subject;
    ...
    var pm: [*c]pmInfo = null;
    _ = &pm;
    var pmi: [*c]pmInfo = @as([*c]pmInfo, @ptrCast(@alignCast(calloc(@as(c_ulong, @bitCast(@as(c_long, @as(c_int, 1)))), @sizeOf(pmInfo)))));
    _ = &pmi;
    if (pmi == @as([*c]pmInfo, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) return nats_setErrorReal("./src/submodules/nats.c/src/js.c", "_trackPublishAsyncTimeout", @as(c_int, 888), @as(c_uint, @bitCast(NATS_NO_MEMORY)), "%s", natsStatus_GetText(@as(c_uint, @bitCast(NATS_NO_MEMORY))));
    pmi.*.subject = strdup(subject);
    if (pmi.*.subject == @as([*c]u8, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) {
        free(@as(?*anyopaque, @ptrCast(pmi)));
        return nats_setErrorReal("./src/submodules/nats.c/src/js.c", "_trackPublishAsyncTimeout", @as(c_int, 894), @as(c_uint, @bitCast(NATS_NO_MEMORY)), "%s", natsStatus_GetText(@as(c_uint, @bitCast(NATS_NO_MEMORY))));
    }
    ...
    if (((blk: {
        ...
        pm = tmp;
        break :blk tmp;
    }) != @as([*c]pmInfo, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) and (pmi.*.deadline >= pm.*.deadline)) {
        js.*.pmTail.*.next = pmi;
        js.*.pmTail = pmi;
    } else if (((blk: {
        const tmp = js.*.pmHead;
    ...
    } else if (js.*.pmHead == @as([*c]pmInfo, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) {
        js.*.pmHead = pmi;
        js.*.pmTail = pmi;
        if (js.*.pmtmr == @as([*c]natsTimer, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) {
            s = natsTimer_Create(&js.*.pmtmr, &_timeoutPubAsync, &_timeoutPubAsyncComplete, mw, @as(?*anyopaque, @ptrCast(js)));
            if (s == @as(c_uint, @bitCast(NATS_OK))) {
                js_retain(js);
            }
        } else {
        ...
        pm = js.*.pmHead;
        while (((pm != @as([*c]pmInfo, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) and (pm.*.next != @as([*c]struct___pmInfo, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0)))))))) and (pmi.*.deadline > pm.*.next.*.deadline)) {
            pm = pm.*.next;
        }
        pmi.*.next = pm.*.next;
        pm.*.next = pmi;
    ...
    return if (s == @as(c_uint, @bitCast(NATS_OK))) s else nats_updateErrStack(s, "_trackPublishAsyncTimeout");
}
pub fn _registerPubMsg(arg_nc: [*c][*c]natsConnection, arg_reply: [*c]u8, arg_js: [*c]jsCtx, arg_msg: [*c]natsMsg, arg_mw: i64) callconv(.c) natsStatus {
    var nc = arg_nc;
    _ = &nc;
    var reply = arg_reply;
    _ = &reply;
    ...
    if (s == @as(c_uint, @bitCast(NATS_OK))) {
        id = reply + @as(usize, @bitCast(@as(isize, @intCast(js.*.rpreLen))));
    }
    if (((s == @as(c_uint, @bitCast(NATS_OK))) and (maxp > @as(i64, @bitCast(@as(c_long, @as(c_int, 0)))))) and (js.*.pmcount > maxp)) {
        var target: i64 = nats_setTargetTime(js.*.opts.PublishAsync.StallWait);
        _ = &target;
        _ = blk: {
            const ref = &js.*.refs;
            const tmp = ref.*;
        ...
        js.*.stalled += 1;
        while ((s != @as(c_uint, @bitCast(NATS_TIMEOUT))) and (js.*.pmcount > maxp)) {
            s = natsCondition_AbsoluteTimedWait(js.*.cond, js.*.mu, target);
        }
        js.*.stalled -= 1;
        if (s == @as(c_uint, @bitCast(NATS_TIMEOUT))) {
            s = nats_setErrorReal("./src/submodules/nats.c/src/js.c", "_registerPubMsg", @as(c_int, 971), s, "%s", "stalled with too many outstanding async published messages");
        }
        release = @as(c_int, 1) != 0;
    }
    if ((s == @as(c_uint, @bitCast(NATS_OK))) and (mw > @as(i64, @bitCast(@as(c_long, @as(c_int, 0)))))) {
        s = _trackPublishAsyncTimeout(js, reply, mw);
    }
    if (s == @as(c_uint, @bitCast(NATS_OK))) {
        s = natsStrHash_SetEx(js.*.pm, id, @as(c_int, 1) != 0, (if (@as(c_int, 1) != 0) @as(c_int, 1) else @as(c_int, 0)) != 0, @as(?*anyopaque, @ptrCast(msg)), null);
    }
    if (s == @as(c_uint, @bitCast(NATS_OK))) {
        nc.* = js.*.nc;
    } else {
    ...
    return if (s == @as(c_uint, @bitCast(NATS_OK))) s else nats_updateErrStack(s, "_registerPubMsg");
}
pub fn _lookupStreamBySubject(arg_stream: [*c][*c]const u8, arg_nc: [*c]natsConnection, arg_subject: [*c]const u8, arg_jo: [*c]jsOptions, arg_errCode: [*c]jsErrCode) callconv(.c) natsStatus {
    var stream = arg_stream;
    _ = &stream;
    var nc = arg_nc;
    _ = &nc;
    ...
    _ = &buf;
    var apiSubj: [*c]u8 = null;
    _ = &apiSubj;
    var resp: [*c]natsMsg = null;
    _ = &resp;
    stream.* = null;
    s = natsBuf_Create(&buf, @as(c_int, 14) + @as(c_int, @bitCast(@as(c_uint, @truncate(strlen(subject))))));
    if (s == @as(c_uint, @bitCast(NATS_OK))) {
    ...
    if (s == @as(c_uint, @bitCast(NATS_OK))) {
        if (asprintf(&apiSubj, "%.*s.STREAM.NAMES", js_lenWithoutTrailingDot(jo.*.Prefix), jo.*.Prefix) < @as(c_int, 0)) {
            s = nats_setErrorReal("./src/submodules/nats.c/src/js.c", "_lookupStreamBySubject", @as(c_int, 1188), @as(c_uint, @bitCast(NATS_NO_MEMORY)), "%s", natsStatus_GetText(@as(c_uint, @bitCast(NATS_NO_MEMORY))));
        }
    }
    if (s == @as(c_uint, @bitCast(NATS_OK))) {
        s = natsConnection_Request(&resp, nc, apiSubj, @as(?*const anyopaque, @ptrCast(buf.*.data)), buf.*.len, jo.*.Wait);
        if ((s == @as(c_uint, @bitCast(NATS_NO_RESPONDERS))) and (errCode != @as([*c]jsErrCode, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0)))))))) {
            errCode.* = @as(c_uint, @bitCast(JSNotEnabledErr));
        }
    }
    if (((s == @as(c_uint, @bitCast(NATS_OK))) and (resp != @as([*c]natsMsg, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0)))))))) and (natsMsg_GetDataLength(resp) > @as(c_int, 0))) {
        var json: [*c]nats_JSON = null;
        _ = &json;
        var streams: [*c][*c]u8 = null;
        _ = &streams;
        var count: c_int = 0;
        _ = &count;
        var i: c_int = undefined;
        ...
        s = nats_JSONParse(&json, natsMsg_GetData(resp), natsMsg_GetDataLength(resp));
        if (s == @as(c_uint, @bitCast(NATS_OK))) {
            s = nats_JSONGetArrayStr(json, "streams", &streams, &count);
        }
        if ((s == @as(c_uint, @bitCast(NATS_OK))) and (count > @as(c_int, 0))) {
            stream.* = streams[@as(c_uint, @intCast(@as(c_int, 0)))];
        } else {
            s = nats_setErrorReal("./src/submodules/nats.c/src/js.c", "_lookupStreamBySubject", @as(c_int, 1206), @as(c_uint, @bitCast(NATS_ERR)), "%s", "no stream matches subject");
        }
        {
            i = 1;
            while (i < count) : (i += 1) {
    ...
    free(@as(?*anyopaque, @ptrCast(apiSubj)));
    natsBuf_Destroy(buf);
    natsMsg_Destroy(resp);
    return if (s == @as(c_uint, @bitCast(NATS_OK))) s else nats_updateErrStack(s, "_lookupStreamBySubject");
}
pub fn _destroyFetch(arg_fetch: [*c]jsFetch) callconv(.c) void {
    var fetch = arg_fetch;
    _ = &fetch;
    if (fetch == @as([*c]jsFetch, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) return;
    if (fetch.*.expiresTimer != @as([*c]natsTimer, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) {
        natsTimer_Destroy(fetch.*.expiresTimer);
    }
    free(@as(?*anyopaque, @ptrCast(fetch)));
}
pub fn _autoAckCB(arg_nc: [*c]natsConnection, arg_sub: [*c]natsSubscription, arg_msg: [*c]natsMsg, arg_closure: ?*anyopaque) callconv(.c) void {
    var nc = arg_nc;
    _ = &nc;
    var sub = arg_sub;
    _ = &sub;
    ...
    var closure = arg_closure;
    _ = &closure;
    var jsi: [*c]jsSub = @as([*c]jsSub, @ptrCast(@alignCast(closure)));
    _ = &jsi;
    _ = blk: {
        const ref = &msg.*.flags;
        ref.* |= @as(c_int, 1) << @intCast(2);
        break :blk ref.*;
    };
    jsi.*.usrCb.?(nc, sub, msg, jsi.*.usrCbClosure);
    _ = natsMsg_Ack(msg, null);
    _ = blk: {
        const ref = &msg.*.flags;
        ref.* &= ~(@as(c_int, 1) << @intCast(2));
        break :blk ref.*;
...
pub fn _copyString(arg_new_str: [*c][*c]u8, arg_str: [*c]const u8, arg_l: c_int) callconv(.c) natsStatus {
    ...
    var l = arg_l;
    _ = &l;
    new_str.* = @as([*c]u8, @ptrCast(@alignCast(malloc(@as(c_ulong, @bitCast(@as(c_long, l + @as(c_int, 1))))))));
    if (new_str.* == @as([*c]u8, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) return nats_setErrorReal("./src/submodules/nats.c/src/js.c", "_copyString", @as(c_int, 1345), @as(c_uint, @bitCast(NATS_NO_MEMORY)), "%s", natsStatus_GetText(@as(c_uint, @bitCast(NATS_NO_MEMORY))));
    _ = memcpy(@as(?*anyopaque, @ptrCast(new_str.*)), @as(?*const anyopaque, @ptrCast(str)), @as(c_ulong, @bitCast(@as(c_long, l))));
    (new_str.* + @as(usize, @bitCast(@as(isize, @intCast(l))))).* = '\x00';
    return @as(c_uint, @bitCast(NATS_OK));
}
pub fn _fetchIDFromSubject(arg_sub: [*c]natsSubscription, arg_subj: [*c]const u8) callconv(.c) i64 {
    var sub = arg_sub;
    _ = &sub;
    var subj = arg_subj;
    _ = &subj;
    var len: c_int = (@as(c_int, 7) + (@as(c_int, 12) + @as(c_int, 10))) + @as(c_int, 1);
    _ = &len;
    var id: i64 = 0;
    _ = &id;
    if (strncmp(sub.*.subject, subj, @as(c_ulong, @bitCast(@as(c_long, len)))) != @as(c_int, 0)) return @as(i64, @bitCast(@as(c_long, -@as(c_int, 1))));
    subj += @as(usize, @bitCast(@as(isize, @intCast(len))));
    if (@as(c_int, @bitCast(@as(c_uint, subj.*))) == @as(c_int, '\x00')) return @as(i64, @bitCast(@as(c_long, -@as(c_int, 1))));
    while (@as(c_int, @bitCast(@as(c_uint, subj.*))) != @as(c_int, '\x00')) : (subj += 1) {
        if ((@as(c_int, @bitCast(@as(c_uint, subj.*))) < @as(c_int, '0')) or (@as(c_int, @bitCast(@as(c_uint, subj.*))) > @as(c_int, '9'))) return @as(i64, @bitCast(@as(c_long, -@as(c_int, 1))));
        id = (id * @as(i64, @bitCast(@as(c_long, @as(c_int, 10))))) + @as(i64, @bitCast(@as(c_long, @as(c_int, @bitCast(@as(c_uint, subj.*))) - @as(c_int, '0'))));
    }
    return id;
}
pub fn _sendPullRequest(arg_nc: [*c]natsConnection, arg_subj: [*c]const u8, arg_rply: [*c]const u8, arg_buf: [*c]natsBuffer, arg_req: [*c]jsFetchRequest) callconv(.c) natsStatus {
    var nc = arg_nc;
    _ = &nc;
    var subj = arg_subj;
    _ = &subj;
    ...
    _ = &expires;
    expires = if (req.*.Expires >= @as(i64, @intFromFloat(20000000.0))) req.*.Expires - @as(i64, @intFromFloat(10000000.0)) else req.*.Expires;
    natsBuf_Reset(buf);
    s = natsBuf_AppendByte(buf, @as(u8, @bitCast(@as(i8, @truncate(@as(c_int, '{'))))));
    if (s == @as(c_uint, @bitCast(NATS_OK))) {
        s = nats_marshalLong(buf, @as(c_int, 0) != 0, "batch", @as(i64, @bitCast(@as(c_long, req.*.Batch))));
    }
    if ((s == @as(c_uint, @bitCast(NATS_OK))) and (req.*.MaxBytes > @as(i64, @bitCast(@as(c_long, @as(c_int, 0)))))) {
        s = nats_marshalLong(buf, @as(c_int, 1) != 0, "max_bytes", req.*.MaxBytes);
    }
    if ((s == @as(c_uint, @bitCast(NATS_OK))) and (expires > @as(i64, @bitCast(@as(c_long, @as(c_int, 0)))))) {
        s = nats_marshalLong(buf, @as(c_int, 1) != 0, "expires", expires);
    }
    if ((s == @as(c_uint, @bitCast(NATS_OK))) and (req.*.Heartbeat > @as(i64, @bitCast(@as(c_long, @as(c_int, 0)))))) {
        s = nats_marshalLong(buf, @as(c_int, 1) != 0, "idle_heartbeat", req.*.Heartbeat);
    }
    if ((s == @as(c_uint, @bitCast(NATS_OK))) and (@as(c_int, @intFromBool(req.*.NoWait)) != 0)) {
        s = natsBuf_Append(buf, ",\"no_wait\":true", -@as(c_int, 1));
    }
    if (s == @as(c_uint, @bitCast(NATS_OK))) {
        s = natsBuf_AppendByte(buf, @as(u8, @bitCast(@as(i8, @truncate(@as(c_int, '}'))))));
    }
    if (s == @as(c_uint, @bitCast(NATS_OK))) {
        s = natsConnection_PublishRequest(nc, subj, rply, @as(?*const anyopaque, @ptrCast(buf.*.data)), buf.*.len);
    }
    return if (s == @as(c_uint, @bitCast(NATS_OK))) s else nats_updateErrStack(s, "_sendPullRequest");
}
pub export fn _fetch(arg_list: [*c]natsMsgList, arg_sub: [*c]natsSubscription, arg_req: [*c]jsFetchRequest, arg_simpleFetch: bool) natsStatus {
    var list = arg_list;
    _ = &list;
    var sub = arg_sub;
    _ = &sub;
    var req = arg_req;
    _ = &req;
    var simpleFetch = arg_simpleFetch;
    _ = &simpleFetch;
    var s: natsStatus = @as(c_uint, @bitCast(NATS_OK));
    _ = &s;
    var msgs: [*c][*c]natsMsg = null;
    _ = &msgs;
    var count: c_int = 0;
    _ = &count;
    var batch: c_int = 0;
    ...
    var nc: [*c]natsConnection = null;
    _ = &nc;
    var subj: [*c]const u8 = null;
    _ = &subj;
    var rply: [61]u8 = undefined;
    _ = &rply;
    var pmc: c_int = 0;
    _ = &pmc;
    ...
    var size: c_int = 0;
    _ = &size;
    var sendReq: bool = @as(c_int, 1) != 0;
    _ = &sendReq;
    var jsi: [*c]jsSub = null;
    _ = &jsi;
    var noWait: bool = @as(c_int, 0) != 0;
    _ = &noWait;
    var fetchID: u64 = 0;
    _ = &fetchID;
    if (list == @as([*c]natsMsgList, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) return nats_setErrorReal("./src/submodules/nats.c/src/js.c", "_fetch", @as(c_int, 1870), @as(c_uint, @bitCast(NATS_INVALID_ARG)), "%s", natsStatus_GetText(@as(c_uint, @bitCast(NATS_INVALID_ARG))));
    _ = memset(@as(?*anyopaque, @ptrCast(list)), @as(c_int, 0), @sizeOf(natsMsgList));
    if ((((sub == @as([*c]natsSubscription, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) or (req == @as([*c]jsFetchRequest, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0)))))))) or (req.*.Batch <= @as(c_int, 0))) or (req.*.MaxBytes < @as(i64, @bitCast(@as(c_long, @as(c_int, 0)))))) return nats_setErrorReal("./src/submodules/nats.c/src/js.c", "_fetch", @as(c_int, 1875), @as(c_uint, @bitCast(NATS_INVALID_ARG)), "%s", natsStatus_GetText(@as(c_uint, @bitCast(NATS_INVALID_ARG))));
    if (!req.*.NoWait and (req.*.Expires <= @as(i64, @bitCast(@as(c_long, @as(c_int, 0)))))) return nats_setErrorReal("./src/submodules/nats.c/src/js.c", "_fetch", @as(c_int, 1878), @as(c_uint, @bitCast(NATS_INVALID_TIMEOUT)), "%s", natsStatus_GetText(@as(c_uint, @bitCast(NATS_INVALID_TIMEOUT))));
    natsSub_Lock(sub);
    jsi = sub.*.jsi;
    if ((jsi == @as([*c]jsSub, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) or !jsi.*.pull) {
        natsSub_Unlock(sub);
        return nats_setErrorReal("./src/submodules/nats.c/src/js.c", "_fetch", @as(c_int, 1885), @as(c_uint, @bitCast(NATS_INVALID_SUBSCRIPTION)), "%s", "not a JetStream pull subscription");
    }
    if (jsi.*.inFetch) {
        natsSub_Unlock(sub);
        return nats_setErrorReal("./src/submodules/nats.c/src/js.c", "_fetch", @as(c_int, 1890), @as(c_uint, @bitCast(NATS_ERR)), "%s", "concurrent fetch request not allowed");
    }
    msgs = @as([*c][*c]natsMsg, @ptrCast(@alignCast(calloc(@as(c_ulong, @bitCast(@as(c_long, req.*.Batch))), @sizeOf([*c]natsMsg)))));
    if (msgs == @as([*c][*c]natsMsg, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) {
        natsSub_Unlock(sub);
        return nats_setErrorReal("./src/submodules/nats.c/src/js.c", "_fetch", @as(c_int, 1896), @as(c_uint, @bitCast(NATS_NO_MEMORY)), "%s", natsStatus_GetText(@as(c_uint, @bitCast(NATS_NO_MEMORY))));
    }
    _ = natsBuf_InitWithBackend(&buf, @as([*c]u8, @ptrCast(@alignCast(&buffer))), @as(c_int, 0), @as(c_int, @bitCast(@as(c_uint, @truncate(@sizeOf([64]u8))))));
    nc = sub.*.conn;
    subj = jsi.*.nxtMsgSubj;
    pmc = @intFromBool(sub.*.ownDispatcher.queue.msgs > @as(c_int, 0));
    jsi.*.inFetch = @as(c_int, 1) != 0;
    jsi.*.fetchID +%= 1;
    fetchID = jsi.*.fetchID;
    _ = snprintf(@as([*c]u8, @ptrCast(@alignCast(&rply))), @sizeOf([61]u8), "%.*s%lu", @as(c_int, @bitCast(@as(c_uint, @truncate(strlen(sub.*.subject))))) - @as(c_int, 1), sub.*.subject, fetchID);
    if ((s == @as(c_uint, @bitCast(NATS_OK))) and (req.*.Heartbeat != 0)) {
        s = nats_createControlMessages(sub);
        if (s == @as(c_uint, @bitCast(NATS_OK))) {
            var hbi: i64 = @divTrunc(req.*.Heartbeat, @as(i64, @bitCast(@as(c_long, @as(c_int, 1000000)))));
            _ = &hbi;
            sub.*.refs += 1;
            if (jsi.*.hbTimer == @as([*c]natsTimer, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) {
                s = natsTimer_Create(&jsi.*.hbTimer, &_hbTimerFired, &_releaseSubWhenStopped, hbi * @as(i64, @bitCast(@as(c_long, @as(c_int, 2)))), @as(?*anyopaque, @ptrCast(sub)));
                if (s != @as(c_uint, @bitCast(NATS_OK))) {
                    sub.*.refs -= 1;
                }
            } else {
    ...
    natsSub_Unlock(sub);
    if (req.*.Expires > @as(i64, @bitCast(@as(c_long, @as(c_int, 0))))) {
        start = nats_Now();
        timeout = @divTrunc(req.*.Expires, @as(i64, @intFromFloat(1000000.0)));
        deadline = start + timeout;
    }
    while ((((pmc != 0) and (s == @as(c_uint, @bitCast(NATS_OK)))) and (count < req.*.Batch)) and ((req.*.MaxBytes == @as(i64, @bitCast(@as(c_long, @as(c_int, 0))))) or (@as(i64, @bitCast(@as(c_long, size))) < req.*.MaxBytes))) {
        var msg: [*c]natsMsg = null;
        _ = &msg;
        var usrMsg: bool = @as(c_int, 0) != 0;
        _ = &usrMsg;
        s = natsSub_nextMsg(&msg, sub, @as(i64, @bitCast(@as(c_long, @as(c_int, 0)))), @as(c_int, 1) != 0);
        if (s == @as(c_uint, @bitCast(NATS_TIMEOUT))) {
            s = @as(c_uint, @bitCast(NATS_OK));
            break;
        }
        if (s == @as(c_uint, @bitCast(NATS_OK))) {
            s = js_checkFetchedMsg(sub, msg, fetchID, @as(c_int, 0) != 0, &usrMsg);
            if ((s == @as(c_uint, @bitCast(NATS_OK))) and (@as(c_int, @intFromBool(usrMsg)) != 0)) {
                (blk: {
                    const tmp = blk_1: {
                        const ref = &count;
                        const tmp_2 = ref.*;
                    ...
                    if (tmp >= 0) break :blk msgs + @as(usize, @intCast(tmp)) else break :blk msgs - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
                }).* = msg;
                size += msg.*.wsz;
            } else {
                natsMsg_Destroy(msg);
    ...
    if (s == @as(c_uint, @bitCast(NATS_OK))) {
        if (simpleFetch) {
            noWait = (if ((req.*.Batch - count) > @as(c_int, 1)) @as(c_int, 1) else @as(c_int, 0)) != 0;
        } else {
            noWait = req.*.NoWait;
        }
    }
    batch = req.*.Batch;
    while (((s == @as(c_uint, @bitCast(NATS_OK))) and (count != batch)) and ((req.*.MaxBytes == @as(i64, @bitCast(@as(c_long, @as(c_int, 0))))) or (@as(i64, @bitCast(@as(c_long, size))) < req.*.MaxBytes))) {
        var msg: [*c]natsMsg = null;
        _ = &msg;
        var usrMsg: bool = @as(c_int, 0) != 0;
        _ = &usrMsg;
        ...
        if ((s == @as(c_uint, @bitCast(NATS_OK))) and (@as(c_int, @intFromBool(sendReq)) != 0)) {
            sendReq = @as(c_int, 0) != 0;
            req.*.Batch = req.*.Batch - count;
            req.*.Expires = timeout * @as(i64, @intFromFloat(1000000.0));
            req.*.NoWait = noWait;
            s = _sendPullRequest(nc, subj, @as([*c]u8, @ptrCast(@alignCast(&rply))), &buf, req);
        }
        if (s == @as(c_uint, @bitCast(NATS_OK))) {
            s = natsSub_nextMsg(&msg, sub, timeout, @as(c_int, 1) != 0);
        }
        if (s == @as(c_uint, @bitCast(NATS_OK))) {
            s = js_checkFetchedMsg(sub, msg, fetchID, @as(c_int, 1) != 0, &usrMsg);
            if ((s == @as(c_uint, @bitCast(NATS_OK))) and (@as(c_int, @intFromBool(usrMsg)) != 0)) {
                (blk: {
                    const tmp = blk_1: {
                        const ref = &count;
                ...
                natsMsg_Destroy(msg);
                if ((((@as(c_int, @intFromBool(simpleFetch)) != 0) and (@as(c_int, @intFromBool(noWait)) != 0)) and (s == @as(c_uint, @bitCast(NATS_NOT_FOUND)))) and (count == @as(c_int, 0))) {
                    s = @as(c_uint, @bitCast(NATS_OK));
                    noWait = @as(c_int, 0) != 0;
                    sendReq = @as(c_int, 1) != 0;
                }
            }
        }
    }
    ...
    if (s != @as(c_uint, @bitCast(NATS_OK))) {
        free(@as(?*anyopaque, @ptrCast(msgs)));
    }
    natsSub_Lock(sub);
    jsi.*.inFetch = @as(c_int, 0) != 0;
    if ((req.*.Heartbeat != 0) and (jsi.*.hbTimer != @as([*c]natsTimer, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0)))))))) {
        natsTimer_Stop(jsi.*.hbTimer);
    }
    natsSub_Unlock(sub);
    return if (s == @as(c_uint, @bitCast(NATS_OK))) s else nats_updateErrStack(s, "_fetch");
}
pub fn _fetchExpiredFired(arg_timer: [*c]natsTimer, arg_closure: ?*anyopaque) callconv(.c) void {
    var timer = arg_timer;
    _ = &timer;
    var closure = arg_closure;
    _ = &closure;
...
pub fn _stringPropertyDiffer(arg_user: [*c]const u8, arg_server: [*c]const u8) callconv(.c) bool {
    var user = arg_user;
    _ = &user;
    var server = arg_server;
    _ = &server;
    if ((if ((user == @as([*c]const u8, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) or (@as(c_int, @bitCast(@as(c_uint, user[@as(c_uint, @intCast(@as(c_int, 0)))]))) == @as(c_int, '\x00'))) @as(c_int, 1) else @as(c_int, 0)) != 0) return @as(c_int, 0) != 0;
    if ((if ((server == @as([*c]const u8, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) or (@as(c_int, @bitCast(@as(c_uint, server[@as(c_uint, @intCast(@as(c_int, 0)))]))) == @as(c_int, '\x00'))) @as(c_int, 1) else @as(c_int, 0)) != 0) return @as(c_int, 1) != 0;
    return (if (strcmp(user, server) != @as(c_int, 0)) @as(c_int, 1) else @as(c_int, 0)) != 0;
}
pub fn _checkConfig(arg_s: [*c]jsConsumerConfig, arg_u: [*c]jsConsumerConfig) callconv(.c) natsStatus {
    var s = arg_s;
    _ = &s;
    var u = arg_u;
    _ = &u;
    if (_stringPropertyDiffer(u.*.Durable, s.*.Durable)) return nats_setErrorReal("./src/submodules/nats.c/src/js.c", "_checkConfig", @as(c_int, 2186), @as(c_uint, @bitCast(NATS_ERR)), "configuration requests %s to be '%s', but consumer's value is '%s'", "durable", u.*.Durable, s.*.Durable);
    if (_stringPropertyDiffer(u.*.Description, s.*.Description)) return nats_setErrorReal("./src/submodules/nats.c/src/js.c", "_checkConfig", @as(c_int, 2189), @as(c_uint, @bitCast(NATS_ERR)), "configuration requests %s to be '%s', but consumer's value is '%s'", "description", u.*.Description, s.*.Description);
    if ((@as(c_int, @bitCast(u.*.DeliverPolicy)) >= @as(c_int, 0)) and (u.*.DeliverPolicy != s.*.DeliverPolicy)) return nats_setErrorReal("./src/submodules/nats.c/src/js.c", "_checkConfig", @as(c_int, 2192), @as(c_uint, @bitCast(NATS_ERR)), "configuration requests %s to be %d, but consumer's value is %d", "deliver policy", u.*.DeliverPolicy, s.*.DeliverPolicy);
    if ((u.*.OptStartSeq > @as(u64, @bitCast(@as(c_long, @as(c_int, 0))))) and (u.*.OptStartSeq != s.*.OptStartSeq)) return nats_setErrorReal("./src/submodules/nats.c/src/js.c", "_checkConfig", @as(c_int, 2195), @as(c_uint, @bitCast(NATS_ERR)), "configuration requests %s to be %lu, but consumer's value is %lu", "optional start sequence", u.*.OptStartSeq, s.*.OptStartSeq);
    if ((u.*.OptStartTime > @as(i64, @bitCast(@as(c_long, @as(c_int, 0))))) and (u.*.OptStartTime != s.*.OptStartTime)) return nats_setErrorReal("./src/submodules/nats.c/src/js.c", "_checkConfig", @as(c_int, 2198), @as(c_uint, @bitCast(NATS_ERR)), "configuration requests %s to be %ld, but consumer's value is %ld", "optional start time", u.*.OptStartTime, s.*.OptStartTime);
    if ((@as(c_int, @bitCast(u.*.AckPolicy)) >= @as(c_int, 0)) and (u.*.AckPolicy != s.*.AckPolicy)) return nats_setErrorReal("./src/submodules/nats.c/src/js.c", "_checkConfig", @as(c_int, 2201), @as(c_uint, @bitCast(NATS_ERR)), "configuration requests %s to be %d, but consumer's value is %d", "ack policy", u.*.AckPolicy, s.*.AckPolicy);
    if ((u.*.AckWait > @as(i64, @bitCast(@as(c_long, @as(c_int, 0))))) and (u.*.AckWait != s.*.AckWait)) return nats_setErrorReal("./src/submodules/nats.c/src/js.c", "_checkConfig", @as(c_int, 2204), @as(c_uint, @bitCast(NATS_ERR)), "configuration requests %s to be %ld, but consumer's value is %ld", "ack wait", u.*.AckWait, s.*.AckWait);
    if ((u.*.MaxDeliver > @as(i64, @bitCast(@as(c_long, @as(c_int, 0))))) and (u.*.MaxDeliver != s.*.MaxDeliver)) return nats_setErrorReal("./src/submodules/nats.c/src/js.c", "_checkConfig", @as(c_int, 2207), @as(c_uint, @bitCast(NATS_ERR)), "configuration requests %s to be %ld, but consumer's value is %ld", "max deliver", u.*.MaxDeliver, s.*.MaxDeliver);
    if ((u.*.BackOffLen > @as(c_int, 0)) and (u.*.BackOffLen != s.*.BackOffLen)) return nats_setErrorReal("./src/submodules/nats.c/src/js.c", "_checkConfig", @as(c_int, 2210), @as(c_uint, @bitCast(NATS_ERR)), "configuration requests %s to be %d, but consumer's value is %d", "backoff list length", u.*.BackOffLen, s.*.BackOffLen);
    if ((@as(c_int, @bitCast(u.*.ReplayPolicy)) >= @as(c_int, 0)) and (u.*.ReplayPolicy != s.*.ReplayPolicy)) return nats_setErrorReal("./src/submodules/nats.c/src/js.c", "_checkConfig", @as(c_int, 2213), @as(c_uint, @bitCast(NATS_ERR)), "configuration requests %s to be %d, but consumer's value is %d", "replay policy", u.*.ReplayPolicy, s.*.ReplayPolicy);
    if ((u.*.RateLimit > @as(u64, @bitCast(@as(c_long, @as(c_int, 0))))) and (u.*.RateLimit != s.*.RateLimit)) return nats_setErrorReal("./src/submodules/nats.c/src/js.c", "_checkConfig", @as(c_int, 2216), @as(c_uint, @bitCast(NATS_ERR)), "configuration requests %s to be %lu, but consumer's value is %lu", "rate limit", u.*.RateLimit, s.*.RateLimit);
    if (_stringPropertyDiffer(u.*.SampleFrequency, s.*.SampleFrequency)) return nats_setErrorReal("./src/submodules/nats.c/src/js.c", "_checkConfig", @as(c_int, 2219), @as(c_uint, @bitCast(NATS_ERR)), "configuration requests %s to be '%s', but consumer's value is '%s'", "sample frequency", u.*.SampleFrequency, s.*.SampleFrequency);
    if ((u.*.MaxWaiting > @as(i64, @bitCast(@as(c_long, @as(c_int, 0))))) and (u.*.MaxWaiting != s.*.MaxWaiting)) return nats_setErrorReal("./src/submodules/nats.c/src/js.c", "_checkConfig", @as(c_int, 2222), @as(c_uint, @bitCast(NATS_ERR)), "configuration requests %s to be %ld, but consumer's value is %ld", "max waiting", u.*.MaxWaiting, s.*.MaxWaiting);
    if ((u.*.MaxAckPending > @as(i64, @bitCast(@as(c_long, @as(c_int, 0))))) and (u.*.MaxAckPending != s.*.MaxAckPending)) return nats_setErrorReal("./src/submodules/nats.c/src/js.c", "_checkConfig", @as(c_int, 2225), @as(c_uint, @bitCast(NATS_ERR)), "configuration requests %s to be %ld, but consumer's value is %ld", "max ack pending", u.*.MaxAckPending, s.*.MaxAckPending);
    if ((@as(c_int, @intFromBool(u.*.FlowControl)) != 0) and !s.*.FlowControl) return nats_setErrorReal("./src/submodules/nats.c/src/js.c", "_checkConfig", @as(c_int, 2231), @as(c_uint, @bitCast(NATS_ERR)), "configuration requests %s to be '%s', but consumer's value is '%s'", "flow control", "true", "false");
    if ((u.*.Heartbeat > @as(i64, @bitCast(@as(c_long, @as(c_int, 0))))) and (u.*.Heartbeat != s.*.Heartbeat)) return nats_setErrorReal("./src/submodules/nats.c/src/js.c", "_checkConfig", @as(c_int, 2234), @as(c_uint, @bitCast(NATS_ERR)), "configuration requests %s to be %ld, but consumer's value is %ld", "heartbeat", u.*.Heartbeat, s.*.Heartbeat);
    if (@as(c_int, @intFromBool(u.*.HeadersOnly)) != @as(c_int, @intFromBool(s.*.HeadersOnly))) return nats_setErrorReal("./src/submodules/nats.c/src/js.c", "_checkConfig", @as(c_int, 2237), @as(c_uint, @bitCast(NATS_ERR)), "configuration requests %s to be %d, but consumer's value is %d", "headers only", @as(c_int, @intFromBool(u.*.HeadersOnly)), @as(c_int, @intFromBool(s.*.HeadersOnly)));
    if ((u.*.MaxRequestBatch > @as(i64, @bitCast(@as(c_long, @as(c_int, 0))))) and (u.*.MaxRequestBatch != s.*.MaxRequestBatch)) return nats_setErrorReal("./src/submodules/nats.c/src/js.c", "_checkConfig", @as(c_int, 2240), @as(c_uint, @bitCast(NATS_ERR)), "configuration requests %s to be %ld, but consumer's value is %ld", "max request batch", u.*.Heartbeat, s.*.Heartbeat);
    if ((u.*.MaxRequestExpires > @as(i64, @bitCast(@as(c_long, @as(c_int, 0))))) and (u.*.MaxRequestExpires != s.*.MaxRequestExpires)) return nats_setErrorReal("./src/submodules/nats.c/src/js.c", "_checkConfig", @as(c_int, 2243), @as(c_uint, @bitCast(NATS_ERR)), "configuration requests %s to be %ld, but consumer's value is %ld", "max request expires", u.*.MaxRequestExpires, s.*.MaxRequestExpires);
    if ((u.*.InactiveThreshold > @as(i64, @bitCast(@as(c_long, @as(c_int, 0))))) and (u.*.InactiveThreshold != s.*.InactiveThreshold)) return nats_setErrorReal("./src/submodules/nats.c/src/js.c", "_checkConfig", @as(c_int, 2246), @as(c_uint, @bitCast(NATS_ERR)), "configuration requests %s to be %ld, but consumer's value is %ld", "inactive threshold", u.*.InactiveThreshold, s.*.InactiveThreshold);
    if ((u.*.Replicas > @as(i64, @bitCast(@as(c_long, @as(c_int, 0))))) and (u.*.Replicas != s.*.Replicas)) return nats_setErrorReal("./src/submodules/nats.c/src/js.c", "_checkConfig", @as(c_int, 2249), @as(c_uint, @bitCast(NATS_ERR)), "configuration requests %s to be %ld, but consumer's value is %ld", "replicas", u.*.Replicas, s.*.Replicas);
    if (@as(c_int, @intFromBool(u.*.MemoryStorage)) != @as(c_int, @intFromBool(s.*.MemoryStorage))) return nats_setErrorReal("./src/submodules/nats.c/src/js.c", "_checkConfig", @as(c_int, 2252), @as(c_uint, @bitCast(NATS_ERR)), "configuration requests %s to be %d, but consumer's value is %d", "memory storage", @as(c_int, @intFromBool(u.*.MemoryStorage)), @as(c_int, @intFromBool(s.*.MemoryStorage)));
    return @as(c_uint, @bitCast(NATS_OK));
}
pub fn _processConsInfo(arg_dlvSubject: [*c][*c]const u8, arg_info: [*c]jsConsumerInfo, arg_userCfg: [*c]jsConsumerConfig, arg_isPullMode: bool, arg_subjects: [*c][*c]const u8, arg_numSubjects: c_int, arg_queue: [*c]const u8) callconv(.c) natsStatus {
    var dlvSubject = arg_dlvSubject;
    _ = &dlvSubject;
    var info = arg_info;
    _ = &info;
    var userCfg = arg_userCfg;
    _ = &userCfg;
    var isPullMode = arg_isPullMode;
    _ = &isPullMode;
    var subjects = arg_subjects;
    _ = &subjects;
    var numSubjects = arg_numSubjects;
    ...
    var queue = arg_queue;
    _ = &queue;
    var dlvSubjEmpty: bool = @as(c_int, 0) != 0;
    _ = &dlvSubjEmpty;
    var ccfg: [*c]jsConsumerConfig = info.*.Config;
    _ = &ccfg;
    var dg: [*c]const u8 = null;
    _ = &dg;
    var s: natsStatus = @as(c_uint, @bitCast(NATS_OK));
    _ = &s;
    var stackFilterSubject: [1][*c]const u8 = [1][*c]const u8{
        ccfg.*.FilterSubject,
    };
    _ = &stackFilterSubject;
    var filterSubjects: [*c][*c]const u8 = @as([*c][*c]const u8, @ptrCast(@alignCast(&stackFilterSubject)));
    _ = &filterSubjects;
    var filterSubjectsLen: c_int = 1;
    _ = &filterSubjectsLen;
    var incoming: c_int = undefined;
    _ = &incoming;
    var existing: c_int = undefined;
    _ = &existing;
    dlvSubject.* = null;
    if (ccfg.*.FilterSubjectsLen > @as(c_int, 0)) {
        filterSubjects = ccfg.*.FilterSubjects;
        filterSubjectsLen = ccfg.*.FilterSubjectsLen;
    }
    if ((filterSubjectsLen == @as(c_int, 1)) and ((if ((filterSubjects[@as(c_uint, @intCast(@as(c_int, 0)))] == @as([*c]const u8, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) or (@as(c_int, @bitCast(@as(c_uint, filterSubjects[@as(c_uint, @intCast(@as(c_int, 0)))][@as(c_uint, @intCast(@as(c_int, 0)))]))) == @as(c_int, '\x00'))) @as(c_int, 1) else @as(c_int, 0)) != 0)) {
        filterSubjects = null;
        filterSubjectsLen = 0;
    }
    if ((numSubjects == @as(c_int, 1)) and ((if ((subjects[@as(c_uint, @intCast(@as(c_int, 0)))] == @as([*c]const u8, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) or (@as(c_int, @bitCast(@as(c_uint, subjects[@as(c_uint, @intCast(@as(c_int, 0)))][@as(c_uint, @intCast(@as(c_int, 0)))]))) == @as(c_int, '\x00'))) @as(c_int, 1) else @as(c_int, 0)) != 0)) {
        subjects = null;
        numSubjects = 0;
    }
    if ((numSubjects > @as(c_int, 0)) and (filterSubjectsLen > @as(c_int, 0))) {
        var matches: bool = @as(c_int, 1) != 0;
        _ = &matches;
        {
            incoming = 0;
            while (incoming < numSubjects) : (incoming += 1) {
                var found: bool = @as(c_int, 0) != 0;
                _ = &found;
                {
                    existing = 0;
                    while (existing < filterSubjectsLen) : (existing += 1) {
                        if (strcmp((blk: {
                            const tmp = incoming;
                            if (tmp >= 0) break :blk subjects + @as(usize, @intCast(tmp)) else break :blk subjects - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
                        }).*, (blk: {
                            const tmp = existing;
                            if (tmp >= 0) break :blk filterSubjects + @as(usize, @intCast(tmp)) else break :blk filterSubjects - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
                        }).*) == @as(c_int, 0)) {
                            found = @as(c_int, 1) != 0;
                            break;
                        }
        ...
        if (!matches) {
            if ((numSubjects == @as(c_int, 1)) and (filterSubjectsLen == @as(c_int, 1))) return nats_setErrorReal("./src/submodules/nats.c/src/js.c", "_processConsInfo", @as(c_int, 2318), @as(c_uint, @bitCast(NATS_ERR)), "subject '%s' does not match consumer filter subject '%s'.", subjects[@as(c_uint, @intCast(@as(c_int, 0)))], filterSubjects[@as(c_uint, @intCast(@as(c_int, 0)))]) else return nats_setErrorReal("./src/submodules/nats.c/src/js.c", "_processConsInfo", @as(c_int, 2320), @as(c_uint, @bitCast(NATS_ERR)), "%d subjects do not match any consumer filter subjects.", numSubjects);
        }
    }
    queue = if ((if ((queue == @as([*c]const u8, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) or (@as(c_int, @bitCast(@as(c_uint, queue[@as(c_uint, @intCast(@as(c_int, 0)))]))) == @as(c_int, '\x00'))) @as(c_int, 1) else @as(c_int, 0)) != 0) null else queue;
    if (queue != @as([*c]const u8, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) {
        if (ccfg.*.Heartbeat > @as(i64, @bitCast(@as(c_long, @as(c_int, 0))))) return nats_setErrorReal("./src/submodules/nats.c/src/js.c", "_processConsInfo", @as(c_int, 2330), @as(c_uint, @bitCast(NATS_ERR)), "%s", "a queue subscription cannot be created for a consumer with heartbeat");
        if (ccfg.*.FlowControl) return nats_setErrorReal("./src/submodules/nats.c/src/js.c", "_processConsInfo", @as(c_int, 2333), @as(c_uint, @bitCast(NATS_ERR)), "%s", "a queue subscription cannot be created for a consumer with flow control");
    }
    dlvSubjEmpty = (if ((ccfg.*.DeliverSubject == @as([*c]const u8, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) or (@as(c_int, @bitCast(@as(c_uint, ccfg.*.DeliverSubject[@as(c_uint, @intCast(@as(c_int, 0)))]))) == @as(c_int, '\x00'))) @as(c_int, 1) else @as(c_int, 0)) != 0;
    if ((@as(c_int, @intFromBool(isPullMode)) != 0) and !dlvSubjEmpty) {
        return nats_setErrorReal("./src/submodules/nats.c/src/js.c", "_processConsInfo", @as(c_int, 2341), @as(c_uint, @bitCast(NATS_ERR)), "%s", "cannot pull subscribe to push based consumer");
    } else if (!isPullMode and (@as(c_int, @intFromBool(dlvSubjEmpty)) != 0)) {
        return nats_setErrorReal("./src/submodules/nats.c/src/js.c", "_processConsInfo", @as(c_int, 2345), @as(c_uint, @bitCast(NATS_ERR)), "%s", "must use pull subscribe to bind to pull based consumer");
    }
    if (isPullMode) {
        s = _checkConfig(ccfg, userCfg);
        return if (s == @as(c_uint, @bitCast(NATS_OK))) s else nats_updateErrStack(s, "_processConsInfo");
    }
    dg = ccfg.*.DeliverGroup;
    if ((if ((dg == @as([*c]const u8, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) or (@as(c_int, @bitCast(@as(c_uint, dg[@as(c_uint, @intCast(@as(c_int, 0)))]))) == @as(c_int, '\x00'))) @as(c_int, 1) else @as(c_int, 0)) != 0) {
        if (queue != @as([*c]const u8, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) {
            return nats_setErrorReal("./src/submodules/nats.c/src/js.c", "_processConsInfo", @as(c_int, 2366), @as(c_uint, @bitCast(NATS_ERR)), "%s", "cannot create a queue subscription for a consumer without a deliver group");
        } else if (info.*.PushBound) {
            return nats_setErrorReal("./src/submodules/nats.c/src/js.c", "_processConsInfo", @as(c_int, 2372), @as(c_uint, @bitCast(NATS_ERR)), "%s", "consumer is already bound to a subscription");
        }
    } else {
        if (queue == @as([*c]const u8, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) {
            return nats_setErrorReal("./src/submodules/nats.c/src/js.c", "_processConsInfo", @as(c_int, 2383), @as(c_uint, @bitCast(NATS_ERR)), "cannot create a subscription for a consumer with a deliver group %s", dg);
        } else if (strcmp(queue, dg) != @as(c_int, 0)) {
            return nats_setErrorReal("./src/submodules/nats.c/src/js.c", "_processConsInfo", @as(c_int, 2391), @as(c_uint, @bitCast(NATS_ERR)), "cannot create a queue subscription '%s' for a consumer with a deliver group '%s'", queue, dg);
        }
    }
    s = _checkConfig(ccfg, userCfg);
    if (s == @as(c_uint, @bitCast(NATS_OK))) {
...
// ./src/submodules/nats.c/src/js.c:2547:13: warning: TODO implement translation of stmt class GotoStmtClass

// ./src/submodules/nats.c/src/js.c:2422:1: warning: unable to translate function, demoted to extern
pub extern fn _subscribeMulti(arg_new_sub: [*c][*c]natsSubscription, arg_js: [*c]jsCtx, arg_subjects: [*c][*c]const u8, arg_numSubjects: c_int, arg_pullDurable: [*c]const u8, arg_usrCB: natsMsgHandler, arg_usrCBClosure: ?*anyopaque, arg_isPullMode: bool, arg_jsOpts: [*c]jsOptions, arg_opts: [*c]jsSubOptions, arg_errCode: [*c]jsErrCode) callconv(.c) natsStatus;
pub fn _subscribe(arg_new_sub: [*c][*c]natsSubscription, arg_js: [*c]jsCtx, arg_subject: [*c]const u8, arg_pullDurable: [*c]const u8, arg_usrCB: natsMsgHandler, arg_usrCBClosure: ?*anyopaque, arg_isPullMode: bool, arg_jsOpts: [*c]jsOptions, arg_opts: [*c]jsSubOptions, arg_errCode: [*c]jsErrCode) callconv(.c) natsStatus {
    var new_sub = arg_new_sub;
    _ = &new_sub;
    var js = arg_js;
    _ = &js;
    var subject = arg_subject;
    _ = &subject;
    var pullDurable = arg_pullDurable;
    _ = &pullDurable;
    var usrCB = arg_usrCB;
    _ = &usrCB;
    var usrCBClosure = arg_usrCBClosure;
    _ = &usrCBClosure;
    var isPullMode = arg_isPullMode;
    _ = &isPullMode;
    var jsOpts = arg_jsOpts;
    ...
    var s: natsStatus = @as(c_uint, @bitCast(NATS_OK));
    _ = &s;
    var singleSubject: [1][*c]const u8 = [1][*c]const u8{
        subject,
    };
    _ = &singleSubject;
    var numSubjects: c_int = 1;
    _ = &numSubjects;
    var subjects: [*c][*c]const u8 = @as([*c][*c]const u8, @ptrCast(@alignCast(&singleSubject)));
    _ = &subjects;
    if ((if ((subject == @as([*c]const u8, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) or (@as(c_int, @bitCast(@as(c_uint, subject[@as(c_uint, @intCast(@as(c_int, 0)))]))) == @as(c_int, '\x00'))) @as(c_int, 1) else @as(c_int, 0)) != 0) {
        numSubjects = 0;
        subjects = null;
    }
    s = _subscribeMulti(new_sub, js, subjects, numSubjects, pullDurable, usrCB, usrCBClosure, isPullMode, jsOpts, opts, errCode);
    return if (s == @as(c_uint, @bitCast(NATS_OK))) s else nats_updateErrStack(s, "_subscribe");
}
pub fn _autoNextFetchRequest(arg_messages: [*c]c_int, arg_maxBytes: [*c]i64, arg_sub: [*c]natsSubscription, arg_closure: ?*anyopaque) callconv(.c) bool {
    var messages = arg_messages;
    _ = &messages;
    var maxBytes = arg_maxBytes;
    _ = &maxBytes;
    var sub = arg_sub;
    _ = &sub;
    var closure = arg_closure;
    _ = &closure;
    var fetch: [*c]jsFetch = @as([*c]jsFetch, @ptrCast(@alignCast(closure)));
    _ = &fetch;
    var remainingUnrequested: c_int = 2147483647;
    _ = &remainingUnrequested;
    var remainingBytes: i64 = 0;
    _ = &remainingBytes;
    var want: c_int = 0;
    _ = &want;
    var maybeMore: bool = @as(c_int, 1) != 0;
    _ = &maybeMore;
    nats_lockSubAndDispatcher(sub);
    var isAhead: c_int = fetch.*.requestedMsgs - fetch.*.deliveredMsgs;
    _ = &isAhead;
    var wantAhead: c_int = fetch.*.opts.KeepAhead;
    _ = &wantAhead;
    if (isAhead > wantAhead) {
        maybeMore = @as(c_int, 0) != 0;
    }
    if ((@as(c_int, @intFromBool(maybeMore)) != 0) and (fetch.*.opts.MaxMessages > @as(c_int, 0))) {
        remainingUnrequested = fetch.*.opts.MaxMessages - fetch.*.requestedMsgs;
        if (remainingUnrequested <= @as(c_int, 0)) {
            maybeMore = @as(c_int, 0) != 0;
        }
    }
    if ((@as(c_int, @intFromBool(maybeMore)) != 0) and (fetch.*.opts.MaxBytes > @as(i64, @bitCast(@as(c_long, @as(c_int, 0)))))) {
        remainingBytes = fetch.*.opts.MaxBytes - fetch.*.receivedBytes;
        if (remainingBytes <= @as(i64, @bitCast(@as(c_long, @as(c_int, 0))))) {
            maybeMore = @as(c_int, 0) != 0;
        }
    }
    if (maybeMore) {
        ...
        maybeMore = want > @as(c_int, 0);
    }
    nats_unlockSubAndDispatcher(sub);
    if (!maybeMore) return @as(c_int, 0) != 0;
    maxBytes.* = remainingBytes;
    messages.* = want;
    return @as(c_int, 1) != 0;
}
pub fn _ackMsg(arg_msg: [*c]natsMsg, arg_opts: [*c]jsOptions, arg_o: [*c]_ackOpts, arg_errCode: [*c]jsErrCode) callconv(.c) natsStatus {
    var msg = arg_msg;
    _ = &msg;
    var opts = arg_opts;
    _ = &opts;
    ...
    var s: natsStatus = @as(c_uint, @bitCast(NATS_OK));
    _ = &s;
    var body: [*c]const u8 = o.*.ackType;
    _ = &body;
    var sync_1: bool = o.*.sync;
    _ = &sync_1;
    var wait_2: i64 = 0;
    _ = &wait_2;
    var tmp: [64]u8 = undefined;
    _ = &tmp;
    if (msg == @as([*c]natsMsg, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) return nats_setErrorReal("./src/submodules/nats.c/src/js.c", "_ackMsg", @as(c_int, 3129), @as(c_uint, @bitCast(NATS_INVALID_ARG)), "%s", natsStatus_GetText(@as(c_uint, @bitCast(NATS_INVALID_ARG))));
    if ((msg.*.flags & (@as(c_int, 1) << @intCast(1))) != @as(c_int, 0)) return @as(c_uint, @bitCast(NATS_OK));
    if (msg.*.sub == @as([*c]struct___natsSubscription, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) return nats_setErrorReal("./src/submodules/nats.c/src/js.c", "_ackMsg", @as(c_int, 3135), @as(c_uint, @bitCast(NATS_ILLEGAL_STATE)), "%s", "message not bound to a subscription");
    if ((if ((msg.*.reply == @as([*c]const u8, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) or (@as(c_int, @bitCast(@as(c_uint, msg.*.reply[@as(c_uint, @intCast(@as(c_int, 0)))]))) == @as(c_int, '\x00'))) @as(c_int, 1) else @as(c_int, 0)) != 0) return nats_setErrorReal("./src/submodules/nats.c/src/js.c", "_ackMsg", @as(c_int, 3138), @as(c_uint, @bitCast(NATS_ILLEGAL_STATE)), "%s", "not a JetStream message");
    sub = msg.*.sub;
    jsi = sub.*.jsi;
    js = jsi.*.js;
    nc = sub.*.conn;
    if ((opts != @as([*c]jsOptions, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) and (opts.*.Wait > @as(i64, @bitCast(@as(c_long, @as(c_int, 0)))))) {
        wait_2 = opts.*.Wait;
        sync_1 = @as(c_int, 1) != 0;
    }
    if (o.*.nakDelay > @as(i64, @bitCast(@as(c_long, @as(c_int, 0))))) {
        var v: i64 = o.*.nakDelay * @as(i64, @intFromFloat(1000000.0));
        _ = &v;
        _ = snprintf(@as([*c]u8, @ptrCast(@alignCast(&tmp))), @sizeOf([64]u8), "%s {\"delay\":%ld}", o.*.ackType, v);
        body = @as([*c]const u8, @ptrCast(@alignCast(@as([*c]u8, @ptrCast(@alignCast(&tmp))))));
    }
    if (sync_1) {
        var rply: [*c]natsMsg = null;
        _ = &rply;
        if (wait_2 == @as(i64, @bitCast(@as(c_long, @as(c_int, 0))))) {
            _ = natsMutex_Lock(js.*.mu);
            wait_2 = js.*.opts.Wait;
            _ = natsMutex_Unlock(js.*.mu);
        }
        if (s == @as(c_uint, @bitCast(NATS_OK))) {
            s = natsConnection_RequestString(&rply, nc, msg.*.reply, body, wait_2);
            if ((s == @as(c_uint, @bitCast(NATS_NO_RESPONDERS))) and (errCode != @as([*c]jsErrCode, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0)))))))) {
                errCode.* = @as(c_uint, @bitCast(JSNotEnabledErr));
            }
        }
    ...
    if ((s == @as(c_uint, @bitCast(NATS_OK))) and !o.*.inProgress) {
        _ = blk: {
            const ref = &msg.*.flags;
    ...
    return if (s == @as(c_uint, @bitCast(NATS_OK))) s else nats_updateErrStack(s, "_ackMsg");
}
pub export fn applyNewSID(arg_sub: [*c]natsSubscription) i64 {
    var sub = arg_sub;
    _ = &sub;
    var osid: i64 = 0;
    _ = &osid;
    ...
    osid = sub.*.sid;
    _ = natsHash_Remove(nc.*.subs, osid);
    nc.*.ssid += 1;
    nsid = nc.*.ssid;
    _ = natsHash_Set(nc.*.subs, nsid, @as(?*anyopaque, @ptrCast(sub)), null);
    natsMutex_Unlock(nc.*.subsMu);
    natsSub_Lock(sub);
    sub.*.sid = nsid;
    return osid;
}
pub fn _recreateOrderedCons(arg_closure: ?*anyopaque) callconv(.c) void {
    var closure = arg_closure;
    _ = &closure;
    var oci: [*c]jsOrderedConsInfo = @as([*c]jsOrderedConsInfo, @ptrCast(@alignCast(closure)));
    _ = &oci;
    var nc: [*c]natsConnection = oci.*.nc;
    _ = &nc;
    var sub: [*c]natsSubscription = oci.*.sub;
    _ = &sub;
    var t: [*c]natsThread = null;
    _ = &t;
    var jsi: [*c]jsSub = null;
    _ = &jsi;
    ...
    _ = &s;
    _ = natsMutex_Lock(nc.*.mu);
    if (nc.*.opts.*.writeDeadline > @as(i64, @bitCast(@as(c_long, @as(c_int, 0))))) {
        natsDeadline_Init(&nc.*.sockCtx.writeDeadline, nc.*.opts.*.writeDeadline);
    }
    s = natsConn_sendUnsubProto(nc, oci.*.osid, @as(c_int, 0));
    if (!oci.*.done) {
        if (s == @as(c_uint, @bitCast(NATS_OK))) {
            s = natsConn_sendSubProto(nc, oci.*.ndlv, null, oci.*.nsid);
        }
        if ((s == @as(c_uint, @bitCast(NATS_OK))) and (oci.*.max > @as(c_int, 0))) {
    ...
    _ = natsMutex_Unlock(nc.*.mu);
    if (!oci.*.done and (s == @as(c_uint, @bitCast(NATS_OK)))) {
        natsSub_Lock(sub);
        t = oci.*.thread;
        jsi = sub.*.jsi;
        ...
        if (s == @as(c_uint, @bitCast(NATS_OK))) {
            ...
            cc.*.DeliverPolicy = @as(c_uint, @bitCast(js_DeliverByStartSequence));
            cc.*.OptStartSeq = oci.*.sseq;
            s = js_AddConsumer(&ci, jsi.*.js, jsi.*.stream, cc, null, null);
            if (s == @as(c_uint, @bitCast(NATS_OK))) {
                natsSub_Lock(sub);
                if (strcmp(ci.*.Config.*.DeliverSubject, sub.*.subject) == @as(c_int, 0)) {
                    free(@as(?*anyopaque, @ptrCast(jsi.*.consumer)));
                    jsi.*.consumer = null;
                    {
                        jsi.*.consumer = strdup(ci.*.Name);
                        if (jsi.*.consumer == @as([*c]u8, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) {
                            s = nats_setErrorReal("./src/submodules/nats.c/src/js.c", "_recreateOrderedCons", @as(c_int, 3422), @as(c_uint, @bitCast(NATS_NO_MEMORY)), "%s", natsStatus_GetText(@as(c_uint, @bitCast(NATS_NO_MEMORY))));
                        }
                    }
                }
                natsSub_Unlock(sub);
    ...
    if (s != @as(c_uint, @bitCast(NATS_OK))) {
        var tmp: [256]u8 = undefined;
        _ = &tmp;
        var lastErr: [*c]const u8 = nats_GetLastError(null);
        _ = &lastErr;
        _ = natsMutex_Lock(nc.*.mu);
        _ = snprintf(@as([*c]u8, @ptrCast(@alignCast(&tmp))), @sizeOf([256]u8), "error recreating ordered consumer, will try again: status=%u error=%s", s, if ((if ((lastErr == @as([*c]const u8, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) or (@as(c_int, @bitCast(@as(c_uint, lastErr[@as(c_uint, @intCast(@as(c_int, 0)))]))) == @as(c_int, '\x00'))) @as(c_int, 1) else @as(c_int, 0)) != 0) natsStatus_GetText(s) else lastErr);
        natsAsyncCb_PostErrHandler(nc, sub, s, strdup(@as([*c]u8, @ptrCast(@alignCast(&tmp)))));
        _ = natsMutex_Unlock(nc.*.mu);
    }
    free(@as(?*anyopaque, @ptrCast(oci.*.ndlv)));
...
pub const OPTS_H_ = "";
pub const LOCK_AND_CHECK_OPTIONS = @compileError("unable to translate C expr: unexpected token 'if'");
// ./src/submodules/nats.c/src/opts.h:29:9
pub inline fn UNLOCK_OPTS(o: anytype) @TypeOf(natsMutex_Unlock(o.*.mu)) {
    _ = &o;
    return natsMutex_Unlock(o.*.mu);
}
pub const NATS_OPTS_DEFAULT_MAX_RECONNECT = @as(c_int, 60);
pub const NATS_OPTS_DEFAULT_TIMEOUT = @as(c_int, 2) * @as(c_int, 1000);
pub const NATS_OPTS_DEFAULT_RECONNECT_WAIT = @as(c_int, 2) * @as(c_int, 1000);
pub const NATS_OPTS_DEFAULT_PING_INTERVAL = (@as(c_int, 2) * @as(c_int, 60)) * @as(c_int, 1000);
pub const NATS_OPTS_DEFAULT_MAX_PING_OUT = @as(c_int, 2);
pub const NATS_OPTS_DEFAULT_IO_BUF_SIZE = @as(c_int, 32) * @as(c_int, 1024);
pub const NATS_OPTS_DEFAULT_MAX_PENDING_MSGS = @import("std").zig.c_translation.promoteIntLiteral(c_int, 65536, .decimal);
pub const NATS_OPTS_DEFAULT_MAX_PENDING_BYTES = (@as(c_int, 64) * @as(c_int, 1024)) * @as(c_int, 1024);
pub const NATS_OPTS_DEFAULT_RECONNECT_BUF_SIZE = (@as(c_int, 8) * @as(c_int, 1024)) * @as(c_int, 1024);
pub const NATS_OPTS_DEFAULT_RECONNECT_JITTER = @as(c_int, 100);
pub const NATS_OPTS_DEFAULT_RECONNECT_JITTER_TLS = @as(c_int, 1000);
pub const SUB_H_ = "";
...
pub const GLIB_H_ = "";
pub const _retain = @compileError("TODO postfix inc/dec expr");
// ./src/submodules/nats.c/src/js.c:37:9
pub const _release = @compileError("TODO postfix inc/dec expr");
// ./src/submodules/nats.c/src/js.c:38:9
pub const jsReplyTokenSize = @as(c_int, 8);
pub const jsDefaultMaxMsgs = @as(c_int, 512) * @as(c_int, 1024);
pub const jsLastConsumerSeqHdr = "Nats-Last-Consumer";
pub const CFG_CHECK_ERR_START = "configuration requests %s to be ";
pub const CFG_CHECK_ERR_END = ", but consumer's value is ";
...
pub const __ackOpts = struct___ackOpts;
...
pub const __jsOrderedConsInfo = struct___jsOrderedConsInfo;
