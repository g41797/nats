...
pub export fn natsMsgList_Destroy(arg_list: [*c]natsMsgList) void {
    var list = arg_list;
    _ = &list;
    var i: c_int = undefined;
    _ = &i;
    if ((list == @as([*c]natsMsgList, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) or (list.*.Msgs == @as([*c][*c]natsMsg, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0)))))))) return;
    {
        i = 0;
        while (i < list.*.Count) : (i += 1) {
            natsMsg_Destroy((blk: {
                const tmp = i;
                if (tmp >= 0) break :blk list.*.Msgs + @as(usize, @intCast(tmp)) else break :blk list.*.Msgs - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
            }).*);
        }
    }
    free(@as(?*anyopaque, @ptrCast(list.*.Msgs)));
    list.*.Msgs = null;
    list.*.Count = 0;
}
pub export fn natsMsg_Create(arg_newMsg: [*c][*c]natsMsg, arg_subj: [*c]const u8, arg_reply: [*c]const u8, arg_data: [*c]const u8, arg_dataLen: c_int) natsStatus {
    ...
    _ = &s;
    if (((subj == @as([*c]const u8, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) or (@as(c_int, @bitCast(@as(c_uint, subj[@as(c_uint, @intCast(@as(c_int, 0)))]))) == @as(c_int, '\x00'))) or ((reply != @as([*c]const u8, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) and (@as(c_int, @bitCast(@as(c_uint, reply[@as(c_uint, @intCast(@as(c_int, 0)))]))) == @as(c_int, '\x00')))) {
        return nats_setErrorReal("./src/submodules/nats.c/src/msg.c", "natsMsg_Create", @as(c_int, 879), @as(c_uint, @bitCast(NATS_INVALID_ARG)), "%s", natsStatus_GetText(@as(c_uint, @bitCast(NATS_INVALID_ARG))));
    }
    s = natsMsg_create(newMsg, subj, @as(c_int, @bitCast(@as(c_uint, @truncate(strlen(subj))))), reply, if (reply == @as([*c]const u8, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) @as(c_int, 0) else @as(c_int, @bitCast(@as(c_uint, @truncate(strlen(reply))))), data, dataLen, -@as(c_int, 1));
    return if (s == @as(c_uint, @bitCast(NATS_OK))) s else nats_updateErrStack(s, "natsMsg_Create");
}
pub export fn natsMsg_GetSubject(arg_msg: [*c]const natsMsg) [*c]const u8 {
    var msg = arg_msg;
    _ = &msg;
    if (msg == @as([*c]const natsMsg, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) return null;
    return msg.*.subject;
}
pub export fn natsMsg_GetReply(arg_msg: [*c]const natsMsg) [*c]const u8 {
    var msg = arg_msg;
    _ = &msg;
    if (msg == @as([*c]const natsMsg, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) return null;
    return msg.*.reply;
}
pub export fn natsMsg_GetData(arg_msg: [*c]const natsMsg) [*c]const u8 {
    var msg = arg_msg;
    _ = &msg;
    if (msg == @as([*c]const natsMsg, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) return null;
    return msg.*.data;
}
pub export fn natsMsg_GetDataLength(arg_msg: [*c]const natsMsg) c_int {
    var msg = arg_msg;
    _ = &msg;
    if (msg == @as([*c]const natsMsg, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) return 0;
    return msg.*.dataLen;
}
...
pub export fn natsMsgHeader_Set(arg_msg: [*c]natsMsg, arg_key: [*c]const u8, arg_value: [*c]const u8) natsStatus {
    var msg = arg_msg;
    _ = &msg;
    var key = arg_key;
    _ = &key;
    ...
    _ = &s;
    if ((blk: {
        const tmp = _checkMsgAndKey(msg, key);
        s = tmp;
        break :blk tmp;
    }) != @as(c_uint, @bitCast(NATS_OK))) return if (s == @as(c_uint, @bitCast(NATS_OK))) s else nats_updateErrStack(s, "natsMsgHeader_Set");
    if ((blk: {
        const tmp = _liftHeaders(msg, @as(c_int, 1) != 0);
        s = tmp;
        break :blk tmp;
    }) != @as(c_uint, @bitCast(NATS_OK))) return if (s == @as(c_uint, @bitCast(NATS_OK))) s else nats_updateErrStack(s, "natsMsgHeader_Set");
    if (s == @as(c_uint, @bitCast(NATS_OK))) {
        var v: [*c]natsHeaderValue = null;
        _ = &v;
        s = natsHeaderValue_create(&v, value, @as(c_int, 1) != 0);
        if (s == @as(c_uint, @bitCast(NATS_OK))) {
            var p: ?*anyopaque = @as(?*anyopaque, @ptrFromInt(@as(c_int, 0)));
            _ = &p;
            s = natsStrHash_SetEx(msg.*.headers, @as([*c]u8, @ptrCast(@volatileCast(@constCast(key)))), @as(c_int, 1) != 0, (if (@as(c_int, 1) != 0) @as(c_int, 1) else @as(c_int, 0)) != 0, @as(?*anyopaque, @ptrCast(v)), &p);
            if (s != @as(c_uint, @bitCast(NATS_OK))) {
                natsHeaderValue_free(v, @as(c_int, 0) != 0);
            } else if (p != @as(?*anyopaque, @ptrFromInt(@as(c_int, 0)))) {
                var old: [*c]natsHeaderValue = @as([*c]natsHeaderValue, @ptrCast(@alignCast(p)));
                _ = &old;
                natsHeaderValue_free(old, @as(c_int, 1) != 0);
            }
        }
    }
    return if (s == @as(c_uint, @bitCast(NATS_OK))) s else nats_updateErrStack(s, "natsMsgHeader_Set");
}
pub export fn natsMsgHeader_Add(arg_msg: [*c]natsMsg, arg_key: [*c]const u8, arg_value: [*c]const u8) natsStatus {
    var msg = arg_msg;
    _ = &msg;
    var key = arg_key;
    _ = &key;
    ...
    if ((blk: {
        ...
        s = tmp;
        break :blk tmp;
    }) != @as(c_uint, @bitCast(NATS_OK))) return if (s == @as(c_uint, @bitCast(NATS_OK))) s else nats_updateErrStack(s, "natsMsgHeader_Add");
    if ((blk: {
        const tmp = _liftHeaders(msg, @as(c_int, 1) != 0);
        s = tmp;
        break :blk tmp;
    ...
    if (s == @as(c_uint, @bitCast(NATS_OK))) {
        ...
        s = natsHeaderValue_create(&v, value, @as(c_int, 1) != 0);
        if (s == @as(c_uint, @bitCast(NATS_OK))) {
            var cur: [*c]natsHeaderValue = @as([*c]natsHeaderValue, @ptrCast(@alignCast(natsStrHash_GetEx(msg.*.headers, @as([*c]u8, @ptrCast(@volatileCast(@constCast(key)))), @as(c_int, @bitCast(@as(c_uint, @truncate(strlen(@as([*c]u8, @ptrCast(@volatileCast(@constCast(key)))))))))))));
            _ = &cur;
            if (cur != @as([*c]natsHeaderValue, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) {
                while (cur.*.next != @as([*c]struct___natsHeaderValue, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) {
                    cur = cur.*.next;
                }
                cur.*.next = v;
            } else {
                s = natsStrHash_SetEx(msg.*.headers, @as([*c]u8, @ptrCast(@volatileCast(@constCast(key)))), @as(c_int, 1) != 0, (if (@as(c_int, 1) != 0) @as(c_int, 1) else @as(c_int, 0)) != 0, @as(?*anyopaque, @ptrCast(v)), null);
            }
        }
    }
    return if (s == @as(c_uint, @bitCast(NATS_OK))) s else nats_updateErrStack(s, "natsMsgHeader_Add");
}
pub export fn natsMsgHeader_Get(arg_msg: [*c]natsMsg, arg_key: [*c]const u8, arg_value: [*c][*c]const u8) natsStatus {
    var msg = arg_msg;
    _ = &msg;
    var key = arg_key;
    _ = &key;
    ...
    if ((blk: {
        ...
        s = tmp;
        break :blk tmp;
    }) != @as(c_uint, @bitCast(NATS_OK))) return if (s == @as(c_uint, @bitCast(NATS_OK))) s else nats_updateErrStack(s, "natsMsgHeader_Get");
    if (value == @as([*c][*c]const u8, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) return nats_setErrorReal("./src/submodules/nats.c/src/msg.c", "natsMsgHeader_Get", @as(c_int, 510), @as(c_uint, @bitCast(NATS_INVALID_ARG)), "%s", "value cannot be NULL");
    value.* = null;
    if ((blk: {
        const tmp = _liftHeaders(msg, @as(c_int, 0) != 0);
        s = tmp;
        break :blk tmp;
    }) != @as(c_uint, @bitCast(NATS_OK))) return if (s == @as(c_uint, @bitCast(NATS_OK))) s else nats_updateErrStack(s, "natsMsgHeader_Get");
    if ((msg.*.headers == @as([*c]natsStrHash, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) or (msg.*.headers.*.used == @as(c_int, 0))) return @as(c_uint, @bitCast(NATS_NOT_FOUND));
    v = @as([*c]natsHeaderValue, @ptrCast(@alignCast(natsStrHash_GetEx(msg.*.headers, @as([*c]u8, @ptrCast(@volatileCast(@constCast(key)))), @as(c_int, @bitCast(@as(c_uint, @truncate(strlen(@as([*c]u8, @ptrCast(@volatileCast(@constCast(key)))))))))))));
    if (v == @as([*c]natsHeaderValue, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) return @as(c_uint, @bitCast(NATS_NOT_FOUND));
    value.* = @as([*c]const u8, @ptrCast(@alignCast(v.*.value)));
    return if (s == @as(c_uint, @bitCast(NATS_OK))) s else nats_updateErrStack(s, "natsMsgHeader_Get");
}
pub export fn natsMsgHeader_Values(arg_msg: [*c]natsMsg, arg_key: [*c]const u8, arg_values: [*c][*c][*c]const u8, arg_count: [*c]c_int) natsStatus {
    var msg = arg_msg;
    _ = &msg;
    var key = arg_key;
    _ = &key;
    ...
    var c: c_int = 0;
    _ = &c;
    var cur: [*c]natsHeaderValue = null;
    _ = &cur;
    var strs: [*c][*c]const u8 = null;
    _ = &strs;
    var v: [*c]natsHeaderValue = null;
    _ = &v;
    if ((blk: {
        ...
        s = tmp;
        break :blk tmp;
    }) != @as(c_uint, @bitCast(NATS_OK))) return if (s == @as(c_uint, @bitCast(NATS_OK))) s else nats_updateErrStack(s, "natsMsgHeader_Values");
    if ((values == @as([*c][*c][*c]const u8, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) or (count == @as([*c]c_int, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0)))))))) return nats_setErrorReal("./src/submodules/nats.c/src/msg.c", "natsMsgHeader_Values", @as(c_int, 542), @as(c_uint, @bitCast(NATS_INVALID_ARG)), "%s", "value or count cannot be NULL");
    values.* = null;
    count.* = 0;
    if ((blk: {
        const tmp = _liftHeaders(msg, @as(c_int, 0) != 0);
    ...
    {
        cur = v;
        while (cur != @as([*c]natsHeaderValue, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) : (cur = cur.*.next) {
            c += 1;
        }
    }
    strs = @as([*c][*c]const u8, @ptrCast(@alignCast(calloc(@as(c_ulong, @bitCast(@as(c_long, c))), @sizeOf([*c]u8)))));
    if (strs == @as([*c][*c]const u8, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) {
        s = nats_setErrorReal("./src/submodules/nats.c/src/msg.c", "natsMsgHeader_Values", @as(c_int, 562), @as(c_uint, @bitCast(NATS_NO_MEMORY)), "%s", natsStatus_GetText(@as(c_uint, @bitCast(NATS_NO_MEMORY))));
    } else {
        var i: c_int = 0;
        _ = &i;
        {
            ...
            while (cur != @as([*c]natsHeaderValue, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) : (cur = cur.*.next) {
                (blk: {
                    ...
                    if (tmp >= 0) break :blk strs + @as(usize, @intCast(tmp)) else break :blk strs - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
                }).* = @as([*c]const u8, @ptrCast(@alignCast(cur.*.value)));
            }
        }
        values.* = strs;
        count.* = c;
    }
    return if (s == @as(c_uint, @bitCast(NATS_OK))) s else nats_updateErrStack(s, "natsMsgHeader_Values");
}
...
pub export fn natsMsgHeader_Keys(arg_msg: [*c]natsMsg, arg_keys: [*c][*c][*c]const u8, arg_count: [*c]c_int) natsStatus {
    var msg = arg_msg;
    _ = &msg;
    var keys = arg_keys;
    _ = &keys;
    ...
    var c: c_int = 0;
    _ = &c;
    if (msg == @as([*c]natsMsg, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) return nats_setErrorReal("./src/submodules/nats.c/src/msg.c", "natsMsgHeader_Keys", @as(c_int, 585), @as(c_uint, @bitCast(NATS_INVALID_ARG)), "%s", "message cannot be NULL");
    if ((keys == @as([*c][*c][*c]const u8, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) or (count == @as([*c]c_int, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0)))))))) return nats_setErrorReal("./src/submodules/nats.c/src/msg.c", "natsMsgHeader_Keys", @as(c_int, 588), @as(c_uint, @bitCast(NATS_INVALID_ARG)), "%s", "keys or count cannot be NULL");
    keys.* = null;
    count.* = 0;
    if ((blk: {
        const tmp = _liftHeaders(msg, @as(c_int, 0) != 0);
        s = tmp;
        break :blk tmp;
    }) != @as(c_uint, @bitCast(NATS_OK))) return if (s == @as(c_uint, @bitCast(NATS_OK))) s else nats_updateErrStack(s, "natsMsgHeader_Keys");
    if ((msg.*.headers == @as([*c]natsStrHash, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) or ((blk: {
        const tmp = msg.*.headers.*.used;
        c = tmp;
        break :blk tmp;
    }) == @as(c_int, 0))) return @as(c_uint, @bitCast(NATS_NOT_FOUND));
    strs = @as([*c][*c]const u8, @ptrCast(@alignCast(calloc(@as(c_ulong, @bitCast(@as(c_long, c))), @sizeOf([*c]u8)))));
    if (strs == @as([*c][*c]const u8, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) {
        s = nats_setErrorReal("./src/submodules/nats.c/src/msg.c", "natsMsgHeader_Keys", @as(c_int, 601), @as(c_uint, @bitCast(NATS_NO_MEMORY)), "%s", natsStatus_GetText(@as(c_uint, @bitCast(NATS_NO_MEMORY))));
    } else {
        ...
        {
            i = 0;
            while (natsStrHashIter_Next(&iter, &hk, null)) : (i += 1) {
                (blk: {
                    const tmp = i;
                    if (tmp >= 0) break :blk strs + @as(usize, @intCast(tmp)) else break :blk strs - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
                }).* = @as([*c]const u8, @ptrCast(@alignCast(hk)));
            }
        }
    ...
    return if (s == @as(c_uint, @bitCast(NATS_OK))) s else nats_updateErrStack(s, "natsMsgHeader_Keys");
}
pub export fn natsMsgHeader_Delete(arg_msg: [*c]natsMsg, arg_key: [*c]const u8) natsStatus {
    var msg = arg_msg;
    _ = &msg;
    var key = arg_key;
    _ = &key;
    ...
    if ((blk: {
        ...
        s = tmp;
        break :blk tmp;
    }) != @as(c_uint, @bitCast(NATS_OK))) return if (s == @as(c_uint, @bitCast(NATS_OK))) s else nats_updateErrStack(s, "natsMsgHeader_Delete");
    if ((blk: {
        const tmp = _liftHeaders(msg, @as(c_int, 0) != 0);
        s = tmp;
        break :blk tmp;
    ...
    if ((msg.*.headers == @as([*c]natsStrHash, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) or (msg.*.headers.*.used == @as(c_int, 0))) return @as(c_uint, @bitCast(NATS_NOT_FOUND));
    v = @as([*c]natsHeaderValue, @ptrCast(@alignCast(natsStrHash_Remove(msg.*.headers, @as([*c]u8, @ptrCast(@volatileCast(@constCast(key))))))));
    if (v == @as([*c]natsHeaderValue, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) return @as(c_uint, @bitCast(NATS_NOT_FOUND));
    natsHeaderValue_free(v, @as(c_int, 1) != 0);
    return s;
}
pub export fn natsMsg_IsNoResponders(arg_m: [*c]natsMsg) bool {
    var m = arg_m;
    _ = &m;
    var val: [*c]const u8 = null;
    _ = &val;
    return ((((m != @as([*c]natsMsg, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) and (natsMsg_GetDataLength(m) == @as(c_int, 0))) and (natsMsgHeader_Get(m, "Status", &val) == @as(c_uint, @bitCast(NATS_OK)))) and (val != @as([*c]const u8, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0)))))))) and (strncmp(val, "503", @as(c_ulong, @bitCast(@as(c_long, @as(c_int, 3))))) == @as(c_int, 0));
}
pub export fn natsMsg_Destroy(arg_msg: [*c]natsMsg) void {
    var msg = arg_msg;
    _ = &msg;
    if (msg == @as([*c]natsMsg, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) return;
    if ((msg.*.flags & (@as(c_int, 1) << @intCast(2))) != @as(c_int, 0)) return;
    if (natsGC_collect(@as([*c]natsGCItem, @ptrCast(@alignCast(msg))))) return;
    natsMsg_free(@as(?*anyopaque, @ptrCast(msg)));
}
...
pub export fn natsMsg_GetSequence(arg_msg: [*c]natsMsg) u64 {
    var msg = arg_msg;
    _ = &msg;
    if (msg == @as([*c]natsMsg, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) return 0;
    return msg.*.seq;
}
pub export fn natsMsg_GetTime(arg_msg: [*c]natsMsg) i64 {
    var msg = arg_msg;
    _ = &msg;
    if (msg == @as([*c]natsMsg, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) return 0;
    return msg.*.time;
...
pub export fn natsMsgHeader_encodedLen(arg_msg: [*c]natsMsg) c_int {
    var msg = arg_msg;
    _ = &msg;
    var iter: natsStrHashIter = undefined;
    _ = &iter;
    ...
    var hl: c_int = 0;
    _ = &hl;
    if ((msg.*.flags & (@as(c_int, 1) << @intCast(0))) != @as(c_int, 0)) return msg.*.hdrLen;
    if (msg.*.headers == @as([*c]natsStrHash, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) return 0;
    hl = @as(c_int, 10);
    natsStrHashIter_Init(&iter, msg.*.headers);
    while (natsStrHashIter_Next(&iter, &key, &p)) {
        var v: [*c]natsHeaderValue = @as([*c]natsHeaderValue, @ptrCast(@alignCast(p)));
        _ = &v;
        var c: [*c]natsHeaderValue = undefined;
        _ = &c;
        {
            c = v;
            while (c != @as([*c]natsHeaderValue, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) : (c = c.*.next) {
                hl += @as(c_int, @bitCast(@as(c_uint, @truncate(strlen(key))))) + @as(c_int, 2);
                hl += @as(c_int, @bitCast(@as(c_uint, @truncate(strlen(c.*.value))))) + @as(c_int, 2);
            }
        }
    }
    natsStrHashIter_Done(&iter);
...
pub export fn natsMsgHeader_encode(arg_buf: [*c]natsBuffer, arg_msg: [*c]natsMsg) natsStatus {
    var buf = arg_buf;
    _ = &buf;
    var msg = arg_msg;
    _ = &msg;
    ...
    var p: ?*anyopaque = @as(?*anyopaque, @ptrFromInt(@as(c_int, 0)));
    _ = &p;
    if ((msg.*.flags & (@as(c_int, 1) << @intCast(0))) != @as(c_int, 0)) {
        s = natsBuf_Append(buf, @as([*c]const u8, @ptrCast(@alignCast(msg.*.hdr))), msg.*.hdrLen);
        return if (s == @as(c_uint, @bitCast(NATS_OK))) s else nats_updateErrStack(s, "natsMsgHeader_encode");
    }
    if (msg.*.headers == @as([*c]natsStrHash, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) return nats_setErrorReal("./src/submodules/nats.c/src/msg.c", "natsMsgHeader_encode", @as(c_int, 83), @as(c_uint, @bitCast(NATS_ERR)), "%s", "trying to encode headers while there is none");
    s = natsBuf_Append(buf, "NATS/1.0\r\n", @as(c_int, 10));
    if (s == @as(c_uint, @bitCast(NATS_OK))) {
        natsStrHashIter_Init(&iter, msg.*.headers);
        while ((s == @as(c_uint, @bitCast(NATS_OK))) and (@as(c_int, @intFromBool(natsStrHashIter_Next(&iter, &key, &p))) != 0)) {
            var v: [*c]natsHeaderValue = @as([*c]natsHeaderValue, @ptrCast(@alignCast(p)));
            _ = &v;
            var c: [*c]natsHeaderValue = undefined;
            _ = &c;
            {
                c = v;
                while ((s == @as(c_uint, @bitCast(NATS_OK))) and (c != @as([*c]natsHeaderValue, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0)))))))) : (c = c.*.next) {
                    s = natsBuf_Append(buf, @as([*c]const u8, @ptrCast(@alignCast(key))), @as(c_int, @bitCast(@as(c_uint, @truncate(strlen(key))))));
                    if (s == @as(c_uint, @bitCast(NATS_OK))) {
                        s = natsBuf_Append(buf, ": ", @as(c_int, 2));
                    }
                    if (s == @as(c_uint, @bitCast(NATS_OK))) {
                        var vl: c_int = @as(c_int, @bitCast(@as(c_uint, @truncate(strlen(c.*.value)))));
                        _ = &vl;
                        var pos: c_int = buf.*.len;
                        _ = &pos;
                        s = natsBuf_Append(buf, @as([*c]const u8, @ptrCast(@alignCast(c.*.value))), vl);
                        if (s == @as(c_uint, @bitCast(NATS_OK))) {
                            var ch: [*c]u8 = buf.*.data + @as(usize, @bitCast(@as(isize, @intCast(pos))));
                            _ = &ch;
                            var i: c_int = undefined;
                            _ = &i;
                            {
                                i = 0;
                                while (i < vl) : (i += 1) {
                                    if ((@as(c_int, @bitCast(@as(c_uint, ch.*))) == @as(c_int, '\r')) or (@as(c_int, @bitCast(@as(c_uint, ch.*))) == @as(c_int, '\n'))) {
                                        ch.* = ' ';
                                    }
                                    ch += 1;
                                }
...
pub export fn natsMsg_init(arg_msg: [*c]natsMsg, arg_subj: [*c]const u8, arg_data: [*c]const u8, arg_dataLen: c_int) void {
    var msg = arg_msg;
    _ = &msg;
    var subj = arg_subj;
    _ = &subj;
    ...
    var dataLen = arg_dataLen;
    _ = &dataLen;
    _ = memset(@as(?*anyopaque, @ptrCast(msg)), @as(c_int, 0), @sizeOf(natsMsg));
    msg.*.subject = subj;
    msg.*.data = data;
    msg.*.dataLen = dataLen;
}
pub export fn natsMsg_create(arg_newMsg: [*c][*c]natsMsg, arg_subject: [*c]const u8, arg_subjLen: c_int, arg_reply: [*c]const u8, arg_replyLen: c_int, arg_buf: [*c]const u8, arg_bufLen: c_int, arg_hdrLen: c_int) natsStatus {
    var newMsg = arg_newMsg;
    _ = &newMsg;
    var subject = arg_subject;
    _ = &subject;
    var subjLen = arg_subjLen;
    _ = &subjLen;
    var reply = arg_reply;
    _ = &reply;
    var replyLen = arg_replyLen;
    _ = &replyLen;
    var buf = arg_buf;
    _ = &buf;
    ...
    _ = &hdrLen;
    return natsMsg_createWithPadding(newMsg, subject, subjLen, reply, replyLen, buf, bufLen, @as(c_int, 0), hdrLen);
}
pub export fn natsMsg_createWithPadding(arg_newMsg: [*c][*c]natsMsg, arg_subject: [*c]const u8, arg_subjLen: c_int, arg_reply: [*c]const u8, arg_replyLen: c_int, arg_buf: [*c]const u8, arg_bufLen: c_int, arg_bufPaddingSize: c_int, arg_hdrLen: c_int) natsStatus {
    var newMsg = arg_newMsg;
    _ = &newMsg;
    var subject = arg_subject;
    _ = &subject;
    ...
    var bufLen = arg_bufLen;
    _ = &bufLen;
    var bufPaddingSize = arg_bufPaddingSize;
    _ = &bufPaddingSize;
    var hdrLen = arg_hdrLen;
    _ = &hdrLen;
    ...
    var bufSize: c_int = 0;
    _ = &bufSize;
    var dataLen: c_int = bufLen;
    _ = &dataLen;
    var hasHdrs: bool = (if (hdrLen > @as(c_int, 0)) @as(c_int, 1) else @as(c_int, 0)) != 0;
    _ = &hasHdrs;
    var padLen: c_int = if (bufPaddingSize > @as(c_int, 0)) bufPaddingSize else @as(c_int, 1);
    _ = &padLen;
    bufSize = subjLen;
    bufSize += @as(c_int, 1);
    if (replyLen > @as(c_int, 0)) {
        bufSize += replyLen;
        bufSize += @as(c_int, 1);
    }
    bufSize += bufLen;
    ...
    msg = @as([*c]natsMsg, @ptrCast(@alignCast(malloc(@sizeOf(natsMsg) +% @as(c_ulong, @bitCast(@as(c_long, bufSize)))))));
    if (msg == @as([*c]natsMsg, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) return nats_setErrorReal("./src/submodules/nats.c/src/msg.c", "natsMsg_createWithPadding", @as(c_int, 774), @as(c_uint, @bitCast(NATS_NO_MEMORY)), "%s", natsStatus_GetText(@as(c_uint, @bitCast(NATS_NO_MEMORY))));
    _ = memset(@as(?*anyopaque, @ptrCast(&msg.*.gc)), @as(c_int, 0), @sizeOf(natsGCItem));
    msg.*.hdr = null;
    msg.*.hdrLen = 0;
    msg.*.flags = 0;
    msg.*.headers = null;
    ...
    msg.*.seq = 0;
    msg.*.time = 0;
    ptr = @as([*c]u8, @ptrCast(@alignCast(&msg.*.next))) + @sizeOf([*c]struct___natsMsg);
    msg.*.subject = @as([*c]const u8, @ptrCast(@alignCast(ptr)));
    _ = memcpy(@as(?*anyopaque, @ptrCast(ptr)), @as(?*const anyopaque, @ptrCast(subject)), @as(c_ulong, @bitCast(@as(c_long, subjLen))));
    ptr += @as(usize, @bitCast(@as(isize, @intCast(subjLen))));
    (blk: {
        const ref = &ptr;
        const tmp = ref.*;
        ref.* += 1;
    ...
    if (replyLen > @as(c_int, 0)) {
        msg.*.reply = @as([*c]const u8, @ptrCast(@alignCast(ptr)));
        _ = memcpy(@as(?*anyopaque, @ptrCast(ptr)), @as(?*const anyopaque, @ptrCast(reply)), @as(c_ulong, @bitCast(@as(c_long, replyLen))));
        ptr += @as(usize, @bitCast(@as(isize, @intCast(replyLen))));
        (blk: {
            const ref = &ptr;
            const tmp = ref.*;
            ref.* += 1;
    ...
    if (hasHdrs) {
        msg.*.hdr = ptr;
        if (buf != @as([*c]const u8, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) {
            _ = memcpy(@as(?*anyopaque, @ptrCast(ptr)), @as(?*const anyopaque, @ptrCast(buf)), @as(c_ulong, @bitCast(@as(c_long, hdrLen))));
            buf += @as(usize, @bitCast(@as(isize, @intCast(hdrLen))));
        }
        ptr += @as(usize, @bitCast(@as(isize, @intCast(hdrLen))));
        (blk: {
            const ref = &ptr;
            const tmp = ref.*;
            ref.* += 1;
        ...
        _ = blk: {
            const ref = &msg.*.flags;
            ref.* |= @as(c_int, 1) << @intCast(0);
            break :blk ref.*;
        };
        dataLen -= hdrLen;
    }
    msg.*.data = @as([*c]const u8, @ptrCast(@alignCast(ptr)));
    msg.*.dataLen = dataLen;
    if (buf != @as([*c]const u8, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) {
        _ = memcpy(@as(?*anyopaque, @ptrCast(ptr)), @as(?*const anyopaque, @ptrCast(buf)), @as(c_ulong, @bitCast(@as(c_long, dataLen))));
    }
    ptr += @as(usize, @bitCast(@as(isize, @intCast(dataLen))));
    _ = memset(@as(?*anyopaque, @ptrCast(ptr)), @as(c_int, 0), @as(c_ulong, @bitCast(@as(c_long, padLen))));
    msg.*.wsz = (subjLen + replyLen) + bufLen;
    msg.*.gc.freeCb = &natsMsg_free;
    newMsg.* = msg;
    return @as(c_uint, @bitCast(NATS_OK));
}
pub export fn natsMsg_freeHeaders(arg_msg: [*c]natsMsg) void {
    var msg = arg_msg;
    _ = &msg;
    var iter: natsStrHashIter = undefined;
    _ = &iter;
    var p: ?*anyopaque = @as(?*anyopaque, @ptrFromInt(@as(c_int, 0)));
    _ = &p;
    if (msg.*.headers == @as([*c]natsStrHash, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) return;
    natsStrHashIter_Init(&iter, msg.*.headers);
...
pub export fn natsMsg_free(arg_object: ?*anyopaque) void {
    var object = arg_object;
    _ = &object;
    var msg: [*c]natsMsg = undefined;
    _ = &msg;
    if (object == @as(?*anyopaque, @ptrFromInt(@as(c_int, 0)))) return;
    msg = @as([*c]natsMsg, @ptrCast(@alignCast(object)));
...
pub export fn natsHeaderValue_free(arg_v: [*c]natsHeaderValue, arg_all: bool) void {
    var v = arg_v;
    _ = &v;
    var all = arg_all;
    _ = &all;
    if (v == @as([*c]natsHeaderValue, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) return;
    if ((@as(c_int, @intFromBool(v.*.needFree)) != 0) and (v.*.value != @as([*c]u8, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0)))))))) {
        free(@as(?*anyopaque, @ptrCast(v.*.value)));
    }
    if ((@as(c_int, @intFromBool(all)) != 0) and (v.*.next != @as([*c]struct___natsHeaderValue, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0)))))))) {
        natsHeaderValue_free(v.*.next, all);
    }
    free(@as(?*anyopaque, @ptrCast(v)));
}
pub export fn natsHeaderValue_create(arg_retV: [*c][*c]natsHeaderValue, arg_value: [*c]const u8, arg_makeCopy: bool) natsStatus {
    var retV = arg_retV;
    _ = &retV;
    var value = arg_value;
    _ = &value;
    var makeCopy = arg_makeCopy;
    _ = &makeCopy;
    var s: natsStatus = @as(c_uint, @bitCast(NATS_OK));
    _ = &s;
    var cv: [*c]u8 = @as([*c]u8, @ptrCast(@volatileCast(@constCast(value))));
    _ = &cv;
    var v: [*c]natsHeaderValue = null;
    _ = &v;
    retV.* = null;
    v = @as([*c]natsHeaderValue, @ptrCast(@alignCast(malloc(@sizeOf(natsHeaderValue)))));
    if (v == @as([*c]natsHeaderValue, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) return nats_setErrorReal("./src/submodules/nats.c/src/msg.c", "natsHeaderValue_create", @as(c_int, 156), @as(c_uint, @bitCast(NATS_NO_MEMORY)), "%s", natsStatus_GetText(@as(c_uint, @bitCast(NATS_NO_MEMORY))));
    if ((@as(c_int, @intFromBool(makeCopy)) != 0) and (value != @as([*c]const u8, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0)))))))) {
        {
            cv = strdup(value);
            if (cv == @as([*c]u8, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) {
                s = nats_setErrorReal("./src/submodules/nats.c/src/msg.c", "natsHeaderValue_create", @as(c_int, 160), @as(c_uint, @bitCast(NATS_NO_MEMORY)), "%s", natsStatus_GetText(@as(c_uint, @bitCast(NATS_NO_MEMORY))));
            }
        }
        if (s != @as(c_uint, @bitCast(NATS_OK))) {
            free(@as(?*anyopaque, @ptrCast(v)));
            return if (s == @as(c_uint, @bitCast(NATS_OK))) s else nats_updateErrStack(s, "natsHeaderValue_create");
        }
    }
    v.*.value = cv;
    v.*.needFree = makeCopy;
...
pub fn _checkMsgAndKey(arg_msg: [*c]natsMsg, arg_key: [*c]const u8) callconv(.c) natsStatus {
    var msg = arg_msg;
    _ = &msg;
    var key = arg_key;
    _ = &key;
    if (msg == @as([*c]natsMsg, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) return nats_setErrorReal("./src/submodules/nats.c/src/msg.c", "_checkMsgAndKey", @as(c_int, 179), @as(c_uint, @bitCast(NATS_INVALID_ARG)), "%s", "message cannot be NULL");
    if ((key == @as([*c]const u8, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) or (@as(c_int, @bitCast(@as(c_uint, key[@as(c_uint, @intCast(@as(c_int, 0)))]))) == @as(c_int, '\x00'))) return nats_setErrorReal("./src/submodules/nats.c/src/msg.c", "_checkMsgAndKey", @as(c_int, 182), @as(c_uint, @bitCast(NATS_INVALID_ARG)), "%s", "key cannot be NULL nor empty");
    return @as(c_uint, @bitCast(NATS_OK));
}
pub fn _moveToLF(arg_end: [*c]u8, arg_ptr: [*c]u8) callconv(.c) [*c]u8 {
    var end = arg_end;
    _ = &end;
    var ptr = arg_ptr;
    _ = &ptr;
    while (ptr != end) {
        if ((@as(c_int, @bitCast(@as(c_uint, ptr.*))) == @as(c_int, '\r')) and (@as(c_int, @bitCast(@as(c_uint, (ptr + @as(usize, @bitCast(@as(isize, @intCast(@as(c_int, 1)))))).*))) == @as(c_int, '\n'))) return blk: {
            const ref = &ptr;
            ref.* += 1;
            break :blk ref.*;
        } else {
...
pub fn _processKeyValue(arg_line: c_int, arg_msg: [*c]natsMsg, arg_endPtr: [*c]u8, arg_pPtr: [*c][*c]u8, arg_lastKey: [*c][*c]u8) callconv(.c) natsStatus {
    var line = arg_line;
    _ = &line;
    var msg = arg_msg;
    _ = &msg;
    ...
    var v: [*c]natsHeaderValue = null;
    _ = &v;
    var ml: bool = @as(c_int, 0) != 0;
    _ = &ml;
    var start: [*c]u8 = undefined;
    _ = &start;
    var endval: [*c]u8 = undefined;
    _ = &endval;
    start = ptr;
    if (@as(c_int, @bitCast(@as(c_uint, ptr.*))) == @as(c_int, '\r')) {
        if (((blk: {
            const ref = &ptr;
            ref.* += 1;
            break :blk ref.*;
        }) == endPtr) or ((@as(c_int, @bitCast(@as(c_uint, ptr.*))) == @as(c_int, '\n')) and ((blk: {
            const ref = &ptr;
            ref.* += 1;
            break :blk ref.*;
        }) == endPtr))) {
        ...
        return nats_setErrorReal("./src/submodules/nats.c/src/msg.c", "_processKeyValue", @as(c_int, 221), @as(c_uint, @bitCast(NATS_PROTOCOL_ERROR)), "invalid start of a key: %s", start);
    }
    if ((@as(c_int, @bitCast(@as(c_uint, (blk: {
        ...
        if (line == @as(c_int, 0)) return nats_setErrorReal("./src/submodules/nats.c/src/msg.c", "_processKeyValue", @as(c_int, 226), @as(c_uint, @bitCast(NATS_PROTOCOL_ERROR)), "key cannot start with a space: %s", ptr);
        key = lastKey.*;
        ml = @as(c_int, 1) != 0;
    } else {
        col = strchr(@as([*c]const u8, @ptrCast(@alignCast(ptr))), @as(c_int, ':'));
        if (col == @as([*c]u8, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) return nats_setErrorReal("./src/submodules/nats.c/src/msg.c", "_processKeyValue", @as(c_int, 235), @as(c_uint, @bitCast(NATS_PROTOCOL_ERROR)), "column delimiter not found: %s", ptr);
        key = ptr;
        ptr = col + @as(usize, @bitCast(@as(isize, @intCast(@as(c_int, 1)))));
        col.* = '\x00';
    }
    while ((ptr != endPtr) and ((@as(c_int, @bitCast(@as(c_uint, (blk: {
        const tmp = @as(c_int, @bitCast(@as(c_uint, @as(u8, @bitCast(ptr.*)))));
        if (tmp >= 0) break :blk __ctype_b_loc().* + @as(usize, @intCast(tmp)) else break :blk __ctype_b_loc().* - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
    }).*))) & @as(c_int, @bitCast(@as(c_uint, @as(c_ushort, @bitCast(@as(c_short, @truncate(_ISspace)))))))) != 0)) {
        ptr += 1;
    }
    if (ptr == endPtr) return nats_setErrorReal("./src/submodules/nats.c/src/msg.c", "_processKeyValue", @as(c_int, 247), @as(c_uint, @bitCast(NATS_PROTOCOL_ERROR)), "no value found for key %s", key);
    val = ptr;
    ptr = _moveToLF(endPtr, ptr);
    if (ptr == endPtr) return nats_setErrorReal("./src/submodules/nats.c/src/msg.c", "_processKeyValue", @as(c_int, 253), @as(c_uint, @bitCast(NATS_PROTOCOL_ERROR)), "no CRLF found for value of key %s", key);
    endval = ptr;
    endval -= 1;
    if (@as(c_int, @bitCast(@as(c_uint, endval.*))) == @as(c_int, '\r')) {
        endval -= 1;
    }
    while ((endval != val) and ((@as(c_int, @bitCast(@as(c_uint, (blk: {
        const tmp = @as(c_int, @bitCast(@as(c_uint, @as(u8, @bitCast(endval.*)))));
        if (tmp >= 0) break :blk __ctype_b_loc().* + @as(usize, @intCast(tmp)) else break :blk __ctype_b_loc().* - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
    }).*))) & @as(c_int, @bitCast(@as(c_uint, @as(c_ushort, @bitCast(@as(c_short, @truncate(_ISspace)))))))) != 0)) {
        endval -= 1;
    }
    ...
    endval.* = '\x00';
    if (ml) {
        var newValue: [*c]u8 = null;
        _ = &newValue;
        var cur: [*c]natsHeaderValue = @as([*c]natsHeaderValue, @ptrCast(@alignCast(natsStrHash_GetEx(msg.*.headers, key, @as(c_int, @bitCast(@as(c_uint, @truncate(strlen(key)))))))));
        _ = &cur;
        if (cur == @as([*c]natsHeaderValue, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) return nats_setErrorReal("./src/submodules/nats.c/src/msg.c", "_processKeyValue", @as(c_int, 273), @as(c_uint, @bitCast(NATS_PROTOCOL_ERROR)), "unable to process folding lines for key %s", key);
        while (cur.*.next != @as([*c]struct___natsHeaderValue, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) {
            cur = cur.*.next;
        }
        if (asprintf(&newValue, "%s %s", cur.*.value, val) == -@as(c_int, 1)) return nats_setErrorReal("./src/submodules/nats.c/src/msg.c", "_processKeyValue", @as(c_int, 279), @as(c_uint, @bitCast(NATS_NO_MEMORY)), "%s", natsStatus_GetText(@as(c_uint, @bitCast(NATS_NO_MEMORY))));
        if (cur.*.needFree) {
            free(@as(?*anyopaque, @ptrCast(cur.*.value)));
        }
        cur.*.value = newValue;
        cur.*.needFree = @as(c_int, 1) != 0;
    } else {
        s = natsHeaderValue_create(&v, @as([*c]const u8, @ptrCast(@alignCast(val))), @as(c_int, 0) != 0);
        if (s == @as(c_uint, @bitCast(NATS_OK))) {
            var cur: [*c]natsHeaderValue = @as([*c]natsHeaderValue, @ptrCast(@alignCast(natsStrHash_GetEx(msg.*.headers, key, @as(c_int, @bitCast(@as(c_uint, @truncate(strlen(key)))))))));
            _ = &cur;
            if (cur != @as([*c]natsHeaderValue, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) {
                ...
                s = natsStrHash_SetEx(msg.*.headers, key, @as(c_int, 0) != 0, (if (@as(c_int, 0) != 0) @as(c_int, 1) else @as(c_int, 0)) != 0, @as(?*anyopaque, @ptrCast(v)), null);
            }
        }
    }
    if (s == @as(c_uint, @bitCast(NATS_OK))) {
    ...
    return if (s == @as(c_uint, @bitCast(NATS_OK))) s else nats_updateErrStack(s, "_processKeyValue");
}
pub fn _liftHeaders(arg_msg: [*c]natsMsg, arg_setOrAdd: bool) callconv(.c) natsStatus {
    var msg = arg_msg;
    _ = &msg;
    var setOrAdd = arg_setOrAdd;
    _ = &setOrAdd;
    var s: natsStatus = @as(c_uint, @bitCast(NATS_OK));
    _ = &s;
    var ptr: [*c]u8 = null;
    ...
    var i: c_int = undefined;
    _ = &i;
    if ((!setOrAdd and (msg.*.headers == @as([*c]natsStrHash, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0)))))))) and !((msg.*.flags & (@as(c_int, 1) << @intCast(0))) != @as(c_int, 0))) return @as(c_uint, @bitCast(NATS_OK));
    if (msg.*.headers == @as([*c]natsStrHash, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) {
        s = natsStrHash_Create(&msg.*.headers, @as(c_int, 4));
        if (s != @as(c_uint, @bitCast(NATS_OK))) return if (s == @as(c_uint, @bitCast(NATS_OK))) s else nats_updateErrStack(s, "_liftHeaders");
    }
    if (!((msg.*.flags & (@as(c_int, 1) << @intCast(0))) != @as(c_int, 0))) return @as(c_uint, @bitCast(NATS_OK));
    if ((msg.*.hdrLen < @as(c_int, 10)) or (strstr(msg.*.hdr, "NATS/1.0") != msg.*.hdr)) return nats_setErrorReal("./src/submodules/nats.c/src/msg.c", "_liftHeaders", @as(c_int, 344), @as(c_uint, @bitCast(NATS_PROTOCOL_ERROR)), "header prefix missing: %s", msg.*.hdr);
    endPtr = msg.*.hdr + @as(usize, @bitCast(@as(isize, @intCast(msg.*.hdrLen))));
    sts = msg.*.hdr + @as(usize, @bitCast(@as(isize, @intCast(@as(c_int, 8)))));
    while ((sts != endPtr) and (@as(c_int, @bitCast(@as(c_uint, sts.*))) == @as(c_int, ' '))) {
        sts += 1;
    }
    ptr = sts;
    ptr = _moveToLF(endPtr, ptr);
    if (ptr != endPtr) {
        ...
        _ = &stsEnd;
        ptr += 1;
        while ((stsEnd != sts) and (@as(c_int, @bitCast(@as(c_uint, stsEnd.*))) != @as(c_int, '\r'))) {
            stsEnd -= 1;
        }
        stsEnd.* = '\x00';
    }
    if (ptr == endPtr) return nats_setErrorReal("./src/submodules/nats.c/src/msg.c", "_liftHeaders", @as(c_int, 367), @as(c_uint, @bitCast(NATS_PROTOCOL_ERROR)), "early termination of headers: %s", msg.*.hdr);
    {
        i = 0;
        while ((s == @as(c_uint, @bitCast(NATS_OK))) and (ptr != endPtr)) : (i += 1) {
    ...
    if (s == @as(c_uint, @bitCast(NATS_OK))) {
        ...
        if ((sts != @as([*c]u8, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) and (@as(c_int, @bitCast(@as(c_uint, sts.*))) != @as(c_int, '\x00'))) {
            if (strlen(sts) > @as(c_ulong, @bitCast(@as(c_long, @as(c_int, 3))))) {
                var desc: [*c]u8 = sts + @as(usize, @bitCast(@as(isize, @intCast(@as(c_int, 3)))));
                _ = &desc;
                var descb: u8 = 0;
                _ = &descb;
                descb = desc.*;
                desc.* = '\x00';
                s = natsMsgHeader_Set(msg, "Status", @as([*c]const u8, @ptrCast(@alignCast(sts))));
                if (s == @as(c_uint, @bitCast(NATS_OK))) {
                    var desce: [*c]u8 = null;
                    _ = &desce;
                    desc.* = descb;
                    while ((@as(c_int, @bitCast(@as(c_uint, desc.*))) != @as(c_int, '\x00')) and ((@as(c_int, @bitCast(@as(c_uint, (blk: {
                        const tmp = @as(c_int, @bitCast(@as(c_uint, @as(u8, @bitCast(desc.*)))));
                        if (tmp >= 0) break :blk __ctype_b_loc().* + @as(usize, @intCast(tmp)) else break :blk __ctype_b_loc().* - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
                    }).*))) & @as(c_int, @bitCast(@as(c_uint, @as(c_ushort, @bitCast(@as(c_short, @truncate(_ISspace)))))))) != 0)) {
                        desc += 1;
                    }
                    if (@as(c_int, @bitCast(@as(c_uint, desc.*))) != @as(c_int, '\x00')) {
                        desce = (desc + @as(usize, @bitCast(@as(isize, @intCast(@as(c_int, @bitCast(@as(c_uint, @truncate(strlen(desc)))))))))) - @as(usize, @bitCast(@as(isize, @intCast(@as(c_int, 1)))));
                        while ((desce != desc) and ((@as(c_int, @bitCast(@as(c_uint, (blk: {
                            const tmp = @as(c_int, @bitCast(@as(c_uint, @as(u8, @bitCast(desce.*)))));
                            if (tmp >= 0) break :blk __ctype_b_loc().* + @as(usize, @intCast(tmp)) else break :blk __ctype_b_loc().* - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
                        }).*))) & @as(c_int, @bitCast(@as(c_uint, @as(c_ushort, @bitCast(@as(c_short, @truncate(_ISspace)))))))) != 0)) {
                            desce.* = '\x00';
                            desce -= 1;
                    ...
                    if (@as(c_int, @bitCast(@as(c_uint, desc.*))) != @as(c_int, '\x00')) {
                        s = natsMsgHeader_Set(msg, "Description", @as([*c]const u8, @ptrCast(@alignCast(desc))));
                    }
                }
            } else {
                s = natsMsgHeader_Set(msg, "Status", @as([*c]const u8, @ptrCast(@alignCast(sts))));
    ...
    return if (s == @as(c_uint, @bitCast(NATS_OK))) s else nats_updateErrStack(s, "_liftHeaders");
}
