...
pub export fn nats_Sleep(arg_millisec: i64) void {
    var millisec = arg_millisec;
    _ = &millisec;
    _ = usleep(@as(__useconds_t, @bitCast(@as(c_int, @truncate(millisec * @as(i64, @bitCast(@as(c_long, @as(c_int, 1000)))))))));
}
...
pub export fn nats_ParseInt64(arg_d: [*c]const u8, arg_dLen: c_int) i64 {
    var d = arg_d;
    _ = &d;
    var dLen = arg_dLen;
    _ = &dLen;
    ...
    _ = &i;
    var dec: u8 = undefined;
    _ = &dec;
    var pn: i64 = 0;
    _ = &pn;
    var n: i64 = 0;
    _ = &n;
    if (dLen == @as(c_int, 0)) return @as(i64, @bitCast(@as(c_long, -@as(c_int, 1))));
    {
        i = 0;
        while (i < dLen) : (i += 1) {
            dec = (blk: {
            ...
            if ((@as(c_int, @bitCast(@as(c_uint, dec))) < @as(c_int, 48)) or (@as(c_int, @bitCast(@as(c_uint, dec))) > @as(c_int, 57))) return @as(i64, @bitCast(@as(c_long, -@as(c_int, 1))));
            n = (n * @as(i64, @bitCast(@as(c_long, @as(c_int, 10))))) + @as(i64, @bitCast(@as(c_long, @as(c_int, @bitCast(@as(c_uint, dec))) - @as(c_int, 48))));
            if (n < pn) return @as(i64, @bitCast(@as(c_long, -@as(c_int, 1))));
            pn = n;
        }
    }
    return n;
}
pub export fn nats_Trim(arg_pres: [*c][*c]u8, arg_s: [*c]const u8) natsStatus {
    var pres = arg_pres;
    _ = &pres;
    var s = arg_s;
    _ = &s;
    ...
    var res: [*c]u8 = null;
    _ = &res;
    var ptr: [*c]u8 = @as([*c]u8, @ptrCast(@volatileCast(@constCast(s))));
    _ = &ptr;
    var start: [*c]u8 = @as([*c]u8, @ptrCast(@volatileCast(@constCast(s))));
    _ = &start;
    while ((@as(c_int, @bitCast(@as(c_uint, ptr.*))) != @as(c_int, '\x00')) and ((@as(c_int, @bitCast(@as(c_uint, (blk: {
        const tmp = @as(c_int, @bitCast(@as(c_uint, @as(u8, @bitCast(ptr.*)))));
    ...
    start = ptr;
    ptr = @as([*c]u8, @ptrCast(@volatileCast(@constCast((s + strlen(s)) - @as(usize, @bitCast(@as(isize, @intCast(@as(c_int, 1)))))))));
    while ((ptr != start) and ((@as(c_int, @bitCast(@as(c_uint, (blk: {
        const tmp = @as(c_int, @bitCast(@as(c_uint, @as(u8, @bitCast(ptr.*)))));
        if (tmp >= 0) break :blk __ctype_b_loc().* + @as(usize, @intCast(tmp)) else break :blk __ctype_b_loc().* - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
    }).*))) & @as(c_int, @bitCast(@as(c_uint, @as(c_ushort, @bitCast(@as(c_short, @truncate(_ISspace)))))))) != 0)) {
        ptr -= 1;
    }
    len = @as(c_int, @bitCast(@as(c_int, @truncate(@divExact(@as(c_long, @bitCast(@intFromPtr(ptr) -% @intFromPtr(start))), @sizeOf(u8)))))) + @as(c_int, 1);
    res = @as([*c]u8, @ptrCast(@alignCast(malloc(@as(c_ulong, @bitCast(@as(c_long, len + @as(c_int, 1))))))));
    if (res == @as([*c]u8, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) return nats_setErrorReal("./src/submodules/nats.c/src/util.c", "nats_Trim", @as(c_int, 209), @as(c_uint, @bitCast(NATS_NO_MEMORY)), "%s", natsStatus_GetText(@as(c_uint, @bitCast(NATS_NO_MEMORY))));
    _ = memcpy(@as(?*anyopaque, @ptrCast(res)), @as(?*const anyopaque, @ptrCast(start)), @as(usize, @bitCast(@as(c_long, len))));
    (blk: {
        const tmp = len;
        if (tmp >= 0) break :blk res + @as(usize, @intCast(tmp)) else break :blk res - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
    }).* = '\x00';
    pres.* = res;
    return @as(c_uint, @bitCast(NATS_OK));
}
pub export fn nats_ParseControl(arg_control: [*c]natsControl, arg_line: [*c]const u8) natsStatus {
    ...
    var len: c_int = 0;
    _ = &len;
    if ((line == @as([*c]const u8, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) or (@as(c_int, @bitCast(@as(c_uint, line[@as(c_uint, @intCast(@as(c_int, 0)))]))) == @as(c_int, '\x00'))) return nats_setErrorReal("./src/submodules/nats.c/src/util.c", "nats_ParseControl", @as(c_int, 226), @as(c_uint, @bitCast(NATS_PROTOCOL_ERROR)), "%s", natsStatus_GetText(@as(c_uint, @bitCast(NATS_PROTOCOL_ERROR))));
    tok = strchr(line, @as(c_int, ' '));
    if (tok == @as([*c]u8, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) {
        control.*.op = strdup(line);
        if (control.*.op == @as([*c]u8, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) return nats_setErrorReal("./src/submodules/nats.c/src/util.c", "nats_ParseControl", @as(c_int, 233), @as(c_uint, @bitCast(NATS_NO_MEMORY)), "%s", natsStatus_GetText(@as(c_uint, @bitCast(NATS_NO_MEMORY))));
        return @as(c_uint, @bitCast(NATS_OK));
    }
    len = @as(c_int, @bitCast(@as(c_int, @truncate(@divExact(@as(c_long, @bitCast(@intFromPtr(tok) -% @intFromPtr(line))), @sizeOf(u8))))));
    control.*.op = @as([*c]u8, @ptrCast(@alignCast(malloc(@as(c_ulong, @bitCast(@as(c_long, len + @as(c_int, 1))))))));
    if (control.*.op == @as([*c]u8, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) {
        s = nats_setErrorReal("./src/submodules/nats.c/src/util.c", "nats_ParseControl", @as(c_int, 242), @as(c_uint, @bitCast(NATS_NO_MEMORY)), "%s", natsStatus_GetText(@as(c_uint, @bitCast(NATS_NO_MEMORY))));
    } else {
        _ = memcpy(@as(?*anyopaque, @ptrCast(control.*.op)), @as(?*const anyopaque, @ptrCast(line)), @as(c_ulong, @bitCast(@as(c_long, len))));
        (blk: {
            const tmp = len;
            if (tmp >= 0) break :blk control.*.op + @as(usize, @intCast(tmp)) else break :blk control.*.op - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
        }).* = '\x00';
    }
    if (s == @as(c_uint, @bitCast(NATS_OK))) {
        while ((@as(c_int, @bitCast(@as(c_uint, tok[@as(c_uint, @intCast(@as(c_int, 0)))]))) != @as(c_int, '\x00')) and ((((@as(c_int, @bitCast(@as(c_uint, tok[@as(c_uint, @intCast(@as(c_int, 0)))]))) == @as(c_int, ' ')) or (@as(c_int, @bitCast(@as(c_uint, tok[@as(c_uint, @intCast(@as(c_int, 0)))]))) == @as(c_int, '\r'))) or (@as(c_int, @bitCast(@as(c_uint, tok[@as(c_uint, @intCast(@as(c_int, 0)))]))) == @as(c_int, '\n'))) or (@as(c_int, @bitCast(@as(c_uint, tok[@as(c_uint, @intCast(@as(c_int, 0)))]))) == @as(c_int, '\t')))) {
            tok += 1;
        }
    }
    if (@as(c_int, @bitCast(@as(c_uint, tok[@as(c_uint, @intCast(@as(c_int, 0)))]))) != @as(c_int, '\x00')) {
        var tmp: [*c]u8 = undefined;
        _ = &tmp;
        len = @as(c_int, @bitCast(@as(c_uint, @truncate(strlen(tok)))));
        tmp = &(blk: {
            const tmp_1 = len - @as(c_int, 1);
            if (tmp_1 >= 0) break :blk tok + @as(usize, @intCast(tmp_1)) else break :blk tok - ~@as(usize, @bitCast(@as(isize, @intCast(tmp_1)) +% -1));
        }).*;
        while ((@as(c_int, @bitCast(@as(c_uint, tmp[@as(c_uint, @intCast(@as(c_int, 0)))]))) != @as(c_int, '\x00')) and ((((@as(c_int, @bitCast(@as(c_uint, tmp[@as(c_uint, @intCast(@as(c_int, 0)))]))) == @as(c_int, ' ')) or (@as(c_int, @bitCast(@as(c_uint, tmp[@as(c_uint, @intCast(@as(c_int, 0)))]))) == @as(c_int, '\r'))) or (@as(c_int, @bitCast(@as(c_uint, tmp[@as(c_uint, @intCast(@as(c_int, 0)))]))) == @as(c_int, '\n'))) or (@as(c_int, @bitCast(@as(c_uint, tmp[@as(c_uint, @intCast(@as(c_int, 0)))]))) == @as(c_int, '\t')))) {
            tmp -= 1;
            len -= 1;
        }
        control.*.args = @as([*c]u8, @ptrCast(@alignCast(malloc(@as(c_ulong, @bitCast(@as(c_long, len + @as(c_int, 1))))))));
        if (control.*.args == @as([*c]u8, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) {
            s = nats_setErrorReal("./src/submodules/nats.c/src/util.c", "nats_ParseControl", @as(c_int, 287), @as(c_uint, @bitCast(NATS_NO_MEMORY)), "%s", natsStatus_GetText(@as(c_uint, @bitCast(NATS_NO_MEMORY))));
        } else {
            _ = memcpy(@as(?*anyopaque, @ptrCast(control.*.args)), @as(?*const anyopaque, @ptrCast(tok)), @as(c_ulong, @bitCast(@as(c_long, len))));
            (blk: {
                const tmp_1 = len;
                if (tmp_1 >= 0) break :blk control.*.args + @as(usize, @intCast(tmp_1)) else break :blk control.*.args - ~@as(usize, @bitCast(@as(isize, @intCast(tmp_1)) +% -1));
            }).* = '\x00';
        }
    }
    if (s != @as(c_uint, @bitCast(NATS_OK))) {
    ...
    return if (s == @as(c_uint, @bitCast(NATS_OK))) s else nats_updateErrStack(s, "nats_ParseControl");
}
pub export fn nats_CreateStringFromBuffer(arg_newStr: [*c][*c]u8, arg_buf: [*c]natsBuffer) natsStatus {
    var newStr = arg_newStr;
    _ = &newStr;
    var buf = arg_buf;
    _ = &buf;
    var str: [*c]u8 = null;
    ...
    var len: c_int = 0;
    _ = &len;
    if ((buf == @as([*c]natsBuffer, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) or ((blk: {
        const tmp = buf.*.len;
        len = tmp;
        break :blk tmp;
    }) == @as(c_int, 0))) return @as(c_uint, @bitCast(NATS_OK));
    str = @as([*c]u8, @ptrCast(@alignCast(malloc(@as(c_ulong, @bitCast(@as(c_long, len + @as(c_int, 1))))))));
    if (str == @as([*c]u8, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) return nats_setErrorReal("./src/submodules/nats.c/src/util.c", "nats_CreateStringFromBuffer", @as(c_int, 319), @as(c_uint, @bitCast(NATS_NO_MEMORY)), "%s", natsStatus_GetText(@as(c_uint, @bitCast(NATS_NO_MEMORY))));
    _ = memcpy(@as(?*anyopaque, @ptrCast(str)), @as(?*const anyopaque, @ptrCast(buf.*.data)), @as(c_ulong, @bitCast(@as(c_long, len))));
    (blk: {
        const tmp = len;
...
pub export fn nats_GetBoolStr(arg_value: bool) [*c]const u8 {
    var value = arg_value;
    _ = &value;
    if (value) return "true";
    return "false";
}
pub export fn nats_NormalizeErr(arg_error: [*c]u8) void {
    var @"error" = arg_error;
    _ = &@"error";
    var start: c_int = 0;
    _ = &start;
    var end: c_int = 0;
    _ = &end;
    var len: c_int = @as(c_int, @bitCast(@as(c_uint, @truncate(strlen(@"error")))));
    _ = &len;
    var i: c_int = undefined;
    _ = &i;
    if (strncmp(@"error", "-ERR", @as(c_ulong, @bitCast(@as(c_long, @as(c_int, 4))))) == @as(c_int, 0)) {
        start = @as(c_int, 4);
    }
    {
        i = start;
        while (i < len) : (i += 1) {
            if ((@as(c_int, @bitCast(@as(c_uint, (blk: {
                const tmp = i;
                if (tmp >= 0) break :blk @"error" + @as(usize, @intCast(tmp)) else break :blk @"error" - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
    ...
    start = i;
    if (start == len) {
        @"error"[@as(c_uint, @intCast(@as(c_int, 0)))] = '\x00';
        return;
    }
    {
        end = len - @as(c_int, 1);
        while (end > @as(c_int, 0)) : (end -= 1) {
            var c: u8 = (blk: {
                const tmp = end;
                if (tmp >= 0) break :blk @"error" + @as(usize, @intCast(tmp)) else break :blk @"error" - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
            }).*;
            _ = &c;
            if ((((@as(c_int, @bitCast(@as(c_uint, c))) == @as(c_int, '\r')) or (@as(c_int, @bitCast(@as(c_uint, c))) == @as(c_int, '\n'))) or (@as(c_int, @bitCast(@as(c_uint, c))) == @as(c_int, '\''))) or (@as(c_int, @bitCast(@as(c_uint, c))) == @as(c_int, ' '))) continue;
            break;
        }
    }
    if (end <= start) {
    ...
    len = (end - start) + @as(c_int, 1);
    _ = memmove(@as(?*anyopaque, @ptrCast(@"error")), @as(?*const anyopaque, @ptrCast(@"error" + @as(usize, @bitCast(@as(isize, @intCast(start)))))), @as(c_ulong, @bitCast(@as(c_long, len))));
    (blk: {
        const tmp = len;
        if (tmp >= 0) break :blk @"error" + @as(usize, @intCast(tmp)) else break :blk @"error" - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
    }).* = '\x00';
}
pub export fn nats_JSONParse(arg_newJSON: [*c][*c]nats_JSON, arg_jsonStr: [*c]const u8, arg_jsonLen: c_int) natsStatus {
    var newJSON = arg_newJSON;
    _ = &newJSON;
    var jsonStr = arg_jsonStr;
    _ = &jsonStr;
    var jsonLen = arg_jsonLen;
    _ = &jsonLen;
    var s: natsStatus = _jsonParse(newJSON, null, jsonStr, jsonLen, @as(c_int, 0));
    _ = &s;
    return if (s == @as(c_uint, @bitCast(NATS_OK))) s else nats_updateErrStack(s, "nats_JSONParse");
}
pub export fn nats_JSONGetField(arg_json: [*c]nats_JSON, arg_fieldName: [*c]const u8, arg_fieldType: c_int, arg_retField: [*c][*c]nats_JSONField) natsStatus {
    var json = arg_json;
    _ = &json;
    var fieldName = arg_fieldName;
    _ = &fieldName;
    var fieldType = arg_fieldType;
    _ = &fieldType;
    var retField = arg_retField;
    _ = &retField;
    var field: [*c]nats_JSONField = null;
    _ = &field;
    field = @as([*c]nats_JSONField, @ptrCast(@alignCast(natsStrHash_GetEx(json.*.fields, @as([*c]u8, @ptrCast(@volatileCast(@constCast(fieldName)))), @as(c_int, @bitCast(@as(c_uint, @truncate(strlen(@as([*c]u8, @ptrCast(@volatileCast(@constCast(fieldName)))))))))))));
    if ((field == @as([*c]nats_JSONField, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) or (field.*.typ == @as(c_int, 9))) {
        retField.* = null;
        return @as(c_uint, @bitCast(NATS_OK));
    }
    while (true) {
        switch (fieldType) {
            @as(c_int, 4), @as(c_int, 5), @as(c_int, 6) => {
                if (field.*.typ != @as(c_int, 3)) return nats_setErrorReal("./src/submodules/nats.c/src/util.c", "nats_JSONGetField", @as(c_int, 1151), @as(c_uint, @bitCast(NATS_INVALID_ARG)), "Asked for field '%s' as type %d, but got type %d when parsing", field.*.name, fieldType, field.*.typ);
                break;
            },
            @as(c_int, 2), @as(c_int, 1), @as(c_int, 8) => {
                if (field.*.typ != fieldType) return nats_setErrorReal("./src/submodules/nats.c/src/util.c", "nats_JSONGetField", @as(c_int, 1159), @as(c_uint, @bitCast(NATS_INVALID_ARG)), "Asked for field '%s' as type %d, but got type %d when parsing", field.*.name, fieldType, field.*.typ);
                break;
            },
            else => return nats_setErrorReal("./src/submodules/nats.c/src/util.c", "nats_JSONGetField", @as(c_int, 1164), @as(c_uint, @bitCast(NATS_INVALID_ARG)), "Asked for field '%s' as type %d, but this type does not exist", field.*.name, fieldType),
        }
        break;
    }
    retField.* = field;
...
pub export fn nats_JSONGetStr(arg_json: [*c]nats_JSON, arg_fieldName: [*c]const u8, arg_value: [*c][*c]u8) natsStatus {
    var json = arg_json;
    _ = &json;
    var fieldName = arg_fieldName;
    _ = &fieldName;
    ...
    var field: [*c]nats_JSONField = null;
    _ = &field;
    s = nats_JSONGetField(json, fieldName, @as(c_int, 1), &field);
    if (s == @as(c_uint, @bitCast(NATS_OK))) {
        if ((field == @as([*c]nats_JSONField, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) or (field.*.value.vstr == @as([*c]u8, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0)))))))) {
            value.* = null;
            return @as(c_uint, @bitCast(NATS_OK));
        } else {
            var tmp: [*c]u8 = strdup(field.*.value.vstr);
            _ = &tmp;
            if (tmp == @as([*c]u8, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) return nats_setErrorReal("./src/submodules/nats.c/src/util.c", "nats_JSONGetStr", @as(c_int, 1188), @as(c_uint, @bitCast(NATS_NO_MEMORY)), "%s", natsStatus_GetText(@as(c_uint, @bitCast(NATS_NO_MEMORY))));
            value.* = tmp;
        }
    }
    return if (s == @as(c_uint, @bitCast(NATS_OK))) s else nats_updateErrStack(s, "nats_JSONGetStr");
}
pub export fn nats_JSONGetStrPtr(arg_json: [*c]nats_JSON, arg_fieldName: [*c]const u8, arg_str: [*c][*c]const u8) natsStatus {
    var json = arg_json;
    _ = &json;
    var fieldName = arg_fieldName;
    _ = &fieldName;
    ...
    s = nats_JSONGetField(json, fieldName, @as(c_int, 1), &field);
    if (s == @as(c_uint, @bitCast(NATS_OK))) {
        if (field == @as([*c]nats_JSONField, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) {
            str.* = null;
        } else {
            str.* = field.*.value.vstr;
        }
    }
    return if (s == @as(c_uint, @bitCast(NATS_OK))) s else nats_updateErrStack(s, "nats_JSONGetStrPtr");
}
pub export fn nats_JSONGetBytes(arg_json: [*c]nats_JSON, arg_fieldName: [*c]const u8, arg_value: [*c][*c]u8, arg_len: [*c]c_int) natsStatus {
    var json = arg_json;
    _ = &json;
    var fieldName = arg_fieldName;
    _ = &fieldName;
    ...
    return if (s == @as(c_uint, @bitCast(NATS_OK))) s else nats_updateErrStack(s, "nats_JSONGetBytes");
}
pub export fn nats_JSONGetInt(arg_json: [*c]nats_JSON, arg_fieldName: [*c]const u8, arg_value: [*c]c_int) natsStatus {
    var json = arg_json;
    _ = &json;
    var fieldName = arg_fieldName;
    _ = &fieldName;
    ...
    var field: [*c]nats_JSONField = null;
    _ = &field;
    s = nats_JSONGetField(json, fieldName, @as(c_int, 4), &field);
    if ((s == @as(c_uint, @bitCast(NATS_OK))) and (field == @as([*c]nats_JSONField, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0)))))))) {
        value.* = 0;
        return @as(c_uint, @bitCast(NATS_OK));
        ...
        while (true) {
            switch (field.*.numTyp) {
                @as(c_int, 4) => {
                    value.* = @as(c_int, @bitCast(@as(c_int, @truncate(field.*.value.vint))));
                    break;
                },
                @as(c_int, 5) => {
                    value.* = @as(c_int, @bitCast(@as(c_uint, @truncate(field.*.value.vuint))));
                    break;
                },
                else => {
                    value.* = @as(c_int, @intFromFloat(field.*.value.vdec));
                },
            }
            break;
        }
    }
    return if (s == @as(c_uint, @bitCast(NATS_OK))) s else nats_updateErrStack(s, "nats_JSONGetInt");
}
pub export fn nats_JSONGetInt32(arg_json: [*c]nats_JSON, arg_fieldName: [*c]const u8, arg_value: [*c]i32) natsStatus {
    var json = arg_json;
    _ = &json;
    var fieldName = arg_fieldName;
    _ = &fieldName;
    ...
    if ((s == @as(c_uint, @bitCast(NATS_OK))) and (field == @as([*c]nats_JSONField, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0)))))))) {
        ...
        while (true) {
            switch (field.*.numTyp) {
                @as(c_int, 4) => {
                    value.* = @as(i32, @bitCast(@as(c_int, @truncate(field.*.value.vint))));
                    break;
                },
                @as(c_int, 5) => {
                    value.* = @as(i32, @bitCast(@as(c_uint, @truncate(field.*.value.vuint))));
                    break;
                },
                else => {
                    value.* = @as(i32, @intFromFloat(field.*.value.vdec));
                },
            }
            break;
        }
    }
    return if (s == @as(c_uint, @bitCast(NATS_OK))) s else nats_updateErrStack(s, "nats_JSONGetInt32");
}
pub export fn nats_JSONGetUInt16(arg_json: [*c]nats_JSON, arg_fieldName: [*c]const u8, arg_value: [*c]u16) natsStatus {
    var json = arg_json;
    _ = &json;
    var fieldName = arg_fieldName;
    _ = &fieldName;
    ...
    var field: [*c]nats_JSONField = null;
    _ = &field;
    s = nats_JSONGetField(json, fieldName, @as(c_int, 5), &field);
    if ((s == @as(c_uint, @bitCast(NATS_OK))) and (field == @as([*c]nats_JSONField, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0)))))))) {
        value.* = 0;
        return @as(c_uint, @bitCast(NATS_OK));
    } else if (s == @as(c_uint, @bitCast(NATS_OK))) {
        while (true) {
            switch (field.*.numTyp) {
                @as(c_int, 4) => {
                    value.* = @as(u16, @bitCast(@as(c_short, @truncate(field.*.value.vint))));
                    break;
                },
                @as(c_int, 5) => {
                    value.* = @as(u16, @bitCast(@as(c_ushort, @truncate(field.*.value.vuint))));
                    break;
                },
                else => {
                    value.* = @as(u16, @intFromFloat(field.*.value.vdec));
                },
            }
            break;
        }
    }
    return if (s == @as(c_uint, @bitCast(NATS_OK))) s else nats_updateErrStack(s, "nats_JSONGetUInt16");
}
pub export fn nats_JSONGetBool(arg_json: [*c]nats_JSON, arg_fieldName: [*c]const u8, arg_value: [*c]bool) natsStatus {
    var json = arg_json;
    _ = &json;
    var fieldName = arg_fieldName;
    _ = &fieldName;
    ...
    var field: [*c]nats_JSONField = null;
    _ = &field;
    s = nats_JSONGetField(json, fieldName, @as(c_int, 2), &field);
    if (s == @as(c_uint, @bitCast(NATS_OK))) {
        value.* = (if (field == @as([*c]nats_JSONField, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) @as(c_int, 0) else @as(c_int, @intFromBool(field.*.value.vbool))) != 0;
        return @as(c_uint, @bitCast(NATS_OK));
    }
    return if (s == @as(c_uint, @bitCast(NATS_OK))) s else nats_updateErrStack(s, "nats_JSONGetBool");
}
pub export fn nats_JSONGetLong(arg_json: [*c]nats_JSON, arg_fieldName: [*c]const u8, arg_value: [*c]i64) natsStatus {
    var json = arg_json;
    _ = &json;
    var fieldName = arg_fieldName;
    _ = &fieldName;
    ...
    if ((s == @as(c_uint, @bitCast(NATS_OK))) and (field == @as([*c]nats_JSONField, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0)))))))) {
        ...
        while (true) {
            switch (field.*.numTyp) {
                @as(c_int, 4) => {
                    value.* = field.*.value.vint;
                    break;
                },
                @as(c_int, 5) => {
                    value.* = @as(i64, @bitCast(field.*.value.vuint));
                    break;
                },
                else => {
                    value.* = @as(i64, @intFromFloat(field.*.value.vdec));
                },
            }
            break;
        }
    }
    return if (s == @as(c_uint, @bitCast(NATS_OK))) s else nats_updateErrStack(s, "nats_JSONGetLong");
}
pub export fn nats_JSONGetULong(arg_json: [*c]nats_JSON, arg_fieldName: [*c]const u8, arg_value: [*c]u64) natsStatus {
    var json = arg_json;
    _ = &json;
    var fieldName = arg_fieldName;
    _ = &fieldName;
    ...
    if ((s == @as(c_uint, @bitCast(NATS_OK))) and (field == @as([*c]nats_JSONField, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0)))))))) {
        ...
        while (true) {
            switch (field.*.numTyp) {
                @as(c_int, 4) => {
                    value.* = @as(u64, @bitCast(field.*.value.vint));
                    break;
                },
                @as(c_int, 5) => {
                    value.* = field.*.value.vuint;
                    break;
                },
                else => {
                    value.* = @as(u64, @intFromFloat(field.*.value.vdec));
                },
            }
            break;
        }
    }
    return if (s == @as(c_uint, @bitCast(NATS_OK))) s else nats_updateErrStack(s, "nats_JSONGetULong");
}
pub export fn nats_JSONGetDouble(arg_json: [*c]nats_JSON, arg_fieldName: [*c]const u8, arg_value: [*c]c_longdouble) natsStatus {
    var json = arg_json;
    _ = &json;
    var fieldName = arg_fieldName;
    _ = &fieldName;
    ...
    var field: [*c]nats_JSONField = null;
    _ = &field;
    s = nats_JSONGetField(json, fieldName, @as(c_int, 6), &field);
    if ((s == @as(c_uint, @bitCast(NATS_OK))) and (field == @as([*c]nats_JSONField, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0)))))))) {
        value.* = 0;
        return @as(c_uint, @bitCast(NATS_OK));
    } else if (s == @as(c_uint, @bitCast(NATS_OK))) {
        while (true) {
            switch (field.*.numTyp) {
                @as(c_int, 4) => {
                    value.* = @as(c_longdouble, @floatFromInt(field.*.value.vint));
                    break;
                },
                @as(c_int, 5) => {
                    value.* = @as(c_longdouble, @floatFromInt(field.*.value.vuint));
                    break;
                },
                else => {
                    value.* = field.*.value.vdec;
                },
            }
            break;
        }
    }
    return if (s == @as(c_uint, @bitCast(NATS_OK))) s else nats_updateErrStack(s, "nats_JSONGetDouble");
}
pub export fn nats_JSONGetObject(arg_json: [*c]nats_JSON, arg_fieldName: [*c]const u8, arg_value: [*c][*c]nats_JSON) natsStatus {
    var json = arg_json;
    _ = &json;
    var fieldName = arg_fieldName;
    _ = &fieldName;
    ...
    var field: [*c]nats_JSONField = null;
    _ = &field;
    s = nats_JSONGetField(json, fieldName, @as(c_int, 8), &field);
    if (s == @as(c_uint, @bitCast(NATS_OK))) {
        value.* = if (field == @as([*c]nats_JSONField, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) null else field.*.value.vobj;
        return @as(c_uint, @bitCast(NATS_OK));
    }
    return if (s == @as(c_uint, @bitCast(NATS_OK))) s else nats_updateErrStack(s, "nats_JSONGetObject");
}
pub export fn nats_JSONGetTime(arg_json: [*c]nats_JSON, arg_fieldName: [*c]const u8, arg_timeUTC: [*c]i64) natsStatus {
    var json = arg_json;
    _ = &json;
    var fieldName = arg_fieldName;
    _ = &fieldName;
    ...
    if ((s == @as(c_uint, @bitCast(NATS_OK))) and (str == @as([*c]u8, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0)))))))) {
        timeUTC.* = 0;
        return @as(c_uint, @bitCast(NATS_OK));
    } else if (s != @as(c_uint, @bitCast(NATS_OK))) return if (s == @as(c_uint, @bitCast(NATS_OK))) s else nats_updateErrStack(s, "nats_JSONGetTime");
    s = nats_parseTime(str, timeUTC);
    free(@as(?*anyopaque, @ptrCast(str)));
    return if (s == @as(c_uint, @bitCast(NATS_OK))) s else nats_updateErrStack(s, "nats_JSONGetTime");
}
pub export fn nats_JSONGetArrayField(arg_json: [*c]nats_JSON, arg_fieldName: [*c]const u8, arg_fieldType: c_int, arg_retField: [*c][*c]nats_JSONField) natsStatus {
    var json = arg_json;
    _ = &json;
    var fieldName = arg_fieldName;
    _ = &fieldName;
    ...
    if (field.*.typ != @as(c_int, 7)) return nats_setErrorReal("./src/submodules/nats.c/src/util.c", "nats_JSONGetArrayField", @as(c_int, 1463), @as(c_uint, @bitCast(NATS_INVALID_ARG)), "Field '%s' is not an array, it has type: %d", field.*.name, field.*.typ);
    if (field.*.value.varr.*.typ == @as(c_int, 9)) {
        retField.* = null;
        return @as(c_uint, @bitCast(NATS_OK));
    }
    if (fieldType != field.*.value.varr.*.typ) return nats_setErrorReal("./src/submodules/nats.c/src/util.c", "nats_JSONGetArrayField", @as(c_int, 1473), @as(c_uint, @bitCast(NATS_INVALID_ARG)), "Asked for field '%s' as an array of type: %d, but it is an array of type: %d", field.*.name, fieldType, field.*.typ);
    retField.* = field;
    return @as(c_uint, @bitCast(NATS_OK));
}
pub export fn nats_JSONArrayAsStrings(arg_arr: [*c]nats_JSONArray, arg_array: [*c][*c][*c]u8, arg_arraySize: [*c]c_int) natsStatus {
    var arr = arg_arr;
    _ = &arr;
    var array = arg_array;
    _ = &array;
    var arraySize = arg_arraySize;
    _ = &arraySize;
    var s: natsStatus = @as(c_uint, @bitCast(NATS_OK));
    _ = &s;
    var i: c_int = undefined;
    _ = &i;
    var values: [*c][*c]u8 = @as([*c][*c]u8, @ptrCast(@alignCast(calloc(@as(c_ulong, @bitCast(@as(c_long, arr.*.size))), @as(c_ulong, @bitCast(@as(c_long, arr.*.eltSize)))))));
    _ = &values;
    if (values == @as([*c][*c]u8, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) return nats_setErrorReal("./src/submodules/nats.c/src/util.c", "nats_JSONArrayAsStrings", @as(c_int, 1487), @as(c_uint, @bitCast(NATS_NO_MEMORY)), "%s", natsStatus_GetText(@as(c_uint, @bitCast(NATS_NO_MEMORY))));
    {
        i = 0;
        while (i < arr.*.size) : (i += 1) {
            ...
            }).* = strdup(@as([*c]u8, @ptrCast(@alignCast((blk: {
                const tmp = i;
            ...
            if ((blk: {
                ...
                s = nats_setErrorReal("./src/submodules/nats.c/src/util.c", "nats_JSONArrayAsStrings", @as(c_int, 1494), @as(c_uint, @bitCast(NATS_NO_MEMORY)), "%s", natsStatus_GetText(@as(c_uint, @bitCast(NATS_NO_MEMORY))));
                break;
            }
        }
    }
    if (s != @as(c_uint, @bitCast(NATS_OK))) {
        ...
        free(@as(?*anyopaque, @ptrCast(values)));
    } else {
        array.* = values;
        arraySize.* = arr.*.size;
    }
    return if (s == @as(c_uint, @bitCast(NATS_OK))) s else nats_updateErrStack(s, "nats_JSONArrayAsStrings");
}
pub export fn nats_JSONGetArrayStr(arg_json: [*c]nats_JSON, arg_fieldName: [*c]const u8, arg_array: [*c][*c][*c]u8, arg_arraySize: [*c]c_int) natsStatus {
    var json = arg_json;
    _ = &json;
    var fieldName = arg_fieldName;
    _ = &fieldName;
    ...
    var field: [*c]nats_JSONField = null;
    _ = &field;
    s = nats_JSONGetArrayField(json, fieldName, @as(c_int, 1), &field);
    if ((s == @as(c_uint, @bitCast(NATS_OK))) and (field == @as([*c]nats_JSONField, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0)))))))) {
        array.* = null;
        arraySize.* = 0;
        return @as(c_uint, @bitCast(NATS_OK));
    } else if (s == @as(c_uint, @bitCast(NATS_OK))) {
        s = nats_JSONArrayAsStrings(field.*.value.varr, array, arraySize);
    }
    return if (s == @as(c_uint, @bitCast(NATS_OK))) s else nats_updateErrStack(s, "nats_JSONGetArrayStr");
}
pub export fn nats_JSONArrayAsBools(arg_arr: [*c]nats_JSONArray, arg_array: [*c][*c]bool, arg_arraySize: [*c]c_int) natsStatus {
    var arr = arg_arr;
    _ = &arr;
    var array = arg_array;
    _ = &array;
    ...
    var i: c_int = undefined;
    _ = &i;
    var values: [*c]bool = @as([*c]bool, @ptrCast(@alignCast(calloc(@as(c_ulong, @bitCast(@as(c_long, arr.*.size))), @sizeOf(bool)))));
    _ = &values;
    if (values == @as([*c]bool, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) return nats_setErrorReal("./src/submodules/nats.c/src/util.c", "nats_JSONArrayAsBools", @as(c_int, 1524), @as(c_uint, @bitCast(NATS_NO_MEMORY)), "%s", natsStatus_GetText(@as(c_uint, @bitCast(NATS_NO_MEMORY))));
    {
        i = 0;
        while (i < arr.*.size) : (i += 1) {
            (blk: {
                ...
                const tmp = i;
                if (tmp >= 0) break :blk @as([*c]bool, @ptrCast(@alignCast(arr.*.values))) + @as(usize, @intCast(tmp)) else break :blk @as([*c]bool, @ptrCast(@alignCast(arr.*.values))) - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
            }).*;
        }
    }
    array.* = values;
...
pub export fn nats_JSONGetArrayBool(arg_json: [*c]nats_JSON, arg_fieldName: [*c]const u8, arg_array: [*c][*c]bool, arg_arraySize: [*c]c_int) natsStatus {
    var json = arg_json;
    _ = &json;
    var fieldName = arg_fieldName;
    _ = &fieldName;
    ...
    var field: [*c]nats_JSONField = null;
    _ = &field;
    s = nats_JSONGetArrayField(json, fieldName, @as(c_int, 2), &field);
    if ((s == @as(c_uint, @bitCast(NATS_OK))) and (field == @as([*c]nats_JSONField, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0)))))))) {
        array.* = null;
        arraySize.* = 0;
        return @as(c_uint, @bitCast(NATS_OK));
    } else if (s == @as(c_uint, @bitCast(NATS_OK))) {
        s = nats_JSONArrayAsBools(field.*.value.varr, array, arraySize);
    }
    return if (s == @as(c_uint, @bitCast(NATS_OK))) s else nats_updateErrStack(s, "nats_JSONGetArrayBool");
}
pub export fn nats_JSONArrayAsDoubles(arg_arr: [*c]nats_JSONArray, arg_array: [*c][*c]c_longdouble, arg_arraySize: [*c]c_int) natsStatus {
    var arr = arg_arr;
    _ = &arr;
    var array = arg_array;
    _ = &array;
    ...
    var i: c_int = undefined;
    _ = &i;
    var values: [*c]c_longdouble = @as([*c]c_longdouble, @ptrCast(@alignCast(calloc(@as(c_ulong, @bitCast(@as(c_long, arr.*.size))), @sizeOf(c_longdouble)))));
    _ = &values;
    if (values == @as([*c]c_longdouble, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) return nats_setErrorReal("./src/submodules/nats.c/src/util.c", "nats_JSONArrayAsDoubles", @as(c_int, 1536), @as(c_uint, @bitCast(NATS_NO_MEMORY)), "%s", natsStatus_GetText(@as(c_uint, @bitCast(NATS_NO_MEMORY))));
    {
        i = 0;
        while (i < arr.*.size) : (i += 1) {
            var ptr: ?*anyopaque = @as(?*anyopaque, @ptrFromInt(@as(c_int, 0)));
            _ = &ptr;
            ptr = @as(?*anyopaque, @ptrCast(@as([*c]u8, @ptrCast(@alignCast(arr.*.values))) + @as(usize, @bitCast(@as(isize, @intCast(i * @as(c_int, @bitCast(@as(c_uint, @truncate(@sizeOf(c_longdouble)))))))))));
            (blk: {
                const tmp = i;
                if (tmp >= 0) break :blk values + @as(usize, @intCast(tmp)) else break :blk values - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
            }).* = @as([*c]c_longdouble, @ptrCast(@alignCast(ptr))).*;
        }
    }
    array.* = values;
    arraySize.* = arr.*.size;
...
pub export fn nats_JSONGetArrayDouble(arg_json: [*c]nats_JSON, arg_fieldName: [*c]const u8, arg_array: [*c][*c]c_longdouble, arg_arraySize: [*c]c_int) natsStatus {
    var json = arg_json;
    _ = &json;
    var fieldName = arg_fieldName;
    _ = &fieldName;
    ...
    var field: [*c]nats_JSONField = null;
    _ = &field;
    s = nats_JSONGetArrayField(json, fieldName, @as(c_int, 3), &field);
    if ((s == @as(c_uint, @bitCast(NATS_OK))) and (field == @as([*c]nats_JSONField, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0)))))))) {
        array.* = null;
        arraySize.* = 0;
        return @as(c_uint, @bitCast(NATS_OK));
    } else if (s == @as(c_uint, @bitCast(NATS_OK))) {
        s = nats_JSONArrayAsDoubles(field.*.value.varr, array, arraySize);
    }
    return if (s == @as(c_uint, @bitCast(NATS_OK))) s else nats_updateErrStack(s, "nats_JSONGetArrayDouble");
}
pub export fn nats_JSONArrayAsInts(arg_arr: [*c]nats_JSONArray, arg_array: [*c][*c]c_int, arg_arraySize: [*c]c_int) natsStatus {
    var arr = arg_arr;
    _ = &arr;
    var array = arg_array;
    _ = &array;
    ...
    var i: c_int = undefined;
    _ = &i;
    var values: [*c]c_int = @as([*c]c_int, @ptrCast(@alignCast(calloc(@as(c_ulong, @bitCast(@as(c_long, arr.*.size))), @sizeOf(c_int)))));
    _ = &values;
    if (values == @as([*c]c_int, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) return nats_setErrorReal("./src/submodules/nats.c/src/util.c", "nats_JSONArrayAsInts", @as(c_int, 1548), @as(c_uint, @bitCast(NATS_NO_MEMORY)), "%s", natsStatus_GetText(@as(c_uint, @bitCast(NATS_NO_MEMORY))));
    {
        i = 0;
        while (i < arr.*.size) : (i += 1) {
            var ptr: ?*anyopaque = @as(?*anyopaque, @ptrFromInt(@as(c_int, 0)));
            ...
            (blk: {
                const tmp = i;
                if (tmp >= 0) break :blk values + @as(usize, @intCast(tmp)) else break :blk values - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
            }).* = @as([*c]c_int, @ptrCast(@alignCast(ptr))).*;
        }
    }
    array.* = values;
    arraySize.* = arr.*.size;
...
pub export fn nats_JSONGetArrayInt(arg_json: [*c]nats_JSON, arg_fieldName: [*c]const u8, arg_array: [*c][*c]c_int, arg_arraySize: [*c]c_int) natsStatus {
    var json = arg_json;
    _ = &json;
    var fieldName = arg_fieldName;
    _ = &fieldName;
    ...
    if ((s == @as(c_uint, @bitCast(NATS_OK))) and (field == @as([*c]nats_JSONField, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0)))))))) {
        ...
        s = nats_JSONArrayAsInts(field.*.value.varr, array, arraySize);
    }
    return if (s == @as(c_uint, @bitCast(NATS_OK))) s else nats_updateErrStack(s, "nats_JSONGetArrayInt");
}
pub export fn nats_JSONArrayAsLongs(arg_arr: [*c]nats_JSONArray, arg_array: [*c][*c]i64, arg_arraySize: [*c]c_int) natsStatus {
    var arr = arg_arr;
    _ = &arr;
    var array = arg_array;
    _ = &array;
    ...
    var i: c_int = undefined;
    _ = &i;
    var values: [*c]i64 = @as([*c]i64, @ptrCast(@alignCast(calloc(@as(c_ulong, @bitCast(@as(c_long, arr.*.size))), @sizeOf(i64)))));
    _ = &values;
    if (values == @as([*c]i64, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) return nats_setErrorReal("./src/submodules/nats.c/src/util.c", "nats_JSONArrayAsLongs", @as(c_int, 1560), @as(c_uint, @bitCast(NATS_NO_MEMORY)), "%s", natsStatus_GetText(@as(c_uint, @bitCast(NATS_NO_MEMORY))));
    {
        i = 0;
        while (i < arr.*.size) : (i += 1) {
            var ptr: ?*anyopaque = @as(?*anyopaque, @ptrFromInt(@as(c_int, 0)));
            ...
            (blk: {
                const tmp = i;
                if (tmp >= 0) break :blk values + @as(usize, @intCast(tmp)) else break :blk values - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
            }).* = @as([*c]i64, @ptrCast(@alignCast(ptr))).*;
        }
    }
    array.* = values;
    arraySize.* = arr.*.size;
...
pub export fn nats_JSONGetArrayLong(arg_json: [*c]nats_JSON, arg_fieldName: [*c]const u8, arg_array: [*c][*c]i64, arg_arraySize: [*c]c_int) natsStatus {
    var json = arg_json;
    _ = &json;
    var fieldName = arg_fieldName;
    _ = &fieldName;
    ...
    if ((s == @as(c_uint, @bitCast(NATS_OK))) and (field == @as([*c]nats_JSONField, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0)))))))) {
        ...
        s = nats_JSONArrayAsLongs(field.*.value.varr, array, arraySize);
    }
    return if (s == @as(c_uint, @bitCast(NATS_OK))) s else nats_updateErrStack(s, "nats_JSONGetArrayLong");
}
pub export fn nats_JSONArrayAsULongs(arg_arr: [*c]nats_JSONArray, arg_array: [*c][*c]u64, arg_arraySize: [*c]c_int) natsStatus {
    var arr = arg_arr;
    _ = &arr;
    var array = arg_array;
    _ = &array;
    ...
    var i: c_int = undefined;
    _ = &i;
    var values: [*c]u64 = @as([*c]u64, @ptrCast(@alignCast(calloc(@as(c_ulong, @bitCast(@as(c_long, arr.*.size))), @sizeOf(u64)))));
    _ = &values;
    if (values == @as([*c]u64, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) return nats_setErrorReal("./src/submodules/nats.c/src/util.c", "nats_JSONArrayAsULongs", @as(c_int, 1572), @as(c_uint, @bitCast(NATS_NO_MEMORY)), "%s", natsStatus_GetText(@as(c_uint, @bitCast(NATS_NO_MEMORY))));
    {
        i = 0;
        while (i < arr.*.size) : (i += 1) {
            var ptr: ?*anyopaque = @as(?*anyopaque, @ptrFromInt(@as(c_int, 0)));
            ...
            (blk: {
                const tmp = i;
                if (tmp >= 0) break :blk values + @as(usize, @intCast(tmp)) else break :blk values - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
            }).* = @as([*c]u64, @ptrCast(@alignCast(ptr))).*;
        }
    }
    array.* = values;
    arraySize.* = arr.*.size;
...
pub export fn nats_JSONGetArrayULong(arg_json: [*c]nats_JSON, arg_fieldName: [*c]const u8, arg_array: [*c][*c]u64, arg_arraySize: [*c]c_int) natsStatus {
    var json = arg_json;
    _ = &json;
    var fieldName = arg_fieldName;
    _ = &fieldName;
    ...
    if ((s == @as(c_uint, @bitCast(NATS_OK))) and (field == @as([*c]nats_JSONField, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0)))))))) {
        ...
        s = nats_JSONArrayAsULongs(field.*.value.varr, array, arraySize);
    }
    return if (s == @as(c_uint, @bitCast(NATS_OK))) s else nats_updateErrStack(s, "nats_JSONGetArrayULong");
}
pub export fn nats_JSONArrayAsObjects(arg_arr: [*c]nats_JSONArray, arg_array: [*c][*c][*c]nats_JSON, arg_arraySize: [*c]c_int) natsStatus {
    var arr = arg_arr;
    _ = &arr;
    var array = arg_array;
    _ = &array;
    ...
    var i: c_int = undefined;
    _ = &i;
    var values: [*c][*c]nats_JSON = @as([*c][*c]nats_JSON, @ptrCast(@alignCast(calloc(@as(c_ulong, @bitCast(@as(c_long, arr.*.size))), @sizeOf([*c]nats_JSON)))));
    _ = &values;
    if (values == @as([*c][*c]nats_JSON, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) return nats_setErrorReal("./src/submodules/nats.c/src/util.c", "nats_JSONArrayAsObjects", @as(c_int, 1584), @as(c_uint, @bitCast(NATS_NO_MEMORY)), "%s", natsStatus_GetText(@as(c_uint, @bitCast(NATS_NO_MEMORY))));
    {
        i = 0;
        while (i < arr.*.size) : (i += 1) {
            (blk: {
                ...
                const tmp = i;
                if (tmp >= 0) break :blk @as([*c][*c]nats_JSON, @ptrCast(@alignCast(arr.*.values))) + @as(usize, @intCast(tmp)) else break :blk @as([*c][*c]nats_JSON, @ptrCast(@alignCast(arr.*.values))) - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
            }).*;
        }
    }
    array.* = values;
...
pub export fn nats_JSONGetArrayObject(arg_json: [*c]nats_JSON, arg_fieldName: [*c]const u8, arg_array: [*c][*c][*c]nats_JSON, arg_arraySize: [*c]c_int) natsStatus {
    var json = arg_json;
    _ = &json;
    var fieldName = arg_fieldName;
    _ = &fieldName;
    ...
    var field: [*c]nats_JSONField = null;
    _ = &field;
    s = nats_JSONGetArrayField(json, fieldName, @as(c_int, 8), &field);
    if ((s == @as(c_uint, @bitCast(NATS_OK))) and (field == @as([*c]nats_JSONField, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0)))))))) {
        array.* = null;
        arraySize.* = 0;
        return @as(c_uint, @bitCast(NATS_OK));
    } else if (s == @as(c_uint, @bitCast(NATS_OK))) {
        s = nats_JSONArrayAsObjects(field.*.value.varr, array, arraySize);
    }
    return if (s == @as(c_uint, @bitCast(NATS_OK))) s else nats_updateErrStack(s, "nats_JSONGetArrayObject");
}
pub export fn nats_JSONArrayAsArrays(arg_arr: [*c]nats_JSONArray, arg_array: [*c][*c][*c]nats_JSONArray, arg_arraySize: [*c]c_int) natsStatus {
    var arr = arg_arr;
    _ = &arr;
    var array = arg_array;
    _ = &array;
    ...
    var i: c_int = undefined;
    _ = &i;
    var values: [*c][*c]nats_JSONArray = @as([*c][*c]nats_JSONArray, @ptrCast(@alignCast(calloc(@as(c_ulong, @bitCast(@as(c_long, arr.*.size))), @sizeOf([*c]nats_JSONArray)))));
    _ = &values;
    if (values == @as([*c][*c]nats_JSONArray, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) return nats_setErrorReal("./src/submodules/nats.c/src/util.c", "nats_JSONArrayAsArrays", @as(c_int, 1596), @as(c_uint, @bitCast(NATS_NO_MEMORY)), "%s", natsStatus_GetText(@as(c_uint, @bitCast(NATS_NO_MEMORY))));
    {
        i = 0;
        while (i < arr.*.size) : (i += 1) {
            (blk: {
                ...
                const tmp = i;
                if (tmp >= 0) break :blk @as([*c][*c]nats_JSONArray, @ptrCast(@alignCast(arr.*.values))) + @as(usize, @intCast(tmp)) else break :blk @as([*c][*c]nats_JSONArray, @ptrCast(@alignCast(arr.*.values))) - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
            }).*;
        }
    }
    array.* = values;
...
pub export fn nats_JSONGetArrayArray(arg_json: [*c]nats_JSON, arg_fieldName: [*c]const u8, arg_array: [*c][*c][*c]nats_JSONArray, arg_arraySize: [*c]c_int) natsStatus {
    var json = arg_json;
    _ = &json;
    var fieldName = arg_fieldName;
    _ = &fieldName;
    ...
    var field: [*c]nats_JSONField = null;
    _ = &field;
    s = nats_JSONGetArrayField(json, fieldName, @as(c_int, 7), &field);
    if ((s == @as(c_uint, @bitCast(NATS_OK))) and (field == @as([*c]nats_JSONField, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0)))))))) {
        array.* = null;
        arraySize.* = 0;
        return @as(c_uint, @bitCast(NATS_OK));
    } else if (s == @as(c_uint, @bitCast(NATS_OK))) {
        s = nats_JSONArrayAsArrays(field.*.value.varr, array, arraySize);
    }
    return if (s == @as(c_uint, @bitCast(NATS_OK))) s else nats_updateErrStack(s, "nats_JSONGetArrayArray");
}
pub export fn nats_JSONRange(arg_json: [*c]nats_JSON, arg_expectedType: c_int, arg_expectedNumType: c_int, arg_cb: jsonRangeCB, arg_userInfo: ?*anyopaque) natsStatus {
    var json = arg_json;
    _ = &json;
    var expectedType = arg_expectedType;
    _ = &expectedType;
    var expectedNumType = arg_expectedNumType;
    _ = &expectedNumType;
    var cb = arg_cb;
    _ = &cb;
    ...
    while ((s == @as(c_uint, @bitCast(NATS_OK))) and (@as(c_int, @intFromBool(natsStrHashIter_Next(&iter, &fname, &val))) != 0)) {
        var f: [*c]nats_JSONField = @as([*c]nats_JSONField, @ptrCast(@alignCast(val)));
        _ = &f;
        if (f.*.typ != expectedType) {
            s = nats_setErrorReal("./src/submodules/nats.c/src/util.c", "nats_JSONRange", @as(c_int, 1620), @as(c_uint, @bitCast(NATS_ERR)), "field '%s': expected value type of %d, got %d", f.*.name, expectedType, f.*.typ);
        } else if ((f.*.typ == @as(c_int, 3)) and (f.*.numTyp != expectedNumType)) {
            s = nats_setErrorReal("./src/submodules/nats.c/src/util.c", "nats_JSONRange", @as(c_int, 1623), @as(c_uint, @bitCast(NATS_ERR)), "field '%s': expected numeric type of %d, got %d", f.*.name, expectedNumType, f.*.numTyp);
        } else {
            s = cb.?(userInfo, @as([*c]const u8, @ptrCast(@alignCast(f.*.name))), f);
        }
    }
    natsStrHashIter_Done(&iter);
    return if (s == @as(c_uint, @bitCast(NATS_OK))) s else nats_updateErrStack(s, "nats_JSONRange");
}
pub export fn nats_JSONDestroy(arg_json: [*c]nats_JSON) void {
    var json = arg_json;
    _ = &json;
    var iter: natsStrHashIter = undefined;
    _ = &iter;
    var field: ?*anyopaque = @as(?*anyopaque, @ptrFromInt(@as(c_int, 0)));
    _ = &field;
    if (json == @as([*c]nats_JSON, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) return;
    natsStrHashIter_Init(&iter, json.*.fields);
    while (natsStrHashIter_Next(&iter, null, &field)) {
        _ = natsStrHashIter_RemoveCurrent(&iter);
        _jsonFreeField(@as([*c]nats_JSONField, @ptrCast(@alignCast(field))));
    }
    natsStrHash_Destroy(json.*.fields);
    free(@as(?*anyopaque, @ptrCast(json.*.str)));
    free(@as(?*anyopaque, @ptrCast(json)));
}
pub export fn nats_EncodeTimeUTC(arg_buf: [*c]u8, arg_bufLen: usize, arg_timeUTC: i64) natsStatus {
    var buf = arg_buf;
    _ = &buf;
    ...
    var timeUTC = arg_timeUTC;
    _ = &timeUTC;
    var t: i64 = @divTrunc(timeUTC, @as(i64, @intFromFloat(1000000000.0)));
    _ = &t;
    var ns: i64 = timeUTC - (t * @as(i64, @intFromFloat(1000000000.0)));
    _ = &ns;
    var tp: struct_tm = undefined;
    _ = &tp;
    var n: c_int = undefined;
    _ = &n;
    if (bufLen < @as(usize, @bitCast(@as(c_long, @as(c_int, 36))))) return nats_setErrorReal("./src/submodules/nats.c/src/util.c", "nats_EncodeTimeUTC", @as(c_int, 1664), @as(c_uint, @bitCast(NATS_INVALID_ARG)), "buffer to encode UTC time is too small (%d), needs 36", @as(c_int, @bitCast(@as(c_uint, @truncate(bufLen)))));
    if (timeUTC == @as(i64, @bitCast(@as(c_long, @as(c_int, 0))))) {
        _ = snprintf(buf, bufLen, "%s", "0001-01-01T00:00:00Z");
        return @as(c_uint, @bitCast(NATS_OK));
    }
    _ = memset(@as(?*anyopaque, @ptrCast(&tp)), @as(c_int, 0), @sizeOf(struct_tm));
    _ = gmtime_r(@as([*c]const time_t, @ptrCast(@alignCast(&t))), &tp);
    n = @as(c_int, @bitCast(@as(c_uint, @truncate(strftime(buf, bufLen, "%FT%T", &tp)))));
    if (n == @as(c_int, 0)) return nats_setErrorReal("./src/submodules/nats.c/src/util.c", "nats_EncodeTimeUTC", @as(c_int, 1680), @as(c_uint, @bitCast(NATS_ERR)), "%s", natsStatus_GetText(@as(c_uint, @bitCast(NATS_ERR))));
    if (ns > @as(i64, @bitCast(@as(c_long, @as(c_int, 0))))) {
        var nsBuf: [15]u8 = undefined;
        _ = &nsBuf;
        var i: c_int = undefined;
        _ = &i;
        var nd: c_int = undefined;
        _ = &nd;
        nd = snprintf(@as([*c]u8, @ptrCast(@alignCast(&nsBuf))), @sizeOf([15]u8), ".%ld", ns);
        while ((nd > @as(c_int, 0)) and (@as(c_int, @bitCast(@as(c_uint, nsBuf[@as(c_uint, @intCast(nd - @as(c_int, 1)))]))) == @as(c_int, '0'))) {
            nd -= 1;
        }
        {
            i = 0;
            while (i < nd) : (i += 1) {
                (buf + @as(usize, @bitCast(@as(isize, @intCast(blk: {
                    const ref = &n;
                    const tmp = ref.*;
                    ref.* += 1;
                    break :blk tmp;
                }))))).* = nsBuf[@as(c_uint, @intCast(i))];
            }
        }
    }
    (buf + @as(usize, @bitCast(@as(isize, @intCast(n))))).* = 'Z';
    ((buf + @as(usize, @bitCast(@as(isize, @intCast(n))))) + @as(usize, @bitCast(@as(isize, @intCast(@as(c_int, 1)))))).* = '\x00';
    return @as(c_uint, @bitCast(NATS_OK));
}
pub export fn nats_Base32_Init() void {
    var alphabet: [*c]const u8 = "ABCDEFGHIJKLMNOPQRSTUVWXYZ234567";
    _ = &alphabet;
    var alphaLen: c_int = @as(c_int, @bitCast(@as(c_uint, @truncate(strlen(alphabet)))));
    _ = &alphaLen;
    var i: c_int = undefined;
    _ = &i;
    {
        ...
        while (i < @as(c_int, @bitCast(@as(c_uint, @truncate(@sizeOf([256]u8)))))) : (i += 1) {
            base32DecodeMap[@as(c_uint, @intCast(i))] = @as(u8, @bitCast(@as(i8, @truncate(@as(c_int, 4294967295)))));
        }
    }
    {
        i = 0;
        while (i < alphaLen) : (i += 1) {
            base32DecodeMap[@as(c_uint, @intCast(@as(c_int, @bitCast(@as(c_uint, (blk: {
                    const tmp = i;
                    if (tmp >= 0) break :blk alphabet + @as(usize, @intCast(tmp)) else break :blk alphabet - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
                }).*)))))] = @as(u8, @bitCast(@as(i8, @truncate(i))));
        }
    }
}
pub export fn nats_Base32_DecodeString(arg_src: [*c]const u8, arg_dst: [*c]u8, arg_dstMax: c_int, arg_dstLen: [*c]c_int) natsStatus {
    var src = arg_src;
    _ = &src;
    var dst = arg_dst;
    _ = &dst;
    var dstMax = arg_dstMax;
    _ = &dstMax;
    var dstLen = arg_dstLen;
    _ = &dstLen;
    var ptr: [*c]u8 = @as([*c]u8, @ptrCast(@volatileCast(@constCast(src))));
    _ = &ptr;
    var n: c_int = 0;
    _ = &n;
    var done: bool = @as(c_int, 0) != 0;
    _ = &done;
    var srcLen: c_int = @as(c_int, @bitCast(@as(c_uint, @truncate(strlen(src)))));
    _ = &srcLen;
    var remaining: c_int = srcLen;
    _ = &remaining;
    dstLen.* = 0;
    while (remaining > @as(c_int, 0)) {
        ...
        _ = &needs;
        {
            ...
            while (j < @as(c_int, 8)) {
                ...
                _ = &in;
                if (remaining == @as(c_int, 0)) {
                    dLen = j;
                    done = @as(c_int, 1) != 0;
                    break;
                }
                in = @as(c_int, @bitCast(@as(c_uint, ptr.*)));
                ptr += 1;
                remaining -= 1;
                dbuf[@as(c_uint, @intCast(j))] = base32DecodeMap[@as(c_uint, @intCast(in))];
                if (@as(c_int, @bitCast(@as(c_uint, dbuf[@as(c_uint, @intCast(j))]))) == @as(c_int, 4294967295)) return nats_setErrorReal("./src/submodules/nats.c/src/util.c", "nats_Base32_DecodeString", @as(c_int, 1751), @as(c_uint, @bitCast(NATS_ERR)), "base32: invalid data at location %d", srcLen - remaining);
                j += 1;
            }
        }
        needs = 0;
        ...
        if ((n + needs) > dstMax) return nats_setErrorReal("./src/submodules/nats.c/src/util.c", "nats_Base32_DecodeString", @as(c_int, 1765), @as(c_uint, @bitCast(NATS_INSUFFICIENT_BUFFER)), "based32: needs %d bytes, max is %d", n + needs, dstMax);
        if (dLen == @as(c_int, 8)) {
            dst[@as(c_uint, @intCast(@as(c_int, 4)))] = @as(u8, @bitCast(@as(i8, @truncate((@as(c_int, @bitCast(@as(c_uint, dbuf[@as(c_uint, @intCast(@as(c_int, 6)))]))) << @intCast(5)) | @as(c_int, @bitCast(@as(c_uint, dbuf[@as(c_uint, @intCast(@as(c_int, 7)))])))))));
        }
        if (dLen >= @as(c_int, 7)) {
            dst[@as(c_uint, @intCast(@as(c_int, 3)))] = @as(u8, @bitCast(@as(i8, @truncate(((@as(c_int, @bitCast(@as(c_uint, dbuf[@as(c_uint, @intCast(@as(c_int, 4)))]))) << @intCast(7)) | (@as(c_int, @bitCast(@as(c_uint, dbuf[@as(c_uint, @intCast(@as(c_int, 5)))]))) << @intCast(2))) | (@as(c_int, @bitCast(@as(c_uint, dbuf[@as(c_uint, @intCast(@as(c_int, 6)))]))) >> @intCast(3))))));
        }
        if (dLen >= @as(c_int, 5)) {
            dst[@as(c_uint, @intCast(@as(c_int, 2)))] = @as(u8, @bitCast(@as(i8, @truncate((@as(c_int, @bitCast(@as(c_uint, dbuf[@as(c_uint, @intCast(@as(c_int, 3)))]))) << @intCast(4)) | (@as(c_int, @bitCast(@as(c_uint, dbuf[@as(c_uint, @intCast(@as(c_int, 4)))]))) >> @intCast(1))))));
        }
        if (dLen >= @as(c_int, 4)) {
            dst[@as(c_uint, @intCast(@as(c_int, 1)))] = @as(u8, @bitCast(@as(i8, @truncate(((@as(c_int, @bitCast(@as(c_uint, dbuf[@as(c_uint, @intCast(@as(c_int, 1)))]))) << @intCast(6)) | (@as(c_int, @bitCast(@as(c_uint, dbuf[@as(c_uint, @intCast(@as(c_int, 2)))]))) << @intCast(1))) | (@as(c_int, @bitCast(@as(c_uint, dbuf[@as(c_uint, @intCast(@as(c_int, 3)))]))) >> @intCast(4))))));
        }
        if (dLen >= @as(c_int, 2)) {
            dst[@as(c_uint, @intCast(@as(c_int, 0)))] = @as(u8, @bitCast(@as(i8, @truncate((@as(c_int, @bitCast(@as(c_uint, dbuf[@as(c_uint, @intCast(@as(c_int, 0)))]))) << @intCast(3)) | (@as(c_int, @bitCast(@as(c_uint, dbuf[@as(c_uint, @intCast(@as(c_int, 1)))]))) >> @intCast(2))))));
        }
        n += needs;
        if (!done) {
            dst += @as(usize, @bitCast(@as(isize, @intCast(@as(c_int, 5)))));
        }
    }
    dstLen.* = n;
    return @as(c_uint, @bitCast(NATS_OK));
}
pub export fn nats_Base64RawURL_EncodeString(arg_src: [*c]const u8, arg_srcLen: c_int, arg_pDest: [*c][*c]u8) natsStatus {
    var src = arg_src;
    _ = &src;
    var srcLen = arg_srcLen;
    _ = &srcLen;
    var pDest = arg_pDest;
    _ = &pDest;
    var s: natsStatus = _base64Encode(base64EncodeURL, @as(c_int, 0) != 0, src, srcLen, pDest);
    _ = &s;
    return if (s == @as(c_uint, @bitCast(NATS_OK))) s else nats_updateErrStack(s, "nats_Base64RawURL_EncodeString");
}
pub export fn nats_Base64_Encode(arg_src: [*c]const u8, arg_srcLen: c_int, arg_pDest: [*c][*c]u8) natsStatus {
    var src = arg_src;
    _ = &src;
    var srcLen = arg_srcLen;
    _ = &srcLen;
    var pDest = arg_pDest;
    _ = &pDest;
    var s: natsStatus = _base64Encode(base64EncodeStd, @as(c_int, 1) != 0, src, srcLen, pDest);
    _ = &s;
    return if (s == @as(c_uint, @bitCast(NATS_OK))) s else nats_updateErrStack(s, "nats_Base64_Encode");
}
pub export fn nats_Base64_DecodeLen(arg_src: [*c]const u8, arg_srcLen: [*c]c_int, arg_dstLen: [*c]c_int) natsStatus {
    var src = arg_src;
    _ = &src;
    var srcLen = arg_srcLen;
    _ = &srcLen;
    ...
    _ = &l;
    var dl: c_int = undefined;
    _ = &dl;
    var i: c_int = undefined;
    _ = &i;
    if ((if ((src == @as([*c]const u8, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) or (@as(c_int, @bitCast(@as(c_uint, src[@as(c_uint, @intCast(@as(c_int, 0)))]))) == @as(c_int, '\x00'))) @as(c_int, 1) else @as(c_int, 0)) != 0) return nats_setErrorReal("./src/submodules/nats.c/src/util.c", "nats_Base64_DecodeLen", @as(c_int, 1896), @as(c_uint, @bitCast(NATS_INVALID_ARG)), "%s", "base64 content cannot be empty");
    l = @as(c_int, @bitCast(@as(c_uint, @truncate(strlen(src)))));
    if (@import("std").zig.c_translation.signedRemainder(l, @as(c_int, 4)) != @as(c_int, 0)) return nats_setErrorReal("./src/submodules/nats.c/src/util.c", "nats_Base64_DecodeLen", @as(c_int, 1900), @as(c_uint, @bitCast(NATS_INVALID_ARG)), "invalid base64 length: %d", l);
    dl = @divTrunc(l, @as(c_int, 4)) * @as(c_int, 3);
    {
        i = 0;
        while (i < l) : (i += 1) {
            if (!_base64IsValidChar((blk: {
                const tmp = i;
                if (tmp >= 0) break :blk src + @as(usize, @intCast(tmp)) else break :blk src - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
            }).*, i >= (l - @as(c_int, 2)))) return nats_setErrorReal("./src/submodules/nats.c/src/util.c", "nats_Base64_DecodeLen", @as(c_int, 1906), @as(c_uint, @bitCast(NATS_INVALID_ARG)), "invalid base64 character: '%c'", @as(c_int, @bitCast(@as(c_uint, (blk: {
                const tmp = i;
                if (tmp >= 0) break :blk src + @as(usize, @intCast(tmp)) else break :blk src - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
            }).*))));
            if (@as(c_int, @bitCast(@as(c_uint, (blk: {
                const tmp = i;
                if (tmp >= 0) break :blk src + @as(usize, @intCast(tmp)) else break :blk src - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
            }).*))) == @as(c_int, @bitCast(@as(c_uint, base64Padding)))) {
                dl -= 1;
            }
        }
    }
...
pub export fn nats_Base64_DecodeInPlace(arg_src: [*c]const u8, arg_l: c_int, arg_dst: [*c]u8) void {
    var src = arg_src;
    _ = &src;
    var l = arg_l;
    _ = &l;
    ...
    _ = &v;
    {
        ...
        while (i < l) : (_ = blk: {
            ...
            v = base64Ints[@as(c_uint, @intCast(@as(c_int, @bitCast(@as(c_uint, (blk: {
                    const tmp = i;
                    if (tmp >= 0) break :blk src + @as(usize, @intCast(tmp)) else break :blk src - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
                }).*))) - @as(c_int, 43)))];
            v = (v << @intCast(6)) | base64Ints[@as(c_uint, @intCast(@as(c_int, @bitCast(@as(c_uint, (blk: {
                    const tmp = i + @as(c_int, 1);
                    if (tmp >= 0) break :blk src + @as(usize, @intCast(tmp)) else break :blk src - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
                }).*))) - @as(c_int, 43)))];
            v = if (@as(c_int, @bitCast(@as(c_uint, (blk: {
                const tmp = i + @as(c_int, 2);
                if (tmp >= 0) break :blk src + @as(usize, @intCast(tmp)) else break :blk src - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
            }).*))) == @as(c_int, @bitCast(@as(c_uint, base64Padding)))) v << @intCast(6) else (v << @intCast(6)) | base64Ints[@as(c_uint, @intCast(@as(c_int, @bitCast(@as(c_uint, (blk: {
                    const tmp = i + @as(c_int, 2);
                    if (tmp >= 0) break :blk src + @as(usize, @intCast(tmp)) else break :blk src - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
                }).*))) - @as(c_int, 43)))];
            v = if (@as(c_int, @bitCast(@as(c_uint, (blk: {
            ...
            }).* = @as(u8, @bitCast(@as(i8, @truncate((v >> @intCast(16)) & @as(c_int, 255)))));
            if (@as(c_int, @bitCast(@as(c_uint, (blk: {
                const tmp = i + @as(c_int, 2);
                if (tmp >= 0) break :blk src + @as(usize, @intCast(tmp)) else break :blk src - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
            }).*))) != @as(c_int, @bitCast(@as(c_uint, base64Padding)))) {
                (blk: {
                    ...
                    if (tmp >= 0) break :blk dst + @as(usize, @intCast(tmp)) else break :blk dst - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
                }).* = @as(u8, @bitCast(@as(i8, @truncate((v >> @intCast(8)) & @as(c_int, 255)))));
            }
            if (@as(c_int, @bitCast(@as(c_uint, (blk: {
                const tmp = i + @as(c_int, 3);
                if (tmp >= 0) break :blk src + @as(usize, @intCast(tmp)) else break :blk src - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
                ...
                (blk: {
                    const tmp = j + @as(c_int, 2);
                    if (tmp >= 0) break :blk dst + @as(usize, @intCast(tmp)) else break :blk dst - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
                }).* = @as(u8, @bitCast(@as(i8, @truncate(v & @as(c_int, 255)))));
            }
        }
    }
}
pub export fn nats_Base64_Decode(arg_src: [*c]const u8, arg_dst: [*c][*c]u8, arg_dstLen: [*c]c_int) natsStatus {
    var src = arg_src;
    _ = &src;
    var dst = arg_dst;
    _ = &dst;
    ...
    if (s == @as(c_uint, @bitCast(NATS_OK))) {
        dst.* = @as([*c]u8, @ptrCast(@alignCast(malloc(@as(c_ulong, @bitCast(@as(c_long, dstLen.*)))))));
        if (dst.* == @as([*c]u8, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) {
            dstLen.* = 0;
            return nats_setErrorReal("./src/submodules/nats.c/src/util.c", "nats_Base64_Decode", @as(c_int, 1953), @as(c_uint, @bitCast(NATS_NO_MEMORY)), "%s", natsStatus_GetText(@as(c_uint, @bitCast(NATS_NO_MEMORY))));
        }
        nats_Base64_DecodeInPlace(src, sl, dst.*);
    }
    return if (s == @as(c_uint, @bitCast(NATS_OK))) s else nats_updateErrStack(s, "nats_Base64_Decode");
}
pub export fn nats_CRC16_Compute(arg_data: [*c]u8, arg_len: c_int) u16 {
    var data = arg_data;
    _ = &data;
    var len = arg_len;
    _ = &len;
    ...
    _ = &i;
    {
        i = 0;
        while (i < len) : (i += 1) {
            crc = @as(u16, @bitCast(@as(c_short, @truncate(((@as(c_int, @bitCast(@as(c_uint, crc))) << @intCast(8)) & @as(c_int, 65535)) ^ @as(c_int, @bitCast(@as(c_uint, crc16tab[@as(c_uint, @intCast(((@as(c_int, @bitCast(@as(c_uint, crc))) >> @intCast(8)) ^ @as(c_int, @bitCast(@as(c_uint, @as(u16, @bitCast(@as(c_ushort, (blk: {
                    const tmp = i;
...
pub export fn nats_CRC16_Validate(arg_data: [*c]u8, arg_len: c_int, arg_expected: u16) bool {
    var data = arg_data;
    _ = &data;
    var len = arg_len;
    _ = &len;
    ...
    _ = &expected;
    var crc: u16 = nats_CRC16_Compute(data, len);
    _ = &crc;
    return @as(c_int, @bitCast(@as(c_uint, crc))) == @as(c_int, @bitCast(@as(c_uint, expected)));
}
pub export fn nats_ReadFile(arg_buffer: [*c][*c]natsBuffer, arg_initBufSize: c_int, arg_fn: [*c]const u8) natsStatus {
    var buffer = arg_buffer;
    _ = &buffer;
    var initBufSize = arg_initBufSize;
    _ = &initBufSize;
    var @"fn" = arg_fn;
    _ = &@"fn";
    var s: natsStatus = undefined;
    ...
    var total: c_int = 0;
    _ = &total;
    if ((initBufSize <= @as(c_int, 0)) or ((if ((@"fn" == @as([*c]const u8, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) or (@as(c_int, @bitCast(@as(c_uint, @"fn"[@as(c_uint, @intCast(@as(c_int, 0)))]))) == @as(c_int, '\x00'))) @as(c_int, 1) else @as(c_int, 0)) != 0)) return nats_setErrorReal("./src/submodules/nats.c/src/util.c", "nats_ReadFile", @as(c_int, 1991), @as(c_uint, @bitCast(NATS_INVALID_ARG)), "%s", natsStatus_GetText(@as(c_uint, @bitCast(NATS_INVALID_ARG))));
    f = fopen(@"fn", "r");
    if (f == @as([*c]FILE, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) return nats_setErrorReal("./src/submodules/nats.c/src/util.c", "nats_ReadFile", @as(c_int, 1995), @as(c_uint, @bitCast(NATS_ERR)), "error opening file '%s': %s", @"fn", strerror(__errno_location().*));
    s = natsBuf_Create(&buf, initBufSize);
    if (s == @as(c_uint, @bitCast(NATS_OK))) {
        ptr = buf.*.data;
    }
    while (s == @as(c_uint, @bitCast(NATS_OK))) {
        var r: c_int = @as(c_int, @bitCast(@as(c_uint, @truncate(fread(@as(?*anyopaque, @ptrCast(ptr)), @as(c_ulong, @bitCast(@as(c_long, @as(c_int, 1)))), @as(usize, @bitCast(@as(c_long, buf.*.capacity - buf.*.len))), f)))));
        _ = &r;
        if (r == @as(c_int, 0)) break;
        total += r;
        natsBuf_MoveTo(buf, total);
        if ((buf.*.capacity - buf.*.len) == @as(c_int, 0)) {
            s = natsBuf_Expand(buf, buf.*.capacity * @as(c_int, 2));
        }
        if (s == @as(c_uint, @bitCast(NATS_OK))) {
            ptr = buf.*.data + @as(usize, @bitCast(@as(isize, @intCast(total))));
        }
    }
    if (s != @as(c_uint, @bitCast(NATS_OK))) {
        _ = fclose(f);
    } else if (fclose(f) != @as(c_int, 0)) {
        s = nats_setErrorReal("./src/submodules/nats.c/src/util.c", "nats_ReadFile", @as(c_int, 2019), @as(c_uint, @bitCast(NATS_ERR)), "error closing file '%s': '%s", @"fn", strerror(__errno_location().*));
    }
    if (s == @as(c_uint, @bitCast(NATS_OK))) {
    ...
    if (s == @as(c_uint, @bitCast(NATS_OK))) {
        buffer.* = buf;
    } else if (buf != @as([*c]natsBuffer, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) {
        _ = memset(@as(?*anyopaque, @ptrCast(buf.*.data)), @as(c_int, 0), @as(c_ulong, @bitCast(@as(c_long, buf.*.capacity))));
        natsBuf_Destroy(buf);
    }
    return if (s == @as(c_uint, @bitCast(NATS_OK))) s else nats_updateErrStack(s, "nats_ReadFile");
}
pub export fn nats_HostIsIP(arg_host: [*c]const u8) bool {
    var host = arg_host;
    _ = &host;
    var hint: struct_addrinfo = undefined;
    _ = &hint;
    var res: [*c]struct_addrinfo = null;
    _ = &res;
    var isIP: bool = @as(c_int, 1) != 0;
    _ = &isIP;
    _ = memset(@as(?*anyopaque, @ptrCast(&hint)), @as(c_int, '\x00'), @sizeOf(struct_addrinfo));
    hint.ai_family = 0;
    hint.ai_flags = 4;
    if (getaddrinfo(host, null, &hint, &res) != @as(c_int, 0)) {
        isIP = @as(c_int, 0) != 0;
    }
    nats_FreeAddrInfo(res);
    return isIP;
}
pub export fn nats_GetJWTOrSeed(arg_val: [*c][*c]u8, arg_content: [*c]const u8, arg_item: c_int) natsStatus {
    var val = arg_val;
    _ = &val;
    ...
    var s: natsStatus = @as(c_uint, @bitCast(NATS_OK));
    _ = &s;
    var next: [*c]const u8 = content;
    _ = &next;
    var line: [*c]const u8 = null;
    _ = &line;
    var lineLen: c_int = 0;
    _ = &lineLen;
    var curItem: c_int = 0;
    _ = &curItem;
    var saved: [*c]const u8 = null;
    _ = &saved;
    var savedLen: c_int = 0;
    _ = &savedLen;
    while ((blk: {
        const tmp = _scan_line(&line, &next);
        lineLen = tmp;
        break :blk tmp;
    }) > @as(c_int, 0)) {
        if (_isLineAnHeader(line, lineLen)) {
            savedLen = _scan_line(&saved, &next);
            if (savedLen == @as(c_int, 0)) break;
            lineLen = _scan_line(&line, &next);
            if (_isLineAnHeader(line, lineLen)) {
                if (curItem == item) {
                    val.* = @as([*c]u8, @ptrCast(@alignCast(calloc(@as(c_ulong, @bitCast(@as(c_long, savedLen + @as(c_int, 1)))), @as(c_ulong, @bitCast(@as(c_long, @as(c_int, 1))))))));
                    if (val.* == @as([*c]u8, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) {
                        s = nats_setErrorReal("./src/submodules/nats.c/src/util.c", "nats_GetJWTOrSeed", @as(c_int, 2182), @as(c_uint, @bitCast(NATS_NO_MEMORY)), "%s", natsStatus_GetText(@as(c_uint, @bitCast(NATS_NO_MEMORY))));
                    } else {
                        _ = memcpy(@as(?*anyopaque, @ptrCast(val.*)), @as(?*const anyopaque, @ptrCast(saved)), @as(c_ulong, @bitCast(@as(c_long, savedLen))));
                    }
                    break;
                } else if ((blk: {
                    const ref = &curItem;
    ...
    if ((s == @as(c_uint, @bitCast(NATS_OK))) and (val.* == @as([*c]u8, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0)))))))) return @as(c_uint, @bitCast(NATS_NOT_FOUND));
    return if (s == @as(c_uint, @bitCast(NATS_OK))) s else nats_updateErrStack(s, "nats_GetJWTOrSeed");
}
pub export fn nats_FreeAddrInfo(arg_res: [*c]struct_addrinfo) void {
    var res = arg_res;
    _ = &res;
    if (res == @as([*c]struct_addrinfo, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) return;
    freeaddrinfo(res);
}
pub export fn nats_marshalLong(arg_buf: [*c]natsBuffer, arg_comma: bool, arg_fieldName: [*c]const u8, arg_lval: i64) natsStatus {
    var buf = arg_buf;
    _ = &buf;
    var comma = arg_comma;
    _ = &comma;
    ...
    var lval = arg_lval;
    _ = &lval;
    var s: natsStatus = _marshalLongVal(buf, comma, fieldName, @as(c_int, 1) != 0, lval, @as(u64, @bitCast(@as(c_long, @as(c_int, 0)))));
    _ = &s;
    return if (s == @as(c_uint, @bitCast(NATS_OK))) s else nats_updateErrStack(s, "nats_marshalLong");
}
pub export fn nats_marshalULong(arg_buf: [*c]natsBuffer, arg_comma: bool, arg_fieldName: [*c]const u8, arg_uval: u64) natsStatus {
    var buf = arg_buf;
    _ = &buf;
    var comma = arg_comma;
    _ = &comma;
    ...
    var uval = arg_uval;
    _ = &uval;
    var s: natsStatus = _marshalLongVal(buf, comma, fieldName, @as(c_int, 0) != 0, @as(i64, @bitCast(@as(c_long, @as(c_int, 0)))), uval);
    _ = &s;
    return if (s == @as(c_uint, @bitCast(NATS_OK))) s else nats_updateErrStack(s, "nats_marshalULong");
}
pub export fn nats_marshalDuration(arg_out_buf: [*c]natsBuffer, arg_comma: bool, arg_field_name: [*c]const u8, arg_d: i64) natsStatus {
    var out_buf = arg_out_buf;
    _ = &out_buf;
    var comma = arg_comma;
    _ = &comma;
    var field_name = arg_field_name;
    _ = &field_name;
    var d = arg_d;
    _ = &d;
    ...
    var w: c_int = 32;
    _ = &w;
    var neg: bool = d < @as(i64, @bitCast(@as(c_long, @as(c_int, 0))));
    _ = &neg;
    var u: u64 = @as(u64, @bitCast(if (@as(c_int, @intFromBool(neg)) != 0) -d else d));
    _ = &u;
    var prec: c_int = undefined;
    _ = &prec;
    var s: natsStatus = @as(c_uint, @bitCast(NATS_OK));
    _ = &s;
    var start: [*c]const u8 = if (@as(c_int, @intFromBool(comma)) != 0) ",\"" else "\"";
    _ = &start;
    if (u < @as(u64, @bitCast(@as(c_long, @as(c_int, 1000000000))))) {
        w -= 1;
        buf[@as(c_uint, @intCast(w))] = 's';
        w -= 1;
        if (u == @as(u64, @bitCast(@as(c_long, @as(c_int, 0))))) {
            s = natsBuf_Append(out_buf, start, -@as(c_int, 1));
            if (s == @as(c_uint, @bitCast(NATS_OK))) {
                s = natsBuf_Append(out_buf, field_name, -@as(c_int, 1));
            }
            if (s == @as(c_uint, @bitCast(NATS_OK))) {
                s = natsBuf_Append(out_buf, "\":\"0s\"", -@as(c_int, 1));
            }
            return if (s == @as(c_uint, @bitCast(NATS_OK))) s else nats_updateErrStack(s, "nats_marshalDuration");
        } else if (u < @as(u64, @bitCast(@as(c_long, @as(c_int, 1000))))) {
            prec = 0;
            buf[@as(c_uint, @intCast(w))] = 'n';
        } else if (u < @as(u64, @bitCast(@as(c_long, @as(c_int, 1000000))))) {
            prec = 3;
            buf[@as(c_uint, @intCast(w))] = @as(u8, @bitCast(@as(i8, @truncate(@as(c_int, 4294967221)))));
            w -= 1;
            buf[@as(c_uint, @intCast(w))] = @as(u8, @bitCast(@as(i8, @truncate(@as(c_int, 4294967234)))));
        } else {
            prec = 6;
            buf[@as(c_uint, @intCast(w))] = 'm';
        }
        fmt_frac(@as([*c]u8, @ptrCast(@alignCast(&buf))), w, u, prec, &w, &u);
        w = fmt_int(@as([*c]u8, @ptrCast(@alignCast(&buf))), w, u);
    } else {
        w -= 1;
        buf[@as(c_uint, @intCast(w))] = 's';
        fmt_frac(@as([*c]u8, @ptrCast(@alignCast(&buf))), w, u, @as(c_int, 9), &w, &u);
        w = fmt_int(@as([*c]u8, @ptrCast(@alignCast(&buf))), w, u % @as(u64, @bitCast(@as(c_long, @as(c_int, 60)))));
        u /= @as(u64, @bitCast(@as(c_long, @as(c_int, 60))));
        if (u > @as(u64, @bitCast(@as(c_long, @as(c_int, 0))))) {
            w -= 1;
            buf[@as(c_uint, @intCast(w))] = 'm';
            w = fmt_int(@as([*c]u8, @ptrCast(@alignCast(&buf))), w, u % @as(u64, @bitCast(@as(c_long, @as(c_int, 60)))));
    ...
    if (s == @as(c_uint, @bitCast(NATS_OK))) {
        s = natsBuf_Append(out_buf, "\":\"", -@as(c_int, 1));
    }
    if (s == @as(c_uint, @bitCast(NATS_OK))) {
        s = natsBuf_Append(out_buf, @as([*c]u8, @ptrCast(@alignCast(&buf))) + @as(usize, @bitCast(@as(isize, @intCast(w)))), @as(c_int, @bitCast(@as(c_uint, @truncate(@sizeOf([32]u8) -% @as(c_ulong, @bitCast(@as(c_long, w))))))));
    }
    if (s == @as(c_uint, @bitCast(NATS_OK))) {
        s = natsBuf_Append(out_buf, "\"", -@as(c_int, 1));
    }
...
pub export fn nats_marshalMetadata(arg_buf: [*c]natsBuffer, arg_comma: bool, arg_fieldName: [*c]const u8, arg_md: natsMetadata) natsStatus {
    var buf = arg_buf;
    _ = &buf;
    var comma = arg_comma;
    _ = &comma;
    ...
    var start: [*c]const u8 = if (@as(c_int, @intFromBool(comma)) != 0) ",\"" else "\"";
    _ = &start;
    if (md.Count <= @as(c_int, 0)) return @as(c_uint, @bitCast(NATS_OK));
    if (s == @as(c_uint, @bitCast(NATS_OK))) {
        s = natsBuf_Append(buf, start, -@as(c_int, 1));
    }
    if (s == @as(c_uint, @bitCast(NATS_OK))) {
        s = natsBuf_Append(buf, fieldName, -@as(c_int, 1));
    }
    if (s == @as(c_uint, @bitCast(NATS_OK))) {
        s = natsBuf_Append(buf, "\":{", @as(c_int, 3));
    }
    {
        i = 0;
        while ((s == @as(c_uint, @bitCast(NATS_OK))) and (i < md.Count)) : (i += 1) {
            if (s == @as(c_uint, @bitCast(NATS_OK))) {
            ...
            if (s == @as(c_uint, @bitCast(NATS_OK))) {
                s = natsBuf_Append(buf, (blk: {
                    const tmp = i * @as(c_int, 2);
                    if (tmp >= 0) break :blk md.List + @as(usize, @intCast(tmp)) else break :blk md.List - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
                }).*, -@as(c_int, 1));
            }
            if (s == @as(c_uint, @bitCast(NATS_OK))) {
                s = natsBuf_Append(buf, "\":\"", @as(c_int, 3));
            ...
            if (i != (md.Count - @as(c_int, 1))) if (s == @as(c_uint, @bitCast(NATS_OK))) {
                s = natsBuf_AppendByte(buf, @as(u8, @bitCast(@as(i8, @truncate(@as(c_int, ','))))));
            };
        }
    }
...
pub export fn nats_unmarshalMetadata(arg_json: [*c]nats_JSON, arg_fieldName: [*c]const u8, arg_md: [*c]natsMetadata) natsStatus {
    var json = arg_json;
    _ = &json;
    var fieldName = arg_fieldName;
    _ = &fieldName;
    ...
    var s: natsStatus = @as(c_uint, @bitCast(NATS_OK));
    _ = &s;
    var mdJSON: [*c]nats_JSON = null;
    _ = &mdJSON;
    var n: c_int = undefined;
    _ = &n;
    md.*.List = null;
    md.*.Count = 0;
    if (json == @as([*c]nats_JSON, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) return @as(c_uint, @bitCast(NATS_OK));
    s = nats_JSONGetObject(json, fieldName, &mdJSON);
    if ((s != @as(c_uint, @bitCast(NATS_OK))) or (mdJSON == @as([*c]nats_JSON, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0)))))))) return @as(c_uint, @bitCast(NATS_OK));
    n = mdJSON.*.fields.*.used;
    md.*.List = @as([*c][*c]const u8, @ptrCast(@alignCast(calloc(@as(c_ulong, @bitCast(@as(c_long, n * @as(c_int, 2)))), @sizeOf([*c]u8)))));
    if (md.*.List == @as([*c][*c]const u8, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) {
        s = nats_setErrorReal("./src/submodules/nats.c/src/util.c", "nats_unmarshalMetadata", @as(c_int, 2504), @as(c_uint, @bitCast(NATS_NO_MEMORY)), "%s", natsStatus_GetText(@as(c_uint, @bitCast(NATS_NO_MEMORY))));
    }
    if (s == @as(c_uint, @bitCast(NATS_OK))) {
        s = nats_JSONRange(mdJSON, @as(c_int, 1), @as(c_int, 0), &_addMD, @as(?*anyopaque, @ptrCast(md)));
    }
    return s;
}
pub export fn nats_cloneMetadata(arg_clone_1: [*c]natsMetadata, arg_md: natsMetadata) natsStatus {
    ...
    clone_1.*.List = null;
    if (md.Count == @as(c_int, 0)) return @as(c_uint, @bitCast(NATS_OK));
    n = md.Count * @as(c_int, 2);
    list = @as([*c][*c]u8, @ptrCast(@alignCast(calloc(@as(c_ulong, @bitCast(@as(c_long, n))), @sizeOf([*c]u8)))));
    if (list == @as([*c][*c]u8, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) {
        s = nats_setErrorReal("./src/submodules/nats.c/src/util.c", "nats_cloneMetadata", @as(c_int, 2526), @as(c_uint, @bitCast(NATS_NO_MEMORY)), "%s", natsStatus_GetText(@as(c_uint, @bitCast(NATS_NO_MEMORY))));
    }
    {
        i = 0;
        while ((s == @as(c_uint, @bitCast(NATS_OK))) and (i < n)) : (i += 1) {
            (blk: {
                const tmp = i;
            ...
            if ((blk: {
                ...
                s = nats_setErrorReal("./src/submodules/nats.c/src/util.c", "nats_cloneMetadata", @as(c_int, 2532), @as(c_uint, @bitCast(NATS_NO_MEMORY)), "%s", natsStatus_GetText(@as(c_uint, @bitCast(NATS_NO_MEMORY))));
            }
        }
    }
    if (s == @as(c_uint, @bitCast(NATS_OK))) {
        clone_1.*.List = @as([*c][*c]const u8, @ptrCast(@alignCast(list)));
        clone_1.*.Count = md.Count;
    } else {
        {
            _ = blk: {
                n = i;
...
pub export fn nats_freeMetadata(arg_md: [*c]natsMetadata) void {
    var md = arg_md;
    _ = &md;
    if (md == @as([*c]natsMetadata, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) return;
    {
        var i: c_int = 0;
        _ = &i;
        while (i < (md.*.Count * @as(c_int, 2))) : (i += 1) {
    ...
    free(@as(?*anyopaque, @ptrCast(@as([*c]u8, @ptrCast(@alignCast(md.*.List))))));
    md.*.List = null;
    md.*.Count = 0;
}
pub export fn nats_IsSubjectValid(arg_subject: [*c]const u8, arg_wcAllowed: bool) bool {
    var subject = arg_subject;
    _ = &subject;
    var wcAllowed = arg_wcAllowed;
    _ = &wcAllowed;
    var i: c_int = 0;
    _ = &i;
    var len: c_int = 0;
    _ = &len;
    var lastDot: c_int = -@as(c_int, 1);
    _ = &lastDot;
    var c: u8 = undefined;
    _ = &c;
    if ((if ((subject == @as([*c]const u8, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) or (@as(c_int, @bitCast(@as(c_uint, subject[@as(c_uint, @intCast(@as(c_int, 0)))]))) == @as(c_int, '\x00'))) @as(c_int, 1) else @as(c_int, 0)) != 0) return @as(c_int, 0) != 0;
    len = @as(c_int, @bitCast(@as(c_uint, @truncate(strlen(subject)))));
    {
        i = 0;
        while (i < len) : (i += 1) {
            c = (blk: {
                const tmp = i;
                if (tmp >= 0) break :blk subject + @as(usize, @intCast(tmp)) else break :blk subject - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
            }).*;
            if ((@as(c_int, @bitCast(@as(c_uint, (blk: {
                const tmp = @as(c_int, @bitCast(@as(c_uint, @as(u8, @bitCast(c)))));
                if (tmp >= 0) break :blk __ctype_b_loc().* + @as(usize, @intCast(tmp)) else break :blk __ctype_b_loc().* - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
            ...
            if (@as(c_int, @bitCast(@as(c_uint, c))) == @as(c_int, '.')) {
                if ((i == (len - @as(c_int, 1))) or (i == (lastDot + @as(c_int, 1)))) return @as(c_int, 0) != 0;
                if (i == (lastDot + @as(c_int, 2))) {
                    var prevToken: u8 = (blk: {
                        const tmp = i - @as(c_int, 1);
                        if (tmp >= 0) break :blk subject + @as(usize, @intCast(tmp)) else break :blk subject - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
                    }).*;
                    _ = &prevToken;
                    if (@as(c_int, @bitCast(@as(c_uint, prevToken))) == @as(c_int, '>')) return @as(c_int, 0) != 0 else if (!wcAllowed and (@as(c_int, @bitCast(@as(c_uint, prevToken))) == @as(c_int, '*'))) return @as(c_int, 0) != 0;
                }
                lastDot = i;
            }
            if (i == (len - @as(c_int, 1))) {
                if (((@as(c_int, @bitCast(@as(c_uint, c))) == @as(c_int, '>')) or (@as(c_int, @bitCast(@as(c_uint, c))) == @as(c_int, '*'))) and (i == (lastDot + @as(c_int, 1)))) return wcAllowed;
            }
        }
    }
    return @as(c_int, 1) != 0;
}
pub export fn nats_parseTime(arg_orgStr: [*c]u8, arg_timeUTC: [*c]i64) natsStatus {
    var orgStr = arg_orgStr;
    _ = &orgStr;
    var timeUTC = arg_timeUTC;
    _ = &timeUTC;
    var s: natsStatus = @as(c_uint, @bitCast(NATS_OK));
    _ = &s;
    var dotPos: [*c]u8 = null;
    _ = &dotPos;
    var utcOff: [7]u8 = [1]u8{
        '\x00',
    } ++ [1]u8{0} ** 6;
    _ = &utcOff;
    var nanosecs: i64 = 0;
    ...
    var p: [*c]u8 = null;
    _ = &p;
    var timeStr: [42]u8 = [1]u8{
        '\x00',
    } ++ [1]u8{0} ** 41;
    _ = &timeStr;
    var tmpStr: [36]u8 = [1]u8{
        '\x00',
    } ++ [1]u8{0} ** 35;
    _ = &tmpStr;
    var str: [*c]u8 = null;
    ...
    var tp: struct_tm = undefined;
    _ = &tp;
    if (strcmp(orgStr, "0001-01-01T00:00:00Z") == @as(c_int, 0)) {
        timeUTC.* = 0;
        return @as(c_uint, @bitCast(NATS_OK));
    }
    l = @as(c_int, @bitCast(@as(c_uint, @truncate(strlen(orgStr)))));
    if ((l < @as(c_int, 20)) or (l > @as(c_int, @bitCast(@as(c_uint, @truncate(@sizeOf([36]u8) -% @as(c_ulong, @bitCast(@as(c_long, @as(c_int, 1)))))))))) {
        if (l < @as(c_int, 20)) {
            s = nats_setErrorReal("./src/submodules/nats.c/src/util.c", "nats_parseTime", @as(c_int, 1323), @as(c_uint, @bitCast(NATS_INVALID_ARG)), "time '%s' too small", orgStr);
        } else {
            s = nats_setErrorReal("./src/submodules/nats.c/src/util.c", "nats_parseTime", @as(c_int, 1325), @as(c_uint, @bitCast(NATS_INVALID_ARG)), "time '%s' too long", orgStr);
        }
        return if (s == @as(c_uint, @bitCast(NATS_OK))) s else nats_updateErrStack(s, "nats_parseTime");
    }
    _ = snprintf(@as([*c]u8, @ptrCast(@alignCast(&tmpStr))), @sizeOf([36]u8), "%s", orgStr);
    str = @as([*c]u8, @ptrCast(@alignCast(&tmpStr)));
    _ = memset(@as(?*anyopaque, @ptrCast(&tp)), @as(c_int, 0), @sizeOf(struct_tm));
    if ((@as(c_int, @bitCast(@as(c_uint, (blk: {
        const tmp = l - @as(c_int, 1);
        if (tmp >= 0) break :blk str + @as(usize, @intCast(tmp)) else break :blk str - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
    }).*))) == @as(c_int, 'Z')) or (@as(c_int, @bitCast(@as(c_uint, (blk: {
        const tmp = l - @as(c_int, 1);
        if (tmp >= 0) break :blk str + @as(usize, @intCast(tmp)) else break :blk str - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
    }).*))) == @as(c_int, 'z'))) {
        _ = snprintf(@as([*c]u8, @ptrCast(@alignCast(&utcOff))), @sizeOf([7]u8), "%s", "+00:00");
        (blk: {
            const tmp = l - @as(c_int, 1);
            if (tmp >= 0) break :blk str + @as(usize, @intCast(tmp)) else break :blk str - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
        }).* = '\x00';
    } else {
        p = (str + @as(usize, @bitCast(@as(isize, @intCast(l))))) - @as(usize, @bitCast(@as(isize, @intCast(@as(c_int, 6)))));
        if (((strlen(p) != @as(c_ulong, @bitCast(@as(c_long, @as(c_int, 6))))) or ((@as(c_int, @bitCast(@as(c_uint, p.*))) != @as(c_int, '+')) and (@as(c_int, @bitCast(@as(c_uint, p.*))) != @as(c_int, '-')))) or (@as(c_int, @bitCast(@as(c_uint, (p + @as(usize, @bitCast(@as(isize, @intCast(@as(c_int, 3)))))).*))) != @as(c_int, ':'))) {
            s = nats_setErrorReal("./src/submodules/nats.c/src/util.c", "nats_parseTime", @as(c_int, 1348), @as(c_uint, @bitCast(NATS_INVALID_ARG)), "time '%s' has invalid UTC offset", orgStr);
            return if (s == @as(c_uint, @bitCast(NATS_OK))) s else nats_updateErrStack(s, "nats_parseTime");
        }
        _ = snprintf(@as([*c]u8, @ptrCast(@alignCast(&utcOff))), @sizeOf([7]u8), "%s", p);
        p.* = '\x00';
    }
    dotPos = strstr(str, ".");
    if (dotPos != @as([*c]u8, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) {
        var val: i64 = 0;
        _ = &val;
        p = dotPos + @as(usize, @bitCast(@as(isize, @intCast(@as(c_int, 1)))));
        l = @as(c_int, @bitCast(@as(c_uint, @truncate(strlen(p)))));
        val = nats_ParseInt64(@as([*c]const u8, @ptrCast(@alignCast(p))), l);
        if (val == @as(i64, @bitCast(@as(c_long, -@as(c_int, 1))))) {
            s = nats_setErrorReal("./src/submodules/nats.c/src/util.c", "nats_parseTime", @as(c_int, 1369), @as(c_uint, @bitCast(NATS_INVALID_ARG)), "time '%s' is invalid", orgStr);
            return if (s == @as(c_uint, @bitCast(NATS_OK))) s else nats_updateErrStack(s, "nats_parseTime");
        }
        {
            i = 0;
            while (i < (@as(c_int, 9) - l)) : (i += 1) {
                val *= @as(i64, @bitCast(@as(c_long, @as(c_int, 10))));
            }
        }
        if (val > @as(i64, @bitCast(@as(c_long, @as(c_int, 999999999))))) {
            s = nats_setErrorReal("./src/submodules/nats.c/src/util.c", "nats_parseTime", @as(c_int, 1378), @as(c_uint, @bitCast(NATS_INVALID_ARG)), "time '%s' second fraction too big", orgStr);
            return if (s == @as(c_uint, @bitCast(NATS_OK))) s else nats_updateErrStack(s, "nats_parseTime");
        }
        nanosecs = val;
        dotPos.* = '\x00';
    }
    _ = snprintf(@as([*c]u8, @ptrCast(@alignCast(&timeStr))), @sizeOf([42]u8), "%s%s", str, @as([*c]u8, @ptrCast(@alignCast(&utcOff))));
    if (sscanf(@as([*c]u8, @ptrCast(@alignCast(&timeStr))), "%4d-%2d-%2dT%2d:%2d:%2d%c%2d:%2d", &tp.tm_year, &tp.tm_mon, &tp.tm_mday, &tp.tm_hour, &tp.tm_min, &tp.tm_sec, &offSign, &offHours, &offMin) == @as(c_int, 9)) {
        var res: i64 = 0;
        _ = &res;
        var off: i64 = 0;
        _ = &off;
        tp.tm_year -= @as(c_int, 1900);
        tp.tm_mon -= 1;
        tp.tm_isdst = 0;
        res = @as(i64, @bitCast(timegm(&tp)));
        if (res == @as(i64, @bitCast(@as(c_long, -@as(c_int, 1))))) {
            s = nats_setErrorReal("./src/submodules/nats.c/src/util.c", "nats_parseTime", @as(c_int, 1405), @as(c_uint, @bitCast(NATS_ERR)), "error parsing time '%s'", orgStr);
            return if (s == @as(c_uint, @bitCast(NATS_OK))) s else nats_updateErrStack(s, "nats_parseTime");
        }
        off = @as(i64, @bitCast(@as(c_long, ((offHours * @as(c_int, 60)) * @as(c_int, 60)) + (offMin * @as(c_int, 60)))));
        if (@as(c_int, @bitCast(@as(c_uint, offSign))) == @as(c_int, '+')) {
            off *= @as(i64, @bitCast(@as(c_long, -@as(c_int, 1))));
        }
        res *= @as(i64, @intFromFloat(1000000000.0));
        res += off * @as(i64, @intFromFloat(1000000000.0));
        res += nanosecs;
        timeUTC.* = res;
    } else {
        s = nats_setErrorReal("./src/submodules/nats.c/src/util.c", "nats_parseTime", @as(c_int, 1422), @as(c_uint, @bitCast(NATS_ERR)), "error parsing time '%s'", orgStr);
    }
    return if (s == @as(c_uint, @bitCast(NATS_OK))) s else nats_updateErrStack(s, "nats_parseTime");
}
pub export fn nats_formatStringArray(arg_out: [*c][*c]u8, arg_strings: [*c][*c]const u8, arg_count: c_int) natsStatus {
    var out = arg_out;
    _ = &out;
    var strings = arg_strings;
    _ = &strings;
    ...
    len += 1;
    {
        ...
        while (i < count) : (i += 1) {
            ...
            if ((blk: {
                ...
                len += @as(c_int, @bitCast(@as(c_uint, @truncate(strlen("(null)")))));
            } else {
                len += @as(c_int, @bitCast(@as(c_uint, @truncate(strlen((blk: {
                    const tmp = i;
                    if (tmp >= 0) break :blk strings + @as(usize, @intCast(tmp)) else break :blk strings - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
                }).*)))));
            }
    ...
    _ = natsBuf_AppendByte(&buf, @as(u8, @bitCast(@as(i8, @truncate(@as(c_int, '['))))));
    {
        i = 0;
        while ((s == @as(c_uint, @bitCast(NATS_OK))) and (i < count)) : (i += 1) {
            ...
            if ((blk: {
                ...
                if (s == @as(c_uint, @bitCast(NATS_OK))) {
                    s = natsBuf_Append(&buf, "(null)", -@as(c_int, 1));
                }
            } else {
                if (s == @as(c_uint, @bitCast(NATS_OK))) {
                    s = natsBuf_Append(&buf, (blk: {
...
pub fn _jsonParse(arg_newJSON: [*c][*c]nats_JSON, arg_parsedLen: [*c]c_int, arg_jsonStr: [*c]const u8, arg_jsonLen: c_int, arg_nested: c_int) callconv(.c) natsStatus {
    var newJSON = arg_newJSON;
    _ = &newJSON;
    var parsedLen = arg_parsedLen;
    _ = &parsedLen;
    var jsonStr = arg_jsonStr;
    _ = &jsonStr;
    var jsonLen = arg_jsonLen;
    ...
    var field: [*c]nats_JSONField = null;
    _ = &field;
    var oldField: ?*anyopaque = @as(?*anyopaque, @ptrFromInt(@as(c_int, 0)));
    _ = &oldField;
    var ptr: [*c]u8 = undefined;
    _ = &ptr;
    var fieldName: [*c]u8 = null;
    _ = &fieldName;
    var state: c_int = undefined;
    _ = &state;
    var copyStr: [*c]u8 = null;
    _ = &copyStr;
    var breakLoop: bool = @as(c_int, 0) != 0;
    _ = &breakLoop;
    if (parsedLen != @as([*c]c_int, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) {
        parsedLen.* = 0;
    }
    if (nested >= jsonMaxNested) return nats_setErrorReal("./src/submodules/nats.c/src/util.c", "_jsonParse", @as(c_int, 945), @as(c_uint, @bitCast(NATS_ERR)), "json reached maximum nested objects of %d", jsonMaxNested);
    if (jsonLen < @as(c_int, 0)) {
        if (jsonStr == @as([*c]const u8, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) return nats_setErrorReal("./src/submodules/nats.c/src/util.c", "_jsonParse", @as(c_int, 950), @as(c_uint, @bitCast(NATS_INVALID_ARG)), "%s", natsStatus_GetText(@as(c_uint, @bitCast(NATS_INVALID_ARG))));
        jsonLen = @as(c_int, @bitCast(@as(c_uint, @truncate(strlen(jsonStr)))));
    }
    json = @as([*c]nats_JSON, @ptrCast(@alignCast(calloc(@as(c_ulong, @bitCast(@as(c_long, @as(c_int, 1)))), @sizeOf(nats_JSON)))));
    if (json == @as([*c]nats_JSON, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) return nats_setErrorReal("./src/submodules/nats.c/src/util.c", "_jsonParse", @as(c_int, 957), @as(c_uint, @bitCast(NATS_NO_MEMORY)), "%s", natsStatus_GetText(@as(c_uint, @bitCast(NATS_NO_MEMORY))));
    s = natsStrHash_Create(&json.*.fields, @as(c_int, 4));
    if (s == @as(c_uint, @bitCast(NATS_OK))) {
        json.*.str = @as([*c]u8, @ptrCast(@alignCast(malloc(@as(c_ulong, @bitCast(@as(c_long, jsonLen + @as(c_int, 1))))))));
        if (json.*.str == @as([*c]u8, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) {
            s = nats_setErrorReal("./src/submodules/nats.c/src/util.c", "_jsonParse", @as(c_int, 964), @as(c_uint, @bitCast(NATS_NO_MEMORY)), "%s", natsStatus_GetText(@as(c_uint, @bitCast(NATS_NO_MEMORY))));
        }
        if (s == @as(c_uint, @bitCast(NATS_OK))) {
            _ = memcpy(@as(?*anyopaque, @ptrCast(json.*.str)), @as(?*const anyopaque, @ptrCast(jsonStr)), @as(c_ulong, @bitCast(@as(c_long, jsonLen))));
            (blk: {
                const tmp = jsonLen;
                if (tmp >= 0) break :blk json.*.str + @as(usize, @intCast(tmp)) else break :blk json.*.str - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
            }).* = '\x00';
        }
    }
    if (s != @as(c_uint, @bitCast(NATS_OK))) {
        nats_JSONDestroy(json);
        return if (s == @as(c_uint, @bitCast(NATS_OK))) s else nats_updateErrStack(s, "_jsonParse");
    }
    ptr = json.*.str;
    copyStr = strdup(ptr);
    if (copyStr == @as([*c]u8, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) {
        nats_JSONDestroy(json);
        return nats_setErrorReal("./src/submodules/nats.c/src/util.c", "_jsonParse", @as(c_int, 983), @as(c_uint, @bitCast(NATS_NO_MEMORY)), "%s", natsStatus_GetText(@as(c_uint, @bitCast(NATS_NO_MEMORY))));
    }
    state = if (nested == @as(c_int, 0)) @as(c_int, 0) else @as(c_int, 1);
    while (((s == @as(c_uint, @bitCast(NATS_OK))) and (@as(c_int, @bitCast(@as(c_uint, ptr.*))) != @as(c_int, '\x00'))) and !breakLoop) {
        ptr = _jsonTrimSpace(ptr);
        if (@as(c_int, @bitCast(@as(c_uint, ptr.*))) == @as(c_int, '\x00')) break;
        while (true) {
            switch (state) {
                @as(c_int, 0) => {
                    {
                        if (@as(c_int, @bitCast(@as(c_uint, ptr.*))) != @as(c_int, '{')) {
                            s = nats_setErrorReal("./src/submodules/nats.c/src/util.c", "_jsonParse", @as(c_int, 999), @as(c_uint, @bitCast(NATS_ERR)), "incorrect JSON string: '%s'", ptr);
                            break;
                        }
                        ptr += @as(usize, @bitCast(@as(isize, @intCast(@as(c_int, 1)))));
                        state = @as(c_int, 1);
                        break;
                    }
                },
                @as(c_int, 1), @as(c_int, 2) => {
                    {
                        if (@as(c_int, @bitCast(@as(c_uint, ptr.*))) == @as(c_int, '}')) {
                            ...
                            s = nats_setErrorReal("./src/submodules/nats.c/src/util.c", "_jsonParse", @as(c_int, 1020), @as(c_uint, @bitCast(NATS_ERR)), "expected beginning of field, got: '%s'", ptr);
                            break;
                        }
                        if (@as(c_int, @bitCast(@as(c_uint, ptr.*))) != @as(c_int, '"')) {
                            s = nats_setErrorReal("./src/submodules/nats.c/src/util.c", "_jsonParse", @as(c_int, 1027), @as(c_uint, @bitCast(NATS_ERR)), "missing quote: '%s'", ptr);
                            break;
                        }
                        ptr += @as(usize, @bitCast(@as(isize, @intCast(@as(c_int, 1)))));
                        s = _jsonGetStr(&ptr, &fieldName);
                        if (s != @as(c_uint, @bitCast(NATS_OK))) break;
                        s = _jsonCreateField(&field, fieldName);
                        if (s != @as(c_uint, @bitCast(NATS_OK))) {
                            _ = if (s == @as(c_uint, @bitCast(NATS_OK))) s else nats_updateErrStack(s, "_jsonParse");
                            break;
                        }
                        s = natsStrHash_SetEx(json.*.fields, fieldName, @as(c_int, 0) != 0, (if (@as(c_int, 0) != 0) @as(c_int, 1) else @as(c_int, 0)) != 0, @as(?*anyopaque, @ptrCast(field)), &oldField);
                        if (s != @as(c_uint, @bitCast(NATS_OK))) {
                            _ = if (s == @as(c_uint, @bitCast(NATS_OK))) s else nats_updateErrStack(s, "_jsonParse");
                            break;
                        }
                        if (oldField != @as(?*anyopaque, @ptrFromInt(@as(c_int, 0)))) {
                            free(oldField);
                            oldField = @as(?*anyopaque, @ptrFromInt(@as(c_int, 0)));
                        }
                        state = @as(c_int, 3);
                        break;
                    }
                ...
                @as(c_int, 3) => {
                    {
                        if (@as(c_int, @bitCast(@as(c_uint, ptr.*))) != @as(c_int, ':')) {
                            s = nats_setErrorReal("./src/submodules/nats.c/src/util.c", "_jsonParse", @as(c_int, 1059), @as(c_uint, @bitCast(NATS_ERR)), "missing value for field '%s': '%s'", fieldName, ptr);
                            break;
                        }
                        ptr += @as(usize, @bitCast(@as(isize, @intCast(@as(c_int, 1)))));
                        state = @as(c_int, 4);
                ...
                @as(c_int, 5) => {
                    {
                        if ((@as(c_int, @bitCast(@as(c_uint, ptr.*))) != @as(c_int, ',')) and (@as(c_int, @bitCast(@as(c_uint, ptr.*))) != @as(c_int, '}'))) {
                            s = nats_setErrorReal("./src/submodules/nats.c/src/util.c", "_jsonParse", @as(c_int, 1078), @as(c_uint, @bitCast(NATS_ERR)), "missing separator: '%s' (%s)", ptr, copyStr);
                            break;
                        }
                        if (@as(c_int, @bitCast(@as(c_uint, ptr.*))) == @as(c_int, ',')) {
                            state = @as(c_int, 2);
                ...
                @as(c_int, 6) => {
                    {
                        if (nested > @as(c_int, 0)) {
                            breakLoop = @as(c_int, 1) != 0;
                            break;
                        }
                        s = nats_setErrorReal("./src/submodules/nats.c/src/util.c", "_jsonParse", @as(c_int, 1099), @as(c_uint, @bitCast(NATS_ERR)), "invalid characters after end of JSON: '%s'", ptr);
                        break;
                    }
                },
                else => {},
    ...
    if (s == @as(c_uint, @bitCast(NATS_OK))) {
        if (state != @as(c_int, 6)) {
            s = nats_setErrorReal("./src/submodules/nats.c/src/util.c", "_jsonParse", @as(c_int, 1107), @as(c_uint, @bitCast(NATS_ERR)), "%s", "JSON string not properly closed");
        }
    }
    if (s == @as(c_uint, @bitCast(NATS_OK))) {
        if (parsedLen != @as([*c]c_int, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) {
            parsedLen.* = @as(c_int, @bitCast(@as(c_int, @truncate(@divExact(@as(c_long, @bitCast(@intFromPtr(ptr) -% @intFromPtr(json.*.str))), @sizeOf(u8))))));
        }
        newJSON.* = json;
    } else {
        nats_JSONDestroy(json);
    }
    free(@as(?*anyopaque, @ptrCast(copyStr)));
    return if (s == @as(c_uint, @bitCast(NATS_OK))) s else nats_updateErrStack(s, "_jsonParse");
}
pub fn _jsonParseValue(arg_str: [*c][*c]u8, arg_field: [*c]nats_JSONField, arg_nested: c_int) callconv(.c) natsStatus {
    var str = arg_str;
    _ = &str;
    var field = arg_field;
    _ = &field;
    ...
    if (@as(c_int, @bitCast(@as(c_uint, ptr.*))) == @as(c_int, '"')) {
        ptr += @as(usize, @bitCast(@as(isize, @intCast(@as(c_int, 1)))));
        field.*.typ = @as(c_int, 1);
        s = _jsonGetStr(&ptr, &field.*.value.vstr);
    } else if ((@as(c_int, @bitCast(@as(c_uint, ptr.*))) == @as(c_int, 't')) or (@as(c_int, @bitCast(@as(c_uint, ptr.*))) == @as(c_int, 'f'))) {
        field.*.typ = @as(c_int, 2);
        s = _jsonGetBool(&ptr, &field.*.value.vbool);
    } else if (((@as(c_int, @bitCast(@as(c_uint, (blk: {
        const tmp = @as(c_int, @bitCast(@as(c_uint, @as(u8, @bitCast(ptr.*)))));
        if (tmp >= 0) break :blk __ctype_b_loc().* + @as(usize, @intCast(tmp)) else break :blk __ctype_b_loc().* - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
    }).*))) & @as(c_int, @bitCast(@as(c_uint, @as(c_ushort, @bitCast(@as(c_short, @truncate(_ISdigit)))))))) != 0) or (@as(c_int, @bitCast(@as(c_uint, ptr.*))) == @as(c_int, '-'))) {
        field.*.typ = @as(c_int, 3);
        s = _jsonGetNum(&ptr, field);
    } else if (@as(c_int, @bitCast(@as(c_uint, ptr.*))) == @as(c_int, '[')) {
        ptr += @as(usize, @bitCast(@as(isize, @intCast(@as(c_int, 1)))));
        field.*.typ = @as(c_int, 7);
        s = _jsonGetArray(&ptr, &field.*.value.varr, nested + @as(c_int, 1));
    } else if (@as(c_int, @bitCast(@as(c_uint, ptr.*))) == @as(c_int, '{')) {
        var object: [*c]nats_JSON = null;
        _ = &object;
        var objLen: c_int = 0;
        _ = &objLen;
        ptr += @as(usize, @bitCast(@as(isize, @intCast(@as(c_int, 1)))));
        field.*.typ = @as(c_int, 8);
        s = _jsonParse(&object, &objLen, ptr, -@as(c_int, 1), nested + @as(c_int, 1));
        if (s == @as(c_uint, @bitCast(NATS_OK))) {
            field.*.value.vobj = object;
            ptr += @as(usize, @bitCast(@as(isize, @intCast(objLen))));
        }
    } else if ((@as(c_int, @bitCast(@as(c_uint, ptr.*))) == @as(c_int, 'n')) and (strstr(ptr, "null") == ptr)) {
        ptr += @as(usize, @bitCast(@as(isize, @intCast(@as(c_int, 4)))));
        field.*.typ = @as(c_int, 9);
    } else {
        s = nats_setErrorReal("./src/submodules/nats.c/src/util.c", "_jsonParseValue", @as(c_int, 920), @as(c_uint, @bitCast(NATS_ERR)), "looking for value, got: '%s'", ptr);
    }
    if (s == @as(c_uint, @bitCast(NATS_OK))) {
        str.* = ptr;
    }
    return if (s == @as(c_uint, @bitCast(NATS_OK))) s else nats_updateErrStack(s, "_jsonParseValue");
}
pub fn _jsonFreeArray(arg_arr: [*c]nats_JSONArray, arg_freeObj: bool) callconv(.c) void {
    var arr = arg_arr;
    _ = &arr;
    var freeObj = arg_freeObj;
    _ = &freeObj;
    if (arr == @as([*c]nats_JSONArray, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) return;
    if ((arr.*.typ == @as(c_int, 8)) or (arr.*.typ == @as(c_int, 7))) {
        var i: c_int = undefined;
        _ = &i;
        {
            i = 0;
            while (i < arr.*.size) : (i += 1) {
                if (arr.*.typ == @as(c_int, 8)) {
                    var fjson: [*c]nats_JSON = (blk: {
                        const tmp = i;
                        if (tmp >= 0) break :blk @as([*c][*c]nats_JSON, @ptrCast(@alignCast(arr.*.values))) + @as(usize, @intCast(tmp)) else break :blk @as([*c][*c]nats_JSON, @ptrCast(@alignCast(arr.*.values))) - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
                    }).*;
                    _ = &fjson;
                    ...
                    var farr: [*c]nats_JSONArray = (blk: {
                        const tmp = i;
                        if (tmp >= 0) break :blk @as([*c][*c]nats_JSONArray, @ptrCast(@alignCast(arr.*.values))) + @as(usize, @intCast(tmp)) else break :blk @as([*c][*c]nats_JSONArray, @ptrCast(@alignCast(arr.*.values))) - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
                    }).*;
                    _ = &farr;
                    _jsonFreeArray(farr, @as(c_int, 1) != 0);
                }
            }
        }
    }
    free(@as(?*anyopaque, @ptrCast(arr.*.values)));
    if (freeObj) {
        free(@as(?*anyopaque, @ptrCast(arr)));
    }
}
pub var base32DecodeMap: [256]u8 = @import("std").mem.zeroes([256]u8);
pub var base64EncodeURL: [*c]const u8 = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789-_";
pub var base64EncodeStd: [*c]const u8 = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/";
pub var base64Padding: u8 = '=';
pub var base64Ints: [80]c_int = [80]c_int{
    62,
    -@as(c_int, 1),
    -@as(c_int, 1),
    -@as(c_int, 1),
...
pub var crc16tab: [256]u16 = [256]u16{
    0,
    @as(u16, @bitCast(@as(c_short, @truncate(@as(c_int, 4129))))),
    @as(u16, @bitCast(@as(c_short, @truncate(@as(c_int, 8258))))),
    @as(u16, @bitCast(@as(c_short, @truncate(@as(c_int, 12387))))),
    @as(u16, @bitCast(@as(c_short, @truncate(@as(c_int, 16516))))),
    @as(u16, @bitCast(@as(c_short, @truncate(@as(c_int, 20645))))),
    @as(u16, @bitCast(@as(c_short, @truncate(@as(c_int, 24774))))),
    @as(u16, @bitCast(@as(c_short, @truncate(@as(c_int, 28903))))),
    @as(u16, @bitCast(@as(c_short, @truncate(@as(c_int, 33032))))),
    @as(u16, @bitCast(@as(c_short, @truncate(@as(c_int, 37161))))),
    @as(u16, @bitCast(@as(c_short, @truncate(@as(c_int, 41290))))),
    @as(u16, @bitCast(@as(c_short, @truncate(@as(c_int, 45419))))),
    @as(u16, @bitCast(@as(c_short, @truncate(@as(c_int, 49548))))),
    @as(u16, @bitCast(@as(c_short, @truncate(@as(c_int, 53677))))),
    @as(u16, @bitCast(@as(c_short, @truncate(@as(c_int, 57806))))),
    @as(u16, @bitCast(@as(c_short, @truncate(@as(c_int, 61935))))),
    @as(u16, @bitCast(@as(c_short, @truncate(@as(c_int, 4657))))),
    @as(u16, @bitCast(@as(c_short, @truncate(@as(c_int, 528))))),
    @as(u16, @bitCast(@as(c_short, @truncate(@as(c_int, 12915))))),
    @as(u16, @bitCast(@as(c_short, @truncate(@as(c_int, 8786))))),
    @as(u16, @bitCast(@as(c_short, @truncate(@as(c_int, 21173))))),
    @as(u16, @bitCast(@as(c_short, @truncate(@as(c_int, 17044))))),
    @as(u16, @bitCast(@as(c_short, @truncate(@as(c_int, 29431))))),
    @as(u16, @bitCast(@as(c_short, @truncate(@as(c_int, 25302))))),
    @as(u16, @bitCast(@as(c_short, @truncate(@as(c_int, 37689))))),
    @as(u16, @bitCast(@as(c_short, @truncate(@as(c_int, 33560))))),
    @as(u16, @bitCast(@as(c_short, @truncate(@as(c_int, 45947))))),
    @as(u16, @bitCast(@as(c_short, @truncate(@as(c_int, 41818))))),
    @as(u16, @bitCast(@as(c_short, @truncate(@as(c_int, 54205))))),
    @as(u16, @bitCast(@as(c_short, @truncate(@as(c_int, 50076))))),
    @as(u16, @bitCast(@as(c_short, @truncate(@as(c_int, 62463))))),
    @as(u16, @bitCast(@as(c_short, @truncate(@as(c_int, 58334))))),
    @as(u16, @bitCast(@as(c_short, @truncate(@as(c_int, 9314))))),
    @as(u16, @bitCast(@as(c_short, @truncate(@as(c_int, 13379))))),
    @as(u16, @bitCast(@as(c_short, @truncate(@as(c_int, 1056))))),
    @as(u16, @bitCast(@as(c_short, @truncate(@as(c_int, 5121))))),
    @as(u16, @bitCast(@as(c_short, @truncate(@as(c_int, 25830))))),
    @as(u16, @bitCast(@as(c_short, @truncate(@as(c_int, 29895))))),
    @as(u16, @bitCast(@as(c_short, @truncate(@as(c_int, 17572))))),
    @as(u16, @bitCast(@as(c_short, @truncate(@as(c_int, 21637))))),
    @as(u16, @bitCast(@as(c_short, @truncate(@as(c_int, 42346))))),
    @as(u16, @bitCast(@as(c_short, @truncate(@as(c_int, 46411))))),
    @as(u16, @bitCast(@as(c_short, @truncate(@as(c_int, 34088))))),
    @as(u16, @bitCast(@as(c_short, @truncate(@as(c_int, 38153))))),
    @as(u16, @bitCast(@as(c_short, @truncate(@as(c_int, 58862))))),
    @as(u16, @bitCast(@as(c_short, @truncate(@as(c_int, 62927))))),
    @as(u16, @bitCast(@as(c_short, @truncate(@as(c_int, 50604))))),
    @as(u16, @bitCast(@as(c_short, @truncate(@as(c_int, 54669))))),
    @as(u16, @bitCast(@as(c_short, @truncate(@as(c_int, 13907))))),
    @as(u16, @bitCast(@as(c_short, @truncate(@as(c_int, 9842))))),
    @as(u16, @bitCast(@as(c_short, @truncate(@as(c_int, 5649))))),
    @as(u16, @bitCast(@as(c_short, @truncate(@as(c_int, 1584))))),
    @as(u16, @bitCast(@as(c_short, @truncate(@as(c_int, 30423))))),
    @as(u16, @bitCast(@as(c_short, @truncate(@as(c_int, 26358))))),
    @as(u16, @bitCast(@as(c_short, @truncate(@as(c_int, 22165))))),
    @as(u16, @bitCast(@as(c_short, @truncate(@as(c_int, 18100))))),
    @as(u16, @bitCast(@as(c_short, @truncate(@as(c_int, 46939))))),
    @as(u16, @bitCast(@as(c_short, @truncate(@as(c_int, 42874))))),
    @as(u16, @bitCast(@as(c_short, @truncate(@as(c_int, 38681))))),
    @as(u16, @bitCast(@as(c_short, @truncate(@as(c_int, 34616))))),
    @as(u16, @bitCast(@as(c_short, @truncate(@as(c_int, 63455))))),
    @as(u16, @bitCast(@as(c_short, @truncate(@as(c_int, 59390))))),
    @as(u16, @bitCast(@as(c_short, @truncate(@as(c_int, 55197))))),
    @as(u16, @bitCast(@as(c_short, @truncate(@as(c_int, 51132))))),
    @as(u16, @bitCast(@as(c_short, @truncate(@as(c_int, 18628))))),
    @as(u16, @bitCast(@as(c_short, @truncate(@as(c_int, 22757))))),
    @as(u16, @bitCast(@as(c_short, @truncate(@as(c_int, 26758))))),
    @as(u16, @bitCast(@as(c_short, @truncate(@as(c_int, 30887))))),
    @as(u16, @bitCast(@as(c_short, @truncate(@as(c_int, 2112))))),
    @as(u16, @bitCast(@as(c_short, @truncate(@as(c_int, 6241))))),
    @as(u16, @bitCast(@as(c_short, @truncate(@as(c_int, 10242))))),
    @as(u16, @bitCast(@as(c_short, @truncate(@as(c_int, 14371))))),
    @as(u16, @bitCast(@as(c_short, @truncate(@as(c_int, 51660))))),
    @as(u16, @bitCast(@as(c_short, @truncate(@as(c_int, 55789))))),
    @as(u16, @bitCast(@as(c_short, @truncate(@as(c_int, 59790))))),
    @as(u16, @bitCast(@as(c_short, @truncate(@as(c_int, 63919))))),
    @as(u16, @bitCast(@as(c_short, @truncate(@as(c_int, 35144))))),
    @as(u16, @bitCast(@as(c_short, @truncate(@as(c_int, 39273))))),
    @as(u16, @bitCast(@as(c_short, @truncate(@as(c_int, 43274))))),
    @as(u16, @bitCast(@as(c_short, @truncate(@as(c_int, 47403))))),
    @as(u16, @bitCast(@as(c_short, @truncate(@as(c_int, 23285))))),
    @as(u16, @bitCast(@as(c_short, @truncate(@as(c_int, 19156))))),
    @as(u16, @bitCast(@as(c_short, @truncate(@as(c_int, 31415))))),
    @as(u16, @bitCast(@as(c_short, @truncate(@as(c_int, 27286))))),
    @as(u16, @bitCast(@as(c_short, @truncate(@as(c_int, 6769))))),
    @as(u16, @bitCast(@as(c_short, @truncate(@as(c_int, 2640))))),
    @as(u16, @bitCast(@as(c_short, @truncate(@as(c_int, 14899))))),
    @as(u16, @bitCast(@as(c_short, @truncate(@as(c_int, 10770))))),
    @as(u16, @bitCast(@as(c_short, @truncate(@as(c_int, 56317))))),
    @as(u16, @bitCast(@as(c_short, @truncate(@as(c_int, 52188))))),
    @as(u16, @bitCast(@as(c_short, @truncate(@as(c_int, 64447))))),
    @as(u16, @bitCast(@as(c_short, @truncate(@as(c_int, 60318))))),
    @as(u16, @bitCast(@as(c_short, @truncate(@as(c_int, 39801))))),
    @as(u16, @bitCast(@as(c_short, @truncate(@as(c_int, 35672))))),
    @as(u16, @bitCast(@as(c_short, @truncate(@as(c_int, 47931))))),
    @as(u16, @bitCast(@as(c_short, @truncate(@as(c_int, 43802))))),
    @as(u16, @bitCast(@as(c_short, @truncate(@as(c_int, 27814))))),
    @as(u16, @bitCast(@as(c_short, @truncate(@as(c_int, 31879))))),
    @as(u16, @bitCast(@as(c_short, @truncate(@as(c_int, 19684))))),
    @as(u16, @bitCast(@as(c_short, @truncate(@as(c_int, 23749))))),
    @as(u16, @bitCast(@as(c_short, @truncate(@as(c_int, 11298))))),
    @as(u16, @bitCast(@as(c_short, @truncate(@as(c_int, 15363))))),
    @as(u16, @bitCast(@as(c_short, @truncate(@as(c_int, 3168))))),
    @as(u16, @bitCast(@as(c_short, @truncate(@as(c_int, 7233))))),
    @as(u16, @bitCast(@as(c_short, @truncate(@as(c_int, 60846))))),
    @as(u16, @bitCast(@as(c_short, @truncate(@as(c_int, 64911))))),
    @as(u16, @bitCast(@as(c_short, @truncate(@as(c_int, 52716))))),
    @as(u16, @bitCast(@as(c_short, @truncate(@as(c_int, 56781))))),
    @as(u16, @bitCast(@as(c_short, @truncate(@as(c_int, 44330))))),
    @as(u16, @bitCast(@as(c_short, @truncate(@as(c_int, 48395))))),
    @as(u16, @bitCast(@as(c_short, @truncate(@as(c_int, 36200))))),
    @as(u16, @bitCast(@as(c_short, @truncate(@as(c_int, 40265))))),
    @as(u16, @bitCast(@as(c_short, @truncate(@as(c_int, 32407))))),
    @as(u16, @bitCast(@as(c_short, @truncate(@as(c_int, 28342))))),
    @as(u16, @bitCast(@as(c_short, @truncate(@as(c_int, 24277))))),
    @as(u16, @bitCast(@as(c_short, @truncate(@as(c_int, 20212))))),
    @as(u16, @bitCast(@as(c_short, @truncate(@as(c_int, 15891))))),
    @as(u16, @bitCast(@as(c_short, @truncate(@as(c_int, 11826))))),
    @as(u16, @bitCast(@as(c_short, @truncate(@as(c_int, 7761))))),
    @as(u16, @bitCast(@as(c_short, @truncate(@as(c_int, 3696))))),
    @as(u16, @bitCast(@as(c_short, @truncate(@as(c_int, 65439))))),
    @as(u16, @bitCast(@as(c_short, @truncate(@as(c_int, 61374))))),
    @as(u16, @bitCast(@as(c_short, @truncate(@as(c_int, 57309))))),
    @as(u16, @bitCast(@as(c_short, @truncate(@as(c_int, 53244))))),
    @as(u16, @bitCast(@as(c_short, @truncate(@as(c_int, 48923))))),
    @as(u16, @bitCast(@as(c_short, @truncate(@as(c_int, 44858))))),
    @as(u16, @bitCast(@as(c_short, @truncate(@as(c_int, 40793))))),
    @as(u16, @bitCast(@as(c_short, @truncate(@as(c_int, 36728))))),
    @as(u16, @bitCast(@as(c_short, @truncate(@as(c_int, 37256))))),
    @as(u16, @bitCast(@as(c_short, @truncate(@as(c_int, 33193))))),
    @as(u16, @bitCast(@as(c_short, @truncate(@as(c_int, 45514))))),
    @as(u16, @bitCast(@as(c_short, @truncate(@as(c_int, 41451))))),
    @as(u16, @bitCast(@as(c_short, @truncate(@as(c_int, 53516))))),
    @as(u16, @bitCast(@as(c_short, @truncate(@as(c_int, 49453))))),
    @as(u16, @bitCast(@as(c_short, @truncate(@as(c_int, 61774))))),
    @as(u16, @bitCast(@as(c_short, @truncate(@as(c_int, 57711))))),
    @as(u16, @bitCast(@as(c_short, @truncate(@as(c_int, 4224))))),
    161,
    @as(u16, @bitCast(@as(c_short, @truncate(@as(c_int, 12482))))),
    @as(u16, @bitCast(@as(c_short, @truncate(@as(c_int, 8419))))),
    @as(u16, @bitCast(@as(c_short, @truncate(@as(c_int, 20484))))),
    @as(u16, @bitCast(@as(c_short, @truncate(@as(c_int, 16421))))),
    @as(u16, @bitCast(@as(c_short, @truncate(@as(c_int, 28742))))),
    @as(u16, @bitCast(@as(c_short, @truncate(@as(c_int, 24679))))),
    @as(u16, @bitCast(@as(c_short, @truncate(@as(c_int, 33721))))),
    @as(u16, @bitCast(@as(c_short, @truncate(@as(c_int, 37784))))),
    @as(u16, @bitCast(@as(c_short, @truncate(@as(c_int, 41979))))),
    @as(u16, @bitCast(@as(c_short, @truncate(@as(c_int, 46042))))),
    @as(u16, @bitCast(@as(c_short, @truncate(@as(c_int, 49981))))),
    @as(u16, @bitCast(@as(c_short, @truncate(@as(c_int, 54044))))),
    @as(u16, @bitCast(@as(c_short, @truncate(@as(c_int, 58239))))),
    @as(u16, @bitCast(@as(c_short, @truncate(@as(c_int, 62302))))),
    @as(u16, @bitCast(@as(c_short, @truncate(@as(c_int, 689))))),
    @as(u16, @bitCast(@as(c_short, @truncate(@as(c_int, 4752))))),
    @as(u16, @bitCast(@as(c_short, @truncate(@as(c_int, 8947))))),
    @as(u16, @bitCast(@as(c_short, @truncate(@as(c_int, 13010))))),
    @as(u16, @bitCast(@as(c_short, @truncate(@as(c_int, 16949))))),
    @as(u16, @bitCast(@as(c_short, @truncate(@as(c_int, 21012))))),
    @as(u16, @bitCast(@as(c_short, @truncate(@as(c_int, 25207))))),
    @as(u16, @bitCast(@as(c_short, @truncate(@as(c_int, 29270))))),
    @as(u16, @bitCast(@as(c_short, @truncate(@as(c_int, 46570))))),
    @as(u16, @bitCast(@as(c_short, @truncate(@as(c_int, 42443))))),
    @as(u16, @bitCast(@as(c_short, @truncate(@as(c_int, 38312))))),
    @as(u16, @bitCast(@as(c_short, @truncate(@as(c_int, 34185))))),
    @as(u16, @bitCast(@as(c_short, @truncate(@as(c_int, 62830))))),
    @as(u16, @bitCast(@as(c_short, @truncate(@as(c_int, 58703))))),
    @as(u16, @bitCast(@as(c_short, @truncate(@as(c_int, 54572))))),
    @as(u16, @bitCast(@as(c_short, @truncate(@as(c_int, 50445))))),
    @as(u16, @bitCast(@as(c_short, @truncate(@as(c_int, 13538))))),
    @as(u16, @bitCast(@as(c_short, @truncate(@as(c_int, 9411))))),
    @as(u16, @bitCast(@as(c_short, @truncate(@as(c_int, 5280))))),
    @as(u16, @bitCast(@as(c_short, @truncate(@as(c_int, 1153))))),
    @as(u16, @bitCast(@as(c_short, @truncate(@as(c_int, 29798))))),
    @as(u16, @bitCast(@as(c_short, @truncate(@as(c_int, 25671))))),
    @as(u16, @bitCast(@as(c_short, @truncate(@as(c_int, 21540))))),
    @as(u16, @bitCast(@as(c_short, @truncate(@as(c_int, 17413))))),
    @as(u16, @bitCast(@as(c_short, @truncate(@as(c_int, 42971))))),
    @as(u16, @bitCast(@as(c_short, @truncate(@as(c_int, 47098))))),
    @as(u16, @bitCast(@as(c_short, @truncate(@as(c_int, 34713))))),
    @as(u16, @bitCast(@as(c_short, @truncate(@as(c_int, 38840))))),
    @as(u16, @bitCast(@as(c_short, @truncate(@as(c_int, 59231))))),
    @as(u16, @bitCast(@as(c_short, @truncate(@as(c_int, 63358))))),
    @as(u16, @bitCast(@as(c_short, @truncate(@as(c_int, 50973))))),
    @as(u16, @bitCast(@as(c_short, @truncate(@as(c_int, 55100))))),
    @as(u16, @bitCast(@as(c_short, @truncate(@as(c_int, 9939))))),
    @as(u16, @bitCast(@as(c_short, @truncate(@as(c_int, 14066))))),
    @as(u16, @bitCast(@as(c_short, @truncate(@as(c_int, 1681))))),
    @as(u16, @bitCast(@as(c_short, @truncate(@as(c_int, 5808))))),
    @as(u16, @bitCast(@as(c_short, @truncate(@as(c_int, 26199))))),
    @as(u16, @bitCast(@as(c_short, @truncate(@as(c_int, 30326))))),
    @as(u16, @bitCast(@as(c_short, @truncate(@as(c_int, 17941))))),
    @as(u16, @bitCast(@as(c_short, @truncate(@as(c_int, 22068))))),
    @as(u16, @bitCast(@as(c_short, @truncate(@as(c_int, 55628))))),
    @as(u16, @bitCast(@as(c_short, @truncate(@as(c_int, 51565))))),
    @as(u16, @bitCast(@as(c_short, @truncate(@as(c_int, 63758))))),
    @as(u16, @bitCast(@as(c_short, @truncate(@as(c_int, 59695))))),
    @as(u16, @bitCast(@as(c_short, @truncate(@as(c_int, 39368))))),
    @as(u16, @bitCast(@as(c_short, @truncate(@as(c_int, 35305))))),
    @as(u16, @bitCast(@as(c_short, @truncate(@as(c_int, 47498))))),
    @as(u16, @bitCast(@as(c_short, @truncate(@as(c_int, 43435))))),
    @as(u16, @bitCast(@as(c_short, @truncate(@as(c_int, 22596))))),
    @as(u16, @bitCast(@as(c_short, @truncate(@as(c_int, 18533))))),
    @as(u16, @bitCast(@as(c_short, @truncate(@as(c_int, 30726))))),
    @as(u16, @bitCast(@as(c_short, @truncate(@as(c_int, 26663))))),
    @as(u16, @bitCast(@as(c_short, @truncate(@as(c_int, 6336))))),
    @as(u16, @bitCast(@as(c_short, @truncate(@as(c_int, 2273))))),
    @as(u16, @bitCast(@as(c_short, @truncate(@as(c_int, 14466))))),
    @as(u16, @bitCast(@as(c_short, @truncate(@as(c_int, 10403))))),
    @as(u16, @bitCast(@as(c_short, @truncate(@as(c_int, 52093))))),
    @as(u16, @bitCast(@as(c_short, @truncate(@as(c_int, 56156))))),
    @as(u16, @bitCast(@as(c_short, @truncate(@as(c_int, 60223))))),
    @as(u16, @bitCast(@as(c_short, @truncate(@as(c_int, 64286))))),
    @as(u16, @bitCast(@as(c_short, @truncate(@as(c_int, 35833))))),
    @as(u16, @bitCast(@as(c_short, @truncate(@as(c_int, 39896))))),
    @as(u16, @bitCast(@as(c_short, @truncate(@as(c_int, 43963))))),
    @as(u16, @bitCast(@as(c_short, @truncate(@as(c_int, 48026))))),
    @as(u16, @bitCast(@as(c_short, @truncate(@as(c_int, 19061))))),
    @as(u16, @bitCast(@as(c_short, @truncate(@as(c_int, 23124))))),
    @as(u16, @bitCast(@as(c_short, @truncate(@as(c_int, 27191))))),
    @as(u16, @bitCast(@as(c_short, @truncate(@as(c_int, 31254))))),
    @as(u16, @bitCast(@as(c_short, @truncate(@as(c_int, 2801))))),
    @as(u16, @bitCast(@as(c_short, @truncate(@as(c_int, 6864))))),
    @as(u16, @bitCast(@as(c_short, @truncate(@as(c_int, 10931))))),
    @as(u16, @bitCast(@as(c_short, @truncate(@as(c_int, 14994))))),
    @as(u16, @bitCast(@as(c_short, @truncate(@as(c_int, 64814))))),
    @as(u16, @bitCast(@as(c_short, @truncate(@as(c_int, 60687))))),
    @as(u16, @bitCast(@as(c_short, @truncate(@as(c_int, 56684))))),
    @as(u16, @bitCast(@as(c_short, @truncate(@as(c_int, 52557))))),
    @as(u16, @bitCast(@as(c_short, @truncate(@as(c_int, 48554))))),
    @as(u16, @bitCast(@as(c_short, @truncate(@as(c_int, 44427))))),
    @as(u16, @bitCast(@as(c_short, @truncate(@as(c_int, 40424))))),
    @as(u16, @bitCast(@as(c_short, @truncate(@as(c_int, 36297))))),
    @as(u16, @bitCast(@as(c_short, @truncate(@as(c_int, 31782))))),
    @as(u16, @bitCast(@as(c_short, @truncate(@as(c_int, 27655))))),
    @as(u16, @bitCast(@as(c_short, @truncate(@as(c_int, 23652))))),
    @as(u16, @bitCast(@as(c_short, @truncate(@as(c_int, 19525))))),
    @as(u16, @bitCast(@as(c_short, @truncate(@as(c_int, 15522))))),
    @as(u16, @bitCast(@as(c_short, @truncate(@as(c_int, 11395))))),
    @as(u16, @bitCast(@as(c_short, @truncate(@as(c_int, 7392))))),
    @as(u16, @bitCast(@as(c_short, @truncate(@as(c_int, 3265))))),
    @as(u16, @bitCast(@as(c_short, @truncate(@as(c_int, 61215))))),
    @as(u16, @bitCast(@as(c_short, @truncate(@as(c_int, 65342))))),
    @as(u16, @bitCast(@as(c_short, @truncate(@as(c_int, 53085))))),
    @as(u16, @bitCast(@as(c_short, @truncate(@as(c_int, 57212))))),
    @as(u16, @bitCast(@as(c_short, @truncate(@as(c_int, 44955))))),
    @as(u16, @bitCast(@as(c_short, @truncate(@as(c_int, 49082))))),
    @as(u16, @bitCast(@as(c_short, @truncate(@as(c_int, 36825))))),
    @as(u16, @bitCast(@as(c_short, @truncate(@as(c_int, 40952))))),
    @as(u16, @bitCast(@as(c_short, @truncate(@as(c_int, 28183))))),
    @as(u16, @bitCast(@as(c_short, @truncate(@as(c_int, 32310))))),
    @as(u16, @bitCast(@as(c_short, @truncate(@as(c_int, 20053))))),
    @as(u16, @bitCast(@as(c_short, @truncate(@as(c_int, 24180))))),
    @as(u16, @bitCast(@as(c_short, @truncate(@as(c_int, 11923))))),
    @as(u16, @bitCast(@as(c_short, @truncate(@as(c_int, 16050))))),
    @as(u16, @bitCast(@as(c_short, @truncate(@as(c_int, 3793))))),
    @as(u16, @bitCast(@as(c_short, @truncate(@as(c_int, 7920))))),
};
pub fn _jsonCreateField(arg_newField: [*c][*c]nats_JSONField, arg_fieldName: [*c]u8) callconv(.c) natsStatus {
    var newField = arg_newField;
    _ = &newField;
    var fieldName = arg_fieldName;
    _ = &fieldName;
    var field: [*c]nats_JSONField = null;
    _ = &field;
    field = @as([*c]nats_JSONField, @ptrCast(@alignCast(calloc(@as(c_ulong, @bitCast(@as(c_long, @as(c_int, 1)))), @sizeOf(nats_JSONField)))));
    if (field == @as([*c]nats_JSONField, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) return nats_setErrorReal("./src/submodules/nats.c/src/util.c", "_jsonCreateField", @as(c_int, 398), @as(c_uint, @bitCast(NATS_NO_MEMORY)), "%s", natsStatus_GetText(@as(c_uint, @bitCast(NATS_NO_MEMORY))));
    field.*.name = fieldName;
    field.*.typ = @as(c_int, 0);
    newField.* = field;
    return @as(c_uint, @bitCast(NATS_OK));
}
pub fn _jsonFreeField(arg_field: [*c]nats_JSONField) callconv(.c) void {
    var field = arg_field;
    _ = &field;
    if (field.*.typ == @as(c_int, 7)) {
        _jsonFreeArray(field.*.value.varr, @as(c_int, 1) != 0);
    } else if (field.*.typ == @as(c_int, 8)) {
        nats_JSONDestroy(field.*.value.vobj);
    }
    free(@as(?*anyopaque, @ptrCast(field)));
}
pub fn _jsonTrimSpace(arg_ptr: [*c]u8) callconv(.c) [*c]u8 {
    var ptr = arg_ptr;
    _ = &ptr;
    while ((@as(c_int, @bitCast(@as(c_uint, ptr.*))) != @as(c_int, '\x00')) and ((((@as(c_int, @bitCast(@as(c_uint, ptr.*))) == @as(c_int, ' ')) or (@as(c_int, @bitCast(@as(c_uint, ptr.*))) == @as(c_int, '\t'))) or (@as(c_int, @bitCast(@as(c_uint, ptr.*))) == @as(c_int, '\r'))) or (@as(c_int, @bitCast(@as(c_uint, ptr.*))) == @as(c_int, '\n')))) {
        ptr += @as(usize, @bitCast(@as(isize, @intCast(@as(c_int, 1)))));
    }
    return ptr;
}
pub fn _decodeUni(arg_iPtr: [*c][*c]u8, arg_val: [*c]u8) callconv(.c) natsStatus {
    var iPtr = arg_iPtr;
    _ = &iPtr;
    var val = arg_val;
    _ = &val;
    ...
    var j: c_int = undefined;
    _ = &j;
    if (strlen(i) < @as(c_ulong, @bitCast(@as(c_long, @as(c_int, 5))))) return @as(c_uint, @bitCast(NATS_ERR));
    i += 1;
    {
        j = 0;
        while (j < @as(c_int, 4)) : (j += 1) {
            ...
            _ = &c;
            if ((@as(c_int, @bitCast(@as(c_uint, c))) >= @as(c_int, '0')) and (@as(c_int, @bitCast(@as(c_uint, c))) <= @as(c_int, '9'))) {
                c = @as(u8, @bitCast(@as(i8, @truncate(@as(c_int, @bitCast(@as(c_uint, c))) - @as(c_int, '0')))));
            } else if ((@as(c_int, @bitCast(@as(c_uint, c))) >= @as(c_int, 'a')) and (@as(c_int, @bitCast(@as(c_uint, c))) <= @as(c_int, 'f'))) {
                c = @as(u8, @bitCast(@as(i8, @truncate((@as(c_int, @bitCast(@as(c_uint, c))) - @as(c_int, 'a')) + @as(c_int, 10)))));
            } else if ((@as(c_int, @bitCast(@as(c_uint, c))) >= @as(c_int, 'A')) and (@as(c_int, @bitCast(@as(c_uint, c))) <= @as(c_int, 'F'))) {
                c = @as(u8, @bitCast(@as(i8, @truncate((@as(c_int, @bitCast(@as(c_uint, c))) - @as(c_int, 'A')) + @as(c_int, 10)))));
            } else return @as(c_uint, @bitCast(NATS_ERR));
            res = (res << @intCast(4)) + @as(c_int, @bitCast(@as(c_uint, c)));
        }
    }
    val.* = @as(u8, @bitCast(@as(i8, @truncate(res))));
    iPtr.* += @as(usize, @bitCast(@as(isize, @intCast(@as(c_int, 5)))));
    return @as(c_uint, @bitCast(NATS_OK));
}
pub fn _jsonGetStr(arg_ptr: [*c][*c]u8, arg_value: [*c][*c]u8) callconv(.c) natsStatus {
    var ptr = arg_ptr;
    _ = &ptr;
    var value = arg_value;
    _ = &value;
    ...
    var o: [*c]u8 = ptr.*;
    _ = &o;
    while ((@as(c_int, @bitCast(@as(c_uint, p.*))) != @as(c_int, '\x00')) and (@as(c_int, @bitCast(@as(c_uint, p.*))) != @as(c_int, '"'))) {
        ...
        if (@as(c_int, @bitCast(@as(c_uint, p.*))) == @as(c_int, '\x00')) {
            o.* = '\x00';
            return nats_setErrorReal("./src/submodules/nats.c/src/util.c", "_jsonGetStr", @as(c_int, 512), @as(c_uint, @bitCast(NATS_ERR)), "error parsing string '%s': invalid control character at the end", o);
        }
        while (true) {
            switch (@as(c_int, @bitCast(@as(c_uint, p.*)))) {
                ...
                @as(c_int, 34), @as(c_int, 92), @as(c_int, 47) => {
                    (blk: {
                        const ref = &o;
                        const tmp = ref.*;
                        ref.* += 1;
                ...
                @as(c_int, 117) => {
                    {
                        var val: u8 = 0;
                        _ = &val;
                        var s: natsStatus = _decodeUni(&p, &val);
                        _ = &s;
                        if (s != @as(c_uint, @bitCast(NATS_OK))) {
                            return nats_setErrorReal("./src/submodules/nats.c/src/util.c", "_jsonGetStr", @as(c_int, 535), @as(c_uint, @bitCast(NATS_ERR)), "error parsing string '%s': invalid unicode character", p);
                        }
                        (blk: {
                            const ref = &o;
                            const tmp = ref.*;
                ...
                else => return nats_setErrorReal("./src/submodules/nats.c/src/util.c", "_jsonGetStr", @as(c_int, 544), @as(c_uint, @bitCast(NATS_ERR)), "error parsing string '%s': invalid control character", p),
            }
            break;
        }
        p += 1;
    ...
    if (@as(c_int, @bitCast(@as(c_uint, p.*))) != @as(c_int, '\x00')) {
        o.* = '\x00';
        value.* = ptr.*;
        ptr.* = p + @as(usize, @bitCast(@as(isize, @intCast(@as(c_int, 1)))));
        return @as(c_uint, @bitCast(NATS_OK));
    }
    return nats_setErrorReal("./src/submodules/nats.c/src/util.c", "_jsonGetStr", @as(c_int, 558), @as(c_uint, @bitCast(NATS_ERR)), "error parsing string '%s': unexpected end of JSON input", ptr.*);
}
pub fn _jsonGetNum(arg_ptr: [*c][*c]u8, arg_field: [*c]nats_JSONField) callconv(.c) natsStatus {
    var ptr = arg_ptr;
    _ = &ptr;
    var field = arg_field;
    _ = &field;
    var p: [*c]u8 = ptr.*;
    _ = &p;
    var expIsNegative: bool = @as(c_int, 0) != 0;
    _ = &expIsNegative;
    var uintVal: u64 = 0;
    _ = &uintVal;
    var decVal: u64 = 0;
    ...
    var decPower: u64 = 1;
    _ = &decPower;
    var sign: c_longdouble = @as(c_longdouble, @floatCast(1.0));
    _ = &sign;
    var ePower: c_longdouble = @as(c_longdouble, @floatCast(1.0));
    _ = &ePower;
    var decPCount: c_int = 0;
    _ = &decPCount;
    var numTyp: c_int = 0;
    _ = &numTyp;
    ...
    sign = @as(c_longdouble, @floatCast(if (@as(c_int, @bitCast(@as(c_uint, p.*))) == @as(c_int, '-')) -1.0 else 1.0));
    if ((@as(c_int, @bitCast(@as(c_uint, p.*))) == @as(c_int, '-')) or (@as(c_int, @bitCast(@as(c_uint, p.*))) == @as(c_int, '+'))) {
        p += 1;
    }
    while ((@as(c_int, @bitCast(@as(c_uint, (blk: {
        const tmp = @as(c_int, @bitCast(@as(c_uint, @as(u8, @bitCast(p.*)))));
        ...
        uintVal = (uintVal *% @as(u64, @bitCast(@as(c_long, @as(c_int, 10))))) +% @as(u64, @bitCast(@as(c_long, @as(c_int, @bitCast(@as(c_uint, (blk: {
            const ref = &p;
            const tmp = ref.*;
            ref.* += 1;
            break :blk tmp;
    ...
    while ((@as(c_int, @bitCast(@as(c_uint, (blk: {
        ...
        decVal = (decVal *% @as(u64, @bitCast(@as(c_long, @as(c_int, 10))))) +% @as(u64, @bitCast(@as(c_long, @as(c_int, @bitCast(@as(c_uint, (blk: {
            const ref = &p;
            const tmp = ref.*;
            ref.* += 1;
            break :blk tmp;
        }).*))) - @as(c_int, '0'))));
        decPower *%= @as(u64, @bitCast(@as(c_long, @as(c_int, 10))));
        decPCount += 1;
    }
    if ((@as(c_int, @bitCast(@as(c_uint, p.*))) == @as(c_int, 'e')) or (@as(c_int, @bitCast(@as(c_uint, p.*))) == @as(c_int, 'E'))) {
        var eVal: i64 = 0;
        _ = &eVal;
        numTyp = @as(c_int, 6);
        p += 1;
        expIsNegative = (if (@as(c_int, @bitCast(@as(c_uint, p.*))) == @as(c_int, '-')) @as(c_int, 1) else @as(c_int, 0)) != 0;
        if ((@as(c_int, @bitCast(@as(c_uint, p.*))) == @as(c_int, '-')) or (@as(c_int, @bitCast(@as(c_uint, p.*))) == @as(c_int, '+'))) {
            p += 1;
        }
        while ((@as(c_int, @bitCast(@as(c_uint, (blk: {
            ...
            eVal = (eVal * @as(i64, @bitCast(@as(c_long, @as(c_int, 10))))) + @as(i64, @bitCast(@as(c_long, @as(c_int, @bitCast(@as(c_uint, (blk: {
                const ref = &p;
                const tmp = ref.*;
                ref.* += 1;
                break :blk tmp;
        ...
        if (expIsNegative) {
            if (decPower > @as(u64, @bitCast(@as(c_long, @as(c_int, 0))))) {
                ePower = @as(c_longdouble, @floatFromInt(decPower));
            }
        } else {
            if (@as(i64, @bitCast(@as(c_long, decPCount))) > eVal) {
                eVal = @as(i64, @bitCast(@as(c_long, decPCount))) - eVal;
                expIsNegative = @as(c_int, 1) != 0;
            } else {
                eVal -= @as(i64, @bitCast(@as(c_long, decPCount)));
            }
        }
        while (eVal != @as(i64, @bitCast(@as(c_long, @as(c_int, 0))))) {
            ePower *= @as(c_longdouble, @floatFromInt(@as(c_int, 10)));
            eVal -= 1;
        }
    }
    if ((((@as(c_int, @bitCast(@as(c_uint, p.*))) != @as(c_int, ' ')) and (@as(c_int, @bitCast(@as(c_uint, p.*))) != @as(c_int, ','))) and (@as(c_int, @bitCast(@as(c_uint, p.*))) != @as(c_int, '}'))) and (@as(c_int, @bitCast(@as(c_uint, p.*))) != @as(c_int, ']'))) return nats_setErrorReal("./src/submodules/nats.c/src/util.c", "_jsonGetNum", @as(c_int, 642), @as(c_uint, @bitCast(NATS_ERR)), "error parsing number '%s': missing separator or unexpected end of JSON input", ptr.*);
    if (numTyp == @as(c_int, 6)) {
        var res: c_longdouble = @as(c_longdouble, @floatCast(0.0));
        _ = &res;
        if (decVal > @as(u64, @bitCast(@as(c_long, @as(c_int, 0))))) {
            res = sign * @as(c_longdouble, @floatFromInt((uintVal *% decPower) +% decVal));
        } else {
            res = sign * @as(c_longdouble, @floatFromInt(uintVal));
        }
        if (ePower > @as(c_longdouble, @floatFromInt(@as(c_int, 1)))) {
            if (expIsNegative) {
                res /= ePower;
            } else {
                res *= ePower;
            }
        } else if (decVal > @as(u64, @bitCast(@as(c_long, @as(c_int, 0))))) {
            res /= @as(c_longdouble, @floatFromInt(decPower));
        }
        field.*.value.vdec = res;
    } else if (sign < @as(c_longdouble, @floatFromInt(@as(c_int, 0)))) {
        numTyp = @as(c_int, 4);
        field.*.value.vint = -@as(i64, @bitCast(uintVal));
    } else {
        numTyp = @as(c_int, 5);
...
pub fn _jsonGetBool(arg_ptr: [*c][*c]u8, arg_val: [*c]bool) callconv(.c) natsStatus {
    var ptr = arg_ptr;
    _ = &ptr;
    var val = arg_val;
    _ = &val;
    if (strncmp(ptr.*, "true", @as(c_ulong, @bitCast(@as(c_long, @as(c_int, 4))))) == @as(c_int, 0)) {
        val.* = @as(c_int, 1) != 0;
        ptr.* += @as(usize, @bitCast(@as(isize, @intCast(@as(c_int, 4)))));
        return @as(c_uint, @bitCast(NATS_OK));
    } else if (strncmp(ptr.*, "false", @as(c_ulong, @bitCast(@as(c_long, @as(c_int, 5))))) == @as(c_int, 0)) {
        val.* = @as(c_int, 0) != 0;
        ptr.* += @as(usize, @bitCast(@as(isize, @intCast(@as(c_int, 5)))));
        return @as(c_uint, @bitCast(NATS_OK));
    }
    return nats_setErrorReal("./src/submodules/nats.c/src/util.c", "_jsonGetBool", @as(c_int, 697), @as(c_uint, @bitCast(NATS_ERR)), "error parsing boolean, got: '%s'", ptr.*);
}
pub fn _jsonGetArray(arg_ptr: [*c][*c]u8, arg_newArray: [*c][*c]nats_JSONArray, arg_nested: c_int) callconv(.c) natsStatus {
    var ptr = arg_ptr;
    _ = &ptr;
    var newArray = arg_newArray;
    _ = &newArray;
    var nested = arg_nested;
    _ = &nested;
    var s: natsStatus = @as(c_uint, @bitCast(NATS_OK));
    ...
    var p: [*c]u8 = ptr.*;
    _ = &p;
    var end: bool = @as(c_int, 0) != 0;
    _ = &end;
    var typ: c_int = @as(c_int, 0);
    _ = &typ;
    var field: nats_JSONField = undefined;
    _ = &field;
    var array: nats_JSONArray = undefined;
    _ = &array;
    if (nested >= jsonMaxNested) return nats_setErrorReal("./src/submodules/nats.c/src/util.c", "_jsonGetArray", @as(c_int, 711), @as(c_uint, @bitCast(NATS_ERR)), "json reached maximum nested arrays of %d", jsonMaxNested);
    _ = memset(@as(?*anyopaque, @ptrCast(&array)), @as(c_int, 0), @sizeOf(nats_JSONArray));
    while ((s == @as(c_uint, @bitCast(NATS_OK))) and (@as(c_int, @bitCast(@as(c_uint, p.*))) != @as(c_int, '\x00'))) {
        p = _jsonTrimSpace(p);
        if ((typ == @as(c_int, 0)) and (@as(c_int, @bitCast(@as(c_uint, p.*))) == @as(c_int, ']'))) {
            array.typ = @as(c_int, 9);
            end = @as(c_int, 1) != 0;
            break;
        }
        _ = memset(@as(?*anyopaque, @ptrCast(&field)), @as(c_int, 0), @sizeOf(nats_JSONField));
        ...
        if (s == @as(c_uint, @bitCast(NATS_OK))) {
            if (typ == @as(c_int, 0)) {
                ...
                while (true) {
                    switch (typ) {
                        @as(c_int, 1) => {
                            array.eltSize = @as(c_int, @bitCast(@as(c_uint, @truncate(@sizeOf([*c]u8)))));
                            break;
                        },
                        @as(c_int, 2) => {
                            array.eltSize = @as(c_int, @bitCast(@as(c_uint, @truncate(@sizeOf(bool)))));
                            break;
                        },
                        @as(c_int, 3) => {
                            array.eltSize = @as(c_int, @bitCast(@as(c_uint, @truncate(@sizeOf(c_longdouble)))));
                            break;
                        },
                        @as(c_int, 8) => {
                            array.eltSize = @as(c_int, @bitCast(@as(c_uint, @truncate(@sizeOf([*c]nats_JSON)))));
                            break;
                        },
                        @as(c_int, 7) => {
                            array.eltSize = @as(c_int, @bitCast(@as(c_uint, @truncate(@sizeOf([*c]nats_JSONArray)))));
                            break;
                        },
                        else => {
                            s = nats_setErrorReal("./src/submodules/nats.c/src/util.c", "_jsonGetArray", @as(c_int, 748), @as(c_uint, @bitCast(NATS_ERR)), "array of type %d not supported", typ);
                        },
                    }
                    break;
                }
            } else if (typ != field.typ) {
                s = nats_setErrorReal("./src/submodules/nats.c/src/util.c", "_jsonGetArray", @as(c_int, 755), @as(c_uint, @bitCast(NATS_ERR)), "array content of different types '%s'", ptr.*);
            }
        }
        if (s != @as(c_uint, @bitCast(NATS_OK))) break;
        if ((array.size + @as(c_int, 1)) > array.cap) {
            var newValues: [*c][*c]u8 = null;
            _ = &newValues;
            var newCap: c_int = @as(c_int, 2) * array.cap;
            _ = &newCap;
            if (newCap == @as(c_int, 0)) {
                newCap = 4;
            }
            newValues = @as([*c][*c]u8, @ptrCast(@alignCast(realloc(@as(?*anyopaque, @ptrCast(array.values)), @as(c_ulong, @bitCast(@as(c_long, newCap * array.eltSize)))))));
            if (newValues == @as([*c][*c]u8, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) {
                s = nats_setErrorReal("./src/submodules/nats.c/src/util.c", "_jsonGetArray", @as(c_int, 772), @as(c_uint, @bitCast(NATS_NO_MEMORY)), "%s", natsStatus_GetText(@as(c_uint, @bitCast(NATS_NO_MEMORY))));
                break;
            }
            array.values = @as([*c]?*anyopaque, @ptrCast(@alignCast(newValues)));
            array.cap = newCap;
        }
        while (true) {
            switch (typ) {
                @as(c_int, 1) => {
                    (blk: {
                        const tmp = blk_1: {
                            const ref = &array.size;
                            const tmp_2 = ref.*;
                            ref.* += 1;
                            break :blk_1 tmp_2;
                        };
                        if (tmp >= 0) break :blk @as([*c][*c]u8, @ptrCast(@alignCast(array.values))) + @as(usize, @intCast(tmp)) else break :blk @as([*c][*c]u8, @ptrCast(@alignCast(array.values))) - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
                    }).* = field.value.vstr;
                    break;
                },
                @as(c_int, 2) => {
                    (blk: {
                        ...
                        if (tmp >= 0) break :blk @as([*c]bool, @ptrCast(@alignCast(array.values))) + @as(usize, @intCast(tmp)) else break :blk @as([*c]bool, @ptrCast(@alignCast(array.values))) - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
                    }).* = field.value.vbool;
                    break;
                },
                @as(c_int, 3) => {
                    {
                        var numPtr: ?*anyopaque = @as(?*anyopaque, @ptrFromInt(@as(c_int, 0)));
                        _ = &numPtr;
                        var sz: usize = 0;
                        _ = &sz;
                        while (true) {
                            switch (field.numTyp) {
                                @as(c_int, 4) => {
                                    numPtr = @as(?*anyopaque, @ptrCast(&field.value.vint));
                                    sz = @sizeOf(i64);
                                    break;
                                },
                                @as(c_int, 5) => {
                                    numPtr = @as(?*anyopaque, @ptrCast(&field.value.vuint));
                                    sz = @sizeOf(u64);
                                    break;
                                },
                                else => {
                                    numPtr = @as(?*anyopaque, @ptrCast(&field.value.vdec));
                                    sz = @sizeOf(c_longdouble);
                                },
                            }
                            break;
                        }
                        _ = memcpy(@as(?*anyopaque, @ptrCast(@as([*c]u8, @ptrCast(@alignCast(array.values))) + @as(usize, @bitCast(@as(isize, @intCast(array.size * array.eltSize)))))), numPtr, sz);
                        array.size += 1;
                        break;
                    }
                },
                @as(c_int, 8) => {
                    (blk: {
                        ...
                        if (tmp >= 0) break :blk @as([*c][*c]nats_JSON, @ptrCast(@alignCast(array.values))) + @as(usize, @intCast(tmp)) else break :blk @as([*c][*c]nats_JSON, @ptrCast(@alignCast(array.values))) - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
                    }).* = field.value.vobj;
                    break;
                },
                @as(c_int, 7) => {
                    (blk: {
                        ...
                        if (tmp >= 0) break :blk @as([*c][*c]nats_JSONArray, @ptrCast(@alignCast(array.values))) + @as(usize, @intCast(tmp)) else break :blk @as([*c][*c]nats_JSONArray, @ptrCast(@alignCast(array.values))) - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
                    }).* = field.value.varr;
                    break;
                },
                else => {},
        ...
        if (@as(c_int, @bitCast(@as(c_uint, p.*))) == @as(c_int, ']')) {
            ...
            p += @as(usize, @bitCast(@as(isize, @intCast(@as(c_int, 1)))));
        } else {
            s = nats_setErrorReal("./src/submodules/nats.c/src/util.c", "_jsonGetArray", @as(c_int, 833), @as(c_uint, @bitCast(NATS_ERR)), "expected ',' got '%s'", p);
        }
    }
    if ((s == @as(c_uint, @bitCast(NATS_OK))) and !end) {
        s = nats_setErrorReal("./src/submodules/nats.c/src/util.c", "_jsonGetArray", @as(c_int, 840), @as(c_uint, @bitCast(NATS_ERR)), "unexpected end of array: '%s'", if (@as(c_int, @bitCast(@as(c_uint, p.*))) != @as(c_int, '\x00')) p else "NULL");
    }
    if (s == @as(c_uint, @bitCast(NATS_OK))) {
        newArray.* = @as([*c]nats_JSONArray, @ptrCast(@alignCast(malloc(@sizeOf(nats_JSONArray)))));
        if (newArray.* == @as([*c]nats_JSONArray, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) {
            s = nats_setErrorReal("./src/submodules/nats.c/src/util.c", "_jsonGetArray", @as(c_int, 847), @as(c_uint, @bitCast(NATS_NO_MEMORY)), "%s", natsStatus_GetText(@as(c_uint, @bitCast(NATS_NO_MEMORY))));
        } else {
            _ = memcpy(@as(?*anyopaque, @ptrCast(newArray.*)), @as(?*const anyopaque, @ptrCast(&array)), @sizeOf(nats_JSONArray));
            ptr.* = p + @as(usize, @bitCast(@as(isize, @intCast(@as(c_int, 1)))));
        }
    }
    if (s != @as(c_uint, @bitCast(NATS_OK))) {
        _jsonFreeArray(&array, @as(c_int, 0) != 0);
    }
    return if (s == @as(c_uint, @bitCast(NATS_OK))) s else nats_updateErrStack(s, "_jsonGetArray");
}
pub fn _base64Encode(arg_map: [*c]const u8, arg_padding: bool, arg_src: [*c]const u8, arg_srcLen: c_int, arg_pDest: [*c][*c]u8) callconv(.c) natsStatus {
    var map = arg_map;
    _ = &map;
    ...
    _ = &val;
    pDest.* = null;
    if ((src == @as([*c]const u8, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) or (srcLen == @as(c_int, 0))) return @as(c_uint, @bitCast(NATS_OK));
    n = srcLen;
    if (padding) {
        dstLen = @divTrunc(n + @as(c_int, 2), @as(c_int, 3)) * @as(c_int, 4);
    } else {
        dstLen = @divTrunc((n * @as(c_int, 8)) + @as(c_int, 5), @as(c_int, 6));
    }
    dst = @as([*c]u8, @ptrCast(@alignCast(calloc(@as(c_ulong, @bitCast(@as(c_long, @as(c_int, 1)))), @as(c_ulong, @bitCast(@as(c_long, dstLen + @as(c_int, 1))))))));
    if (dst == @as([*c]u8, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) return nats_setErrorReal("./src/submodules/nats.c/src/util.c", "_base64Encode", @as(c_int, 1812), @as(c_uint, @bitCast(NATS_NO_MEMORY)), "%s", natsStatus_GetText(@as(c_uint, @bitCast(NATS_NO_MEMORY))));
    n = @divTrunc(srcLen, @as(c_int, 3)) * @as(c_int, 3);
    {
        si = 0;
        while (si < n) {
            val = ((@as(u32, @bitCast(@as(c_uint, (blk: {
                const tmp = si + @as(c_int, 0);
                if (tmp >= 0) break :blk src + @as(usize, @intCast(tmp)) else break :blk src - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
            }).*))) << @intCast(16)) | (@as(u32, @bitCast(@as(c_uint, (blk: {
                const tmp = si + @as(c_int, 1);
                if (tmp >= 0) break :blk src + @as(usize, @intCast(tmp)) else break :blk src - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
            }).*))) << @intCast(8))) | @as(u32, @bitCast(@as(c_uint, (blk: {
                const tmp = si + @as(c_int, 2);
                if (tmp >= 0) break :blk src + @as(usize, @intCast(tmp)) else break :blk src - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
            }).*)));
            (blk: {
                const tmp = di + @as(c_int, 0);
                if (tmp >= 0) break :blk dst + @as(usize, @intCast(tmp)) else break :blk dst - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
            }).* = map[(val >> @intCast(18)) & @as(u32, @bitCast(@as(c_int, 63)))];
            (blk: {
                const tmp = di + @as(c_int, 1);
                if (tmp >= 0) break :blk dst + @as(usize, @intCast(tmp)) else break :blk dst - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
            }).* = map[(val >> @intCast(12)) & @as(u32, @bitCast(@as(c_int, 63)))];
            (blk: {
                const tmp = di + @as(c_int, 2);
                if (tmp >= 0) break :blk dst + @as(usize, @intCast(tmp)) else break :blk dst - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
            }).* = map[(val >> @intCast(6)) & @as(u32, @bitCast(@as(c_int, 63)))];
            (blk: {
                const tmp = di + @as(c_int, 3);
                if (tmp >= 0) break :blk dst + @as(usize, @intCast(tmp)) else break :blk dst - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
            }).* = map[val & @as(u32, @bitCast(@as(c_int, 63)))];
            si += @as(c_int, 3);
            di += @as(c_int, 4);
        }
    }
    remain = srcLen - si;
    if (remain == @as(c_int, 0)) {
        pDest.* = dst;
        return @as(c_uint, @bitCast(NATS_OK));
    }
    val = @as(u32, @bitCast(@as(c_uint, (blk: {
    ...
    } else if ((@as(c_int, @intFromBool(padding)) != 0) and (remain == @as(c_int, 1))) {
        (blk: {
            const tmp = di + @as(c_int, 2);
            if (tmp >= 0) break :blk dst + @as(usize, @intCast(tmp)) else break :blk dst - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
        }).* = base64Padding;
...
pub fn _base64IsValidChar(arg_c: u8, arg_paddingOk: bool) callconv(.c) bool {
    var c = arg_c;
    _ = &c;
    var paddingOk = arg_paddingOk;
    _ = &paddingOk;
    if ((((((@as(c_int, @bitCast(@as(c_uint, c))) >= @as(c_int, 'A')) and (@as(c_int, @bitCast(@as(c_uint, c))) <= @as(c_int, 'Z'))) or ((@as(c_int, @bitCast(@as(c_uint, c))) >= @as(c_int, 'a')) and (@as(c_int, @bitCast(@as(c_uint, c))) <= @as(c_int, 'z')))) or ((@as(c_int, @bitCast(@as(c_uint, c))) >= @as(c_int, '0')) and (@as(c_int, @bitCast(@as(c_uint, c))) <= @as(c_int, '9')))) or (@as(c_int, @bitCast(@as(c_uint, c))) == @as(c_int, '+'))) or (@as(c_int, @bitCast(@as(c_uint, c))) == @as(c_int, '/'))) {
        return @as(c_int, 1) != 0;
    }
    if ((@as(c_int, @bitCast(@as(c_uint, c))) == @as(c_int, @bitCast(@as(c_uint, base64Padding)))) and (@as(c_int, @intFromBool(paddingOk)) != 0)) return @as(c_int, 1) != 0;
    return @as(c_int, 0) != 0;
}
pub fn _isLineAnHeader(arg_ptr: [*c]const u8, arg_len: c_int) callconv(.c) bool {
    var ptr = arg_ptr;
    _ = &ptr;
    var len = arg_len;
    _ = &len;
    ...
    var done: bool = @as(c_int, 0) != 0;
    _ = &done;
    if (len < @as(c_int, 6)) return @as(c_int, 0) != 0;
    last = @as([*c]u8, @ptrCast(@volatileCast(@constCast((ptr + @as(usize, @bitCast(@as(isize, @intCast(len))))) - @as(usize, @bitCast(@as(isize, @intCast(@as(c_int, 1)))))))));
    while ((@as(c_int, @bitCast(@as(c_uint, last.*))) == @as(c_int, '-')) and (last != @as([*c]u8, @ptrCast(@volatileCast(@constCast(ptr)))))) {
        count += 1;
        last -= 1;
        if (count == @as(c_int, 3)) break;
    }
    if (count != @as(c_int, 3)) return @as(c_int, 0) != 0;
    count = 0;
    while (!done) {
        if (@as(c_int, @bitCast(@as(c_uint, last.*))) == @as(c_int, '-')) {
            if ((blk: {
                const ref = &count;
                ref.* += 1;
                break :blk ref.*;
            }) == @as(c_int, 3)) return @as(c_int, 1) != 0;
        } else {
            count = 0;
        }
        if (last == @as([*c]u8, @ptrCast(@volatileCast(@constCast(ptr))))) {
            done = @as(c_int, 1) != 0;
        } else {
            last -= 1;
        }
...
pub fn _scan_line(arg_start: [*c][*c]const u8, arg_next: [*c][*c]const u8) callconv(.c) c_int {
    var start = arg_start;
    _ = &start;
    var next = arg_next;
    _ = &next;
    var ptr: [*c]const u8 = next.*;
    _ = &ptr;
    var n: c_int = 0;
    _ = &n;
    while ((@as(c_int, @bitCast(@as(c_uint, ptr.*))) == @as(c_int, '\r')) or (@as(c_int, @bitCast(@as(c_uint, ptr.*))) == @as(c_int, '\n'))) {
        ptr += 1;
    }
    start.* = ptr;
    while (((@as(c_int, @bitCast(@as(c_uint, ptr.*))) != @as(c_int, '\r')) and (@as(c_int, @bitCast(@as(c_uint, ptr.*))) != @as(c_int, '\n'))) and (@as(c_int, @bitCast(@as(c_uint, ptr.*))) != @as(c_int, '\x00'))) {
        ptr += 1;
        n += 1;
    }
...
pub fn _marshalLongVal(arg_buf: [*c]natsBuffer, arg_comma: bool, arg_fieldName: [*c]const u8, arg_l: bool, arg_lval: i64, arg_uval: u64) callconv(.c) natsStatus {
    var buf = arg_buf;
    _ = &buf;
    var comma = arg_comma;
    _ = &comma;
    ...
    _ = &start;
    if (l) {
        _ = snprintf(@as([*c]u8, @ptrCast(@alignCast(&temp))), @sizeOf([32]u8), "%ld", lval);
    } else {
        _ = snprintf(@as([*c]u8, @ptrCast(@alignCast(&temp))), @sizeOf([32]u8), "%li", uval);
    }
    s = natsBuf_Append(buf, start, -@as(c_int, 1));
    if (s == @as(c_uint, @bitCast(NATS_OK))) {
        s = natsBuf_Append(buf, fieldName, -@as(c_int, 1));
    ...
    if (s == @as(c_uint, @bitCast(NATS_OK))) {
        s = natsBuf_Append(buf, @as([*c]u8, @ptrCast(@alignCast(&temp))), -@as(c_int, 1));
    }
    return if (s == @as(c_uint, @bitCast(NATS_OK))) s else nats_updateErrStack(s, "_marshalLongVal");
}
pub fn fmt_frac(arg_buf: [*c]u8, arg_w: c_int, arg_v: u64, arg_prec: c_int, arg_nw: [*c]c_int, arg_nv: [*c]u64) callconv(.c) void {
    var buf = arg_buf;
    _ = &buf;
    var w = arg_w;
    _ = &w;
    ...
    _ = &digit;
    {
        i = 0;
        while (i < prec) : (i += 1) {
            digit = @as(u8, @bitCast(@as(u8, @truncate(v % @as(u64, @bitCast(@as(c_long, @as(c_int, 10))))))));
            print = (@as(c_int, @intFromBool(print)) != 0) or (@as(c_int, @bitCast(@as(c_uint, digit))) != @as(c_int, 0));
            if (print) {
                w -= 1;
                (blk: {
                    const tmp = w;
                    if (tmp >= 0) break :blk buf + @as(usize, @intCast(tmp)) else break :blk buf - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
                }).* = @as(u8, @bitCast(@as(i8, @truncate(@as(c_int, @bitCast(@as(c_uint, digit))) + @as(c_int, '0')))));
            }
            v /= @as(u64, @bitCast(@as(c_long, @as(c_int, 10))));
        }
    }
    if (print) {
        w -= 1;
...
pub fn fmt_int(arg_buf: [*c]u8, arg_w: c_int, arg_v: u64) callconv(.c) c_int {
    var buf = arg_buf;
    _ = &buf;
    var w = arg_w;
    _ = &w;
    var v = arg_v;
    _ = &v;
    if (v == @as(u64, @bitCast(@as(c_long, @as(c_int, 0))))) {
        w -= 1;
        (blk: {
            const tmp = w;
            if (tmp >= 0) break :blk buf + @as(usize, @intCast(tmp)) else break :blk buf - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
        ...
        while (v > @as(u64, @bitCast(@as(c_long, @as(c_int, 0))))) {
            w -= 1;
            (blk: {
                const tmp = w;
                if (tmp >= 0) break :blk buf + @as(usize, @intCast(tmp)) else break :blk buf - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
            }).* = @as(u8, @bitCast(@as(u8, @truncate((v % @as(u64, @bitCast(@as(c_long, @as(c_int, 10))))) +% @as(u64, @bitCast(@as(c_long, @as(c_int, '0'))))))));
            v /= @as(u64, @bitCast(@as(c_long, @as(c_int, 10))));
        }
    }
    return w;
}
pub fn _addMD(arg_closure: ?*anyopaque, arg_fieldName: [*c]const u8, arg_f: [*c]nats_JSONField) callconv(.c) natsStatus {
    ...
    var f = arg_f;
    _ = &f;
    var md: [*c]natsMetadata = @as([*c]natsMetadata, @ptrCast(@alignCast(closure)));
    _ = &md;
    var name: [*c]u8 = strdup(fieldName);
    _ = &name;
    var value: [*c]u8 = strdup(f.*.value.vstr);
    _ = &value;
    if ((name == @as([*c]u8, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) or (value == @as([*c]u8, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0)))))))) {
        free(@as(?*anyopaque, @ptrCast(name)));
        free(@as(?*anyopaque, @ptrCast(value)));
        return nats_setErrorReal("./src/submodules/nats.c/src/util.c", "_addMD", @as(c_int, 2476), @as(c_uint, @bitCast(NATS_NO_MEMORY)), "%s", natsStatus_GetText(@as(c_uint, @bitCast(NATS_NO_MEMORY))));
    }
    (blk: {
        const tmp = md.*.Count * @as(c_int, 2);
        if (tmp >= 0) break :blk md.*.List + @as(usize, @intCast(tmp)) else break :blk md.*.List - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
    }).* = name;
    (blk: {
        const tmp = (md.*.Count * @as(c_int, 2)) + @as(c_int, 1);
        if (tmp >= 0) break :blk md.*.List + @as(usize, @intCast(tmp)) else break :blk md.*.List - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
    }).* = value;
    md.*.Count += 1;
    return @as(c_uint, @bitCast(NATS_OK));
...
// /home/g41797/dev/langs/zig-linux-x86_64-0.14.0/lib/include/__stdarg_va_arg.h:17:9
pub const va_end = @compileError("unable to translate macro: undefined identifier `__builtin_va_end`");
// /home/g41797/dev/langs/zig-linux-x86_64-0.14.0/lib/include/__stdarg_va_arg.h:19:9
pub const va_arg = @compileError("unable to translate C expr: unexpected token 'an identifier'");
// /home/g41797/dev/langs/zig-linux-x86_64-0.14.0/lib/include/__stdarg_va_arg.h:20:9
pub const __va_copy = @compileError("unable to translate macro: undefined identifier `__builtin_va_copy`");
// /home/g41797/dev/langs/zig-linux-x86_64-0.14.0/lib/include/__stdarg___va_copy.h:11:9
pub const va_copy = @compileError("unable to translate macro: undefined identifier `__builtin_va_copy`");
// /home/g41797/dev/langs/zig-linux-x86_64-0.14.0/lib/include/__stdarg_va_copy.h:11:9
...
pub const JSON_MAX_NUM_SIZE = @compileError("unable to translate: TODO long double");
// ./src/submodules/nats.c/src/util.c:29:9
pub const JSON_GET_AS = @compileError("unable to translate macro: undefined identifier `s`");
// ./src/submodules/nats.c/src/util.c:36:9
pub const JSON_ARRAY_AS = @compileError("unable to translate macro: undefined identifier `i`");
// ./src/submodules/nats.c/src/util.c:59:9
pub const JSON_ARRAY_AS_NUM = @compileError("unable to translate macro: undefined identifier `i`");
// ./src/submodules/nats.c/src/util.c:70:9
pub const JSON_GET_ARRAY = @compileError("unable to translate macro: undefined identifier `s`");
// ./src/submodules/nats.c/src/util.c:85:9
pub const ASCII_0 = @as(c_int, 48);
pub const ASCII_9 = @as(c_int, 57);
pub const JSON_STATE_START = @as(c_int, 0);
pub const JSON_STATE_NO_FIELD_YET = @as(c_int, 1);
pub const JSON_STATE_FIELD = @as(c_int, 2);
pub const JSON_STATE_SEPARATOR = @as(c_int, 3);
pub const JSON_STATE_VALUE = @as(c_int, 4);
pub const JSON_STATE_NEXT_FIELD = @as(c_int, 5);
pub const JSON_STATE_END = @as(c_int, 6);
