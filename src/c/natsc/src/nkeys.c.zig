...
pub export fn nats_Sign(arg_encodedSeed: [*c]const u8, arg_input: [*c]const u8, arg_signature: [*c][*c]u8, arg_signatureLength: [*c]c_int) natsStatus {
    var encodedSeed = arg_encodedSeed;
    _ = &encodedSeed;
    var input = arg_input;
    _ = &input;
    var signature = arg_signature;
    _ = &signature;
    var signatureLength = arg_signatureLength;
    _ = &signatureLength;
    var s: natsStatus = undefined;
    _ = &s;
    var sig: [64]u8 = undefined;
    _ = &sig;
    if ((if ((encodedSeed == @as([*c]const u8, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) or (@as(c_int, @bitCast(@as(c_uint, encodedSeed[@as(c_uint, @intCast(@as(c_int, 0)))]))) == @as(c_int, '\x00'))) @as(c_int, 1) else @as(c_int, 0)) != 0) return nats_setErrorReal("./src/submodules/nats.c/src/nkeys.c", "nats_Sign", @as(c_int, 138), @as(c_uint, @bitCast(NATS_INVALID_ARG)), "%s", "seed cannot be empty");
    if ((if ((input == @as([*c]const u8, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) or (@as(c_int, @bitCast(@as(c_uint, input[@as(c_uint, @intCast(@as(c_int, 0)))]))) == @as(c_int, '\x00'))) @as(c_int, 1) else @as(c_int, 0)) != 0) return nats_setErrorReal("./src/submodules/nats.c/src/nkeys.c", "nats_Sign", @as(c_int, 141), @as(c_uint, @bitCast(NATS_INVALID_ARG)), "%s", "input cannot be empty");
    if ((signature == @as([*c][*c]u8, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) or (signatureLength == @as([*c]c_int, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0)))))))) return nats_setErrorReal("./src/submodules/nats.c/src/nkeys.c", "nats_Sign", @as(c_int, 144), @as(c_uint, @bitCast(NATS_INVALID_ARG)), "%s", "signature and/or signatureLength cannot be NULL");
    s = natsKeys_Sign(encodedSeed, @as([*c]const u8, @ptrCast(@alignCast(input))), @as(c_int, @bitCast(@as(c_uint, @truncate(strlen(input))))), @as([*c]u8, @ptrCast(@alignCast(&sig))));
    if (s != @as(c_uint, @bitCast(NATS_OK))) return if (s == @as(c_uint, @bitCast(NATS_OK))) s else nats_updateErrStack(s, "nats_Sign");
    signature.* = @as([*c]u8, @ptrCast(@alignCast(malloc(@as(c_ulong, @bitCast(@as(c_long, @as(c_int, 64))))))));
    if (signature.* == @as([*c]u8, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) return nats_setErrorReal("./src/submodules/nats.c/src/nkeys.c", "nats_Sign", @as(c_int, 152), @as(c_uint, @bitCast(NATS_NO_MEMORY)), "%s", natsStatus_GetText(@as(c_uint, @bitCast(NATS_NO_MEMORY))));
    _ = memcpy(@as(?*anyopaque, @ptrCast(signature.*)), @as(?*const anyopaque, @ptrCast(@as([*c]u8, @ptrCast(@alignCast(&sig))))), @as(c_ulong, @bitCast(@as(c_long, @as(c_int, 64)))));
    signatureLength.* = 64;
...
pub export fn natsKeys_Sign(arg_encodedSeed: [*c]const u8, arg_input: [*c]const u8, arg_inputLen: c_int, arg_signature: [*c]u8) natsStatus {
    var encodedSeed = arg_encodedSeed;
    _ = &encodedSeed;
    var input = arg_input;
    _ = &input;
    ...
    var seedLen: c_int = 0;
    _ = &seedLen;
    if ((input != @as([*c]const u8, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) and (inputLen == @as(c_int, 0))) {
        inputLen = @as(c_int, @bitCast(@as(c_uint, @truncate(strlen(@as([*c]u8, @ptrCast(@volatileCast(@constCast(input)))))))));
    }
    seedLen = @as(c_int, @bitCast(@as(c_uint, @truncate((strlen(encodedSeed) *% @as(c_ulong, @bitCast(@as(c_long, @as(c_int, 5))))) / @as(c_ulong, @bitCast(@as(c_long, @as(c_int, 8))))))));
    seed = @as([*c]u8, @ptrCast(@alignCast(calloc(@as(c_ulong, @bitCast(@as(c_long, @as(c_int, 1)))), @as(c_ulong, @bitCast(@as(c_long, seedLen)))))));
    if (seed == @as([*c]u8, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) {
        s = nats_setErrorReal("./src/submodules/nats.c/src/nkeys.c", "natsKeys_Sign", @as(c_int, 111), @as(c_uint, @bitCast(NATS_NO_MEMORY)), "%s", natsStatus_GetText(@as(c_uint, @bitCast(NATS_NO_MEMORY))));
    }
    if (s == @as(c_uint, @bitCast(NATS_OK))) {
        s = _decodeSeed(encodedSeed, seed, seedLen);
    }
    if (s == @as(c_uint, @bitCast(NATS_OK))) {
        s = natsCrypto_Sign(@as([*c]const u8, @ptrCast(@alignCast(seed + @as(usize, @bitCast(@as(isize, @intCast(@as(c_int, 2)))))))), input, inputLen, signature);
    }
    if (seed != @as([*c]u8, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) {
        natsCrypto_Clear(@as(?*anyopaque, @ptrCast(seed)), seedLen);
        free(@as(?*anyopaque, @ptrCast(seed)));
    }
    return if (s == @as(c_uint, @bitCast(NATS_OK))) s else nats_updateErrStack(s, "natsKeys_Sign");
}
pub fn _getUInt16LittleEndian(arg_src: [*c]u8) callconv(.c) u16 {
    var src = arg_src;
    _ = &src;
    var b0: u16 = @as(u16, @bitCast(@as(c_short, @truncate(@as(c_int, @bitCast(@as(c_uint, src[@as(c_uint, @intCast(@as(c_int, 0)))]))) & @as(c_int, 255)))));
    _ = &b0;
    var b1: u16 = @as(u16, @bitCast(@as(c_short, @truncate(@as(c_int, @bitCast(@as(c_uint, src[@as(c_uint, @intCast(@as(c_int, 1)))]))) & @as(c_int, 255)))));
    _ = &b1;
    return @as(u16, @bitCast(@as(c_short, @truncate(@as(c_int, @bitCast(@as(c_uint, b0))) | (@as(c_int, @bitCast(@as(c_uint, b1))) << @intCast(8))))));
}
pub fn _isValidPublicPrefixByte(arg_b: u8) callconv(.c) bool {
    var b = arg_b;
    _ = &b;
    while (true) {
        switch (@as(c_int, @bitCast(@as(c_uint, b)))) {
            @as(c_int, @bitCast(@as(c_uint, @as(u8, -96)))), @as(c_int, @bitCast(@as(c_uint, @as(u8, 104)))), @as(c_int, @bitCast(@as(c_uint, @as(u8, 16)))), @as(c_int, @bitCast(@as(c_uint, @as(u8, 0)))) => return @as(c_int, 1) != 0,
...
pub fn _decodeSeed(arg_seed: [*c]const u8, arg_raw: [*c]u8, arg_rawMax: c_int) callconv(.c) natsStatus {
    var seed = arg_seed;
    _ = &seed;
    var raw = arg_raw;
    _ = &raw;
    var rawMax = arg_rawMax;
    _ = &rawMax;
    var s: natsStatus = @as(c_uint, @bitCast(NATS_OK));
    _ = &s;
    var crc: u16 = 0;
    ...
    if (s != @as(c_uint, @bitCast(NATS_OK))) return if (s == @as(c_uint, @bitCast(NATS_OK))) s else nats_updateErrStack(s, "_decodeSeed");
    if (rawLen < @as(c_int, 4)) return nats_setErrorReal("./src/submodules/nats.c/src/nkeys.c", "_decodeSeed", @as(c_int, 76), @as(c_uint, @bitCast(NATS_ERR)), "%s", "invalid encoded key");
    crc = _getUInt16LittleEndian((raw + @as(usize, @bitCast(@as(isize, @intCast(rawLen))))) - @as(usize, @bitCast(@as(isize, @intCast(@as(c_int, 2))))));
    if (!nats_CRC16_Validate(@as([*c]u8, @ptrCast(@alignCast(raw))), rawLen - @as(c_int, 2), crc)) return nats_setErrorReal("./src/submodules/nats.c/src/nkeys.c", "_decodeSeed", @as(c_int, 83), @as(c_uint, @bitCast(NATS_ERR)), "%s", "invalid checksum");
    b1 = @as(u8, @bitCast(@as(i8, @truncate(@as(c_int, @bitCast(@as(c_uint, raw[@as(c_uint, @intCast(@as(c_int, 0)))]))) & @as(c_int, 248)))));
    b2 = @as(u8, @bitCast(@as(i8, @truncate(((@as(c_int, @bitCast(@as(c_uint, raw[@as(c_uint, @intCast(@as(c_int, 0)))]))) & @as(c_int, 7)) << @intCast(5)) | ((@as(c_int, @bitCast(@as(c_uint, raw[@as(c_uint, @intCast(@as(c_int, 1)))]))) & @as(c_int, 248)) >> @intCast(3))))));
    if (@as(c_int, @bitCast(@as(c_uint, b1))) != @as(c_int, @bitCast(@as(c_uint, @as(u8, @bitCast(@as(i8, @truncate(@as(c_int, 18) << @intCast(3))))))))) return nats_setErrorReal("./src/submodules/nats.c/src/nkeys.c", "_decodeSeed", @as(c_int, 90), @as(c_uint, @bitCast(NATS_ERR)), "%s", "invalid seed");
    if (!_isValidPublicPrefixByte(b2)) return nats_setErrorReal("./src/submodules/nats.c/src/nkeys.c", "_decodeSeed", @as(c_int, 93), @as(c_uint, @bitCast(NATS_ERR)), "%s", "invalid prefix byte");
    return @as(c_uint, @bitCast(NATS_OK));
}
...
pub const PREFIX_BYTE_SEED = @import("std").zig.c_translation.cast(u8, @as(c_int, 18) << @as(c_int, 3));
pub const PREFIX_BYTE_PRIVATE = @import("std").zig.c_translation.cast(u8, @as(c_int, 15) << @as(c_int, 3));
pub const PREFIX_BYTE_SERVER = @import("std").zig.c_translation.cast(u8, @as(c_int, 13) << @as(c_int, 3));
pub const PREFIX_BYTE_CLUSTER = @import("std").zig.c_translation.cast(u8, @as(c_int, 2) << @as(c_int, 3));
pub const PREFIX_BYTE_ACCOUNT = @import("std").zig.c_translation.cast(u8, @as(c_int, 0));
pub const PREFIX_BYTE_USER = @import("std").zig.c_translation.cast(u8, @as(c_int, 20) << @as(c_int, 3));
