...
pub export fn natsConnection_Subscribe(arg_sub: [*c][*c]natsSubscription, arg_nc: [*c]natsConnection, arg_subject: [*c]const u8, arg_cb: natsMsgHandler, arg_cbClosure: ?*anyopaque) natsStatus {
    var sub = arg_sub;
    _ = &sub;
    var nc = arg_nc;
    _ = &nc;
    ...
    _ = &s;
    if (cb == @as(natsMsgHandler, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) return nats_setErrorReal("./src/submodules/nats.c/src/sub.c", "natsConnection_Subscribe", @as(c_int, 446), @as(c_uint, @bitCast(NATS_INVALID_ARG)), "%s", natsStatus_GetText(@as(c_uint, @bitCast(NATS_INVALID_ARG))));
    s = natsConn_subscribeImpl(sub, nc, @as(c_int, 1) != 0, subject, null, @as(i64, @bitCast(@as(c_long, @as(c_int, 0)))), cb, cbClosure, @as(c_int, 0) != 0, null);
    return if (s == @as(c_uint, @bitCast(NATS_OK))) s else nats_updateErrStack(s, "natsConnection_Subscribe");
}
pub export fn natsConnection_SubscribeTimeout(arg_sub: [*c][*c]natsSubscription, arg_nc: [*c]natsConnection, arg_subject: [*c]const u8, arg_timeout: i64, arg_cb: natsMsgHandler, arg_cbClosure: ?*anyopaque) natsStatus {
    var sub = arg_sub;
    _ = &sub;
    var nc = arg_nc;
    _ = &nc;
    ...
    var s: natsStatus = undefined;
    _ = &s;
    if ((cb == @as(natsMsgHandler, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) or (timeout <= @as(i64, @bitCast(@as(c_long, @as(c_int, 0)))))) return nats_setErrorReal("./src/submodules/nats.c/src/sub.c", "natsConnection_SubscribeTimeout", @as(c_int, 467), @as(c_uint, @bitCast(NATS_INVALID_ARG)), "%s", natsStatus_GetText(@as(c_uint, @bitCast(NATS_INVALID_ARG))));
    s = natsConn_subscribeImpl(sub, nc, @as(c_int, 1) != 0, subject, null, timeout, cb, cbClosure, @as(c_int, 0) != 0, null);
    return if (s == @as(c_uint, @bitCast(NATS_OK))) s else nats_updateErrStack(s, "natsConnection_SubscribeTimeout");
}
pub export fn natsConnection_SubscribeSync(arg_sub: [*c][*c]natsSubscription, arg_nc: [*c]natsConnection, arg_subject: [*c]const u8) natsStatus {
    var sub = arg_sub;
    _ = &sub;
    var nc = arg_nc;
    _ = &nc;
    ...
    var s: natsStatus = undefined;
    _ = &s;
    s = natsConn_subscribeImpl(sub, nc, @as(c_int, 1) != 0, subject, null, @as(i64, @bitCast(@as(c_long, @as(c_int, 0)))), null, @as(?*anyopaque, @ptrFromInt(@as(c_int, 0))), @as(c_int, 0) != 0, null);
    return if (s == @as(c_uint, @bitCast(NATS_OK))) s else nats_updateErrStack(s, "natsConnection_SubscribeSync");
}
pub export fn natsConnection_QueueSubscribe(arg_sub: [*c][*c]natsSubscription, arg_nc: [*c]natsConnection, arg_subject: [*c]const u8, arg_queueGroup: [*c]const u8, arg_cb: natsMsgHandler, arg_cbClosure: ?*anyopaque) natsStatus {
    var sub = arg_sub;
    _ = &sub;
    var nc = arg_nc;
    _ = &nc;
    ...
    var s: natsStatus = undefined;
    _ = &s;
    if (((queueGroup == @as([*c]const u8, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) or (strlen(queueGroup) == @as(c_ulong, @bitCast(@as(c_long, @as(c_int, 0)))))) or (cb == @as(natsMsgHandler, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0)))))))) return nats_setErrorReal("./src/submodules/nats.c/src/sub.c", "natsConnection_QueueSubscribe", @as(c_int, 501), @as(c_uint, @bitCast(NATS_INVALID_ARG)), "%s", natsStatus_GetText(@as(c_uint, @bitCast(NATS_INVALID_ARG))));
    s = natsConn_subscribeImpl(sub, nc, @as(c_int, 1) != 0, subject, queueGroup, @as(i64, @bitCast(@as(c_long, @as(c_int, 0)))), cb, cbClosure, @as(c_int, 0) != 0, null);
    return if (s == @as(c_uint, @bitCast(NATS_OK))) s else nats_updateErrStack(s, "natsConnection_QueueSubscribe");
}
pub export fn natsConnection_QueueSubscribeTimeout(arg_sub: [*c][*c]natsSubscription, arg_nc: [*c]natsConnection, arg_subject: [*c]const u8, arg_queueGroup: [*c]const u8, arg_timeout: i64, arg_cb: natsMsgHandler, arg_cbClosure: ?*anyopaque) natsStatus {
    var sub = arg_sub;
    _ = &sub;
    var nc = arg_nc;
    _ = &nc;
    ...
    var s: natsStatus = undefined;
    _ = &s;
    if ((((queueGroup == @as([*c]const u8, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) or (strlen(queueGroup) == @as(c_ulong, @bitCast(@as(c_long, @as(c_int, 0)))))) or (cb == @as(natsMsgHandler, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0)))))))) or (timeout <= @as(i64, @bitCast(@as(c_long, @as(c_int, 0)))))) {
        return nats_setErrorReal("./src/submodules/nats.c/src/sub.c", "natsConnection_QueueSubscribeTimeout", @as(c_int, 524), @as(c_uint, @bitCast(NATS_INVALID_ARG)), "%s", natsStatus_GetText(@as(c_uint, @bitCast(NATS_INVALID_ARG))));
    }
    s = natsConn_subscribeImpl(sub, nc, @as(c_int, 1) != 0, subject, queueGroup, timeout, cb, cbClosure, @as(c_int, 0) != 0, null);
    return if (s == @as(c_uint, @bitCast(NATS_OK))) s else nats_updateErrStack(s, "natsConnection_QueueSubscribeTimeout");
}
pub export fn natsConnection_QueueSubscribeSync(arg_sub: [*c][*c]natsSubscription, arg_nc: [*c]natsConnection, arg_subject: [*c]const u8, arg_queueGroup: [*c]const u8) natsStatus {
    var sub = arg_sub;
    _ = &sub;
    var nc = arg_nc;
    _ = &nc;
    ...
    var s: natsStatus = undefined;
    _ = &s;
    if ((queueGroup == @as([*c]const u8, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) or (strlen(queueGroup) == @as(c_ulong, @bitCast(@as(c_long, @as(c_int, 0)))))) return nats_setErrorReal("./src/submodules/nats.c/src/sub.c", "natsConnection_QueueSubscribeSync", @as(c_int, 542), @as(c_uint, @bitCast(NATS_INVALID_ARG)), "%s", natsStatus_GetText(@as(c_uint, @bitCast(NATS_INVALID_ARG))));
    s = natsConn_subscribeImpl(sub, nc, @as(c_int, 1) != 0, subject, queueGroup, @as(i64, @bitCast(@as(c_long, @as(c_int, 0)))), null, @as(?*anyopaque, @ptrFromInt(@as(c_int, 0))), @as(c_int, 0) != 0, null);
    return if (s == @as(c_uint, @bitCast(NATS_OK))) s else nats_updateErrStack(s, "natsConnection_QueueSubscribeSync");
}
pub export fn natsSubscription_NoDeliveryDelay(arg_sub: [*c]natsSubscription) natsStatus {
    var sub = arg_sub;
    _ = &sub;
    if (sub == @as([*c]natsSubscription, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) return nats_setErrorReal("./src/submodules/nats.c/src/sub.c", "natsSubscription_NoDeliveryDelay", @as(c_int, 562), @as(c_uint, @bitCast(NATS_INVALID_ARG)), "%s", natsStatus_GetText(@as(c_uint, @bitCast(NATS_INVALID_ARG))));
    return @as(c_uint, @bitCast(NATS_OK));
}
pub export fn natsSubscription_NextMsg(arg_nextMsg: [*c][*c]natsMsg, arg_sub: [*c]natsSubscription, arg_timeout: i64) natsStatus {
    var nextMsg = arg_nextMsg;
    _ = &nextMsg;
    var sub = arg_sub;
    _ = &sub;
    var timeout = arg_timeout;
    _ = &timeout;
    var s: natsStatus = natsSub_nextMsg(nextMsg, sub, timeout, @as(c_int, 0) != 0);
    _ = &s;
    return if (s == @as(c_uint, @bitCast(NATS_OK))) s else nats_updateErrStack(s, "natsSubscription_NextMsg");
}
pub export fn natsSubscription_Unsubscribe(arg_sub: [*c]natsSubscription) natsStatus {
    var sub = arg_sub;
    _ = &sub;
    var s: natsStatus = _unsubscribe(sub, @as(c_int, 0), @as(c_int, 0) != 0, @as(i64, @bitCast(@as(c_long, @as(c_int, 0)))));
    _ = &s;
    return if (s == @as(c_uint, @bitCast(NATS_OK))) s else nats_updateErrStack(s, "natsSubscription_Unsubscribe");
}
pub export fn natsSubscription_AutoUnsubscribe(arg_sub: [*c]natsSubscription, arg_max: c_int) natsStatus {
    var sub = arg_sub;
    _ = &sub;
    var max = arg_max;
    _ = &max;
    var s: natsStatus = _unsubscribe(sub, max, @as(c_int, 0) != 0, @as(i64, @bitCast(@as(c_long, @as(c_int, 0)))));
    _ = &s;
    return if (s == @as(c_uint, @bitCast(NATS_OK))) s else nats_updateErrStack(s, "natsSubscription_AutoUnsubscribe");
}
pub export fn natsSubscription_QueuedMsgs(arg_sub: [*c]natsSubscription, arg_queuedMsgs: [*c]u64) natsStatus {
    var sub = arg_sub;
    _ = &sub;
    var queuedMsgs = arg_queuedMsgs;
    _ = &queuedMsgs;
    var s: natsStatus = undefined;
    _ = &s;
    var msgs: c_int = 0;
    _ = &msgs;
    if (queuedMsgs == @as([*c]u64, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) return nats_setErrorReal("./src/submodules/nats.c/src/sub.c", "natsSubscription_QueuedMsgs", @as(c_int, 1046), @as(c_uint, @bitCast(NATS_INVALID_ARG)), "%s", natsStatus_GetText(@as(c_uint, @bitCast(NATS_INVALID_ARG))));
    s = natsSubscription_GetPending(sub, &msgs, null);
    if (s == @as(c_uint, @bitCast(NATS_OK))) {
        queuedMsgs.* = @as(u64, @bitCast(@as(c_long, msgs)));
    }
    return s;
}
pub export fn natsSubscription_GetID(arg_sub: [*c]natsSubscription) i64 {
    var sub = arg_sub;
    _ = &sub;
    var id: i64 = 0;
    _ = &id;
    if (sub == @as([*c]natsSubscription, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) return 0;
    natsSub_Lock(sub);
    if (sub.*.closed) {
        natsSub_Unlock(sub);
        return 0;
...
pub export fn natsSubscription_GetSubject(arg_sub: [*c]natsSubscription) [*c]const u8 {
    var sub = arg_sub;
    _ = &sub;
    var subject: [*c]const u8 = null;
    _ = &subject;
    if (sub == @as([*c]natsSubscription, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) return null;
    natsSub_Lock(sub);
    if (sub.*.closed) {
        natsSub_Unlock(sub);
        return null;
    }
    subject = @as([*c]const u8, @ptrCast(@alignCast(sub.*.subject)));
    natsSub_Unlock(sub);
    return subject;
}
pub export fn natsSubscription_SetPendingLimits(arg_sub: [*c]natsSubscription, arg_msgLimit: c_int, arg_bytesLimit: c_int) natsStatus {
    var sub = arg_sub;
    _ = &sub;
    var msgLimit = arg_msgLimit;
    _ = &msgLimit;
    var bytesLimit = arg_bytesLimit;
    _ = &bytesLimit;
    if (sub == @as([*c]natsSubscription, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) return nats_setErrorReal("./src/submodules/nats.c/src/sub.c", "natsSubscription_SetPendingLimits", @as(c_int, 1132), @as(c_uint, @bitCast(NATS_INVALID_ARG)), "%s", natsStatus_GetText(@as(c_uint, @bitCast(NATS_INVALID_ARG))));
    if ((msgLimit == @as(c_int, 0)) or (bytesLimit == @as(c_int, 0))) return nats_setErrorReal("./src/submodules/nats.c/src/sub.c", "natsSubscription_SetPendingLimits", @as(c_int, 1136), @as(c_uint, @bitCast(NATS_INVALID_ARG)), "%s", "Limits must be either > 0 or negative to specify no limit");
    nats_lockSubAndDispatcher(sub);
    if (sub.*.closed) {
        nats_unlockSubAndDispatcher(sub);
        return nats_setErrorReal("./src/submodules/nats.c/src/sub.c", "natsSubscription_SetPendingLimits", @as(c_int, 1143), @as(c_uint, @bitCast(NATS_INVALID_SUBSCRIPTION)), "%s", natsStatus_GetText(@as(c_uint, @bitCast(NATS_INVALID_SUBSCRIPTION))));
    }
...
pub export fn natsSubscription_GetPendingLimits(arg_sub: [*c]natsSubscription, arg_msgLimit: [*c]c_int, arg_bytesLimit: [*c]c_int) natsStatus {
    var sub = arg_sub;
    _ = &sub;
    var msgLimit = arg_msgLimit;
    _ = &msgLimit;
    var bytesLimit = arg_bytesLimit;
    _ = &bytesLimit;
    if (sub == @as([*c]natsSubscription, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) return nats_setErrorReal("./src/submodules/nats.c/src/sub.c", "natsSubscription_GetPendingLimits", @as(c_int, 1158), @as(c_uint, @bitCast(NATS_INVALID_ARG)), "%s", natsStatus_GetText(@as(c_uint, @bitCast(NATS_INVALID_ARG))));
    nats_lockSubAndDispatcher(sub);
    if (sub.*.closed) {
        nats_unlockSubAndDispatcher(sub);
        return nats_setErrorReal("./src/submodules/nats.c/src/sub.c", "natsSubscription_GetPendingLimits", @as(c_int, 1165), @as(c_uint, @bitCast(NATS_INVALID_SUBSCRIPTION)), "%s", natsStatus_GetText(@as(c_uint, @bitCast(NATS_INVALID_SUBSCRIPTION))));
    }
    if (msgLimit != @as([*c]c_int, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) {
        msgLimit.* = sub.*.msgsLimit;
    }
    if (bytesLimit != @as([*c]c_int, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) {
        bytesLimit.* = sub.*.bytesLimit;
    }
    nats_unlockSubAndDispatcher(sub);
    return @as(c_uint, @bitCast(NATS_OK));
}
pub export fn natsSubscription_GetPending(arg_sub: [*c]natsSubscription, arg_msgs: [*c]c_int, arg_bytes: [*c]c_int) natsStatus {
    var sub = arg_sub;
    _ = &sub;
    var msgs = arg_msgs;
    _ = &msgs;
    var bytes = arg_bytes;
    _ = &bytes;
    if (sub == @as([*c]natsSubscription, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) return nats_setErrorReal("./src/submodules/nats.c/src/sub.c", "natsSubscription_GetPending", @as(c_int, 1107), @as(c_uint, @bitCast(NATS_INVALID_ARG)), "%s", natsStatus_GetText(@as(c_uint, @bitCast(NATS_INVALID_ARG))));
    nats_lockSubAndDispatcher(sub);
    if (sub.*.closed) {
        nats_unlockSubAndDispatcher(sub);
        return nats_setErrorReal("./src/submodules/nats.c/src/sub.c", "natsSubscription_GetPending", @as(c_int, 1114), @as(c_uint, @bitCast(NATS_INVALID_SUBSCRIPTION)), "%s", natsStatus_GetText(@as(c_uint, @bitCast(NATS_INVALID_SUBSCRIPTION))));
    }
    if (msgs != @as([*c]c_int, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) {
        msgs.* = sub.*.ownDispatcher.queue.msgs;
    }
    if (bytes != @as([*c]c_int, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) {
        bytes.* = sub.*.ownDispatcher.queue.bytes;
    }
    nats_unlockSubAndDispatcher(sub);
    return @as(c_uint, @bitCast(NATS_OK));
}
pub export fn natsSubscription_GetDelivered(arg_sub: [*c]natsSubscription, arg_msgs: [*c]i64) natsStatus {
    var sub = arg_sub;
    _ = &sub;
    var msgs = arg_msgs;
    _ = &msgs;
    if ((sub == @as([*c]natsSubscription, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) or (msgs == @as([*c]i64, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0)))))))) return nats_setErrorReal("./src/submodules/nats.c/src/sub.c", "natsSubscription_GetDelivered", @as(c_int, 1183), @as(c_uint, @bitCast(NATS_INVALID_ARG)), "%s", natsStatus_GetText(@as(c_uint, @bitCast(NATS_INVALID_ARG))));
    nats_lockSubAndDispatcher(sub);
    if (sub.*.closed) {
        nats_unlockSubAndDispatcher(sub);
        return nats_setErrorReal("./src/submodules/nats.c/src/sub.c", "natsSubscription_GetDelivered", @as(c_int, 1190), @as(c_uint, @bitCast(NATS_INVALID_SUBSCRIPTION)), "%s", natsStatus_GetText(@as(c_uint, @bitCast(NATS_INVALID_SUBSCRIPTION))));
    }
    msgs.* = @as(i64, @bitCast(sub.*.delivered));
    nats_unlockSubAndDispatcher(sub);
    return @as(c_uint, @bitCast(NATS_OK));
}
pub export fn natsSubscription_GetDropped(arg_sub: [*c]natsSubscription, arg_msgs: [*c]i64) natsStatus {
    var sub = arg_sub;
    _ = &sub;
    var msgs = arg_msgs;
    _ = &msgs;
    if ((sub == @as([*c]natsSubscription, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) or (msgs == @as([*c]i64, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0)))))))) return nats_setErrorReal("./src/submodules/nats.c/src/sub.c", "natsSubscription_GetDropped", @as(c_int, 1204), @as(c_uint, @bitCast(NATS_INVALID_ARG)), "%s", natsStatus_GetText(@as(c_uint, @bitCast(NATS_INVALID_ARG))));
    nats_lockSubAndDispatcher(sub);
    if (sub.*.closed) {
        nats_unlockSubAndDispatcher(sub);
        return nats_setErrorReal("./src/submodules/nats.c/src/sub.c", "natsSubscription_GetDropped", @as(c_int, 1211), @as(c_uint, @bitCast(NATS_INVALID_SUBSCRIPTION)), "%s", natsStatus_GetText(@as(c_uint, @bitCast(NATS_INVALID_SUBSCRIPTION))));
    }
    msgs.* = sub.*.dropped;
    nats_unlockSubAndDispatcher(sub);
    return @as(c_uint, @bitCast(NATS_OK));
}
pub export fn natsSubscription_GetMaxPending(arg_sub: [*c]natsSubscription, arg_msgs: [*c]c_int, arg_bytes: [*c]c_int) natsStatus {
    var sub = arg_sub;
    _ = &sub;
    var msgs = arg_msgs;
    _ = &msgs;
    var bytes = arg_bytes;
    _ = &bytes;
    if (sub == @as([*c]natsSubscription, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) return nats_setErrorReal("./src/submodules/nats.c/src/sub.c", "natsSubscription_GetMaxPending", @as(c_int, 1225), @as(c_uint, @bitCast(NATS_INVALID_ARG)), "%s", natsStatus_GetText(@as(c_uint, @bitCast(NATS_INVALID_ARG))));
    nats_lockSubAndDispatcher(sub);
    if (sub.*.closed) {
        nats_unlockSubAndDispatcher(sub);
        return nats_setErrorReal("./src/submodules/nats.c/src/sub.c", "natsSubscription_GetMaxPending", @as(c_int, 1232), @as(c_uint, @bitCast(NATS_INVALID_SUBSCRIPTION)), "%s", natsStatus_GetText(@as(c_uint, @bitCast(NATS_INVALID_SUBSCRIPTION))));
    }
    if (msgs != @as([*c]c_int, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) {
        msgs.* = sub.*.msgsMax;
    }
...
pub export fn natsSubscription_ClearMaxPending(arg_sub: [*c]natsSubscription) natsStatus {
    var sub = arg_sub;
    _ = &sub;
    if (sub == @as([*c]natsSubscription, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) return nats_setErrorReal("./src/submodules/nats.c/src/sub.c", "natsSubscription_ClearMaxPending", @as(c_int, 1250), @as(c_uint, @bitCast(NATS_INVALID_ARG)), "%s", natsStatus_GetText(@as(c_uint, @bitCast(NATS_INVALID_ARG))));
    nats_lockSubAndDispatcher(sub);
    if (sub.*.closed) {
        nats_unlockSubAndDispatcher(sub);
        return nats_setErrorReal("./src/submodules/nats.c/src/sub.c", "natsSubscription_ClearMaxPending", @as(c_int, 1256), @as(c_uint, @bitCast(NATS_INVALID_SUBSCRIPTION)), "%s", natsStatus_GetText(@as(c_uint, @bitCast(NATS_INVALID_SUBSCRIPTION))));
    }
    sub.*.msgsMax = 0;
    sub.*.bytesMax = 0;
    nats_unlockSubAndDispatcher(sub);
...
pub export fn natsSubscription_GetStats(arg_sub: [*c]natsSubscription, arg_pendingMsgs: [*c]c_int, arg_pendingBytes: [*c]c_int, arg_maxPendingMsgs: [*c]c_int, arg_maxPendingBytes: [*c]c_int, arg_deliveredMsgs: [*c]i64, arg_droppedMsgs: [*c]i64) natsStatus {
    var sub = arg_sub;
    _ = &sub;
    var pendingMsgs = arg_pendingMsgs;
    _ = &pendingMsgs;
    var pendingBytes = arg_pendingBytes;
    _ = &pendingBytes;
    var maxPendingMsgs = arg_maxPendingMsgs;
    _ = &maxPendingMsgs;
    var maxPendingBytes = arg_maxPendingBytes;
    _ = &maxPendingBytes;
    var deliveredMsgs = arg_deliveredMsgs;
    _ = &deliveredMsgs;
    var droppedMsgs = arg_droppedMsgs;
    _ = &droppedMsgs;
    if (sub == @as([*c]natsSubscription, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) return nats_setErrorReal("./src/submodules/nats.c/src/sub.c", "natsSubscription_GetStats", @as(c_int, 1277), @as(c_uint, @bitCast(NATS_INVALID_ARG)), "%s", natsStatus_GetText(@as(c_uint, @bitCast(NATS_INVALID_ARG))));
    nats_lockSubAndDispatcher(sub);
    if (sub.*.closed) {
        nats_unlockSubAndDispatcher(sub);
        return nats_setErrorReal("./src/submodules/nats.c/src/sub.c", "natsSubscription_GetStats", @as(c_int, 1284), @as(c_uint, @bitCast(NATS_INVALID_SUBSCRIPTION)), "%s", natsStatus_GetText(@as(c_uint, @bitCast(NATS_INVALID_SUBSCRIPTION))));
    }
    if (pendingMsgs != @as([*c]c_int, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) {
        pendingMsgs.* = sub.*.ownDispatcher.queue.msgs;
    }
    if (pendingBytes != @as([*c]c_int, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) {
        pendingBytes.* = sub.*.ownDispatcher.queue.bytes;
    }
    if (maxPendingMsgs != @as([*c]c_int, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) {
        maxPendingMsgs.* = sub.*.msgsMax;
    }
    if (maxPendingBytes != @as([*c]c_int, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) {
        maxPendingBytes.* = sub.*.bytesMax;
    }
    if (deliveredMsgs != @as([*c]i64, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) {
        deliveredMsgs.* = @as(i64, @bitCast(@as(c_long, @as(c_int, @bitCast(@as(c_uint, @truncate(sub.*.delivered)))))));
    }
    if (droppedMsgs != @as([*c]i64, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) {
        droppedMsgs.* = sub.*.dropped;
    }
    nats_unlockSubAndDispatcher(sub);
    return @as(c_uint, @bitCast(NATS_OK));
}
pub export fn natsSubscription_IsValid(arg_sub: [*c]natsSubscription) bool {
    var sub = arg_sub;
    _ = &sub;
    var valid: bool = @as(c_int, 0) != 0;
    _ = &valid;
    if (sub == @as([*c]natsSubscription, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) return @as(c_int, 0) != 0;
    natsSub_Lock(sub);
    valid = !sub.*.closed;
    natsSub_Unlock(sub);
    return valid;
}
pub export fn natsSubscription_Drain(arg_sub: [*c]natsSubscription) natsStatus {
    var sub = arg_sub;
    _ = &sub;
    var s: natsStatus = undefined;
    _ = &s;
    s = _unsubscribe(sub, @as(c_int, 0), @as(c_int, 1) != 0, @as(i64, @bitCast(@as(c_long, @as(c_int, 30000)))));
    return if (s == @as(c_uint, @bitCast(NATS_OK))) s else nats_updateErrStack(s, "natsSubscription_Drain");
}
pub export fn natsSubscription_DrainTimeout(arg_sub: [*c]natsSubscription, arg_timeout: i64) natsStatus {
    var sub = arg_sub;
    _ = &sub;
    var timeout = arg_timeout;
    _ = &timeout;
    var s: natsStatus = undefined;
    _ = &s;
    s = _unsubscribe(sub, @as(c_int, 0), @as(c_int, 1) != 0, timeout);
    return if (s == @as(c_uint, @bitCast(NATS_OK))) s else nats_updateErrStack(s, "natsSubscription_DrainTimeout");
}
pub export fn natsSubscription_WaitForDrainCompletion(arg_sub: [*c]natsSubscription, arg_timeout: i64) natsStatus {
    var sub = arg_sub;
    _ = &sub;
    var timeout = arg_timeout;
    _ = &timeout;
    ...
    var deadline: i64 = 0;
    _ = &deadline;
    var dc: bool = @as(c_int, 0) != 0;
    _ = &dc;
    if (sub == @as([*c]natsSubscription, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) return nats_setErrorReal("./src/submodules/nats.c/src/sub.c", "natsSubscription_WaitForDrainCompletion", @as(c_int, 984), @as(c_uint, @bitCast(NATS_INVALID_ARG)), "%s", natsStatus_GetText(@as(c_uint, @bitCast(NATS_INVALID_ARG))));
    natsSub_Lock(sub);
    if (!((@as(c_int, @bitCast(@as(c_uint, sub.*.drainState))) & @as(c_int, @bitCast(@as(c_uint, @as(u8, @bitCast(@as(i8, @truncate(@as(c_int, 1))))))))) != @as(c_int, 0))) {
        natsSub_Unlock(sub);
        return nats_setErrorReal("./src/submodules/nats.c/src/sub.c", "natsSubscription_WaitForDrainCompletion", @as(c_int, 990), @as(c_uint, @bitCast(NATS_ILLEGAL_STATE)), "%s", "Subscription not in draining mode");
    }
    _ = blk: {
        const ref = &sub.*.refs;
        ref.* += 1;
    ...
    dc = (if (sub.*.jsi != @as([*c]jsSub, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) @as(c_int, @intFromBool(sub.*.jsi.*.dc)) else @as(c_int, 0)) != 0;
    if (timeout > @as(i64, @bitCast(@as(c_long, @as(c_int, 0))))) {
        deadline = nats_setTargetTime(timeout);
    }
    while ((s != @as(c_uint, @bitCast(NATS_TIMEOUT))) and !((@as(c_int, @bitCast(@as(c_uint, sub.*.drainState))) & @as(c_int, @bitCast(@as(c_uint, @as(u8, @bitCast(@as(i8, @truncate(@as(c_int, 2))))))))) != @as(c_int, 0))) {
        if (timeout > @as(i64, @bitCast(@as(c_long, @as(c_int, 0))))) {
    ...
    natsSub_Unlock(sub);
    if ((s == @as(c_uint, @bitCast(NATS_OK))) and (@as(c_int, @intFromBool(dc)) != 0)) {
        s = jsSub_deleteConsumer(sub);
    }
    natsSub_release(sub);
    return s;
}
pub export fn natsSubscription_DrainCompletionStatus(arg_sub: [*c]natsSubscription) natsStatus {
    var sub = arg_sub;
    _ = &sub;
    var s: natsStatus = undefined;
    _ = &s;
    if (sub == @as([*c]natsSubscription, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) return nats_setErrorReal("./src/submodules/nats.c/src/sub.c", "natsSubscription_DrainCompletionStatus", @as(c_int, 1024), @as(c_uint, @bitCast(NATS_INVALID_ARG)), "%s", natsStatus_GetText(@as(c_uint, @bitCast(NATS_INVALID_ARG))));
    natsSub_Lock(sub);
    if (!((@as(c_int, @bitCast(@as(c_uint, sub.*.drainState))) & @as(c_int, @bitCast(@as(c_uint, @as(u8, @bitCast(@as(i8, @truncate(@as(c_int, 2))))))))) != @as(c_int, 0))) {
        s = @as(c_uint, @bitCast(NATS_ILLEGAL_STATE));
    } else {
        s = sub.*.drainStatus;
    }
    natsSub_Unlock(sub);
...
pub export fn natsSubscription_SetOnCompleteCB(arg_sub: [*c]natsSubscription, arg_cb: natsOnCompleteCB, arg_closure: ?*anyopaque) natsStatus {
    var sub = arg_sub;
    _ = &sub;
    var cb = arg_cb;
    _ = &cb;
    ...
    var s: natsStatus = @as(c_uint, @bitCast(NATS_OK));
    _ = &s;
    if (sub == @as([*c]natsSubscription, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) return nats_setErrorReal("./src/submodules/nats.c/src/sub.c", "natsSubscription_SetOnCompleteCB", @as(c_int, 235), @as(c_uint, @bitCast(NATS_INVALID_ARG)), "%s", natsStatus_GetText(@as(c_uint, @bitCast(NATS_INVALID_ARG))));
    natsSub_Lock(sub);
    if ((@as(c_int, @intFromBool(sub.*.closed)) != 0) or (sub.*.msgCb == @as(natsMsgHandler, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0)))))))) {
        s = nats_setErrorReal("./src/submodules/nats.c/src/sub.c", "natsSubscription_SetOnCompleteCB", @as(c_int, 239), @as(c_uint, @bitCast(NATS_INVALID_SUBSCRIPTION)), "%s", natsStatus_GetText(@as(c_uint, @bitCast(NATS_INVALID_SUBSCRIPTION))));
    } else {
        sub.*.onCompleteCB = cb;
...
pub export fn natsSubscription_Destroy(arg_sub: [*c]natsSubscription) void {
    var sub = arg_sub;
    _ = &sub;
    var doUnsub: bool = @as(c_int, 0) != 0;
    _ = &doUnsub;
    if (sub == @as([*c]natsSubscription, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) return;
    natsSub_Lock(sub);
    doUnsub = !sub.*.closed;
    if ((@as(c_int, @intFromBool(doUnsub)) != 0) and (sub.*.max > @as(u64, @bitCast(@as(c_long, @as(c_int, 0)))))) {
...
pub export fn natsSub_unlockRelease(arg_sub: [*c]natsSubscription) void {
    var sub = arg_sub;
    _ = &sub;
    var refs: c_int = 0;
    _ = &refs;
...
pub export fn natsSub_release(arg_sub: [*c]natsSubscription) void {
    var sub = arg_sub;
    _ = &sub;
    var refs: c_int = 0;
    _ = &refs;
...
pub export fn natsSub_create(arg_newSub: [*c][*c]natsSubscription, arg_nc: [*c]natsConnection, arg_subj: [*c]const u8, arg_queueGroup: [*c]const u8, arg_timeout: i64, arg_cb: natsMsgHandler, arg_cbClosure: ?*anyopaque, arg_forReplies: bool, arg_jsi: [*c]jsSub) natsStatus {
    ...
    _ = &sub;
    sub = @as([*c]natsSubscription, @ptrCast(@alignCast(calloc(@as(c_ulong, @bitCast(@as(c_long, @as(c_int, 1)))), @sizeOf(natsSubscription)))));
    if (sub == @as([*c]natsSubscription, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) return nats_setErrorReal("./src/submodules/nats.c/src/sub.c", "natsSub_create", @as(c_int, 354), @as(c_uint, @bitCast(NATS_NO_MEMORY)), "%s", natsStatus_GetText(@as(c_uint, @bitCast(NATS_NO_MEMORY))));
    s = natsMutex_Create(&sub.*.mu);
    if (s != @as(c_uint, @bitCast(NATS_OK))) {
        free(@as(?*anyopaque, @ptrCast(sub)));
        return if (s == @as(c_uint, @bitCast(NATS_OK))) s else nats_updateErrStack(s, "natsSub_create");
    }
    natsConn_retain(nc);
    sub.*.refs = 1;
    sub.*.conn = nc;
    ...
    sub.*.bytesLimit = if (nc.*.opts.*.maxPendingBytes == @as(i64, @bitCast(@as(c_long, -@as(c_int, 1))))) nc.*.opts.*.maxPendingMsgs * @as(c_int, 1024) else @as(c_int, @bitCast(@as(c_int, @truncate(nc.*.opts.*.maxPendingBytes))));
    sub.*.jsi = jsi;
    sub.*.subject = strdup(subj);
    if (sub.*.subject == @as([*c]u8, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) {
        s = nats_setErrorReal("./src/submodules/nats.c/src/sub.c", "natsSub_create", @as(c_int, 376), @as(c_uint, @bitCast(NATS_NO_MEMORY)), "%s", natsStatus_GetText(@as(c_uint, @bitCast(NATS_NO_MEMORY))));
    }
    if (((s == @as(c_uint, @bitCast(NATS_OK))) and (queueGroup != @as([*c]const u8, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0)))))))) and (strlen(queueGroup) > @as(c_ulong, @bitCast(@as(c_long, @as(c_int, 0)))))) {
        sub.*.queue = strdup(queueGroup);
        if (sub.*.queue == @as([*c]u8, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) {
            s = nats_setErrorReal("./src/submodules/nats.c/src/sub.c", "natsSub_create", @as(c_int, 382), @as(c_uint, @bitCast(NATS_NO_MEMORY)), "%s", natsStatus_GetText(@as(c_uint, @bitCast(NATS_NO_MEMORY))));
        }
    }
    if (s == @as(c_uint, @bitCast(NATS_OK))) {
    ...
    var useShared: bool = (if (@as(c_int, @intFromBool(forReplies)) != 0) @as(c_int, @intFromBool(nc.*.opts.*.useSharedReplyDispatcher)) else @as(c_int, @intFromBool(nc.*.opts.*.useSharedDispatcher))) != 0;
    _ = &useShared;
    var useAsyncThread: bool = cb != @as(natsMsgHandler, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))));
    _ = &useAsyncThread;
    if ((s == @as(c_uint, @bitCast(NATS_OK))) and (@as(c_int, @intFromBool(useAsyncThread)) != 0)) {
    ...
    if (s == @as(c_uint, @bitCast(NATS_OK))) {
        ...
        } else if ((@as(c_int, @intFromBool(useShared)) != 0) and !forReplies) {
            s = nats_assignSubToDispatch(sub);
            if ((s == @as(c_uint, @bitCast(NATS_OK))) and (timeout > @as(i64, @bitCast(@as(c_long, @as(c_int, 0)))))) {
                _ = blk: {
                    const ref = &sub.*.refs;
                    ref.* += 1;
                    break :blk ref.*;
                };
                s = natsTimer_Create(&sub.*.timeoutTimer, &_asyncTimeoutCb, &_asyncTimeoutStopCb, timeout, @as(?*anyopaque, @ptrCast(sub)));
                if (s != @as(c_uint, @bitCast(NATS_OK))) {
                    _ = blk: {
                        const ref = &sub.*.refs;
                        ref.* -= 1;
...
pub export fn natsSub_setMax(arg_sub: [*c]natsSubscription, arg_max: u64) bool {
    var sub = arg_sub;
    _ = &sub;
    var max = arg_max;
    _ = &max;
    var accepted: bool = @as(c_int, 0) != 0;
    _ = &accepted;
    nats_lockSubAndDispatcher(sub);
    sub.*.max = if (max <= sub.*.delivered) @as(u64, @bitCast(@as(c_long, @as(c_int, 0)))) else max;
    accepted = sub.*.max != @as(u64, @bitCast(@as(c_long, @as(c_int, 0))));
    nats_unlockSubAndDispatcher(sub);
    return accepted;
}
pub export fn natsSub_initDrain(arg_sub: [*c]natsSubscription) void {
    var sub = arg_sub;
    _ = &sub;
    natsSub_Lock(sub);
    sub.*.drainState |= @as(u8, @bitCast(@as(i8, @truncate(@as(c_int, @bitCast(@as(c_uint, @as(u8, @bitCast(@as(i8, @truncate(@as(c_int, 1))))))))))));
    natsSub_Unlock(sub);
}
pub export fn natsSub_startDrain(arg_sub: [*c]natsSubscription, arg_timeout: i64) natsStatus {
    var sub = arg_sub;
    _ = &sub;
    var timeout = arg_timeout;
    _ = &timeout;
    ...
    if (testDrainAutoUnsubRace) {
        nats_Sleep(@as(i64, @bitCast(@as(c_long, @as(c_int, 1)))));
    }
    natsSub_Lock(sub);
    if ((@as(c_int, @bitCast(@as(c_uint, sub.*.drainState))) & @as(c_int, @bitCast(@as(c_uint, @as(u8, @bitCast(@as(i8, @truncate(@as(c_int, 1))))))))) != @as(c_int, 0)) {
        natsSub_Unlock(sub);
    ...
    if (s == @as(c_uint, @bitCast(NATS_OK))) {
        s = natsThread_Create(&sub.*.drainThread, &_flushAndDrain, @as(?*anyopaque, @ptrCast(sub)));
    }
    if (s == @as(c_uint, @bitCast(NATS_OK))) {
    ...
    natsSub_Unlock(sub);
    return if (s == @as(c_uint, @bitCast(NATS_OK))) s else nats_updateErrStack(s, "natsSub_startDrain");
}
pub export fn natsSub_setDrainCompleteState(arg_sub: [*c]natsSubscription) void {
    var sub = arg_sub;
    _ = &sub;
    natsSub_Lock(sub);
...
pub export fn natsSub_setDrainSkip(arg_sub: [*c]natsSubscription, arg_s: natsStatus) void {
    var sub = arg_sub;
    _ = &sub;
    var s = arg_s;
    _ = &s;
    ...
    sub.*.drainSkip = @as(c_int, 1) != 0;
    nats_unlockSubAndDispatcher(sub);
}
pub export fn natsSub_updateDrainStatus(arg_sub: [*c]natsSubscription, arg_s: natsStatus) void {
    var sub = arg_sub;
    _ = &sub;
    var s = arg_s;
    _ = &s;
...
pub export fn natsSub_drain(arg_sub: [*c]natsSubscription) void {
    var sub = arg_sub;
    _ = &sub;
    nats_lockSubAndDispatcher(sub);
    if (sub.*.closed) {
    ...
    sub.*.draining = @as(c_int, 1) != 0;
    if (sub.*.timeout != @as(i64, @bitCast(@as(c_long, @as(c_int, 0))))) {
...
pub export fn natsSub_nextMsg(arg_nextMsg: [*c][*c]natsMsg, arg_sub: [*c]natsSubscription, arg_timeout: i64, arg_pullSubInternal: bool) natsStatus {
    var nextMsg = arg_nextMsg;
    _ = &nextMsg;
    var sub = arg_sub;
    _ = &sub;
    var timeout = arg_timeout;
    _ = &timeout;
    var pullSubInternal = arg_pullSubInternal;
    _ = &pullSubInternal;
    var s: natsStatus = @as(c_uint, @bitCast(NATS_OK));
    _ = &s;
    ...
    _ = &msg;
    var removeSub: bool = @as(c_int, 0) != 0;
    _ = &removeSub;
    var target: i64 = 0;
    _ = &target;
    ...
    _ = &fcReply;
    if ((sub == @as([*c]natsSubscription, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) or (nextMsg == @as([*c][*c]natsMsg, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0)))))))) return nats_setErrorReal("./src/submodules/nats.c/src/sub.c", "natsSub_nextMsg", @as(c_int, 579), @as(c_uint, @bitCast(NATS_INVALID_ARG)), "%s", natsStatus_GetText(@as(c_uint, @bitCast(NATS_INVALID_ARG))));
    natsSub_Lock(sub);
    if (sub.*.connClosed) {
        natsSub_Unlock(sub);
        return nats_setErrorReal("./src/submodules/nats.c/src/sub.c", "natsSub_nextMsg", @as(c_int, 587), @as(c_uint, @bitCast(NATS_CONNECTION_CLOSED)), "%s", natsStatus_GetText(@as(c_uint, @bitCast(NATS_CONNECTION_CLOSED))));
    }
    if (sub.*.closed) {
        if ((sub.*.max > @as(u64, @bitCast(@as(c_long, @as(c_int, 0))))) and (sub.*.delivered >= sub.*.max)) {
            s = @as(c_uint, @bitCast(NATS_MAX_DELIVERED_MSGS));
        } else {
            s = @as(c_uint, @bitCast(NATS_INVALID_SUBSCRIPTION));
        }
        natsSub_Unlock(sub);
        return nats_setErrorReal("./src/submodules/nats.c/src/sub.c", "natsSub_nextMsg", @as(c_int, 598), s, "%s", natsStatus_GetText(s));
    }
    if (sub.*.msgCb != @as(natsMsgHandler, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) {
        natsSub_Unlock(sub);
        return nats_setErrorReal("./src/submodules/nats.c/src/sub.c", "natsSub_nextMsg", @as(c_int, 604), @as(c_uint, @bitCast(NATS_ILLEGAL_STATE)), "%s", natsStatus_GetText(@as(c_uint, @bitCast(NATS_ILLEGAL_STATE))));
    }
    if (sub.*.slowConsumer) {
        sub.*.slowConsumer = @as(c_int, 0) != 0;
        natsSub_Unlock(sub);
        return nats_setErrorReal("./src/submodules/nats.c/src/sub.c", "natsSub_nextMsg", @as(c_int, 611), @as(c_uint, @bitCast(NATS_SLOW_CONSUMER)), "%s", natsStatus_GetText(@as(c_uint, @bitCast(NATS_SLOW_CONSUMER))));
    }
    if (sub.*.jsi != @as([*c]jsSub, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) {
        if (sub.*.jsi.*.sm) {
            sub.*.jsi.*.sm = @as(c_int, 0) != 0;
            natsSub_Unlock(sub);
            return nats_setErrorReal("./src/submodules/nats.c/src/sub.c", "natsSub_nextMsg", @as(c_int, 620), @as(c_uint, @bitCast(NATS_MISMATCH)), "%s", "consumer sequence mismatch");
        } else if (!pullSubInternal and (@as(c_int, @intFromBool(sub.*.jsi.*.pull)) != 0)) {
            natsSub_Unlock(sub);
            return nats_setErrorReal("./src/submodules/nats.c/src/sub.c", "natsSub_nextMsg", @as(c_int, 625), @as(c_uint, @bitCast(NATS_INVALID_SUBSCRIPTION)), "%s", "not applicable to JetStream pull subscriptions");
        }
    }
    nc = sub.*.conn;
    jsi = sub.*.jsi;
    if (timeout > @as(i64, @bitCast(@as(c_long, @as(c_int, 0))))) {
        while ((((sub.*.ownDispatcher.queue.msgs == @as(c_int, 0)) and (s != @as(c_uint, @bitCast(NATS_TIMEOUT)))) and !sub.*.closed) and !sub.*.draining) {
            ...
            if (s != @as(c_uint, @bitCast(NATS_OK))) {
                s = nats_setErrorReal("./src/submodules/nats.c/src/sub.c", "natsSub_nextMsg", @as(c_int, 641), s, "%s", natsStatus_GetText(s));
            }
        }
        if (sub.*.connClosed) {
            s = nats_setErrorReal("./src/submodules/nats.c/src/sub.c", "natsSub_nextMsg", @as(c_int, 645), @as(c_uint, @bitCast(NATS_CONNECTION_CLOSED)), "%s", natsStatus_GetText(@as(c_uint, @bitCast(NATS_CONNECTION_CLOSED))));
        } else if (sub.*.closed) {
            s = nats_setErrorReal("./src/submodules/nats.c/src/sub.c", "natsSub_nextMsg", @as(c_int, 647), @as(c_uint, @bitCast(NATS_INVALID_SUBSCRIPTION)), "%s", natsStatus_GetText(@as(c_uint, @bitCast(NATS_INVALID_SUBSCRIPTION))));
        }
    } else {
        s = @as(c_uint, @bitCast(if (sub.*.ownDispatcher.queue.msgs == @as(c_int, 0)) NATS_TIMEOUT else NATS_OK));
        if ((s != @as(c_uint, @bitCast(NATS_OK))) and !pullSubInternal) {
            s = nats_setErrorReal("./src/submodules/nats.c/src/sub.c", "natsSub_nextMsg", @as(c_int, 653), s, "%s", natsStatus_GetText(s));
        }
    }
    if (s == @as(c_uint, @bitCast(NATS_OK))) {
        msg = sub.*.ownDispatcher.queue.head;
        if ((msg == @as([*c]natsMsg, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) and (@as(c_int, @intFromBool(sub.*.draining)) != 0)) {
            removeSub = @as(c_int, 1) != 0;
            ...
            if (sub.*.max > @as(u64, @bitCast(@as(c_long, @as(c_int, 0))))) {
                if (sub.*.delivered > sub.*.max) {
                    s = nats_setErrorReal("./src/submodules/nats.c/src/sub.c", "natsSub_nextMsg", @as(c_int, 682), @as(c_uint, @bitCast(NATS_MAX_DELIVERED_MSGS)), "%s", natsStatus_GetText(@as(c_uint, @bitCast(NATS_MAX_DELIVERED_MSGS))));
                } else if (sub.*.delivered == sub.*.max) {
                    removeSub = @as(c_int, 1) != 0;
                }
            }
            if ((@as(c_int, @intFromBool(sub.*.draining)) != 0) and (sub.*.ownDispatcher.queue.msgs == @as(c_int, 0))) {
                removeSub = @as(c_int, 1) != 0;
            }
        }
        if (removeSub) {
    ...
    if ((s == @as(c_uint, @bitCast(NATS_OK))) and (@as(c_int, @intFromBool(natsMsg_IsNoResponders(msg))) != 0)) {
        natsMsg_Destroy(msg);
    ...
    if ((@as(c_int, @intFromBool(pullSubInternal)) != 0) and (s == @as(c_uint, @bitCast(NATS_TIMEOUT)))) return s;
    return if (s == @as(c_uint, @bitCast(NATS_OK))) s else nats_updateErrStack(s, "natsSub_nextMsg");
}
pub export fn natsSub_close(arg_sub: [*c]natsSubscription, arg_connectionClosed: bool) void {
    var sub = arg_sub;
    _ = &sub;
    var connectionClosed = arg_connectionClosed;
    _ = &connectionClosed;
    nats_lockSubAndDispatcher(sub);
    if (!sub.*.closed) {
        sub.*.closed = @as(c_int, 1) != 0;
        sub.*.connClosed = connectionClosed;
        if (sub.*.jsi != @as([*c]jsSub, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) {
            if (sub.*.jsi.*.hbTimer != @as([*c]natsTimer, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) {
                natsTimer_Stop(sub.*.jsi.*.hbTimer);
            }
            if ((sub.*.jsi.*.fetch != @as([*c]jsFetch, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) and (sub.*.jsi.*.fetch.*.expiresTimer != @as([*c]natsTimer, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0)))))))) {
...
pub export fn nats_createControlMessages(arg_sub: [*c]natsSubscription) natsStatus {
    var sub = arg_sub;
    _ = &sub;
    var s: natsStatus = @as(c_uint, @bitCast(NATS_OK));
    _ = &s;
    if (sub.*.control != @as([*c]natsSubscriptionControlMessages, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) return @as(c_uint, @bitCast(NATS_OK));
    sub.*.control = @as([*c]natsSubscriptionControlMessages, @ptrCast(@alignCast(calloc(@as(c_ulong, @bitCast(@as(c_long, @as(c_int, 1)))), @sizeOf(natsSubscriptionControlMessages)))));
    if (sub.*.control == @as([*c]natsSubscriptionControlMessages, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) return nats_setErrorReal("./src/submodules/nats.c/src/sub.c", "nats_createControlMessages", @as(c_int, 333), @as(c_uint, @bitCast(NATS_NO_MEMORY)), "%s", natsStatus_GetText(@as(c_uint, @bitCast(NATS_NO_MEMORY))));
    if (s == @as(c_uint, @bitCast(NATS_OK))) {
        s = _createControlMessage(&sub.*.control.*.sub.timeout, sub);
    }
    if (s == @as(c_uint, @bitCast(NATS_OK))) {
        s = _createControlMessage(&sub.*.control.*.sub.close, sub);
    }
    if (s == @as(c_uint, @bitCast(NATS_OK))) {
        s = _createControlMessage(&sub.*.control.*.sub.drain, sub);
    }
    if (s == @as(c_uint, @bitCast(NATS_OK))) {
        s = _createControlMessage(&sub.*.control.*.fetch.expired, sub);
    }
    if (s == @as(c_uint, @bitCast(NATS_OK))) {
        s = _createControlMessage(&sub.*.control.*.fetch.missedHeartbeat, sub);
    }
    return if (s == @as(c_uint, @bitCast(NATS_OK))) s else nats_updateErrStack(s, "nats_createControlMessages");
}
...
pub fn _destroyControlMessage(arg_msg: [*c]natsMsg) callconv(.c) void {
    var msg = arg_msg;
    _ = &msg;
...
pub fn _freeControlMessages(arg_sub: [*c]natsSubscription) callconv(.c) void {
    var sub = arg_sub;
    _ = &sub;
    if (sub.*.control == @as([*c]natsSubscriptionControlMessages, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) return;
    ...
    free(@as(?*anyopaque, @ptrCast(sub.*.control)));
}
pub fn _createControlMessage(arg_msg: [*c][*c]natsMsg, arg_sub: [*c]natsSubscription) callconv(.c) natsStatus {
    var msg = arg_msg;
    _ = &msg;
    var sub = arg_sub;
    _ = &sub;
    var s: natsStatus = natsMsg_create(msg, null, @as(c_int, 0), null, @as(c_int, 0), null, @as(c_int, 0), -@as(c_int, 1));
    _ = &s;
    if (s == @as(c_uint, @bitCast(NATS_OK))) {
        _ = blk: {
            const ref = &msg.*.*.flags;
...
pub fn _initOwnDispatcher(arg_sub: [*c]natsSubscription) callconv(.c) natsStatus {
    var sub = arg_sub;
    _ = &sub;
    var s: natsStatus = @as(c_uint, @bitCast(NATS_OK));
    _ = &s;
    if (sub.*.ownDispatcher.ownedBy != @as([*c]natsSubscription, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) return nats_setErrorReal("./src/submodules/nats.c/src/sub.c", "_initOwnDispatcher", @as(c_int, 84), @as(c_uint, @bitCast(NATS_ILLEGAL_STATE)), "%s", natsStatus_GetText(@as(c_uint, @bitCast(NATS_ILLEGAL_STATE))));
    sub.*.ownDispatcher.ownedBy = sub;
    sub.*.ownDispatcher.mu = sub.*.mu;
    s = natsCondition_Create(&sub.*.ownDispatcher.cond);
    return if (s == @as(c_uint, @bitCast(NATS_OK))) s else nats_updateErrStack(s, "_initOwnDispatcher");
}
pub fn _cleanupOwnDispatcher(arg_sub: [*c]natsSubscription) callconv(.c) void {
    var sub = arg_sub;
    _ = &sub;
    nats_destroyQueuedMessages(&sub.*.ownDispatcher.queue);
    if (sub.*.ownDispatcher.thread != @as([*c]natsThread, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) {
...
pub fn _freeSub(arg_sub: [*c]natsSubscription) callconv(.c) void {
    var sub = arg_sub;
    _ = &sub;
    if (sub == @as([*c]natsSubscription, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) return;
    ...
    free(@as(?*anyopaque, @ptrCast(sub.*.queue)));
...
pub fn _setDrainCompleteState(arg_sub: [*c]natsSubscription) callconv(.c) void {
    var sub = arg_sub;
    _ = &sub;
    if (!((@as(c_int, @bitCast(@as(c_uint, sub.*.drainState))) & @as(c_int, @bitCast(@as(c_uint, @as(u8, @bitCast(@as(i8, @truncate(@as(c_int, 2))))))))) != @as(c_int, 0))) {
        if (((sub.*.jsi != @as([*c]jsSub, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) and ((@as(c_int, @bitCast(@as(c_uint, sub.*.drainState))) & @as(c_int, @bitCast(@as(c_uint, @as(u8, @bitCast(@as(i8, @truncate(@as(c_int, 1))))))))) != @as(c_int, 0))) and (@as(c_int, @intFromBool(sub.*.jsi.*.dc)) != 0)) {
            jsSub_deleteConsumerAfterDrain(sub);
            if ((@as(c_int, @bitCast(@as(c_uint, sub.*.drainState))) & @as(c_int, @bitCast(@as(c_uint, @as(u8, @bitCast(@as(i8, @truncate(@as(c_int, 2))))))))) != @as(c_int, 0)) return;
        }
        if (sub.*.drainStatus == @as(c_uint, @bitCast(NATS_OK))) {
            if (sub.*.connClosed) {
                sub.*.drainStatus = @as(c_uint, @bitCast(NATS_CONNECTION_CLOSED));
            } else if (sub.*.closed) {
                sub.*.drainStatus = @as(c_uint, @bitCast(NATS_INVALID_SUBSCRIPTION));
            }
        }
        sub.*.drainState |= @as(u8, @bitCast(@as(i8, @truncate(@as(c_int, @bitCast(@as(c_uint, @as(u8, @bitCast(@as(i8, @truncate(@as(c_int, 2))))))))))));
        natsCondition_Broadcast(sub.*.drainCond);
    }
}
pub fn _runOwnDispatcher(arg_sub: [*c]natsSubscription, arg_forReplies: bool) callconv(.c) natsStatus {
    var sub = arg_sub;
    _ = &sub;
    var forReplies = arg_forReplies;
    _ = &forReplies;
    var s: natsStatus = @as(c_uint, @bitCast(NATS_OK));
    _ = &s;
    if (sub.*.ownDispatcher.thread != @as([*c]natsThread, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) return @as(c_uint, @bitCast(NATS_ILLEGAL_STATE));
    sub.*.dispatcher = &sub.*.ownDispatcher;
    s = natsThread_Create(&sub.*.ownDispatcher.thread, &nats_dispatchThreadOwn, @as(?*anyopaque, @ptrCast(sub)));
    return s;
}
pub fn _asyncTimeoutCb(arg_timer: [*c]natsTimer, arg_closure: ?*anyopaque) callconv(.c) void {
    var timer = arg_timer;
    _ = &timer;
    var closure = arg_closure;
    _ = &closure;
    ...
    _ = &sub;
    if (sub.*.dispatcher == @as([*c]natsDispatcher, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) return;
    nats_lockSubAndDispatcher(sub);
    if ((!sub.*.closed and !sub.*.timedOut) and !sub.*.timeoutSuspended) {
        sub.*.timedOut = @as(c_int, 1) != 0;
        natsTimer_Reset(sub.*.timeoutTimer, @as(i64, @bitCast(@as(c_long, (@as(c_int, 60) * @as(c_int, 60)) * @as(c_int, 1000)))));
        natsSub_enqueueMessage(sub, sub.*.control.*.sub.timeout);
    }
    nats_unlockSubAndDispatcher(sub);
}
pub fn _asyncTimeoutStopCb(arg_timer: [*c]natsTimer, arg_closure: ?*anyopaque) callconv(.c) void {
    var timer = arg_timer;
    _ = &timer;
    var closure = arg_closure;
    _ = &closure;
...
pub fn _unsubscribe(arg_sub: [*c]natsSubscription, arg_max: c_int, arg_drainMode: bool, arg_timeout: i64) callconv(.c) natsStatus {
    var sub = arg_sub;
    _ = &sub;
    var max = arg_max;
    _ = &max;
    ...
    _ = &jsi;
    if (sub == @as([*c]natsSubscription, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) return nats_setErrorReal("./src/submodules/nats.c/src/sub.c", "_unsubscribe", @as(c_int, 743), @as(c_uint, @bitCast(NATS_INVALID_ARG)), "%s", natsStatus_GetText(@as(c_uint, @bitCast(NATS_INVALID_ARG))));
    natsSub_Lock(sub);
    nc = sub.*.conn;
    _ = blk: {
        const ref = &sub.*.refs;
    ...
    if ((max == @as(c_int, 0)) and ((blk: {
        const tmp = sub.*.jsi;
        jsi = tmp;
        break :blk tmp;
    }) != @as([*c]jsSub, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0)))))))) {
        if (jsi.*.hbTimer != @as([*c]natsTimer, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) {
            natsTimer_Stop(jsi.*.hbTimer);
        }
        if ((jsi.*.fetch != @as([*c]jsFetch, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) and (jsi.*.fetch.*.expiresTimer != @as([*c]natsTimer, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0)))))))) {
    ...
    if ((((s == @as(c_uint, @bitCast(NATS_OK))) and (max == @as(c_int, 0))) and !drainMode) and (@as(c_int, @intFromBool(dc)) != 0)) {
        s = jsSub_deleteConsumer(sub);
    }
    natsSub_release(sub);
    return if (s == @as(c_uint, @bitCast(NATS_OK))) s else nats_updateErrStack(s, "_unsubscribe");
}
pub fn _updateDrainStatus(arg_sub: [*c]natsSubscription, arg_s: natsStatus) callconv(.c) void {
    var sub = arg_sub;
    _ = &sub;
    var s = arg_s;
    _ = &s;
...
pub fn _flushAndDrain(arg_closure: ?*anyopaque) callconv(.c) void {
    ...
    sync_1 = (if (sub.*.msgCb == @as(natsMsgHandler, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) @as(c_int, 1) else @as(c_int, 0)) != 0;
    natsSub_Unlock(sub);
    if (timeout < @as(i64, @bitCast(@as(c_long, @as(c_int, 0))))) {
        timeout = 0;
    } else {
    ...
    if (timeout > @as(i64, @bitCast(@as(c_long, @as(c_int, 0))))) {
        ...
        natsSub_Lock(sub);
        if (((@as(c_int, @intFromBool(sync_1)) != 0) and !((@as(c_int, @bitCast(@as(c_uint, sub.*.drainState))) & @as(c_int, @bitCast(@as(c_uint, @as(u8, @bitCast(@as(i8, @truncate(@as(c_int, 2))))))))) != @as(c_int, 0))) and (sub.*.ownDispatcher.queue.msgs == @as(c_int, 0))) {
            _setDrainCompleteState(sub);
        } else {
            while ((s != @as(c_uint, @bitCast(NATS_TIMEOUT))) and !((@as(c_int, @bitCast(@as(c_uint, sub.*.drainState))) & @as(c_int, @bitCast(@as(c_uint, @as(u8, @bitCast(@as(i8, @truncate(@as(c_int, 2))))))))) != @as(c_int, 0))) {
                s = natsCondition_AbsoluteTimedWait(sub.*.drainCond, sub.*.mu, deadline);
...
pub const GLIB_H_ = "";
pub const _retain = @compileError("TODO unary inc/dec expr");
// ./src/submodules/nats.c/src/sub.c:35:9
pub const _release = @compileError("TODO unary inc/dec expr");
// ./src/submodules/nats.c/src/sub.c:36:9
