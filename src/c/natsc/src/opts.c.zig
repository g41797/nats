...
pub export fn natsOptions_Create(arg_newOpts: [*c][*c]natsOptions) natsStatus {
    var newOpts = arg_newOpts;
    _ = &newOpts;
    ...
    opts = @as([*c]natsOptions, @ptrCast(@alignCast(calloc(@as(c_ulong, @bitCast(@as(c_long, @as(c_int, 1)))), @sizeOf(natsOptions)))));
    if (opts == @as([*c]natsOptions, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) return nats_setErrorReal("./src/submodules/nats.c/src/opts.c", "natsOptions_Create", @as(c_int, 1541), @as(c_uint, @bitCast(NATS_NO_MEMORY)), "%s", natsStatus_GetText(@as(c_uint, @bitCast(NATS_NO_MEMORY))));
    if (s == @as(c_uint, @bitCast(NATS_OK))) {
        s = natsMutex_Create(&opts.*.mu);
    }
    if (s != @as(c_uint, @bitCast(NATS_OK))) {
        free(@as(?*anyopaque, @ptrCast(opts)));
        return if (NATS_NO_MEMORY == NATS_OK) @as(c_uint, @bitCast(NATS_NO_MEMORY)) else nats_updateErrStack(@as(c_uint, @bitCast(NATS_NO_MEMORY)), "natsOptions_Create");
    }
    opts.*.allowReconnect = @as(c_int, 1) != 0;
    opts.*.secure = @as(c_int, 0) != 0;
    opts.*.maxReconnect = @as(c_int, 60);
    opts.*.reconnectWait = @as(i64, @bitCast(@as(c_long, @as(c_int, 2) * @as(c_int, 1000))));
    opts.*.pingInterval = @as(i64, @bitCast(@as(c_long, (@as(c_int, 2) * @as(c_int, 60)) * @as(c_int, 1000))));
    opts.*.maxPingsOut = @as(c_int, 2);
    opts.*.ioBufSize = @as(c_int, 32) * @as(c_int, 1024);
    opts.*.maxPendingMsgs = @as(c_int, 65536);
    opts.*.maxPendingBytes = @as(i64, @bitCast(@as(c_long, -@as(c_int, 1))));
    opts.*.timeout = @as(i64, @bitCast(@as(c_long, @as(c_int, 2) * @as(c_int, 1000))));
    opts.*.reconnectBufSize = (@as(c_int, 8) * @as(c_int, 1024)) * @as(c_int, 1024);
    opts.*.reconnectJitter = @as(i64, @bitCast(@as(c_long, @as(c_int, 100))));
    opts.*.reconnectJitterTLS = @as(i64, @bitCast(@as(c_long, @as(c_int, 1000))));
    opts.*.asyncErrCb = &natsConn_defaultErrHandler;
    nats_overrideDefaultOptionsWithConfig(opts);
    newOpts.* = opts;
    return @as(c_uint, @bitCast(NATS_OK));
}
pub export fn natsOptions_SetURL(arg_opts: [*c]natsOptions, arg_url: [*c]const u8) natsStatus {
    var opts = arg_opts;
    _ = &opts;
    var url = arg_url;
    _ = &url;
    ...
    _ = &s;
    if ((opts == @as([*c]natsOptions, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) or (@as(c_int, 0) != 0)) return nats_setErrorReal("./src/submodules/nats.c/src/opts.c", "natsOptions_SetURL", @as(c_int, 29), @as(c_uint, @bitCast(NATS_INVALID_ARG)), "%s", natsStatus_GetText(@as(c_uint, @bitCast(NATS_INVALID_ARG))));
    natsMutex_Lock(opts.*.mu);
    if (opts.*.url != @as([*c]u8, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) {
        free(@as(?*anyopaque, @ptrCast(opts.*.url)));
        opts.*.url = null;
    }
    if (url != @as([*c]const u8, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) {
        s = nats_Trim(&opts.*.url, url);
    }
    natsMutex_Unlock(opts.*.mu);
    return if (s == @as(c_uint, @bitCast(NATS_OK))) s else nats_updateErrStack(s, "natsOptions_SetURL");
}
pub export fn natsOptions_SetServers(arg_opts: [*c]natsOptions, arg_servers: [*c][*c]const u8, arg_serversCount: c_int) natsStatus {
    var opts = arg_opts;
    _ = &opts;
    var servers = arg_servers;
    _ = &servers;
    var serversCount = arg_serversCount;
    _ = &serversCount;
    var s: natsStatus = @as(c_uint, @bitCast(NATS_OK));
    _ = &s;
    var i: c_int = undefined;
    _ = &i;
    if ((opts == @as([*c]natsOptions, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) or (((servers != @as([*c][*c]const u8, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) and (serversCount <= @as(c_int, 0))) or ((servers == @as([*c][*c]const u8, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) and (serversCount != @as(c_int, 0))))) return nats_setErrorReal("./src/submodules/nats.c/src/opts.c", "natsOptions_SetServers", @as(c_int, 70), @as(c_uint, @bitCast(NATS_INVALID_ARG)), "%s", natsStatus_GetText(@as(c_uint, @bitCast(NATS_INVALID_ARG))));
    natsMutex_Lock(opts.*.mu);
    _freeServers(opts);
    if (servers != @as([*c][*c]const u8, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) {
        opts.*.servers = @as([*c][*c]u8, @ptrCast(@alignCast(calloc(@as(c_ulong, @bitCast(@as(c_long, serversCount))), @sizeOf([*c]u8)))));
        if (opts.*.servers == @as([*c][*c]u8, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) {
            s = nats_setErrorReal("./src/submodules/nats.c/src/opts.c", "natsOptions_SetServers", @as(c_int, 78), @as(c_uint, @bitCast(NATS_NO_MEMORY)), "%s", natsStatus_GetText(@as(c_uint, @bitCast(NATS_NO_MEMORY))));
        }
        {
            i = 0;
            while ((s == @as(c_uint, @bitCast(NATS_OK))) and (i < serversCount)) : (i += 1) {
                s = nats_Trim(&(blk: {
                    const tmp = i;
                    if (tmp >= 0) break :blk opts.*.servers + @as(usize, @intCast(tmp)) else break :blk opts.*.servers - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
                }).*, (blk: {
                    const tmp = i;
                    if (tmp >= 0) break :blk servers + @as(usize, @intCast(tmp)) else break :blk servers - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
                }).*);
                if (s == @as(c_uint, @bitCast(NATS_OK))) {
                    opts.*.serversCount += 1;
                }
    ...
    natsMutex_Unlock(opts.*.mu);
    return if (s == @as(c_uint, @bitCast(NATS_OK))) s else nats_updateErrStack(s, "natsOptions_SetServers");
}
pub export fn natsOptions_SetUserInfo(arg_opts: [*c]natsOptions, arg_user: [*c]const u8, arg_password: [*c]const u8) natsStatus {
    var opts = arg_opts;
    _ = &opts;
    var user = arg_user;
    _ = &user;
    ...
    var s: natsStatus = @as(c_uint, @bitCast(NATS_OK));
    _ = &s;
    if ((opts == @as([*c]natsOptions, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) or (@as(c_int, 0) != 0)) return nats_setErrorReal("./src/submodules/nats.c/src/opts.c", "natsOptions_SetUserInfo", @as(c_int, 149), @as(c_uint, @bitCast(NATS_INVALID_ARG)), "%s", natsStatus_GetText(@as(c_uint, @bitCast(NATS_INVALID_ARG))));
    natsMutex_Lock(opts.*.mu);
    free(@as(?*anyopaque, @ptrCast(opts.*.user)));
    opts.*.user = null;
    free(@as(?*anyopaque, @ptrCast(opts.*.password)));
    opts.*.password = null;
    if (user != @as([*c]const u8, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) {
        opts.*.user = strdup(user);
        if (opts.*.user == @as([*c]u8, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) {
            s = nats_setErrorReal("./src/submodules/nats.c/src/opts.c", "natsOptions_SetUserInfo", @as(c_int, 159), @as(c_uint, @bitCast(NATS_NO_MEMORY)), "%s", natsStatus_GetText(@as(c_uint, @bitCast(NATS_NO_MEMORY))));
        }
    }
    if ((s == @as(c_uint, @bitCast(NATS_OK))) and (password != @as([*c]const u8, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0)))))))) {
        opts.*.password = strdup(password);
        if (opts.*.password == @as([*c]u8, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) {
            s = nats_setErrorReal("./src/submodules/nats.c/src/opts.c", "natsOptions_SetUserInfo", @as(c_int, 165), @as(c_uint, @bitCast(NATS_NO_MEMORY)), "%s", natsStatus_GetText(@as(c_uint, @bitCast(NATS_NO_MEMORY))));
        }
    }
    natsMutex_Unlock(opts.*.mu);
    return s;
}
pub export fn natsOptions_SetToken(arg_opts: [*c]natsOptions, arg_token: [*c]const u8) natsStatus {
    var opts = arg_opts;
    _ = &opts;
    var token = arg_token;
    _ = &token;
    var s: natsStatus = @as(c_uint, @bitCast(NATS_OK));
    _ = &s;
    if ((opts == @as([*c]natsOptions, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) or (@as(c_int, 0) != 0)) return nats_setErrorReal("./src/submodules/nats.c/src/opts.c", "natsOptions_SetToken", @as(c_int, 178), @as(c_uint, @bitCast(NATS_INVALID_ARG)), "%s", natsStatus_GetText(@as(c_uint, @bitCast(NATS_INVALID_ARG))));
    natsMutex_Lock(opts.*.mu);
    if ((token != @as([*c]const u8, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) and (opts.*.tokenCb != @as(natsTokenHandler, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0)))))))) {
        s = nats_setErrorReal("./src/submodules/nats.c/src/opts.c", "natsOptions_SetToken", @as(c_int, 181), @as(c_uint, @bitCast(NATS_ILLEGAL_STATE)), "%s", "Cannot set a token if a token handler has already been set");
    } else {
        free(@as(?*anyopaque, @ptrCast(opts.*.token)));
        opts.*.token = null;
        if (token != @as([*c]const u8, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) {
            opts.*.token = strdup(token);
            if (opts.*.token == @as([*c]u8, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) {
                s = nats_setErrorReal("./src/submodules/nats.c/src/opts.c", "natsOptions_SetToken", @as(c_int, 190), @as(c_uint, @bitCast(NATS_NO_MEMORY)), "%s", natsStatus_GetText(@as(c_uint, @bitCast(NATS_NO_MEMORY))));
            }
        }
    }
    natsMutex_Unlock(opts.*.mu);
...
pub export fn natsOptions_SetTokenHandler(arg_opts: [*c]natsOptions, arg_tokenCb: natsTokenHandler, arg_closure: ?*anyopaque) natsStatus {
    var opts = arg_opts;
    _ = &opts;
    var tokenCb = arg_tokenCb;
    _ = &tokenCb;
    var closure = arg_closure;
    _ = &closure;
    var s: natsStatus = @as(c_uint, @bitCast(NATS_OK));
    _ = &s;
    if ((opts == @as([*c]natsOptions, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) or (@as(c_int, 0) != 0)) return nats_setErrorReal("./src/submodules/nats.c/src/opts.c", "natsOptions_SetTokenHandler", @as(c_int, 204), @as(c_uint, @bitCast(NATS_INVALID_ARG)), "%s", natsStatus_GetText(@as(c_uint, @bitCast(NATS_INVALID_ARG))));
    natsMutex_Lock(opts.*.mu);
    if ((tokenCb != @as(natsTokenHandler, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) and (opts.*.token != @as([*c]u8, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0)))))))) {
        s = nats_setErrorReal("./src/submodules/nats.c/src/opts.c", "natsOptions_SetTokenHandler", @as(c_int, 207), @as(c_uint, @bitCast(NATS_ILLEGAL_STATE)), "%s", "Cannot set a token handler if a token has already been set");
    } else {
...
pub export fn natsOptions_SetNoRandomize(arg_opts: [*c]natsOptions, arg_noRandomize: bool) natsStatus {
    var opts = arg_opts;
    _ = &opts;
    var noRandomize = arg_noRandomize;
    _ = &noRandomize;
    var s: natsStatus = @as(c_uint, @bitCast(NATS_OK));
    _ = &s;
    if ((opts == @as([*c]natsOptions, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) or (@as(c_int, 0) != 0)) return nats_setErrorReal("./src/submodules/nats.c/src/opts.c", "natsOptions_SetNoRandomize", @as(c_int, 101), @as(c_uint, @bitCast(NATS_INVALID_ARG)), "%s", natsStatus_GetText(@as(c_uint, @bitCast(NATS_INVALID_ARG))));
    natsMutex_Lock(opts.*.mu);
    opts.*.noRandomize = noRandomize;
    natsMutex_Unlock(opts.*.mu);
    return s;
}
pub export fn natsOptions_SetTimeout(arg_opts: [*c]natsOptions, arg_timeout: i64) natsStatus {
    var opts = arg_opts;
    _ = &opts;
    var timeout = arg_timeout;
    _ = &timeout;
    if ((opts == @as([*c]natsOptions, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) or (timeout < @as(i64, @bitCast(@as(c_long, @as(c_int, 0)))))) return nats_setErrorReal("./src/submodules/nats.c/src/opts.c", "natsOptions_SetTimeout", @as(c_int, 113), @as(c_uint, @bitCast(NATS_INVALID_ARG)), "%s", natsStatus_GetText(@as(c_uint, @bitCast(NATS_INVALID_ARG))));
    natsMutex_Lock(opts.*.mu);
    opts.*.timeout = timeout;
    natsMutex_Unlock(opts.*.mu);
    return @as(c_uint, @bitCast(NATS_OK));
}
pub export fn natsOptions_SetName(arg_opts: [*c]natsOptions, arg_name: [*c]const u8) natsStatus {
    var opts = arg_opts;
    _ = &opts;
    var name = arg_name;
    _ = &name;
    var s: natsStatus = @as(c_uint, @bitCast(NATS_OK));
    _ = &s;
    if ((opts == @as([*c]natsOptions, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) or (@as(c_int, 0) != 0)) return nats_setErrorReal("./src/submodules/nats.c/src/opts.c", "natsOptions_SetName", @as(c_int, 128), @as(c_uint, @bitCast(NATS_INVALID_ARG)), "%s", natsStatus_GetText(@as(c_uint, @bitCast(NATS_INVALID_ARG))));
    natsMutex_Lock(opts.*.mu);
    free(@as(?*anyopaque, @ptrCast(opts.*.name)));
    opts.*.name = null;
    if (name != @as([*c]const u8, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) {
        opts.*.name = strdup(name);
        if (opts.*.name == @as([*c]u8, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) {
            s = nats_setErrorReal("./src/submodules/nats.c/src/opts.c", "natsOptions_SetName", @as(c_int, 136), @as(c_uint, @bitCast(NATS_NO_MEMORY)), "%s", natsStatus_GetText(@as(c_uint, @bitCast(NATS_NO_MEMORY))));
        }
    }
    natsMutex_Unlock(opts.*.mu);
    return s;
}
pub export fn natsOptions_SetSecure(arg_opts: [*c]natsOptions, arg_secure: bool) natsStatus {
    var opts = arg_opts;
    _ = &opts;
    var secure = arg_secure;
    _ = &secure;
    return nats_setErrorReal("./src/submodules/nats.c/src/opts.c", "natsOptions_SetSecure", @as(c_int, 708), @as(c_uint, @bitCast(NATS_ILLEGAL_STATE)), "%s", "The library was built without SSL support!");
}
pub export fn natsOptions_TLSHandshakeFirst(arg_opts: [*c]natsOptions) natsStatus {
    var opts = arg_opts;
    _ = &opts;
    return nats_setErrorReal("./src/submodules/nats.c/src/opts.c", "natsOptions_TLSHandshakeFirst", @as(c_int, 714), @as(c_uint, @bitCast(NATS_ILLEGAL_STATE)), "%s", "The library was built without SSL support!");
}
pub export fn natsOptions_LoadCATrustedCertificates(arg_opts: [*c]natsOptions, arg_fileName: [*c]const u8) natsStatus {
    var opts = arg_opts;
    _ = &opts;
    var fileName = arg_fileName;
    _ = &fileName;
    return nats_setErrorReal("./src/submodules/nats.c/src/opts.c", "natsOptions_LoadCATrustedCertificates", @as(c_int, 720), @as(c_uint, @bitCast(NATS_ILLEGAL_STATE)), "%s", "The library was built without SSL support!");
}
pub export fn natsOptions_SetCATrustedCertificates(arg_opts: [*c]natsOptions, arg_certificates: [*c]const u8) natsStatus {
    var opts = arg_opts;
    _ = &opts;
    var certificates = arg_certificates;
    _ = &certificates;
    return nats_setErrorReal("./src/submodules/nats.c/src/opts.c", "natsOptions_SetCATrustedCertificates", @as(c_int, 726), @as(c_uint, @bitCast(NATS_ILLEGAL_STATE)), "%s", "The library was built without SSL support!");
}
pub export fn natsOptions_LoadCertificatesChain(arg_opts: [*c]natsOptions, arg_certFileName: [*c]const u8, arg_keyFileName: [*c]const u8) natsStatus {
    var opts = arg_opts;
    _ = &opts;
    var certFileName = arg_certFileName;
    _ = &certFileName;
    var keyFileName = arg_keyFileName;
    _ = &keyFileName;
    return nats_setErrorReal("./src/submodules/nats.c/src/opts.c", "natsOptions_LoadCertificatesChain", @as(c_int, 734), @as(c_uint, @bitCast(NATS_ILLEGAL_STATE)), "%s", "The library was built without SSL support!");
}
pub export fn natsOptions_SetCertificatesChain(arg_opts: [*c]natsOptions, arg_certStr: [*c]const u8, arg_keyStr: [*c]const u8) natsStatus {
    var opts = arg_opts;
    _ = &opts;
    var certStr = arg_certStr;
    _ = &certStr;
    var keyStr = arg_keyStr;
    _ = &keyStr;
    return nats_setErrorReal("./src/submodules/nats.c/src/opts.c", "natsOptions_SetCertificatesChain", @as(c_int, 740), @as(c_uint, @bitCast(NATS_ILLEGAL_STATE)), "%s", "The library was built without SSL support!");
}
pub export fn natsOptions_SetCiphers(arg_opts: [*c]natsOptions, arg_ciphers: [*c]const u8) natsStatus {
    var opts = arg_opts;
    _ = &opts;
    var ciphers = arg_ciphers;
    _ = &ciphers;
    return nats_setErrorReal("./src/submodules/nats.c/src/opts.c", "natsOptions_SetCiphers", @as(c_int, 746), @as(c_uint, @bitCast(NATS_ILLEGAL_STATE)), "%s", "The library was built without SSL support!");
}
pub extern fn natsOptions_SetCipherSuites(opts: [*c]natsOptions, ciphers: [*c]const u8) natsStatus;
pub export fn natsOptions_SetExpectedHostname(arg_opts: [*c]natsOptions, arg_hostname: [*c]const u8) natsStatus {
    var opts = arg_opts;
    _ = &opts;
    var hostname = arg_hostname;
    _ = &hostname;
    return nats_setErrorReal("./src/submodules/nats.c/src/opts.c", "natsOptions_SetExpectedHostname", @as(c_int, 752), @as(c_uint, @bitCast(NATS_ILLEGAL_STATE)), "%s", "The library was built without SSL support!");
}
pub export fn natsOptions_SkipServerVerification(arg_opts: [*c]natsOptions, arg_skip: bool) natsStatus {
    var opts = arg_opts;
    _ = &opts;
    var skip = arg_skip;
    _ = &skip;
    return nats_setErrorReal("./src/submodules/nats.c/src/opts.c", "natsOptions_SkipServerVerification", @as(c_int, 758), @as(c_uint, @bitCast(NATS_ILLEGAL_STATE)), "%s", "The library was built without SSL support!");
}
pub export fn natsOptions_SetVerbose(arg_opts: [*c]natsOptions, arg_verbose: bool) natsStatus {
    var opts = arg_opts;
    _ = &opts;
    var verbose = arg_verbose;
    _ = &verbose;
    if ((opts == @as([*c]natsOptions, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) or (@as(c_int, 0) != 0)) return nats_setErrorReal("./src/submodules/nats.c/src/opts.c", "natsOptions_SetVerbose", @as(c_int, 766), @as(c_uint, @bitCast(NATS_INVALID_ARG)), "%s", natsStatus_GetText(@as(c_uint, @bitCast(NATS_INVALID_ARG))));
    natsMutex_Lock(opts.*.mu);
    opts.*.verbose = verbose;
    natsMutex_Unlock(opts.*.mu);
    return @as(c_uint, @bitCast(NATS_OK));
}
pub export fn natsOptions_SetPedantic(arg_opts: [*c]natsOptions, arg_pedantic: bool) natsStatus {
    var opts = arg_opts;
    _ = &opts;
    var pedantic = arg_pedantic;
    _ = &pedantic;
    if ((opts == @as([*c]natsOptions, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) or (@as(c_int, 0) != 0)) return nats_setErrorReal("./src/submodules/nats.c/src/opts.c", "natsOptions_SetPedantic", @as(c_int, 778), @as(c_uint, @bitCast(NATS_INVALID_ARG)), "%s", natsStatus_GetText(@as(c_uint, @bitCast(NATS_INVALID_ARG))));
    natsMutex_Lock(opts.*.mu);
    opts.*.pedantic = pedantic;
    natsMutex_Unlock(opts.*.mu);
    return @as(c_uint, @bitCast(NATS_OK));
}
pub export fn natsOptions_SetPingInterval(arg_opts: [*c]natsOptions, arg_interval: i64) natsStatus {
    var opts = arg_opts;
    _ = &opts;
    var interval = arg_interval;
    _ = &interval;
    if ((opts == @as([*c]natsOptions, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) or (@as(c_int, 0) != 0)) return nats_setErrorReal("./src/submodules/nats.c/src/opts.c", "natsOptions_SetPingInterval", @as(c_int, 790), @as(c_uint, @bitCast(NATS_INVALID_ARG)), "%s", natsStatus_GetText(@as(c_uint, @bitCast(NATS_INVALID_ARG))));
    natsMutex_Lock(opts.*.mu);
    opts.*.pingInterval = interval;
    natsMutex_Unlock(opts.*.mu);
    return @as(c_uint, @bitCast(NATS_OK));
}
pub export fn natsOptions_SetMaxPingsOut(arg_opts: [*c]natsOptions, arg_maxPignsOut: c_int) natsStatus {
    var opts = arg_opts;
    _ = &opts;
    var maxPignsOut = arg_maxPignsOut;
    _ = &maxPignsOut;
    if ((opts == @as([*c]natsOptions, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) or (@as(c_int, 0) != 0)) return nats_setErrorReal("./src/submodules/nats.c/src/opts.c", "natsOptions_SetMaxPingsOut", @as(c_int, 802), @as(c_uint, @bitCast(NATS_INVALID_ARG)), "%s", natsStatus_GetText(@as(c_uint, @bitCast(NATS_INVALID_ARG))));
    natsMutex_Lock(opts.*.mu);
    opts.*.maxPingsOut = maxPignsOut;
    natsMutex_Unlock(opts.*.mu);
    return @as(c_uint, @bitCast(NATS_OK));
}
pub export fn natsOptions_SetIOBufSize(arg_opts: [*c]natsOptions, arg_ioBufSize: c_int) natsStatus {
    var opts = arg_opts;
    _ = &opts;
    var ioBufSize = arg_ioBufSize;
    _ = &ioBufSize;
    if ((opts == @as([*c]natsOptions, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) or (ioBufSize < @as(c_int, 0))) return nats_setErrorReal("./src/submodules/nats.c/src/opts.c", "natsOptions_SetIOBufSize", @as(c_int, 814), @as(c_uint, @bitCast(NATS_INVALID_ARG)), "%s", natsStatus_GetText(@as(c_uint, @bitCast(NATS_INVALID_ARG))));
    natsMutex_Lock(opts.*.mu);
    opts.*.ioBufSize = ioBufSize;
    natsMutex_Unlock(opts.*.mu);
    return @as(c_uint, @bitCast(NATS_OK));
}
pub export fn natsOptions_SetAllowReconnect(arg_opts: [*c]natsOptions, arg_allow: bool) natsStatus {
    var opts = arg_opts;
    _ = &opts;
    var allow = arg_allow;
    _ = &allow;
    if ((opts == @as([*c]natsOptions, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) or (@as(c_int, 0) != 0)) return nats_setErrorReal("./src/submodules/nats.c/src/opts.c", "natsOptions_SetAllowReconnect", @as(c_int, 826), @as(c_uint, @bitCast(NATS_INVALID_ARG)), "%s", natsStatus_GetText(@as(c_uint, @bitCast(NATS_INVALID_ARG))));
    natsMutex_Lock(opts.*.mu);
    opts.*.allowReconnect = allow;
    natsMutex_Unlock(opts.*.mu);
    return @as(c_uint, @bitCast(NATS_OK));
}
pub export fn natsOptions_SetMaxReconnect(arg_opts: [*c]natsOptions, arg_maxReconnect: c_int) natsStatus {
    var opts = arg_opts;
    _ = &opts;
    var maxReconnect = arg_maxReconnect;
    _ = &maxReconnect;
    if ((opts == @as([*c]natsOptions, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) or (@as(c_int, 0) != 0)) return nats_setErrorReal("./src/submodules/nats.c/src/opts.c", "natsOptions_SetMaxReconnect", @as(c_int, 838), @as(c_uint, @bitCast(NATS_INVALID_ARG)), "%s", natsStatus_GetText(@as(c_uint, @bitCast(NATS_INVALID_ARG))));
    natsMutex_Lock(opts.*.mu);
    opts.*.maxReconnect = maxReconnect;
    natsMutex_Unlock(opts.*.mu);
    return @as(c_uint, @bitCast(NATS_OK));
}
pub export fn natsOptions_SetReconnectWait(arg_opts: [*c]natsOptions, arg_reconnectWait: i64) natsStatus {
    var opts = arg_opts;
    _ = &opts;
    var reconnectWait = arg_reconnectWait;
    _ = &reconnectWait;
    if ((opts == @as([*c]natsOptions, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) or (reconnectWait < @as(i64, @bitCast(@as(c_long, @as(c_int, 0)))))) return nats_setErrorReal("./src/submodules/nats.c/src/opts.c", "natsOptions_SetReconnectWait", @as(c_int, 850), @as(c_uint, @bitCast(NATS_INVALID_ARG)), "%s", natsStatus_GetText(@as(c_uint, @bitCast(NATS_INVALID_ARG))));
    natsMutex_Lock(opts.*.mu);
    opts.*.reconnectWait = reconnectWait;
    natsMutex_Unlock(opts.*.mu);
    return @as(c_uint, @bitCast(NATS_OK));
}
pub export fn natsOptions_SetReconnectJitter(arg_opts: [*c]natsOptions, arg_jitter: i64, arg_jitterTLS: i64) natsStatus {
    var opts = arg_opts;
    _ = &opts;
    var jitter = arg_jitter;
    _ = &jitter;
    var jitterTLS = arg_jitterTLS;
    _ = &jitterTLS;
    if ((opts == @as([*c]natsOptions, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) or ((jitter < @as(i64, @bitCast(@as(c_long, @as(c_int, 0))))) or (jitterTLS < @as(i64, @bitCast(@as(c_long, @as(c_int, 0))))))) return nats_setErrorReal("./src/submodules/nats.c/src/opts.c", "natsOptions_SetReconnectJitter", @as(c_int, 862), @as(c_uint, @bitCast(NATS_INVALID_ARG)), "%s", natsStatus_GetText(@as(c_uint, @bitCast(NATS_INVALID_ARG))));
    natsMutex_Lock(opts.*.mu);
...
pub export fn natsOptions_SetCustomReconnectDelay(arg_opts: [*c]natsOptions, arg_cb: natsCustomReconnectDelayHandler, arg_closure: ?*anyopaque) natsStatus {
    var opts = arg_opts;
    _ = &opts;
    var cb = arg_cb;
    _ = &cb;
    var closure = arg_closure;
    _ = &closure;
    if ((opts == @as([*c]natsOptions, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) or (@as(c_int, 0) != 0)) return nats_setErrorReal("./src/submodules/nats.c/src/opts.c", "natsOptions_SetCustomReconnectDelay", @as(c_int, 877), @as(c_uint, @bitCast(NATS_INVALID_ARG)), "%s", natsStatus_GetText(@as(c_uint, @bitCast(NATS_INVALID_ARG))));
    natsMutex_Lock(opts.*.mu);
...
pub export fn natsOptions_SetReconnectBufSize(arg_opts: [*c]natsOptions, arg_reconnectBufSize: c_int) natsStatus {
    var opts = arg_opts;
    _ = &opts;
    var reconnectBufSize = arg_reconnectBufSize;
    _ = &reconnectBufSize;
    if ((opts == @as([*c]natsOptions, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) or (reconnectBufSize < @as(c_int, 0))) return nats_setErrorReal("./src/submodules/nats.c/src/opts.c", "natsOptions_SetReconnectBufSize", @as(c_int, 890), @as(c_uint, @bitCast(NATS_INVALID_ARG)), "%s", natsStatus_GetText(@as(c_uint, @bitCast(NATS_INVALID_ARG))));
    natsMutex_Lock(opts.*.mu);
    opts.*.reconnectBufSize = reconnectBufSize;
    natsMutex_Unlock(opts.*.mu);
    return @as(c_uint, @bitCast(NATS_OK));
}
pub export fn natsOptions_SetMaxPendingMsgs(arg_opts: [*c]natsOptions, arg_maxPending: c_int) natsStatus {
    var opts = arg_opts;
    _ = &opts;
    var maxPending = arg_maxPending;
    _ = &maxPending;
    if ((opts == @as([*c]natsOptions, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) or (maxPending <= @as(c_int, 0))) return nats_setErrorReal("./src/submodules/nats.c/src/opts.c", "natsOptions_SetMaxPendingMsgs", @as(c_int, 902), @as(c_uint, @bitCast(NATS_INVALID_ARG)), "%s", natsStatus_GetText(@as(c_uint, @bitCast(NATS_INVALID_ARG))));
    natsMutex_Lock(opts.*.mu);
    opts.*.maxPendingMsgs = maxPending;
    natsMutex_Unlock(opts.*.mu);
    return @as(c_uint, @bitCast(NATS_OK));
}
pub export fn natsOptions_SetMaxPendingBytes(arg_opts: [*c]natsOptions, arg_maxPending: i64) natsStatus {
    var opts = arg_opts;
    _ = &opts;
    var maxPending = arg_maxPending;
    _ = &maxPending;
    if ((opts == @as([*c]natsOptions, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) or (maxPending <= @as(i64, @bitCast(@as(c_long, @as(c_int, 0)))))) return nats_setErrorReal("./src/submodules/nats.c/src/opts.c", "natsOptions_SetMaxPendingBytes", @as(c_int, 914), @as(c_uint, @bitCast(NATS_INVALID_ARG)), "%s", natsStatus_GetText(@as(c_uint, @bitCast(NATS_INVALID_ARG))));
    natsMutex_Lock(opts.*.mu);
    opts.*.maxPendingBytes = maxPending;
    natsMutex_Unlock(opts.*.mu);
    return @as(c_uint, @bitCast(NATS_OK));
}
pub export fn natsOptions_SetErrorHandler(arg_opts: [*c]natsOptions, arg_errHandler: natsErrHandler, arg_closure: ?*anyopaque) natsStatus {
    var opts = arg_opts;
    _ = &opts;
    var errHandler = arg_errHandler;
    _ = &errHandler;
    var closure = arg_closure;
    _ = &closure;
    if ((opts == @as([*c]natsOptions, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) or (@as(c_int, 0) != 0)) return nats_setErrorReal("./src/submodules/nats.c/src/opts.c", "natsOptions_SetErrorHandler", @as(c_int, 927), @as(c_uint, @bitCast(NATS_INVALID_ARG)), "%s", natsStatus_GetText(@as(c_uint, @bitCast(NATS_INVALID_ARG))));
    natsMutex_Lock(opts.*.mu);
    opts.*.asyncErrCb = errHandler;
    opts.*.asyncErrCbClosure = closure;
    if (opts.*.asyncErrCb == @as(natsErrHandler, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) {
        opts.*.asyncErrCb = &natsConn_defaultErrHandler;
    }
    natsMutex_Unlock(opts.*.mu);
    return @as(c_uint, @bitCast(NATS_OK));
}
pub export fn natsOptions_SetClosedCB(arg_opts: [*c]natsOptions, arg_closedCb: natsConnectionHandler, arg_closure: ?*anyopaque) natsStatus {
    var opts = arg_opts;
    _ = &opts;
    var closedCb = arg_closedCb;
    _ = &closedCb;
    var closure = arg_closure;
    _ = &closure;
    if ((opts == @as([*c]natsOptions, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) or (@as(c_int, 0) != 0)) return nats_setErrorReal("./src/submodules/nats.c/src/opts.c", "natsOptions_SetClosedCB", @as(c_int, 944), @as(c_uint, @bitCast(NATS_INVALID_ARG)), "%s", natsStatus_GetText(@as(c_uint, @bitCast(NATS_INVALID_ARG))));
    natsMutex_Lock(opts.*.mu);
...
pub export fn natsOptions_SetDisconnectedCB(arg_opts: [*c]natsOptions, arg_disconnectedCb: natsConnectionHandler, arg_closure: ?*anyopaque) natsStatus {
    var opts = arg_opts;
    _ = &opts;
    var disconnectedCb = arg_disconnectedCb;
    _ = &disconnectedCb;
    var closure = arg_closure;
    _ = &closure;
    if ((opts == @as([*c]natsOptions, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) or (@as(c_int, 0) != 0)) return nats_setErrorReal("./src/submodules/nats.c/src/opts.c", "natsOptions_SetDisconnectedCB", @as(c_int, 972), @as(c_uint, @bitCast(NATS_INVALID_ARG)), "%s", natsStatus_GetText(@as(c_uint, @bitCast(NATS_INVALID_ARG))));
    natsMutex_Lock(opts.*.mu);
...
pub export fn natsOptions_SetReconnectedCB(arg_opts: [*c]natsOptions, arg_reconnectedCb: natsConnectionHandler, arg_closure: ?*anyopaque) natsStatus {
    var opts = arg_opts;
    _ = &opts;
    var reconnectedCb = arg_reconnectedCb;
    _ = &reconnectedCb;
    var closure = arg_closure;
    _ = &closure;
    if ((opts == @as([*c]natsOptions, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) or (@as(c_int, 0) != 0)) return nats_setErrorReal("./src/submodules/nats.c/src/opts.c", "natsOptions_SetReconnectedCB", @as(c_int, 987), @as(c_uint, @bitCast(NATS_INVALID_ARG)), "%s", natsStatus_GetText(@as(c_uint, @bitCast(NATS_INVALID_ARG))));
    natsMutex_Lock(opts.*.mu);
...
pub export fn natsOptions_SetDiscoveredServersCB(arg_opts: [*c]natsOptions, arg_discoveredServersCb: natsConnectionHandler, arg_closure: ?*anyopaque) natsStatus {
    var opts = arg_opts;
    _ = &opts;
    var discoveredServersCb = arg_discoveredServersCb;
    _ = &discoveredServersCb;
    var closure = arg_closure;
    _ = &closure;
    if ((opts == @as([*c]natsOptions, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) or (@as(c_int, 0) != 0)) return nats_setErrorReal("./src/submodules/nats.c/src/opts.c", "natsOptions_SetDiscoveredServersCB", @as(c_int, 1002), @as(c_uint, @bitCast(NATS_INVALID_ARG)), "%s", natsStatus_GetText(@as(c_uint, @bitCast(NATS_INVALID_ARG))));
    natsMutex_Lock(opts.*.mu);
...
pub export fn natsOptions_SetIgnoreDiscoveredServers(arg_opts: [*c]natsOptions, arg_ignore: bool) natsStatus {
    var opts = arg_opts;
    _ = &opts;
    var ignore = arg_ignore;
    _ = &ignore;
    if ((opts == @as([*c]natsOptions, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) or (@as(c_int, 0) != 0)) return nats_setErrorReal("./src/submodules/nats.c/src/opts.c", "natsOptions_SetIgnoreDiscoveredServers", @as(c_int, 1015), @as(c_uint, @bitCast(NATS_INVALID_ARG)), "%s", natsStatus_GetText(@as(c_uint, @bitCast(NATS_INVALID_ARG))));
    natsMutex_Lock(opts.*.mu);
    opts.*.ignoreDiscoveredServers = ignore;
    natsMutex_Unlock(opts.*.mu);
    return @as(c_uint, @bitCast(NATS_OK));
}
pub export fn natsOptions_SetLameDuckModeCB(arg_opts: [*c]natsOptions, arg_lameDuckCb: natsConnectionHandler, arg_closure: ?*anyopaque) natsStatus {
    var opts = arg_opts;
    _ = &opts;
    var lameDuckCb = arg_lameDuckCb;
    _ = &lameDuckCb;
    var closure = arg_closure;
    _ = &closure;
    if ((opts == @as([*c]natsOptions, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) or (@as(c_int, 0) != 0)) return nats_setErrorReal("./src/submodules/nats.c/src/opts.c", "natsOptions_SetLameDuckModeCB", @as(c_int, 1029), @as(c_uint, @bitCast(NATS_INVALID_ARG)), "%s", natsStatus_GetText(@as(c_uint, @bitCast(NATS_INVALID_ARG))));
    natsMutex_Lock(opts.*.mu);
...
pub export fn natsOptions_SetEventLoop(arg_opts: [*c]natsOptions, arg_loop: ?*anyopaque, arg_attachCb: natsEvLoop_Attach, arg_readCb: natsEvLoop_ReadAddRemove, arg_writeCb: natsEvLoop_WriteAddRemove, arg_detachCb: natsEvLoop_Detach) natsStatus {
    var opts = arg_opts;
    _ = &opts;
    var loop = arg_loop;
    _ = &loop;
    var attachCb = arg_attachCb;
    _ = &attachCb;
    var readCb = arg_readCb;
    _ = &readCb;
    var writeCb = arg_writeCb;
    _ = &writeCb;
    var detachCb = arg_detachCb;
    _ = &detachCb;
    if ((opts == @as([*c]natsOptions, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) or (((((loop == @as(?*anyopaque, @ptrFromInt(@as(c_int, 0)))) or (attachCb == @as(natsEvLoop_Attach, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0)))))))) or (readCb == @as(natsEvLoop_ReadAddRemove, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0)))))))) or (writeCb == @as(natsEvLoop_WriteAddRemove, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0)))))))) or (detachCb == @as(natsEvLoop_Detach, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))))) return nats_setErrorReal("./src/submodules/nats.c/src/opts.c", "natsOptions_SetEventLoop", @as(c_int, 1051), @as(c_uint, @bitCast(NATS_INVALID_ARG)), "%s", natsStatus_GetText(@as(c_uint, @bitCast(NATS_INVALID_ARG))));
    natsMutex_Lock(opts.*.mu);
    opts.*.evLoop = loop;
...
pub export fn natsOptions_UseGlobalMessageDelivery(arg_opts: [*c]natsOptions, arg_global: bool) natsStatus {
    var opts = arg_opts;
    _ = &opts;
    var global = arg_global;
    _ = &global;
    if ((opts == @as([*c]natsOptions, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) or (@as(c_int, 0) != 0)) return nats_setErrorReal("./src/submodules/nats.c/src/opts.c", "natsOptions_UseGlobalMessageDelivery", @as(c_int, 1067), @as(c_uint, @bitCast(NATS_INVALID_ARG)), "%s", natsStatus_GetText(@as(c_uint, @bitCast(NATS_INVALID_ARG))));
    natsMutex_Lock(opts.*.mu);
    opts.*.useSharedDispatcher = global;
    natsMutex_Unlock(opts.*.mu);
    return @as(c_uint, @bitCast(NATS_OK));
}
pub export fn natsOptions_IPResolutionOrder(arg_opts: [*c]natsOptions, arg_order: c_int) natsStatus {
    var opts = arg_opts;
    _ = &opts;
    var order = arg_order;
    _ = &order;
    if ((opts == @as([*c]natsOptions, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) or (((((order != @as(c_int, 0)) and (order != @as(c_int, 4))) and (order != @as(c_int, 6))) and (order != @as(c_int, 46))) and (order != @as(c_int, 64)))) return nats_setErrorReal("./src/submodules/nats.c/src/opts.c", "natsOptions_IPResolutionOrder", @as(c_int, 1086), @as(c_uint, @bitCast(NATS_INVALID_ARG)), "%s", natsStatus_GetText(@as(c_uint, @bitCast(NATS_INVALID_ARG))));
    natsMutex_Lock(opts.*.mu);
    opts.*.orderIP = order;
    natsMutex_Unlock(opts.*.mu);
    return @as(c_uint, @bitCast(NATS_OK));
}
pub export fn natsOptions_SetSendAsap(arg_opts: [*c]natsOptions, arg_sendAsap: bool) natsStatus {
    var opts = arg_opts;
    _ = &opts;
    var sendAsap = arg_sendAsap;
    _ = &sendAsap;
    if ((opts == @as([*c]natsOptions, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) or (@as(c_int, 0) != 0)) return nats_setErrorReal("./src/submodules/nats.c/src/opts.c", "natsOptions_SetSendAsap", @as(c_int, 1098), @as(c_uint, @bitCast(NATS_INVALID_ARG)), "%s", natsStatus_GetText(@as(c_uint, @bitCast(NATS_INVALID_ARG))));
    natsMutex_Lock(opts.*.mu);
    opts.*.sendAsap = sendAsap;
    natsMutex_Unlock(opts.*.mu);
    return @as(c_uint, @bitCast(NATS_OK));
}
pub export fn natsOptions_UseOldRequestStyle(arg_opts: [*c]natsOptions, arg_useOldStype: bool) natsStatus {
    var opts = arg_opts;
    _ = &opts;
    var useOldStype = arg_useOldStype;
    _ = &useOldStype;
    if ((opts == @as([*c]natsOptions, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) or (@as(c_int, 0) != 0)) return nats_setErrorReal("./src/submodules/nats.c/src/opts.c", "natsOptions_UseOldRequestStyle", @as(c_int, 1139), @as(c_uint, @bitCast(NATS_INVALID_ARG)), "%s", natsStatus_GetText(@as(c_uint, @bitCast(NATS_INVALID_ARG))));
    natsMutex_Lock(opts.*.mu);
    opts.*.useOldRequestStyle = useOldStype;
    natsMutex_Unlock(opts.*.mu);
    return @as(c_uint, @bitCast(NATS_OK));
}
pub export fn natsOptions_SetFailRequestsOnDisconnect(arg_opts: [*c]natsOptions, arg_failRequests: bool) natsStatus {
    var opts = arg_opts;
    _ = &opts;
    var failRequests = arg_failRequests;
    _ = &failRequests;
    if ((opts == @as([*c]natsOptions, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) or (@as(c_int, 0) != 0)) return nats_setErrorReal("./src/submodules/nats.c/src/opts.c", "natsOptions_SetFailRequestsOnDisconnect", @as(c_int, 1149), @as(c_uint, @bitCast(NATS_INVALID_ARG)), "%s", natsStatus_GetText(@as(c_uint, @bitCast(NATS_INVALID_ARG))));
    natsMutex_Lock(opts.*.mu);
    opts.*.failRequestsOnDisconnect = failRequests;
    natsMutex_Unlock(opts.*.mu);
    return @as(c_uint, @bitCast(NATS_OK));
}
pub export fn natsOptions_SetNoEcho(arg_opts: [*c]natsOptions, arg_noEcho: bool) natsStatus {
    var opts = arg_opts;
    _ = &opts;
    var noEcho = arg_noEcho;
    _ = &noEcho;
    if ((opts == @as([*c]natsOptions, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) or (@as(c_int, 0) != 0)) return nats_setErrorReal("./src/submodules/nats.c/src/opts.c", "natsOptions_SetNoEcho", @as(c_int, 1108), @as(c_uint, @bitCast(NATS_INVALID_ARG)), "%s", natsStatus_GetText(@as(c_uint, @bitCast(NATS_INVALID_ARG))));
    natsMutex_Lock(opts.*.mu);
    opts.*.noEcho = noEcho;
    natsMutex_Unlock(opts.*.mu);
    return @as(c_uint, @bitCast(NATS_OK));
}
pub export fn natsOptions_SetRetryOnFailedConnect(arg_opts: [*c]natsOptions, arg_retry: bool, arg_connectedCb: natsConnectionHandler, arg_closure: ?*anyopaque) natsStatus {
    var opts = arg_opts;
    _ = &opts;
    var retry = arg_retry;
    _ = &retry;
    var connectedCb = arg_connectedCb;
    _ = &connectedCb;
    var closure = arg_closure;
    _ = &closure;
    if ((opts == @as([*c]natsOptions, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) or (@as(c_int, 0) != 0)) return nats_setErrorReal("./src/submodules/nats.c/src/opts.c", "natsOptions_SetRetryOnFailedConnect", @as(c_int, 1119), @as(c_uint, @bitCast(NATS_INVALID_ARG)), "%s", natsStatus_GetText(@as(c_uint, @bitCast(NATS_INVALID_ARG))));
    natsMutex_Lock(opts.*.mu);
    opts.*.retryOnFailedConnect = retry;
    if (!retry) {
        opts.*.connectedCb = null;
        opts.*.connectedCbClosure = @as(?*anyopaque, @ptrFromInt(@as(c_int, 0)));
    } else {
...
pub export fn natsOptions_SetUserCredentialsCallbacks(arg_opts: [*c]natsOptions, arg_ujwtCB: natsUserJWTHandler, arg_ujwtClosure: ?*anyopaque, arg_sigCB: natsSignatureHandler, arg_sigClosure: ?*anyopaque) natsStatus {
    var opts = arg_opts;
    _ = &opts;
    var ujwtCB = arg_ujwtCB;
    _ = &ujwtCB;
    var ujwtClosure = arg_ujwtClosure;
    _ = &ujwtClosure;
    var sigCB = arg_sigCB;
    _ = &sigCB;
    var sigClosure = arg_sigClosure;
    _ = &sigClosure;
    if ((opts == @as([*c]natsOptions, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) or (((ujwtCB != @as(natsUserJWTHandler, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) and (sigCB == @as(natsSignatureHandler, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0)))))))) or ((ujwtCB == @as(natsUserJWTHandler, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) and (sigCB != @as(natsSignatureHandler, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0)))))))))) return nats_setErrorReal("./src/submodules/nats.c/src/opts.c", "natsOptions_SetUserCredentialsCallbacks", @as(c_int, 1310), @as(c_uint, @bitCast(NATS_INVALID_ARG)), "%s", natsStatus_GetText(@as(c_uint, @bitCast(NATS_INVALID_ARG))));
    natsMutex_Lock(opts.*.mu);
    ...
    if ((ujwtCB != @as(natsUserJWTHandler, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) and (opts.*.nkey != @as([*c]u8, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0)))))))) {
        free(@as(?*anyopaque, @ptrCast(opts.*.nkey)));
        opts.*.nkey = null;
    }
    natsMutex_Unlock(opts.*.mu);
    return @as(c_uint, @bitCast(NATS_OK));
...
pub export fn natsOptions_SetUserCredentialsFromFiles(arg_opts: [*c]natsOptions, arg_userOrChainedFile: [*c]const u8, arg_seedFile: [*c]const u8) natsStatus {
    var opts = arg_opts;
    _ = &opts;
    var userOrChainedFile = arg_userOrChainedFile;
    _ = &userOrChainedFile;
    var seedFile = arg_seedFile;
    _ = &seedFile;
    var s: natsStatus = @as(c_uint, @bitCast(NATS_OK));
    _ = &s;
    var uc: [*c]userCreds = null;
    _ = &uc;
    if ((opts == @as([*c]natsOptions, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) or (@as(c_int, 0) != 0)) return nats_setErrorReal("./src/submodules/nats.c/src/opts.c", "natsOptions_SetUserCredentialsFromFiles", @as(c_int, 1249), @as(c_uint, @bitCast(NATS_INVALID_ARG)), "%s", natsStatus_GetText(@as(c_uint, @bitCast(NATS_INVALID_ARG))));
    natsMutex_Lock(opts.*.mu);
    if (((if ((userOrChainedFile == @as([*c]const u8, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) or (@as(c_int, @bitCast(@as(c_uint, userOrChainedFile[@as(c_uint, @intCast(@as(c_int, 0)))]))) == @as(c_int, '\x00'))) @as(c_int, 1) else @as(c_int, 0)) != 0) and !((if ((seedFile == @as([*c]const u8, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) or (@as(c_int, @bitCast(@as(c_uint, seedFile[@as(c_uint, @intCast(@as(c_int, 0)))]))) == @as(c_int, '\x00'))) @as(c_int, 1) else @as(c_int, 0)) != 0)) {
        natsMutex_Unlock(opts.*.mu);
        return nats_setErrorReal("./src/submodules/nats.c/src/opts.c", "natsOptions_SetUserCredentialsFromFiles", @as(c_int, 1256), @as(c_uint, @bitCast(NATS_INVALID_ARG)), "%s", "user or chained file need to be specified");
    }
    if (!((if ((userOrChainedFile == @as([*c]const u8, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) or (@as(c_int, @bitCast(@as(c_uint, userOrChainedFile[@as(c_uint, @intCast(@as(c_int, 0)))]))) == @as(c_int, '\x00'))) @as(c_int, 1) else @as(c_int, 0)) != 0)) {
        s = _createUserCreds(&uc, userOrChainedFile, seedFile, null);
        if (s != @as(c_uint, @bitCast(NATS_OK))) {
            natsMutex_Unlock(opts.*.mu);
            return if (s == @as(c_uint, @bitCast(NATS_OK))) s else nats_updateErrStack(s, "natsOptions_SetUserCredentialsFromFiles");
        }
    }
    _setAndUnlockOptsFromUserCreds(opts, uc);
    return @as(c_uint, @bitCast(NATS_OK));
}
pub export fn natsOptions_SetUserCredentialsFromMemory(arg_opts: [*c]natsOptions, arg_jwtAndSeedContent: [*c]const u8) natsStatus {
    var opts = arg_opts;
    _ = &opts;
    var jwtAndSeedContent = arg_jwtAndSeedContent;
    _ = &jwtAndSeedContent;
    var s: natsStatus = @as(c_uint, @bitCast(NATS_OK));
    _ = &s;
    var uc: [*c]userCreds = null;
    _ = &uc;
    if ((opts == @as([*c]natsOptions, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) or (@as(c_int, 0) != 0)) return nats_setErrorReal("./src/submodules/nats.c/src/opts.c", "natsOptions_SetUserCredentialsFromMemory", @as(c_int, 1280), @as(c_uint, @bitCast(NATS_INVALID_ARG)), "%s", natsStatus_GetText(@as(c_uint, @bitCast(NATS_INVALID_ARG))));
    natsMutex_Lock(opts.*.mu);
    if (jwtAndSeedContent != @as([*c]const u8, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) {
        s = _createUserCreds(&uc, null, null, jwtAndSeedContent);
        if (s != @as(c_uint, @bitCast(NATS_OK))) {
            natsMutex_Unlock(opts.*.mu);
            return if (s == @as(c_uint, @bitCast(NATS_OK))) s else nats_updateErrStack(s, "natsOptions_SetUserCredentialsFromMemory");
        }
    }
    _setAndUnlockOptsFromUserCreds(opts, uc);
    return @as(c_uint, @bitCast(NATS_OK));
}
pub export fn natsOptions_SetNKey(arg_opts: [*c]natsOptions, arg_pubKey: [*c]const u8, arg_sigCB: natsSignatureHandler, arg_sigClosure: ?*anyopaque) natsStatus {
    var opts = arg_opts;
    _ = &opts;
    var pubKey = arg_pubKey;
    _ = &pubKey;
    var sigCB = arg_sigCB;
    _ = &sigCB;
    var sigClosure = arg_sigClosure;
    ...
    var nk: [*c]u8 = null;
    _ = &nk;
    if ((opts == @as([*c]natsOptions, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) or (!((if ((pubKey == @as([*c]const u8, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) or (@as(c_int, @bitCast(@as(c_uint, pubKey[@as(c_uint, @intCast(@as(c_int, 0)))]))) == @as(c_int, '\x00'))) @as(c_int, 1) else @as(c_int, 0)) != 0) and (sigCB == @as(natsSignatureHandler, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))))) return nats_setErrorReal("./src/submodules/nats.c/src/opts.c", "natsOptions_SetNKey", @as(c_int, 1344), @as(c_uint, @bitCast(NATS_INVALID_ARG)), "%s", natsStatus_GetText(@as(c_uint, @bitCast(NATS_INVALID_ARG))));
    natsMutex_Lock(opts.*.mu);
    if (!((if ((pubKey == @as([*c]const u8, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) or (@as(c_int, @bitCast(@as(c_uint, pubKey[@as(c_uint, @intCast(@as(c_int, 0)))]))) == @as(c_int, '\x00'))) @as(c_int, 1) else @as(c_int, 0)) != 0)) {
        nk = strdup(pubKey);
        if (nk == @as([*c]u8, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) {
            natsMutex_Unlock(opts.*.mu);
            return nats_setErrorReal("./src/submodules/nats.c/src/opts.c", "natsOptions_SetNKey", @as(c_int, 1352), @as(c_uint, @bitCast(NATS_NO_MEMORY)), "%s", natsStatus_GetText(@as(c_uint, @bitCast(NATS_NO_MEMORY))));
        }
    }
    free(@as(?*anyopaque, @ptrCast(opts.*.nkey)));
    opts.*.nkey = nk;
    ...
    opts.*.sigClosure = sigClosure;
    if (nk != @as([*c]u8, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) {
        if (opts.*.userCreds != @as([*c]struct___userCreds, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) {
            _freeUserCreds(opts.*.userCreds);
            opts.*.userCreds = null;
        }
        opts.*.userJWTHandler = null;
        opts.*.userJWTClosure = @as(?*anyopaque, @ptrFromInt(@as(c_int, 0)));
    }
    natsMutex_Unlock(opts.*.mu);
    return @as(c_uint, @bitCast(NATS_OK));
}
pub export fn natsOptions_SetNKeyFromSeed(arg_opts: [*c]natsOptions, arg_pubKey: [*c]const u8, arg_seedFile: [*c]const u8) natsStatus {
    var opts = arg_opts;
    _ = &opts;
    var pubKey = arg_pubKey;
    _ = &pubKey;
    ...
    var uc: [*c]userCreds = null;
    _ = &uc;
    if ((opts == @as([*c]natsOptions, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) or (!((if ((pubKey == @as([*c]const u8, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) or (@as(c_int, @bitCast(@as(c_uint, pubKey[@as(c_uint, @intCast(@as(c_int, 0)))]))) == @as(c_int, '\x00'))) @as(c_int, 1) else @as(c_int, 0)) != 0) and ((if ((seedFile == @as([*c]const u8, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) or (@as(c_int, @bitCast(@as(c_uint, seedFile[@as(c_uint, @intCast(@as(c_int, 0)))]))) == @as(c_int, '\x00'))) @as(c_int, 1) else @as(c_int, 0)) != 0))) return nats_setErrorReal("./src/submodules/nats.c/src/opts.c", "natsOptions_SetNKeyFromSeed", @as(c_int, 1390), @as(c_uint, @bitCast(NATS_INVALID_ARG)), "%s", natsStatus_GetText(@as(c_uint, @bitCast(NATS_INVALID_ARG))));
    natsMutex_Lock(opts.*.mu);
    if (!((if ((pubKey == @as([*c]const u8, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) or (@as(c_int, @bitCast(@as(c_uint, pubKey[@as(c_uint, @intCast(@as(c_int, 0)))]))) == @as(c_int, '\x00'))) @as(c_int, 1) else @as(c_int, 0)) != 0)) {
        nk = strdup(pubKey);
        if (nk == @as([*c]u8, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) {
            natsMutex_Unlock(opts.*.mu);
            return nats_setErrorReal("./src/submodules/nats.c/src/opts.c", "natsOptions_SetNKeyFromSeed", @as(c_int, 1398), @as(c_uint, @bitCast(NATS_NO_MEMORY)), "%s", natsStatus_GetText(@as(c_uint, @bitCast(NATS_NO_MEMORY))));
        }
        s = _createUserCreds(&uc, null, seedFile, null);
        if (s != @as(c_uint, @bitCast(NATS_OK))) {
            free(@as(?*anyopaque, @ptrCast(nk)));
            natsMutex_Unlock(opts.*.mu);
            return if (s == @as(c_uint, @bitCast(NATS_OK))) s else nats_updateErrStack(s, "natsOptions_SetNKeyFromSeed");
        }
    }
    free(@as(?*anyopaque, @ptrCast(opts.*.nkey)));
    _freeUserCreds(opts.*.userCreds);
    opts.*.nkey = nk;
    opts.*.sigHandler = if (nk == @as([*c]u8, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) null else &natsConn_signatureHandler;
    opts.*.sigClosure = if (nk == @as([*c]u8, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) @as(?*anyopaque, @ptrFromInt(@as(c_int, 0))) else @as(?*anyopaque, @ptrCast(uc));
    opts.*.userCreds = if (nk == @as([*c]u8, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) null else uc;
    opts.*.userJWTHandler = null;
    opts.*.userJWTClosure = @as(?*anyopaque, @ptrFromInt(@as(c_int, 0)));
    natsMutex_Unlock(opts.*.mu);
    return @as(c_uint, @bitCast(NATS_OK));
}
pub export fn natsOptions_SetWriteDeadline(arg_opts: [*c]natsOptions, arg_deadline: i64) natsStatus {
    var opts = arg_opts;
    _ = &opts;
    var deadline = arg_deadline;
    _ = &deadline;
    if ((opts == @as([*c]natsOptions, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) or (deadline < @as(i64, @bitCast(@as(c_long, @as(c_int, 0)))))) return nats_setErrorReal("./src/submodules/nats.c/src/opts.c", "natsOptions_SetWriteDeadline", @as(c_int, 1429), @as(c_uint, @bitCast(NATS_INVALID_ARG)), "%s", natsStatus_GetText(@as(c_uint, @bitCast(NATS_INVALID_ARG))));
    natsMutex_Lock(opts.*.mu);
    opts.*.writeDeadline = deadline;
    natsMutex_Unlock(opts.*.mu);
    return @as(c_uint, @bitCast(NATS_OK));
}
pub export fn natsOptions_DisableNoResponders(arg_opts: [*c]natsOptions, arg_disabled: bool) natsStatus {
    var opts = arg_opts;
    _ = &opts;
    var disabled = arg_disabled;
    _ = &disabled;
    if ((opts == @as([*c]natsOptions, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) or (@as(c_int, 0) != 0)) return nats_setErrorReal("./src/submodules/nats.c/src/opts.c", "natsOptions_DisableNoResponders", @as(c_int, 1441), @as(c_uint, @bitCast(NATS_INVALID_ARG)), "%s", natsStatus_GetText(@as(c_uint, @bitCast(NATS_INVALID_ARG))));
    natsMutex_Lock(opts.*.mu);
    opts.*.disableNoResponders = disabled;
    natsMutex_Unlock(opts.*.mu);
    return @as(c_uint, @bitCast(NATS_OK));
}
pub export fn natsOptions_SetCustomInboxPrefix(arg_opts: [*c]natsOptions, arg_inboxPrefix: [*c]const u8) natsStatus {
    var opts = arg_opts;
    _ = &opts;
    var inboxPrefix = arg_inboxPrefix;
    _ = &inboxPrefix;
    var s: natsStatus = _setCustomInboxPrefix(opts, inboxPrefix, @as(c_int, 1) != 0);
    _ = &s;
    return if (s == @as(c_uint, @bitCast(NATS_OK))) s else nats_updateErrStack(s, "natsOptions_SetCustomInboxPrefix");
}
pub export fn natsOptions_SetMessageBufferPadding(arg_opts: [*c]natsOptions, arg_paddingSize: c_int) natsStatus {
    var opts = arg_opts;
    _ = &opts;
    var paddingSize = arg_paddingSize;
    _ = &paddingSize;
    if ((opts == @as([*c]natsOptions, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) or (paddingSize < @as(c_int, 0))) return nats_setErrorReal("./src/submodules/nats.c/src/opts.c", "natsOptions_SetMessageBufferPadding", @as(c_int, 1499), @as(c_uint, @bitCast(NATS_INVALID_ARG)), "%s", natsStatus_GetText(@as(c_uint, @bitCast(NATS_INVALID_ARG))));
    natsMutex_Lock(opts.*.mu);
    opts.*.payloadPaddingSize = paddingSize;
    natsMutex_Unlock(opts.*.mu);
    return @as(c_uint, @bitCast(NATS_OK));
}
pub export fn natsOptions_Destroy(arg_opts: [*c]natsOptions) void {
    var opts = arg_opts;
    _ = &opts;
    if (opts == @as([*c]natsOptions, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) return;
    _freeOptions(opts);
}
...
pub export fn natsOptions_clone(arg_opts: [*c]natsOptions) [*c]natsOptions {
    var opts = arg_opts;
    _ = &opts;
    var s: natsStatus = @as(c_uint, @bitCast(NATS_OK));
    _ = &s;
    var cloned: [*c]natsOptions = null;
    _ = &cloned;
    var muSize: c_int = undefined;
    _ = &muSize;
    if ((blk: {
        const tmp = natsOptions_Create(&cloned);
        s = tmp;
        break :blk tmp;
    }) != @as(c_uint, @bitCast(NATS_OK))) {
        _ = if (s == @as(c_uint, @bitCast(NATS_OK))) s else nats_updateErrStack(s, "natsOptions_clone");
        return null;
    }
    natsMutex_Lock(opts.*.mu);
    muSize = @as(c_int, @bitCast(@as(c_uint, @truncate(@sizeOf([*c]natsMutex)))));
    _ = memcpy(@as(?*anyopaque, @ptrCast(@as([*c]u8, @ptrCast(@alignCast(cloned))) + @as(usize, @bitCast(@as(isize, @intCast(muSize)))))), @as(?*const anyopaque, @ptrCast(@as([*c]u8, @ptrCast(@alignCast(opts))) + @as(usize, @bitCast(@as(isize, @intCast(muSize)))))), @sizeOf(natsOptions) -% @as(c_ulong, @bitCast(@as(c_long, muSize))));
    cloned.*.name = null;
    cloned.*.servers = null;
    cloned.*.url = null;
    cloned.*.sslCtx = null;
    ...
    if ((s == @as(c_uint, @bitCast(NATS_OK))) and (opts.*.url != @as([*c]u8, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0)))))))) {
        s = natsOptions_SetURL(cloned, opts.*.url);
    }
    if ((s == @as(c_uint, @bitCast(NATS_OK))) and (opts.*.servers != @as([*c][*c]u8, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0)))))))) {
        s = natsOptions_SetServers(cloned, @as([*c][*c]const u8, @ptrCast(@alignCast(opts.*.servers))), opts.*.serversCount);
    }
    if ((s == @as(c_uint, @bitCast(NATS_OK))) and (opts.*.user != @as([*c]u8, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0)))))))) {
        s = natsOptions_SetUserInfo(cloned, opts.*.user, opts.*.password);
    }
    if ((s == @as(c_uint, @bitCast(NATS_OK))) and (opts.*.token != @as([*c]u8, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0)))))))) {
        s = natsOptions_SetToken(cloned, opts.*.token);
    }
    if ((s == @as(c_uint, @bitCast(NATS_OK))) and (opts.*.sslCtx != @as([*c]natsSSLCtx, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0)))))))) {
        cloned.*.sslCtx = natsSSLCtx_retain(opts.*.sslCtx);
    }
    if ((s == @as(c_uint, @bitCast(NATS_OK))) and (opts.*.nkey != @as([*c]u8, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0)))))))) {
        if (opts.*.userCreds != @as([*c]struct___userCreds, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) {
    ...
    } else if ((s == @as(c_uint, @bitCast(NATS_OK))) and (opts.*.userCreds != @as([*c]struct___userCreds, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0)))))))) {
        if (opts.*.userCreds.*.jwtAndSeedContent != @as([*c]u8, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) {
            s = natsOptions_SetUserCredentialsFromMemory(cloned, opts.*.userCreds.*.jwtAndSeedContent);
        } else {
            s = natsOptions_SetUserCredentialsFromFiles(cloned, opts.*.userCreds.*.userOrChainedFile, opts.*.userCreds.*.seedFile);
        }
    }
    if ((s == @as(c_uint, @bitCast(NATS_OK))) and (opts.*.inboxPfx != @as([*c]u8, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0)))))))) {
        s = _setCustomInboxPrefix(cloned, opts.*.inboxPfx, @as(c_int, 0) != 0);
    }
    if (s != @as(c_uint, @bitCast(NATS_OK))) {
        _freeOptions(cloned);
        cloned = null;
...
pub export fn natsOptions_setMicroCallbacks(arg_opts: [*c]natsOptions, arg_closed: natsConnectionHandler, arg_errHandler: natsErrHandler) natsStatus {
    var opts = arg_opts;
    _ = &opts;
    var closed = arg_closed;
    _ = &closed;
    var errHandler = arg_errHandler;
    _ = &errHandler;
    if ((opts == @as([*c]natsOptions, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) or (@as(c_int, 0) != 0)) return nats_setErrorReal("./src/submodules/nats.c/src/opts.c", "natsOptions_setMicroCallbacks", @as(c_int, 957), @as(c_uint, @bitCast(NATS_INVALID_ARG)), "%s", natsStatus_GetText(@as(c_uint, @bitCast(NATS_INVALID_ARG))));
    natsMutex_Lock(opts.*.mu);
...
pub fn _freeServers(arg_opts: [*c]natsOptions) callconv(.c) void {
    var opts = arg_opts;
    _ = &opts;
    var i: c_int = undefined;
    _ = &i;
    if ((opts.*.servers == @as([*c][*c]u8, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) or (opts.*.serversCount == @as(c_int, 0))) return;
    {
        i = 0;
        while (i < opts.*.serversCount) : (i += 1) {
            free(@as(?*anyopaque, @ptrCast((blk: {
                const tmp = i;
                if (tmp >= 0) break :blk opts.*.servers + @as(usize, @intCast(tmp)) else break :blk opts.*.servers - ~@as(usize, @bitCast(@as(isize, @intCast(tmp)) +% -1));
            }).*)));
    ...
    free(@as(?*anyopaque, @ptrCast(opts.*.servers)));
    opts.*.servers = null;
    opts.*.serversCount = 0;
}
pub fn natsSSLCtx_release(arg_ctx: [*c]natsSSLCtx) callconv(.c) void {
    var ctx = arg_ctx;
    _ = &ctx;
    var refs: c_int = undefined;
    _ = &refs;
    if (ctx == @as([*c]natsSSLCtx, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) return;
    ...
    if (refs == @as(c_int, 0)) {
        free(@as(?*anyopaque, @ptrCast(ctx.*.expectedHostname)));
        {
            ctx.*.ctx = null;
        }
...
pub fn natsSSLCtx_retain(arg_ctx: [*c]natsSSLCtx) callconv(.c) [*c]natsSSLCtx {
    var ctx = arg_ctx;
    _ = &ctx;
    natsMutex_Lock(ctx.*.lock);
    ctx.*.refs += 1;
...
pub fn _freeUserCreds(arg_uc: [*c]userCreds) callconv(.c) void {
    var uc = arg_uc;
    _ = &uc;
    if (uc == @as([*c]userCreds, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) return;
    free(@as(?*anyopaque, @ptrCast(uc.*.userOrChainedFile)));
    free(@as(?*anyopaque, @ptrCast(uc.*.seedFile)));
    free(@as(?*anyopaque, @ptrCast(uc.*.jwtAndSeedContent)));
    free(@as(?*anyopaque, @ptrCast(uc)));
}
pub fn _createUserCreds(arg_puc: [*c][*c]userCreds, arg_uocf: [*c]const u8, arg_sf: [*c]const u8, arg_jwtAndSeedContent: [*c]const u8) callconv(.c) natsStatus {
    var puc = arg_puc;
    _ = &puc;
    var uocf = arg_uocf;
    _ = &uocf;
    ...
    var uc: [*c]userCreds = null;
    _ = &uc;
    uc = @as([*c]userCreds, @ptrCast(@alignCast(calloc(@as(c_ulong, @bitCast(@as(c_long, @as(c_int, 1)))), @sizeOf(userCreds)))));
    if (uc == @as([*c]userCreds, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) return nats_setErrorReal("./src/submodules/nats.c/src/opts.c", "_createUserCreds", @as(c_int, 1176), @as(c_uint, @bitCast(NATS_NO_MEMORY)), "%s", natsStatus_GetText(@as(c_uint, @bitCast(NATS_NO_MEMORY))));
    if (jwtAndSeedContent != @as([*c]const u8, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) {
        uc.*.jwtAndSeedContent = strdup(jwtAndSeedContent);
        if (uc.*.jwtAndSeedContent == @as([*c]u8, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) {
            s = nats_setErrorReal("./src/submodules/nats.c/src/opts.c", "_createUserCreds", @as(c_int, 1183), @as(c_uint, @bitCast(NATS_NO_MEMORY)), "%s", natsStatus_GetText(@as(c_uint, @bitCast(NATS_NO_MEMORY))));
        }
    } else {
        if (uocf != null) {
            uc.*.userOrChainedFile = strdup(uocf);
            if (uc.*.userOrChainedFile == @as([*c]u8, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) {
                s = nats_setErrorReal("./src/submodules/nats.c/src/opts.c", "_createUserCreds", @as(c_int, 1191), @as(c_uint, @bitCast(NATS_NO_MEMORY)), "%s", natsStatus_GetText(@as(c_uint, @bitCast(NATS_NO_MEMORY))));
            }
        }
        if ((s == @as(c_uint, @bitCast(NATS_OK))) and (sf != @as([*c]const u8, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0)))))))) {
            uc.*.seedFile = strdup(sf);
            if (uc.*.seedFile == @as([*c]u8, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) {
                s = nats_setErrorReal("./src/submodules/nats.c/src/opts.c", "_createUserCreds", @as(c_int, 1197), @as(c_uint, @bitCast(NATS_NO_MEMORY)), "%s", natsStatus_GetText(@as(c_uint, @bitCast(NATS_NO_MEMORY))));
            }
        }
    }
    if (s != @as(c_uint, @bitCast(NATS_OK))) {
    ...
    return if (s == @as(c_uint, @bitCast(NATS_OK))) s else nats_updateErrStack(s, "_createUserCreds");
}
pub fn _setAndUnlockOptsFromUserCreds(arg_opts: [*c]natsOptions, arg_uc: [*c]userCreds) callconv(.c) void {
    var opts = arg_opts;
    _ = &opts;
    var uc = arg_uc;
    _ = &uc;
    ...
    if (uc != @as([*c]userCreds, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) {
        ...
        opts.*.userJWTClosure = @as(?*anyopaque, @ptrCast(uc));
        opts.*.sigHandler = &natsConn_signatureHandler;
        opts.*.sigClosure = @as(?*anyopaque, @ptrCast(uc));
        if (opts.*.nkey != @as([*c]u8, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) {
            free(@as(?*anyopaque, @ptrCast(opts.*.nkey)));
            opts.*.nkey = null;
        }
    } else {
        ...
        opts.*.sigClosure = @as(?*anyopaque, @ptrFromInt(@as(c_int, 0)));
    }
    natsMutex_Unlock(opts.*.mu);
}
pub fn _setCustomInboxPrefix(arg_opts: [*c]natsOptions, arg_inboxPrefix: [*c]const u8, arg_check: bool) callconv(.c) natsStatus {
    var opts = arg_opts;
    _ = &opts;
    var inboxPrefix = arg_inboxPrefix;
    _ = &inboxPrefix;
    ...
    var s: natsStatus = @as(c_uint, @bitCast(NATS_OK));
    _ = &s;
    if ((opts == @as([*c]natsOptions, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) or (@as(c_int, 0) != 0)) return nats_setErrorReal("./src/submodules/nats.c/src/opts.c", "_setCustomInboxPrefix", @as(c_int, 1455), @as(c_uint, @bitCast(NATS_INVALID_ARG)), "%s", natsStatus_GetText(@as(c_uint, @bitCast(NATS_INVALID_ARG))));
    natsMutex_Lock(opts.*.mu);
    free(@as(?*anyopaque, @ptrCast(opts.*.inboxPfx)));
    opts.*.inboxPfx = null;
    if (!((if ((inboxPrefix == @as([*c]const u8, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) or (@as(c_int, @bitCast(@as(c_uint, inboxPrefix[@as(c_uint, @intCast(@as(c_int, 0)))]))) == @as(c_int, '\x00'))) @as(c_int, 1) else @as(c_int, 0)) != 0)) {
        if ((@as(c_int, @intFromBool(check)) != 0) and !nats_IsSubjectValid(inboxPrefix, @as(c_int, 0) != 0)) {
            s = nats_setErrorReal("./src/submodules/nats.c/src/opts.c", "_setCustomInboxPrefix", @as(c_int, 1465), @as(c_uint, @bitCast(NATS_INVALID_ARG)), "Invalid inbox prefix '%s'", inboxPrefix);
        }
        if (s == @as(c_uint, @bitCast(NATS_OK))) {
            if (check) {
                if (asprintf(&opts.*.inboxPfx, "%s.", inboxPrefix) < @as(c_int, 0)) {
                    s = nats_setErrorReal("./src/submodules/nats.c/src/opts.c", "_setCustomInboxPrefix", @as(c_int, 1474), @as(c_uint, @bitCast(NATS_NO_MEMORY)), "%s", natsStatus_GetText(@as(c_uint, @bitCast(NATS_NO_MEMORY))));
                }
            } else {
                {
                    opts.*.inboxPfx = strdup(inboxPrefix);
                    if (opts.*.inboxPfx == @as([*c]u8, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) {
                        s = nats_setErrorReal("./src/submodules/nats.c/src/opts.c", "_setCustomInboxPrefix", @as(c_int, 1479), @as(c_uint, @bitCast(NATS_NO_MEMORY)), "%s", natsStatus_GetText(@as(c_uint, @bitCast(NATS_NO_MEMORY))));
                    }
                }
            }
        }
...
pub fn _freeOptions(arg_opts: [*c]natsOptions) callconv(.c) void {
    var opts = arg_opts;
    _ = &opts;
    if (opts == @as([*c]natsOptions, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) return;
    free(@as(?*anyopaque, @ptrCast(opts.*.url)));
