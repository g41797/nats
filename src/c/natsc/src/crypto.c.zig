...
pub export fn natsCrypto_Init() natsStatus {
    return @as(c_uint, @bitCast(NATS_OK));
}
pub export fn natsCrypto_Sign(arg_seed: [*c]const u8, arg_input: [*c]const u8, arg_inputLen: c_int, arg_signature: [*c]u8) natsStatus {
    var seed = arg_seed;
    _ = &seed;
    var input = arg_input;
    _ = &input;
    ...
    _ = &sk;
    sm = @as([*c]u8, @ptrCast(@alignCast(malloc(@as(c_ulong, @bitCast(@as(c_long, inputLen + @as(c_int, 64))))))));
    if (sm == @as([*c]u8, @ptrCast(@alignCast(@as(?*anyopaque, @ptrFromInt(@as(c_int, 0))))))) return nats_setErrorReal("./src/submodules/nats.c/src/crypto.c", "natsCrypto_Sign", @as(c_int, 503), @as(c_uint, @bitCast(NATS_NO_MEMORY)), "%s", natsStatus_GetText(@as(c_uint, @bitCast(NATS_NO_MEMORY))));
    newKeyFromSeed(seed, @as([*c]u8, @ptrCast(@alignCast(&sk))));
    cryptoSign(@as([*c]u8, @ptrCast(@alignCast(sm))), input, inputLen, @as([*c]u8, @ptrCast(@alignCast(&sk))));
    _ = memcpy(@as(?*anyopaque, @ptrCast(signature)), @as(?*const anyopaque, @ptrCast(sm)), @as(c_ulong, @bitCast(@as(c_long, @as(c_int, 64)))));
    secure_memzero(@as(?*anyopaque, @ptrCast(sm)), @as(usize, @bitCast(@as(c_long, @as(c_int, 64)))));
    secure_memzero(@as(?*anyopaque, @ptrCast(@as([*c]u8, @ptrCast(@alignCast(&sk))))), @sizeOf([64]u8));
    free(@as(?*anyopaque, @ptrCast(sm)));
    return @as(c_uint, @bitCast(NATS_OK));
}
pub export fn natsCrypto_Clear(arg_mem: ?*anyopaque, arg_memLen: c_int) void {
    var mem = arg_mem;
    _ = &mem;
    var memLen = arg_memLen;
    _ = &memLen;
    secure_memzero(mem, @as(usize, @bitCast(@as(c_long, memLen))));
}
...
pub const @"u8" = u8;
pub const @"u32" = c_ulong;
pub const @"u64" = c_ulonglong;
pub const @"i64" = c_longlong;
pub const gf = [16]@"i64";
...
pub fn dl64(arg_x: [*c]const @"u8") callconv(.c) @"u64" {
    var x = arg_x;
    _ = &x;
    var i: @"u64" = undefined;
    _ = &i;
    ...
    {
        i = 0;
        while (i < @as(@"u64", @bitCast(@as(c_longlong, @as(c_int, 8))))) : (i +%= 1) {
            u = (u << @intCast(8)) | @as(@"u64", @bitCast(@as(c_ulonglong, x[@as(usize, @intCast(i))])));
        }
    }
    return u;
}
pub fn ts64(arg_x: [*c]@"u8", arg_u: @"u64") callconv(.c) void {
    var x = arg_x;
    _ = &x;
    var u = arg_u;
    _ = &u;
    ...
    _ = &i;
    {
        ...
        while (i >= @as(c_int, 0)) : (i -= 1) {
            ...
            }).* = @as(@"u8", @bitCast(@as(u8, @truncate(u))));
            u >>= @intCast(@as(c_int, 8));
        }
    }
}
...
pub fn R(arg_x: @"u64", arg_c: c_int) callconv(.c) @"u64" {
    var x = arg_x;
    _ = &x;
    var c = arg_c;
    _ = &c;
    return (x >> @intCast(c)) | (x << @intCast(@as(c_int, 64) - c));
}
pub fn Ch(arg_x: @"u64", arg_y: @"u64", arg_z: @"u64") callconv(.c) @"u64" {
    var x = arg_x;
    _ = &x;
    var y = arg_y;
    _ = &y;
...
pub fn Maj(arg_x: @"u64", arg_y: @"u64", arg_z: @"u64") callconv(.c) @"u64" {
    var x = arg_x;
    _ = &x;
    var y = arg_y;
    _ = &y;
...
pub fn Sigma0(arg_x: @"u64") callconv(.c) @"u64" {
    var x = arg_x;
    _ = &x;
    return (R(x, @as(c_int, 28)) ^ R(x, @as(c_int, 34))) ^ R(x, @as(c_int, 39));
}
pub fn Sigma1(arg_x: @"u64") callconv(.c) @"u64" {
    var x = arg_x;
    _ = &x;
    return (R(x, @as(c_int, 14)) ^ R(x, @as(c_int, 18))) ^ R(x, @as(c_int, 41));
}
pub fn sigma0(arg_x: @"u64") callconv(.c) @"u64" {
    var x = arg_x;
    _ = &x;
    return (R(x, @as(c_int, 1)) ^ R(x, @as(c_int, 8))) ^ (x >> @intCast(7));
}
pub fn sigma1(arg_x: @"u64") callconv(.c) @"u64" {
    var x = arg_x;
    _ = &x;
    return (R(x, @as(c_int, 19)) ^ R(x, @as(c_int, 61))) ^ (x >> @intCast(6));
}
pub const K: [80]@"u64" = [80]@"u64"{
    4794697086780616226,
    8158064640168781261,
...
pub fn crypto_hashblocks(arg_x: [*c]@"u8", arg_m: [*c]const @"u8", arg_n: @"u64") callconv(.c) void {
    var x = arg_x;
    _ = &x;
    var m = arg_m;
    _ = &m;
    ...
    _ = &j;
    {
        ...
        while (i < @as(c_int, 8)) : (i += 1) {
            z[@as(c_uint, @intCast(i))] = blk: {
                const tmp = dl64(x + @as(usize, @bitCast(@as(isize, @intCast(@as(c_int, 8) * i)))));
                a[@as(c_uint, @intCast(i))] = tmp;
                break :blk tmp;
            };
        }
    }
    while (n >= @as(@"u64", @bitCast(@as(c_longlong, @as(c_int, 128))))) {
        {
            i = 0;
            while (i < @as(c_int, 16)) : (i += 1) {
                w[@as(c_uint, @intCast(i))] = dl64(m + @as(usize, @bitCast(@as(isize, @intCast(@as(c_int, 8) * i)))));
            }
        }
        {
            i = 0;
            while (i < @as(c_int, 80)) : (i += 1) {
                {
                    j = 0;
                    while (j < @as(c_int, 8)) : (j += 1) {
                        b[@as(c_uint, @intCast(j))] = a[@as(c_uint, @intCast(j))];
                    }
                }
                t = (((a[@as(c_uint, @intCast(@as(c_int, 7)))] +% Sigma1(a[@as(c_uint, @intCast(@as(c_int, 4)))])) +% Ch(a[@as(c_uint, @intCast(@as(c_int, 4)))], a[@as(c_uint, @intCast(@as(c_int, 5)))], a[@as(c_uint, @intCast(@as(c_int, 6)))])) +% K[@as(c_uint, @intCast(i))]) +% w[@as(c_uint, @intCast(@import("std").zig.c_translation.signedRemainder(i, @as(c_int, 16))))];
                b[@as(c_uint, @intCast(@as(c_int, 7)))] = (t +% Sigma0(a[@as(c_uint, @intCast(@as(c_int, 0)))])) +% Maj(a[@as(c_uint, @intCast(@as(c_int, 0)))], a[@as(c_uint, @intCast(@as(c_int, 1)))], a[@as(c_uint, @intCast(@as(c_int, 2)))]);
                b[@as(c_uint, @intCast(@as(c_int, 3)))] +%= t;
                {
                    j = 0;
                    while (j < @as(c_int, 8)) : (j += 1) {
                        a[@as(c_uint, @intCast(@import("std").zig.c_translation.signedRemainder(j + @as(c_int, 1), @as(c_int, 8))))] = b[@as(c_uint, @intCast(j))];
                    }
                }
                if (@import("std").zig.c_translation.signedRemainder(i, @as(c_int, 16)) == @as(c_int, 15)) {
                    j = 0;
                    while (j < @as(c_int, 16)) : (j += 1) {
                        w[@as(c_uint, @intCast(j))] +%= (w[@as(c_uint, @intCast(@import("std").zig.c_translation.signedRemainder(j + @as(c_int, 9), @as(c_int, 16))))] +% sigma0(w[@as(c_uint, @intCast(@import("std").zig.c_translation.signedRemainder(j + @as(c_int, 1), @as(c_int, 16))))])) +% sigma1(w[@as(c_uint, @intCast(@import("std").zig.c_translation.signedRemainder(j + @as(c_int, 14), @as(c_int, 16))))]);
                    }
                }
            }
        }
        {
            i = 0;
            while (i < @as(c_int, 8)) : (i += 1) {
                a[@as(c_uint, @intCast(i))] +%= z[@as(c_uint, @intCast(i))];
                z[@as(c_uint, @intCast(i))] = a[@as(c_uint, @intCast(i))];
            }
        }
        m += @as(usize, @bitCast(@as(isize, @intCast(@as(c_int, 128)))));
        n -%= @as(@"u64", @bitCast(@as(c_longlong, @as(c_int, 128))));
    }
    {
        i = 0;
        while (i < @as(c_int, 8)) : (i += 1) {
            ts64(x + @as(usize, @bitCast(@as(isize, @intCast(@as(c_int, 8) * i)))), z[@as(c_uint, @intCast(i))]);
        }
    }
}
pub const iv: [64]@"u8" = [64]@"u8"{
    106,
    9,
    230,
    103,
...
pub fn crypto_hash(arg_out: [*c]@"u8", arg_m: [*c]const @"u8", arg_n: @"u64") callconv(.c) c_int {
    var out = arg_out;
    _ = &out;
    var m = arg_m;
    _ = &m;
    ...
    {
        i = 0;
        while (i < @as(@"u64", @bitCast(@as(c_longlong, @as(c_int, 64))))) : (i +%= 1) {
            h[@as(usize, @intCast(i))] = iv[@as(usize, @intCast(i))];
        }
    }
    crypto_hashblocks(@as([*c]@"u8", @ptrCast(@alignCast(&h))), m, n);
    m += n;
    n &= @as(@"u64", @bitCast(@as(c_longlong, @as(c_int, 127))));
    m -= n;
    {
        i = 0;
        while (i < @as(@"u64", @bitCast(@as(c_longlong, @as(c_int, 256))))) : (i +%= 1) {
    ...
    }
    {
        i = 0;
        while (i < n) : (i +%= 1) {
            x[@as(usize, @intCast(i))] = m[@as(usize, @intCast(i))];
        }
    }
    x[@as(usize, @intCast(n))] = 128;
    n = @as(@"u64", @bitCast(@as(c_longlong, @as(c_int, 256) - (@as(c_int, 128) * @intFromBool(n < @as(@"u64", @bitCast(@as(c_longlong, @as(c_int, 112)))))))));
    x[@as(usize, @intCast(n -% @as(@"u64", @bitCast(@as(c_longlong, @as(c_int, 9))))))] = @as(@"u8", @bitCast(@as(u8, @truncate(b >> @intCast(61)))));
    ts64((@as([*c]@"u8", @ptrCast(@alignCast(&x))) + n) - @as(usize, @bitCast(@as(isize, @intCast(@as(c_int, 8))))), b << @intCast(3));
    crypto_hashblocks(@as([*c]@"u8", @ptrCast(@alignCast(&h))), @as([*c]@"u8", @ptrCast(@alignCast(&x))), n);
    {
        i = 0;
        while (i < @as(@"u64", @bitCast(@as(c_longlong, @as(c_int, 64))))) : (i +%= 1) {
            out[@as(usize, @intCast(i))] = h[@as(usize, @intCast(i))];
        }
    }
    return 0;
}
pub fn add(arg_p: [*c]gf, arg_q: [*c]gf) callconv(.c) void {
    var p = arg_p;
    _ = &p;
    var q = arg_q;
    _ = &q;
...
pub fn newKeyFromSeed(arg_seed: [*c]const u8, arg_sk: [*c]u8) callconv(.c) void {
    var seed = arg_seed;
    _ = &seed;
    var sk = arg_sk;
    _ = &sk;
    ...
    _ = &pk;
    _ = crypto_hash(@as([*c]@"u8", @ptrCast(@alignCast(&d))), seed, @as(@"u64", @bitCast(@as(c_longlong, @as(c_int, 32)))));
    ...
    pack(@as([*c]@"u8", @ptrCast(@alignCast(&pk))), @as([*c]gf, @ptrCast(@alignCast(&p))));
    {
        i = 0;
        while (i < @as(@"u64", @bitCast(@as(c_longlong, @as(c_int, 32))))) : (i +%= 1) {
            sk[@as(usize, @intCast(i))] = seed[@as(usize, @intCast(i))];
        }
    }
    {
        i = 0;
        while (i < @as(@"u64", @bitCast(@as(c_longlong, @as(c_int, 32))))) : (i +%= 1) {
            sk[@as(usize, @intCast(@as(@"u64", @bitCast(@as(c_longlong, @as(c_int, 32)))) +% i))] = pk[@as(usize, @intCast(i))];
        }
    }
}
pub fn cryptoSign(arg_sm: [*c]u8, arg_m: [*c]const u8, arg_mlen: c_int, arg_sk: [*c]const u8) callconv(.c) void {
    var sm = arg_sm;
    _ = &sm;
    var m = arg_m;
    _ = &m;
    ...
    var p: [4]gf = undefined;
    _ = &p;
    var n: @"u64" = @as(@"u64", @bitCast(@as(c_longlong, mlen)));
    _ = &n;
    _ = crypto_hash(@as([*c]@"u8", @ptrCast(@alignCast(&d))), sk, @as(@"u64", @bitCast(@as(c_longlong, @as(c_int, 32)))));
    d[@as(c_uint, @intCast(@as(c_int, 0)))] &= @as(@"u8", @bitCast(@as(i8, @truncate(@as(c_int, 248)))));
    d[@as(c_uint, @intCast(@as(c_int, 31)))] &= @as(@"u8", @bitCast(@as(i8, @truncate(@as(c_int, 127)))));
    d[@as(c_uint, @intCast(@as(c_int, 31)))] |= @as(@"u8", @bitCast(@as(i8, @truncate(@as(c_int, 64)))));
    {
        i = 0;
        while (i < n) : (i +%= 1) {
            sm[@as(usize, @intCast(@as(@"u64", @bitCast(@as(c_longlong, @as(c_int, 64)))) +% i))] = m[@as(usize, @intCast(i))];
        }
    }
    {
        i = 0;
        while (i < @as(@"u64", @bitCast(@as(c_longlong, @as(c_int, 32))))) : (i +%= 1) {
            sm[@as(usize, @intCast(@as(@"u64", @bitCast(@as(c_longlong, @as(c_int, 32)))) +% i))] = d[@as(usize, @intCast(@as(@"u64", @bitCast(@as(c_longlong, @as(c_int, 32)))) +% i))];
        }
    }
    _ = crypto_hash(@as([*c]@"u8", @ptrCast(@alignCast(&r))), sm + @as(usize, @bitCast(@as(isize, @intCast(@as(c_int, 32))))), n +% @as(@"u64", @bitCast(@as(c_longlong, @as(c_int, 32)))));
    ...
    pack(sm, @as([*c]gf, @ptrCast(@alignCast(&p))));
    {
        i = 0;
        while (i < @as(@"u64", @bitCast(@as(c_longlong, @as(c_int, 32))))) : (i +%= 1) {
            sm[@as(usize, @intCast(i +% @as(@"u64", @bitCast(@as(c_longlong, @as(c_int, 32))))))] = sk[@as(usize, @intCast(i +% @as(@"u64", @bitCast(@as(c_longlong, @as(c_int, 32))))))];
        }
    }
    _ = crypto_hash(@as([*c]@"u8", @ptrCast(@alignCast(&h))), sm, n +% @as(@"u64", @bitCast(@as(c_longlong, @as(c_int, 64)))));
    ...
    }
    {
        ...
        while (i < @as(@"u64", @bitCast(@as(c_longlong, @as(c_int, 32))))) : (i +%= 1) {
            j = 0;
            while (j < @as(@"i64", @bitCast(@as(c_longlong, @as(c_int, 32))))) : (j += 1) {
                x[@as(usize, @intCast(i +% @as(@"u64", @bitCast(j))))] += @as(@"i64", @bitCast(@as(@"u64", @bitCast(@as(c_ulonglong, h[@as(usize, @intCast(i))]))) *% @as(@"u64", @bitCast(@as(c_ulonglong, d[@as(usize, @intCast(j))])))));
            }
        }
    }
    modL(sm + @as(usize, @bitCast(@as(isize, @intCast(@as(c_int, 32))))), @as([*c]@"i64", @ptrCast(@alignCast(&x))));
}
pub fn secure_memzero(pnt: ?*anyopaque, len: usize) callconv(.c) void {
    _ = &pnt;
    _ = &len;
...
// ./src/submodules/nats.c/src/crypto.c:56:9
